---
title: "IMenuPoints.Remove"
description: "Removes an item from the context menu."
---

# IMenuPoints.Remove

!!! abstract "Method &middot; `ContextMenu.chm`"
    Method: Remove for MenuPoints
...
*Source: `ContextMenu/methods/ContextMenu_method_Remove_IMenuPoints.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
