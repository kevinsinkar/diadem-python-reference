---
title: "ILocalWorker.SetArgument"
description: "Sets the transfer parameter of the LocalWorker object which you can read in the master with GetArgument for Worker . Exchange data as an Array between master an"
---

# ILocalWorker.SetArgument

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: SetArgument for LocalWorker
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_SetArgument_ILocalWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
