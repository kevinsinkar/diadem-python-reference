---
title: "IWorker.ResetError"
description: "Resets the error status of the Worker object. Always create a procedure in the master which is called by OnWorkerStateChange for ParallelProcessControl and chec"
---

# IWorker.ResetError

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: ResetError for Worker

Resets the error status of the Worker object. Always create a procedure in the master which is called by OnWorkerStateChange for ParallelProcessControl and checks the error status of the Worker object.
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_ResetError_IWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
