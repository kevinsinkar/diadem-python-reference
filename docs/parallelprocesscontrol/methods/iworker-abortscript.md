---
title: "IWorker.AbortScript"
description: "Ends a script in a Worker object. The Worker object is not closed."
---

# IWorker.AbortScript

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: AbortScript for Worker

Ends a script in a Worker object. The Worker object is not closed.
...
Pause(Timeout)
for oMyWorker in ParallelProcessControl.Workers:
    if oMyWorker.IsRunning:
        oMyWorker.AbortScript
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_AbortScript_IWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
