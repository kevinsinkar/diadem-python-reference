---
title: "IWorker.GetErrorFlag"
description: "Specifies the error status of the Worker object. Always create a procedure in the master which is called by OnWorkerStateChange for ParallelProcessControl and c"
---

# IWorker.GetErrorFlag

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: GetErrorFlag for Worker

Specifies the error status of the Worker object. Always create a procedure in the master which is called by OnWorkerStateChange for ParallelProcessControl and checks the error status of the Worker object.
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_GetErrorFlag_IWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
