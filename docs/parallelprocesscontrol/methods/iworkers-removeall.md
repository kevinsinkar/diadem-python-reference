---
title: "IWorkers.RemoveAll"
description: "Deletes all Worker objects and closes the associated applications. As soon as you exit the master, DIAdem automatically closes all previously started workers."
---

# IWorkers.RemoveAll

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: RemoveAll for Workers

Deletes all Worker objects and closes the associated applications. As soon as you exit the master, DIAdem automatically closes all previously started workers.
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_RemoveAll_IWorkers.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
