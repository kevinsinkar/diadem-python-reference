---
title: "IWorkers.Item"
description: "Returns the Worker object of a specific ID."
---

# IWorkers.Item

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: Item for Workers

Returns the Worker object of a specific ID.

## Signature

```python
return_value = obj.Item(ID)
```
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_Item_IWorkers.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
