---
title: "IWorker.SetArgument"
description: "Sets the transfer parameter of the Worker object which you can read in the worker with GetArgument for LocalWorker . Exchange data as an Array between master an"
---

# IWorker.SetArgument

!!! abstract "Method &middot; `ParallelProcessControl.chm`"
    Method: SetArgument for Worker
...
*Source: `ParallelProcessControl/methods/ParallelProcessControl_method_SetArgument_IWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
