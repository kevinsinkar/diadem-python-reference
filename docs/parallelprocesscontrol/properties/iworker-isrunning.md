---
title: "IWorker.isRunning"
description: "Specifies whether a Worker object is busy."
---

# IWorker.isRunning

!!! abstract "Property &middot; `ParallelProcessControl.chm`"
    Property: IsRunning for Worker

Specifies whether a Worker object is busy.
...
*Source: `ParallelProcessControl/properties/ParallelProcessControl_property_isRunning_IWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
