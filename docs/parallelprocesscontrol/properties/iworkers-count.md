---
title: "IWorkers.Count"
description: "Returns the number of Worker objects."
---

# IWorkers.Count

!!! abstract "Property &middot; `ParallelProcessControl.chm`"
    Property: Count for Workers

Returns the number of Worker objects.
...
*Source: `ParallelProcessControl/properties/ParallelProcessControl_property_Count_IWorkers.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
