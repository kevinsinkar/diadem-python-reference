---
title: "IParallelProcessControl.Workers"
description: "Returns a collection of all Worker objects in parallel processing."
---

# IParallelProcessControl.Workers

!!! abstract "Property &middot; `ParallelProcessControl.chm`"
    Property: Workers for ParallelProcessControl

Returns a collection of all Worker objects in parallel processing.

## Signature

```python
return_value = obj.Workers
```
...
*Source: `ParallelProcessControl/properties/ParallelProcessControl_property_Workers_IParallelProcessControl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
