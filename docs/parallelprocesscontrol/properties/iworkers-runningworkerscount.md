---
title: "IWorkers.RunningWorkersCount"
description: "Returns the number of busy Worker objects. Busy Worker objects are objects that are executing a script."
---

# IWorkers.RunningWorkersCount

!!! abstract "Property &middot; `ParallelProcessControl.chm`"
    Property: RunningWorkersCount for Workers

Returns the number of busy Worker objects. Busy Worker objects are objects that are executing a script.

## Signature

```python
obj.RunningWorkersCount
```
...
*Source: `ParallelProcessControl/properties/ParallelProcessControl_property_RunningWorkersCount_IWorkers.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
