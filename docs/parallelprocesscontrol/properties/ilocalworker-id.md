---
title: "ILocalWorker.ID"
description: "Specifies the ID of the LocalWorker object. Use the property to specify the current ID in a worker script."
---

# ILocalWorker.ID

!!! abstract "Property &middot; `ParallelProcessControl.chm`"
    Property: ID for LocalWorker

Specifies the ID of the LocalWorker object. Use the property to specify the current ID in a worker script.
...
*Source: `ParallelProcessControl/properties/ParallelProcessControl_property_ID_ILocalWorker.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
