---
title: "IParallelProcessControl.OnScriptFinished"
description: "Triggers in parallel processing when a worker object ends the script started with the Run for Worker method. The event starts the user command that you assigned"
---

# IParallelProcessControl.OnScriptFinished
...
*Source: `ParallelProcessControl/events/ParallelProcessControl_Event_OnScriptFinished_IParallelProcessControl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
