---
title: "Workers"
description: "Collection of all Worker objects in parallel processing. Use the worker collection to create or to delete Worker objects or to access an individual Worker objec"
---

# Workers

!!! abstract "Collection &middot; `ParallelProcessControl.chm`"
    Collection: Workers

Collection of all Worker objects in parallel processing. Use the worker collection to create or to delete Worker objects or to access an individual Worker object from the master DIAdem.
...
<p><a href="../../properties/iworkers-count/">Count</a> | <a href="../../properties/iworkers-runningworkerscount/">RunningWorkersCount</a></p>
</div>
<div class="Methods"><h2>Methods</h2>
<p><a href="../../methods/iworkers-add/">Add</a> | <a href="../../methods/iworkers-item/">Item</a> | <a href="../../methods/iworkers-remove/">Remove</a> | <a href="../../methods/iworkers-removeall/">RemoveAll</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../objects/iparallelprocesscontrol/">ParallelProcessControl</a>.<a href="../../properties/iparallelprocesscontrol-workers/">Workers</a></p>
</div>
</div>
...
*Source: `ParallelProcessControl/objects/ParallelProcessControl_Objects_IWorkers.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
