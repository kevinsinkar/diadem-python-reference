---
title: "ITDMModelReferences.Item"
description: "Returns the ModelReference object associated with a specific index or with a specific name, in a data store."
---

# ITDMModelReferences.Item

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Item for ModelReferences

Returns the ModelReference object associated with a specific index or with a specific name, in a data store.
...
oMyEntities = oMyDataStoreModel.Entities
oMyModelReference = oMyEntities(1).ModelReferences
dd.MsgBoxDisp(oMyModelReference.Item(1).Name)
```
...
*Source: `ScriptNavi/methods/navigator_method_Item_ITDMModelReferences.htm`*
