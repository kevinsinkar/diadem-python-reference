---
title: "IDisplay.OpenDataStoreByParameter"
description: "Uses the specified parameters to open a data store in the DIAdem NAVIGATOR interface."
---

# IDisplay.OpenDataStoreByParameter
...
<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If DIAdem cannot execute the <span class="Monospace">OpenDataStoreByParameter</span> method successfully, DIAdem fills the VBS Error object and aborts the script. DIAdem writes further information into the logfile and displays a dialog box that contains information on the error.</td></tr></table>
...
```python
dd.Navigator.Display.OpenDataStoreByParameter("Atfx", "C:\\MyAtfxData.atfx")
```
...
*Source: `ScriptNavi/methods/navigator_method_OpenDataStoreByParameter_IDisplay.htm`*
