---
title: "IDataStoreDisplay.IsKindOf"
description: "Determines whether a data store is open."
---

# IDataStoreDisplay.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for DataStoreDisplay

Determines whether a data store is open.
...
if (oMyDataProvider.IsKindOf(dd.eDataStore)) :
    dd.MsgBoxDisp(oMyDataProvider.Name)
else:
    dd.MsgBoxDisp("No DataStore")
```
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_IDataStoreDisplay.HTM`*
