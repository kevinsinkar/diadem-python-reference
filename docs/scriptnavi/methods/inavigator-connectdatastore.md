---
title: "INavigator.ConnectDataStore"
description: "Opens a connection to an ASAM data store without using the user interface. You specify the ASAM data store by its name."
---

# INavigator.ConnectDataStore
...
```python
return_value = obj.ConnectDataStore(Name)
```
...
*Source: `ScriptNavi/methods/navigator_method_ConnectDataStore_INavigator.htm`*
