---
title: "ITDMDataFinderIndexer.GetStatistics"
description: "Returns the index status of the DataFinder."
---

# ITDMDataFinderIndexer.GetStatistics

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: GetStatistics for Indexer

Returns the index status of the DataFinder.

## Signature

```python
return_value = obj.GetStatistics()
```

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  From version 2015, the <span class="Monospace">GetStatistics</span> method returns the value zero as the number of indexed channels or channel groups for the DataFinder instances.</td></tr></table>
</div>
...
*Source: `ScriptNavi/methods/navigator_method_GetStatistics_ITDMDataFinderIndexer.htm`*
