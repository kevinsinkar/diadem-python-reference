---
title: "ITDMDataFinder.LoadQuery"
description: "Generates a search object with the parameters from the transferred file, in a DataFinder. The LoadQuery method can load files with parameters of a quick search "
---

# ITDMDataFinder.LoadQuery

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: LoadQuery for DataFinder

Generates a search object with the parameters from the transferred file, in a DataFinder. The LoadQuery method can load files with parameters of a quick search and files with the parameters of an advanced search. Note Use the LoadQueryInfoSet method instead of the LoadQuery method if you want to work on the NAVIGATOR interface. Use the LoadQueryInfoSet method to also load the configuration of the search results list.
...
*Source: `ScriptNavi/methods/navigator_method_LoadQuery_ITDMDataFinder.htm`*
