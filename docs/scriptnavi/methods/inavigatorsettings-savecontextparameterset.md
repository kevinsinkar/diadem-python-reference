---
title: "INavigatorSettings.SaveContextParameterSet"
description: "Saves a set of context parameters. Context parameter sets have the filename extentsion *.tdp ."
---

# INavigatorSettings.SaveContextParameterSet

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: SaveContextParameterSet for Settings <Navigator>

Saves a set of context parameters. Context parameter sets have the filename extentsion *.tdp .

## Signature

```python
obj.SaveContextParameterSet(FileNamePath, ContextParameterSet)
```
...
*Source: `ScriptNavi/methods/navigator_method_SaveContextParameterSet_INavigatorSettings.htm`*
