---
title: "INaviDataFinderBrowser.CloseAll"
description: "Closes in a DataFinder all open elements of the file browser."
---

# INaviDataFinderBrowser.CloseAll
...
```python
dd.Navigator.Display.CurrDataFinder.Browser.CloseAll()
```
...
*Source: `ScriptNavi/methods/navigator_method_CloseAll_INaviDataFinderBrowser.HTM`*
