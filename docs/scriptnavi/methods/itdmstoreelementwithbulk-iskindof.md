---
title: "ITDMStoreElementWithBulk.IsKindOf"
description: "Checks in a data store whether a data element is a certain entity. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <D"
---

# ITDMStoreElementWithBulk.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for ElementWithValues <DataStore>

Checks in a data store whether a data element is a certain entity. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
if oMyLocalColumn.IsKindOf("localcolumn") :
    dd.MsgBoxDisp(oMyLocalColumn.name)
```
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_ITDMStoreElementWithBulk.htm`*
