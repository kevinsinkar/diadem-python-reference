---
title: "ITDMIndexedProperties.Exists"
description: "Checks in a DataFinder whether the IndexedProperties object already exists with the specified name."
---

# ITDMIndexedProperties.Exists
...
dd.MsgBoxDisp(oMyProperties.Exists("test"))
```
...
*Source: `ScriptNavi/methods/navigator_method_Exists_ITDMIndexedProperties.htm`*
