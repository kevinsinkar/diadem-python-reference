---
title: "ITDMStoreReferences.Item"
description: "Returns the Reference object associated with a specific name or with a specific index in a data store."
---

# ITDMStoreReferences.Item

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Item for References

Returns the Reference object associated with a specific name or with a specific index in a data store.
...
oMyMeasurement = oMyStoreElement.Children(1)
oMyMeasurementQuantity = oMyMeasurement.Children(1)
dd.MsgBoxDisp(oMyMeasurementQuantity.References.Item(1).Name)
```
...
*Source: `ScriptNavi/methods/navigator_method_Item_ITDMStoreReferences.htm`*
