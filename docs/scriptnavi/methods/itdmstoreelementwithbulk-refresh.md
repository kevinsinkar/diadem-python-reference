---
title: "ITDMStoreElementWithBulk.Refresh"
description: "Refreshes the properties of a data element from a data store. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataSt"
---

# ITDMStoreElementWithBulk.Refresh

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Refresh for ElementWithValues <DataStore>

Refreshes the properties of a data element from a data store. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
*Source: `ScriptNavi/methods/navigator_method_Refresh_ITDMStoreElementWithBulk.htm`*
