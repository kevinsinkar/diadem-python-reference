---
title: "INaviDataFinderQueryForm.ClearHistory"
description: "Deletes the list contents for automatic completion of search terms when you enter text in the quick search or when you enter values for the advanced search in a"
---

# INaviDataFinderQueryForm.ClearHistory
...
```python
dd.Navigator.Display.CurrDataFinder.QueryForm.ClearHistory()
```
...
*Source: `ScriptNavi/methods/navigator_method_ClearHistory_INaviDataFinderQueryForm.htm`*
