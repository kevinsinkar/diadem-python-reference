---
title: "ITDMModelEntities.Item"
description: "Returns the entity associated with a specific name or with a specific index in a data store."
---

# ITDMModelEntities.Item

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Item for ModelEntities

Returns the entity associated with a specific name or with a specific index in a data store.
...
oMyEntities = oMyModel.Entities
dd.MsgBoxDisp(oMyEntities.Item(1).Name)
```
...
*Source: `ScriptNavi/methods/navigator_method_Item_ITDMModelEntities.htm`*
