---
title: "ITDMStoreElement.IsKindOf"
description: "Checks in a data store whether an element is a certain entity."
---

# ITDMStoreElement.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for Element <DataStore>

Checks in a data store whether an element is a certain entity.
...
for Element in oMyResultsList.Elements:
    if Element.IsKindOf("AOMeasurement") :
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_ITDMStoreElement.htm`*
