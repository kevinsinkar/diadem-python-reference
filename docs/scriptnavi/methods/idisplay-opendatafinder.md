---
title: "IDisplay.OpenDataFinder"
description: "Opens a DataFinder in the DIAdem NAVIGATOR interface."
---

# IDisplay.OpenDataFinder
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If DIAdem cannot execute the <span class="Monospace">OpenDataFinder</span> method successfully, DIAdem fills the VBS error object and terminates the script. DIAdem writes further information into a logfile and displays a dialog box that contains information on the error.</td></tr></table>
...
```python
if dd.Navigator.Display.CurrDataFinder is None :
    dd.Navigator.Display.OpenDataFinder("My DataFinder")
```
...
*Source: `ScriptNavi/methods/navigator_method_OpenDataFinder_IDisplay.htm`*
