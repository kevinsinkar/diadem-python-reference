---
title: "INavigator.ConnectDataFinder"
description: "Opens a connection to a DataFinder without using the user interface. You specify the DataFinder by its name."
---

# INavigator.ConnectDataFinder
...
```python
return_value = obj.ConnectDataFinder(Name)
```
...
*Source: `ScriptNavi/methods/navigator_method_ConnectDataFinder_INavigator.htm`*
