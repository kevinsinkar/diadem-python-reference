---
title: "ITDMDataFinderAdvancedQuery.IsKindOf"
description: "Specifies in a DataFinder whether you run a quick search or an advanced search."
---

# ITDMDataFinderAdvancedQuery.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for AdvancedQuery <DataFinder>

Specifies in a DataFinder whether you run a quick search or an advanced search.
...
elif (oMyQuery.IsKindOf(dd.eAdvancedQuery)) :
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_ITDMDataFinderAdvancedQuery.htm`*
