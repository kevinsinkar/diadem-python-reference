---
title: "IDataStoreDisplay.SetBrowseSettings"
description: "Assigns new Browse Settings to an open data store in DIAdem NAVIGATOR."
---

# IDataStoreDisplay.SetBrowseSettings

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: SetBrowseSettings for DataStoreDisplay

Assigns new Browse Settings to an open data store in DIAdem NAVIGATOR.
...
*Source: `ScriptNavi/methods/navigator_method_SetBrowseSettings_IDataStoreDisplay.htm`*
