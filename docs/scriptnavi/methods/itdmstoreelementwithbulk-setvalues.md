---
title: "ITDMStoreElementWithBulk.SetValues"
description: "Transfers in a data store the values of a channel from the Data Portal into the value vector of a LocalColumn. Note Only the data elements derived from the base"
---

# ITDMStoreElementWithBulk.SetValues

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: SetValues for ElementWithValues <DataStore>

Transfers in a data store the values of a channel from the Data Portal into the value vector of a LocalColumn. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.

## Signature

```python
obj.SetValues(Values, bflags)
```
...
*Source: `ScriptNavi/methods/navigator_method_SetValues_ITDMStoreElementWithBulk.htm`*
