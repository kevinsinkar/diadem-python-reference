---
title: "ITDMModelStandardProperty.IsKindOf"
description: "Determines whether a standard property of a ModelEntity in a data store is the specified type."
---

# ITDMModelStandardProperty.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for ModelStandardProperty

Determines whether a standard property of a ModelEntity in a data store is the specified type.
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_ITDMModelStandardProperty.htm`*
