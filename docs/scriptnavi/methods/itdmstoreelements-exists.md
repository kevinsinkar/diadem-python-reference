---
title: "ITDMStoreElements.Exists"
description: "Checks in a data store whether the data element with the specified name already exists."
---

# ITDMStoreElements.Exists
...
dd.MsgBoxDisp(oMyStoreElements.Exists("MyTest"))
```
...
*Source: `ScriptNavi/methods/navigator_method_Exists_ITDMStoreElements.htm`*
