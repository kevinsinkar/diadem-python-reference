---
title: "ITDMDataStoreContext.SetParameter"
description: "Writes a context parameter to a data store on an ASAM server."
---

# ITDMDataStoreContext.SetParameter

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: SetParameter for Context

Writes a context parameter to a data store on an ASAM server.

## Signature

```python
obj.SetParameter(Name, Val, DataType)
```
...
*Source: `ScriptNavi/methods/navigator_method_SetParameter_ITDMDataStoreContext.htm`*
