---
title: "ITDMDataStoreContext.SetParameters"
description: "Writes the parameters from a context parameter set to a data store on an ASAM server."
---

# ITDMDataStoreContext.SetParameters

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: SetParameters for Context

Writes the parameters from a context parameter set to a data store on an ASAM server.

## Signature

```python
obj.SetParameters(ParameterSet)
```
...
*Source: `ScriptNavi/methods/navigator_method_SetParameters_ITDMDataStoreContext.htm`*
