---
title: "ITDMModelEnumerationProperty.IsKindOf"
description: "Determines whether an enumeration property of a ModelEntity in a data store is the specified type."
---

# ITDMModelEnumerationProperty.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for ModelEnumerationProperty

Determines whether an enumeration property of a ModelEntity in a data store is the specified type.
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_ITDMModelEnumerationProperty.htm`*
