---
title: "INavigatorSettings.CreateContextParameterSet"
description: "Generates a set of context parameters."
---

# INavigatorSettings.CreateContextParameterSet

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: CreateContextParameterSet for Settings <Navigator>

Generates a set of context parameters.

## Signature

```python
return_value = obj.CreateContextParameterSet()
```
...
*Source: `ScriptNavi/methods/navigator_method_CreateContextParameterSet_INavigatorSettings.htm`*
