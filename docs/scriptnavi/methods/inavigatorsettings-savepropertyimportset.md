---
title: "INavigatorSettings.SavePropertyImportSet"
description: "Saves the Loading configuration of a data store. Loading configurations have the filename extension *.tdl ."
---

# INavigatorSettings.SavePropertyImportSet

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: SavePropertyImportSet for Settings <Navigator>

Saves the Loading configuration of a data store. Loading configurations have the filename extension *.tdl .

## Signature

```python
obj.SavePropertyImportSet(FileNamePath, PropertyImportSet)
```
...
*Source: `ScriptNavi/methods/navigator_method_SavePropertyImportSet_INavigatorSettings.htm`*
