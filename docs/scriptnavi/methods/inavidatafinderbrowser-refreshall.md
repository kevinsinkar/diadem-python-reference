---
title: "INaviDataFinderBrowser.RefreshAll"
description: "Refreshes in a DataFinder the view of the file browser."
---

# INaviDataFinderBrowser.RefreshAll
...
```python
dd.Navigator.Display.CurrDataFinder.Browser.RefreshAll()
```
...
*Source: `ScriptNavi/methods/navigator_method_RefreshAll_INaviDataFinderBrowser.HTM`*
