---
title: "ITDMStoreProperties.Item"
description: "Returns the Properties object associated with a specific name or with a specific index in a data store."
---

# ITDMStoreProperties.Item

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Item for Properties <DataStore>

Returns the Properties object associated with a specific name or with a specific index in a data store.
...
for Element in oMyResultsList.Elements:
    dd.MsgBoxDisp(Element.Properties.Item(1).Value)
```
...
*Source: `ScriptNavi/methods/navigator_method_Item_ITDMStoreProperties.htm`*
