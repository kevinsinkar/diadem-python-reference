---
title: "ITDMDataFinder.Refresh"
description: "Reads in the DataFinder configuration once more."
---

# ITDMDataFinder.Refresh

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Refresh for DataFinder

Reads in the DataFinder configuration once more.
...
*Source: `ScriptNavi/methods/navigator_method_Refresh_ITDMDataFinder.htm`*
