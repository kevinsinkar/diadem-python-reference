---
title: "ITDMStoreElementWithBulk.Save"
description: "Saves a data element in the corresponding data store. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> typ"
---

# ITDMStoreElementWithBulk.Save

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Save for ElementWithValues <DataStore>

Saves a data element in the corresponding data store. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
*Source: `ScriptNavi/methods/navigator_method_Save_ITDMStoreElementWithBulk.htm`*
