---
title: "IResultsDisplaySelection.IsKindOf"
...
# IResultsDisplaySelection.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for Selection
...
| --- | ---: | --- |
| `eColumnsSelection` | 1 | ColumnsSelection |
| `eElementsSelection` | 2 | ElementsSelection <DataFinder> , ElementsSelection <DataStore> |
| `eCellsSelection` | 4 | CellsSelection |
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_IResultsDisplaySelection.htm`*
