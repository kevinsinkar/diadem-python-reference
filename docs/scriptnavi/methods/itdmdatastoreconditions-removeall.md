---
title: "ITDMDataStoreConditions.RemoveAll"
description: "Removes all search conditions of a search in a data store."
---

# ITDMDataStoreConditions.RemoveAll

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: RemoveAll for Conditions <DataStore>

Removes all search conditions of a search in a data store.
...
*Source: `ScriptNavi/methods/navigator_method_RemoveAll_ITDMDataStoreConditions.htm`*
