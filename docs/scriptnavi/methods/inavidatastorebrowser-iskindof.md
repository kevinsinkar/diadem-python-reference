---
title: "INaviDataStoreBrowser.IsKindOf"
description: "Determines in a data store whether the data browser is open."
---

# INaviDataStoreBrowser.IsKindOf

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: IsKindOf for Browser <DataStore>

Determines in a data store whether the data browser is open.
...
if oMyBrowser.IsKindOf(eDataStoreBrowser) :
    dd.MsgBoxDisp("DataStoreBrowser")
else:
    dd.MsgBoxDisp("DataFinderBrowser")
```
...
*Source: `ScriptNavi/methods/navigator_method_IsKindOf_INaviDataStoreBrowser.htm`*
