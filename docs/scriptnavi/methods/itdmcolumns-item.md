---
title: "ITDMColumns.Item"
description: "Uses the index to access a column of the search results, in a DataFinder or a data store."
---
...
dd.MsgBoxDisp (oMyResultsList.Columns.Item(1).Property)
```
...
*Source: `ScriptNavi/methods/navigator_method_Item_ITDMColumns.htm`*
