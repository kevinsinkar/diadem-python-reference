---
title: "ITDMModelProperties.Item"
description: "Returns the ModelProperty object associated with a specific index or with a specific name, in a data store."
---

# ITDMModelProperties.Item

!!! abstract "Method &middot; `ScriptNavi.chm`"
    Method: Item for ModelProperties

Returns the ModelProperty object associated with a specific index or with a specific name, in a data store.
...
oMyDataStoreModelProperties = oMyDataStoreModel.Entities(1).ModelProperties
dd.MsgBoxDisp(oMyDataStoreModelProperties.Item(1).DataType)
```
...
*Source: `ScriptNavi/methods/navigator_method_Item_ITDMModelProperties.htm`*
