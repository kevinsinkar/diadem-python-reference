---
title: "OnDataStoreSaving.OnDataStoreSaving"
description: "Is triggered in DIAdem NAVIGATOR before data stores are saved. The event starts the user command that you assigned to the OnDataStoreSaving for Events <Navigato"
---

# OnDataStoreSaving.OnDataStoreSaving

!!! abstract "Event &middot; `ScriptNavi.chm`"
    Event: OnDataStoreSaving

Is triggered in DIAdem NAVIGATOR before data stores are saved. The event starts the user command that you assigned to the OnDataStoreSaving for Events <Navigator> property. With this event you can determine, for example, which element is selected in the Data Portal and on which file the focus in the data browser is before you save data.

## Signature

```python
obj.OnDataStoreSaving
```

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the method <a href="../../properties/inavidatastorebrowser-enabledropdata/">EnableDropData for Browser</a> to drag and drop data from the Data Portal to the data browser.</td></tr></table>
