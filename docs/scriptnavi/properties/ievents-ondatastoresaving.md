---
title: "IEvents.OnDataStoreSaving"
description: "Specifies the name of the user command that DIAdem executes after saving a data store."
---

# IEvents.OnDataStoreSaving

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: OnDataStoreSaving for Events <Navigator>

Specifies the name of the user command that DIAdem executes after saving a data store.
