---
title: "ITDMModelStandardProperty.DataType"
description: "Specifies in a data store the data type of a standard property of the data model."
---

# ITDMModelStandardProperty.DataType

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: DataType for ModelStandardProperty

Specifies in a data store the data type of a standard property of the data model.
...
*Source: `ScriptNavi/properties/navigator_property_DataType_ITDMModelStandardProperty.htm`*
