---
title: "ITDMStoreElementWithBulk.DataType"
description: "Specifies in a data store the data type of a LocalColumn. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore>"
---

# ITDMStoreElementWithBulk.DataType

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: DataType for ElementWithValues <DataStore>

Specifies in a data store the data type of a LocalColumn. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>You only can change the data type of a LocalColumn if you have not assigned values to the LocalColumn.</td></tr></table>
</div>
...
dd.MsgBoxDisp(oMyTargetLocalColumn.DataType)
```
...
*Source: `ScriptNavi/properties/navigator_property_DataType_ITDMStoreElementWithBulk.htm`*
