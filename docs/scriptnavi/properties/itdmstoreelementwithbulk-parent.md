---
title: "ITDMStoreElementWithBulk.Parent"
description: "Returns the superordinate element of a data element in a data store. Use the Parent property to navigate from the measurement quantities to the root element. No"
---

# ITDMStoreElementWithBulk.Parent

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Parent for ElementWithValues <DataStore>

Returns the superordinate element of a data element in a data store. Use the Parent property to navigate from the measurement quantities to the root element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.

## Signature

```python
return_value = obj.Parent
```
...
#------ Displaying parent name ---------
dd.MsgBoxDisp(oMyTargetLocalColumn.Parent.Name)
```
...
*Source: `ScriptNavi/properties/navigator_property_Parent_ITDMStoreElementWithBulk.htm`*
