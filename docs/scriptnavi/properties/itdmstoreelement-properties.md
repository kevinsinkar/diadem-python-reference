---
title: "ITDMStoreElement.Properties"
description: "Returns the properties of a data element in a data store."
---

# ITDMStoreElement.Properties

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Properties for Element <DataStore>

Returns the properties of a data element in a data store.
...
dd.MsgBoxDisp(oMyStoreElement.Properties.Count)
```
...
*Source: `ScriptNavi/properties/navigator_property_Properties_ITDMStoreElement.htm`*
