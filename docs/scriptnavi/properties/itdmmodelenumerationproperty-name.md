---
title: "ITDMModelEnumerationProperty.Name"
description: "Specifies the name of an enumeration property in an entity of the data model."
---

# ITDMModelEnumerationProperty.Name

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Name for ModelEnumerationProperty

Specifies the name of an enumeration property in an entity of the data model.
...
*Source: `ScriptNavi/properties/navigator_property_Name_ITDMModelEnumerationProperty.htm`*
