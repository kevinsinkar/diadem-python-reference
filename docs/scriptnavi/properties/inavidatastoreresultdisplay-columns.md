---
title: "INaviDataStoreResultDisplay.Columns"
description: "Specifies in the search results list of a data store all the columns with properties except the column Results List. DIAdem automatically displays additional co"
---

# INaviDataStoreResultDisplay.Columns

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Columns for ResultsList <DataStore>

Specifies in the search results list of a data store all the columns with properties except the column Results List. DIAdem automatically displays additional columns with the properties that you searched for. Select Configure Search Results List from the context menu of the search results list to manually add further columns with properties. You only can remove columns which were added manually.
...
```python
dd.Navigator.Display.CurrDataStore.ResultsList.Columns.Add("Test","ID")
```
...
*Source: `ScriptNavi/properties/navigator_property_Columns_INaviDataStoreResultDisplay.htm`*
