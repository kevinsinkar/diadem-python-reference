---
title: "IEvents.OnDataStoreLoading"
description: "Specifies the name of the user command that DIAdem executes before loading data from a data store."
---

# IEvents.OnDataStoreLoading

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: OnDataStoreLoading for Events <Navigator>

Specifies the name of the user command that DIAdem executes before loading data from a data store.

## Signature

```python
obj.OnDataStoreLoading
```
