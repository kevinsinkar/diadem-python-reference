---
title: "ITDMDataFinderSettings.IndexerSchedule"
description: "Returns the settings for the indexer schedule in a DataFinder configuration."
---

# ITDMDataFinderSettings.IndexerSchedule

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: IndexerSchedule for DataFinderSettings

Returns the settings for the indexer schedule in a DataFinder configuration.

## Signature

```python
return_value = obj.IndexerSchedule
```

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <span class="style1">IndexerSchedule</span> property only for the configuration of the <span class="Monospace">My DataFinder</span> DataFinder. To configure a data indexing instance in SystemLink TDM, use the SystemLink TDM HTTP API. For a description of the SystemLink TDM HTTP API, see the SystemLink Help.</td></tr></table>
</div>
...
dd.MsgBoxDisp(oMyDataFinderSettings.IndexerSchedule.Interval)
```
...
*Source: `ScriptNavi/properties/navigator_property_IndexerSchedule_ITDMDataFinderSettings.htm`*
