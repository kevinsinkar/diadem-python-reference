---
title: "IEvents.OnFileLoading"
description: "Specifies the name of the user command that DIAdem executes before loading data from a file."
---

# IEvents.OnFileLoading

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: OnFileLoading for Events <Navigator>

Specifies the name of the user command that DIAdem executes before loading data from a file.
