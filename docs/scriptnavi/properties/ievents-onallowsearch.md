---
title: "IEvents.OnAllowSearch"
description: "Specifies the name of the user command that DIAdem executes before executing a search. The user command receives a parameter. This parameter specifies whether D"
---

# IEvents.OnAllowSearch

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: OnAllowSearch for Events <Navigator>

Specifies the name of the user command that DIAdem executes before executing a search. The user command receives a parameter. This parameter specifies whether DIAdem executes the search after executing the user command (TRUE) or not (FALSE).
