---
title: "ITDMModelReference.Inverse"
description: "Specifies in a data store the inverse reference of a model reference."
---

# ITDMModelReference.Inverse
...
oMyModelReference = oMyDataStoreModel.Entities(1).ModelReferences(1)
dd.MsgBoxDisp(oMyModelReference.Inverse.Name)
```
...
*Source: `ScriptNavi/properties/navigator_property_Inverse_ITDMModelReference.htm`*
