---
title: "ITDMStoreElement.Type"
description: "Specifies in a data store the type of a data element."
---

# ITDMStoreElement.Type

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Type for Element <DataStore>

Specifies in a data store the type of a data element.
...
dd.MsgBoxDisp(oMyStoreElement.Type)
```
...
*Source: `ScriptNavi/properties/navigator_property_Type_ITDMStoreElement.htm`*
