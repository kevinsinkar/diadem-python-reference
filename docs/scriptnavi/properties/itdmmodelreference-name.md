---
title: "ITDMModelReference.Name"
description: "Specifies in a data store the name of the model reference of an entity."
---

# ITDMModelReference.Name
...
dd.MsgBoxDisp(oMyDataStoreModel.Entities(1).ModelReferences(1).Name)
```
...
*Source: `ScriptNavi/properties/navigator_property_Name_ITDMModelReference.htm`*
