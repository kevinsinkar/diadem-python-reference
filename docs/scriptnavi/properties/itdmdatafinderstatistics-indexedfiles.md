---
title: "ITDMDataFinderStatistics.IndexedFiles"
description: "Specifies the number of indexed files whose associated DataPlugins can read in the group information and the channel information as well as the file information"
---

# ITDMDataFinderStatistics.IndexedFiles

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: IndexedFiles for DataFinderStatistics

Specifies the number of indexed files whose associated DataPlugins can read in the group information and the channel information as well as the file information.
...
*Source: `ScriptNavi/properties/navigator_property_IndexedFiles_ITDMDataFinderStatistics.htm`*
