---
title: "INaviDataFinderQueryForm.Text"
description: "Specifies the search text of the DataFinder quick search."
---

# INaviDataFinderQueryForm.Text
...
if oMyQueryForm.Mode == dd.eQuickQueryForm :
    dd.MsgBoxDisp (oMyQueryForm.Text)
else:
    dd.MsgBoxDisp ("No Quick Search")
```
...
*Source: `ScriptNavi/properties/navigator_property_Text_INaviDataFinderQueryForm.htm`*
