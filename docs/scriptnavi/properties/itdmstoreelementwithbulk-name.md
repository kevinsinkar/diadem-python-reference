---
title: "ITDMStoreElementWithBulk.Name"
description: "Specifies in a data store the name of a data element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> typ"
---

# ITDMStoreElementWithBulk.Name

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Name for ElementWithValues <DataStore>

Specifies in a data store the name of a data element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
*Source: `ScriptNavi/properties/navigator_property_Name_ITDMStoreElementWithBulk.htm`*
