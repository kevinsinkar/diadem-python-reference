---
title: "ITDMStoreElementWithBulk.Type"
description: "Specifies in a data store the type of a data element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> typ"
---

# ITDMStoreElementWithBulk.Type

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Type for ElementWithValues <DataStore>

Specifies in a data store the type of a data element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
#------ Displaying local column type ---------
dd.MsgBoxDisp(oMyTargetLocalColumn.Type)
```
...
*Source: `ScriptNavi/properties/navigator_property_Type_ITDMStoreElementWithBulk.htm`*
