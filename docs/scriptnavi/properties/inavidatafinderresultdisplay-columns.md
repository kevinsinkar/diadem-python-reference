---
title: "INaviDataFinderResultDisplay.Columns"
description: "Specifies in the search results list of a DataFinder all the columns with properties except the column Search Results . If you run an advanced search, DIAdem au"
---

# INaviDataFinderResultDisplay.Columns

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Columns for ResultsList <DataFinder>

Specifies in the search results list of a DataFinder all the columns with properties except the column Search Results . If you run an advanced search, DIAdem automatically adds columns with the properties that you searched for. Select Configure Search Results List from the context menu of the search results list to manually add further columns with properties. You only can remove columns which were added manually.
...
```python
dd.Navigator.Display.CurrDataFinder.ResultsList.Columns.Add(dd.eSearchChannel,"maximum")
```
...
*Source: `ScriptNavi/properties/navigator_property_Columns_INaviDataFinderResultDisplay.htm`*
