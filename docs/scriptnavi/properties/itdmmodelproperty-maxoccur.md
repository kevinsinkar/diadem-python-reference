---
title: "ITDMModelProperty.MaxOccur"
description: "Specifies in a data store the maximum number of values a property may contain."
---

# ITDMModelProperty.MaxOccur

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: MaxOccur for ModelProperty

Specifies in a data store the maximum number of values a property may contain.
...
*Source: `ScriptNavi/properties/navigator_property_MaxOccur_ITDMModelProperty.htm`*
