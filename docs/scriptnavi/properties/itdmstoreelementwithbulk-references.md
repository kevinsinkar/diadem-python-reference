---
title: "ITDMStoreElementWithBulk.References"
description: "Returns the references to other data elements in a data store. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataS"
---

# ITDMStoreElementWithBulk.References

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: References for ElementWithValues <DataStore>

Returns the references to other data elements in a data store. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.

## Signature

```python
return_value = obj.References
```
...
#------ Displaying number of references ---------
dd.MsgBoxDisp(oMyTargetLocalColumn.References.Count)
```
...
*Source: `ScriptNavi/properties/navigator_property_References_ITDMStoreElementWithBulk.htm`*
