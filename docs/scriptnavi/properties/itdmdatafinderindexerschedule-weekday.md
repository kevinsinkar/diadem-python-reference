---
title: "ITDMDataFinderIndexerSchedule.Weekday"
description: "Specifies the weekday on which the DataFinder indexes the search areas, in a DataFinder configuration. You can assign a value to the Weekday property only if th"
---

# ITDMDataFinderIndexerSchedule.Weekday

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Weekday for IndexerSchedule

Specifies the weekday on which the DataFinder indexes the search areas, in a DataFinder configuration. You can assign a value to the Weekday property only if the DataFinder indexes the search areas every week.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <span class="Monospace">Weekday</span> property only for the configuration of the <span class="Monospace">My DataFinder</span> DataFinder. To configure a data indexing instance in SystemLink TDM, use the SystemLink TDM HTTP API. For a description of the SystemLink TDM HTTP API, see the SystemLink Help.</td></tr></table>
</div>
...
| --- | ---: | --- |
| `eReindexOnMondays` | 1 | Monday |
| `eReindexOnTuesdays` | 2 | Tuesday |
| `eReindexOnWednesdays` | 4 | Wednesday |
| `eReindexOnThursdays` | 8 | Thursday |
| `eReindexOnFridays` | 16 | Friday |
| `eReindexOnSaturdays` | 32 | Saturday |
| `eReindexOnSundays` | 64 | Sunday |
...
*Source: `ScriptNavi/properties/navigator_property_Weekday_ITDMDataFinderIndexerSchedule.htm`*
