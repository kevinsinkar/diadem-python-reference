---
title: "ITDMStoreElementWithBulk.Flags"
description: "Specifies in a data store a vector with the flags that correspond to Values . Note Only the data elements derived from the base type AoLocalColumn are ElementWi"
---

# ITDMStoreElementWithBulk.Flags

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Flags for ElementWithValues <DataStore>

Specifies in a data store a vector with the flags that correspond to Values . Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
#------ Displaying first value and flag ---------
dd.MsgBoxDisp(oMyTargetLocalColumn.Values(1))
dd.MsgBoxDisp(oMyTargetLocalColumn.Flags(1))
```
...
*Source: `ScriptNavi/properties/navigator_property_Flags_ITDMStoreElementWithBulk.htm`*
