---
title: "IEvents.OnDataProviderOpened"
description: "Specifies the name of the user command that DIAdem executes after opening a DataFinder or a data store."
---

# IEvents.OnDataProviderOpened

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: OnDataProviderOpened for Events <Navigator>

Specifies the name of the user command that DIAdem executes after opening a DataFinder or a data store.

## Signature

```python
obj.OnDataProviderOpened
```
