---
title: "ITDMDataFinderIndexerSchedule.Interval"
description: "Specifies the intervals at which the DataFinder repeats the indexing of the search areas, in a DataFinder configuration."
---

# ITDMDataFinderIndexerSchedule.Interval

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: Interval for IndexerSchedule

Specifies the intervals at which the DataFinder repeats the indexing of the search areas, in a DataFinder configuration.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <span class="Monospace">Interval</span> property only for the configuration of the <span class="Monospace">My DataFinder</span> DataFinder. To configure a data indexing instance in SystemLink TDM, use the SystemLink TDM HTTP API. For a description of the SystemLink TDM HTTP API, see the SystemLink Help.</td></tr></table>
</div>
...
| --- | ---: | --- |
| `eReindexNever` | 0 | Never |
| `eReindexHourly` | 1 | Hourly |
| `eReindexDaily` | 2 | Daily |
| `eReindexWeekly` | 3 | Weekly |
...
oMyIndexerSchedule.StartTime = dd.CreateTime(0,0,0,10,0,0,0,0,0)
...
<div markdown="1">
<div class="Properties"><h2>See Also</h2>
...
*Source: `ScriptNavi/properties/navigator_property_Interval_ITDMDataFinderIndexerSchedule.htm`*
