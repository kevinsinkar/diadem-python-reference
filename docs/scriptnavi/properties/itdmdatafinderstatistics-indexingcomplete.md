---
title: "ITDMDataFinderStatistics.IndexingComplete"
description: "Displays whether the DataFinder has executed the indexing of the search area completely at least once."
---

# ITDMDataFinderStatistics.IndexingComplete

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: IndexingComplete for DataFinderStatistics

Displays whether the DataFinder has executed the indexing of the search area completely at least once.

## Signature

```python
obj.IndexingComplete
```
...
*Source: `ScriptNavi/properties/navigator_property_IndexingComplete_ITDMDataFinderStatistics.htm`*
