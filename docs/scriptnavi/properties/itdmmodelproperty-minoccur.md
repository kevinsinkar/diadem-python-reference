---
title: "ITDMModelProperty.MinOccur"
description: "Specifies in a data store the minimum number of values a property must contain."
---

# ITDMModelProperty.MinOccur

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: MinOccur for ModelProperty

Specifies in a data store the minimum number of values a property must contain.
...
*Source: `ScriptNavi/properties/navigator_property_MinOccur_ITDMModelProperty.htm`*
