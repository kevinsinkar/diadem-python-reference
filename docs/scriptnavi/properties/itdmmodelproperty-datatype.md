---
title: "ITDMModelProperty.DataType"
description: "Specifies in a data store the data type of a data model property."
---

# ITDMModelProperty.DataType

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: DataType for ModelProperty

Specifies in a data store the data type of a data model property.
...
*Source: `ScriptNavi/properties/navigator_property_DataType_ITDMModelProperty.htm`*
