---
title: "ITDMDataFinderStatistics.LastCompleteIndexing"
description: "Displays the date and time of the last complete indexing of the search area by the DataFinder."
---

# ITDMDataFinderStatistics.LastCompleteIndexing

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: LastCompleteIndexing for DataFinderStatistics

Displays the date and time of the last complete indexing of the search area by the DataFinder.

## Signature

```python
return_value = obj.LastCompleteIndexing
```
...
*Source: `ScriptNavi/properties/navigator_property_LastCompleteIndexing_ITDMDataFinderStatistics.htm`*
