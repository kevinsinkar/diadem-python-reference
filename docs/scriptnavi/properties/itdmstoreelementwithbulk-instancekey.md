---
title: "ITDMStoreElementWithBulk.InstanceKey"
description: "Specifies in a data store the instance key of a data element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataSt"
---

# ITDMStoreElementWithBulk.InstanceKey

!!! abstract "Property &middot; `ScriptNavi.chm`"
    Property: InstanceKey for ElementWithValues <DataStore>

Specifies in a data store the instance key of a data element. Note Only the data elements derived from the base type AoLocalColumn are ElementWithValues <DataStore> types.
...
#------ Displaying instance key ---------
dd.MsgBoxDisp(oMyTargetLocalColumn.InstanceKey)
```
...
*Source: `ScriptNavi/properties/navigator_property_InstanceKey_ITDMStoreElementWithBulk.htm`*
