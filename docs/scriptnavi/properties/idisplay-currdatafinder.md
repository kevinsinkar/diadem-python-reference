---
title: "IDisplay.CurrDataFinder"
description: "Returns the current DataFinder. To do so a DataFinder must be open in DIAdem NAVIGATOR."
---

# IDisplay.CurrDataFinder
...
```python
return_value = obj.CurrDataFinder
```
...
*Source: `ScriptNavi/properties/navigator_property_CurrDataFinder_IDisplay.htm`*
