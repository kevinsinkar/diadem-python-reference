---
title: "ExpansionLineStyles"
description: "Collection of all ExpansionLineStyle objects in DIAdem REPORT. Use the ExpansionLineStyles collection to delete line properties of an expanded curve or to add n"
---

# ExpansionLineStyles

!!! abstract "Collection &middot; `ReportApi.chm`"
    Collection: ExpansionLineStyles

Collection of all ExpansionLineStyle objects in DIAdem REPORT. Use the ExpansionLineStyles collection to delete line properties of an expanded curve or to add new line properties.
...
<p><a href="../../properties/irepexpansionlinestylelistint-count/">Count</a></p>
</div>
<div class="Methods"><h2>Methods</h2>
<p><a href="../../methods/irepexpansionlinestylelistint-add/">Add</a> | <a href="../../methods/irepexpansionlinestylelistint-item/">Item</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../objects/irepattributelistint/">AttributeList</a>.<a href="../../properties/irepattributelistint-linestyles/">LineStyles</a></p>
</div>
</div>
...
*Source: `ReportApi/Objects/Report_Objects_IRepExpansionLineStyleListInt.htm`*
