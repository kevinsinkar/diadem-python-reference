---
title: "IRepD3ShapeObjLineExtensionsInt.Marker"
description: "Specifies the curve marker properties in the 3D curve display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjLineExtensionsInt.Marker

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Marker for 3DLineExtensions

Specifies the curve marker properties in the 3D curve display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Marker_IRepD3ShapeObjLineExtensionsInt.htm`*
