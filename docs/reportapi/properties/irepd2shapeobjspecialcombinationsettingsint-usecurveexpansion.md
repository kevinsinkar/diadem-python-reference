---
title: "IRepD2ShapeObjSpecialCombinationSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Special combination display mode."
---

# IRepD2ShapeObjSpecialCombinationSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DSpecialCombinationSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Special combination display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjSpecialCombinationSettingsInt.htm`*
