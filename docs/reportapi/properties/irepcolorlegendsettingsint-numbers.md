---
title: "IRepColorLegendSettingsInt.Numbers"
description: "Specifies the properties of the color legend labels in an axis system in DIAdem REPORT."
---

# IRepColorLegendSettingsInt.Numbers

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Numbers for ColorLegendSettings

Specifies the properties of the color legend labels in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Numbers_IRepColorLegendSettingsInt.htm`*
