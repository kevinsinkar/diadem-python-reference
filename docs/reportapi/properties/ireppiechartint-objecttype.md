---
title: "IRepPieChartInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepPieChartInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for PieChart
...
dd.MsgBoxDisp(oMyPieChart.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepPieChartInt.htm`*
