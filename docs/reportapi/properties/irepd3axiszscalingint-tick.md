---
title: "IRepD3AxisZScalingInt.Tick"
description: "Specifies the properties of the z-axis ticks in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisZScalingInt.Tick

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Tick for 3DAxisZScaling

Specifies the properties of the z-axis ticks in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Tick_IRepD3AxisZScalingInt.htm`*
