---
title: "IRepD2AxisYScalingInt.Origin"
description: "Specifies the value at which the horizontal axis intersects the selected axis in a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisYScalingInt.Origin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Origin for 2DAxisYScaling

Specifies the value at which the horizontal axis intersects the selected axis in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Origin_IRepD2AxisYScalingInt.htm`*
