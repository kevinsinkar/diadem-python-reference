---
title: "IRepD3ShapeObjCoordinateInt.BoundingXChannel"
description: "Specifies the x-channel to which the BoundingPosition property of a channel-bound coordinate of a 3D axis system in DIAdem REPORT refers."
---

# IRepD3ShapeObjCoordinateInt.BoundingXChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingXChannel for 3DCoordinate

Specifies the x-channel to which the BoundingPosition property of a channel-bound coordinate of a 3D axis system in DIAdem REPORT refers.

## Signature

```python
return_value = obj.BoundingXChannel
```
...
*Source: `ReportApi/properties/Report_property_BoundingXChannel_IRepD3ShapeObjCoordinateInt.htm`*
