---
title: "IRepTable2DColumnTransformingContextInt.Table"
description: "Specifies the 2D table for the channel transformation in a column of a 2D table in DIAdem REPORT."
---

# IRepTable2DColumnTransformingContextInt.Table

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Table for Table2DColumnTransformingContext

Specifies the 2D table for the channel transformation in a column of a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Table_IRepTable2DColumnTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
