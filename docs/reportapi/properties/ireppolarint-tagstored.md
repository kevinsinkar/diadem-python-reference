...
# IRepPolarInt.TagStored

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagStored for PolarSystem
...
*Source: `ReportApi/properties/Report_property_TagStored_IRepPolarInt.htm`*
