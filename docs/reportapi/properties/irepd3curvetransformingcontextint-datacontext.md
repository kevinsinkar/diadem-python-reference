---
title: "IRepD3CurveTransformingContextInt.DataContext"
description: "Specifies the number of the input and output channels or the values of the input and output constants for the curve transformation in a 3D axis system in DIAdem"
---

# IRepD3CurveTransformingContextInt.DataContext

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DataContext for D3CurveTransformingContext

Specifies the number of the input and output channels or the values of the input and output constants for the curve transformation in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_DataContext_IRepD3CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
