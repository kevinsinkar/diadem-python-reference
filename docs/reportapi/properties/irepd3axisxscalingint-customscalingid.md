---
title: "IRepD3AxisXScalingInt.CustomScalingID"
description: "Specifies in a 3D axis system in DIAdem REPORT the ID with which you assign a user-defined axis scaling to an x-axis."
---

# IRepD3AxisXScalingInt.CustomScalingID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CustomScalingID for 3DAxisXScaling

Specifies in a 3D axis system in DIAdem REPORT the ID with which you assign a user-defined axis scaling to an x-axis.
...
oMyXScaling.AutoScalingType = eAxisScalingSimpleCustom
oMyXScaling.CustomScalingID = "MotorWarmScaling"
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_CustomScalingID_IRepD3AxisXScalingInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
