---
title: "IRepTransformDataContextConstantXYZInt.ConstZIn"
description: "Specifies the values of the z-input constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextConstantXYZInt.ConstZIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstZIn for TransformDataContextConstantXYZ

Specifies the values of the z-input constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstZIn_IRepTransformDataContextConstantXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
