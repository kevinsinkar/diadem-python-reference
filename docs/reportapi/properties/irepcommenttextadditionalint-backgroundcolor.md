---
title: "IRepCommentTextAdditionalInt.BackgroundColor"
description: "Specifies the background color of an additional comment in the 2D and 3D display mode Coordinate in DIAdem REPORT."
---

# IRepCommentTextAdditionalInt.BackgroundColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BackgroundColor for AdditionalCommentText

Specifies the background color of an additional comment in the 2D and 3D display mode Coordinate in DIAdem REPORT.
...
oMyCoordComment.Comment.BackgroundColor.SetPredefinedColor(dd.ePredefinedColorViolet)
```
...
*Source: `ReportApi/properties/Report_property_BackgroundColor_IRepCommentTextAdditionalInt.htm`*
