---
title: "IRepD3CurveDrawingContextInt.AxisSystem"
description: "Specifies the 3D axis system of the curve DIAdem REPORT is plotting."
---

# IRepD3CurveDrawingContextInt.AxisSystem

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem for D3CurveDrawingContext

Specifies the 3D axis system of the curve DIAdem REPORT is plotting.
...
```python
AddUserCommandToEvent("dd.Report.Events.OnDrawing3DAxisSystemCurve", "MyOn3DCurveDrawEvent")
...
*Source: `ReportApi/properties/Report_property_AxisSystem_IRepD3CurveDrawingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
