---
title: "IRepToolTipPositionInt.X"
description: "Returns the x-cursor coordinates as page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIA"
---

# IRepToolTipPositionInt.X

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X for ToolTipPositionInt

Returns the x-cursor coordinates as page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object. Use the methods ConvertPageXPositionToXAxisValue and ConvertPageYPositionToYAxisValue to convert the page coordinates into coordinates of a 2D axis system.
...
*Source: `ReportApi/properties/Report_property_X_IRepToolTipPositionInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
