---
title: "IRepExpansionLineStyleInt.Marker"
description: "Specifies the curve marker properties of an expanding curve in DIAdem REPORT if you assign the value TRUE to the UseMarkerProperties property."
---

# IRepExpansionLineStyleInt.Marker

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Marker for ExpansionLineStyle

Specifies the curve marker properties of an expanding curve in DIAdem REPORT if you assign the value TRUE to the UseMarkerProperties property.
...
*Source: `ReportApi/properties/Report_property_Marker_IRepExpansionLineStyleInt.htm`*
