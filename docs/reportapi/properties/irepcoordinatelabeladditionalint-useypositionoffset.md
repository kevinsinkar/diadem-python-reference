---
title: "IRepCoordinateLabelAdditionalInt.UseYPositionOffset"
description: "Specifies whether DIAdem REPORT plots the coordinate labels at the y-value of the curve point or at an angle to the y-value in a 2D axis system in the Coordinat"
---

# IRepCoordinateLabelAdditionalInt.UseYPositionOffset

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseYPositionOffset for AdditionalCoordinateLabel

Specifies whether DIAdem REPORT plots the coordinate labels at the y-value of the curve point or at an angle to the y-value in a 2D axis system in the Coordinate display mode.
...
*Source: `ReportApi/properties/Report_property_UseYPositionOffset_IRepCoordinateLabelAdditionalInt.htm`*
