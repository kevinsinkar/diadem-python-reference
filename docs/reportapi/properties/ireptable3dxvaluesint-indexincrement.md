---
title: "IRepTable3DXValuesInt.IndexIncrement"
description: "Specifies the step width between two successive x-values in a 3D table in DIAdem REPORT. Use the IndexIncrement property if you do not want to display all x-val"
---

# IRepTable3DXValuesInt.IndexIncrement

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: IndexIncrement for 3DTableXValues
...
*Source: `ReportApi/properties/Report_property_IndexIncrement_IRepTable3DXValuesInt.htm`*
