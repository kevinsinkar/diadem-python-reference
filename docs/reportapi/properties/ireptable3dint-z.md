---
title: "IRepTable3DInt.Z"
description: "Specifies the properties of the column with the z-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DInt.Z

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Z for 3DTable

Specifies the properties of the column with the z-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Z_IRepTable3DInt.htm`*
