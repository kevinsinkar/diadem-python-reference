---
title: "IRepAttributeListInt.UseLineInterval"
description: "Specifies whether DIAdem REPORT displays expanding curves in the intervals specified in the attribute list."
---

# IRepAttributeListInt.UseLineInterval

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseLineInterval for AttributeList

Specifies whether DIAdem REPORT displays expanding curves in the intervals specified in the attribute list.
...
*Source: `ReportApi/properties/Report_property_UseLineInterval_IRepAttributeListInt.htm`*
