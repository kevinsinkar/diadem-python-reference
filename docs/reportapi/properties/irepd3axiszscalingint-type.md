---
title: "IRepD3AxisZScalingInt.Type"
description: "Specifies the type of z-axis scaling in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisZScalingInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for 3DAxisZScaling

Specifies the type of z-axis scaling in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Type_IRepD3AxisZScalingInt.htm`*
