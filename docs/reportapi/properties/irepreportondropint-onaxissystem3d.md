...
```python
dd.Report.Events.Drop.OnAxisSystem3D = "MyOnDrop3DAxisSystemEvent"
...
*Source: `ReportApi/properties/Report_property_OnAxisSystem3D_IRepReportOnDropInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
