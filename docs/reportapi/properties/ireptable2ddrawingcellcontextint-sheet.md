---
title: "IRepTable2DDrawingCellContextInt.Sheet"
description: "Specifies the worksheet of the cell DIAdem is plotting in a 2D table in DIAdem REPORT."
---

# IRepTable2DDrawingCellContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for 2DTableDrawingCellContext

Specifies the worksheet of the cell DIAdem is plotting in a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepTable2DDrawingCellContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
