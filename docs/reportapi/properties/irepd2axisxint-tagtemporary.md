---
title: "IRepD2AxisXInt.TagTemporary"
...
# IRepD2AxisXInt.TagTemporary

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagTemporary for 2DAxisX
...
for oMyReportObj in oMyReportObjects:
    if oMyReportObj.ObjectType == dd.eReportObject2DAxisSystem :
        oMyReportObj.XAxis.TagTemporary = "Selected"
```
...
*Source: `ReportApi/properties/Report_property_TagTemporary_IRepD2AxisXInt.htm`*
