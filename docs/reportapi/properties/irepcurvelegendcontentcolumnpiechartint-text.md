---
title: "IRepCurvelegendContentColumnPieChartInt.Text"
description: "Specifies the free text with which DIAdem REPORT labels the segments in a pie chart."
---

# IRepCurvelegendContentColumnPieChartInt.Text

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Text for CurveLegendColumnPieChart

Specifies the free text with which DIAdem REPORT labels the segments in a pie chart.
...
*Source: `ReportApi/properties/Report_property_Text_IRepCurvelegendContentColumnPieChartInt.htm`*
