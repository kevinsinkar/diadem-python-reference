---
title: "IRepTransformDataContextXYZX1Y1Z1Int.X1ChannelNumberOut"
description: "Specifies the number of the x1-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.X1ChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X1ChannelNumberOut for TransformDataContextXYZX1Y1Z1

Specifies the number of the x1-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_X1ChannelNumberOut_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
