---
title: "IRepD3ShapeObjVectorInt.ZChannelEnd"
description: "Specifies the z-channel for the end points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorInt.ZChannelEnd

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ZChannelEnd for 3DVector

Specifies the z-channel for the end points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.ZChannelEnd
```
...
*Source: `ReportApi/properties/Report_property_ZChannelEnd_IRepD3ShapeObjVectorInt.htm`*
