---
title: "IRepD2BackgroundImageScalingInt.XEnd"
description: "Specifies the end value in x-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT."
---

# IRepD2BackgroundImageScalingInt.XEnd

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XEnd for 2DBackgroundImageScaling

Specifies the end value in x-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XEnd_IRepD2BackgroundImageScalingInt.htm`*
