---
title: "IRepD2ShapeObjCoordinateInt.BoundingXChannel"
description: "Specifies the x-channel to which the BoundingPosition property of a channel-bound coordinate of a 2D axis system in DIAdem REPORT refers."
---

# IRepD2ShapeObjCoordinateInt.BoundingXChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingXChannel for 2DCoordinate

Specifies the x-channel to which the BoundingPosition property of a channel-bound coordinate of a 2D axis system in DIAdem REPORT refers.
...
*Source: `ReportApi/properties/Report_property_BoundingXChannel_IRepD2ShapeObjCoordinateInt.htm`*
