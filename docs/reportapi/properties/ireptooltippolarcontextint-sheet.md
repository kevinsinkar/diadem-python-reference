---
title: "IRepToolTipPolarContextInt.Sheet"
description: "Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnPolarSystem for ToolTipEvents property. DIAdem calls this event if you press "
---

# IRepToolTipPolarContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for ToolTipPolarContext

Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnPolarSystem for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepToolTipPolarContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
