---
title: "IRepD3ShapeObjSpikeExtensionsInt.Label"
description: "Specifies the curve labels in the Spikes display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjSpikeExtensionsInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for 3DSpikesExtensions

Specifies the curve labels in the Spikes display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepD3ShapeObjSpikeExtensionsInt.htm`*
