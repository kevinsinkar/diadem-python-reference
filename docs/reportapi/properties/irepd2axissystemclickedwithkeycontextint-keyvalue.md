---
title: "IRepD2AxisSystemClickedWithKeyContextInt.KeyValue"
description: "Specifies the key you press when clicking in a 2D axis system. DIAdem calls the event which you assigned to the OnAxisSystem2D for ClickedWithKeyEvents property"
---

# IRepD2AxisSystemClickedWithKeyContextInt.KeyValue

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: KeyValue for D2AxisSystemClickedWithKeyContext

Specifies the key you press when clicking in a 2D axis system. DIAdem calls the event which you assigned to the OnAxisSystem2D for ClickedWithKeyEvents property. For this event DIAdem does not support keys such as <Alt>, <Ctrl>, and <Shift>.
...
*Source: `ReportApi/properties/Report_property_KeyValue_IRepD2AxisSystemClickedWithKeyContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
