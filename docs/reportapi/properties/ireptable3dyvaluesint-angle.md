---
title: "IRepTable3DYValuesInt.Angle"
description: "Specifies the text angle of the y-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DYValuesInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for 3DTableYValues

Specifies the text angle of the y-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepTable3DYValuesInt.htm`*
