---
title: "IRepTable2DHeaderDefaultSettingsInt.UseTextClipping"
description: "Specifies whether DIAdem REPORT truncates text at the cell boundary in headers or footers of a 2D table. You must assign the value False to the UseAutoFontSize "
---

# IRepTable2DHeaderDefaultSettingsInt.UseTextClipping

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseTextClipping for 2DTableHeaderFooterDefaultSettings
...
oMyHeaderSettings.Title1 = "very long title"
oMyHeaderSettings.UseTextClipping = True
oMyHeaderSettings.UseWordWrap = True
...
oMyColumn2.Settings.RelativeColumnWidth = 10
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_UseTextClipping_IRepTable2DHeaderDefaultSettingsInt.htm`*
