---
title: "IRepD2AxisXScalingInt.MiniTickCount"
description: "Specifies the number of miniticks between the scale ticks on the x-axis of a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisXScalingInt.MiniTickCount

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MiniTickCount for 2DAxisXScaling

Specifies the number of miniticks between the scale ticks on the x-axis of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_MiniTickCount_IRepD2AxisXScalingInt.htm`*
