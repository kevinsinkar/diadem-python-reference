---
title: "IRepToolTipFrameContextInt.SubObject"
description: "Returns the subobject of a rectangle in DIAdem REPORT when DIAdem calls the event assigned to the OnFrame for ToolTipEvents property. DIAdem calls this event if"
---

# IRepToolTipFrameContextInt.SubObject

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SubObject for ToolTipFrameContext

Returns the subobject of a rectangle in DIAdem REPORT when DIAdem calls the event assigned to the OnFrame for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_SubObject_IRepToolTipFrameContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
