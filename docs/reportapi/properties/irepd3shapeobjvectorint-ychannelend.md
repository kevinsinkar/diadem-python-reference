---
title: "IRepD3ShapeObjVectorInt.YChannelEnd"
description: "Specifies the y-channel for the end points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorInt.YChannelEnd

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelEnd for 3DVector

Specifies the y-channel for the end points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.YChannelEnd
```
...
*Source: `ReportApi/properties/Report_property_YChannelEnd_IRepD3ShapeObjVectorInt.htm`*
