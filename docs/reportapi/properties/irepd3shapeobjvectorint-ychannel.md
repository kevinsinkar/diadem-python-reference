---
title: "IRepD3ShapeObjVectorInt.YChannel"
description: "Specifies the y-channel for the start points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorInt.YChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannel for 3DVector

Specifies the y-channel for the start points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannel_IRepD3ShapeObjVectorInt.htm`*
