---
title: "IRepD3PlaneGridXZInt.LineX"
description: "Specifies the properties of the x gridlines in the xz plane of a 3D axis system in DIAdem REPORT."
---

# IRepD3PlaneGridXZInt.LineX

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: LineX for 3DPlaneGridXZ

Specifies the properties of the x gridlines in the xz plane of a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_LineX_IRepD3PlaneGridXZInt.htm`*
