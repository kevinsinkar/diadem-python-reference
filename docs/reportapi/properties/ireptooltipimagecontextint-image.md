---
title: "IRepToolTipImageContextInt.Image"
description: "Returns a graphic in DIAdem REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event if you press the shif"
---

# IRepToolTipImageContextInt.Image

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Image for ToolTipImageContext

Returns a graphic in DIAdem REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.

## Signature

```python
return_value = obj.Image
```
...
*Source: `ReportApi/properties/Report_property_Image_IRepToolTipImageContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
