---
title: "IRepD3ShapeObjVectorInt.ZChannel"
description: "Specifies the z-channel for the start points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorInt.ZChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ZChannel for 3DVector

Specifies the z-channel for the start points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ZChannel_IRepD3ShapeObjVectorInt.htm`*
