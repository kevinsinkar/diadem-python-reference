---
title: "IRepD2ShapeObjSpikesHorizontalSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Horizontal spikes display mode."
---

# IRepD2ShapeObjSpikesHorizontalSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DSpikesHorizontalSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Horizontal spikes display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjSpikesHorizontalSettingsInt.htm`*
