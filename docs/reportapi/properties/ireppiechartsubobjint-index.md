---
title: "IRepPieChartSubObjInt.Index"
description: "Returns the index of the subobject of a pie chart in DIAdem REPORT when DIAdem calls the event assigned to the property OnPieChart for ToolTipEvents . DIAdem ca"
---

# IRepPieChartSubObjInt.Index

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Index for PieChartSubObj

Returns the index of the subobject of a pie chart in DIAdem REPORT when DIAdem calls the event assigned to the property OnPieChart for ToolTipEvents . DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Index_IRepPieChartSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
