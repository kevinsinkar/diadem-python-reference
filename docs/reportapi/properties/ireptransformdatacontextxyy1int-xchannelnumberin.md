---
title: "IRepTransformDataContextXYY1Int.XChannelNumberIn"
description: "Specifies the number of the x-input channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel, "
---

# IRepTransformDataContextXYY1Int.XChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberIn for TransformDataContextXYY1

Specifies the number of the x-input channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel, in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannelNumberIn_IRepTransformDataContextXYY1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
