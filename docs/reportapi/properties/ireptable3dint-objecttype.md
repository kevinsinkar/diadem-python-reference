---
title: "IRepTable3DInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepTable3DInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for 3DTable
...
dd.MsgBoxDisp(oMy3DTable.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepTable3DInt.htm`*
