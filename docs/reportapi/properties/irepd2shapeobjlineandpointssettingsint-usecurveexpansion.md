---
title: "IRepD2ShapeObjLineAndPointsSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Line and points display mode."
---

# IRepD2ShapeObjLineAndPointsSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DLineAndPointsSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Line and points display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjLineAndPointsSettingsInt.htm`*
