---
title: "IRepD2ShapeObjCoordinateInt.Y1Coordinate"
description: "Specifies the y1-coordinate of a 2D axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateInt.Y1Coordinate

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1Coordinate for 2DCoordinate

Specifies the y1-coordinate of a 2D axis system in the Coordinate display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.Y1Coordinate
```
...
*Source: `ReportApi/properties/Report_property_Y1Coordinate_IRepD2ShapeObjCoordinateInt.htm`*
