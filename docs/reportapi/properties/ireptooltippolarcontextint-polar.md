---
title: "IRepToolTipPolarContextInt.Polar"
description: "Returns a polar axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnPolarSystem for ToolTipEvents property. DIAdem calls this event if yo"
---

# IRepToolTipPolarContextInt.Polar

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Polar for ToolTipPolarContext

Returns a polar axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnPolarSystem for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.

## Signature

```python
return_value = obj.Polar
```
...
*Source: `ReportApi/properties/Report_property_Polar_IRepToolTipPolarContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
