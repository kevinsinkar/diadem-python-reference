---
title: "IRepTransformDataContextXYZX1Y1Z1Int.YChannelNumberIn"
description: "Specifies the number of the y-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.YChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberIn for TransformDataContextXYZX1Y1Z1

Specifies the number of the y-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannelNumberIn_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
