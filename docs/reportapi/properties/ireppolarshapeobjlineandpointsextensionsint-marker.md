---
title: "IRepPolarShapeObjLineAndPointsExtensionsInt.Marker"
description: "Specifies the properties of the curve marker of a polar curve in the Line and points display mode in a polar axis system in DIAdem REPORT."
---

# IRepPolarShapeObjLineAndPointsExtensionsInt.Marker

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Marker for PolarLineAndPointsExtensions

Specifies the properties of the curve marker of a polar curve in the Line and points display mode in a polar axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Marker_IRepPolarShapeObjLineAndPointsExtensionsInt.htm`*
