---
title: "IRepD2AxisYInt.TagTemporary"
...
!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagTemporary for 2DAxisY
...
for oMyReportObj in oMyReportObjects:
    if oMyReportObj.ObjectType == dd.eReportObject2DAxisSystem :
        for oMyReportSubObj in oMyReportObj.YAxisList:
            oMyReportSubObj.TagTemporary = "Selected"
```
...
*Source: `ReportApi/properties/Report_property_TagTemporary_IRepD2AxisYInt.htm`*
