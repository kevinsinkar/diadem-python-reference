---
title: "IRepPolarAxisSystemClickedWithKeyContextInt.DoProceed"
description: "Specifies whether DIAdem also transfers the PolarAxisSystemClickedWithKeyContext object to the following events. If the value is TRUE , DIAdem also transfers th"
---

# IRepPolarAxisSystemClickedWithKeyContextInt.DoProceed

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DoProceed for PolarAxisSystemClickedWithKeyContext

Specifies whether DIAdem also transfers the PolarAxisSystemClickedWithKeyContext object to the following events. If the value is TRUE , DIAdem also transfers the PolarAxisSystemClickedWithKeyContext object to the following events.
...
*Source: `ReportApi/properties/Report_property_DoProceed_IRepPolarAxisSystemClickedWithKeyContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
