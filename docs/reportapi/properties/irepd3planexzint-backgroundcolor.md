---
title: "IRepD3PlaneXZInt.BackgroundColor"
description: "Specifies the background color of the xz plane in a 3D display in DIAdem REPORT."
---

# IRepD3PlaneXZInt.BackgroundColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BackgroundColor for 3DPlaneXZ

Specifies the background color of the xz plane in a 3D display in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_BackgroundColor_IRepD3PlaneXZInt.htm`*
