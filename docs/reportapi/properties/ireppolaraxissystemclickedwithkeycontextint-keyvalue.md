---
title: "IRepPolarAxisSystemClickedWithKeyContextInt.KeyValue"
description: "Specifies the key you press when clicking in a polar axis system. DIAdem calls the event which you assigned to the OnAxisSystemPolar for ClickedWithKeyEvents pr"
---

# IRepPolarAxisSystemClickedWithKeyContextInt.KeyValue

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: KeyValue for PolarAxisSystemClickedWithKeyContext

Specifies the key you press when clicking in a polar axis system. DIAdem calls the event which you assigned to the OnAxisSystemPolar for ClickedWithKeyEvents property. For this event DIAdem does not support keys such as <Alt>, <Ctrl>, and <Shift>.
...
*Source: `ReportApi/properties/Report_property_KeyValue_IRepPolarAxisSystemClickedWithKeyContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
