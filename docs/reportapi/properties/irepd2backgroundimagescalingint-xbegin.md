---
title: "IRepD2BackgroundImageScalingInt.XBegin"
description: "Specifies the first value in x-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT."
---

# IRepD2BackgroundImageScalingInt.XBegin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XBegin for 2DBackgroundImageScaling

Specifies the first value in x-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XBegin_IRepD2BackgroundImageScalingInt.htm`*
