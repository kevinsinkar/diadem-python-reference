---
title: "IRepD3PartialLoadInt.MinimumZValue"
description: "Specifies the minimum limit of the z-value to be checked, in a characteristic diagram with partial load structure in DIAdem REPORT."
---

# IRepD3PartialLoadInt.MinimumZValue

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MinimumZValue for D3PartialLoad

Specifies the minimum limit of the z-value to be checked, in a characteristic diagram with partial load structure in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_MinimumZValue_IRepD3PartialLoadInt.htm`*
