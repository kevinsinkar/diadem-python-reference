---
title: "IRepCustomScalingAxisSystem2DScaledInt.Label"
description: "Specifies the label for a user-defined axis scaling on the Axis Parameters tab in the Curve and Axis Definition dialog box in a scaled display in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DScaledInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for AxisSystem2DScaledCustomScaling

Specifies the label for a user-defined axis scaling on the Axis Parameters tab in the Curve and Axis Definition dialog box in a scaled display in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepCustomScalingAxisSystem2DScaledInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
