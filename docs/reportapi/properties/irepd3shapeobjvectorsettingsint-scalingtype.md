---
title: "IRepD3ShapeObjVectorSettingsInt.ScalingType"
description: "Specifies how DIAdem REPORT determines the vectors in a 3D axis system with the Vector display mode."
---

# IRepD3ShapeObjVectorSettingsInt.ScalingType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ScalingType for 3DVectorSettings

Specifies how DIAdem REPORT determines the vectors in a 3D axis system with the Vector display mode.
...
*Source: `ReportApi/properties/Report_property_ScalingType_IRepD3ShapeObjVectorSettingsInt.htm`*
