---
title: "IRepTable3DZValuesInt.Channel"
description: "Specifies the channel with the z-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DZValuesInt.Channel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Channel for 3DTableZValues

Specifies the channel with the z-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Channel_IRepTable3DZValuesInt.htm`*
