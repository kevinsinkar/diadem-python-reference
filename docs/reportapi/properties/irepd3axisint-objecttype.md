---
title: "IRepD3AxisInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepD3AxisInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for 3DAxisSystem
...
dd.MsgBoxDisp(oMy3DAxisSystem.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepD3AxisInt.htm`*
