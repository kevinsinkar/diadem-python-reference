---
title: "IRepD3AxisXInt.UseNumbersAutoPosition"
description: "Specifies whether DIAdem REPORT determines the x-scale label position automatically in a 3D axis system."
---

# IRepD3AxisXInt.UseNumbersAutoPosition

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseNumbersAutoPosition for 3DAxisX

Specifies whether DIAdem REPORT determines the x-scale label position automatically in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_UseNumbersAutoPosition_IRepD3AxisXInt.htm`*
