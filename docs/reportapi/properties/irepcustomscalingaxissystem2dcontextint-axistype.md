---
title: "IRepCustomScalingAxisSystem2DContextInt.AxisType"
description: "Specifies in a 2D axis system in DIAdem REPORT the type of axis to which you assign a user-defined axis scaling."
---

# IRepCustomScalingAxisSystem2DContextInt.AxisType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisType for CustomScalingAxisSystem2DContext

Specifies in a 2D axis system in DIAdem REPORT the type of axis to which you assign a user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_AxisType_IRepCustomScalingAxisSystem2DContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
