---
title: "IRepFrameSubObjInt.Type"
description: "Returns the subobject type of a rectangle in DIAdem REPORT when DIAdem calls the event assigned to the OnFrame for ToolTipEvents property. DIAdem calls this eve"
---

# IRepFrameSubObjInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for FrameSubObj

Returns the subobject type of a rectangle in DIAdem REPORT when DIAdem calls the event assigned to the OnFrame for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Type_IRepFrameSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
