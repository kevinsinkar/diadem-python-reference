...
description: "Specifies the name of the event which calculates a user-defined axis scaling in a 3D axis system in DIAdem REPORT. The associated user command receives a parame"
---

# IRepCustomScalingAxisSystem3DInt.EventName

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: EventName for AxisSystem3DCustomScaling

Specifies the name of the event which calculates a user-defined axis scaling in a 3D axis system in DIAdem REPORT. The associated user command receives a parameter. This parameter is a CustomScalingAxisSystem3DContext object and provides information about the axis system and about the ID of the user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_EventName_IRepCustomScalingAxisSystem3DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
