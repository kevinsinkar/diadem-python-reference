---
title: "IRepFormulaDisplayInt.FontColor"
description: "Specifies the font color of a formula graphic in DIAdem REPORT."
---

# IRepFormulaDisplayInt.FontColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: FontColor for FormulaDisplay

Specifies the font color of a formula graphic in DIAdem REPORT.

## Signature

```python
return_value = obj.FontColor
```
...
*Source: `ReportApi/properties/Report_property_FontColor_IRepFormulaDisplayInt.htm`*
