---
title: "IRepToolTipArrowContextInt.Arrow"
description: "Returns an arrow in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event if you press the shift"
---

# IRepToolTipArrowContextInt.Arrow

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Arrow for ToolTipArrowContext

Returns an arrow in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Arrow_IRepToolTipArrowContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
