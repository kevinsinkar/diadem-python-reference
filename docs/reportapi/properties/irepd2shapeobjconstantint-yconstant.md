---
title: "IRepD2ShapeObjConstantInt.YConstant"
description: "Specifies the y-channel of a curve in the Constant display mode in a 2D axis system in DIAdem REPORT."
---

# IRepD2ShapeObjConstantInt.YConstant

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YConstant for 2DConstant

Specifies the y-channel of a curve in the Constant display mode in a 2D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.YConstant
```
...
*Source: `ReportApi/properties/Report_property_YConstant_IRepD2ShapeObjConstantInt.htm`*
