---
title: "IRepD3ShapeObjVectorArrowHeadInt.Size"
description: "When DIAdem REPORT displays a 4D/6D vector, this variable specifies the length of the vector head as a percentage of the vector length."
---

# IRepD3ShapeObjVectorArrowHeadInt.Size

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Size for 3DVectorArrowHead

When DIAdem REPORT displays a 4D/6D vector, this variable specifies the length of the vector head as a percentage of the vector length.
...
*Source: `ReportApi/properties/Report_property_Size_IRepD3ShapeObjVectorArrowHeadInt.htm`*
