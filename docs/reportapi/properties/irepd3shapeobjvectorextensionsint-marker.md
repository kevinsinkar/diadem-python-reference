---
title: "IRepD3ShapeObjVectorExtensionsInt.Marker"
description: "Specifies the curve marker properties in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorExtensionsInt.Marker

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Marker for 3DVectorExtensions

Specifies the curve marker properties in the Vector display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Marker_IRepD3ShapeObjVectorExtensionsInt.htm`*
