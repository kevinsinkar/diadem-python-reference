---
title: "IRepLegendPositionInt.EntireWidth"
description: "Specifies the legend width as a percentage of the worksheet in an axis system in DIAdem REPORT."
---

# IRepLegendPositionInt.EntireWidth

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: EntireWidth for LegendPosition

Specifies the legend width as a percentage of the worksheet in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_EntireWidth_IRepLegendPositionInt.htm`*
