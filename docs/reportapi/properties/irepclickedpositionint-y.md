---
title: "IRepClickedPositionInt.Y"
description: "Specifies the y-cursor coordinates as page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ClickedWithKeyEvents prop"
---

# IRepClickedPositionInt.Y

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y for ClickedPositionInt

Specifies the y-cursor coordinates as page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ClickedWithKeyEvents property. DIAdem calls this event when you click a 2D axis system while pressing a key. For this event DIAdem does not support keys such as <Alt>, <Ctrl>, and <Shift>. Use the methods ConvertPageXPositionToXAxisValue and ConvertPageYPositionToYAxisValue to convert the page coordinates into coordinates of a 2D axis system.
...
*Source: `ReportApi/properties/Report_property_Y_IRepClickedPositionInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
