...
description: "Specifies the user command that DIAdem REPORT executes when you drag and drop an element onto a 2D table. The user command receives two parameters. The first pa"
---

# IRepReportOnDropInt.OnTable2D

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnTable2D for DropEvents

Specifies the user command that DIAdem REPORT executes when you drag and drop an element onto a 2D table. The user command receives two parameters. The first parameter corresponds to a 2DTableDropContext object and provides information about the 2D table onto which you dragged and dropped an object. The second parameter corresponds to a DropInformation object and provides information about the object which you dragged and dropped onto another object. DIAdem REPORT saves this property with the layout.
...
```python
dd.Report.Events.Drop.OnTable2D = "MyOnDrop2DTableEvent"
...
*Source: `ReportApi/properties/Report_property_OnTable2D_IRepReportOnDropInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
