---
title: "IRepPolarMarkerAdditionalInt.Size"
description: "Specifies the size of the marker symbols as a percentage of the worksheet in a polar curve in DIAdem REPORT."
---

# IRepPolarMarkerAdditionalInt.Size

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Size for PolarAdditionalMarker

Specifies the size of the marker symbols as a percentage of the worksheet in a polar curve in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Size_IRepPolarMarkerAdditionalInt.htm`*
