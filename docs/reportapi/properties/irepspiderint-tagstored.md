...
# IRepSpiderInt.TagStored

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagStored for Spider
...
*Source: `ReportApi/properties/Report_property_TagStored_IRepSpiderInt.htm`*
