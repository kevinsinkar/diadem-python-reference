---
title: "IRepSpiderSubObjInt.Name"
description: "Returns the subobject name of a spider axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem call"
---

# IRepSpiderSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for SpiderSubObj

Returns the subobject name of a spider axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepSpiderSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
