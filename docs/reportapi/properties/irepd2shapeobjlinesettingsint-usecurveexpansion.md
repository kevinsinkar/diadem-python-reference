---
title: "IRepD2ShapeObjLineSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Line display mode."
---

# IRepD2ShapeObjLineSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DLineSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Line display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjLineSettingsInt.htm`*
