---
title: "IRepCurvelegendContentColumnBaseInt.Text"
description: "Specifies the free text DIAdem REPORT uses for the legend labels of a curve."
---

# IRepCurvelegendContentColumnBaseInt.Text

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Text for CurveLegendColumnBase

Specifies the free text DIAdem REPORT uses for the legend labels of a curve.
...
*Source: `ReportApi/properties/Report_property_Text_IRepCurvelegendContentColumnBaseInt.htm`*
