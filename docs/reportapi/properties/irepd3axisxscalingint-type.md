---
title: "IRepD3AxisXScalingInt.Type"
description: "Specifies the type of x-axis scaling in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisXScalingInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for 3DAxisXScaling

Specifies the type of x-axis scaling in a 3D axis system in DIAdem REPORT.
...
oMyYScaling.Type = dd.e3DScalingLogarithmic
...
oMyZScaling.Type = dd.e3DScalingLinear
...
*Source: `ReportApi/properties/Report_property_Type_IRepD3AxisXScalingInt.htm`*
