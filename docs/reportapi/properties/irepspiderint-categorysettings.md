---
title: "IRepSpiderInt.CategorySettings"
description: "Specifies the settings of a category in a spider axis system in DIAdem REPORT."
---

# IRepSpiderInt.CategorySettings
...
```python
return_value = obj.CategorySettings
```
...
*Source: `ReportApi/properties/Report_property_CategorySettings_IRepSpiderInt.htm`*
