---
title: "IRepCurvelegendContentColumnBaseInt.RelativeWidth"
description: "Specifies the relative width of a legend label in relation to the other legend columns in an axis system in DIAdem REPORT."
---

# IRepCurvelegendContentColumnBaseInt.RelativeWidth

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: RelativeWidth for CurveLegendColumnBase

Specifies the relative width of a legend label in relation to the other legend columns in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_RelativeWidth_IRepCurvelegendContentColumnBaseInt.htm`*
