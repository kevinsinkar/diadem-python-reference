---
title: "IRepD3ShapeObjVectorExtensionsInt.CurveLine"
description: "Specifies the properties of the additional 3D curve in a 3D axis system with the Vector display mode in DIAdem REPORT."
---

# IRepD3ShapeObjVectorExtensionsInt.CurveLine

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CurveLine for 3DVectorExtensions

Specifies the properties of the additional 3D curve in a 3D axis system with the Vector display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.CurveLine
```
...
*Source: `ReportApi/properties/Report_property_CurveLine_IRepD3ShapeObjVectorExtensionsInt.htm`*
