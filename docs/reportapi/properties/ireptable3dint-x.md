---
title: "IRepTable3DInt.X"
description: "Specifies the properties of the column with the x-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DInt.X

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X for 3DTable

Specifies the properties of the column with the x-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_X_IRepTable3DInt.htm`*
