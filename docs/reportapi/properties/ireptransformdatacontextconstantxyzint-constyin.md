---
title: "IRepTransformDataContextConstantXYZInt.ConstYIn"
description: "Specifies the values of the y-input constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextConstantXYZInt.ConstYIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstYIn for TransformDataContextConstantXYZ

Specifies the values of the y-input constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstYIn_IRepTransformDataContextConstantXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
