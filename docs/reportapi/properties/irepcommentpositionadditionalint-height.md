---
title: "IRepCommentPositionAdditionalInt.Height"
description: "Specifies the comment height as a percentage of the worksheet in cm or inches in the Coordinate display mode of an axis system in DIAdem-REPORT."
---

# IRepCommentPositionAdditionalInt.Height

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Height for AdditionalCommentPosition

Specifies the comment height as a percentage of the worksheet in cm or inches in the Coordinate display mode of an axis system in DIAdem-REPORT.
...
*Source: `ReportApi/properties/Report_property_Height_IRepCommentPositionAdditionalInt.htm`*
