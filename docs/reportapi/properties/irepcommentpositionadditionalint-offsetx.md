---
title: "IRepCommentPositionAdditionalInt.OffsetX"
description: "Specifies in DIAdem REPORT the horizontal distance, in centimeters or inches, between the comment in the Coordinate 2D display mode and the origin of the axis s"
---

# IRepCommentPositionAdditionalInt.OffsetX

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OffsetX for AdditionalCommentPosition

Specifies in DIAdem REPORT the horizontal distance, in centimeters or inches, between the comment in the Coordinate 2D display mode and the origin of the axis system, as a percentage of the worksheet.
...
*Source: `ReportApi/properties/Report_property_OffsetX_IRepCommentPositionAdditionalInt.htm`*
