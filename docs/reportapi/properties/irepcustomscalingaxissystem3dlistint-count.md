---
title: "IRepCustomScalingAxisSystem3DListInt.Count"
description: "Returns the number of user-defined axis scalings in a 3D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DListInt.Count

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Count for AxisSystem3DCustomScalings

Returns the number of user-defined axis scalings in a 3D axis system in DIAdem REPORT.
...
MsgBoxDisp("Number of custom axis scalings: " + oMyCustomScalings.Count)
...
*Source: `ReportApi/properties/Report_property_Count_IRepCustomScalingAxisSystem3DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
