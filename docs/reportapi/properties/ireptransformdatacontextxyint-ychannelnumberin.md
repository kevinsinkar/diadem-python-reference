---
title: "IRepTransformDataContextXYInt.YChannelNumberIn"
description: "Specifies the number of the y-input channel for the Curve Transformation of a curve, whose data originates from an x-channel and a y-channel, in a 2D axis syste"
---

# IRepTransformDataContextXYInt.YChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberIn for TransformDataContextXY

Specifies the number of the y-input channel for the Curve Transformation of a curve, whose data originates from an x-channel and a y-channel, in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannelNumberIn_IRepTransformDataContextXYInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
