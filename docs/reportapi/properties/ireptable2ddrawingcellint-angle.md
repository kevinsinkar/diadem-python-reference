---
title: "IRepTable2DDrawingCellInt.Angle"
description: "Specifies the text angle of the cell DIAdem is plotting in a 2D table in DIAdem REPORT."
---

# IRepTable2DDrawingCellInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for 2DTableDrawingCell

Specifies the text angle of the cell DIAdem is plotting in a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepTable2DDrawingCellInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
