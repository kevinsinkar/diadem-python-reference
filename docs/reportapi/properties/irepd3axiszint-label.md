---
title: "IRepD3AxisZInt.Label"
description: "Specifies the label of the z-axis in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisZInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for 3DAxisZ

Specifies the label of the z-axis in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepD3AxisZInt.htm`*
