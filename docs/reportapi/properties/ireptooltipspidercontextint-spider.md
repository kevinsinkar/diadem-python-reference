---
title: "IRepToolTipSpiderContextInt.Spider"
description: "Returns a spider axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls this event if you pr"
---

# IRepToolTipSpiderContextInt.Spider

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Spider for ToolTipSpiderContext

Returns a spider axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.

## Signature

```python
return_value = obj.Spider
```
...
*Source: `ReportApi/properties/Report_property_Spider_IRepToolTipSpiderContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
