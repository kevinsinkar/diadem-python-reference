---
title: "IRepTable3DXValuesInt.Angle"
description: "Specifies the text angle of the x-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DXValuesInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for 3DTableXValues

Specifies the text angle of the x-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepTable3DXValuesInt.htm`*
