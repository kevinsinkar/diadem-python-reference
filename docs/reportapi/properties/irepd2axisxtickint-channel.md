---
title: "IRepD2AxisXTickInt.Channel"
description: "Specifies the tick channel for the x-axis scaling of a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisXTickInt.Channel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Channel for 2DAxisXTick

Specifies the tick channel for the x-axis scaling of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Channel_IRepD2AxisXTickInt.htm`*
