---
title: "IRepD2AxisXScalingInt.End"
description: "Specifies the value up to which DIAdem REPORT displays the x-axis of a 2D axis system."
---

# IRepD2AxisXScalingInt.End

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: End for 2DAxisXScaling

Specifies the value up to which DIAdem REPORT displays the x-axis of a 2D axis system.
...
*Source: `ReportApi/properties/Report_property_End_IRepD2AxisXScalingInt.htm`*
