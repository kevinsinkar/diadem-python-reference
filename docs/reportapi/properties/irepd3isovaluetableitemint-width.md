---
title: "IRepD3IsoValueTableItemInt.Width"
description: "Specifies the line width of an isoline in the contour table in the 3D display mode Characteristic diagram in DIAdem REPORT."
---

# IRepD3IsoValueTableItemInt.Width

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Width for 3DIsoValueTableItem

Specifies the line width of an isoline in the contour table in the 3D display mode Characteristic diagram in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Width_IRepD3IsoValueTableItemInt.htm`*
