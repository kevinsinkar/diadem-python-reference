---
title: "IRepD2BackgroundImageScalingInt.YBegin"
description: "Specifies the first value in y-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT."
---

# IRepD2BackgroundImageScalingInt.YBegin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YBegin for 2DBackgroundImageScaling

Specifies the first value in y-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YBegin_IRepD2BackgroundImageScalingInt.htm`*
