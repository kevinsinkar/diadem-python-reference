---
title: "IRepImageSubObjInt.Type"
description: "Returns the subobject type of a graphic in DIAdem REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event"
---

# IRepImageSubObjInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for ImageSubObj

Returns the subobject type of a graphic in DIAdem REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Type_IRepImageSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
