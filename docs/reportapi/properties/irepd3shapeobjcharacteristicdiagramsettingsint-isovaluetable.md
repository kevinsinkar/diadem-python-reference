---
title: "IRepD3ShapeObjCharacteristicDiagramSettingsInt.IsoValueTable"
description: "Returns a collection of all isolines in the contour table for the 3D display mode Characteristic diagram in DIAdem REPORT."
---

# IRepD3ShapeObjCharacteristicDiagramSettingsInt.IsoValueTable

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: IsoValueTable for 3DCharacteristicDiagramSettings

Returns a collection of all isolines in the contour table for the 3D display mode Characteristic diagram in DIAdem REPORT.

## Signature

```python
return_value = obj.IsoValueTable
```
...
*Source: `ReportApi/properties/Report_property_IsoValueTable_IRepD3ShapeObjCharacteristicDiagramSettingsInt.htm`*
