---
title: "IRepD2ShapeObjCoordinateInt.YCoordinate"
description: "Specifies the y-channel of a curve in the Coordinate display mode in a 2D axis system in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateInt.YCoordinate

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YCoordinate for 2DCoordinate

Specifies the y-channel of a curve in the Coordinate display mode in a 2D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.YCoordinate
```
...
*Source: `ReportApi/properties/Report_property_YCoordinate_IRepD2ShapeObjCoordinateInt.htm`*
