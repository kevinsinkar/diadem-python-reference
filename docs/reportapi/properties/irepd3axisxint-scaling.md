---
title: "IRepD3AxisXInt.Scaling"
description: "Specifies the scaling of the x-axis in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisXInt.Scaling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Scaling for 3DAxisX

Specifies the scaling of the x-axis in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Scaling_IRepD3AxisXInt.htm`*
