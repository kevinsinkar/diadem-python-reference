---
title: "IRepPolarInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepPolarInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for PolarSystem
...
dd.MsgBoxDisp(oMyPolarSystem.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepPolarInt.htm`*
