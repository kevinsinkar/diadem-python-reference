---
title: "IRepD2ShapeObjCoordinateSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Coordinate display mode. The position of a channel-bound coordinate ref"
---

# IRepD2ShapeObjCoordinateSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DCoordinateSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Coordinate display mode. The position of a channel-bound coordinate refers to the expanded channels.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjCoordinateSettingsInt.htm`*
