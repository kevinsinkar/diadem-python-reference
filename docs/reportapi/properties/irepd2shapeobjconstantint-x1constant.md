---
title: "IRepD2ShapeObjConstantInt.X1Constant"
description: "Specifies the x1-constant of a 2D axis system in the Constant display mode in DIAdem REPORT."
---

# IRepD2ShapeObjConstantInt.X1Constant

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X1Constant for 2DConstant

Specifies the x1-constant of a 2D axis system in the Constant display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.X1Constant
```
...
*Source: `ReportApi/properties/Report_property_X1Constant_IRepD2ShapeObjConstantInt.htm`*
