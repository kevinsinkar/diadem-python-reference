---
title: "IRepD2TableSubObjInt.Name"
description: "Returns the name of the subobject of a 2D table in DIAdem REPORT when DIAdem calls the event associated with the OnTable2D for ToolTipEvents property. DIAdem ca"
---

# IRepD2TableSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for D2TableSubObj

Returns the name of the subobject of a 2D table in DIAdem REPORT when DIAdem calls the event associated with the OnTable2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepD2TableSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
