---
title: "IRepCustomScalingAxisSystem2DScaledListInt.Count"
description: "Returns the number of user-defined axis scalings in a 2D axis system in DIAdem REPORT in a scaled display."
---

# IRepCustomScalingAxisSystem2DScaledListInt.Count

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Count for AxisSystem2DScaledCustomScalings

Returns the number of user-defined axis scalings in a 2D axis system in DIAdem REPORT in a scaled display.
...
MsgBoxDisp("Number of Custom Scalings: " + oMyCustomScalings.Count)
...
*Source: `ReportApi/properties/Report_property_Count_IRepCustomScalingAxisSystem2DScaledListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
