---
title: "IRepTable3DXValuesInt.Channel"
description: "Specifies the channel with the x-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DXValuesInt.Channel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Channel for 3DTableXValues

Specifies the channel with the x-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Channel_IRepTable3DXValuesInt.htm`*
