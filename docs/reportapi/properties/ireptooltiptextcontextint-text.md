---
title: "IRepToolTipTextContextInt.Text"
description: "Returns a text in DIAdem REPORT when DIAdem calls the event assigned to the OnText for ToolTipEvents property. DIAdem calls this event if you press the shift ke"
---

# IRepToolTipTextContextInt.Text

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Text for ToolTipTextContext

Returns a text in DIAdem REPORT when DIAdem calls the event assigned to the OnText for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Text_IRepToolTipTextContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
