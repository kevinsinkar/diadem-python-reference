---
title: "IRepToolTip2DAxisContextInt.Sheet"
description: "Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press"
---

# IRepToolTip2DAxisContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for ToolTip2DAxisContext

Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepToolTip2DAxisContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
