---
title: "IRepPolarAxisSystemClickedWithKeyContextInt.Position"
description: "Specifies the cursor position in page coordinates in DIAdem REPORT when you call the event you assigned to the OnAxisSystemPolar for ClickedWithKeyEvents proper"
---

# IRepPolarAxisSystemClickedWithKeyContextInt.Position

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Position for PolarAxisSystemClickedWithKeyContext

Specifies the cursor position in page coordinates in DIAdem REPORT when you call the event you assigned to the OnAxisSystemPolar for ClickedWithKeyEvents property. DIAdem calls this event when you click a polar axis system while pressing a key. For this event DIAdem does not support keys such as <Alt>, <Ctrl>, and <Shift>. Use the methods ConvertPageXPositionToXAxisValue , and ConvertPageYPositionToYAxisValue to convert the page coordinates of a polar axis system.
...
*Source: `ReportApi/properties/Report_property_Position_IRepPolarAxisSystemClickedWithKeyContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
