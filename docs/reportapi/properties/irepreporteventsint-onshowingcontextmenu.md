---
title: "IRepReportEventsInt.OnShowingContextMenu"
description: "Specifies the name of the user command that DIAdem executes when you open a context menu in DIAdem REPORT."
---

# IRepReportEventsInt.OnShowingContextMenu

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnShowingContextMenu for Events

Specifies the name of the user command that DIAdem executes when you open a context menu in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_OnShowingContextMenu_IRepReportEventsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
