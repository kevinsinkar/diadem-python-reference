---
title: "IRepExpansionMarkerInt.RepetitionMode"
description: "Specifies how DIAdem specifies the frequency of the curve markers of expanding curves in DIAdem REPORT."
---

# IRepExpansionMarkerInt.RepetitionMode

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: RepetitionMode for CurveExpansionMarker

Specifies how DIAdem specifies the frequency of the curve markers of expanding curves in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_RepetitionMode_IRepExpansionMarkerInt.htm`*
