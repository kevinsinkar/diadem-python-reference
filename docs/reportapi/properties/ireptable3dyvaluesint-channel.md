---
title: "IRepTable3DYValuesInt.Channel"
description: "Specifies the channel with the y-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DYValuesInt.Channel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Channel for 3DTableYValues

Specifies the channel with the y-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Channel_IRepTable3DYValuesInt.htm`*
