...
!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnInitializeSheetRefresh for Events
...
*Source: `ReportApi/properties/Report_property_OnInitializeSheetRefresh_IRepReportEventsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
