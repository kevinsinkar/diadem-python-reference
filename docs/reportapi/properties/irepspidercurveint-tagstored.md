---
title: "IRepSpiderCurveInt.TagStored"
...
# IRepSpiderCurveInt.TagStored

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagStored for SpiderCurve
...
for oMyReportObj in oMyReportObjects:
    if oMyReportObj.ObjectType == dd.eReportObjectSpider :
        for oMyReportSubObj in oMyReportObj.CurvesSpider:
...
*Source: `ReportApi/properties/Report_property_TagStored_IRepSpiderCurveInt.htm`*
