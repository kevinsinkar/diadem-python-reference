---
title: "IRepD3IsoValueTableItemInt.LineType"
description: "Specifies the line style of an isoline from the contour table in the Characteristic diagram display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3IsoValueTableItemInt.LineType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: LineType for 3DIsoValueTableItem

Specifies the line style of an isoline from the contour table in the Characteristic diagram display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_LineType_IRepD3IsoValueTableItemInt.htm`*
