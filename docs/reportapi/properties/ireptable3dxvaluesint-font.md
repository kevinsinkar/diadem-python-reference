---
title: "IRepTable3DXValuesInt.Font"
description: "Specifies the font of the x-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DXValuesInt.Font

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Font for 3DTableXValues

Specifies the font of the x-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Font_IRepTable3DXValuesInt.htm`*
