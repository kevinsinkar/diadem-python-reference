---
title: "IRepCustomScalingAxisSystem3DInt.Index"
description: "Specifies the index of a user-defined axis scaling in the list of user-defined axis scalings in a 3D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DInt.Index

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Index for AxisSystem3DCustomScaling

Specifies the index of a user-defined axis scaling in the list of user-defined axis scalings in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Index_IRepCustomScalingAxisSystem3DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
