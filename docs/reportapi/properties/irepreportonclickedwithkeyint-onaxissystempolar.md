...
description: "Specifies the user command which DIAdem REPORT triggers when you click a polar axis system while pressing a key. The user command receives a parameter. The para"
---

# IRepReportOnClickedWithKeyInt.OnAxisSystemPolar

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnAxisSystemPolar for ClickedWithKeyEvents

Specifies the user command which DIAdem REPORT triggers when you click a polar axis system while pressing a key. The user command receives a parameter. The parameter corresponds with a PolarAxisSystemClickedWithKeyContext object and provides information about the polar axis system which you clicked while you pressed a key. For this event DIAdem does not support keys such as <Alt>, <Ctrl>, and <Shift>. Use the methods ConvertPageXYPositionToAngle and ConvertPageXYPositionToLength to convert the page coordinates of a polar axis system.
...
*Source: `ReportApi/properties/Report_property_OnAxisSystemPolar_IRepReportOnClickedWithKeyInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
