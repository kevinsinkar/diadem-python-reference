---
title: "IRepTransformDataContextXYX1Y1Int.YChannelNumberOut"
description: "Specifies the number of the y-output channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYX1Y1Int.YChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberOut for TransformDataContextXYX1Y1

Specifies the number of the y-output channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannelNumberOut_IRepTransformDataContextXYX1Y1Int.htm`*
