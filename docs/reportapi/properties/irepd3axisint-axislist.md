---
title: "IRepD3AxisInt.AxisList"
description: "Specifies the axes in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisInt.AxisList

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisList for 3DAxisSystem

Specifies the axes in a 3D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.AxisList
```
...
*Source: `ReportApi/properties/Report_property_AxisList_IRepD3AxisInt.htm`*
