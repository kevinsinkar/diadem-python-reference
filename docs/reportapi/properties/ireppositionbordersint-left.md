---
title: "IRepPositionBordersInt.Left"
description: "Specifies, in DIAdem REPORT, the distance from the left edge of an object to the left edge of the worksheet as a percentage of the page area, in cm, or in inch,"
---

# IRepPositionBordersInt.Left

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Left for ObjectPositionDefinedByBorders

Specifies, in DIAdem REPORT, the distance from the left edge of an object to the left edge of the worksheet as a percentage of the page area, in cm, or in inch, if you use margins to position the object. Because you can use either the Bottom , Height , Left , Right , Top , and Width for the ObjectPositionDefinedByBorders property, or the Height , Width , X1 , X2 , Y1 , and Y2 for the ObjectPositionDefinedByCoordinates property to specify the position, these properties impact each other and the value of the property set first can be modified by another property.
...
*Source: `ReportApi/properties/Report_property_Left_IRepPositionBordersInt.htm`*
