---
title: "IRepD3CurveTransformingContextInt.Sheet"
description: "Specifies the worksheet for the curve transformation in a 3D axis system in DIAdem REPORT."
---

# IRepD3CurveTransformingContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for D3CurveTransformingContext

Specifies the worksheet for the curve transformation in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepD3CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
