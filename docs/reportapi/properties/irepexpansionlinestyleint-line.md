---
title: "IRepExpansionLineStyleInt.Line"
description: "Specifies the line properties of an expanding curve in a 2D axis system in DIAdem REPORT."
---

# IRepExpansionLineStyleInt.Line

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Line for ExpansionLineStyle

Specifies the line properties of an expanding curve in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Line_IRepExpansionLineStyleInt.htm`*
