---
title: "IRepExpansionMarkerInt.UseMarkerAtBegin"
description: "Specifies whether DIAdem REPORT plots a marker at the beginning of expanding curves."
---

# IRepExpansionMarkerInt.UseMarkerAtBegin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseMarkerAtBegin for CurveExpansionMarker

Specifies whether DIAdem REPORT plots a marker at the beginning of expanding curves.

## Signature

```python
obj.UseMarkerAtBegin
```
...
*Source: `ReportApi/properties/Report_property_UseMarkerAtBegin_IRepExpansionMarkerInt.htm`*
