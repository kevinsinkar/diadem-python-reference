---
title: "IRepD3AxisXScalingInt.End"
description: "Specifies the value up to which DIAdem REPORT displays the x-axis of a 3D axis system. DIAdem REPORT only includes the End property if you assign the value eAxi"
---

# IRepD3AxisXScalingInt.End

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: End for 3DAxisXScaling

Specifies the value up to which DIAdem REPORT displays the x-axis of a 3D axis system. DIAdem REPORT only includes the End property if you assign the value eAxisScalingSimpleManual to the AutoScalingType property.
...
*Source: `ReportApi/properties/Report_property_End_IRepD3AxisXScalingInt.htm`*
