---
title: "IRepD3IsoValueTableItemInt.Interval"
description: "Specifies the line interval for broken isolines in the contour table for the 3D display mode Characteristic diagram in DIAdem REPORT. Greater values mean greate"
---

# IRepD3IsoValueTableItemInt.Interval

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Interval for 3DIsoValueTableItem

Specifies the line interval for broken isolines in the contour table for the 3D display mode Characteristic diagram in DIAdem REPORT. Greater values mean greater intervals.
...
*Source: `ReportApi/properties/Report_property_Interval_IRepD3IsoValueTableItemInt.htm`*
