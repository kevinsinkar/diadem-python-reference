---
title: "IRepCustomScalingAxisSystem3DContextInt.Sheet"
description: "Returns in a 3D axis system in DIAdem REPORT the worksheet for which you use a user-defined axis scaling."
---

# IRepCustomScalingAxisSystem3DContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for CustomScalingAxisSystem3DContext

Returns in a 3D axis system in DIAdem REPORT the worksheet for which you use a user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepCustomScalingAxisSystem3DContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
