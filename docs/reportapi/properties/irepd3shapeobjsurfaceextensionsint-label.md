---
title: "IRepD3ShapeObjSurfaceExtensionsInt.Label"
description: "Specifies the curve labels in the Surface display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjSurfaceExtensionsInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for 3DSurfaceExtensions

Specifies the curve labels in the Surface display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepD3ShapeObjSurfaceExtensionsInt.htm`*
