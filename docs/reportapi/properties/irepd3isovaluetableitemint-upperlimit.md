---
title: "IRepD3IsoValueTableItemInt.UpperLimit"
description: "Specifies the upper limit of an isoline in the contour table for the 3D display mode Characteristic diagram in DIAdem REPORT."
---

# IRepD3IsoValueTableItemInt.UpperLimit

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UpperLimit for 3DIsoValueTableItem

Specifies the upper limit of an isoline in the contour table for the 3D display mode Characteristic diagram in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_UpperLimit_IRepD3IsoValueTableItemInt.htm`*
