---
title: "IRepD3AxisZScalingInt.MiniTickCount"
description: "Specifies the number of miniticks between the scale ticks on the z-axis of a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisZScalingInt.MiniTickCount

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MiniTickCount for 3DAxisZScaling

Specifies the number of miniticks between the scale ticks on the z-axis of a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_MiniTickCount_IRepD3AxisZScalingInt.htm`*
