---
title: "IRepD3MarkerAdditionalInt.Type"
description: "Specifies the marker type of a 3D axis system in DIAdem REPORT."
---

# IRepD3MarkerAdditionalInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for 3DAdditionalMarker

Specifies the marker type of a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Type_IRepD3MarkerAdditionalInt.htm`*
