---
title: "IRepCustomScalingAxisSystem3DInt.Label"
description: "Specifies the label for a user-defined axis scaling on the Axis Parameters tab in the 3D Axis Definition dialog box in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for AxisSystem3DCustomScaling

Specifies the label for a user-defined axis scaling on the Axis Parameters tab in the 3D Axis Definition dialog box in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepCustomScalingAxisSystem3DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
