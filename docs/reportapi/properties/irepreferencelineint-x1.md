---
title: "IRepReferenceLineInt.X1"
description: "Specifies the first x-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system."
---

# IRepReferenceLineInt.X1

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X1 for ReferenceLine

Specifies the first x-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_X1_IRepReferenceLineInt.htm`*
