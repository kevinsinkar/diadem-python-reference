---
title: "IRepD2ShapeObjDifferentialSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Differential display mode."
---

# IRepD2ShapeObjDifferentialSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DDifferentialSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Differential display mode.
...
oMyShape.YChannelDifferential.Reference = "Temp_B"
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjDifferentialSettingsInt.htm`*
