---
title: "IRepD2ShapeObjBarsHorizontalSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Horizontal bars display mode."
---

# IRepD2ShapeObjBarsHorizontalSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DBarsHorizontalSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Horizontal bars display mode.
...
oMyShape.XChannel.Reference = "Temp_A"
oMyShape.YChannel.Reference = ""
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjBarsHorizontalSettingsInt.htm`*
