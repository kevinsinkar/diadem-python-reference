---
title: "IRepColorLegendHeaderInt.Angle"
description: "Specifies the angle in degrees at which DIAdem REPORT displays the title of a color legend of a 2D axis system."
---

# IRepColorLegendHeaderInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for ColorLegendHeader

Specifies the angle in degrees at which DIAdem REPORT displays the title of a color legend of a 2D axis system.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepColorLegendHeaderInt.htm`*
