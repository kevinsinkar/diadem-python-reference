---
title: "IRepTransformDataContextXYZInt.YChannelNumberIn"
description: "Specifies the number of the y-input channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spi"
---

# IRepTransformDataContextXYZInt.YChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberIn for TransformDataContextXYZ

Specifies the number of the y-input channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spikes , or Points , in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannelNumberIn_IRepTransformDataContextXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
