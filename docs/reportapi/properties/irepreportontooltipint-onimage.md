...
description: "Specifies the user command which DIAdem REPORT executes when you press the shift key and move the mouse over an image. The user command receives two parameters."
---

# IRepReportOnToolTipInt.OnImage

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnImage for ToolTipEvents

Specifies the user command which DIAdem REPORT executes when you press the shift key and move the mouse over an image. The user command receives two parameters. The first parameter corresponds to a ToolTipImageContext object and provides information about the image in DIAdem REPORT. The second parameter is a text and corresponds with the tooltip for display.
...
*Source: `ReportApi/properties/Report_property_OnImage_IRepReportOnToolTipInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
