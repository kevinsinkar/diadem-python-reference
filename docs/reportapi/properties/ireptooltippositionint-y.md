---
title: "IRepToolTipPositionInt.Y"
description: "Returns the y-cursor coordinates as page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIA"
---

# IRepToolTipPositionInt.Y

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y for ToolTipPositionInt

Returns the y-cursor coordinates as page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object. Use the methods ConvertPageXPositionToXAxisValue and ConvertPageYPositionToYAxisValue to convert the page coordinates into coordinates of a 2D axis system.
...
*Source: `ReportApi/properties/Report_property_Y_IRepToolTipPositionInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
