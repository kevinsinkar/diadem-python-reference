---
title: "IRepD2AxisYScalingInt.Tick"
description: "Specifies the properties of the y-axis ticks in a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisYScalingInt.Tick

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Tick for 2DAxisYScaling

Specifies the properties of the y-axis ticks in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Tick_IRepD2AxisYScalingInt.htm`*
