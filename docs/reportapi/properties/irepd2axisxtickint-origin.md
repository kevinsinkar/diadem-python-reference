---
title: "IRepD2AxisXTickInt.Origin"
description: "Specifies the x-value where DIAdem REPORT plots the first tick when you scale 2D axes manually."
---

# IRepD2AxisXTickInt.Origin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Origin for 2DAxisXTick

Specifies the x-value where DIAdem REPORT plots the first tick when you scale 2D axes manually.
...
*Source: `ReportApi/properties/Report_property_Origin_IRepD2AxisXTickInt.htm`*
