---
title: "IRepD2ShapeObjConstantInt.XConstant"
description: "Specifies the x-channel of a curve in the Constant display mode in a 2D axis system in DIAdem REPORT."
---

# IRepD2ShapeObjConstantInt.XConstant

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XConstant for 2DConstant

Specifies the x-channel of a curve in the Constant display mode in a 2D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.XConstant
```
...
*Source: `ReportApi/properties/Report_property_XConstant_IRepD2ShapeObjConstantInt.htm`*
