...
description: "Specifies the user command which DIAdem REPORT executes when you press the shift key and move the mouse over a 2D axis system. The user command receives two par"
---

# IRepReportOnToolTipInt.OnAxisSystem2D

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnAxisSystem2D for ToolTipEvents

Specifies the user command which DIAdem REPORT executes when you press the shift key and move the mouse over a 2D axis system. The user command receives two parameters. The parameter corresponds to a ToolTip2DAxisContext object and provides the information about the 2D axis system in DIAdem REPORT. The second parameter is a text and corresponds with the tooltip for display.
...
*Source: `ReportApi/properties/Report_property_OnAxisSystem2D_IRepReportOnToolTipInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
