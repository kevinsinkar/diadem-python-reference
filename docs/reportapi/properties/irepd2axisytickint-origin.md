---
title: "IRepD2AxisYTickInt.Origin"
description: "Specifies the y-value where DIAdem REPORT plots the first tick when you scale 2D axes manually."
---

# IRepD2AxisYTickInt.Origin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Origin for 2DAxisYTick

Specifies the y-value where DIAdem REPORT plots the first tick when you scale 2D axes manually.
...
*Source: `ReportApi/properties/Report_property_Origin_IRepD2AxisYTickInt.htm`*
