---
title: "IRepPolarSubObjInt.Name"
description: "Returns the name of the subobject of a polar axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnPolarSystem for ToolTipEvents property. "
---

# IRepPolarSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for PolarSubObj

Returns the name of the subobject of a polar axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnPolarSystem for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepPolarSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
