---
title: "IRepD3ShapeObjCoordinateSettingsInt.MarkerLine"
description: "Specifies the marker line properties of a curve in the Coordinate display mode in DIAdem REPORT."
---

# IRepD3ShapeObjCoordinateSettingsInt.MarkerLine

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MarkerLine for 3DCoordinateSettings

Specifies the marker line properties of a curve in the Coordinate display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.MarkerLine
```
...
*Source: `ReportApi/properties/Report_property_MarkerLine_IRepD3ShapeObjCoordinateSettingsInt.htm`*
