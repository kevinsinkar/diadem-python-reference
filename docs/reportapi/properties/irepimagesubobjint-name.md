---
title: "IRepImageSubObjInt.Name"
description: "Returns the name of the subobject of a graphic in REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event"
---

# IRepImageSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for ImageSubObj

Returns the name of the subobject of a graphic in REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepImageSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
