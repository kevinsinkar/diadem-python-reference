---
title: "IRepToolTip2DAxisContextInt.AxisSystem2D"
description: "Returns a 2D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you "
---

# IRepToolTip2DAxisContextInt.AxisSystem2D

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem2D for ToolTip2DAxisContext

Returns a 2D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_AxisSystem2D_IRepToolTip2DAxisContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
