---
title: "IRepTable2DSettingsInt.IndexSettings"
description: "Specifies the scaling of a 2D table in DIAdem REPORT."
---

# IRepTable2DSettingsInt.IndexSettings

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: IndexSettings for 2DTableSettings

Specifies the scaling of a 2D table in DIAdem REPORT.

## Signature

```python
return_value = obj.IndexSettings
```
...
*Source: `ReportApi/properties/Report_property_IndexSettings_IRepTable2DSettingsInt.htm`*
