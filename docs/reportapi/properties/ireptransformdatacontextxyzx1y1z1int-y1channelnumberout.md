---
title: "IRepTransformDataContextXYZX1Y1Z1Int.Y1ChannelNumberOut"
description: "Specifies the number of the y1-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.Y1ChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1ChannelNumberOut for TransformDataContextXYZX1Y1Z1

Specifies the number of the y1-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Y1ChannelNumberOut_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
