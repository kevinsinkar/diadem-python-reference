---
title: "IRepTransformDataContextXYY1Int.Y1ChannelNumberOut"
description: "Specifies the number of the y1-output channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel"
---

# IRepTransformDataContextXYY1Int.Y1ChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1ChannelNumberOut for TransformDataContextXYY1

Specifies the number of the y1-output channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel, in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Y1ChannelNumberOut_IRepTransformDataContextXYY1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
