---
title: "IRepD3AxisZScalingInt.Begin"
description: "Specifies the value from which DIAdem REPORT starts displaying the z-axis of a 3D axis system."
---

# IRepD3AxisZScalingInt.Begin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Begin for 3DAxisZScaling

Specifies the value from which DIAdem REPORT starts displaying the z-axis of a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_Begin_IRepD3AxisZScalingInt.htm`*
