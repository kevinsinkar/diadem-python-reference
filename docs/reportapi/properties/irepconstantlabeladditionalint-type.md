---
title: "IRepConstantLabelAdditionalInt.Type"
description: "Specifies the type of curve end labels in a 2D axis system in the Constant display mode in DIAdem REPORT."
---

# IRepConstantLabelAdditionalInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for AdditionalConstantLabel

Specifies the type of curve end labels in a 2D axis system in the Constant display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Type_IRepConstantLabelAdditionalInt.htm`*
