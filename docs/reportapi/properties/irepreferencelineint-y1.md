---
title: "IRepReferenceLineInt.Y1"
description: "Specifies the first y-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system."
---

# IRepReferenceLineInt.Y1

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1 for ReferenceLine

Specifies the first y-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_Y1_IRepReferenceLineInt.htm`*
