---
title: "IRepD3AxisZScalingInt.Origin"
description: "Specifies the value at which the z-axis of a 3D axis system in DIAdem REPORT intersects the perpendicular xy-plane"
---

# IRepD3AxisZScalingInt.Origin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Origin for 3DAxisZScaling

Specifies the value at which the z-axis of a 3D axis system in DIAdem REPORT intersects the perpendicular xy-plane
...
*Source: `ReportApi/properties/Report_property_Origin_IRepD3AxisZScalingInt.htm`*
