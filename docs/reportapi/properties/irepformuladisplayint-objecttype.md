---
title: "IRepFormulaDisplayInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepFormulaDisplayInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for FormulaDisplay
...
dd.MsgBoxDisp(oMyFormulaDisplay.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepFormulaDisplayInt.htm`*
