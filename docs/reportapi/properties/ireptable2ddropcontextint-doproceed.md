---
title: "IRepTable2DDropContextInt.DoProceed"
description: "Specifies whether DIAdem transfers the 2DTableDropContext object to subsequent events. If the value is TRUE , DIAdem also transfers the 2DTableDropContext objec"
---

# IRepTable2DDropContextInt.DoProceed

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DoProceed for 2DTableDropContext

Specifies whether DIAdem transfers the 2DTableDropContext object to subsequent events. If the value is TRUE , DIAdem also transfers the 2DTableDropContext object to the following events. Do not set the DoProceed property to TRUE if you change the number of columns in the associated event or if you execute similar operations.
...
*Source: `ReportApi/properties/Report_property_DoProceed_IRepTable2DDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
