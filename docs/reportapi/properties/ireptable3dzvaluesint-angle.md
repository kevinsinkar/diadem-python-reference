---
title: "IRepTable3DZValuesInt.Angle"
description: "Specifies the text angle of the z-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DZValuesInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for 3DTableZValues

Specifies the text angle of the z-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepTable3DZValuesInt.htm`*
