---
title: "IRepArrowSubObjInt.Name"
description: "Returns the name of the subobject of an arrow in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this"
---

# IRepArrowSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for ArrowSubObj

Returns the name of the subobject of an arrow in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepArrowSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
