---
title: "IRepCommentPositionAdditionalInt.Width"
description: "Specifies the comment width as a percentage of the worksheet, in cm or inches, in the Coordinate display mode in DIAdem-REPORT."
---

# IRepCommentPositionAdditionalInt.Width

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Width for AdditionalCommentPosition

Specifies the comment width as a percentage of the worksheet, in cm or inches, in the Coordinate display mode in DIAdem-REPORT.
...
*Source: `ReportApi/properties/Report_property_Width_IRepCommentPositionAdditionalInt.htm`*
