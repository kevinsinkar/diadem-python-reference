---
title: "IRepTable2DDrawingCellContextInt.Col"
description: "Specifies the column number of the cell DIAdem is plotting in a 2D table in DIAdem REPORT."
---

# IRepTable2DDrawingCellContextInt.Col

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Col for 2DTableDrawingCellContext

Specifies the column number of the cell DIAdem is plotting in a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Col_IRepTable2DDrawingCellContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
