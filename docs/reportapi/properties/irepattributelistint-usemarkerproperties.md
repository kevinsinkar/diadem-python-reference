---
title: "IRepAttributeListInt.UseMarkerProperties"
description: "Specifies whether DIAdem REPORT displays expanding curves with the marker properties specified in the attribute list."
---

# IRepAttributeListInt.UseMarkerProperties

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseMarkerProperties for AttributeList

Specifies whether DIAdem REPORT displays expanding curves with the marker properties specified in the attribute list.

## Signature

```python
obj.UseMarkerProperties
```
...
*Source: `ReportApi/properties/Report_property_UseMarkerProperties_IRepAttributeListInt.htm`*
