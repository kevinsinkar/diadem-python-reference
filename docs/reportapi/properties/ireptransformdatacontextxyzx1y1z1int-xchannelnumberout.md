---
title: "IRepTransformDataContextXYZX1Y1Z1Int.XChannelNumberOut"
description: "Specifies the number of the x-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.XChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberOut for TransformDataContextXYZX1Y1Z1

Specifies the number of the x-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannelNumberOut_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
