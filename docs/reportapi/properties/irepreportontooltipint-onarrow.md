...
description: "Specifies the user command which DIAdem REPORT executes when you press the shift key and move the mouse over an arrow. The user command receives two parameters."
---

# IRepReportOnToolTipInt.OnArrow

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: OnArrow for ToolTipEvents

Specifies the user command which DIAdem REPORT executes when you press the shift key and move the mouse over an arrow. The user command receives two parameters. The first parameter corresponds to a ToolTipArrowContext object and provides information about the arrow in DIAdem REPORT. The second parameter is a text and corresponds with the tooltip for display.
...
*Source: `ReportApi/properties/Report_property_OnArrow_IRepReportOnToolTipInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
