---
title: "IRepPositionCoordinatesInt.Width"
description: "Specifies in DIAdem REPORT the width of an object as a percentage of the page area, in cm or in inches, if you use the coordinates of a corner, and the height a"
---

# IRepPositionCoordinatesInt.Width

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Width for ObjectPositionDefinedByCoordinates
...
*Source: `ReportApi/properties/Report_property_Width_IRepPositionCoordinatesInt.htm`*
