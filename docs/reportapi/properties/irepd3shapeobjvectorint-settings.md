---
title: "IRepD3ShapeObjVectorInt.Settings"
description: "Specifies the properties of a 3D display in the Vector display mode in DIAdem REPORT."
---

# IRepD3ShapeObjVectorInt.Settings

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Settings for 3DVector

Specifies the properties of a 3D display in the Vector display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Settings_IRepD3ShapeObjVectorInt.htm`*
