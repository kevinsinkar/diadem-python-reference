---
title: "IRepTransformDataContextXYX1Y1Int.X1ChannelNumberIn"
description: "Specifies the number of the x1-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYX1Y1Int.X1ChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X1ChannelNumberIn for TransformDataContextXYX1Y1

Specifies the number of the x1-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_X1ChannelNumberIn_IRepTransformDataContextXYX1Y1Int.htm`*
