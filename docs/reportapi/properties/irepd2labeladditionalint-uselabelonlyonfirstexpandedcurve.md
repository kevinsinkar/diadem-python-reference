---
title: "IRepD2LabelAdditionalInt.UseLabelOnlyOnFirstExpandedCurve"
description: "Specifies whether DIAdem REPORT only labels the first curve in 2D axis systems with expanding curves in the display modes Line and points or Special combination"
---

# IRepD2LabelAdditionalInt.UseLabelOnlyOnFirstExpandedCurve

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseLabelOnlyOnFirstExpandedCurve for 2DAdditionalLabel

Specifies whether DIAdem REPORT only labels the first curve in 2D axis systems with expanding curves in the display modes Line and points or Special combination .
...
oMyLabel.UseLabelOnlyOnFirstExpandedCurve = True
...
*Source: `ReportApi/properties/Report_property_UseLabelOnlyOnFirstExpandedCurve_IRepD2LabelAdditionalInt.htm`*
