---
title: "IRepCustomScalingAxisSystem2DContextInt.AxisSystem"
description: "Returns in a 2D axis system in DIAdem REPORT the axis system to which you assigned the user-defined axis scaling."
---

# IRepCustomScalingAxisSystem2DContextInt.AxisSystem

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem for CustomScalingAxisSystem2DContext

Returns in a 2D axis system in DIAdem REPORT the axis system to which you assigned the user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_AxisSystem_IRepCustomScalingAxisSystem2DContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
