---
title: "IRepSpiderInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepSpiderInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for Spider
...
```python
dd.Report.NewLayout()
oMySpiderSystem = dd.Report.ActiveSheet.Objects.Add(dd.eReportObjectSpider,"MySpiderSystem")
dd.MsgBoxDisp(oMySpiderSystem.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepSpiderInt.htm`*
