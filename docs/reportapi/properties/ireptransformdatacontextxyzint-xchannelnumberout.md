---
title: "IRepTransformDataContextXYZInt.XChannelNumberOut"
description: "Specifies the number of the x-input channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spi"
---

# IRepTransformDataContextXYZInt.XChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberOut for TransformDataContextXYZ

Specifies the number of the x-input channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spikes , or Points , in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.XChannelNumberOut
```
...
*Source: `ReportApi/properties/Report_property_XChannelNumberOut_IRepTransformDataContextXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
