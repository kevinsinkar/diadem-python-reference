---
title: "IRepD3AxisXScalingInt.Begin"
description: "Specifies the value from which DIAdem REPORT starts displaying the x-axis of a 3D axis system."
---

# IRepD3AxisXScalingInt.Begin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Begin for 3DAxisXScaling

Specifies the value from which DIAdem REPORT starts displaying the x-axis of a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_Begin_IRepD3AxisXScalingInt.htm`*
