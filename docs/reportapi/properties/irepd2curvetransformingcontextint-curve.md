---
title: "IRepD2CurveTransformingContextInt.Curve"
description: "Specifies the curve for the curve transformation in a 2D axis system in DIAdem REPORT."
---

# IRepD2CurveTransformingContextInt.Curve

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Curve for D2CurveTransformingContext

Specifies the curve for the curve transformation in a 2D axis system in DIAdem REPORT.
...
def MyOnCurveTransformation(Context):
    ...
    if Context.Curve.Name = "MyTransCurve":
...
*Source: `ReportApi/properties/Report_property_Curve_IRepD2CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
