---
title: "IRepCommentInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepCommentInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for Comment
...
dd.MsgBoxDisp(oMyComment.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepCommentInt.htm`*
