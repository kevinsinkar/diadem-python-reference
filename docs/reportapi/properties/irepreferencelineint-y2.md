---
title: "IRepReferenceLineInt.Y2"
description: "Specifies the second y-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system."
---

# IRepReferenceLineInt.Y2

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y2 for ReferenceLine

Specifies the second y-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_Y2_IRepReferenceLineInt.htm`*
