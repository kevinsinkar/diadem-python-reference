---
title: "IRepCurvelegendContentColumnPieChartInt.Title"
description: "Specifies the text for the legend column label in a pie chart in DIAdem REPORT."
---

# IRepCurvelegendContentColumnPieChartInt.Title

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Title for CurveLegendColumnPieChart

Specifies the text for the legend column label in a pie chart in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Title_IRepCurvelegendContentColumnPieChartInt.htm`*
