---
title: "IRepD3CharacteristicDiagramPointsLabelInt.Angle"
description: "Specifies the text angle of the symbol labels in characteristic diagrams in a 3D axis system in DIAdem REPORT."
---

# IRepD3CharacteristicDiagramPointsLabelInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for 3DCharacteristicDiagramPointsLabel

Specifies the text angle of the symbol labels in characteristic diagrams in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepD3CharacteristicDiagramPointsLabelInt.htm`*
