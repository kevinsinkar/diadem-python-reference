---
title: "IRepD3PlaneXYInt.BackgroundColor"
description: "Specifies the background color of the xy plane in a 3D display in DIAdem REPORT."
---

# IRepD3PlaneXYInt.BackgroundColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BackgroundColor for 3DPlaneXY

Specifies the background color of the xy plane in a 3D display in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_BackgroundColor_IRepD3PlaneXYInt.htm`*
