---
title: "IRepD2AxisSubObjInt.Name"
description: "Returns the name of the subobject of a 2D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DI"
---

# IRepD2AxisSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for D2SubObj

Returns the name of the subobject of a 2D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepD2AxisSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
