---
title: "IRepD3AxisYScalingInt.DateTimeRepresentation"
description: "Specifies whether the y-axis of a 3D axis system in DIAdem REPORT displays the time values as absolute or as relative time values."
---

# IRepD3AxisYScalingInt.DateTimeRepresentation

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DateTimeRepresentation for 3DAxisYScaling

Specifies whether the y-axis of a 3D axis system in DIAdem REPORT displays the time values as absolute or as relative time values.
...
*Source: `ReportApi/properties/Report_property_DateTimeRepresentation_IRepD3AxisYScalingInt.htm`*
