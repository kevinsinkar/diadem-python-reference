...
description: "Specifies the name of the event in which you create a user-defined axis scaling for a 2D axis system in DIAdem REPORT. The associated user command receives a pa"
---

# IRepCustomScalingAxisSystem2DInt.EventName

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: EventName for AxisSystem2DCustomScaling

Specifies the name of the event in which you create a user-defined axis scaling for a 2D axis system in DIAdem REPORT. The associated user command receives a parameter. This parameter is a CustomScalingAxisSystem2DContext object and provides information about the axis system and about the ID of the user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_EventName_IRepCustomScalingAxisSystem2DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
