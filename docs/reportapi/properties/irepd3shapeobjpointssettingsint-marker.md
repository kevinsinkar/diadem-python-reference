---
title: "IRepD3ShapeObjPointsSettingsInt.Marker"
description: "Specifies the curve marker properties in the Points display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjPointsSettingsInt.Marker

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Marker for 3DPointsSettings

Specifies the curve marker properties in the Points display mode in a 3D axis system in DIAdem REPORT.
...
oMyShape.Settings.Marker.Type = dd.eMarkerCircle
oMyShape.Settings.Marker.Size = 3
...
*Source: `ReportApi/properties/Report_property_Marker_IRepD3ShapeObjPointsSettingsInt.htm`*
