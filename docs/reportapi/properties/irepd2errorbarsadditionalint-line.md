---
title: "IRepD2ErrorBarsAdditionalInt.Line"
description: "Returns the curve parameters of an error bar in a 2D axis system in DIAdem REPORT."
---

# IRepD2ErrorBarsAdditionalInt.Line

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Line for 2DAdditionalErrorBars

Returns the curve parameters of an error bar in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Line_IRepD2ErrorBarsAdditionalInt.htm`*
