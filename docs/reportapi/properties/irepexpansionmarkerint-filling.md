---
title: "IRepExpansionMarkerInt.Filling"
description: "Specifies the marker filling of expanding curves in DIAdem REPORT."
---

# IRepExpansionMarkerInt.Filling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Filling for CurveExpansionMarker

Specifies the marker filling of expanding curves in DIAdem REPORT.
...
for I in range( 1, oMyExpansionLineStyle.Count+1):
    ...
    oMyExpansionLineStyle(I).Marker.Filling.UseCurveColor = False
    oMyExpansionLineStyle(I).Marker.Filling.SetPredefinedColor(dd.ePredefinedColorBlue)
...
*Source: `ReportApi/properties/Report_property_Filling_IRepExpansionMarkerInt.htm`*
