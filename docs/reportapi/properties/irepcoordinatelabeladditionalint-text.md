---
title: "IRepCoordinateLabelAdditionalInt.Text"
description: "Specifies the text for the coordinate label in a 2D axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepCoordinateLabelAdditionalInt.Text

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Text for AdditionalCoordinateLabel

Specifies the text for the coordinate label in a 2D axis system in the Coordinate display mode in DIAdem REPORT.
...
oMyShape.Settings.Type = dd.eMarkerAsterisk
oMyCoordLabel = oMyShape.Extensions.CoordinateLabel
oMyCoordLabel.Type = dd.eEndLabelCustomText
oMyCoordLabel.Text = "Coordinate"
...
*Source: `ReportApi/properties/Report_property_Text_IRepCoordinateLabelAdditionalInt.htm`*
