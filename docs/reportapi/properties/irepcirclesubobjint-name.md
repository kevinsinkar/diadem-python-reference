---
title: "IRepCircleSubObjInt.Name"
description: "Returns the name of the subobject of a circle in DIAdem REPORT when DIAdem calls the event assigned to the OnCircle for ToolTipEvents property. DIAdem calls thi"
---

# IRepCircleSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for CircleSubObj

Returns the name of the subobject of a circle in DIAdem REPORT when DIAdem calls the event assigned to the OnCircle for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepCircleSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
