---
title: "IRepD3AxisSubObjInt.Name"
description: "Returns the name of the subobject of a 3D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem3D for ToolTipEvents property. DI"
---

# IRepD3AxisSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for D3SubObj

Returns the name of the subobject of a 3D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem3D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepD3AxisSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
