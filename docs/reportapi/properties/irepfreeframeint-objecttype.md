---
title: "IRepFreeFrameInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepFreeFrameInt.ObjectType
...
dd.MsgBoxDisp(oMyFrame.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepFreeFrameInt.htm`*
