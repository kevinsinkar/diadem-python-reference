---
title: "IRepArrowSubObjInt.Type"
description: "Returns the subobject type of an arrow in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event "
---

# IRepArrowSubObjInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for ArrowSubObj

Returns the subobject type of an arrow in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Type_IRepArrowSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
