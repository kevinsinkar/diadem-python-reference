---
title: "IRepTransformDataContextXYZX1Y1Z1Int.Y1ChannelNumberIn"
description: "Specifies the number of the y1-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.Y1ChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1ChannelNumberIn for TransformDataContextXYZX1Y1Z1

Specifies the number of the y1-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Y1ChannelNumberIn_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
