---
title: "IRepImageInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepImageInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for Image
...
oMyImage.FileName = "Example1.png"
dd.MsgBoxDisp(oMyImage.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepImageInt.htm`*
