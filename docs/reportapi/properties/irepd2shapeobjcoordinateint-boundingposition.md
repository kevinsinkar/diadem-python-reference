---
title: "IRepD2ShapeObjCoordinateInt.BoundingPosition"
description: "Specifies how DIAdem REPORT specifies the position of a channel-bound coordinate in a 2D axis system."
---

# IRepD2ShapeObjCoordinateInt.BoundingPosition

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingPosition for 2DCoordinate

Specifies how DIAdem REPORT specifies the position of a channel-bound coordinate in a 2D axis system.

## Signature

```python
obj.BoundingPosition
```
...
*Source: `ReportApi/properties/Report_property_BoundingPosition_IRepD2ShapeObjCoordinateInt.htm`*
