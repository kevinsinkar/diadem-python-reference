---
title: "IRepLabelNumericInt.Format"
description: "Specifies the Format definition of the scale labels in an axis system in DIAdem REPORT."
---

# IRepLabelNumericInt.Format

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Format for LabelNumeric

Specifies the Format definition of the scale labels in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Format_IRepLabelNumericInt.htm`*
