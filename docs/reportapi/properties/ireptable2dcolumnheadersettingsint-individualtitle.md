---
title: "IRepTable2DColumnHeaderSettingsInt.IndividualTitle"
description: "Specifies the individual properties of a column header in a 2D table in DIAdem REPORT."
---

# IRepTable2DColumnHeaderSettingsInt.IndividualTitle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: IndividualTitle for 2DTableColumnHeaderSettings

Specifies the individual properties of a column header in a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_IndividualTitle_IRepTable2DColumnHeaderSettingsInt.htm`*
