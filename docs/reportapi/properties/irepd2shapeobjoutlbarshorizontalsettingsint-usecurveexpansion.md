---
title: "IRepD2ShapeObjOutlBarsHorizontalSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Horizontal outlined bars display mode."
---

# IRepD2ShapeObjOutlBarsHorizontalSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DOutlineBarsHorizontalSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Horizontal outlined bars display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjOutlBarsHorizontalSettingsInt.htm`*
