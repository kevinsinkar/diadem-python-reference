---
title: "IRepTable3DDropContextInt.Sheet"
description: "Specifies the worksheet which contains the 3D table onto which you dragged and dropped an object."
---

# IRepTable3DDropContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for 3DTableDropContext

Specifies the worksheet which contains the 3D table onto which you dragged and dropped an object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepTable3DDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
