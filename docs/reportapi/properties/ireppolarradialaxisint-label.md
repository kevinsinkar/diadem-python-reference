---
title: "IRepPolarRadialAxisInt.Label"
description: "Specifies the properties of the radial axis label in a polar axis system in DIAdem REPORT."
---

# IRepPolarRadialAxisInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for PolarRadialAxis

Specifies the properties of the radial axis label in a polar axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepPolarRadialAxisInt.htm`*
