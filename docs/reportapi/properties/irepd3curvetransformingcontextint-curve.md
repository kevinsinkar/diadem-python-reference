---
title: "IRepD3CurveTransformingContextInt.Curve"
description: "Specifies the curve for the curve transformation in a 3D axis system in DIAdem REPORT."
---

# IRepD3CurveTransformingContextInt.Curve

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Curve for D3CurveTransformingContext

Specifies the curve for the curve transformation in a 3D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.Curve
```
...
def MyOn3DCurveTransformation(TransformContext):
    ...
    if Context.Curve.Name = "My3DCurveTrans":
...
*Source: `ReportApi/properties/Report_property_Curve_IRepD3CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
