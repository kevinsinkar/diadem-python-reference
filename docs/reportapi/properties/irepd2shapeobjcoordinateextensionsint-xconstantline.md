---
title: "IRepD2ShapeObjCoordinateExtensionsInt.XConstantLine"
description: "Specifies the vertical line through an x-coordinate in a 2D axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateExtensionsInt.XConstantLine

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XConstantLine for 2DCoordinateExtensions

Specifies the vertical line through an x-coordinate in a 2D axis system in the Coordinate display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.XConstantLine
```
...
*Source: `ReportApi/properties/Report_property_XConstantLine_IRepD2ShapeObjCoordinateExtensionsInt.htm`*
