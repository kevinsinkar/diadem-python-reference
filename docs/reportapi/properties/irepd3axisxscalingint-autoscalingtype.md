---
title: "IRepD3AxisXScalingInt.AutoScalingType"
description: "Specifies whether DIAdem REPORT scales the x-axis of a 3D axis system automatically."
---

# IRepD3AxisXScalingInt.AutoScalingType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AutoScalingType for 3DAxisXScaling

Specifies whether DIAdem REPORT scales the x-axis of a 3D axis system automatically.
...
| `eAxisScalingSimpleCustom` | 2 | User-defined axis scaling |
...
*Source: `ReportApi/properties/Report_property_AutoScalingType_IRepD3AxisXScalingInt.htm`*
