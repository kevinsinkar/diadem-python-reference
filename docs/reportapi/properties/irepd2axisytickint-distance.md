---
title: "IRepD2AxisYTickInt.Distance"
description: "Specifies the interval between the ticks you want labeled on the y-axis in units of the axis range, in a 2D axis system in DIAdem REPORT. If the scaling is not "
---

# IRepD2AxisYTickInt.Distance

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Distance for 2DAxisYTick
...
*Source: `ReportApi/properties/Report_property_Distance_IRepD2AxisYTickInt.htm`*
