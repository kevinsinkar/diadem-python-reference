---
title: "IRepCoordinateMarkerFillingInt.UseMarkerColor"
description: "Specifies whether DIAdem REPORT displays the marker filling of an additional comment in the 2D and 3D display mode Coordinate in the same color as the curve."
---

# IRepCoordinateMarkerFillingInt.UseMarkerColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseMarkerColor for CoordinateMarkerFilling

Specifies whether DIAdem REPORT displays the marker filling of an additional comment in the 2D and 3D display mode Coordinate in the same color as the curve.
...
*Source: `ReportApi/properties/Report_property_UseMarkerColor_IRepCoordinateMarkerFillingInt.htm`*
