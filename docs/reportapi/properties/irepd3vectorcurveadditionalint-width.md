---
title: "IRepD3VectorCurveAdditionalInt.Width"
description: "Specifies the line width of the additional 3D curve in a 3D axis system in the Vector display mode in DIAdem REPORT."
---

# IRepD3VectorCurveAdditionalInt.Width

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Width for 3DAdditionalVectorCurve

Specifies the line width of the additional 3D curve in a 3D axis system in the Vector display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Width_IRepD3VectorCurveAdditionalInt.htm`*
