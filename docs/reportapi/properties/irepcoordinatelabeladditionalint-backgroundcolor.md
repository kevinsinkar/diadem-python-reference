---
title: "IRepCoordinateLabelAdditionalInt.BackgroundColor"
description: "Specifies the background color of the coordinate labels in 2D and 3D axis systems in the Coordinate display mode in DIAdem REPORT."
---

# IRepCoordinateLabelAdditionalInt.BackgroundColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BackgroundColor for AdditionalCoordinateLabel

Specifies the background color of the coordinate labels in 2D and 3D axis systems in the Coordinate display mode in DIAdem REPORT.
...
oMyCoordLabel.BackgroundColor.SetPredefinedColor(dd.eColorIndexGrey)
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_BackgroundColor_IRepCoordinateLabelAdditionalInt.htm`*
