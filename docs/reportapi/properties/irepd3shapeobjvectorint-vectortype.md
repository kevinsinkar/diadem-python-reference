---
title: "IRepD3ShapeObjVectorInt.VectorType"
description: "Specifies whether DIAdem REPORT displays the four-dimensional vectors or six-dimensional vectors in a 3D axis system in the Vector display mode."
---

# IRepD3ShapeObjVectorInt.VectorType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: VectorType for 3DVector

Specifies whether DIAdem REPORT displays the four-dimensional vectors or six-dimensional vectors in a 3D axis system in the Vector display mode.
...
*Source: `ReportApi/properties/Report_property_VectorType_IRepD3ShapeObjVectorInt.htm`*
