---
title: "IRepD3TableSubObjInt.Name"
description: "Returns the name of the subobject of a 3D table in DIAdem REPORT when DIAdem calls the event associated with the OnTable3D for ToolTipEvents property. DIAdem ca"
---

# IRepD3TableSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for D3TableSubObj

Returns the name of the subobject of a 3D table in DIAdem REPORT when DIAdem calls the event associated with the OnTable3D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepD3TableSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
