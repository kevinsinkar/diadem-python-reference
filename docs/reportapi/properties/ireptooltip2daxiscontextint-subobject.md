---
title: "IRepToolTip2DAxisContextInt.SubObject"
description: "Returns a subobject of a 2D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls thi"
---

# IRepToolTip2DAxisContextInt.SubObject

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SubObject for ToolTip2DAxisContext

Returns a subobject of a 2D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem2D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_SubObject_IRepToolTip2DAxisContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
