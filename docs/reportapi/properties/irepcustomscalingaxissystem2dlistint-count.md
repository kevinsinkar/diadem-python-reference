---
title: "IRepCustomScalingAxisSystem2DListInt.Count"
description: "Returns the number of user-defined axis scalings in a 2D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DListInt.Count

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Count for AxisSystem2DCustomScalings

Returns the number of user-defined axis scalings in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Count_IRepCustomScalingAxisSystem2DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
