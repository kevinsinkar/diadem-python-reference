---
title: "IRepD3AxisXInt.Line"
description: "Specifies the line of the x-axis in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisXInt.Line

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Line for 3DAxisX

Specifies the line of the x-axis in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Line_IRepD3AxisXInt.htm`*
