---
title: "IRepPolarMarkerAdditionalInt.Filling"
description: "Specifies the marker filling properties of a polar curve in DIAdem REPORT."
---

# IRepPolarMarkerAdditionalInt.Filling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Filling for PolarAdditionalMarker

Specifies the marker filling properties of a polar curve in DIAdem REPORT.
...
oMyExtension.Marker.Filling.SetPredefinedColor(dd.ePredefinedColorDarkBlue)
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_Filling_IRepPolarMarkerAdditionalInt.htm`*
