---
title: "IRepCoordinateMarkerFillingInt.Transparency"
description: "Specifies the percentaged transparency of the marker filling of an additional comment in the Coordinate 2D and 3D display mode in DIAdem REPORT. The value 100 s"
---

# IRepCoordinateMarkerFillingInt.Transparency

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Transparency for CoordinateMarkerFilling

Specifies the percentaged transparency of the marker filling of an additional comment in the Coordinate 2D and 3D display mode in DIAdem REPORT. The value 100 specifies a completely transparent display and the value 0 specifies a completely opaque display.
...
oMyCoordShape.Settings.MarkerFilling.Transparency = 70
...
*Source: `ReportApi/properties/Report_property_Transparency_IRepCoordinateMarkerFillingInt.htm`*
