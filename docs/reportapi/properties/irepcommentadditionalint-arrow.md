---
title: "IRepCommentAdditionalInt.Arrow"
description: "Specifies the arrow which DIAdem REPORT plots at a comment in the 2D and 3D display mode Coordinate in DIAdem REPORT."
---

# IRepCommentAdditionalInt.Arrow

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Arrow for AdditionalComment

Specifies the arrow which DIAdem REPORT plots at a comment in the 2D and 3D display mode Coordinate in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Arrow_IRepCommentAdditionalInt.htm`*
