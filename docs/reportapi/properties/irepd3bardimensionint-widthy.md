---
title: "IRepD3BarDimensionInt.WidthY"
description: "Specifies the height of the rectangles or 3D bars as a percentage in the display modes 2D matrix or Bars in 3D axis systems in DIAdem REPORT."
---

# IRepD3BarDimensionInt.WidthY

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: WidthY for 3DBarDimension

Specifies the height of the rectangles or 3D bars as a percentage in the display modes 2D matrix or Bars in 3D axis systems in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_WidthY_IRepD3BarDimensionInt.htm`*
