---
title: "IRepD2ShapeObjBarsInt.YChannel"
description: "Specifies the y-channel of a curve in the Bars display mode in a 2D axis system in DIAdem REPORT."
---

# IRepD2ShapeObjBarsInt.YChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannel for 2DBars

Specifies the y-channel of a curve in the Bars display mode in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannel_IRepD2ShapeObjBarsInt.htm`*
