---
title: "IRepTransformDataContextConstantXYZInt.ConstZOut"
description: "Specifies the values of the z-output constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextConstantXYZInt.ConstZOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstZOut for TransformDataContextConstantXYZ

Specifies the values of the z-output constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstZOut_IRepTransformDataContextConstantXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
