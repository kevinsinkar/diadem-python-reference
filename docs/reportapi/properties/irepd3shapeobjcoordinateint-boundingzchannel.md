---
title: "IRepD3ShapeObjCoordinateInt.BoundingZChannel"
description: "Specifies the z-channel to which the BoundingPosition property of a channel-bound coordinate of a 3D axis system in DIAdem REPORT refers."
---

# IRepD3ShapeObjCoordinateInt.BoundingZChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingZChannel for 3DCoordinate

Specifies the z-channel to which the BoundingPosition property of a channel-bound coordinate of a 3D axis system in DIAdem REPORT refers.

## Signature

```python
return_value = obj.BoundingZChannel
```
...
*Source: `ReportApi/properties/Report_property_BoundingZChannel_IRepD3ShapeObjCoordinateInt.htm`*
