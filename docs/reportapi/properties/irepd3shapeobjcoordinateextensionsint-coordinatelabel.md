---
title: "IRepD3ShapeObjCoordinateExtensionsInt.CoordinateLabel"
description: "Specifies the properties of the coordinate label in 3D axis systems in the Coordinate display mode in DIAdem REPORT."
---

# IRepD3ShapeObjCoordinateExtensionsInt.CoordinateLabel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CoordinateLabel for 3DCoordinateExtensions

Specifies the properties of the coordinate label in 3D axis systems in the Coordinate display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_CoordinateLabel_IRepD3ShapeObjCoordinateExtensionsInt.htm`*
