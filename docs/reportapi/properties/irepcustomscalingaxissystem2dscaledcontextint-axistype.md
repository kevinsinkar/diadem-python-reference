---
title: "IRepCustomScalingAxisSystem2DScaledContextInt.AxisType"
description: "Specifies in a 2D axis system in scaled display in DIAdem REPORT the type of axis to which you assigned a user-defined axis scaling."
---

# IRepCustomScalingAxisSystem2DScaledContextInt.AxisType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisType for CustomScalingAxisSystem2DScaledContext

Specifies in a 2D axis system in scaled display in DIAdem REPORT the type of axis to which you assigned a user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_AxisType_IRepCustomScalingAxisSystem2DScaledContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
