---
title: "IRepCustomScalingAxisSystem3DInt.BaseScalingType"
description: "Specifies the scaling type from which DIAdem REPORT derives the user-defined axis scaling in a 3D axis system."
---

# IRepCustomScalingAxisSystem3DInt.BaseScalingType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BaseScalingType for AxisSystem3DCustomScaling

Specifies the scaling type from which DIAdem REPORT derives the user-defined axis scaling in a 3D axis system.
...
| `eAxisScalingSimpleCustom` | 2 | User-defined |
...
*Source: `ReportApi/properties/Report_property_BaseScalingType_IRepCustomScalingAxisSystem3DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
