---
title: "IRepD2ShapeObjBarsSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Bars display mode."
---

# IRepD2ShapeObjBarsSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DBarsSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Bars display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjBarsSettingsInt.htm`*
