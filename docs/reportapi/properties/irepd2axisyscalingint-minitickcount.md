---
title: "IRepD2AxisYScalingInt.MiniTickCount"
description: "Specifies the number of miniticks between the scale ticks on the y-axis of a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisYScalingInt.MiniTickCount

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MiniTickCount for 2DAxisYScaling

Specifies the number of miniticks between the scale ticks on the y-axis of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_MiniTickCount_IRepD2AxisYScalingInt.htm`*
