---
title: "IRepD2AxisXInt.TagStored"
...
# IRepD2AxisXInt.TagStored

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagStored for 2DAxisX
...
for oMyReportObj in oMyReportObjects:
    if oMyReportObj.ObjectType == dd.eReportObject2DAxisSystem :
        oMyReportObj.XAxis.TagStored = "Selected"
```
...
*Source: `ReportApi/properties/Report_property_TagStored_IRepD2AxisXInt.htm`*
