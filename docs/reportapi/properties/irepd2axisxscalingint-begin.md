---
title: "IRepD2AxisXScalingInt.Begin"
description: "Specifies the value where DIAdem REPORT starts displaying the x-axis of a 2D axis system."
---

# IRepD2AxisXScalingInt.Begin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Begin for 2DAxisXScaling

Specifies the value where DIAdem REPORT starts displaying the x-axis of a 2D axis system.
...
*Source: `ReportApi/properties/Report_property_Begin_IRepD2AxisXScalingInt.htm`*
