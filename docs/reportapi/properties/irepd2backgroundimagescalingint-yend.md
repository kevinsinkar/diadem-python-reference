---
title: "IRepD2BackgroundImageScalingInt.YEnd"
description: "Specifies the end value in y-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT."
---

# IRepD2BackgroundImageScalingInt.YEnd

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YEnd for 2DBackgroundImageScaling

Specifies the end value in y-direction for scaling the background graphic of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YEnd_IRepD2BackgroundImageScalingInt.htm`*
