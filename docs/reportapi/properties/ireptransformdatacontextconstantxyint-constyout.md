---
title: "IRepTransformDataContextConstantXYInt.ConstYOut"
description: "Specifies the values of the y-output constants for the curve transformation of a curve with the Constant or Coordinate display type in a 2D axis system in DIAde"
---

# IRepTransformDataContextConstantXYInt.ConstYOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstYOut for TransformDataContextConstantXY

Specifies the values of the y-output constants for the curve transformation of a curve with the Constant or Coordinate display type in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstYOut_IRepTransformDataContextConstantXYInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
