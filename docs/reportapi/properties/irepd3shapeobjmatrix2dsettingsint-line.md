---
title: "IRepD3ShapeObjMatrix2DSettingsInt.Line"
description: "Specifies the properties of the curve line in the 2D matrix display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjMatrix2DSettingsInt.Line

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Line for 3DMatrix2DSettings

Specifies the properties of the curve line in the 2D matrix display mode in a 3D axis system in DIAdem REPORT.
...
<span class="HlVBSKeyword">Set</span> oMy3DCurve = oMy3DAxisSystem.Curves3D.Add(<span class="Hldiademconstant">e3DShapeMatrix2D</span>, <span class="HlString">"MyNew3DCurve"</span>)
...
oMySettings.Dimensions.WidthX = <span class="HlNumbers">10</span>
oMySettings.Dimensions.WidthY = <span class="HlNumbers">10</span>
...
oMySettings.Line.Width = <span class="Hldiademconstant">eLineWidth0025</span>
...
oMyLabel.ZValueFormat = <span class="HlString">"d.ddde"</span>
...
<span class="HlVBSKeyword">Call</span> oMyLabel.Font.Color.SetPredefinedColor(<span class="Hldiademconstant">eColorIndexBlue</span>)
...
oMyPos.Y1 = <span class="HlNumbers">20</span> 
oMyPos.Y2 = <span class="HlNumbers">80</span> 
oMy3DCurve = oMy3DAxisSystem.Curves3D.Add(dd.e3DShapeMatrix2D, <span class="HlString">"MyNew3DCurve"</span>) 
oMyShape = oMy3DCurve.Shape 
oMyShape.XChannel.Reference = <span class="HlString">"[2]/[1]"</span> 
oMyShape.YChannel.Reference = <span class="HlString">"[2]/[2]"</span> 
oMyShape.ZChannel.Reference = <span class="HlString">"[2]/[3]"</span> 
...
*Source: `ReportApi/properties/Report_property_Line_IRepD3ShapeObjMatrix2DSettingsInt.htm`*
