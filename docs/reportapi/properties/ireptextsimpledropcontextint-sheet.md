---
title: "IRepTextSimpleDropContextInt.Sheet"
description: "Specifies the worksheet that contains the text onto which you dragged and dropped an object."
---

# IRepTextSimpleDropContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for TextDropContext

Specifies the worksheet that contains the text onto which you dragged and dropped an object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepTextSimpleDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
