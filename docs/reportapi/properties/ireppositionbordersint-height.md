---
title: "IRepPositionBordersInt.Height"
description: "Specifies, in DIAdem REPORT, the height of an object as a percentage of the page area, in cm or in inches, if you use the margins to position the object. Becaus"
---

# IRepPositionBordersInt.Height

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Height for ObjectPositionDefinedByBorders
...
*Source: `ReportApi/properties/Report_property_Height_IRepPositionBordersInt.htm`*
