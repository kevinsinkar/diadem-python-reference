---
title: "IRepToolTipFrameContextInt.Frame"
description: "Returns a rectangle in DIAdem REPORT when DIAdem calls the event assigned to the OnFrame for ToolTipEvents property. DIAdem calls this event if you press the sh"
---

# IRepToolTipFrameContextInt.Frame

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Frame for ToolTipFrameContext

Returns a rectangle in DIAdem REPORT when DIAdem calls the event assigned to the OnFrame for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Frame_IRepToolTipFrameContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
