---
title: "IRepLabelNumericInt.RelativePosition"
description: "Specifies the relative position of the scaling labels in relation to the scale ticks of the axis in an axis system in DIAdem REPORT."
---

# IRepLabelNumericInt.RelativePosition

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: RelativePosition for LabelNumeric

Specifies the relative position of the scaling labels in relation to the scale ticks of the axis in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_RelativePosition_IRepLabelNumericInt.htm`*
