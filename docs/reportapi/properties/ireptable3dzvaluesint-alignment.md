---
title: "IRepTable3DZValuesInt.Alignment"
description: "Specifies the relative position of the z-values in 3D tables in DIAdem REPORT."
---

# IRepTable3DZValuesInt.Alignment

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Alignment for 3DTableZValues

Specifies the relative position of the z-values in 3D tables in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Alignment_IRepTable3DZValuesInt.htm`*
