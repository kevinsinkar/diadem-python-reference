---
title: "IRepTransformDataContextXYX1Y1Int.Y1ChannelNumberIn"
description: "Specifies the number of the y1-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYX1Y1Int.Y1ChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1ChannelNumberIn for TransformDataContextXYX1Y1

Specifies the number of the y1-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Y1ChannelNumberIn_IRepTransformDataContextXYX1Y1Int.htm`*
