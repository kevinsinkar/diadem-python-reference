---
title: "IRepTable3DXValuesInt.Alignment"
description: "Specifies the relative position of the x-values in 3D tables in DIAdem REPORT."
---

# IRepTable3DXValuesInt.Alignment

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Alignment for 3DTableXValues

Specifies the relative position of the x-values in 3D tables in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Alignment_IRepTable3DXValuesInt.htm`*
