---
title: "IRepTable3DSettingsInt.BackgroundColor"
description: "Specifies the background color of a 3D table in DIAdem REPORT."
---

# IRepTable3DSettingsInt.BackgroundColor

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BackgroundColor for 3DTableSettings

Specifies the background color of a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_BackgroundColor_IRepTable3DSettingsInt.htm`*
