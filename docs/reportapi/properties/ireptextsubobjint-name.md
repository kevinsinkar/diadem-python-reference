---
title: "IRepTextSubObjInt.Name"
description: "Returns the name of the subobject of a text in DIAdem REPORT when DIAdem calls the event assigned to the OnText for ToolTipEvents property. DIAdem calls this ev"
---

# IRepTextSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for TextSubObj

Returns the name of the subobject of a text in DIAdem REPORT when DIAdem calls the event assigned to the OnText for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepTextSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
