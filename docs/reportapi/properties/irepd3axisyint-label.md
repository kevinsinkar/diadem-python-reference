---
title: "IRepD3AxisYInt.Label"
description: "Specifies the label of the y-axis in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisYInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for 3DAxisY

Specifies the label of the y-axis in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepD3AxisYInt.htm`*
