---
title: "IRepD3ShapeObjCoordinateInt.YCoordinate"
description: "Specifies the y-channel of a curve in the Coordinate display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjCoordinateInt.YCoordinate

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YCoordinate for 3DCoordinate

Specifies the y-channel of a curve in the Coordinate display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YCoordinate_IRepD3ShapeObjCoordinateInt.htm`*
