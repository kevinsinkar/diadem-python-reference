---
title: "IRepD3ShapeObjVectorSettingsInt.ArrowHead"
description: "Specifies the arrow end of a vector arrow in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorSettingsInt.ArrowHead

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ArrowHead for 3DVectorSettings

Specifies the arrow end of a vector arrow in the Vector display mode in a 3D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.ArrowHead
```
...
*Source: `ReportApi/properties/Report_property_ArrowHead_IRepD3ShapeObjVectorSettingsInt.htm`*
