---
title: "IRepD3VectorCurveAdditionalInt.Interval"
description: "Specifies the line interval for broken lines of the additional 3D curve in a 3D axis system in the Vector display mode in DIAdem REPORT. Greater values mean gre"
---

# IRepD3VectorCurveAdditionalInt.Interval

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Interval for 3DAdditionalVectorCurve

Specifies the line interval for broken lines of the additional 3D curve in a 3D axis system in the Vector display mode in DIAdem REPORT. Greater values mean greater intervals.
...
oMyCurveLineExtension.LineType = dd.eLineTypeDashDot
...
*Source: `ReportApi/properties/Report_property_Interval_IRepD3VectorCurveAdditionalInt.htm`*
