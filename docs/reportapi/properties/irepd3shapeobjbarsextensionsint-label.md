---
title: "IRepD3ShapeObjBarsExtensionsInt.Label"
description: "Specifies the curve labels in the Bars display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjBarsExtensionsInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for 3DBarsExtensions

Specifies the curve labels in the Bars display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepD3ShapeObjBarsExtensionsInt.htm`*
