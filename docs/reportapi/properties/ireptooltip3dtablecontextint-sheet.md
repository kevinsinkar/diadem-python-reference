---
title: "IRepToolTip3DTableContextInt.Sheet"
description: "Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnTable3D for ToolTipEvents property. DIAdem calls this event if you press the "
---

# IRepToolTip3DTableContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for ToolTip3DTableContext

Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnTable3D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepToolTip3DTableContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
