---
title: "IRepD3AxisYScalingInt.CustomScalingID"
description: "Specifies in a 3D axis system in DIAdem REPORT the ID with which you assign a user-defined axis scaling to a y-axis."
---

# IRepD3AxisYScalingInt.CustomScalingID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CustomScalingID for 3DAxisYScaling

Specifies in a 3D axis system in DIAdem REPORT the ID with which you assign a user-defined axis scaling to a y-axis.
...
*Source: `ReportApi/properties/Report_property_CustomScalingID_IRepD3AxisYScalingInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
