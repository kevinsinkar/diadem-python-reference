---
title: "IRepD3VectorCurveAdditionalInt.Visible"
description: "Specifies whether DIAdem REPORT plots additional 3D curves through the vector starting points when displaying 4D/6D vectors in a 3D axis system."
---

# IRepD3VectorCurveAdditionalInt.Visible

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Visible for 3DAdditionalVectorCurve

Specifies whether DIAdem REPORT plots additional 3D curves through the vector starting points when displaying 4D/6D vectors in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_Visible_IRepD3VectorCurveAdditionalInt.htm`*
