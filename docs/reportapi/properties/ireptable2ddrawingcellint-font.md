---
title: "IRepTable2DDrawingCellInt.Font"
description: "Specifies the font of the cell DIAdem is plotting in a 2D table in DIAdem REPORT."
---

# IRepTable2DDrawingCellInt.Font

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Font for 2DTableDrawingCell

Specifies the font of the cell DIAdem is plotting in a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Font_IRepTable2DDrawingCellInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
