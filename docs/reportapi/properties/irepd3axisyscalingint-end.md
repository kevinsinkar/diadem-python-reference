---
title: "IRepD3AxisYScalingInt.End"
description: "Specifies the value up to which DIAdem REPORT displays the y-axis of a 3D axis system. DIAdem REPORT only includes the End property if you assign the value eAxi"
---

# IRepD3AxisYScalingInt.End

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: End for 3DAxisYScaling

Specifies the value up to which DIAdem REPORT displays the y-axis of a 3D axis system. DIAdem REPORT only includes the End property if you assign the value eAxisScalingSimpleManual to the AutoScalingType property.
...
*Source: `ReportApi/properties/Report_property_End_IRepD3AxisYScalingInt.htm`*
