---
title: "IRepAttributeListInt.UseMarkerType"
description: "Specifies whether DIAdem REPORT displays expanding curves with the markers specified in the attribute list."
---

# IRepAttributeListInt.UseMarkerType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseMarkerType for AttributeList

Specifies whether DIAdem REPORT displays expanding curves with the markers specified in the attribute list.
...
*Source: `ReportApi/properties/Report_property_UseMarkerType_IRepAttributeListInt.htm`*
