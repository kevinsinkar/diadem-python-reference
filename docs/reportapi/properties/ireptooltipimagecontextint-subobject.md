---
title: "IRepToolTipImageContextInt.SubObject"
description: "Returns the subobject of a graphic in DIAdem REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event if y"
---

# IRepToolTipImageContextInt.SubObject

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SubObject for ToolTipImageContext

Returns the subobject of a graphic in DIAdem REPORT when DIAdem calls the event assigned to the OnImage for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_SubObject_IRepToolTipImageContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
