---
title: "IRepReportEventsInt.ToolTip"
description: "Returns in DIAdem REPORT the object which provides the events if you press the shift key and move the mouse over a REPORT object."
---

# IRepReportEventsInt.ToolTip

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ToolTip for Events

Returns in DIAdem REPORT the object which provides the events if you press the shift key and move the mouse over a REPORT object.

## Signature

```python
return_value = obj.ToolTip
```
...
*Source: `ReportApi/properties/Report_property_ToolTip_IRepReportEventsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
