---
title: "IRepD2AxisDropContextInt.DoProceed"
description: "Specifies whether DIAdem transfers the D2AxisSystemDropContext object to subsequent events. If the value is TRUE , DIAdem also transfers the D2AxisSystemDropCon"
---

# IRepD2AxisDropContextInt.DoProceed

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DoProceed for D2AxisSystemDropContext

Specifies whether DIAdem transfers the D2AxisSystemDropContext object to subsequent events. If the value is TRUE , DIAdem also transfers the D2AxisSystemDropContext object to the following events. Do not set the DoProceed property to TRUE if you change the number of curves in the associated event or if you execute similar operations.
...
*Source: `ReportApi/properties/Report_property_DoProceed_IRepD2AxisDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
