---
title: "IRepToolTipSpiderContextInt.Position"
description: "Returns the cursor position in page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls t"
---

# IRepToolTipSpiderContextInt.Position

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Position for ToolTipSpiderContext

Returns the cursor position in page coordinates in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Position_IRepToolTipSpiderContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
