---
title: "IRepD3ShapeObjVectorSettingsInt.EndCoordinateType"
description: "Specifies how DIAdem REPORT determines the end points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjVectorSettingsInt.EndCoordinateType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: EndCoordinateType for 3DVectorSettings

Specifies how DIAdem REPORT determines the end points of a curve in the Vector display mode in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.EndCoordinateType
```
...
*Source: `ReportApi/properties/Report_property_EndCoordinateType_IRepD3ShapeObjVectorSettingsInt.htm`*
