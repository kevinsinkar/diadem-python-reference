---
title: "IRepCurveLegendSettingsInt.ShowOnlyFirstCurve"
description: "Specifies whether DIAdem REPORT displays the legend in the Expansion mode only for the first curve."
---

# IRepCurveLegendSettingsInt.ShowOnlyFirstCurve

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ShowOnlyFirstCurve for CurveLegendSettings

Specifies whether DIAdem REPORT displays the legend in the Expansion mode only for the first curve.

## Signature

```python
obj.ShowOnlyFirstCurve
```
...
*Source: `ReportApi/properties/Report_property_ShowOnlyFirstCurve_IRepCurveLegendSettingsInt.htm`*
