---
title: "IRepD2BackgroundImageInt.Scaling"
description: "Specifies the scaling of the background graphic for a 2D axis system in DIAdem REPORT."
---

# IRepD2BackgroundImageInt.Scaling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Scaling for 2DBackgroundImage

Specifies the scaling of the background graphic for a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Scaling_IRepD2BackgroundImageInt.htm`*
