---
title: "IRepCommentDropContextInt.Comment"
description: "Specifies the comment onto which you dragged and dropped an object."
---

# IRepCommentDropContextInt.Comment

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Comment for CommentDropContext

Specifies the comment onto which you dragged and dropped an object.
...
*Source: `ReportApi/properties/Report_property_Comment_IRepCommentDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
