---
title: "IRepD3ShapeObjCoordinateInt.Settings"
description: "Specifies the properties of a 3D display in the Coordinate display mode in DIAdem REPORT."
---

# IRepD3ShapeObjCoordinateInt.Settings

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Settings for 3DCoordinate

Specifies the properties of a 3D display in the Coordinate display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Settings_IRepD3ShapeObjCoordinateInt.htm`*
