---
title: "IRepD2ShapeObjCoordinateInt.BoundingType"
description: "Specifies whether you can freely select the coordinate in a 2D axis system in DIAdem REPORT, or whether it is bound to a channel."
---

# IRepD2ShapeObjCoordinateInt.BoundingType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingType for 2DCoordinate

Specifies whether you can freely select the coordinate in a 2D axis system in DIAdem REPORT, or whether it is bound to a channel.
...
*Source: `ReportApi/properties/Report_property_BoundingType_IRepD2ShapeObjCoordinateInt.htm`*
