---
title: "IRepD2ShapeObjCoordinateInt.Settings"
description: "Specifies the curve properties in the Coordinate display mode in a 2D axis system in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateInt.Settings

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Settings for 2DCoordinate

Specifies the curve properties in the Coordinate display mode in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Settings_IRepD2ShapeObjCoordinateInt.htm`*
