---
title: "IRepPolarDropContextInt.DoProceed"
description: "Specifies whether DIAdem transfers the PolarSystemDropContext object to subsequent events. If the value is TRUE , DIAdem also transfers the PolarSystemDropConte"
---

# IRepPolarDropContextInt.DoProceed

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DoProceed for PolarSystemDropContext

Specifies whether DIAdem transfers the PolarSystemDropContext object to subsequent events. If the value is TRUE , DIAdem also transfers the PolarSystemDropContext object to the following events. Do not set the DoProceed property to TRUE if you change the number of curves in the associated event or if you execute similar operations.
...
*Source: `ReportApi/properties/Report_property_DoProceed_IRepPolarDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
