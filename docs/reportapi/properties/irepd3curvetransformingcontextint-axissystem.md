---
title: "IRepD3CurveTransformingContextInt.AxisSystem"
description: "Specifies the 3D axis system for the curve transformation in DIAdem REPORT."
---

# IRepD3CurveTransformingContextInt.AxisSystem

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem for D3CurveTransformingContext

Specifies the 3D axis system for the curve transformation in DIAdem REPORT.
...
def MyOn3DCurveTransformation(TransformContext):
    ...
    if Context.AxisSystem.Name = "MyAxisSystem":
...
*Source: `ReportApi/properties/Report_property_AxisSystem_IRepD3CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
