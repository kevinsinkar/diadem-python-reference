---
title: "IRepCommentAdditionalInt.Comment"
description: "Specifies a comment in an axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepCommentAdditionalInt.Comment

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Comment for AdditionalComment

Specifies a comment in an axis system in the Coordinate display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Comment_IRepCommentAdditionalInt.htm`*
