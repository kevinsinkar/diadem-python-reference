---
title: "IRepD3ShapeObjIsolinesSettingsInt.Palette"
description: "Specifies the properties of the palette which DIAdem REPORT uses to display isolines in a 3D axis system."
---

# IRepD3ShapeObjIsolinesSettingsInt.Palette

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Palette for 3DIsolinesSettings

Specifies the properties of the palette which DIAdem REPORT uses to display isolines in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_Palette_IRepD3ShapeObjIsolinesSettingsInt.htm`*
