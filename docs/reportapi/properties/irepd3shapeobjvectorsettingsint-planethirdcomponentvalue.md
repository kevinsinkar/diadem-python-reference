---
title: "IRepD3ShapeObjVectorSettingsInt.PlaneThirdComponentValue"
description: "Specifies the value of the constant component in a 3D axis system with the Vector display mode in DIAdem-REPORT if you assign the value e3DVectorComponentUserSe"
---

# IRepD3ShapeObjVectorSettingsInt.PlaneThirdComponentValue

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: PlaneThirdComponentValue for 3DVectorSettings

Specifies the value of the constant component in a 3D axis system with the Vector display mode in DIAdem-REPORT if you assign the value e3DVectorComponentUserSelection to the PlaneThirdComponentType property.

## Signature

```python
obj.PlaneThirdComponentValue
```
...
*Source: `ReportApi/properties/Report_property_PlaneThirdComponentValue_IRepD3ShapeObjVectorSettingsInt.htm`*
