---
title: "IRepTable2DColumnSettingsInt.UseWordWrap"
description: "Specifies whether DIAdem REPORT wraps text in a column of a 2D table. You must assign the value False to the UseAutoFontSize property because DIAdem REPORT othe"
---

# IRepTable2DColumnSettingsInt.UseWordWrap

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseWordWrap for 2DTableColumnSettings

Specifies whether DIAdem REPORT wraps text in a column of a 2D table. You must assign the value False to the UseAutoFontSize property because DIAdem REPORT otherwise adjusts the font size of the text to the size of the cell.
...
*Source: `ReportApi/properties/Report_property_UseWordWrap_IRepTable2DColumnSettingsInt.htm`*
