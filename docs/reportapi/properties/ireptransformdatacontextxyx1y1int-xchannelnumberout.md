---
title: "IRepTransformDataContextXYX1Y1Int.XChannelNumberOut"
description: "Specifies the number of the x-output channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYX1Y1Int.XChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberOut for TransformDataContextXYX1Y1

Specifies the number of the x-output channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannelNumberOut_IRepTransformDataContextXYX1Y1Int.htm`*
