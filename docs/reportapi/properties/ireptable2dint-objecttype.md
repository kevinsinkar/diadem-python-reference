---
title: "IRepTable2DInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepTable2DInt.ObjectType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ObjectType for 2DTable
...
dd.MsgBoxDisp(oMy2DTable.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepTable2DInt.htm`*
