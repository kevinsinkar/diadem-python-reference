---
title: "IRepD3AxisZScalingInt.CustomScalingID"
description: "Specifies in a 3D axis system in DIAdem REPORT the ID with which you assign a user-defined axis scaling to a z-axis."
---

# IRepD3AxisZScalingInt.CustomScalingID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CustomScalingID for 3DAxisZScaling

Specifies in a 3D axis system in DIAdem REPORT the ID with which you assign a user-defined axis scaling to a z-axis.
...
oMyZScaling.AutoScalingType = eAxisScalingSimpleCustom
oMyZScaling.CustomScalingID = "MotorWarmScaling"
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_CustomScalingID_IRepD3AxisZScalingInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
