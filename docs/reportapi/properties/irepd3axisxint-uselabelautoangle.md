---
title: "IRepD3AxisXInt.UseLabelAutoAngle"
description: "Specifies whether DIAdem REPORT determines the font angle of an x-axis text in a 3D axis system automatically."
---

# IRepD3AxisXInt.UseLabelAutoAngle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseLabelAutoAngle for 3DAxisX

Specifies whether DIAdem REPORT determines the font angle of an x-axis text in a 3D axis system automatically.
...
*Source: `ReportApi/properties/Report_property_UseLabelAutoAngle_IRepD3AxisXInt.htm`*
