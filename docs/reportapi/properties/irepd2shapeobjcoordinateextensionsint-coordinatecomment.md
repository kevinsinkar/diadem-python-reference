---
title: "IRepD2ShapeObjCoordinateExtensionsInt.CoordinateComment"
description: "Specifies the comment properties of a curve in a 2D axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateExtensionsInt.CoordinateComment

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CoordinateComment for 2DCoordinateExtensions

Specifies the comment properties of a curve in a 2D axis system in the Coordinate display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_CoordinateComment_IRepD2ShapeObjCoordinateExtensionsInt.htm`*
