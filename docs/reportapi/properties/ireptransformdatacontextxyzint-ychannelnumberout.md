---
title: "IRepTransformDataContextXYZInt.YChannelNumberOut"
description: "Specifies the number of the y-output channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Sp"
---

# IRepTransformDataContextXYZInt.YChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberOut for TransformDataContextXYZ

Specifies the number of the y-output channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spikes , or Points , in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannelNumberOut_IRepTransformDataContextXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
