---
title: "IRepCommentTextAdditionalInt.Font"
description: "Specifies the text font in an additional comment in the 2D and 3D display mode Coordinate in DIAdem REPORT."
---

# IRepCommentTextAdditionalInt.Font

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Font for AdditionalCommentText

Specifies the text font in an additional comment in the 2D and 3D display mode Coordinate in DIAdem REPORT.
...
oMyCoordComment.Comment.Font.Name = "Times Roman"()
...
*Source: `ReportApi/properties/Report_property_Font_IRepCommentTextAdditionalInt.htm`*
