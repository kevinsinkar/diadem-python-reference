---
title: "IRepD3BarDimensionInt.WidthX"
description: "Specifies the width of the rectangles or 3D bars as a percentage in the display modes 2D matrix or Bars in 3D axis systems in DIAdem REPORT."
---

# IRepD3BarDimensionInt.WidthX

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: WidthX for 3DBarDimension

Specifies the width of the rectangles or 3D bars as a percentage in the display modes 2D matrix or Bars in 3D axis systems in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_WidthX_IRepD3BarDimensionInt.htm`*
