---
title: "IRepTransformDataContextXInt.ChannelNumberOut"
description: "Specifies the number of the output channel for the channel transformation in a 2D table in DIAdem REPORT."
---

# IRepTransformDataContextXInt.ChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ChannelNumberOut for TransformDataContextX

Specifies the number of the output channel for the channel transformation in a 2D table in DIAdem REPORT.

## Signature

```python
obj.ChannelNumberOut
```
...
*Source: `ReportApi/properties/Report_property_ChannelNumberOut_IRepTransformDataContextXInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
