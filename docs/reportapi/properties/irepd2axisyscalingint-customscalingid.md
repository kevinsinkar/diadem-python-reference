---
title: "IRepD2AxisYScalingInt.CustomScalingID"
description: "Specifies the ID of a user-defined axis scaling which you use for the y-axis of a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisYScalingInt.CustomScalingID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CustomScalingID for 2DAxisYScaling

Specifies the ID of a user-defined axis scaling which you use for the y-axis of a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_CustomScalingID_IRepD2AxisYScalingInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
