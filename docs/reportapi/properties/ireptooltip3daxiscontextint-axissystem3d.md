---
title: "IRepToolTip3DAxisContextInt.AxisSystem3D"
description: "Returns a 3D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem3D for ToolTipEvents property. DIAdem calls this event if you "
---

# IRepToolTip3DAxisContextInt.AxisSystem3D

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem3D for ToolTip3DAxisContext

Returns a 3D axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnAxisSystem3D for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.

## Signature

```python
return_value = obj.AxisSystem3D
```
...
*Source: `ReportApi/properties/Report_property_AxisSystem3D_IRepToolTip3DAxisContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
