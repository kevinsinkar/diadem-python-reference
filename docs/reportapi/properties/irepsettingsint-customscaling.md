---
title: "IRepSettingsInt.CustomScaling"
description: "Manages all user-defined axis scalings in a 2D and 3D axis system in DIAdem REPORT."
---

# IRepSettingsInt.CustomScaling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CustomScaling for Settings

Manages all user-defined axis scalings in a 2D and 3D axis system in DIAdem REPORT.

## Signature

```python
return_value = obj.CustomScaling
```
...
*Source: `ReportApi/properties/Report_property_CustomScaling_IRepSettingsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
