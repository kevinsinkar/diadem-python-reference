---
title: "IRepD3AxisZInt.UseNumbersAutoPosition"
description: "Specifies whether DIAdem REPORT determines the z-scale label position automatically in a 3D axis system."
---

# IRepD3AxisZInt.UseNumbersAutoPosition

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseNumbersAutoPosition for 3DAxisZ

Specifies whether DIAdem REPORT determines the z-scale label position automatically in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_UseNumbersAutoPosition_IRepD3AxisZInt.htm`*
