---
title: "IRepTransformDataContextXYX1Y1Int.YChannelNumberIn"
description: "Specifies the number of the y-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYX1Y1Int.YChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberIn for TransformDataContextXYX1Y1

Specifies the number of the y-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.YChannelNumberIn
```
...
*Source: `ReportApi/properties/Report_property_YChannelNumberIn_IRepTransformDataContextXYX1Y1Int.htm`*
