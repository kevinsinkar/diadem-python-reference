---
title: "IRepTransformDataContextConstantXYInt.ConstXOut"
description: "Specifies the values of the x-output constants for the curve transformation of a curve with the Constant or Coordinate display type in a 2D axis system in DIAde"
---

# IRepTransformDataContextConstantXYInt.ConstXOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstXOut for TransformDataContextConstantXY

Specifies the values of the x-output constants for the curve transformation of a curve with the Constant or Coordinate display type in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstXOut_IRepTransformDataContextConstantXYInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
