---
title: "IRepTransformDataContextXYX1Y1Int.XChannelNumberIn"
description: "Specifies the number of the x-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYX1Y1Int.XChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberIn for TransformDataContextXYX1Y1

Specifies the number of the x-input channel for the Curve Transformation of a curve with a 4D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannelNumberIn_IRepTransformDataContextXYX1Y1Int.htm`*
