---
title: "IRepTransformDataContextXYZInt.ZChannelNumberOut"
description: "Specifies the number of the z-output channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Sp"
---

# IRepTransformDataContextXYZInt.ZChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ZChannelNumberOut for TransformDataContextXYZ

Specifies the number of the z-output channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spikes , or Points in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.ZChannelNumberOut
```
...
*Source: `ReportApi/properties/Report_property_ZChannelNumberOut_IRepTransformDataContextXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
