---
title: "IRepD2AxisYTickInt.SpacingType"
description: "Specifies whether DIAdem REPORT takes the positions of the scaling ticks of the y-axis from a data channel or calculates the positions automatically."
---

# IRepD2AxisYTickInt.SpacingType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SpacingType for 2DAxisYTick

Specifies whether DIAdem REPORT takes the positions of the scaling ticks of the y-axis from a data channel or calculates the positions automatically.
...
*Source: `ReportApi/properties/Report_property_SpacingType_IRepD2AxisYTickInt.htm`*
