---
title: "IRepD2ShapeObjBarsInt.Settings"
description: "Specifies the curve properties in the Bars display mode in a 2D axis system in DIAdem REPORT."
---

# IRepD2ShapeObjBarsInt.Settings

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Settings for 2DBars

Specifies the curve properties in the Bars display mode in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Settings_IRepD2ShapeObjBarsInt.htm`*
