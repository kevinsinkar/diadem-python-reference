---
title: "IRepReferenceLineInt.X2"
description: "Specifies the second x-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system."
---

# IRepReferenceLineInt.X2

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X2 for ReferenceLine

Specifies the second x-value of the reference line along which DIAdem REPORT displays the contour values of a characteristic diagram in a 3D axis system.
...
*Source: `ReportApi/properties/Report_property_X2_IRepReferenceLineInt.htm`*
