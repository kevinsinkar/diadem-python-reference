---
title: "IRepD3CharacteristicDiagramIsolineAdditionalInt.Color"
description: "Specifies the isoline colors for the 3D display mode Characteristic diagram in DIAdem REPORT."
---

# IRepD3CharacteristicDiagramIsolineAdditionalInt.Color

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Color for 3DAdditionalCharacteristicDiagramIsoline

Specifies the isoline colors for the 3D display mode Characteristic diagram in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Color_IRepD3CharacteristicDiagramIsolineAdditionalInt.htm`*
