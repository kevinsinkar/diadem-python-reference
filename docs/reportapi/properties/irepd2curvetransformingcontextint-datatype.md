---
title: "IRepD2CurveTransformingContextInt.DataType"
description: "Specifies the type of data assignment for the curve transformation in a 2D axis system in DIAdem REPORT."
---

# IRepD2CurveTransformingContextInt.DataType

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DataType for D2CurveTransformingContext

Specifies the type of data assignment for the curve transformation in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_DataType_IRepD2CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
