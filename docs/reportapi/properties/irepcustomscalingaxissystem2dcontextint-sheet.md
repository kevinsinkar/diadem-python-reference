---
title: "IRepCustomScalingAxisSystem2DContextInt.Sheet"
description: "Returns in a 2D axis system in DIAdem REPORT the worksheet for which you use a user-defined axis scaling."
---

# IRepCustomScalingAxisSystem2DContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for CustomScalingAxisSystem2DContext

Returns in a 2D axis system in DIAdem REPORT the worksheet for which you use a user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepCustomScalingAxisSystem2DContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
