---
title: "IRepD3AxisXScalingInt.DateTimeRepresentation"
description: "Specifies whether the x-axis of a 3D axis system in DIAdem REPORT displays the time values as absolute or as relative time values."
---

# IRepD3AxisXScalingInt.DateTimeRepresentation

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DateTimeRepresentation for 3DAxisXScaling

Specifies whether the x-axis of a 3D axis system in DIAdem REPORT displays the time values as absolute or as relative time values.
...
*Source: `ReportApi/properties/Report_property_DateTimeRepresentation_IRepD3AxisXScalingInt.htm`*
