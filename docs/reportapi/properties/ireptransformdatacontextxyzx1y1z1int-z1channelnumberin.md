---
title: "IRepTransformDataContextXYZX1Y1Z1Int.Z1ChannelNumberIn"
description: "Specifies the number of the z1-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.Z1ChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Z1ChannelNumberIn for TransformDataContextXYZX1Y1Z1

Specifies the number of the z1-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.Z1ChannelNumberIn
```
...
*Source: `ReportApi/properties/Report_property_Z1ChannelNumberIn_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
