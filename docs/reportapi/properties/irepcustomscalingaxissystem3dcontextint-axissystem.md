---
title: "IRepCustomScalingAxisSystem3DContextInt.AxisSystem"
description: "Returns in a 3D axis system in DIAdem REPORT the axis system to which you assigned the user-defined axis scaling."
---

# IRepCustomScalingAxisSystem3DContextInt.AxisSystem

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem for CustomScalingAxisSystem3DContext
...
*Source: `ReportApi/properties/Report_property_AxisSystem_IRepCustomScalingAxisSystem3DContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
