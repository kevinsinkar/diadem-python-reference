---
title: "IRepD2ShapeObjFilledAreaSettingsInt.UseCurveExpansion"
description: "Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Filled area display mode."
---

# IRepD2ShapeObjFilledAreaSettingsInt.UseCurveExpansion

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseCurveExpansion for 2DFilledAreaSettings

Specifies whether DIAdem REPORT enables curve expansion when displaying 2D curves in the Filled area display mode.
...
*Source: `ReportApi/properties/Report_property_UseCurveExpansion_IRepD2ShapeObjFilledAreaSettingsInt.htm`*
