---
title: "IRepCoordinateLabelAdditionalInt.Type"
description: "Specifies the type of coordinate labels in 2D and 3D axis systems in the Coordinate display mode in DIAdem REPORT."
---

# IRepCoordinateLabelAdditionalInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for AdditionalCoordinateLabel

Specifies the type of coordinate labels in 2D and 3D axis systems in the Coordinate display mode in DIAdem REPORT.
...
| --- | ---: | --- |
| `eEndLabelNone` | 0 | None |
| `eEndLabelCoordinate` | 1 | Constant value |
| `eEndLabelCustomText` | 2 | Free text |
...
*Source: `ReportApi/properties/Report_property_Type_IRepCoordinateLabelAdditionalInt.htm`*
