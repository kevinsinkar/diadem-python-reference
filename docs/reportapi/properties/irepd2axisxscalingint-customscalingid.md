---
title: "IRepD2AxisXScalingInt.CustomScalingID"
description: "Specifies the ID of a user-defined axis scaling which you use for the x-axis of a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisXScalingInt.CustomScalingID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: CustomScalingID for 2DAxisXScaling

Specifies the ID of a user-defined axis scaling which you use for the x-axis of a 2D axis system in DIAdem REPORT.
...
oMyXScaling.AutoScalingType = eAxisAutoScalingCustom
...
*Source: `ReportApi/properties/Report_property_CustomScalingID_IRepD2AxisXScalingInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
