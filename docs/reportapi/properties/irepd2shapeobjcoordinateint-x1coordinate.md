---
title: "IRepD2ShapeObjCoordinateInt.X1Coordinate"
description: "Specifies the x1-coordinate of a 2D axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateInt.X1Coordinate

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: X1Coordinate for 2DCoordinate

Specifies the x1-coordinate of a 2D axis system in the Coordinate display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.X1Coordinate
```
...
*Source: `ReportApi/properties/Report_property_X1Coordinate_IRepD2ShapeObjCoordinateInt.htm`*
