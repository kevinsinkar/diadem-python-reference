---
title: "IRepTable3DInt.Y"
description: "Specifies the properties of the column with the y-values in a 3D table in DIAdem REPORT."
---

# IRepTable3DInt.Y

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y for 3DTable

Specifies the properties of the column with the y-values in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Y_IRepTable3DInt.htm`*
