---
title: "IRepD2CurveTransformingContextInt.AxisSystem"
description: "Specifies the 2D axis system for the curve transformation in DIAdem REPORT."
---

# IRepD2CurveTransformingContextInt.AxisSystem

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem for D2CurveTransformingContext

Specifies the 2D axis system for the curve transformation in DIAdem REPORT.
...
oMy2DAxisSystem2 = dd.Report.ActiveSheet.Objects.Add(eReportObject2DAxisSystem, "My2DAxisSystemTrans")
...
def MyOnCurveTransformation(Context):
    ...
    if Context.AxisSystem.Name == "My2DAxisSystemTrans":
...
*Source: `ReportApi/properties/Report_property_AxisSystem_IRepD2CurveTransformingContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
