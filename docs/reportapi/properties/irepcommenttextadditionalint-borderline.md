---
title: "IRepCommentTextAdditionalInt.BorderLine"
description: "Specifies the properties of the frame line of an additional comment in DIAdem REPORT."
---

# IRepCommentTextAdditionalInt.BorderLine

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BorderLine for AdditionalCommentText

Specifies the properties of the frame line of an additional comment in DIAdem REPORT.
...
oMyBorderLine = oMyCoordComment.Comment.BorderLine
oMyBorderLine.LineType = dd.eLineTypeDashDot
...
*Source: `ReportApi/properties/Report_property_BorderLine_IRepCommentTextAdditionalInt.htm`*
