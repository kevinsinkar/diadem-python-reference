---
title: "IRepTransformDataContextXYZX1Y1Z1Int.Z1ChannelNumberOut"
description: "Specifies the number of the z1-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.Z1ChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Z1ChannelNumberOut for TransformDataContextXYZX1Y1Z1

Specifies the number of the z1-output channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.Z1ChannelNumberOut
```
...
*Source: `ReportApi/properties/Report_property_Z1ChannelNumberOut_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
