---
title: "IRepTextSimpleInt.ObjectType"
description: "Specifies the object type in DIAdem REPORT."
---

# IRepTextSimpleInt.ObjectType
...
dd.MsgBoxDisp(oMyText.ObjectType)
```
...
*Source: `ReportApi/properties/Report_property_ObjectType_IRepTextSimpleInt.htm`*
