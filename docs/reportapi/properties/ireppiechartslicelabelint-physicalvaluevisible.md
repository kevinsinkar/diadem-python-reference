---
title: "IRepPieChartSliceLabelInt.PhysicalValueVisible"
description: "Specifies whether DIAdem REPORT displays the physical values in the slice labels of a pie chart."
---

# IRepPieChartSliceLabelInt.PhysicalValueVisible

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: PhysicalValueFormat for PieChartSliceLabel

Specifies whether DIAdem REPORT displays the physical values in the slice labels of a pie chart.

## Signature

```python
obj.PhysicalValueVisible
```
...
*Source: `ReportApi/properties/Report_property_PhysicalValueVisible_IRepPieChartSliceLabelInt.htm`*
