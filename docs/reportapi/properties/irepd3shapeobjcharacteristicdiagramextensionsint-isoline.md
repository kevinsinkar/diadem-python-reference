---
title: "IRepD3ShapeObjCharacteristicDiagramExtensionsInt.Isoline"
description: "Specifies the isoline properties for the 3D display mode Characteristic diagram in DIAdem REPORT."
---

# IRepD3ShapeObjCharacteristicDiagramExtensionsInt.Isoline

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Isoline for 3DCharacteristicDiagramExtensions

Specifies the isoline properties for the 3D display mode Characteristic diagram in DIAdem REPORT.

## Signature

```python
return_value = obj.Isoline
```
...
*Source: `ReportApi/properties/Report_property_Isoline_IRepD3ShapeObjCharacteristicDiagramExtensionsInt.htm`*
