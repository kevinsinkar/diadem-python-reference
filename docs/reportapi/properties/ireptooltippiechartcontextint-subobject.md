---
title: "IRepToolTipPieChartContextInt.SubObject"
description: "Returns a subobject of a pie chart in DIAdem REPORT when DIAdem calls the event assigned to the OnPieChart for ToolTipEvents property. DIAdem calls this event i"
---

# IRepToolTipPieChartContextInt.SubObject

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SubObject for ToolTipPieChartContext

Returns a subobject of a pie chart in DIAdem REPORT when DIAdem calls the event assigned to the OnPieChart for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_SubObject_IRepToolTipPieChartContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
