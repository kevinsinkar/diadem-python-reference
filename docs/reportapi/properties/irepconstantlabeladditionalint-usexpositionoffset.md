---
title: "IRepConstantLabelAdditionalInt.UseXPositionOffset"
description: "Specifies whether DIAdem REPORT plots the constant labels at the x-value of the curve point or at an angle to the x-value in a 2D axis system in the Constant di"
---

# IRepConstantLabelAdditionalInt.UseXPositionOffset

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseXPositionOffset for AdditionalConstantLabel

Specifies whether DIAdem REPORT plots the constant labels at the x-value of the curve point or at an angle to the x-value in a 2D axis system in the Constant display mode.
...
*Source: `ReportApi/properties/Report_property_UseXPositionOffset_IRepConstantLabelAdditionalInt.htm`*
