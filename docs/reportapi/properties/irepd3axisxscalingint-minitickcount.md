---
title: "IRepD3AxisXScalingInt.MiniTickCount"
description: "Specifies the number of miniticks between the scale ticks on the x-axis of a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisXScalingInt.MiniTickCount

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MiniTickCount for 3DAxisXScaling

Specifies the number of miniticks between the scale ticks on the x-axis of a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_MiniTickCount_IRepD3AxisXScalingInt.htm`*
