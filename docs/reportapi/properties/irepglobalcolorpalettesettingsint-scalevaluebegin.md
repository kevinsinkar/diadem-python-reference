---
title: "IRepGlobalColorPaletteSettingsInt.ScaleValueBegin"
description: "Specifies the lower boundary of the value range in a global color palette in DIAdem REPORT."
---

# IRepGlobalColorPaletteSettingsInt.ScaleValueBegin

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ScaleValueBegin for GlobalColorPaletteSettings

Specifies the lower boundary of the value range in a global color palette in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ScaleValueBegin_IRepGlobalColorPaletteSettingsInt.htm`*
