---
title: "IRepD2BarFillingInt.LineWidth"
description: "Specifies the line width of the filling in a bar display in a 2D axis system in DIAdem REPORT."
---

# IRepD2BarFillingInt.LineWidth

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: LineWidth for 2DBarFilling

Specifies the line width of the filling in a bar display in a 2D axis system in DIAdem REPORT.
...
oMyFilling.LineWidth = dd.eLineWidth0070
dd.Report.Refresh()
```
...
*Source: `ReportApi/properties/Report_property_LineWidth_IRepD2BarFillingInt.htm`*
