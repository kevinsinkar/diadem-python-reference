---
title: "IRepToolTipArrowContextInt.Sheet"
description: "Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event if you press the sh"
---

# IRepToolTipArrowContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for ToolTipArrowContext

Returns a worksheet in DIAdem REPORT when DIAdem calls the event assigned to the OnArrow for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepToolTipArrowContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
