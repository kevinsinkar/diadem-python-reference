---
title: "IRepD2ShapeObjCoordinateSettingsInt.MarkerFilling"
description: "Specifies the marker filling of an additional comment in the Coordinate 2D display mode in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateSettingsInt.MarkerFilling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MarkerFilling for 2DCoordinateSettings

Specifies the marker filling of an additional comment in the Coordinate 2D display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.MarkerFilling
```
...
*Source: `ReportApi/properties/Report_property_MarkerFilling_IRepD2ShapeObjCoordinateSettingsInt.htm`*
