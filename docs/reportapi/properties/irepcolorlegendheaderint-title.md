---
title: "IRepColorLegendHeaderInt.Title"
description: "Specifies the title of a color legend in an axis system in DIAdem REPORT."
---

# IRepColorLegendHeaderInt.Title

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Title for ColorLegendHeader

Specifies the title of a color legend in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Title_IRepColorLegendHeaderInt.htm`*
