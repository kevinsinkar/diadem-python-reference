---
title: "IRepD3ShapeObjVectorInt.XChannel"
description: "Specifies the x-channel for the start points of a curve in a 3D axis system with the Vector display mode in DIAdem REPORT."
---

# IRepD3ShapeObjVectorInt.XChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannel for 3DVector

Specifies the x-channel for the start points of a curve in a 3D axis system with the Vector display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannel_IRepD3ShapeObjVectorInt.htm`*
