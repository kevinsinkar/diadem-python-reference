---
title: "IRepTransformDataContextXYY1Int.YChannelNumberOut"
description: "Specifies the number of the y-output channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel,"
---

# IRepTransformDataContextXYY1Int.YChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YChannelNumberOut for TransformDataContextXYY1

Specifies the number of the y-output channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel, in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_YChannelNumberOut_IRepTransformDataContextXYY1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
