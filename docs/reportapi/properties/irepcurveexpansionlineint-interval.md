---
title: "IRepCurveExpansionLineInt.Interval"
description: "Specifies the line interval for broken lines of an expanding curve in DIAdem REPORT if you assign the value TRUE to the UseLineInterval property. Greater values"
---

# IRepCurveExpansionLineInt.Interval

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Interval for CurveExpansionLine

Specifies the line interval for broken lines of an expanding curve in DIAdem REPORT if you assign the value TRUE to the UseLineInterval property. Greater values mean greater intervals.
...
*Source: `ReportApi/properties/Report_property_Interval_IRepCurveExpansionLineInt.htm`*
