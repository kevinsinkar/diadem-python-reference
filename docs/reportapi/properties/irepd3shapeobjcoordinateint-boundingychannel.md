---
title: "IRepD3ShapeObjCoordinateInt.BoundingYChannel"
description: "Specifies the y-channel to which the BoundingPosition property of a channel-bound coordinate of a 3D axis system in DIAdem REPORT refers."
---

# IRepD3ShapeObjCoordinateInt.BoundingYChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingYChannel for 3DCoordinate

Specifies the y-channel to which the BoundingPosition property of a channel-bound coordinate of a 3D axis system in DIAdem REPORT refers.
...
*Source: `ReportApi/properties/Report_property_BoundingYChannel_IRepD3ShapeObjCoordinateInt.htm`*
