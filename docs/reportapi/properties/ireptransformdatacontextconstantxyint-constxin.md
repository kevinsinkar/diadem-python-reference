---
title: "IRepTransformDataContextConstantXYInt.ConstXIn"
description: "Specifies the values of the x-input constants for the curve transformation of a curve with the Constant or Coordinate display type in a 2D axis system in DIAdem"
---

# IRepTransformDataContextConstantXYInt.ConstXIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstXIn for TransformDataContextConstantXY

Specifies the values of the x-input constants for the curve transformation of a curve with the Constant or Coordinate display type in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstXIn_IRepTransformDataContextConstantXYInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
