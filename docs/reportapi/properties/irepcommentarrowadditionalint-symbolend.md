---
title: "IRepCommentArrowAdditionalInt.SymbolEnd"
description: "Specifies the type of arrowhead which DIAdem REPORT plots at the end of a comment arrow in the 2D display mode Coordinate ."
---

# IRepCommentArrowAdditionalInt.SymbolEnd

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SymbolEnd for AdditionalCommentArrow

Specifies the type of arrowhead which DIAdem REPORT plots at the end of a comment arrow in the 2D display mode Coordinate .
...
*Source: `ReportApi/properties/Report_property_SymbolEnd_IRepCommentArrowAdditionalInt.htm`*
