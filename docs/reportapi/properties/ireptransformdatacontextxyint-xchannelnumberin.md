---
title: "IRepTransformDataContextXYInt.XChannelNumberIn"
description: "Specifies the number of the x-input channel for the Curve Transformation of a curve, whose data originates from an x-channel and a y-channel, in a 2D axis syste"
---

# IRepTransformDataContextXYInt.XChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberIn for TransformDataContextXY

Specifies the number of the x-input channel for the Curve Transformation of a curve, whose data originates from an x-channel and a y-channel, in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannelNumberIn_IRepTransformDataContextXYInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
