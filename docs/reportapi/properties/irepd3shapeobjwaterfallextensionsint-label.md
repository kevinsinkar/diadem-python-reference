---
title: "IRepD3ShapeObjWaterfallExtensionsInt.Label"
description: "Specifies the curve labels in the Waterfall display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjWaterfallExtensionsInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for 3DWaterfallExtensions

Specifies the curve labels in the Waterfall display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepD3ShapeObjWaterfallExtensionsInt.htm`*
