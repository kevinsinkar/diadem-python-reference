---
title: "IRepReportEventsInt.ClickedWithKey"
description: "Returns the object in DIAdem REPORT that provides the events when clicking a REPORT object while pressing a key."
---

# IRepReportEventsInt.ClickedWithKey

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ClickedWithKey for Events

Returns the object in DIAdem REPORT that provides the events when clicking a REPORT object while pressing a key.

## Signature

```python
return_value = obj.ClickedWithKey
```
...
*Source: `ReportApi/properties/Report_property_ClickedWithKey_IRepReportEventsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
