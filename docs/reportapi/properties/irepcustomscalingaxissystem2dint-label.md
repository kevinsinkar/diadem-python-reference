---
title: "IRepCustomScalingAxisSystem2DInt.Label"
description: "Specifies the label for a user-defined axis scaling on the Axis Parameters tab in the Curve and Axis Definition dialog box in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DInt.Label

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Label for AxisSystem2DCustomScaling

Specifies the label for a user-defined axis scaling on the Axis Parameters tab in the Curve and Axis Definition dialog box in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Label_IRepCustomScalingAxisSystem2DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
