---
title: "IRepD3CharacteristicDiagramIsolineAdditionalInt.Type"
description: "Specifies the origins of the isovalues for the 3D display mode Characteristic diagram in DIAdem REPORT."
---

# IRepD3CharacteristicDiagramIsolineAdditionalInt.Type

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Type for 3DAdditionalCharacteristicDiagramIsoline

Specifies the origins of the isovalues for the 3D display mode Characteristic diagram in DIAdem REPORT.
...
| --- | ---: | --- |
| `Entered` | 8 | e3DCharacteristicIsoValueFromIsoValueTable |
...
*Source: `ReportApi/properties/Report_property_Type_IRepD3CharacteristicDiagramIsolineAdditionalInt.htm`*
