---
title: "IRepTransformDataContextConstantXYZInt.ConstXOut"
description: "Specifies the values of the x-output constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextConstantXYZInt.ConstXOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstXOut for TransformDataContextConstantXYZ

Specifies the values of the x-output constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstXOut_IRepTransformDataContextConstantXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
