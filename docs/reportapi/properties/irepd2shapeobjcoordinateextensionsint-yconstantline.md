---
title: "IRepD2ShapeObjCoordinateExtensionsInt.YConstantLine"
description: "Specifies the horizontal line through a y-coordinate in a 2D axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepD2ShapeObjCoordinateExtensionsInt.YConstantLine

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YConstantLine for 2DCoordinateExtensions

Specifies the horizontal line through a y-coordinate in a 2D axis system in the Coordinate display mode in DIAdem REPORT.

## Signature

```python
return_value = obj.YConstantLine
```
...
*Source: `ReportApi/properties/Report_property_YConstantLine_IRepD2ShapeObjCoordinateExtensionsInt.htm`*
