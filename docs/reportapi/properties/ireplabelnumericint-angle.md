---
title: "IRepLabelNumericInt.Angle"
description: "Specifies the angle of the scale labels of the axis in an axis system in DIAdem REPORT."
---

# IRepLabelNumericInt.Angle

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Angle for LabelNumeric

Specifies the angle of the scale labels of the axis in an axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Angle_IRepLabelNumericInt.htm`*
