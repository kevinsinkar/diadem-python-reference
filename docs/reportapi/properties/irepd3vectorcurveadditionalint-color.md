---
title: "IRepD3VectorCurveAdditionalInt.Color"
description: "Specifies the color of the additional 3D curve in the Vector display mode in a 3D axis system in DIAdem REPORT. Use the Visible property to enable additional 3D"
---

# IRepD3VectorCurveAdditionalInt.Color

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Color for 3DAdditionalVectorCurve

Specifies the color of the additional 3D curve in the Vector display mode in a 3D axis system in DIAdem REPORT. Use the Visible property to enable additional 3D curves.
...
*Source: `ReportApi/properties/Report_property_Color_IRepD3VectorCurveAdditionalInt.htm`*
