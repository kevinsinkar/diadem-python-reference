---
title: "IRepTransformDataContextXYInt.XChannelNumberOut"
description: "Specifies the number of the x-output channel for the Curve Transformation of a curve, whose data originates from an x-channel and a y-channel, in a 2D axis syst"
---

# IRepTransformDataContextXYInt.XChannelNumberOut

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: XChannelNumberOut for TransformDataContextXY

Specifies the number of the x-output channel for the Curve Transformation of a curve, whose data originates from an x-channel and a y-channel, in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_XChannelNumberOut_IRepTransformDataContextXYInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
