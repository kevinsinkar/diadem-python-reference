---
title: "IRepTransformDataContextConstantXYZInt.ConstXIn"
description: "Specifies the values of the x-input constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextConstantXYZInt.ConstXIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ConstXIn for TransformDataContextConstantXY

Specifies the values of the x-input constants for the curve transformation of a curve with the Coordinate display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ConstXIn_IRepTransformDataContextConstantXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
