---
title: "IRepTransformDataContextXYZInt.ZChannelNumberIn"
description: "Specifies the number of the z-input channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spi"
---

# IRepTransformDataContextXYZInt.ZChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ZChannelNumberIn for TransformDataContextXYZ

Specifies the number of the z-input channel for the Curve Transformation of a 3D curve, whose data is in triplet structure, for example Surface , 3D curve , Spikes , or Points , in a 3D axis system in DIAdem REPORT.

## Signature

```python
obj.ZChannelNumberIn
```
...
*Source: `ReportApi/properties/Report_property_ZChannelNumberIn_IRepTransformDataContextXYZInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
