---
title: "IRepPolarDropContextInt.Sheet"
description: "Specifies the worksheet which contains the polar axis system onto which you dragged and dropped an object."
---

# IRepPolarDropContextInt.Sheet

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Sheet for PolarSystemDropContext

Specifies the worksheet which contains the polar axis system onto which you dragged and dropped an object.
...
*Source: `ReportApi/properties/Report_property_Sheet_IRepPolarDropContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
