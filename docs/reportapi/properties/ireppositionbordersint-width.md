---
title: "IRepPositionBordersInt.Width"
description: "Specifies, in DIAdem REPORT, the width of an object as a percentage of the page area, in cm or in inches, if you use the margins to position the object. Because"
---

# IRepPositionBordersInt.Width

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Width for ObjectPositionDefinedByBorders

Specifies, in DIAdem REPORT, the width of an object as a percentage of the page area, in cm or in inches, if you use the margins to position the object. Because you can use either the Bottom , Height , Left , Right , Top , and Width for the ObjectPositionDefinedByBorders property, or the Height , Width , X1 , X2 , Y1 , and Y2 for the ObjectPositionDefinedByCoordinates property to specify the position, these properties impact each other and the value of the property set first can be modified by another property.
...
*Source: `ReportApi/properties/Report_property_Width_IRepPositionBordersInt.htm`*
