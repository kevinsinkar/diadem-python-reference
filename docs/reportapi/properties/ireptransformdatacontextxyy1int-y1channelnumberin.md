---
title: "IRepTransformDataContextXYY1Int.Y1ChannelNumberIn"
description: "Specifies the number of the y1-input channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel,"
---

# IRepTransformDataContextXYY1Int.Y1ChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Y1ChannelNumberIn for TransformDataContextXYY1

Specifies the number of the y1-input channel for the Curve Transformation of a 2D curve, whose data originates from an x-channel, a y-channel, and a y1-channel, in a 2D axis system in DIAdem REPORT.

## Signature

```python
obj.Y1ChannelNumberIn
```
...
*Source: `ReportApi/properties/Report_property_Y1ChannelNumberIn_IRepTransformDataContextXYY1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
