---
title: "IRepTable2DDrawingHeaderFooterCellContextInt.Col"
description: "Determines the column number of the currently drawn cell of a header or footer row of a 2D table in DIAdem-REPORT within the user command. The object of type 2D"
---

# IRepTable2DDrawingHeaderFooterCellContextInt.Col

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Col for 2DTableDrawingHeaderFooterCellContext
...
*Source: `ReportApi/properties/Report_property_Col_IRepTable2DDrawingHeaderFooterCellContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
