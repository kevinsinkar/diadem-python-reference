---
title: "IRepTable2DSettingsInt.GridHorizontal"
description: "Specifies the horizontal grid of a 2D table in DIAdem REPORT."
---

# IRepTable2DSettingsInt.GridHorizontal

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: GridHorizontal for 2DTableSettings

Specifies the horizontal grid of a 2D table in DIAdem REPORT.

## Signature

```python
return_value = obj.GridHorizontal
```
...
*Source: `ReportApi/properties/Report_property_GridHorizontal_IRepTable2DSettingsInt.htm`*
