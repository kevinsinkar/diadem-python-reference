---
title: "IRepCustomScalingAxisSystem2DScaledContextInt.AxisSystem"
description: "Returns in a 2D axis system in scaled display in DIAdem REPORT the axis system to which you assigned the user-defined axis scaling."
---

# IRepCustomScalingAxisSystem2DScaledContextInt.AxisSystem

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: AxisSystem for CustomScalingAxisSystem2DScaledContext

Returns in a 2D axis system in scaled display in DIAdem REPORT the axis system to which you assigned the user-defined axis scaling.
...
*Source: `ReportApi/properties/Report_property_AxisSystem_IRepCustomScalingAxisSystem2DScaledContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
