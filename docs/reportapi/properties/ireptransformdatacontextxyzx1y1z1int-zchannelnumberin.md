---
title: "IRepTransformDataContextXYZX1Y1Z1Int.ZChannelNumberIn"
description: "Specifies the number of the z-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT."
---

# IRepTransformDataContextXYZX1Y1Z1Int.ZChannelNumberIn

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ZChannelNumberIn for TransformDataContextXYZX1Y1Z1

Specifies the number of the z-input channel for the Curve Transformation of a curve with a 6D vector display type in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_ZChannelNumberIn_IRepTransformDataContextXYZX1Y1Z1Int.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
