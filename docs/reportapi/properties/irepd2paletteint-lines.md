---
title: "IRepD2PaletteInt.Lines"
description: "Specifies the line properties of a palette in a 2D axis systems or a polar axis systems in DIAdem REPORT."
---

# IRepD2PaletteInt.Lines

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Lines for 2DPalette

Specifies the line properties of a palette in a 2D axis systems or a polar axis systems in DIAdem REPORT.

## Signature

```python
return_value = obj.Lines
```
...
*Source: `ReportApi/properties/Report_property_Lines_IRepD2PaletteInt.htm`*
