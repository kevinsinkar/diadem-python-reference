---
title: "IRepD3AxisYScalingInt.MiniTickCount"
description: "Specifies the number of miniticks between the scale ticks on the y-axis of a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisYScalingInt.MiniTickCount

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: MiniTickCount for 3DAxisYScaling

Specifies the number of miniticks between the scale ticks on the y-axis of a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_MiniTickCount_IRepD3AxisYScalingInt.htm`*
