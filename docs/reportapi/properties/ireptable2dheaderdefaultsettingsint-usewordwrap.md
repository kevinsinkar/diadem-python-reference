---
title: "IRepTable2DHeaderDefaultSettingsInt.UseWordWrap"
description: "Specifies whether DIAdem REPORT wraps header and footer text of a 2D table. You must assign the value False to the UseAutoFontSize property because DIAdem REPOR"
---

# IRepTable2DHeaderDefaultSettingsInt.UseWordWrap

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: UseWordWrap for 2DTableColumnHeaderFooterDefaultSettings

Specifies whether DIAdem REPORT wraps header and footer text of a 2D table. You must assign the value False to the UseAutoFontSize property because DIAdem REPORT otherwise adjusts the font size of the text to the size of the cell.
...
*Source: `ReportApi/properties/Report_property_UseWordWrap_IRepTable2DHeaderDefaultSettingsInt.htm`*
