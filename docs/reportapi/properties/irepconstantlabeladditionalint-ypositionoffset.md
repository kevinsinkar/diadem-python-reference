---
title: "IRepConstantLabelAdditionalInt.YPositionOffset"
description: "Specifies the vertical offset of the curve end label as a percentage in a 2D axis system in DIAdem REPORT."
---

# IRepConstantLabelAdditionalInt.YPositionOffset

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: YPositionOffset for AdditionalConstantLabel
...
*Source: `ReportApi/properties/Report_property_YPositionOffset_IRepConstantLabelAdditionalInt.htm`*
