---
title: "IRepCustomScalingAxisSystem2DInt.ID"
description: "Specifies the ID of a user-defined scaling in a 2D axis system in DIAdem REPORT. The ID links the axis to a user-defined scaling."
---

# IRepCustomScalingAxisSystem2DInt.ID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ID for AxisSystem2DCustomScaling

Specifies the ID of a user-defined scaling in a 2D axis system in DIAdem REPORT. The ID links the axis to a user-defined scaling.
...
MsgBoxDisp("ID: "& oMyCustomScalings(1).ID)
...
*Source: `ReportApi/properties/Report_property_ID_IRepCustomScalingAxisSystem2DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
