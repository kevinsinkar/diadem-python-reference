---
title: "IRepCustomScalingAxisSystem3DInt.ID"
description: "Specifies the ID of a user-defined axis scaling in a 3D axis system in DIAdem REPORT. The ID links the axis to a user-defined scaling."
---

# IRepCustomScalingAxisSystem3DInt.ID

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: ID for AxisSystem3DCustomScaling

Specifies the ID of a user-defined axis scaling in a 3D axis system in DIAdem REPORT. The ID links the axis to a user-defined scaling.
...
MsgBoxDisp("ID: "& oMyCustomScalingObj.ID)
...
*Source: `ReportApi/properties/Report_property_ID_IRepCustomScalingAxisSystem3DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
