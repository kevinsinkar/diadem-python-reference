---
title: "IRepCustomScalingAxisSystem2DInt.Index"
description: "Specifies the index of a user-defined axis scaling in the list of user-defined axis scalings in a 2D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DInt.Index

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Index for AxisSystem2DCustomScaling

Specifies the index of a user-defined axis scaling in the list of user-defined axis scalings in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Index_IRepCustomScalingAxisSystem2DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
