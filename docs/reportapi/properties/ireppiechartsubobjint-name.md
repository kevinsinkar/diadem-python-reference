---
title: "IRepPieChartSubObjInt.Name"
description: "Returns the name of the subobject of a pie chart in DIAdem REPORT when DIAdem calls the event assigned to the property OnPieChart for ToolTipEvents . DIAdem cal"
---

# IRepPieChartSubObjInt.Name

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Name for PieChartSubObj

Returns the name of the subobject of a pie chart in DIAdem REPORT when DIAdem calls the event assigned to the property OnPieChart for ToolTipEvents . DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_Name_IRepPieChartSubObjInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
