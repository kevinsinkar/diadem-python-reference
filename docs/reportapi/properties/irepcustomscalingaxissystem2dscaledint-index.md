---
title: "IRepCustomScalingAxisSystem2DScaledInt.Index"
description: "Specifies the scaled display of the index of a user-defined axis scaling in the list of user-defined axis scalings, in a 2D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DScaledInt.Index

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Index for AxisSystem2DScaledCustomScaling

Specifies the scaled display of the index of a user-defined axis scaling in the list of user-defined axis scalings, in a 2D axis system in DIAdem REPORT.
...
MsgBoxDisp("Index: " + oMyCustomScalingObj.Index)
...
*Source: `ReportApi/properties/Report_property_Index_IRepCustomScalingAxisSystem2DScaledInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
