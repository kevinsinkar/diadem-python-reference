---
title: "IRepD3AxisXScalingInt.Tick"
description: "Specifies the properties of the x-axis ticks in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisXScalingInt.Tick

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Tick for 3DAxisXScaling

Specifies the properties of the x-axis ticks in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Tick_IRepD3AxisXScalingInt.htm`*
