---
title: "IRepD2ShapeObjCoordinateInt.BoundingYChannel"
description: "Specifies the y-channel to which the BoundingPosition property of a channel-bound coordinate of a 2D axis system in DIAdem REPORT refers."
---

# IRepD2ShapeObjCoordinateInt.BoundingYChannel

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: BoundingYChannel for 2DCoordinate

Specifies the y-channel to which the BoundingPosition property of a channel-bound coordinate of a 2D axis system in DIAdem REPORT refers.

## Signature

```python
return_value = obj.BoundingYChannel
```
...
*Source: `ReportApi/properties/Report_property_BoundingYChannel_IRepD2ShapeObjCoordinateInt.htm`*
