---
title: "IRepD3ShapeObjCoordinateInt.DataStructure"
description: "Specifies the data structure of a curve in the Coordinate display mode in a 3D axis system in DIAdem REPORT."
---

# IRepD3ShapeObjCoordinateInt.DataStructure

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: DataStructure for 3DCoordinate

Specifies the data structure of a curve in the Coordinate display mode in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_DataStructure_IRepD3ShapeObjCoordinateInt.htm`*
