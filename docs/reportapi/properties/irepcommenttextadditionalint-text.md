---
title: "IRepCommentTextAdditionalInt.Text"
description: "Specifies the text of an additional comment in an axis system in the Coordinate display mode in DIAdem REPORT."
---

# IRepCommentTextAdditionalInt.Text

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Text for AdditionalCommentText

Specifies the text of an additional comment in an axis system in the Coordinate display mode in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Text_IRepCommentTextAdditionalInt.htm`*
