---
title: "IRepToolTipSpiderContextInt.SubObject"
description: "Returns a subobject of a spider axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls this "
---

# IRepToolTipSpiderContextInt.SubObject

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: SubObject for ToolTipSpiderContext

Returns a subobject of a spider axis system in DIAdem REPORT when DIAdem calls the event assigned to the OnSpider for ToolTipEvents property. DIAdem calls this event if you press the shift key and move the mouse over a REPORT object.
...
*Source: `ReportApi/properties/Report_property_SubObject_IRepToolTipSpiderContextInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
