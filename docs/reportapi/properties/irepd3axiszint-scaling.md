---
title: "IRepD3AxisZInt.Scaling"
description: "Specifies the scaling of the z-axis in a 3D axis system in DIAdem REPORT."
---

# IRepD3AxisZInt.Scaling

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: Scaling for 3DAxisZ

Specifies the scaling of the z-axis in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/properties/Report_property_Scaling_IRepD3AxisZInt.htm`*
