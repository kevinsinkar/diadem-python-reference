...
# IRepCircleInt.TagStored

!!! abstract "Property &middot; `ReportApi.chm`"
    Property: TagStored for Circle
...
*Source: `ReportApi/properties/Report_property_TagStored_IRepCircleInt.htm`*
