---
title: "IRepCustomScalingAxisSystem3DListInt.Item"
description: "Returns in a 3D axis system in DIAdem REPORT the user-defined axis scaling associated with a specific ID or a specific index."
---

# IRepCustomScalingAxisSystem3DListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for AxisSystem3DCustomScalings

Returns in a 3D axis system in DIAdem REPORT the user-defined axis scaling associated with a specific ID or a specific index.
...
*Source: `ReportApi/methods/Report_method_Item_IRepCustomScalingAxisSystem3DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
