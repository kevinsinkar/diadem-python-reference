---
title: "IRepCustomScalingAxisSystem2DListInt.Item"
description: "Returns the user-defined axis scaling associated with a specific ID or a specific index in a 2D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DListInt.Item
...
*Source: `ReportApi/methods/Report_method_Item_IRepCustomScalingAxisSystem2DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
