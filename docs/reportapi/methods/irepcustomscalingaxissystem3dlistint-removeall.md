---
title: "IRepCustomScalingAxisSystem3DListInt.RemoveAll"
description: "Deletes all user-defined axis scalings in a 3D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DListInt.RemoveAll

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: RemoveAll for AxisSystem3DCustomScalings

Deletes all user-defined axis scalings in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_RemoveAll_IRepCustomScalingAxisSystem3DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
