---
title: "IRepD2SelectedSubObjectsListInt.Item"
description: "Returns the selected element associated with a specific index in a 2D axis system in DIAdem REPORT."
---

# IRepD2SelectedSubObjectsListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for 2DSelectedElements

Returns the selected element associated with a specific index in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepD2SelectedSubObjectsListInt.htm`*
