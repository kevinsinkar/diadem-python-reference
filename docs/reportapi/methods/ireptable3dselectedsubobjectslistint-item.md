---
title: "IRepTable3DSelectedSubObjectsListInt.Item"
description: "Returns the selected element associated with a specific index in a 3D table in DIAdem REPORT."
---

# IRepTable3DSelectedSubObjectsListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for 3DTableSelectedElements

Returns the selected element associated with a specific index in a 3D table in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepTable3DSelectedSubObjectsListInt.htm`*
