---
title: "IRepBackgroundColorInt.SetPredefinedColor"
description: "Assigns a pre-defined background color to an object in DIAdem REPORT. The method also specifies the Color object properties which are necessary to display the p"
---

# IRepBackgroundColorInt.SetPredefinedColor

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: SetPredefinedColor for BackgroundColor

Assigns a pre-defined background color to an object in DIAdem REPORT. The method also specifies the Color object properties which are necessary to display the predefined colors.
...
*Source: `ReportApi/methods/Report_method_SetPredefinedColor_IRepBackgroundColorInt.htm`*
