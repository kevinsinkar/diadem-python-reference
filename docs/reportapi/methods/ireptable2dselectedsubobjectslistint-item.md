---
title: "IRepTable2DSelectedSubObjectsListInt.Item"
description: "Returns the selected element associated with a specific index in a 2D table in DIAdem REPORT."
---

# IRepTable2DSelectedSubObjectsListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for 2DTableSelectedElements

Returns the selected element associated with a specific index in a 2D table in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepTable2DSelectedSubObjectsListInt.htm`*
