---
title: "IRepCustomScalingAxisSystem3DListInt.Remove"
description: "Deletes a user-defined axis scaling in a 3D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DListInt.Remove

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Remove for AxisSystem3DCustomScalings

Deletes a user-defined axis scaling in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Remove_IRepCustomScalingAxisSystem3DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
