---
title: "IRepPolarInt.ExportToImage"
description: "Exports a polar axis system from DIAdem REPORT to a graphics file."
---

# IRepPolarInt.ExportToImage
...
*Source: `ReportApi/methods/Report_method_ExportToImage_IRepPolarInt.htm`*
