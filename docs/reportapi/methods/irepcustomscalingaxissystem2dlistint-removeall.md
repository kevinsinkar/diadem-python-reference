---
title: "IRepCustomScalingAxisSystem2DListInt.RemoveAll"
description: "Deletes all user-defined axis scalings in a 2D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DListInt.RemoveAll

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: RemoveAll for AxisSystem2DCustomScalings

Deletes all user-defined axis scalings in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_RemoveAll_IRepCustomScalingAxisSystem2DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
