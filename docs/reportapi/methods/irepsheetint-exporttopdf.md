---
title: "IRepSheetInt.ExportToPDF"
description: "Exports a worksheet from DIAdem REPORT to a PDF file."
---

# IRepSheetInt.ExportToPDF
...
```python
obj.ExportToPDF(FileName, Append)
```
...
oMySheet.ExportToPDF("MySheet", False)
```
...
*Source: `ReportApi/methods/Report_method_ExportToPDF_IRepSheetInt.htm`*
