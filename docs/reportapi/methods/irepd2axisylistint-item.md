---
title: "IRepD2AxisYListInt.Item"
description: "Returns the y-axis of a 2D axis system, which is associated with a specific name or with a specific index, in DIAdem REPORT."
---

# IRepD2AxisYListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for 2DAxisYAxisList

Returns the y-axis of a 2D axis system, which is associated with a specific name or with a specific index, in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepD2AxisYListInt.htm`*
