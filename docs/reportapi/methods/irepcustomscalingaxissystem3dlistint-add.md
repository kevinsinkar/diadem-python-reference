---
title: "IRepCustomScalingAxisSystem3DListInt.Add"
description: "Adds a user-defined axis scaling to a 3D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DListInt.Add

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Add for AxisSystem3DCustomScalings

Adds a user-defined axis scaling to a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Add_IRepCustomScalingAxisSystem3DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
