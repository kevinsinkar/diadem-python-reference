---
title: "IRepCustomScalingAxisSystem2DListInt.Remove"
description: "Deletes a user-defined axis scaling in a 2D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem2DListInt.Remove

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Remove for AxisSystem2DCustomScalings

Deletes a user-defined axis scaling in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Remove_IRepCustomScalingAxisSystem2DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
