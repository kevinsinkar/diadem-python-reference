---
title: "IRepCustomScalingAxisSystem2DScaledListInt.RemoveAll"
description: "Deletes all user-defined axis scalings in a 2D axis system in DIAdem REPORT in scaled display."
---

# IRepCustomScalingAxisSystem2DScaledListInt.RemoveAll

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: RemoveAll for AxisSystem2DScaledCustomScalings

Deletes all user-defined axis scalings in a 2D axis system in DIAdem REPORT in scaled display.
...
*Source: `ReportApi/methods/Report_method_RemoveAll_IRepCustomScalingAxisSystem2DScaledListInt.htm`*
