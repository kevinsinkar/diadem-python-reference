---
title: "IRepSpiderInt.ExportToImage"
description: "Exports a spider axis system from DIAdem REPORT to a graphics file."
---

# IRepSpiderInt.ExportToImage
...
*Source: `ReportApi/methods/Report_method_ExportToImage_IRepSpiderInt.htm`*
