---
title: "IRepPolarCurveListInt.Item"
description: "Returns the curve of a polar axis system associated with a specific name or a specific index, in DIAdem REPORT."
---

# IRepPolarCurveListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for PolarCurves

Returns the curve of a polar axis system associated with a specific name or a specific index, in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepPolarCurveListInt.htm`*
