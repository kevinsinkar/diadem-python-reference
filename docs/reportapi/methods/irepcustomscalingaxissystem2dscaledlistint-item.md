---
title: "IRepCustomScalingAxisSystem2DScaledListInt.Item"
description: "Returns in a 2D axis system in DIAdem REPORT the user-defined axis scaling associated with a specific ID or a specific index in a scaled display in a 2D axis sy"
---

# IRepCustomScalingAxisSystem2DScaledListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for AxisSystem2DScaledCustomScalings

Returns in a 2D axis system in DIAdem REPORT the user-defined axis scaling associated with a specific ID or a specific index in a scaled display in a 2D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepCustomScalingAxisSystem2DScaledListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
