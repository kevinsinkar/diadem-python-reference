---
title: "IRepD2AxisXInt.ConvertPageXPositionToXAxisValue"
description: "Converts an x-page coordinate into an x-axis coordinate in a 2D axis system in DIAdem REPORT."
---

# IRepD2AxisXInt.ConvertPageXPositionToXAxisValue

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: ConvertPageXPositionToXAxisValue for 2DAxisX

Converts an x-page coordinate into an x-axis coordinate in a 2D axis system in DIAdem REPORT.

## Signature

```python
iConvertPageXPositionToXAxisValue = Object.ConvertPageXPositionToXAxisValue(Value)
```
...
*Source: `ReportApi/methods/Report_method_ConvertPageXPositionToXAxisValue_IRepD2AxisXInt.htm`*
