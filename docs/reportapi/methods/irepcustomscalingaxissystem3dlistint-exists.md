---
title: "IRepCustomScalingAxisSystem3DListInt.Exists"
description: "Checks whether a user-defined axis scaling with a specific ID already exists in a 3D axis system in DIAdem REPORT."
---

# IRepCustomScalingAxisSystem3DListInt.Exists

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Exists for AxisSystem3DCustomScalings

Checks whether a user-defined axis scaling with a specific ID already exists in a 3D axis system in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Exists_IRepCustomScalingAxisSystem3DListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
