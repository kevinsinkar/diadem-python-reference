---
title: "IRepCommentSelectedSubObjectsListInt.Item"
description: "Returns the selected element associated with a specific index of a comment in DIAdem REPORT."
---

# IRepCommentSelectedSubObjectsListInt.Item

!!! abstract "Method &middot; `ReportApi.chm`"
    Method: Item for CommentSelectedElements

Returns the selected element associated with a specific index of a comment in DIAdem REPORT.
...
*Source: `ReportApi/methods/Report_method_Item_IRepCommentSelectedSubObjectsListInt.htm`*
