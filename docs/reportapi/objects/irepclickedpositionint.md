---
title: "IRepClickedPositionInt"
description: "The ClickedPositionInt object returns the x-cursor and y-cursor coordinates as page coordinates in DIAdem REPORT when you call the event which you assigned to t"
---

# IRepClickedPositionInt

!!! abstract "Object &middot; `ReportApi.chm`"
    Object: ClickedPositionInt

The ClickedPositionInt object returns the x-cursor and y-cursor coordinates as page coordinates in DIAdem REPORT when you call the event which you assigned to the OnAxisSystem2D for ClickedWithKeyEvents property. DIAdem calls this event when you click a 2D axis system while pressing a key. For this event DIAdem does not support keys such as <Alt>, <Ctrl>, and <Shift>. Use the methods ConvertPageXPositionToXAxisValue and ConvertPageYPositionToYAxisValue to convert the page coordinates into coordinates of a 2D axis system.
...
<p><a href="../../properties/irepclickedpositionint-x/">X</a> | <a href="../../properties/irepclickedpositionint-y/">Y</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../irepd2axissystemclickedwithkeycontextint/">D2AxisSystemClickedWithKeyContext</a>.<a href="../../properties/irepd2axissystemclickedwithkeycontextint-position/">Position</a> | <a href="../ireppolaraxissystemclickedwithkeycontextint/">PolarAxisSystemClickedWithKeyContext</a>.<a href="../../properties/ireppolaraxissystemclickedwithkeycontextint-position/">Position</a></p>
</div>
</div>
...
*Source: `ReportApi/Objects/Report_Objects_IRepClickedPositionInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
