...
!!! abstract "Event &middot; `ReportApi.chm`"
    Event: OnCurveTransformation for 3DCurve
...
*Source: `ReportApi/events/Report_event_OnCurveTransformation_IRepD3CurveInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
