---
title: "IRepReportOnToolTipInt.OnArrow"
description: "Is triggered in DIAdem REPORT when you press the shift key and move the mouse over an arrow. The event starts the user command that you assigned to the OnArrow "
---

# IRepReportOnToolTipInt.OnArrow

!!! abstract "Event &middot; `ReportApi.chm`"
    Event: OnArrow for ToolTipEvents

Is triggered in DIAdem REPORT when you press the shift key and move the mouse over an arrow. The event starts the user command that you assigned to the OnArrow for ToolTipEvents property. The user command receives two parameters. The first parameter corresponds to a ToolTipArrowContext object and provides information about the arrow in DIAdem REPORT. The second parameter is a text and corresponds with the tooltip for display. Refer to Working with Events in DIAdem for further information on events in DIAdem.
...
*Source: `ReportApi/events/Report_event_OnArrow_IRepReportOnToolTipInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
