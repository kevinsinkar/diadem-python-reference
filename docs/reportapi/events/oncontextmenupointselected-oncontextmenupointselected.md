...
```python
obj.OnContextMenuPointSelected(MenuPoint)
```
...
<p class="body"> <a href="../../properties/irepreporteventsint-oncontextmenupointselected/">OnContextMenuPointSelected</a> | <a href="#" data-unresolved="1">Objects Overview</a></p>
</div>
</div>

---

*Source: `ReportApi/events/Report_events_OnContextMenuPointSelected.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
