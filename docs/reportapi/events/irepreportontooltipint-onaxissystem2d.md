---
title: "IRepReportOnToolTipInt.OnAxisSystem2D"
description: "Is triggered in DIAdem REPORT when you press the shift key and move the mouse over a 2D axis system. The event starts the user command that you assigned to the "
---

# IRepReportOnToolTipInt.OnAxisSystem2D

!!! abstract "Event &middot; `ReportApi.chm`"
    Event: OnAxisSystem2D for ToolTipEvents

Is triggered in DIAdem REPORT when you press the shift key and move the mouse over a 2D axis system. The event starts the user command that you assigned to the OnAxisSystem2D for ToolTipEvents property. The user command receives two parameters. The parameter corresponds to a ToolTip2DAxisContext object and provides the information about the 2D axis system in DIAdem REPORT. The second parameter is a text and corresponds with the tooltip for display. Refer to Working with Events in DIAdem for further information on events in DIAdem.
...
*Source: `ReportApi/events/Report_event_OnAxisSystem2D_IRepReportOnToolTipInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
