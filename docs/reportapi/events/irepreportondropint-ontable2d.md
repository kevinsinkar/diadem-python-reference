---
title: "IRepReportOnDropInt.OnTable2D"
description: "Is triggered in DIAdem REPORT when you drag and drop an element onto a 2D table. The event starts the user command that you assigned to the OnTable2D for DropEv"
---

# IRepReportOnDropInt.OnTable2D

!!! abstract "Event &middot; `ReportApi.chm`"
    Event: OnTable2D for DropEvents

Is triggered in DIAdem REPORT when you drag and drop an element onto a 2D table. The event starts the user command that you assigned to the OnTable2D for DropEvents property. The user command receives two parameters. The first parameter corresponds to a 2DTableDropContext object and provides information about the 2D table onto which you dragged and dropped an object. The second parameter corresponds to a DropInformation object and provides information about the object which you dragged and dropped onto another object. DIAdem REPORT saves this property with the layout. Refer to Working with Events in DIAdem for further information on events in DIAdem.
...
*Source: `ReportApi/events/Report_event_OnTable2D_IRepReportOnDropInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
