---
title: "IRepCustomScalingAxisSystem2DScaledInt.EventName"
description: "Is triggered in a 2D axis system in DIAdem REPORT in scaled display when a user-defined axis scaling is selected. The event starts the user command that you ass"
---

# IRepCustomScalingAxisSystem2DScaledInt.EventName

!!! abstract "Event &middot; `ReportApi.chm`"
    Event: EventName for AxisSystem2DScaledCustomScaling

Is triggered in a 2D axis system in DIAdem REPORT in scaled display when a user-defined axis scaling is selected. The event starts the user command that you assigned to the EventName for AxisSystem2DScaledCustomScaling property. The user command receives a parameter. This parameter is a CustomScalingAxisSystem2DScaledContext object and provides information about the axis system and about the ID of the user-defined axis scaling.
...
*Source: `ReportApi/events/Report_event_EventName_IRepCustomScalingAxisSystem2DScaledInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
