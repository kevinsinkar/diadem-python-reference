...
```python
dd.AddUserCommandToEvent("dd.Report.Events.Drop.OnAxisSystem2D", "MyOnDrop2DAxisSystemEvent")
...
*Source: `ReportApi/events/Report_event_OnAxisSystem2D_IRepReportOnDropInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
