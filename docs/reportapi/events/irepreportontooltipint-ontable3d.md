...
description: "Is triggered in DIAdem REPORT when you press the shift key and move the mouse over a 3D table. The event starts the user command that you assigned to the OnTabl"
---

# IRepReportOnToolTipInt.OnTable3D

!!! abstract "Event &middot; `ReportApi.chm`"
    Event: OnTable3D for ToolTipEvents

Is triggered in DIAdem REPORT when you press the shift key and move the mouse over a 3D table. The event starts the user command that you assigned to the OnTable3D for ToolTipEvents property. The first parameter corresponds to a ToolTip3DTableContext object and provides information about the 3D table in DIAdem REPORT. The second parameter is a text and corresponds with the tooltip for display.
...
*Source: `ReportApi/events/Report_event_OnTable3D_IRepReportOnToolTipInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
