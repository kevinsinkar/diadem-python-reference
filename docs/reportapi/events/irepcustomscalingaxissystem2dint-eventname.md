---
title: "IRepCustomScalingAxisSystem2DInt.EventName"
description: "Is triggered in a 2D axis system in DIAdem REPORT when a user-defined axis scaling is selected. The event starts the user command that you assigned to the Event"
---

# IRepCustomScalingAxisSystem2DInt.EventName

!!! abstract "Event &middot; `ReportApi.chm`"
    Event: EventName for AxisSystem2DCustomScaling

Is triggered in a 2D axis system in DIAdem REPORT when a user-defined axis scaling is selected. The event starts the user command that you assigned to the EventName for AxisSystem2DCustomScaling property. The user command receives a parameter. This parameter is a CustomScalingAxisSystem2DContext object and provides information about the axis system and about the ID of the user-defined axis scaling.
...
*Source: `ReportApi/events/Report_event_EventName_IRepCustomScalingAxisSystem2DInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
