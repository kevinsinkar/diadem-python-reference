...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Picture for ComboBox <XTable>
...
<td><strong>Note  </strong>Use the <a href="../xtable-picturealign-2/">PictureAlign</a> property to specify the alignment of the graphics in the selection list.</td>
</tr>
</table>
</div>
