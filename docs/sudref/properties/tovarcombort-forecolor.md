...
# ToVarComboRt.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for EnumComboBox
...
```python
EnumComboBox1.ForeColor = 16711680
```

```python
EnumComboBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
