...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureWidth</span> property only if you assign a graphic to the <a href="../totreectrl-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
