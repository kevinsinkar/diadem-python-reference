---
title: "ToChnListBoxCtrl.Value"
description: "Specifies in user dialog boxes the value of the term selected in the control element. The user dialog box executes the EventChange method when the value of the "
---

# ToChnListBoxCtrl.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for ChnListBox
...
<div markdown="1">
<table class="Borderless" id="table2"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If you assign the values <span class="Monospace">1</span> or <span class="Monospace">2</span> to the <a href="../tochnlistboxctrl-selectionmode/">SelectionMode</a> property of a channel selection list, this property displays the last term selected.</td></tr></table>
</div>
...
*Source: `Sudref/properties/SUD_property_Value_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
