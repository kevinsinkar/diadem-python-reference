---
title: "ToMulSelListItem.Text"
description: "Specifies the text of a term selected in a selection list in a user dialog box."
---

# ToMulSelListItem.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for ListItem

Specifies the text of a term selected in a selection list in a user dialog box.
...
```python
MsgBoxDisp(ComboBox.Items(1).Text)
```
...
*Source: `Sudref/properties/SUD_property_Text_ToMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
