---
title: "ToCheckRt.Value"
description: "Specifies in user dialog boxes the status of a checkbox. The user dialog box executes the EventChange method when the value of the control changes."
---

# ToCheckRt.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for CheckBox
...
Specifies in user dialog boxes the status of a checkbox. The user dialog box executes the EventChange method when the value of the control changes.
