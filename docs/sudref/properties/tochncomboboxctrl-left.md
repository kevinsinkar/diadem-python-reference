---
title: "ToChnComboBoxCtrl.Left"
description: "Specifies the distance between the left edge of a control and the user dialog box origin. The dialog box origin is in the upper-left corner of the user dialog b"
---

# ToChnComboBoxCtrl.Left

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Left for ChnComboBox
...
Specifies the distance between the left edge of a control and the user dialog box origin. The dialog box origin is in the upper-left corner of the user dialog box.
