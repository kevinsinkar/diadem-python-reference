...
description: "Specifies in user dialog boxes whether a selection list in an extended table displays a vertical scroll bar. The property can have the following settings: 0 - N"
---

# XTable.VerticalScroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VerticalScroll for ChnListBox <XTable>
