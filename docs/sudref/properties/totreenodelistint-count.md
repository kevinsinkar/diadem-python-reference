---
title: "ToTreeNodeListInt.Count"
description: "Specifies in user dialog boxes the number of nodes in a branch of the tree."
---

# ToTreeNodeListInt.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for TreeNodes

Specifies in user dialog boxes the number of nodes in a branch of the tree.
...
*Source: `Sudref/properties/SUD_property_Count_ToTreeNodeListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
