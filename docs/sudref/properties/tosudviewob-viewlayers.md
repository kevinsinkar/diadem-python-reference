---
title: "ToSudviewob.viewlayers"
description: "Use this property to organize controls at different layers in the dialog editor. You can hide layers or controls while you are working in the dialog editor."
---

# ToSudviewob.viewlayers

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ViewLayers for Dialog
...
Use this property to organize controls at different layers in the dialog editor. You can hide layers or controls while you are working in the dialog editor.
...
<td><strong>Note  </strong>Use the <a href="../tosudviewobint-layers/">Layers</a> property in the Properties window to make each layer visible or invisible during runtime.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>Use the <a href="../totabpageviewob-viewlayers/">ViewLayers</a> property to organize controls on different layers in tabs.</td>
</tr>
</table>
</div>
