---
title: "ToTabPageListFmt.Count"
description: "Specifies in user dialog boxes the number of tabs of the TabPageCtrl control."
---

# ToTabPageListFmt.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for Pages

Specifies in user dialog boxes the number of tabs of the TabPageCtrl control.
...
```python
MsgBoxDisp(TabPageCtrl1.Pages.Count)
```
...
*Source: `Sudref/properties/SUD_property_Count_ToTabPageListFmt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
