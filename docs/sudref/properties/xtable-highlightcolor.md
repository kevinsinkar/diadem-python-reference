---
title: "XTable.HighlightColor"
description: "Specifies in user dialog boxes the color or the highlight of a control in an extended table. Click HighlightColor on the Properties tab to open the color select"
---

# XTable.HighlightColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HighlightColor for Text <XTable>
...
<td><strong>Note  </strong>To include the <span class="Monospace">HighlightColor</span> property in the display, you must enter a value greater than 0 for the <a href="../xtable-borderwidth/">BorderWidth</a> property and enter the value <span class="Monospace">Sunken</span> or <span class="Monospace">Raised</span> for the <span class="Monospace">BorderStyle</span> property.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
...
```python
Cell.HighlightColor = 16711680
```

```python
Cell.HighlightColor = dd.RGB(0,0,255)
```
