---
title: "ToSliderCtrl.ToolTipMode"
description: "Determines which tooltip appears when the mouse hovers over the control or when you move the slider."
---

# ToSliderCtrl.ToolTipMode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipMode for Slider
