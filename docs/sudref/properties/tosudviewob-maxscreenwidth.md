---
title: "ToSudViewOb.MaxScreenWidth"
description: "Specifies the width of the workspace of a maximized dialog box, in dialog units ."
---

# ToSudViewOb.MaxScreenWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: MaxScreenWidth for Dialog

Specifies the width of the workspace of a maximized dialog box, in dialog units .
...
```python
Dialog.Height = Dialog.MaxScreenHeight/2
Dialog.Width = Dialog.MaxScreenWidth/2
```
...
*Source: `Sudref/properties/SUD_property_MaxScreenWidth_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
