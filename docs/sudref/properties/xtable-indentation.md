...
description: "Specifies in user dialog boxes the text indentation on a button in an extended table. The user dialog box indents the text from the left or the right according "
---
