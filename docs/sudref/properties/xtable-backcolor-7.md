---
title: "XTable.BackColor"
description: "Specifies in user dialog boxes the background color of a control in an extended table. Use the automatic setting if you want the background color to correspond "
---

# XTable.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for EditBox <XTable>
...
*Source: `Sudref/properties/SUD_property_BackColor_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
