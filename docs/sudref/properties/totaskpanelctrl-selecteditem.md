---
title: "ToTaskPanelCtrl.SelectedItem"
description: "Returns in user dialog boxes the selected entry in the TaskPanel."
---

# ToTaskPanelCtrl.SelectedItem

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectedItem for TaskPanel

Returns in user dialog boxes the selected entry in the TaskPanel.
...
*Source: `Sudref/properties/SUD_property_SelectedItem_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
