---
title: "ToChnListBoxCtrl.borderdrawn"
description: "Draws user dialog box controls with a frame. The property can have the following settings: 0 - No Draws no frame. 1 - Yes Draws a frame."
---

# ToChnListBoxCtrl.borderdrawn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderDrawn for ChnListBox

Draws user dialog box controls with a frame. The property can have the following settings: 0 - No Draws no frame. 1 - Yes Draws a frame.
...
*Source: `Sudref/properties/SUD_property_borderdrawn_ToChnListBoxCtrl.htm`*
