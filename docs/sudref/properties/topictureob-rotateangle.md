...
# ToPictureOb.RotateAngle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RotateAngle for Picture
...
*Source: `Sudref/properties/SUD_property_RotateAngle_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
