---
title: "XTable.VerticalAlignment"
description: "Specifies in a user dialog box the vertical alignment of a text in an extended table."
---

# XTable.VerticalAlignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VerticalAlignment for Text <XTable>

Specifies in a user dialog box the vertical alignment of a text in an extended table.
...
```python
Cell.VerticalAlignment = 1 '0=Top, 1=Center, 2=Bottom
```
...
*Source: `Sudref/properties/SUD_property_VerticalAlignment_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
