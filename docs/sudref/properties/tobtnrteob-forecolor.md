...
# ToBtnRteOb.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for Button
...
```python
Button1.ForeColor = 16711680
```

```python
Button1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
