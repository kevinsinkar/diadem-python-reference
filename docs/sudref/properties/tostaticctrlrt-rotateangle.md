---
title: "ToStaticCtrlRt.RotateAngle"
description: "Specifies the rotation angle of a control in a user dialog box. Specify the rotation angle in degrees. Positive values rotate the control clockwise, negative va"
---

# ToStaticCtrlRt.RotateAngle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RotateAngle for Text
...
Specifies the rotation angle of a control in a user dialog box. Specify the rotation angle in degrees. Positive values rotate the control clockwise, negative values rotate the control counter-clockwise.
...
<td><strong>Note  </strong>If you modify the angle of the control in a script, you cannot move the position of the control in the script.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note </strong> The <a href="../tostaticctrlrt-backcolor/">BackColor</a> property is only effective if the <span class="Monospace">RotateAngle</span> property has the value <span class="Monospace">0</span>.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_RotateAngle_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
