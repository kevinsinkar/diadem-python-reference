...
```python
MsgBoxDisp(ChnComboBox1.Items(3).Value + "," + ChnComboBox.Items(3).Text)
```
...
*Source: `Sudref/properties/SUD_property_Value_ToChnListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
