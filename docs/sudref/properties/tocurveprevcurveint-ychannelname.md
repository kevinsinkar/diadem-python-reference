---
title: "ToCurvePrevCurveInt.YChannelName"
description: "Specifies the name of the y-channel of a curve in the curve preview in user dialog boxes."
---

# ToCurvePrevCurveInt.YChannelName

!!! abstract "Property &middot; `Sudref.chm`"
    Property: YChannelName for Curve

Specifies the name of the y-channel of a curve in the curve preview in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_YChannelName_ToCurvePrevCurveInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
