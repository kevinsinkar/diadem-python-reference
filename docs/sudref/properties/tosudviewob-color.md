...
```python
Dialog.Color = 16711680
```

```python
Dialog.Color = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_Color_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
