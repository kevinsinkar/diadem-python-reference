---
title: "ToVirtGridCtrl.GridLinesHorz"
description: "Specifies in a user dialog box whether an extended table displays horizontal separating lines between the individual cells. The extended table always displays h"
---

# ToVirtGridCtrl.GridLinesHorz
