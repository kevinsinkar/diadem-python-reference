---
title: "ToChnListBoxCtrl.datarefreshactive"
...
# ToChnListBoxCtrl.datarefreshactive
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <a href="../../methods/tochnlistboxctrl-refresh/">Refresh</a> method in scripts to refresh the channel selection list at a time you specify.</td></tr></table>
</div>
