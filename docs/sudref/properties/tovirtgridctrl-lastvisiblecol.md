---
title: "ToVirtGridCtrl.LastVisibleCol"
description: "Specifies in user dialog boxes the index of the column that the extended table displays as last visible column."
---

# ToVirtGridCtrl.LastVisibleCol

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LastVisibleCol for XTable
...
Specifies in user dialog boxes the index of the column that the extended table displays as last visible column.
...
*Source: `Sudref/properties/SUD_property_LastVisibleCol_ToVirtGridCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
