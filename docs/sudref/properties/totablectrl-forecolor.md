...
# ToTableCtrl.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for Table
...
```python
Table1.ForeColor = 16711680
```

```python
Table1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
