---
title: "ToCheckRt.AlignTextLeft"
description: "Specifies in a user dialog box the position of the text of a checkbox."
---

# ToCheckRt.AlignTextLeft

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AlignTextLeft for CheckBox

Specifies in a user dialog box the position of the text of a checkbox.
...
*Source: `Sudref/properties/SUD_property_AlignTextLeft_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
