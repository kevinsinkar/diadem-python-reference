---
title: "ToTabPageViewOb.Tag"
description: "Specifies a label for a tab of the TabPageCtrl control in a user dialog box. The tag does not affect the behavior of the tab."
---

# ToTabPageViewOb.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for Page
...
Specifies a label for a tab of the TabPageCtrl control in a user dialog box. The tag does not affect the behavior of the tab.
...
*Source: `Sudref/properties/SUD_property_Tag_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
