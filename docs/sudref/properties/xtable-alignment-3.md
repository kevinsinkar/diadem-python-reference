...
description: "Specifies the text alignment in a text of an extended table in a user dialog box."
---

# XTable.Alignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Alignment for Text <XTable>

Specifies the text alignment in a text of an extended table in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_Alignment_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
