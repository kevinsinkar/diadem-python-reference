---
title: "ToTreeCtrl.NodeSignStyle"
description: "Specifies whether DIAdem displays a symbol for expanding and collapsing the node in front of a tree node. The property can have the following settings: 0 - None"
---

# ToTreeCtrl.NodeSignStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: NodeSignStyle for Tree
...
Specifies whether DIAdem displays a symbol for expanding and collapsing the node in front of a tree node. The property can have the following settings: 0 - None Does not plot a symbol. 1 - PlusMinus Plots a plus or minus symbol.
...
*Source: `Sudref/properties/sud_property_NodeSignStyle_ToTreeCtrl.htm`*
