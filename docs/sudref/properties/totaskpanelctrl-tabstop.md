...
# ToTaskPanelCtrl.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for TaskPanel
...
```python
TaskPanel1.TabStop = 1 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
