...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ShowBlankEntry for ChnListBox <XTable>
...
<td><strong>Note</strong>  If the channel selection list contains a blank entry the indexing for <a href="../xtable-selection-2/">Selection</a> and <a href="../xtable-topindex/">TopIndex</a>starts at <span class="Monospace">0</span> instead of <span class="Monospace">1</span>. If you select the blank entry, <a href="../xtable-value-3/">Value</a> receives the value <span class="Monospace">0</span> instead of the channel number.</td>
</tr>
</table>
</div>
