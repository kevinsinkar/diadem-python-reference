...
# ToListBoxRt.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ListBox
...
```python
ListBox1.BackColor = 16711680
```

```python
ListBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
