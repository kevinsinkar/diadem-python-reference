---
title: "ToVirtColContInt.Count"
description: "Specifies the number of columns in an extended table in user dialog boxes."
---

# ToVirtColContInt.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for XTableColumns

Specifies the number of columns in an extended table in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToVirtColContInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
