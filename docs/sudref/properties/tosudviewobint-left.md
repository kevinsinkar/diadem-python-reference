---
title: "ToSudViewObInt.Left"
description: "Specifies the distance from the left edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen."
---

# ToSudViewObInt.Left

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Left for Dialog <NonModal>
...
Specifies the distance from the left edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen.
...
<div markdown="1">
<table class="Borderless" id="table2"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>This property does not include the width of the dialog box border, which the <a href="../tosudviewobint-borderwidthpix/">BorderWidthPix</a> property specifies.</td></tr>
</table>
</div>
