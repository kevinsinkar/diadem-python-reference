---
title: "XTable.AlignTextLeft"
description: "Specifies the position of the text of a checkbox in an extended table in a user dialog box."
---

# XTable.AlignTextLeft

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AlignTextLeft for CheckBox <XTable>
...
Specifies the position of the text of a checkbox in an extended table in a user dialog box.
...
```python
Cell.AlignTextLeft = 1  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_AlignTextLeft_ToCheckRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
