---
title: "ToTreeNodeInt.Level"
description: "Specifies in user dialog boxes the hierarchical level of a tree node. The first level with the root node has the value 1."
---

# ToTreeNodeInt.Level

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Level for TreeNode

Specifies in user dialog boxes the hierarchical level of a tree node. The first level with the root node has the value 1.
...
*Source: `Sudref/properties/SUD_property_Level_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
