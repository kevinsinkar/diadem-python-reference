---
title: "ToCurvePreviewOb.BackColor"
...
# ToCurvePreviewOb.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for Curve2DPreview
...
```python
Curve2DPreview1.BackColor = 16711680
```

```python
Curve2DPreview1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
