---
title: "ToTableCtrl.SelRow"
description: "Returns the selected row in a table in a user dialog box. If you do not select a row, or if you select more than one row, the property has the value 0."
---

# ToTableCtrl.SelRow

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelRow for Table

Returns the selected row in a table in a user dialog box. If you do not select a row, or if you select more than one row, the property has the value 0.
...
*Source: `Sudref/properties/SUD_property_SelRow_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
