...
# ToComboRt.dropdownwidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DropDownWidth for ComboBox
...
*Source: `Sudref/properties/SUD_property_dropdownwidth_ToComboRt.htm`*
