---
title: "ToVirtGridCtrl.LastVisibleRow"
description: "Specifies in user dialog boxes the index of the row that the extended table displays as last visible row."
---

# ToVirtGridCtrl.LastVisibleRow
...
*Source: `Sudref/properties/SUD_property_LastVisibleRow_ToVirtGridCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
