---
title: "ToCheckRt.shape"
description: "Specifies the display mode of the CheckBox control in a user dialog box. The property can have the following settings: 0 - CheckBox Displays the checkbox. 2 - B"
---
...
*Source: `Sudref/properties/SUD_property_shape_ToCheckRt.htm`*
