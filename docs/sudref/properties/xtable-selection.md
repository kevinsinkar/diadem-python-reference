...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for ChnComboBox <XTable>
...
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>If you assign the value <span class="Monospace">1</span> to the <a href="../xtable-showblankentry/">ShowBlankEntry</a> property of a channel selection list, the list shows a blank entry as the first entry. The index of this blank entry is <span class="Monospace">0</span>.</td></tr></table>
</div>
...
*Source: `Sudref/properties/SUD_property_Selection_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
