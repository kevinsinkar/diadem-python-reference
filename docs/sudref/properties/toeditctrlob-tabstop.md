...
# ToEditCtrlOb.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for EditBox
...
*Source: `Sudref/properties/SUD_property_TabStop_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
