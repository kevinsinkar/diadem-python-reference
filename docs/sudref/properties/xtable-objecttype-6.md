...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for ChnListBox <XTable>
...
*Source: `Sudref/properties/SUD_property_ObjectType_ToChnListBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
