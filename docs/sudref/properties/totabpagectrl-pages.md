---
title: "ToTabPageCtrl.Pages"
description: "Returns a collection of all the tabs of a TabPageCtrl control in user dialog boxes. To access single tabs in scripts, either use the Item property or enter the "
---

# ToTabPageCtrl.Pages

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Pages for TabPageCtrl
...
Returns a collection of all the tabs of a TabPageCtrl control in user dialog boxes. To access single tabs in scripts, either use the Item property or enter the index or the name in parentheses.

## Signature

```python
return_value = obj.Pages
```
...
```python
TabPageCtrl.Pages(1).Title = "Layout"
```

```python
TabPageCtrl.Pages("Page1").ToolTipText = "Setting Layout Parameters"
```

```python
TabPageCtrl.Pages.Item(1).ToolTipText = "Setting Layout Parameters"
```

```python
MsgBoxDisp(TabPageCtrl.Pages.Count)
```
...
*Source: `Sudref/properties/SUD_property_Pages_ToTabPageCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
