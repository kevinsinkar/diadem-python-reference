---
title: "ToChnComboBoxCtrl.Font"
description: "Specifies the font, font style, and font size for controls in user dialog boxes. You can use all the installed fonts. To restore the default settings, select Fo"
---

# ToChnComboBoxCtrl.Font

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Font for ChnComboBox
...
```python
ChnComboBox1.Font = -dd.FontPointsToPixels(10) + ", None,0,0,0,400,0,0,0,0,3,2,1,34,Arial"
```
...
*Source: `Sudref/properties/SUD_property_Font_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
