---
title: "ToSliderCtrl.Increment"
description: "Specifies the step width for the Slider control in user dialog boxes when you use the arrow keys."
---

# ToSliderCtrl.Increment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Increment for Slider
...
Specifies the step width for the Slider control in user dialog boxes when you use the arrow keys.
