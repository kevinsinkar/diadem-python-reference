---
title: "XTable.ForeColor"
description: "Specifies in user dialog boxes the text color of a control in an extended table. Use the automatic setting if you want the text color to correspond to the color"
---

# XTable.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ChnCtrl <XTable>
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToChnCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
