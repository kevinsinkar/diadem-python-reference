...
```python
MsgBoxDisp(ChnComboBox.Items(1).Text)
```
...
*Source: `Sudref/properties/SUD_property_Text_ToChnMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
