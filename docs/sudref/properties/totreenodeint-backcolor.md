---
title: "ToTreeNodeInt.BackColor"
description: "Specifies in user dialog boxes the background color of a node in the tree. If you do not use the property in the events EventInitialize or EventRefresh , DIAdem"
---

# ToTreeNodeInt.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for TreeNode
...
Specifies in user dialog boxes the background color of a node in the tree. If you do not use the property in the events EventInitialize or EventRefresh , DIAdem does not automatically show the changes in the tree. Call the Update method to refresh a node after making changes to this node.
...
def CreateDefaultTree(This):
    ...
    oRoot.BackColor = dd.RGB(255, 0, 0)
    oRoot.Key = "tools"
    oRoot.Expanded = true
...
*Source: `Sudref/properties/SUD_property_BackColor_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
