...
description: "Specifies in user dialog boxes the graphic of a control element in the extended table. Click to the right of Picture in the Cell Type dialog box to paste, to lo"
---

# XTable.Picture

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Picture for CheckBox <XTable>
...
*Source: `Sudref/properties/SUD_property_Picture_ToCheckRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
