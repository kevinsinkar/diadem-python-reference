---
title: "ToChnComboBoxCtrl.Tag"
description: "Defines any label for a control in a user dialog box. The tag does not affect the behavior of the control."
---

# ToChnComboBoxCtrl.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for ChnComboBox
...
Defines any label for a control in a user dialog box. The tag does not affect the behavior of the control.
...
*Source: `Sudref/properties/SUD_property_Tag_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
