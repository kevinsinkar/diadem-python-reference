---
title: "ToSudViewOb.ObjectCode"
description: "Specifies in user dialog boxes the name that you use to access the dialog box in a script if you want to edit the properties and events of the dialog box."
---

# ToSudViewOb.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for Dialog
...
Specifies in user dialog boxes the name that you use to access the dialog box in a script if you want to edit the properties and events of the dialog box.
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
