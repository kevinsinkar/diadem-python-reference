---
title: "ToCurvePrevCurvesInt.Count"
description: "Returns the number of curves in a curve preview of a user dialog box."
---

# ToCurvePrevCurvesInt.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for Curves
...
Returns the number of curves in a curve preview of a user dialog box.
...
```python
MsgBoxDisp("Number of curves: " + Curve2DPreview1.Curves.Count)
```
...
*Source: `Sudref/properties/SUD_property_Count_ToCurvePrevCurvesInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
