---
title: "ToSliderCtrl.Minimum"
description: "Specifies the lowest value you can set with the Slider control in user dialog boxes."
---

# ToSliderCtrl.Minimum

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Minimum for Slider
...
Specifies the lowest value you can set with the Slider control in user dialog boxes.
