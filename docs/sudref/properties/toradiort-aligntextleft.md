---
title: "ToRadioRt.AlignTextLeft"
description: "Specifies in a user dialog box the position of the text of a radio button."
---

# ToRadioRt.AlignTextLeft

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AlignTextLeft for RadioButton
...
Specifies in a user dialog box the position of the text of a radio button.
...
```python
RadioButton1.AlignTextLeft = 1  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_AlignTextLeft_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
