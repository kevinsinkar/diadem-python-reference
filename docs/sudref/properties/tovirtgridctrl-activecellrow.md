---
title: "ToVirtGridCtrl.ActiveCellRow"
description: "Returns the row index of the enabled cell in an extended table in user dialog boxes. If no table cell is enabled, the property has the value -1 ."
---

# ToVirtGridCtrl.ActiveCellRow

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ActiveCellRow for XTable
...
Returns the row index of the enabled cell in an extended table in user dialog boxes. If no table cell is enabled, the property has the value -1 .
...
<div markdown="1">
<table class="Borderless" id="table2"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <a href="../../methods/tovirtgridctrl-setactivecell/">SetActiveCell</a> method to position the enabled cell in the extended table.</td></tr></table>
</div>
