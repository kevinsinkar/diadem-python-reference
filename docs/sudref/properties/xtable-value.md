---
title: "XTable.Value"
description: "Specifies the status of a checkbox in a user dialog box."
---

# XTable.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for CheckBox <XTable>

Specifies the status of a checkbox in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_Value_ToCheckRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
