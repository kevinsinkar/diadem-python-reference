---
title: "ToComboRt.casesensitive"
description: "Specifies in user dialog boxes whether term selection from a selection list is case-sensitive. The property can have the following settings: 0 - No case-sensiti"
---

# ToComboRt.casesensitive

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CaseSensitive for ComboBox

Specifies in user dialog boxes whether term selection from a selection list is case-sensitive. The property can have the following settings: 0 - No case-sensitive Term selection is not case-sensitive. 1 - Case-sensitive Term selection is case-sensitive.
...
*Source: `Sudref/properties/SUD_property_casesensitive_ToComboRt.htm`*
