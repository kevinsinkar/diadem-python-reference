...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../tosudviewob-height/">Height</a> property to specify the height of the dialog box.</td></tr>
<tr>
...
*Source: `Sudref/properties/SUD_property_MinHeight_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
