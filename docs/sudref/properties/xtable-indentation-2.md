---
title: "XTable.Indentation"
description: "Specifies in user dialog boxes the distance from the checkbox to the edge of the control in extended tables. The entry must be in pixels. The distance refers to"
---

# XTable.Indentation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Indentation for CheckBox <XTable>
...
Specifies in user dialog boxes the distance from the checkbox to the edge of the control in extended tables. The entry must be in pixels. The distance refers to the left or the right, depending on the AlignTextLeft property.
...
*Source: `Sudref/properties/SUD_property_indentation_ToCheckRt_XTable.htm`*
