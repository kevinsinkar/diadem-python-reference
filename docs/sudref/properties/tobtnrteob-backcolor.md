...
# ToBtnRteOb.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for Button
...
```python
Button1.BackColor = 16711680
```

```python
Button1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
