---
title: "ToTreeCtrl.Checkboxes"
description: "Specifies in user dialog boxes whether the tree nodes display additional checkboxes. DIAdem displays a checkbox for each node."
---

# ToTreeCtrl.Checkboxes

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Checkboxes for Tree

Specifies in user dialog boxes whether the tree nodes display additional checkboxes. DIAdem displays a checkbox for each node.
...
*Source: `Sudref/properties/SUD_property_Checkboxes_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
