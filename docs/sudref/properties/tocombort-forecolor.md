...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ComboBox
...
```python
ComboBox1.ForeColor = 16711680
```

```python
ComboBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
