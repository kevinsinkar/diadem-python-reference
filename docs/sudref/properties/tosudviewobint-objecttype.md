---
title: "ToSudViewObInt.ObjectType"
description: "Specifies the type of a dialog box in a user dialog box."
---

# ToSudViewObInt.ObjectType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for Dialog <NonModal>

Specifies the type of a dialog box in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_ObjectType_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
