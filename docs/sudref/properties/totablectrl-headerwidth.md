---
title: "ToTableCtrl.HeaderWidth"
description: "Specifies the width of the first column in a table in user dialog boxes. The property only applies if you set Yes for the VerticalOrientation property and No fo"
---

# ToTableCtrl.HeaderWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HeaderWidth for Table
...
Specifies the width of the first column in a table in user dialog boxes. The property only applies if you set Yes for the VerticalOrientation property and No for the AutoHeaderWidth property.
...
```python
Table1.VerticalOrientation = 1
Table1.AutoHeaderWidth = 0
Table1.HeaderWidth = 20
```
...
*Source: `Sudref/properties/SUD_property_HeaderWidth_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
