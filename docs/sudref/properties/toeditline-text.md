---
title: "ToEditLine.Text"
description: "Specifies the text of a line of an input field in a user dialog box."
---

# ToEditLine.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for Line
...
Specifies the text of a line of an input field in a user dialog box.
...
for i in range(1, Editbox1.Lines.Count + 1):
    MsgBoxDisp(i + ", " + EditBox1.Lines(i).Text)
```
...
*Source: `Sudref/properties/SUD_property_Text_ToEditLine.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
