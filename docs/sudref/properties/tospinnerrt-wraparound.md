---
title: "ToSpinnerRt.WrapAround"
description: "In user dialog boxes, specifies whether a SpinBox continues counting at the opposite end of the value range when it reaches the upper limit or the lower limit ."
---

# ToSpinnerRt.WrapAround

!!! abstract "Property &middot; `Sudref.chm`"
    Property: WrapAround for SpinBox

In user dialog boxes, specifies whether a SpinBox continues counting at the opposite end of the value range when it reaches the upper limit or the lower limit .
...
*Source: `Sudref/properties/SUD_property_WrapAround_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
