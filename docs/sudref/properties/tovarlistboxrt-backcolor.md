---
title: "ToVarListBoxRt.BackColor"
...
# ToVarListBoxRt.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for EnumListBox
...
```python
EnumListBox1.BackColor = 16711680
```

```python
EnumListBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
