---
title: "ToSudViewObInt.MaxScreenHeight"
description: "Specifies the height of the workspace of a maximized dialog box in dialog units ."
---

# ToSudViewObInt.MaxScreenHeight

!!! abstract "Property &middot; `Sudref.chm`"
    Property: MaxScreenHeight for Dialog <NonModal>
...
Specifies the height of the workspace of a maximized dialog box in dialog units .
...
*Source: `Sudref/properties/SUD_property_MaxScreenHeight_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
