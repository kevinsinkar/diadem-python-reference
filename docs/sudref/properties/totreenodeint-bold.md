---
title: "ToTreeNodeInt.Bold"
description: "Specifies in user dialog boxes whether the font of a tree node is displayed in bold. If you do not use the property in the events EventInitialize or EventRefres"
---

# ToTreeNodeInt.Bold

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bold for TreeNode

Specifies in user dialog boxes whether the font of a tree node is displayed in bold. If you do not use the property in the events EventInitialize or EventRefresh , DIAdem does not automatically show the changes in the tree. Call the Update method to refresh a node after making changes to this node.
...
*Source: `Sudref/properties/SUD_property_Bold_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
