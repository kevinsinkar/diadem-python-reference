---
title: "XTable.Text"
description: "Specifies in a user dialog box the displayed text of a control in an extended table."
---

# XTable.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for EditBox <XTable>
...
Specifies in a user dialog box the displayed text of a control in an extended table.
...
*Source: `Sudref/properties/SUD_property_Text_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
