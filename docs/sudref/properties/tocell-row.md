---
title: "ToCell.Row"
description: "Returns the row index of a table cell in a user dialog box."
---

# ToCell.Row

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Row for Cell

Returns the row index of a table cell in a user dialog box.
...
```python
MsgBoxDisp("Row: " &Table1.SelectedCells(1).Row)
```
...
*Source: `Sudref/properties/SUD_property_Row_ToCell.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
