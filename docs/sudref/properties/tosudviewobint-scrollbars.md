---
title: "ToSudViewObInt.ScrollBars"
description: "Specifies that a user dialog box displays a scroll bar. Use the properties ScrollHeight and ScrollWidth to specify the height and width."
---

# ToSudViewObInt.ScrollBars

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollBars for Dialog <NonModal>
...
Specifies that a user dialog box displays a scroll bar. Use the properties ScrollHeight and ScrollWidth to specify the height and width.
...
*Source: `Sudref/properties/SUD_property_ScrollBars_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
