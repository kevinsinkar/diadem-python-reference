...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for ListBox <XTable>
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../xtable-interpretedtextenabled-4/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToListBoxRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
