...
# ToVarComboRt.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for EnumComboBox
...
```python
EnumComboBox1.TabStop = 1 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
