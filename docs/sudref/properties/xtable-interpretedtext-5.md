---
title: "XTable.InterpretedText"
description: "Returns the interpreted text of DIAdem expressions located in the extended table in user dialog boxes. DIAdem expressions are DIAdem variables or formula expres"
---

# XTable.InterpretedText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for Text <XTable>
...
Returns the interpreted text of DIAdem expressions located in the extended table in user dialog boxes. DIAdem expressions are DIAdem variables or formula expressions enclosed in @ , or script expressions from registered DIAdem scripts, enclosed in @@ .
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../xtable-interpretedtextenabled-5/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
