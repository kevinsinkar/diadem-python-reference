...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ChnCtrl
...
```python
ChnCtrl1.BackColor = 16711680
```

```python
ChnCtrl1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
