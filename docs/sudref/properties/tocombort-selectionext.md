...
# ToComboRt.SelectionExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectionExt for ComboBox
...
*Source: `Sudref/properties/SUD_property_SelectionExt_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
