---
title: "ToSudViewOb.DialogCode"
description: "Specifies the unique name of a user dialog box. You use this name to access the user dialog box in a script."
---

# ToSudViewOb.DialogCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DialogCode for Dialog

Specifies the unique name of a user dialog box. You use this name to access the user dialog box in a script.
...
*Source: `Sudref/properties/SUD_property_DialogCode_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
