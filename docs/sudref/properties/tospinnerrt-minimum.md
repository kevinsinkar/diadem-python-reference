---
title: "ToSpinnerRt.Minimum"
description: "Specifies the lowest value you can set with the SpinBox control in user dialog boxes. The WrapAround property specifies what the control does when it reaches th"
---
...
*Source: `Sudref/properties/SUD_property_Minimum_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
