---
title: "ToVirtGridCtrl.ColumnTitlesHeight"
description: "Specifies in user dialog boxes the height of the row that contains the labeling of the extended table."
---

# ToVirtGridCtrl.ColumnTitlesHeight

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ColumnTitlesHeight for XTable
...
Specifies in user dialog boxes the height of the row that contains the labeling of the extended table.

## Signature

```python
obj.ColumnTitlesHeight
```

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>The user dialog box only displays the left table heading when you set <a href="../tovirtgridctrl-columntitlesdisplay/">ColumnTitlesDisplay</a> to <span class="Monospace">Yes</span>.</td></tr></table>
</div>
...
```python
XTable1.ColumnTitlesHeight = 100
```
