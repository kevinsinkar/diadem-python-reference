...
```python
Dialog.Font = -dd.FontPointsToPixels(10) + ", None,0,0,0,400,0,0,0,0,3,2,1,34,Arial"
```
...
*Source: `Sudref/properties/SUD_property_Font_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
