...
# ToSudViewOb.ScrollBars

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollBars for Dialog
...
*Source: `Sudref/properties/SUD_property_ScrollBars_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
