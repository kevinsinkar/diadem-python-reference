---
title: "ToStaticCtrlRt.ShadowStyle"
description: "Specifies in a user dialog box the shape of the shadow around a text."
---

# ToStaticCtrlRt.ShadowStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ShadowStyle for Text

Specifies in a user dialog box the shape of the shadow around a text.
...
*Source: `Sudref/properties/SUD_property_ShadowStyle_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
