---
title: "ToTabPageCtrl.Multiline"
description: "Specifies in user dialog boxes whether the tabs display in multiple lines, if the tabs of the TabPageCtrl control cannot all be displayed in a row."
---

# ToTabPageCtrl.Multiline

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Multiline for TabPageCtrl
...
Specifies in user dialog boxes whether the tabs display in multiple lines, if the tabs of the TabPageCtrl control cannot all be displayed in a row.
...
*Source: `Sudref/properties/SUD_property_Multiline_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
