---
title: "ToSudViewObInt.MinWidth"
description: "Specifies the minimum width of scalable dialog boxes, in dialog units ."
---

# ToSudViewObInt.MinWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: MinWidth for Dialog <NonModal>
...
Specifies the minimum width of scalable dialog boxes, in dialog units .
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../tosudviewobint-width/">Width</a> property to specify the width of the dialog box.</td></tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>The <span class="Monospace">MinWidth</span> property corresponds to the <span class="Monospace">Width</span> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_MinWidth_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
