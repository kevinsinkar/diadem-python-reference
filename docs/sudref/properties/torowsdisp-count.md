---
title: "ToRowsDisp.Count"
description: "Specifies the number of rows in a table in user dialog boxes."
---

# ToRowsDisp.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for Rows

Specifies the number of rows in a table in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToRowsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
