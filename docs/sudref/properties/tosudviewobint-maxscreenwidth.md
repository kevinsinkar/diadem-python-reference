...
oMyDlg.Height = oMyDlg.MaxScreenHeight/2
oMyDlg.Width = oMyDlg.MaxScreenWidth/2
```
...
*Source: `Sudref/properties/SUD_property_MaxScreenWidth_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
