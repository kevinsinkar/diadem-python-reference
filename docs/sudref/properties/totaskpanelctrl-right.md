...
# ToTaskPanelCtrl.Right

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Right for TaskPanel
...
*Source: `Sudref/properties/SUD_property_Right_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
