---
title: "ToCell.Column"
description: "Returns the column index of a table cell in a user dialog box."
---

# ToCell.Column

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Column for Cell

Returns the column index of a table cell in a user dialog box.
...
```python
MsgBoxDisp("Column: " &Table1.SelectedCells(1).Column)
```
...
*Source: `Sudref/properties/SUD_property_Column_ToCell.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
