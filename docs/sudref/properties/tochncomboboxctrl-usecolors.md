---
title: "ToChnComboBoxCtrl.UseColors"
description: "Specifies in user dialog boxes whether a control uses the system color."
---

# ToChnComboBoxCtrl.UseColors

!!! abstract "Property &middot; `Sudref.chm`"
    Property: UseColors for ChnComboBox
...
Specifies in user dialog boxes whether a control uses the system color.
...
```python
ChnComboBox1.UseColors = 0  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_UseColors_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
