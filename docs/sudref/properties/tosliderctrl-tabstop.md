...
# ToSliderCtrl.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for Slider
...
*Source: `Sudref/properties/SUD_property_TabStop_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
