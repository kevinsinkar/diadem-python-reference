---
title: "ToChnComboBoxCtrl.CursorPointer"
description: "Specifies how the user dialog box displays the mouse cursor on a control."
---

# ToChnComboBoxCtrl.CursorPointer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CursorPointer for ChnComboBox

Specifies how the user dialog box displays the mouse cursor on a control.
