---
title: "ToVirtGridCtrl.colwidthmode"
description: "Specifies in user dialog boxes how to display the individual columns in an extended table. The property can have the following settings: 0 - KeepColWidth Displa"
---

# ToVirtGridCtrl.colwidthmode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ColWidthMode for XTable
...
*Source: `Sudref/properties/SUD_property_colwidthmode_ToVirtGridCtrl.htm`*
