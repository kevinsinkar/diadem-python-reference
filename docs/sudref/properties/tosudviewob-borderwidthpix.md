---
title: "ToSudViewOb.BorderWidthPix"
description: "Specifies the width of the user dialog box frame in pixels. Use this property to calculate the coordinates of a control in the user dialog box as an exact numbe"
---

# ToSudViewOb.BorderWidthPix

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderWidthPix for Dialog

Specifies the width of the user dialog box frame in pixels. Use this property to calculate the coordinates of a control in the user dialog box as an exact number of pixels. You use xCoordinateCorr = xCoordinate + 2*BorderWidthPix to calculate the x-coordinate. You use yCoordinateCorr = yCoordinate + BorderWidthPix + TitleHeightPix to calculate the y-coordinate.
...
```python
MsgBoxDisp(Dialog.BorderWidthPix)
MsgBoxDisp(Dialog.MapXPixelToDlu(Dialog.BorderWidthPix))
```
