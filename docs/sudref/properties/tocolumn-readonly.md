---
title: "ToColumn.ReadOnly"
description: "Specifies in user dialog boxes that the values of a table column are only displayed. You cannot change the values."
---

# ToColumn.ReadOnly

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ReadOnly for Column

Specifies in user dialog boxes that the values of a table column are only displayed. You cannot change the values.
...
```python
Table1.Culumns(1).ReadOnly = TRUE
```
