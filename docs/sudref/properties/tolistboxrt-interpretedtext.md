---
title: "ToListBoxRt.InterpretedText"
description: "Returns the interpreted text of DIAdem expressions in a user dialog box. DIAdem expressions are DIAdem variables or formula expressions enclosed in @ , or scrip"
---

# ToListBoxRt.InterpretedText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for ListBox
...
Returns the interpreted text of DIAdem expressions in a user dialog box. DIAdem expressions are DIAdem variables or formula expressions enclosed in @ , or script expressions from registered DIAdem scripts, enclosed in @@ .
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
