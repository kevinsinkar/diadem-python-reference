---
title: "ToChnListBoxCtrl.DisplayNumbers"
description: "Specifies whether the channel selection list displays the channel numbers."
---

# ToChnListBoxCtrl.DisplayNumbers

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DisplayNumbers for ChnListBox
...
Specifies whether the channel selection list displays the channel numbers.
...
```python
ChnListBox1.DisplayNumbers = 1  # 0=No, 1=Yes
```
