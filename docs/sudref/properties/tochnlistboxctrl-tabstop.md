---
title: "ToChnListBoxCtrl.TabStop"
...
# ToChnListBoxCtrl.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for ChnListBox
...
```python
ChnListBox1.TabStop = 1 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
