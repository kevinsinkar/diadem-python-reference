---
title: "ToBtnRteOb.Indentation"
description: "Specifies text indentation on a button in user dialog boxes. The user dialog box indents the text from the left or the right according to the Alignment property"
---

# ToBtnRteOb.Indentation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Indentation for Button
...
Specifies text indentation on a button in user dialog boxes. The user dialog box indents the text from the left or the right according to the Alignment property for text alignment. This property does not affect centered text.
