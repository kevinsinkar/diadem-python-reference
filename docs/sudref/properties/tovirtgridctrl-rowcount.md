---
title: "ToVirtGridCtrl.RowCount"
description: "Specifies in user dialog boxes the number of rows in an extended table."
---

# ToVirtGridCtrl.RowCount

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RowCount for XTable

Specifies in user dialog boxes the number of rows in an extended table.
...
*Source: `Sudref/properties/SUD_property_RowCount_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
