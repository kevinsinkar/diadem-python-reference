...
description: "Specifies in user dialog boxes whether a text box in an extended table displays a horizontal scroll bar. The property can have the following settings: 0 - None "
---

# XTable.HorizontalScroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HorizontalScroll for EditBox <XTable>
