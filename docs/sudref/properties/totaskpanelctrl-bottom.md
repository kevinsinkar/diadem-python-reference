...
# ToTaskPanelCtrl.Bottom

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bottom for TaskPanel
...
*Source: `Sudref/properties/SUD_property_Bottom_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
