---
title: "ToVirtColInt.Name"
description: "Specifies in user dialog boxes the name of the first column of the extended table. Use the Configure columns dialog box to specify the names of the columns of a"
---

# ToVirtColInt.Name

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Name for XTableColumn
...
Specifies in user dialog boxes the name of the first column of the extended table. Use the Configure columns dialog box to specify the names of the columns of an extended table in the dialog editor. Click Columns in the Properties tab to modify the properties of the table columns in the dialog editor..
...
*Source: `Sudref/properties/SUD_property_Name_ToVirtColInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
