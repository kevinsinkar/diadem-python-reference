---
title: "ToTreeNodeInt.Checked"
description: "Specifies in user dialog boxes the status of a checkbox of a tree node."
---

# ToTreeNodeInt.Checked

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Checked for TreeNode

Specifies in user dialog boxes the status of a checkbox of a tree node.
...
*Source: `Sudref/properties/SUD_property_Checked_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
