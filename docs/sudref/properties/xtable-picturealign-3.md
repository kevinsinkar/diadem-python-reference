...
description: "Specifies in a user dialog box the alignment of graphics in a selection list in the extended table. The property can have the following settings: 0 - Left Posit"
---

# XTable.PictureAlign

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureAlign for ListBox <XTable>

Specifies in a user dialog box the alignment of graphics in a selection list in the extended table. The property can have the following settings: 0 - Left Positions the graphic on the left and displays any text to the right of the graphic. 1 - Right Positions the graphic on the right and displays any text to the left of the graphic. 2 - Center Centers the graphic and does not display any text.
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureAlign</span> property only if you assign a graphic to the <a href="../xtable-picture-4/">Picture</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_picturealign_ToListBoxRt_XTable.htm`*
