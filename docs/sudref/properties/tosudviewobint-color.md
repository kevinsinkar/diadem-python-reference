---
title: "ToSudViewObInt.Color"
description: "Specifies the color of a user dialog box. If you set automatic , the dialog box color corresponds to the color settings for the operating system. Click Color in"
---

# ToSudViewObInt.Color

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Color for Dialog <NonModal>
...
oMyDlg.Color = 16711680
```

```python
oMyDlg = dd.SudDlgCreate("Input","Example.sud")
oMyDlg.Color = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_Color_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
