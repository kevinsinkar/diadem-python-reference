...
# ToVarListBoxRt.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for EnumListBox
...
```python
EnumListBox1.TabStop = 1  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
