---
title: "XTable.PictureOffState"
description: "Specifies the graphic for a disabled control in a user dialog box. Click PictureOffstate in the Properties tab to paste, to load, or to edit a graphic. You can "
---

# XTable.PictureOffState

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureOffState for CheckBox <XTable>
...
<td><strong>Note</strong>  The control only displays the graphic if you set the <a href="../xtable-ownerdrawn/">OwnerDrawn</a> property to <span class="Monospace">Yes</span>.</td>
</tr>
</table>
</div>
...
```python
Cell.Picture = "\SUD\On.bmp"
Cell.PictureOffState = "\SUD\Off.bmp"
```
