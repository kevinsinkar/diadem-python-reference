---
title: "ToChnMulSelListItems.ChannelNumbers"
...
# ToChnMulSelListItems.ChannelNumbers

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ChannelNumbers for ChnMultiSelection
...
```python
ChnListBox1.MultiSelection.ChannelNumbers = "1,4-7"
```
...
*Source: `Sudref/properties/SUD_property_ChannelNumbers_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
