...
# ToStaticCtrlRt.layer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Layer for Text
...
<td><strong>Note  </strong>The <a href="../../methods/tostaticctrlrt-layername/">LayerName</a> method returns the name of the layer a control is in.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
...
*Source: `Sudref/properties/SUD_property_layer_ToStaticCtrlRt.htm`*
