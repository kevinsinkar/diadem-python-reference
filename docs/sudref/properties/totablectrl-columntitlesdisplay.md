---
title: "ToTableCtrl.ColumnTitlesDisplay"
description: "Specifies whether tables display the column titles in a user dialog box."
---

# ToTableCtrl.ColumnTitlesDisplay

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ColumnTitlesDisplay for Table

Specifies whether tables display the column titles in a user dialog box.

## Signature

```python
obj.ColumnTitlesDisplay
```

## Notes

<div markdown="1">
<table class="Borderless" id="table2"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>The value of this property does not affect the indexing of the first data cell of the extended table.</td></tr></table>
</div>
...
```python
Table1.ColumnTitlesDisplay = 0 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_ColumnTitlesDisplay_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
