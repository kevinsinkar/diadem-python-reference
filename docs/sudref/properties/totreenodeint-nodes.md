---
title: "ToTreeNodeInt.Nodes"
description: "Specifies in user dialog boxes a collection of all nodes of the next subordinate level in a branch in the tree."
---

# ToTreeNodeInt.Nodes

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Nodes for TreeNode
...
Specifies in user dialog boxes a collection of all nodes of the next subordinate level in a branch in the tree.
...
*Source: `Sudref/properties/SUD_property_Nodes_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
