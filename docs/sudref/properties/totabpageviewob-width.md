---
title: "ToTabPageViewOb.Width"
description: "Returns the width of a tab in user dialog boxes."
---

# ToTabPageViewOb.Width

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Width for Page

Returns the width of a tab in user dialog boxes.
...
<td><strong>Note</strong>  The <a href="./">Width</a> property of the <span class="Monospace">TabPageCtrl</span> control includes the width of the tab and the width of the labels.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Width_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
