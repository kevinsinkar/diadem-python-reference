---
title: "ToVirtGridCtrl.Columns"
description: "Collection of all columns of an extended table in user dialog boxes. To access a specific table column use the Item property, or enter the index or the name in "
---

# ToVirtGridCtrl.Columns

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Columns for XTable
...
Collection of all columns of an extended table in user dialog boxes. To access a specific table column use the Item property, or enter the index or the name in parentheses.
...
*Source: `Sudref/properties/SUD_property_Columns_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
