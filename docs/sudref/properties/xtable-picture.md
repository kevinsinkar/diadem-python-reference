...
description: "Specifies in user dialog boxes the graphic of a button in the extended table. Click Picture in the Properties tab to paste, to load, or to edit a graphic. You a"
---

# XTable.Picture

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Picture for Button <XTable>
...
*Source: `Sudref/properties/SUD_property_Picture_ToBtnRteOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
