---
title: "ToSpinnerRt.editbuddy"
description: "Specifies in user dialog boxes that a SpinBox that comes after an EditBox in the tab order of the controls, modifies the contents of the EditBox . The property "
---

# ToSpinnerRt.editbuddy
