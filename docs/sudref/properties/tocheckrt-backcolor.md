...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for CheckBox
...
```python
CheckBox1.BackColor = 16711680
```

```python
CheckBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
