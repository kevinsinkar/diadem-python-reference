---
title: "ToVarListBoxRt.sort"
description: "Specifies whether selection lists sort the selection terms in alphabetical order in user dialog boxes. The property can have the following settings: 0 - No Does"
---

# ToVarListBoxRt.sort

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Sort for EnumListBox

Specifies whether selection lists sort the selection terms in alphabetical order in user dialog boxes. The property can have the following settings: 0 - No Does not sort the elements. 1 - Yes Sorts the elements.
...
*Source: `Sudref/properties/SUD_property_sort_ToVarListBoxRt.htm`*
