---
title: "ToChnComboBoxCtrl.Height"
description: "Specifies the height of a control in user dialog boxes."
---

# ToChnComboBoxCtrl.Height

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Height for ChnComboBox

Specifies the height of a control in user dialog boxes.
...
```python
MsgBoxDisp("Height: " + ChnComboBox1.Height)
```
