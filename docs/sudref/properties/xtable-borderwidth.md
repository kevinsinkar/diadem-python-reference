---
title: "XTable.BorderWidth"
description: "Specifies the frame width for a control of an extended table in a user dialog box."
---

# XTable.BorderWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderWidth for Text <XTable>

Specifies the frame width for a control of an extended table in a user dialog box.
...
<td><strong>Note  </strong>The property is ineffective if you assign <span class="Monospace">1 - 3D</span> to the <a href="../xtable-borderstyle/">Borderstyle</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_BorderWidth_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
