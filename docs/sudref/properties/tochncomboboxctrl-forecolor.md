---
title: "ToChnComboBoxCtrl.ForeColor"
description: "Specifies the text color for a control in a user dialog box. Use the automatic setting if you want the text color to correspond to the color settings for the op"
---

# ToChnComboBoxCtrl.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ChnComboBox
...
<td><strong>Note  </strong>Use the VBS function <span class="Monospace">RGB</span> to calculate the RGB value of colors, based on the proportions of red, green, and blue.</td>
</tr>
</table>
</div>
...
```python
ChnComboBox1.ForeColor = 16711680
```

```python
ChnComboBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
