...
# ToListBoxRt.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ListBox
...
```python
ListBox1.ForeColor = 16711680
```

```python
ListBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
