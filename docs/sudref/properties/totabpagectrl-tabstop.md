...
# ToTabPageCtrl.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for TabPageCtrl
...
```python
TabPageCtrl1.TabStop = 1  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
