---
title: "XTable.Syntax"
description: "Specifies the format in which the channels appear in the channel selection list of an extended table."
---

# XTable.Syntax

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Syntax for ChnListBox <XTable>

Specifies the format in which the channels appear in the channel selection list of an extended table.
