---
title: "ToVarComboRt.ComboType"
description: "Specifies in user dialog boxes that the user can enter text in selection lists. This does not modify the selection terms."
---

# ToVarComboRt.ComboType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ComboType for EnumComboBox
...
Specifies in user dialog boxes that the user can enter text in selection lists. This does not modify the selection terms.
...
```python
EnumComboBox1.ComboType = 2  # 2=StaticDropDown
```
...
*Source: `Sudref/properties/SUD_property_ComboType_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
