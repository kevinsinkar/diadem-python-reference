...
```python
Frame1.BackColor = 16711680
```

```python
Frame1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
