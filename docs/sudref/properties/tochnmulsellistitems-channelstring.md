---
title: "ToChnMulSelListItems.ChannelString"
description: "Specifies in user dialog boxes the names of the selected channels of a channel selection list. The Syntax property specifies the format used for ChannelString ."
---

# ToChnMulSelListItems.ChannelString

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ChannelString for ChnMultiSelection
...
Specifies in user dialog boxes the names of the selected channels of a channel selection list. The Syntax property specifies the format used for ChannelString .
...
```python
ChnListBox1.MultiSelection.ChannelString = "Time,Speed"
```
...
*Source: `Sudref/properties/SUD_property_ChannelString_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
