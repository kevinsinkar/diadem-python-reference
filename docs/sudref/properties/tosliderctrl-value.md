---
title: "ToSliderCtrl.Value"
description: "Specifies, in user dialog boxes, the value of the control if the value of the control changes through movement of the slider. In this case the user dialog box e"
---

# ToSliderCtrl.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for Slider

Specifies, in user dialog boxes, the value of the control if the value of the control changes through movement of the slider. In this case the user dialog box executes the EventChange method.
...
*Source: `Sudref/properties/SUD_property_Value_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
