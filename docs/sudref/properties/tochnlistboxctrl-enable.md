...
```python
ChnListBox1.Enable = 0 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_Enable_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
