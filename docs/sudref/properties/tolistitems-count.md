---
title: "ToListItems.Count"
description: "Returns the number of selection terms in a selection list in user dialog boxes."
---

# ToListItems.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for ListItems
...
Returns the number of selection terms in a selection list in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
