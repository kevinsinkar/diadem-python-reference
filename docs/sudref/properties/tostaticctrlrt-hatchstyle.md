---
title: "ToStaticCtrlRt.HatchStyle"
description: "Specifies in user dialog boxes the background pattern for a text."
---

# ToStaticCtrlRt.HatchStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HatchStyle for Text

Specifies in user dialog boxes the background pattern for a text.
...
*Source: `Sudref/properties/SUD_property_HatchStyle_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
