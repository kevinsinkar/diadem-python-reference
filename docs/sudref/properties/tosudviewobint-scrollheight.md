---
title: "ToSudViewObInt.ScrollHeight"
description: "Specifies the height of a user dialog box with scroll bar in dialog units ."
---

# ToSudViewObInt.ScrollHeight

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollHeight for Dialog <NonModal>
...
Specifies the height of a user dialog box with scroll bar in dialog units .
...
<td><strong>Note  </strong>The property has no effect if you assign the value <span class="Monospace">0 - No</span> to the <a href="../tosudviewobint-scrollbars/">ScrollBars</a> property.</td>
</tr>
</table>
</div>
...
oMyDlg.ScrollBars = 1
oMyDlg.ScrollHeight = 200
oMyDlg.ScrollWidth = 200
```
...
*Source: `Sudref/properties/SUD_property_ScrollHeight_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
