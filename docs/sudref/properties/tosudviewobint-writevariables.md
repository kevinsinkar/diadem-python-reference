---
title: "ToSudViewObInt.WriteVariables"
description: "Specifies that the user dialog box automatically transfers modified variable values to DIAdem."
---

# ToSudViewObInt.WriteVariables

!!! abstract "Property &middot; `Sudref.chm`"
    Property: WriteVariables for Dialog <NonModal>

Specifies that the user dialog box automatically transfers modified variable values to DIAdem.
...
<td><strong>Note  </strong>This property is no longer available in the current DIAdem version.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_WriteVariables_ToSudViewObInt.HTM`*
