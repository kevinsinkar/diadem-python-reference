---
title: "ToChnListBoxCtrl.SelectionExt"
description: "Specifies in user dialog boxes the index of the term selected in a selection list. The user dialog box does not execute the EventChange method when the value of"
---

# ToChnListBoxCtrl.SelectionExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectionExt for ChnListBox
...
Specifies in user dialog boxes the index of the term selected in a selection list. The user dialog box does not execute the EventChange method when the value of the control changes. The index of the selection term corresponds to the channel number in the Data Portal.
...
```python
ChnListBox1.SelectionExt = 2
```

## See also

<div markdown="1">
<div class="SeeAlso"><table class="Borderless" id="table4">
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>If you assign the value <span class="Monospace">1</span> to the <a href="../tochnlistboxctrl-showblankentry/">ShowBlankEntry</a> property of a channel selection list, the list shows a blank entry as the first entry. The index of this blank entry is <span class="Monospace">0</span>.</td></tr></table><p class="body">The following example selects the second selection term in the <span class="Monospace">ChnListBox1</span> selection list:</p><div class="copyblue"><p class="body"><a href="#">Copy script</a></p></div><div class="codeblue"><pre><donottranslate>ChnListBox1.SelectionExt = <span class="HlNumbers">2</span></donottranslate></pre></div><h2>Use</h2>
<table class="Borderless" id="table6">
<tr>
<td class="Icon"><img src="../image/sud_script.png"/></td>
<td>You can use this property in scripts during user dialog box runtime.</td>
</tr>
...
*Source: `Sudref/properties/SUD_property_SelectionExt_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
