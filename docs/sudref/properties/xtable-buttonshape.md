---
title: "XTable.ButtonShape"
description: "Specifies in user dialog boxes the button form in an extended table."
---

# XTable.ButtonShape

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ButtonShape for Button <XTable>
...
Specifies in user dialog boxes the button form in an extended table.
...
*Source: `Sudref/properties/SUD_property_ButtonShape_ToBtnRteOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
