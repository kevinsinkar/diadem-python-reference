---
title: "ToVarComboRt.picturewidth"
...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureWidth for EnumComboBox
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureWidth</span> property only if you assign a graphic to the <a href="../tovarcombort-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
