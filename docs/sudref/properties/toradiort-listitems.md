---
title: "ToRadioRt.listitems"
description: "Specifies the list elements of controls in user dialog boxes. To modify the properties of the list elements in the dialog editor, click ListItems in the Propert"
---

# ToRadioRt.listitems

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ListItems for RadioButton

Specifies the list elements of controls in user dialog boxes. To modify the properties of the list elements in the dialog editor, click ListItems in the Properties tab.

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td>Note  If you insert the character <span class="Monospace">&amp;</span> into the element name of a <a href="../../objects/toradiort/">RadioButton</a>, the next letter is underlined. You can use this letter, with the &lt;Alt&gt; key, for keyboard navigation.</td></tr></table>
</div>
...
*Source: `Sudref/properties/SUD_property_listitems_ToRadioRt.htm`*
