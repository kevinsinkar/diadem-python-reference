...
description: "Specifies in user dialog boxes the list elements of a control in an extended table. To change properties of the list elements in the dialog editor click to the "
---
...
*Source: `Sudref/properties/SUD_property_listitems_ToListBoxRt_XTable.htm`*
