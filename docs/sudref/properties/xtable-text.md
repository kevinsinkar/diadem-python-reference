...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can use the <a href="../xtable-interpretedtext/">InterpretedText</a> property to read the interpreted text.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can also change the button label directly in the workspace. Use &lt;Ctrl-Enter&gt; to create a line break directly below the entered label.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Text_ToBtnRteOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
