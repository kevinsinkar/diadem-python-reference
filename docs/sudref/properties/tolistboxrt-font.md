...
```python
ListBox1.Font = -FontPointsToPixels(10) + ",,0,0,0,400,0,0,0,0,3,2,1,34,Arial"
```
...
*Source: `Sudref/properties/SUD_property_Font_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
