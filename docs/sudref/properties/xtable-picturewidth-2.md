...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureWidth for ListBox <XTable>
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureWidth</span> property only if you assign a graphic to the <a href="../xtable-picture-4/">Picture</a> property.</td>
</tr>
</table>
</div>
