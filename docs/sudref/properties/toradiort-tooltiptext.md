...
# ToRadioRt.ToolTipText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipText for RadioButton
...
```python
RadioButton1.ToolTipText = "ToolTip"
```
...
*Source: `Sudref/properties/SUD_property_ToolTipText_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
