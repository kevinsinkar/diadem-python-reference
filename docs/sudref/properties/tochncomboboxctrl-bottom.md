---
title: "ToChnComboBoxCtrl.Bottom"
...
# ToChnComboBoxCtrl.Bottom

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bottom for ChnComboBox
...
```python
MsgBoxDisp("Bottom: " + ChnComboBox1.Bottom)
```
