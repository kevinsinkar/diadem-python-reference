...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bottom for RadioButton
...
<td><strong>Note  </strong>If the control is in a tab, the distance is in relation to the upper left corner of the tab surface of the <span class="Monospace">TabPageCtrl</span> control.</td>
</tr>
</table>
</div>
