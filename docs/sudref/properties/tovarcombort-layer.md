...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Layer for EnumComboBox
...
<td><strong>Note  </strong>The <a href="../../methods/tovarcombort-layername/">LayerName</a> method returns the name of the layer a control is in.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
