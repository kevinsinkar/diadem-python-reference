---
title: "ToTreeCtrl.ReadOnly"
description: "Specifies in user dialog boxes that the tree nodes cannot be edited."
---

# ToTreeCtrl.ReadOnly

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ReadOnly for Tree

Specifies in user dialog boxes that the tree nodes cannot be edited.
...
*Source: `Sudref/properties/SUD_property_ReadOnly_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
