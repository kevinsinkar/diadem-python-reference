---
title: "ToSliderCtrl.Maximum"
description: "Specifies the highest value you can set with the Slider control in user dialog boxes."
---

# ToSliderCtrl.Maximum

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Maximum for Slider
...
Specifies the highest value you can set with the Slider control in user dialog boxes.
