---
title: "ToCurvePreviewOb.LegendVisible"
description: "Specifies whether the curve preview displays a legend in user dialog boxes."
---

# ToCurvePreviewOb.LegendVisible

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LegendVisible for Curve2DPreview
...
Specifies whether the curve preview displays a legend in user dialog boxes.
...
Curve2DPreview1.LegendVisible = FALSE
```
...
*Source: `Sudref/properties/SUD_property_LegendVisible_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
