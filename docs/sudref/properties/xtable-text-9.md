---
title: "XTable.Text"
description: "Specifies in a user dialog box the displayed text of a control in an extended table. A user dialog box interprets DIAdem expressions in the text, if you set the"
---
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can use the <a href="../xtable-interpretedtext-5/">InterpretedText</a> property to read the interpreted text.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Text_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
