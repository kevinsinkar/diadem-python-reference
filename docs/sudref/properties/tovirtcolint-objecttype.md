---
title: "ToVirtColInt.ObjectType"
description: "Specifies the type of controls that are assigned to a column of the extended table in user dialog boxes. You can assign the controls Button , CheckBox , ChnComb"
---

# ToVirtColInt.ObjectType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for XTableColumn
...
Specifies the type of controls that are assigned to a column of the extended table in user dialog boxes. You can assign the controls Button , CheckBox , ChnComboBox , ChnListBox , ComboBox , EditBox , ListBox , and Text to a column.
...
*Source: `Sudref/properties/SUD_property_ObjectType_ToVirtColInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
