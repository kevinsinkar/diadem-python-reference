---
title: "ToViewConnectorOb.Width"
description: "Displays the width of the control in the user dialog box. You cannot change this property albeit if you create a user dialog box on the Properties tab or if you"
---

# ToViewConnectorOb.Width

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Width for ViewConnector
...
Displays the width of the control in the user dialog box. You cannot change this property albeit if you create a user dialog box on the Properties tab or if you use in scripts during runtime of the user dialog box.
...
*Source: `Sudref/properties/SUD_property_Width_ToViewConnectorOb.HTM`*
