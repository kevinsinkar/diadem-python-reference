---
title: "ToVirtGridCtrl.HorizontalScroll"
description: "Specifies in user dialog boxes whether an extended table displays a horizontal scroll bar."
---

# ToVirtGridCtrl.HorizontalScroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HorizontalScroll for XTable

Specifies in user dialog boxes whether an extended table displays a horizontal scroll bar.
