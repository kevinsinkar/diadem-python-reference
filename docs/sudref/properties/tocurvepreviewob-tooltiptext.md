---
title: "ToCurvePreviewOb.ToolTipText"
description: "Specifies the tooltip for a control in a user dialog box. If you idle the mouse on a control, a tooltip appears."
---

# ToCurvePreviewOb.ToolTipText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipText for Curve2DPreview
...
Specifies the tooltip for a control in a user dialog box. If you idle the mouse on a control, a tooltip appears.
...
```python
Curve2DPreview1.ToolTipText = "ToolTip"
```
...
*Source: `Sudref/properties/SUD_property_ToolTipText_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
