---
title: "ToViewConnectorOb.Top"
description: "Specifies the distance between the top of the control and the user dialog box origin. The dialog box origin is in the upper-left corner of the user dialog box."
---

# ToViewConnectorOb.Top

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Top for ViewConnector
...
*Source: `Sudref/properties/SUD_property_Top_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
