---
title: "ToBtnRteOb.Default"
description: "Specifies the default button in user dialog boxes. The default button in a dialog box is the button that is selected or highlighted when the dialog box opens. T"
---

# ToBtnRteOb.Default

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Default for Button

Specifies the default button in user dialog boxes. The default button in a dialog box is the button that is selected or highlighted when the dialog box opens. The default button has a wide border. This button is automatically selected if you press <Enter>.
...
*Source: `Sudref/properties/SUD_property_Default_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
