---
title: "ToSpinnerRt.Value"
description: "Specifies in user dialog boxes the value of the the control element. The user dialog box executes the EventChange method when the value of the control changes."
---

# ToSpinnerRt.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for SpinBox

Specifies in user dialog boxes the value of the the control element. The user dialog box executes the EventChange method when the value of the control changes.
...
*Source: `Sudref/properties/SUD_property_Value_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
