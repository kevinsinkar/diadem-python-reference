...
# ToVirtGridCtrl.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for XTable
...
*Source: `Sudref/properties/SUD_property_TabStop_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
