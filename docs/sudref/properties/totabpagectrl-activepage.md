---
title: "ToTabPageCtrl.ActivePage"
description: "Returns the enabled tab of the TabPageCtrl control as an object in user dialog boxes."
---

# ToTabPageCtrl.ActivePage

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ActivePage for TabPageCtrl
...
Returns the enabled tab of the TabPageCtrl control as an object in user dialog boxes.

## Signature

```python
return_value = obj.ActivePage
```
...
*Source: `Sudref/properties/SUD_property_ActivePage_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
