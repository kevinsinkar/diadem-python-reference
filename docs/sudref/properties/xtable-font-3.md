---
title: "XTable.Font"
description: "Specifies in user dialog boxes the font, font style, and font size for controls in extended tables. You can use all the installed fonts. To restore the default "
---

# XTable.Font

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Font for ChnComboBox <XTable>
...
```python
Cell.Font = -dd.FontPointsToPixels(10) + ", None,0,0,0,400,0,0,0,0,3,2,1,34,Arial"
```
