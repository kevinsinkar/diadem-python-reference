---
title: "ToSudViewObInt.MinHeight"
description: "Specifies the minimum height of scalable dialog boxes , in dialog units."
---

# ToSudViewObInt.MinHeight

!!! abstract "Property &middot; `Sudref.chm`"
    Property: MinHeight for Dialog <NonModal>
...
Specifies the minimum height of scalable dialog boxes , in dialog units.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../tosudviewobint-height/">Height</a> property to specify the height of the dialog box.</td></tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>The <span class="Monospace">MinHeight</span> property corresponds to the <span class="Monospace">Height</span> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_MinHeight_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
