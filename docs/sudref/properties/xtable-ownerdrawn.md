---
title: "XTable.OwnerDrawn"
description: "Specifies in user dialog boxes whether a checkbox in an extended table displays the assigned graphic. The property can have the following settings: 0 - No Does "
---

# XTable.OwnerDrawn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: OwnerDrawn for CheckBox <XTable>
...
Specifies in user dialog boxes whether a checkbox in an extended table displays the assigned graphic. The property can have the following settings: 0 - No Does not display the graphic. 1 - Yes Displays the graphic.
...
*Source: `Sudref/properties/SUD_property_ownerdrawn_ToCheckRt_XTable.htm`*
