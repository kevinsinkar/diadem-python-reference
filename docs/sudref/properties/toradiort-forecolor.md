...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for RadioButton
...
```python
RadioButton1.ForeColor = 16711680
```

```python
RadioButton1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
