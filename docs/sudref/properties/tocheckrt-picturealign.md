---
title: "ToCheckRt.picturealign"
description: "Specifies in a user dialog box the alignment of a graphic on the CheckBox control. The property can have the following settings: 0 - Left Positions the graphic "
---

# ToCheckRt.picturealign

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureAlign for CheckBox

Specifies in a user dialog box the alignment of a graphic on the CheckBox control. The property can have the following settings: 0 - Left Positions the graphic to the left. 1 - Right Positions the graphic to the right. 2 - Center Centers the graphic.
...
<td><strong>Note</strong>  You only can specify the <span class="Monospace">PictureAlign</span> property if<br attr="ext"/>the property <a href="../tocheckrt-ownerdrawn/">OwnerDrawn</a> has the value <span class="Monospace">Yes</span>,<br attr="ext"/>and the properties <a href="../tocheckrt-picture/">Picture</a> and <a href="../tocheckrt-pictureoffstate/">PictureOffstate</a> contain graphics that are the same size,<br attr="ext"/>the property <a href="../tocheckrt-shape/">Shape</a> has a value that is different to the <span class="Monospace">0 - CheckBox</span> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_picturealign_ToCheckRt.htm`*
