---
title: "ToCheckRt.ownerdrawn"
description: "Specifies whether checkboxes display the assigned graphic in a user dialog box. The property can have the following settings: 0 - No Does not display the graphi"
---

# ToCheckRt.ownerdrawn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: OwnerDrawn for CheckBox

Specifies whether checkboxes display the assigned graphic in a user dialog box. The property can have the following settings: 0 - No Does not display the graphic. 1 - Yes Displays the graphic.
...
*Source: `Sudref/properties/SUD_property_ownerdrawn_ToCheckRt.htm`*
