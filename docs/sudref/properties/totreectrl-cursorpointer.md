---
title: "ToTreeCtrl.CursorPointer"
description: "Specifies how the user dialog box displays the mouse cursor on a tree."
---

# ToTreeCtrl.CursorPointer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CursorPointer for Tree
...
Specifies how the user dialog box displays the mouse cursor on a tree.
...
*Source: `Sudref/properties/SUD_property_CursorPointer_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
