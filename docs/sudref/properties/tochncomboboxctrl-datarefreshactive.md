---
title: "ToChnComboBoxCtrl.datarefreshactive"
description: "Specifies whether the user dialog box automatically refreshes the selection terms of a channel selection list if the names or the positions of the channels in t"
---

# ToChnComboBoxCtrl.datarefreshactive

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DataRefreshActive for ChnComboBox

Specifies whether the user dialog box automatically refreshes the selection terms of a channel selection list if the names or the positions of the channels in the Data Portal change.

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <a href="../../methods/tochncomboboxctrl-refresh/">Refresh</a> method in scripts to refresh the channel selection list at a time you specify.</td></tr></table>
</div>
