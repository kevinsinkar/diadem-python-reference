...
# ToCheckRt.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for CheckBox
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
