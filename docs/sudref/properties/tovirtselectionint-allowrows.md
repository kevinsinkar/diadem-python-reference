---
title: "ToVirtSelectionInt.AllowRows"
description: "Specifies whether entire rows of an extended table can be selected, for example if the appropriate row label is clicked, in user dialog boxes."
---

# ToVirtSelectionInt.AllowRows

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AllowRows for Selection
...
Specifies whether entire rows of an extended table can be selected, for example if the appropriate row label is clicked, in user dialog boxes.
...
```python
XTable1.SelectedElements.AllowRows = TRUE
```
