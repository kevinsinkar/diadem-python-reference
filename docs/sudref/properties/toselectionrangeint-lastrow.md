---
title: "ToSelectionRangeInt.LastRow"
description: "Specifies the number of the last selected row in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable metho"
---

# ToSelectionRangeInt.LastRow

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LastRow for SelectionItem

Specifies the number of the last selected row in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable method returns the value True and the LastRow property returns the value 0 .
