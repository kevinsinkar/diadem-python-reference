---
title: "ToVirtGridCtrl.cursorpointer"
description: "Specifies in a user dialog box how the user dialog box displays the cursor on the data of an extended table. The property can have the following settings: 0 - D"
---

# ToVirtGridCtrl.cursorpointer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CursorPointer for XTable

Specifies in a user dialog box how the user dialog box displays the cursor on the data of an extended table. The property can have the following settings: 0 - Default Displays a standard arrow. 7 - Hand Displays a hand.
...
*Source: `Sudref/properties/SUD_property_cursorpointer_ToVirtGridCtrl.htm`*
