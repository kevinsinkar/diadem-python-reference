---
title: "ToSpiderCtrl.Orientation"
description: "Specifies the alignment of a control in a user dialog box. The property can have the following settings: 0 - Horizontal Displays the control horizontally. 1 - V"
---

# ToSpiderCtrl.Orientation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Orientation for Slider
...
Specifies the alignment of a control in a user dialog box. The property can have the following settings: 0 - Horizontal Displays the control horizontally. 1 - Vertical Displays the control vertically.
...
*Source: `Sudref/properties/sud_property_Orientation_ToSpiderCtrl.htm`*
