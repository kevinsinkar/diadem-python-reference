---
title: "ToTableCtrl.TitleFontColor"
description: "Specifies the color of the column and row labels in user dialog box tables. Click TitleFontColor in the Properties tab to open the color selection dialog box. T"
---

# ToTableCtrl.TitleFontColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TitleFontColor for Table
...
```python
Table1.TitleFontColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_TitleFontColor_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
