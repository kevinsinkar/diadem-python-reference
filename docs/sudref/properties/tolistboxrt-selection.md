...
# ToListBoxRt.Selection

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for ListBox
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If you can make a multiple selection in a selection list, use the <a href="../../methods/tolistboxrt-multiselection/">MultiSelection</a> method for a list of all the selected terms.</td>
</tr>
</table>
</div>
