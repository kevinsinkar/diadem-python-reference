---
title: "ToChnCtrl.Text"
description: "Specifies the text in a text field of a user dialog box. The ValidReference property specifies whether any text or only valid channel references are allowed. Wh"
---

# ToChnCtrl.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for ChnCtrl
...
*Source: `Sudref/properties/SUD_property_Text_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
