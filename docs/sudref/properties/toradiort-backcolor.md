...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for RadioButton
...
```python
RadioButton1.BackColor = 16711680
```

```python
RadioButton1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
