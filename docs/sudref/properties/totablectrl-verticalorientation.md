---
title: "ToTableCtrl.VerticalOrientation"
description: "Specifies whether rows and columns are exchanged in a user dialog box table."
---

# ToTableCtrl.VerticalOrientation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VerticalOrientation for Table
...
Specifies whether rows and columns are exchanged in a user dialog box table.

## Signature

```python
obj.VerticalOrientation
```
...
```python
Table1.VerticalOrientation = TRUE
```
...
*Source: `Sudref/properties/SUD_property_VerticalOrientation_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
