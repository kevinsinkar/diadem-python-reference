---
title: "XTable.HorizontalScroll"
description: "Specifies in user dialog boxes whether a selection list in an extended table displays a horizontal scroll bar. The property can have the following settings: 0 -"
---

# XTable.HorizontalScroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HorizontalScroll for ChnListBox <XTable>
