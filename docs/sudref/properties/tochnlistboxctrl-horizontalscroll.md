---
title: "ToChnListBoxCtrl.horizontalscroll"
description: "Specifies in user dialog boxes whether a selection list displays a horizontal scroll bar. The property can have the following settings: 0 - None Does not displa"
---

# ToChnListBoxCtrl.horizontalscroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HorizontalScroll for ChnListBox
