---
title: "ToColumn.VarSelection"
description: "Specifies which row or column in a DIAdem matrix variable links a user dialog box to a table. To specify the property value, click Columns in the Properties tab"
---

# ToColumn.VarSelection
...
```python
Table1.Columns(1).VarSelection = 2
```
...
*Source: `Sudref/properties/SUD_property_VarSelection_ToColumn.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
