---
title: "ToStaticCtrlRt.BorderWidth"
description: "Specifies the width of a control frame in user dialog boxes."
---

# ToStaticCtrlRt.BorderWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderWidth for Text
...
Specifies the width of a control frame in user dialog boxes.
...
<td><strong>Note  </strong>The property is ineffective if you assign <span class="Monospace">1 - 3D</span> to the <a href="../tostaticctrlrt-borderstyle/">Borderstyle</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_BorderWidth_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
