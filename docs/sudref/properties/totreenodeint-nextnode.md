---
title: "ToTreeNodeInt.NextNode"
description: "Specifies in user dialog boxes the following nodes in a tree branch. If there is no further node in the branch, DIAdem returns Nothing ."
---

# ToTreeNodeInt.NextNode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: NextNode for TreeNode
...
Specifies in user dialog boxes the following nodes in a tree branch. If there is no further node in the branch, DIAdem returns Nothing .

## Signature

```python
return_value = obj.NextNode
```
...
*Source: `Sudref/properties/SUD_property_NextNode_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
