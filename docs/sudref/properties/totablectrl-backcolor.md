...
# ToTableCtrl.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for Table
...
```python
Table1.BackColor = 16711680
```

```python
Table1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
