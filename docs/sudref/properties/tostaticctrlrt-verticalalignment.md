---
title: "ToStaticCtrlRt.VerticalAlignment"
description: "Specifies the vertical alignment of a text in a user dialog box."
---

# ToStaticCtrlRt.VerticalAlignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VerticalAlignment for Text
...
Specifies the vertical alignment of a text in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_VerticalAlignment_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
