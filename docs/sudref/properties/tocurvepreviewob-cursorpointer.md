...
```python
Curve2DPreview1.CursorPointer = 0
```
...
*Source: `Sudref/properties/SUD_property_CursorPointer_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
