---
title: "XTable.ProcessInput"
description: "Specifies in user dialog boxes whether an expression is interpreted when a DIAdem textbox of an extended table is exited. The property can have the following se"
---
...
*Source: `Sudref/properties/SUD_property_processinput_ToEditCtrlOb_XTable.htm`*
