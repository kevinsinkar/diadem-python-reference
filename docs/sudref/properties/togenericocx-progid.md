---
title: "ToGenericOcx.ProgId"
description: "Specifies in user dialog boxes the unique version number of the ActiveX control."
---

# ToGenericOcx.ProgId

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ProgId for ActiveX
...
Specifies in user dialog boxes the unique version number of the ActiveX control.
...
*Source: `Sudref/properties/SUD_property_ProgId_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
