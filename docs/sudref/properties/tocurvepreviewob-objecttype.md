---
title: "ToCurvePreviewOb.ObjectType"
description: "Specifies the control type in user dialog boxes."
---

# ToCurvePreviewOb.ObjectType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for Curve2DPreview

Specifies the control type in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_ObjectType_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
