...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for CheckBox
...
```python
CheckBox1.ForeColor = 16711680
```

```python
CheckBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
