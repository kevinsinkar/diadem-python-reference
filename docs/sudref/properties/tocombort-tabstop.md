...
```python
ComboBox1.TabStop = 1  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
