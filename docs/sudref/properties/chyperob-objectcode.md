...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for Control
...
```python
oMyCtrl = Dialog.GetControl("Button1")
oMyCtrl.Height = 20
```
...
*Source: `Sudref/properties/SUD_property_ObjectCode_CHyperOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
