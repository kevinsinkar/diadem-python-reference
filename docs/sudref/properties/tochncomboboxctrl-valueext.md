---
title: "ToChnComboBoxCtrl.ValueExt"
description: "Specifies in user dialog boxes the value of the term selected in the control element. The user dialog box does not execute the EventChange method when the value"
---

# ToChnComboBoxCtrl.ValueExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ValueExt for ChnComboBox
