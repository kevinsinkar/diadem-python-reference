---
title: "ToChnComboBoxCtrl.Enable"
description: "Specifies in user dialog boxes whether a control can be enabled. Disabled controls are dimmed."
---

# ToChnComboBoxCtrl.Enable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for ChnComboBox
...
Specifies in user dialog boxes whether a control can be enabled. Disabled controls are dimmed.
...
```python
ChnComboBox1.Enable = 0  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_Enable_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
