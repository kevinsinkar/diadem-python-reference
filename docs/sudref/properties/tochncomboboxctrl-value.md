...
# ToChnComboBoxCtrl.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for ChnComboBox
...
*Source: `Sudref/properties/SUD_property_Value_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
