---
title: "ToEditLines.Count"
description: "Returns the number of lines in a textbox in user dialog boxes."
---

# ToEditLines.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for Lines
...
Returns the number of lines in a textbox in user dialog boxes.
...
```python
MsgBoxDisp(EditBox1.Lines.Count)
```
...
*Source: `Sudref/properties/SUD_property_Count_ToEditLines.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
