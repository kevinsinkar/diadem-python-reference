---
title: "ToChnComboBoxCtrl.TabStop"
description: "Specifies whether you can enable a control with <Tab> during run time in a user dialog box. The property adds the control to the tab order ."
---

# ToChnComboBoxCtrl.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for ChnComboBox

Specifies whether you can enable a control with <Tab> during run time in a user dialog box. The property adds the control to the tab order .
...
```python
ChnComboBox1.TabStop = 1 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_TabStop_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
