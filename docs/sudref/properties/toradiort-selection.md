---
title: "ToRadioRt.Selection"
description: "Specifies in user dialog boxes the index of the term selected in a radio button. The user dialog box executes the EventChange method when the value of the contr"
---

# ToRadioRt.Selection

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for RadioButton

Specifies in user dialog boxes the index of the term selected in a radio button. The user dialog box executes the EventChange method when the value of the control changes. The index of the selection term corresponds to the channel number in the Data Portal.
...
*Source: `Sudref/properties/SUD_property_Selection_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
