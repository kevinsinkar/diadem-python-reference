...
# ToVarComboRt.picture

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Picture for EnumComboBox
...
<td><strong>Note  </strong>Use the <a href="../tovarcombort-picturealign/">PictureAlign</a> property to specify the alignment of the graphics in the selection list.</td>
</tr>
</table>
</div>
