---
title: "ToVirtSelectionInt.Count"
description: "Specifies in user dialog boxes the number of block selections in an extended table."
---

# ToVirtSelectionInt.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for Selection

Specifies in user dialog boxes the number of block selections in an extended table.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>If the <a href="../tovirtselectionint-blockmode/">BlockMode</a> property has the value <span class="Monospace">1-SingleBlock</span>, a maximum of one block is selected.</td></tr></table>
</div>
...
for i in range(1, XTable1.SelectedElements.Count + 1):
    N = XTable1.SelectedElements(i).LastRow - XTable1.SelectedElements(i).FirstRow + 1
...
*Source: `Sudref/properties/SUD_property_Count_ToVirtSelectionInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
