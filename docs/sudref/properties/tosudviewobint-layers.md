---
title: "ToSudViewObInt.Layers"
description: "Assigns controls to various layers in user dialog boxes. Use this property to make the controls you assign to one layer visible or invisible while you generate "
---

# ToSudViewObInt.Layers

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Layers for Dialog <NonModal>

Assigns controls to various layers in user dialog boxes. Use this property to make the controls you assign to one layer visible or invisible while you generate or display the user dialog box. The property does not affect which control is on top.
...
*Source: `Sudref/properties/SUD_property_Layers_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
