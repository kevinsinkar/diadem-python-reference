...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for ComboBox
...
Specifies in user dialog boxes the index of the term selected in a selection list. The user dialog box executes the EventChange method when the value of the control changes.
...
*Source: `Sudref/properties/SUD_property_Selection_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
