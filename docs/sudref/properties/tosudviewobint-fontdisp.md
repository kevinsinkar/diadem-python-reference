---
title: "ToSudViewObInt.FontDisp"
description: "Returns a Font object in user dialog boxes."
---

# ToSudViewObInt.FontDisp

!!! abstract "Property &middot; `Sudref.chm`"
    Property: FontDisp for Dialog <NonModal>
...
Returns a Font object in user dialog boxes.

## Signature

```python
return_value = obj.FontDisp
```
...
<td><strong>Note  </strong>DIAdem uses this property internally.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_FontDisp_ToSudViewObInt.HTM`*
