---
title: "ToSudViewObInt.Title"
description: "Specifies the title for a user dialog box."
---

# ToSudViewObInt.Title

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Title for Dialog <NonModal>
...
Specifies the title for a user dialog box.
...
*Source: `Sudref/properties/SUD_property_Title_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
