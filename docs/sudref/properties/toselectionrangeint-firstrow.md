---
title: "ToSelectionRangeInt.FirstRow"
description: "Specifies the number of the first selected row in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable meth"
---

# ToSelectionRangeInt.FirstRow

!!! abstract "Property &middot; `Sudref.chm`"
    Property: FirstRow for SelectionItem

Specifies the number of the first selected row in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable method returns the value True and the FirstRow property returns the value 0 .
