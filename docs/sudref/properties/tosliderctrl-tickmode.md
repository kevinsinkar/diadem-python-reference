---
title: "ToSliderCtrl.TickMode"
description: "Specifies in user dialog boxes whether DIAdem determines the tick distance for the Slider control automatically or with the TickDistance property."
---

# ToSliderCtrl.TickMode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TickMode for Slider
