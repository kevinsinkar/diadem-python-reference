---
title: "XTable.TriState"
description: "Specifies in a user dialog box whether a checkbox in an extended table has two or three values The property can have the following settings: 0 - No Only allows "
---

# XTable.TriState

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TriState for CheckBox <XTable>
...
Specifies in a user dialog box whether a checkbox in an extended table has two or three values The property can have the following settings: 0 - No Only allows the status Checked and Unchecked . 1 - Yes Also provides the status Undeterminate , which is a gray tick.
...
<td><strong>Note</strong>  The property is only effective if you enter <span class="Monospace"> 0 - No</span> for the <a href="../xtable-ownerdrawn/">OwnerDrawn</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_tristate_ToCheckRt_XTable.htm`*
