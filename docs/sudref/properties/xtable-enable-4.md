---
title: "XTable.Enable"
description: "Specifies in user dialog boxes whether a control can be enabled in an extended table. DIAdem displays channel entry fields, which cannot be enabled, in gray fon"
---

# XTable.Enable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for ChnCtrl <XTable>

Specifies in user dialog boxes whether a control can be enabled in an extended table. DIAdem displays channel entry fields, which cannot be enabled, in gray font in the extended table.
...
*Source: `Sudref/properties/SUD_property_Enable_ToChnCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
