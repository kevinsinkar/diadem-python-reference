---
title: "ToCurvePreviewOb.XAxisScalingType"
description: "Specifies how the x-axis of the curve preview is scaled in user dialog boxes."
---

# ToCurvePreviewOb.XAxisScalingType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: XAxisScalingType for Curve2DPreview
...
Specifies how the x-axis of the curve preview is scaled in user dialog boxes.

## Signature

```python
obj.XAxisScalingType
```
...
*Source: `Sudref/properties/SUD_property_XAxisScalingType_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
