---
title: "ToTabPageCtrl.Style"
description: "Specifies in a user dialog box the display style for the tabs of the TabPageCtrl control."
---

# ToTabPageCtrl.Style

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Style for TabPageCtrl
...
Specifies in a user dialog box the display style for the tabs of the TabPageCtrl control.
...
*Source: `Sudref/properties/SUD_property_Style_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
