...
```python
ChnListBox1.UseColors = 0  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_UseColors_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
