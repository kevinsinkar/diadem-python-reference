---
title: "ToTreeCtrl.NodeLinesDrawn"
description: "Specifies whether DIAdem displays lines between the elements in the tree. The property can have the following settings: True Draws lines. False Does not draw li"
---

# ToTreeCtrl.NodeLinesDrawn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: NodeLinesDrawn for Tree

Specifies whether DIAdem displays lines between the elements in the tree. The property can have the following settings: True Draws lines. False Does not draw lines.
...
*Source: `Sudref/properties/sud_property_NodeLinesDrawn_ToTreeCtrl.htm`*
