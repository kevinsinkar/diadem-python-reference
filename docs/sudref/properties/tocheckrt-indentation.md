---
title: "ToCheckRt.indentation"
description: "Specifies the distance from the checkbox to the edge of the control in user dialog boxes. The entry must be in pixels. The distance refers to the left or the ri"
---

# ToCheckRt.indentation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Indentation for CheckBox

Specifies the distance from the checkbox to the edge of the control in user dialog boxes. The entry must be in pixels. The distance refers to the left or the right, depending on the AlignTextLeft property.
...
*Source: `Sudref/properties/SUD_property_indentation_ToCheckRt.htm`*
