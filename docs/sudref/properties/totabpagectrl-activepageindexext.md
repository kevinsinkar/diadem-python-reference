---
title: "ToTabPageCtrl.ActivePageIndexExt"
description: "Specifies in user dialog boxes which tab of the TabPageCtrl is enabled and visible. The user dialog box does not execute the EventChange method when the value o"
---

# ToTabPageCtrl.ActivePageIndexExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ActivePageIndexExt for TabPageCtrl

Specifies in user dialog boxes which tab of the TabPageCtrl is enabled and visible. The user dialog box does not execute the EventChange method when the value of the control changes.

## Signature

```python
obj.ActivePageIndexExt
```
...
<td><strong>Note</strong>  You can use either the tab name or the tab number to set this property. When you access this property, the return value is always the number.</td>
</tr>
</table>
</div>
...
```python
MsgBoxDisp(TabPageCtrl1.ActivePageIndex)
```
