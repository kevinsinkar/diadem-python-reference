...
```python
Frame1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
