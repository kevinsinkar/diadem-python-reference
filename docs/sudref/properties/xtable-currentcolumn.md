---
title: "XTable.CurrentColumn"
description: "Specifies in user dialog boxes the index of the column where the cursor is located inside the textbox of an extended table. If you set a column index, the curso"
---

# XTable.CurrentColumn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CurrentColumn for EditBox <XTable>
...
```python
Text1.Text = EditBox1.CurrentColumn
```
...
*Source: `Sudref/properties/SUD_property_CurrentColumn_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
