---
title: "ToTreeCtrl.scroll"
description: "Specifies that a user dialog box displays a scroll bar. The property can have the following settings: 0 - None DIAdem does not display a scroll bar. 1 - Vertica"
---
...
*Source: `Sudref/properties/sud_property_scroll_ToTreeCtrl.htm`*
