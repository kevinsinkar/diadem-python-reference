...
# ToChnListBoxCtrl.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for ChnListBox
...
<td><strong>Note  </strong>In the editable selection list you also can enter a term that the selection list does not contain. In this case, the properties <a href="../tochnlistboxctrl-value/">Value</a> and <a href="../tochnlistboxctrl-selection/">Selection</a> receive the value <span class="Monospace">-1</span>.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Text_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
