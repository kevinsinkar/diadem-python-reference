---
title: "ToTaskPanelCtrl.BorderStyle"
description: "Specifies the frame style for a control in a user dialog box. The property can have the following settings: 0 - None Draws no frame. 1 - 3D Displays a narrow fr"
---

# ToTaskPanelCtrl.BorderStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderStyle for TaskPanel
...
Specifies the frame style for a control in a user dialog box. The property can have the following settings: 0 - None Draws no frame. 1 - 3D Displays a narrow frame as a 3D indentation. 2 - Line Displays a standard frame.
...
*Source: `Sudref/properties/SUD_property_BorderStyle_ToTaskPanelCtrl.HTM`*
