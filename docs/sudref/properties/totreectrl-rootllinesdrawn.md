---
title: "ToTreeCtrl.RootlLinesDrawn"
description: "Specifies whether DIAdem displays lines between the roots in the tree. The property can have the following settings: True Draws lines. False Does not draw lines"
---

# ToTreeCtrl.RootlLinesDrawn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RootlLinesDrawn for Tree
...
Specifies whether DIAdem displays lines between the roots in the tree. The property can have the following settings: True Draws lines. False Does not draw lines.
...
*Source: `Sudref/properties/sud_property_RootlLinesDrawn_ToTreeCtrl.htm`*
