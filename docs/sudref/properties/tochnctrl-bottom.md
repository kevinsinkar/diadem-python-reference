...
```python
MsgBoxDisp("Bottom: " + ChnCtrl1.Bottom)
```
...
*Source: `Sudref/properties/SUD_property_Bottom_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
