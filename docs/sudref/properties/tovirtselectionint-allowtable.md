---
title: "ToVirtSelectionInt.AllowTable"
description: "Specifies in user dialog boxes whether the entire extended table can be selected when you click the cell in the top left corner."
---

# ToVirtSelectionInt.AllowTable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AllowTable for Selection
...
Specifies in user dialog boxes whether the entire extended table can be selected when you click the cell in the top left corner.
...
```python
XTable1.SelectedElements.AllowTable = TRUE
```
