---
title: "ToTabPageViewOb.Title"
description: "Specifies the tab label of the TabPageCtrl control. A user dialog box interprets DIAdem expressions in the text, if you set the value 1 for the InterpretedTextE"
---

# ToTabPageViewOb.Title
...
*Source: `Sudref/properties/SUD_property_Title_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
