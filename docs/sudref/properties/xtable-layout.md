---
title: "XTable.Layout"
description: "Specifies the alignment of a graphic on a button in user dialog boxes."
---

# XTable.Layout

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Layout for Button <XTable>

Specifies the alignment of a graphic on a button in user dialog boxes.
...
```python
Cell.Layout = 0  # 0=Center, 1=Left, 2=Right, 3=Top, 4=Bottom
```
...
*Source: `Sudref/properties/SUD_property_Layout_ToBtnRteOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
