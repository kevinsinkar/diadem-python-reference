---
title: "ToStaticCtrlRt.BackColor"
description: "Specifies the background color for a control in a user dialog box. Use the automatic setting if you want the background color to correspond to the color setting"
---

# ToStaticCtrlRt.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for Text
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note</strong>  The <span class="Monospace">BackColor</span> property is only effective if the <a href="../tostaticctrlrt-rotateangle/">RotateAngle</a> property has the value <span class="Monospace">0</span>.</td>
</tr>
</table>
</div>
...
```python
Text1.BackColor = 16711680
```

```python
Text1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
