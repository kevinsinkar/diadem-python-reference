---
title: "ToFrameRt.HighlightColor"
...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: HighlightColor for Frame
...
<td><strong>Note  </strong>To include the <span class="Monospace">HighlightColor</span> property in the display, you must enter a value greater than 0 for the <a href="../toframert-borderwidth/">BorderWidth</a> property and enter the value <span class="Monospace">Sunken</span> or <span class="Monospace">Raised</span> for the <span class="Monospace">BorderStyle</span> property.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
...
```python
Frame1.HighlightColor = 16711680
```
