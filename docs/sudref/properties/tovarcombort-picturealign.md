---
title: "ToVarComboRt.picturealign"
description: "Specifies picture alignment in a selection list in a user dialog box. The property can have the following settings: 0 - Left Positions the graphic to the left. "
---

# ToVarComboRt.picturealign

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureAlign for EnumComboBox
...
Specifies picture alignment in a selection list in a user dialog box. The property can have the following settings: 0 - Left Positions the graphic to the left. 1 - Right Positions the graphic to the right. 2 - Center Centers the graphic.
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureAlign</span> property only if you assign a graphic to the <a href="../tovarcombort-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_picturealign_ToVarComboRt.htm`*
