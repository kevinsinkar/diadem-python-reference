---
title: "XTable.ComboType"
description: "Specifies in user dialog boxes that the user can enter text in a selection list of the extended table. This does not modify the selection terms."
---

# XTable.ComboType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ComboType for ChnComboBox <XTable>
...
Specifies in user dialog boxes that the user can enter text in a selection list of the extended table. This does not modify the selection terms.
...
```python
Cell.ComboType = 2  # 2=StaticDropDown
```
...
*Source: `Sudref/properties/SUD_property_ComboType_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
