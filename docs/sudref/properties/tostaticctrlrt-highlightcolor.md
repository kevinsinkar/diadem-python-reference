---
title: "ToStaticCtrlRt.HighlightColor"
description: "Specifies the color of the highlight of a control in user dialog boxes. Click HighlightColor on the Properties tab to open the color selection dialog box. The c"
---

# ToStaticCtrlRt.HighlightColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HighlightColor for Text
...
Specifies the color of the highlight of a control in user dialog boxes. Click HighlightColor on the Properties tab to open the color selection dialog box. The color selection dialog box offers a basic palette of colors and the option to define more colors. Use a RGB value or a VBS color constant to specify the color.
...
<td><strong>Note  </strong>To include the <span class="Monospace">HighlightColor</span> property in the display, you must enter a value greater than 0 for the <a href="../tostaticctrlrt-borderwidth/">BorderWidth</a> property and enter the value <span class="Monospace">Sunken</span> or <span class="Monospace">Raised</span> for the <span class="Monospace">BorderStyle</span> property.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note</strong> Use the VBS function <span class="Monospace">RGB</span> to calculate the RGB color value of colors, based on the proportions of the colors red, green, and blue.</td>
</tr>
</table>
</div>
...
```python
text1.HighlightColor = 16711680
```

```python
Text1.HighlightColor = dd.RGB(0,0,255)
```
