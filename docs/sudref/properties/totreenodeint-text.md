---
title: "ToTreeNodeInt.Text"
description: "Specifies in user dialog boxes the displayed text of a node in the tree."
---

# ToTreeNodeInt.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for TreeNode
...
Specifies in user dialog boxes the displayed text of a node in the tree.
...
*Source: `Sudref/properties/SUD_property_Text_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
