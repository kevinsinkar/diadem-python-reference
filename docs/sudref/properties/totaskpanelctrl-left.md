...
# ToTaskPanelCtrl.Left

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Left for TaskPanel
...
*Source: `Sudref/properties/SUD_property_Left_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
