...
<td><strong>Note</strong>  The default layout property for graphics is <span class="Monospace">Size to Fit</span>. Change the <a href="../topictureob-layout/">Layout</a> property to access other display modes.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Picture_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
