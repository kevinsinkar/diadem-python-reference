---
title: "ToBtnRteOb.ButtonShape"
description: "Specifies a button shape in a user dialog box."
---

# ToBtnRteOb.ButtonShape

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ButtonShape for Button

Specifies a button shape in a user dialog box.
...
<td>  <strong>Note</strong>  The  <span class="Monospace">2 - Tab (active)</span> setting is disabled. Use the <a href="../../objects/totabpagectrl/">TabPageCtrl</a> control instead.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_ButtonShape_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
