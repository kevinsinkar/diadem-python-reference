---
title: "ToPictureOb.Layout"
description: "Specifies the display of a graphic in user dialog boxes."
---

# ToPictureOb.Layout

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Layout for Picture

Specifies the display of a graphic in user dialog boxes.
...
<td><strong>Note</strong>  The property is only effective if the <a href="../topictureob-rotateangle/">RotateAngle</a> property has the value <span class="Monospace">0</span>.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Layout_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
