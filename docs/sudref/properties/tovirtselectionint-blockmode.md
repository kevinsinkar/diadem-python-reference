---
title: "ToVirtSelectionInt.BlockMode"
description: "Specifies in user dialog boxes whether and which kind of block selection is allowed in an extended table. A block selection consists of several adjacent, select"
---

# ToVirtSelectionInt.BlockMode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BlockMode for Selection
...
Specifies in user dialog boxes whether and which kind of block selection is allowed in an extended table. A block selection consists of several adjacent, selected table cells.
...
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>The setting <span class="Monospace">NoBlock</span> in the ListBox mode means that only one row of the table is selectable.</td></tr></table>
</div>
...
*Source: `Sudref/properties/SUD_property_BlockMode_ToVirtSelectionInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
