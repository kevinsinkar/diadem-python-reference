---
title: "ToChnComboBoxCtrl.dropdownwidth"
description: "Specifies the minimum width of an open selection list in a user dialog box. If this width is less than the width specified in Width , the user dialog box displa"
---

# ToChnComboBoxCtrl.dropdownwidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DropDownWidth for ChnComboBox

Specifies the minimum width of an open selection list in a user dialog box. If this width is less than the width specified in Width , the user dialog box displays the open selection list with the Width width. The open selection list widens automatically if the minimum width specified makes some of the entries in the selection list illegible.
...
*Source: `Sudref/properties/SUD_property_dropdownwidth_ToChnComboBoxCtrl.htm`*
