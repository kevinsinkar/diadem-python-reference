---
title: "XTable.ListItems"
description: "Specifies in user dialog boxes the list elements of controls of the extended table. To change properties of the list elements in the dialog editor click to the "
---

# XTable.ListItems

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ListItems for ComboBox <XTable>

Specifies in user dialog boxes the list elements of controls of the extended table. To change properties of the list elements in the dialog editor click to the right of ListItems in the Cell Type dialog box.
...
*Source: `Sudref/properties/SUD_property_listitems_ToComboRt_XTable.htm`*
