---
title: "XTable.DisplayNumbers"
description: "Specifies whether the channel selection list of an extended table displays the channel numbers."
---

# XTable.DisplayNumbers

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DisplayNumbers for ChnComboBox <XTable>
...
Specifies whether the channel selection list of an extended table displays the channel numbers.
