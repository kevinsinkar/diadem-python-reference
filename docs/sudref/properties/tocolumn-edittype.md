---
title: "ToColumn.EditType"
description: "Specifies whether the user dialog box displays table cells that are linked to a dynamic enumeration variable as an EditBox or as a ComboBox . To modify this pro"
---

# ToColumn.EditType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: EditType for Column
...
Specifies whether the user dialog box displays table cells that are linked to a dynamic enumeration variable as an EditBox or as a ComboBox . To modify this property, click the Properties tab of a table, then click Columns and Column type .
...
*Source: `Sudref/properties/SUD_property_EditType_ToColumn.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
