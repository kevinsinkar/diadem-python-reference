---
title: "ToColumn.Width"
description: "Specifies in user dialog boxes the width of a table column. Click Columns on the Properties tab to specify the column width."
---
...
Specifies in user dialog boxes the width of a table column. Click Columns on the Properties tab to specify the column width.
...
*Source: `Sudref/properties/SUD_property_Width_ToColumn.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
