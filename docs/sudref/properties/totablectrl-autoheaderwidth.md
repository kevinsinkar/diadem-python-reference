---
title: "ToTableCtrl.AutoHeaderWidth"
description: "Automatically specifies the width of the first column of a table in a user dialog box."
---

# ToTableCtrl.AutoHeaderWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AutoHeaderWidth for Table

Automatically specifies the width of the first column of a table in a user dialog box.
...
```python
Table1.AutoHeaderWidth = 1 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_AutoHeaderWidth_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
