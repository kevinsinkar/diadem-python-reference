---
title: "XTable.Text"
description: "Specifies in user dialog boxes the selected term of a selection list in the extended table. The value range corresponds to the number of selection terms you hav"
---

# XTable.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for ListBox <XTable>

Specifies in user dialog boxes the selected term of a selection list in the extended table. The value range corresponds to the number of selection terms you have defined on the Properties tab under ListItems for the control.
...
*Source: `Sudref/properties/SUD_property_Text_ToListBoxRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
