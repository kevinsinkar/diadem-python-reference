---
title: "ToRow.DisplayedLocation"
description: "Returns the index where a table displays a row in user dialog boxes."
---

# ToRow.DisplayedLocation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DisplayedLocation for Row
...
Returns the index where a table displays a row in user dialog boxes.
...
<td><strong>Note  </strong>If you enter the position using the <a href="../totablectrl-columns/">columns</a> or <a href="../totablectrl-rows/">rows property</a>, you refer to the original table order. The order remains unchanged when you move columns or rows interactively, or when you use the <a href="../../methods/torowsdisp-swap/">Swap</a> method. The <span class="Monospace">DisplayedLocation</span> property contains the position where the table displays the row or column.</td>
</tr>
</table>
</div>
...
```python
MsgBoxDisp(Table1.Rows(1).DisplayedLocation)
# The value 1 is displayed
Table1.Rows.Swap(1, 3)
MsgBoxDisp(Table1.Rows(1).DisplayedLocation)
...
*Source: `Sudref/properties/SUD_property_DisplayedLocation_ToRow.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
