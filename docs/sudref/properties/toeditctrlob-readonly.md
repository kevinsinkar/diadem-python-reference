---
title: "ToEditCtrlOb.ReadOnly"
description: "Specifies in user dialog boxes that control values are only displayed. You cannot change the values."
---

# ToEditCtrlOb.ReadOnly

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ReadOnly for EditBox

Specifies in user dialog boxes that control values are only displayed. You cannot change the values.
...
<td><strong>Note</strong>  Set <span class="Monospace">0</span> for the <a href="../toeditctrlob-enable/">Enable</a> property for the <span class="Monospace">EditBox</span> control, to also prevent text from being copied.</td>
</tr>
</table>
</div>
