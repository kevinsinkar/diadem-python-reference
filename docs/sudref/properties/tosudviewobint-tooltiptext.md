---
title: "ToSudViewObInt.ToolTipText"
description: "Specifies the tooltip for a dialog box in a user dialog box. If you idle the mouse on a dialog box, the tooltip appears."
---

# ToSudViewObInt.ToolTipText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipText for Dialog <NonModal>

Specifies the tooltip for a dialog box in a user dialog box. If you idle the mouse on a dialog box, the tooltip appears.
...
*Source: `Sudref/properties/SUD_property_ToolTipText_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
