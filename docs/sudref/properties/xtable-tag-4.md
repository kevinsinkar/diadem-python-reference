---
title: "XTable.Tag"
description: "Defines in a user dialog box any label for a control of an extended table. The tag does not affect the behavior of the control."
---

# XTable.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for ChnComboBox <XTable>
...
Defines in a user dialog box any label for a control of an extended table. The tag does not affect the behavior of the control.
...
*Source: `Sudref/properties/SUD_property_Tag_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
