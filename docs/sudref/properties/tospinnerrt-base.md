---
title: "ToSpinnerRt.Base"
description: "Specifies the base of the SpinBox control in a user dialog box."
---

# ToSpinnerRt.Base

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Base for SpinBox

Specifies the base of the SpinBox control in a user dialog box.
...
<td><strong>Note  </strong>In hexadecimal display, the difference between the <a href="../tospinnerrt-minimum/">Minimum</a> and the <a href="../tospinnerrt-maximum/">Maximum</a> in a spin box must not exceed the value 32767. Do not enter numbers with decimal places for the minimum, the maximum, or the <a href="../tospinnerrt-increment/">step width</a> in hexadecimal display. DIAdem automatically adjusts your spin box entries to meet these guidelines.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Base_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
