---
title: "ToVarListBoxRt.ForeColor"
...
# ToVarListBoxRt.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for EnumListBox
...
```python
EnumListBox1.ForeColor = 16711680
```

```python
EnumListBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
