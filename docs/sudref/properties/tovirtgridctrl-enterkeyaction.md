---
title: "ToVirtGridCtrl.enterkeyaction"
description: "Specifies in user dialog boxes which cell in the extended table is framed after you edit the current cell and press <Enter>. The property can have the following"
---

# ToVirtGridCtrl.enterkeyaction
...
*Source: `Sudref/properties/SUD_property_enterkeyaction_ToVirtGridCtrl.htm`*
