---
title: "XTable.Value"
description: "Specifies in a user dialog box the value of the term selected in a channel selection list of an extended table. The range of values corresponds to the number of"
---

# XTable.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for ChnListBox <XTable>

Specifies in a user dialog box the value of the term selected in a channel selection list of an extended table. The range of values corresponds to the number of options in the control. If no element is selected, the property has the value -1 . In a channel selection list, the value range corresponds to the numbers of the loaded channels.
...
<div markdown="1">
<table class="Borderless" id="table2"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If you assign the values <span class="Monospace">1</span> or <span class="Monospace">2</span> to the <a href="../xtable-selectionmode/">SelectionMode</a> property of a channel selection list, this property displays the last term selected.</td></tr></table>
</div>
...
*Source: `Sudref/properties/SUD_property_Value_ToChnListBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
