...
```python
EnumComboBox1.Accelerator = Asc("X")
```
...
*Source: `Sudref/properties/SUD_property_Accelerator_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
