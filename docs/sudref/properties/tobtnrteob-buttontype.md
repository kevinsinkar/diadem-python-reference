---
title: "ToBtnRteOb.buttontype"
description: "Specifies a button type in a user dialog box. The property can have the following settings: 0 - Cancel Triggers the EventClick event, closes the user dialog box"
---

# ToBtnRteOb.buttontype
...
*Source: `Sudref/properties/SUD_property_buttontype_ToBtnRteOb.htm`*
