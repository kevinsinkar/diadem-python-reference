---
title: "ToTabPageCtrl.ActivePageIndex"
description: "Specifies in user dialog boxes which tab of the TabPageCtrl is enabled and visible. The user dialog box executes the EventChange method when the value of the co"
---

# ToTabPageCtrl.ActivePageIndex

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ActivePageIndex for TabPageCtrl

Specifies in user dialog boxes which tab of the TabPageCtrl is enabled and visible. The user dialog box executes the EventChange method when the value of the control changes.
