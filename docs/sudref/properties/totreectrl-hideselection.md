---
title: "ToTreeCtrl.HideSelection"
description: "Specifies in user dialog boxes whether the selection remains visible in the tree when the control is no longer active. If the value is True , DIAdem does not sh"
---

# ToTreeCtrl.HideSelection

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HideSelection for Tree
...
Specifies in user dialog boxes whether the selection remains visible in the tree when the control is no longer active. If the value is True , DIAdem does not show a selection otherwise DIAdem displays the selection as a grey surface.
...
*Source: `Sudref/properties/SUD_property_HideSelection_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
