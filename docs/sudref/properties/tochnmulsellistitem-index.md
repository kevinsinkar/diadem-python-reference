---
title: "ToChnMulSelListItem.Index"
description: "Returns the index of a selected term in the channel selection list in user dialog boxes."
---

# ToChnMulSelListItem.Index

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Index for ChnListItem
...
Returns the index of a selected term in the channel selection list in user dialog boxes.
...
<div markdown="1">
<table class="Borderless" id="table3"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>If you assign the value <span class="Monospace">1</span> to the <a href="../tochnlistboxctrl-showblankentry/">ShowBlankEntry</a> property of a channel selection list, the list shows a blank entry as the first entry. The index of this blank entry is <span class="Monospace">0</span>.</td></tr></table>
</div>
...
for i in range(1, ChnListBox1.MultiSelection.Count + 1):
    MsgBoxDisp(ChnListBox1.MultiSelection.Item(i).Index + " , " + ChnListBox1.MultiSelection.Item(i).Text)
```
...
*Source: `Sudref/properties/SUD_property_Index_ToChnMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
