---
title: "ToTreeCtrl.Indentation"
description: "This property is no longer available in the current DIAdem version. Specifies in user dialog boxes how far the node is indented from its parent node, in pixel i"
---

# ToTreeCtrl.Indentation

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Indentation for Tree

This property is no longer available in the current DIAdem version. Specifies in user dialog boxes how far the node is indented from its parent node, in pixel in the tree.
...
*Source: `Sudref/properties/SUD_property_Indentation_ToTreeCtrl.htm`*
