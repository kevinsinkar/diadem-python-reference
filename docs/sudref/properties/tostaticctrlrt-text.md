...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can use the <a href="../tostaticctrlrt-interpretedtext/">InterpretedText</a> property to read the interpreted text.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Text_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
