---
title: "ToVirtGridCtrl.BackColor"
...
# ToVirtGridCtrl.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for XTable
...
```python
XTable1.BackColor = 16711680
```

```python
XTable1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
