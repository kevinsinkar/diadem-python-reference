---
title: "XTable.Channel"
description: "Specifies in a user dialog box the channel as a channel object in the channel entry field of an extended table. If DIAdem does not find a channel for the entere"
---

# XTable.Channel

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Channel for ChnCtrl <XTable>
...
Specifies in a user dialog box the channel as a channel object in the channel entry field of an extended table. If DIAdem does not find a channel for the entered channel reference, DIAdem returns Nothing .
...
*Source: `Sudref/properties/SUD_property_Channel_ToChnCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
