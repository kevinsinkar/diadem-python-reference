...
# ToEditCtrlOb.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for EditBox
...
```python
EditBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
