---
title: "XTable.HatchStyle"
description: "Specifies in user dialog boxes the background pattern of a text in an extended table."
---

# XTable.HatchStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HatchStyle for Text <XTable>
...
Specifies in user dialog boxes the background pattern of a text in an extended table.
...
*Source: `Sudref/properties/SUD_property_HatchStyle_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
