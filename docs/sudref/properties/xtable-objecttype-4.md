---
title: "XTable.ObjectType"
description: "Specifies in a user dialog box the type of a control in an extended table."
---

# XTable.ObjectType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for ChnComboBox <XTable>
...
Specifies in a user dialog box the type of a control in an extended table.
...
*Source: `Sudref/properties/SUD_property_ObjectType_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
