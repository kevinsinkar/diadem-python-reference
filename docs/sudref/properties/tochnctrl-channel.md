---
title: "ToChnCtrl.Channel"
description: "Specifies in a user dialog box the channel as a channel object in the channel entry field. If DIAdem does not find a channel for the entered channel reference, "
---

# ToChnCtrl.Channel

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Channel for ChnCtrl
...
Specifies in a user dialog box the channel as a channel object in the channel entry field. If DIAdem does not find a channel for the entered channel reference, DIAdem returns Nothing .
...
*Source: `Sudref/properties/SUD_property_Channel_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
