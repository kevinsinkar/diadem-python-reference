...
description: "Specifies whether the channel selection list in an extended table allows multiple selection. The property can have the following settings: 0 - Single selection "
---

# XTable.SelectionMode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectionMode for ChnListBox <XTable>
...
*Source: `Sudref/properties/SUD_property_selectionmode_ToChnListBoxCtrl_XTable.htm`*
