...
```python
EnumListBox1.Accelerator = Asc("X")
```
...
*Source: `Sudref/properties/SUD_property_Accelerator_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
