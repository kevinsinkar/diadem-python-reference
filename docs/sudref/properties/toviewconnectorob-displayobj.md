---
title: "ToViewConnectorOb.DisplayObj"
description: "Returns the object that contains the area of the dialog box display in DIAdem VIEW."
---

# ToViewConnectorOb.DisplayObj

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DisplayObj for ViewConnector

Returns the object that contains the area of the dialog box display in DIAdem VIEW.
...
*Source: `Sudref/properties/SUD_property_DisplayObj_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
