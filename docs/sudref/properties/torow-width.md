---
title: "ToRow.Width"
description: "Specifies in user dialog boxes the width of table row. Click Rows on the Properties tab to specify the width of the rows."
---

# ToRow.Width

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Width for Row

Specifies in user dialog boxes the width of table row. Click Rows on the Properties tab to specify the width of the rows.
...
*Source: `Sudref/properties/SUD_property_Width_ToRow.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
