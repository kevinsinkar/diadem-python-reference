---
title: "ToSudviewob.resizeable"
description: "Specifies that the user can modify the height and width of a user dialog box during run time. Use the Flex properties to specify the behavior of the individual "
---

# ToSudviewob.resizeable
...
*Source: `Sudref/properties/SUD_property_resizeable_ToSudviewob.htm`*
