...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for Dialog <NonModal>
...
*Source: `Sudref/properties/SUD_property_Tag_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
