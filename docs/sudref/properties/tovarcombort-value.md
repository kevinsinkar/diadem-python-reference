...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for EnumComboBox
...
*Source: `Sudref/properties/SUD_property_Value_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
