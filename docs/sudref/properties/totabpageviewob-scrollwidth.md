---
title: "ToTabPageViewOb.ScrollWidth"
description: "Specifies the width of a tab of the TabPageCtrl control with scroll bars in dialog units ."
---

# ToTabPageViewOb.ScrollWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollWidth for Page

Specifies the width of a tab of the TabPageCtrl control with scroll bars in dialog units .
...
*Source: `Sudref/properties/SUD_property_ScrollWidth_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
