---
title: "ToTableCtrl.CursorPointer"
description: "Specifies how the user dialog box displays the mouse cursor on a control. Note DIAdem uses the CursorPointer property internally."
---

# ToTableCtrl.CursorPointer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CursorPointer for Table

Specifies how the user dialog box displays the mouse cursor on a control. Note DIAdem uses the CursorPointer property internally.

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>DIAdem uses the <span class="Monospace">CursorPointer</span> property internally.</td></tr></table>
</div>
...
*Source: `Sudref/properties/SUD_property_CursorPointer_ToTableCtrl.HTM`*
