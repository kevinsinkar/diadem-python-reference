---
title: "ToCurvePreviewOb.Visible"
description: "Specifies whether a control is visible in user dialog boxes."
---

# ToCurvePreviewOb.Visible

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Visible for Curve2DPreview

Specifies whether a control is visible in user dialog boxes.
...
```python
Curve2DPreview1.Visible = 0  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_Visible_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
