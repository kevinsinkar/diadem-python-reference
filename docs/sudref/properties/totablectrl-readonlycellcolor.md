---
title: "ToTableCtrl.ReadOnlyCellColor"
description: "Specifies the background color of read-only table cells in user dialog boxes. Click ReadOnlyCellColor in the Properties tab to open the color selection dialog b"
---
...
*Source: `Sudref/properties/SUD_property_ReadOnlyCellColor_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
