---
title: "XTable.ValidReference"
description: "Specifies whether any text or only valid channel references are allowed in an extended table. The property can have the following settings: False Any text is al"
---

# XTable.ValidReference

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ValidReference for ChnCtrl <XTable>

Specifies whether any text or only valid channel references are allowed in an extended table. The property can have the following settings: False Any text is allowed True Only valid channel references are allowed. If you exit the control, DIAdem checks the entered text and replaces it with a valid channel reference. If DIAdem cannot find a suitable channel reference, it deletes the text from the control.
...
*Source: `Sudref/properties/sud_property_ValidReference_ToChnCtrl_XTable.htm`*
