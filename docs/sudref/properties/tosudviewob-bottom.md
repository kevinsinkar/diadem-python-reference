---
title: "ToSudViewOb.Bottom"
description: "Specifies the distance from the bottom edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen. The top edge of t"
---

# ToSudViewOb.Bottom

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bottom for Dialog

Specifies the distance from the bottom edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen. The top edge of the user dialog box remains unchanged. To move a dialog box, use the Move method.
