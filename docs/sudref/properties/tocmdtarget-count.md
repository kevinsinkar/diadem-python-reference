---
title: "ToCmdTarget.Count"
description: "Returns the number of controls in a dialog box or in a tab."
---

# ToCmdTarget.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for Controls

Returns the number of controls in a dialog box or in a tab.
...
*Source: `Sudref/properties/SUD_property_Count_CHyperArray_ToCmdTarget.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
