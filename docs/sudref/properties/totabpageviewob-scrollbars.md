---
title: "ToTabPageViewOb.ScrollBars"
description: "Specifies that a tab of the TabPageCtrl control displays scroll bars. Use the properties ScrollHeight and ScrollWidth to specify the height and width."
---

# ToTabPageViewOb.ScrollBars

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollBars for Page

Specifies that a tab of the TabPageCtrl control displays scroll bars. Use the properties ScrollHeight and ScrollWidth to specify the height and width.
...
*Source: `Sudref/properties/SUD_property_ScrollBars_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
