---
title: "ToVirtGridCtrl.ActiveCellCol"
description: "Returns the column index of the enabled cell in an extended table in user dialog boxes. If no table cell is enabled, the property has the value -1 ."
---

# ToVirtGridCtrl.ActiveCellCol

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ActiveCellCol for XTable

Returns the column index of the enabled cell in an extended table in user dialog boxes. If no table cell is enabled, the property has the value -1 .
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  Use the <a href="../../methods/tovirtgridctrl-setactivecell/">SetActiveCell</a> method to position the enabled cell in the extended table.</td></tr></table>
</div>
