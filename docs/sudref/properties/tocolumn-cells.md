...
```python
Table1.Columns(1).Cells(2).Value = 3
```
...
*Source: `Sudref/properties/SUD_property_Cells_ToColumn.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
