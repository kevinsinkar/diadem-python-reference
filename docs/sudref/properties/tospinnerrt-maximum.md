---
title: "ToSpinnerRt.Maximum"
description: "Specifies the highest value you can set with the SpinBox control in user dialog boxes. The WrapAround property specifies what the control does when it reaches t"
---

# ToSpinnerRt.Maximum

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Maximum for SpinBox
...
Specifies the highest value you can set with the SpinBox control in user dialog boxes. The WrapAround property specifies what the control does when it reaches the limit.
...
*Source: `Sudref/properties/SUD_property_Maximum_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
