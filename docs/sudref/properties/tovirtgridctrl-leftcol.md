---
title: "ToVirtGridCtrl.LeftCol"
description: "Specifies in user dialog boxes the index of the column that the extended table displays as first visible column."
---

# ToVirtGridCtrl.LeftCol

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LeftCol for XTable
...
Specifies in user dialog boxes the index of the column that the extended table displays as first visible column.
