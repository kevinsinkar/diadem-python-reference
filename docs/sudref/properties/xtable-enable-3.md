---
title: "XTable.Enable"
description: "Specifies in user dialog boxes whether a control can be enabled in an extended table. Disabled controls are dimmed."
---

# XTable.Enable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for ChnComboBox <XTable>

Specifies in user dialog boxes whether a control can be enabled in an extended table. Disabled controls are dimmed.
...
*Source: `Sudref/properties/SUD_property_Enable_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
