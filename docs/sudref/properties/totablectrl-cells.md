---
title: "ToTableCtrl.Cells"
description: "Specifies the contents of table cells in user dialog boxes. To open the dialog box and enter the table values, click Cells in the Properties tab. You also can d"
---

# ToTableCtrl.Cells

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Cells for Table

Specifies the contents of table cells in user dialog boxes. To open the dialog box and enter the table values, click Cells in the Properties tab. You also can double-click the cell and enter the value in the table.

## Signature

```python
return_value = obj.Cells(Row, Column)
```
...
<td><strong>Note  </strong>The property index refers to the displayed position. For example, if you exchange the first and third rows, <span class="Monospace">Cells(1,2)</span> becomes <span class="Monospace">Cells(3,2)</span>.</td>
</tr>
</table>
</div>
