---
title: "ToVarComboRt.ToolTipText"
...
# ToVarComboRt.ToolTipText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipText for EnumComboBox
...
```python
EnumComboBox1.ToolTipText = "ToolTip"
```
...
*Source: `Sudref/properties/SUD_property_ToolTipText_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
