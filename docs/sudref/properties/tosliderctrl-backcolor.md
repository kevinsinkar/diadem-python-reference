...
# ToSliderCtrl.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for Slider
...
```python
Slider1.BackColor = 16711680
```

```python
Slider1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
