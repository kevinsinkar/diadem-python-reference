---
title: "ToCurvePreviewOb.YAxisScalingType"
description: "Specifies how the y-axis of the curve preview is scaled in user dialog boxes."
---

# ToCurvePreviewOb.YAxisScalingType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: YAxisScalingType for Curve2DPreview

Specifies how the y-axis of the curve preview is scaled in user dialog boxes.

## Signature

```python
obj.YAxisScalingType
```
...
```python
Curve2DPreview1.YAxisScaling = 1  # 0=linear, 1=logarithmic
```
...
*Source: `Sudref/properties/SUD_property_YAxisScalingType_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
