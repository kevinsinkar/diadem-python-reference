...
<td><strong>Note</strong>  If the contents of a control which is connected to a DIAdem variable changes while the user dialog box is active, you must refresh the associated control with the <span class="Monospace">Refresh</span> method.</td>
</tr>
</table>
