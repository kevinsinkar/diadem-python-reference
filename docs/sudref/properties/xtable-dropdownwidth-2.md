...
description: "Specifies in user dialog boxes the minimum width of an expanded selection list of an extended table. If this width is less than the width specified in Width , t"
---
...
*Source: `Sudref/properties/SUD_property_dropdownwidth_ToComboRt_XTable.htm`*
