---
title: "ToCurvePreviewOb.Tag"
description: "Defines a tag for a control in a user dialog box. The tag does not affect the behavior of the control."
---

# ToCurvePreviewOb.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for Curve2DPreview

Defines a tag for a control in a user dialog box. The tag does not affect the behavior of the control.
...
```python
Curve2DPreview1.Tag = "2d axis system"
```
...
*Source: `Sudref/properties/SUD_property_Tag_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
