---
title: "ToTreeNodeInt.Index"
description: "Returns in user dialog boxes the index associated with the selected node in the associated branch."
---
...
def Tree1_EventNodeDblClick(This, Node):
    MsgBoxDisp("Current node = "&  Node.Index)
```
...
*Source: `Sudref/properties/SUD_property_Index_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
