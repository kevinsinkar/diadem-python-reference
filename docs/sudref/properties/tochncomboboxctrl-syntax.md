---
title: "ToChnComboBoxCtrl.Syntax"
description: "Specifies the format in which the channels appear in the channel selection list."
---

# ToChnComboBoxCtrl.Syntax

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Syntax for ChnComboBox

Specifies the format in which the channels appear in the channel selection list.
