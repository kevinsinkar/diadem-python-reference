---
title: "ToSudViewObInt.FilePath"
description: "Returns the path of the current dialog box in a user dialog box."
---

# ToSudViewObInt.FilePath

!!! abstract "Property &middot; `Sudref.chm`"
    Property: FilePath for Dialog <NonModal>
...
Returns the path of the current dialog box in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_FilePath_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
