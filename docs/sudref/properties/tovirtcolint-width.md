---
title: "ToVirtColInt.Width"
description: "Specifies in user dialog boxes the width of an extended table column. Click Columns on the Properties tab to specify the column width."
---

# ToVirtColInt.Width

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Width for XTableColumn

Specifies in user dialog boxes the width of an extended table column. Click Columns on the Properties tab to specify the column width.
...
*Source: `Sudref/properties/SUD_property_Width_ToVirtColInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
