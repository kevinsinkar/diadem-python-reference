---
title: "XTable.Text"
description: "Specifies in a user dialog box the text displayed on a checkbox in an extended table. A user dialog box interprets DIAdem expressions in the text, if you set th"
---

# XTable.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for CheckBox <XTable>
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can use the <a href="../xtable-interpretedtext-2/">InterpretedText</a> property to read the interpreted text.</td>
</tr>
</table>
</div>
...
```python
Cell.Text = "Define text size automatically"
```
...
*Source: `Sudref/properties/SUD_property_Text_ToCheckRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
