---
title: "ToTableCtrl.HeaderColor"
description: "Specifies the background color for table labels in a user dialog box. Click HeaderColor on the Properties tab to open the color selection dialog box. The color "
---

# ToTableCtrl.HeaderColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: HeaderColor for Table
...
Specifies the background color for table labels in a user dialog box. Click HeaderColor on the Properties tab to open the color selection dialog box. The color selection dialog box offers a basic palette of colors and the option to define more colors. Use a RGB value or a VBS color constant to specify the color.
...
```python
Table1.HeaderColor = 16711680
```

```python
Table1.HeaderColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_HeaderColor_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
