---
title: "ToPictureOb.TransparentColor"
description: "Specifies which color is transparent in the displayed picture in a user dialog box. To specify the color, click Picture in the Properties tab. Use a RGB value o"
---

# ToPictureOb.TransparentColor
...
*Source: `Sudref/properties/SUD_property_TransparentColor_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
