---
title: "ToVirtSelectionInt.ColorMode"
description: "Specifies in user dialog boxes how to display the colors of selected entries in an extended table."
---

# ToVirtSelectionInt.ColorMode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ColorMode for Selection

Specifies in user dialog boxes how to display the colors of selected entries in an extended table.
...
*Source: `Sudref/properties/SUD_property_ColorMode_ToVirtSelectionInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
