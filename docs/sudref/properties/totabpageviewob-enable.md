---
title: "ToTabPageViewOb.Enable"
description: "Specifies in user dialog boxes whether a tab of the TabPageCtrl control can be enabled. Disabled tabs are dimmed."
---

# ToTabPageViewOb.Enable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for Page
...
Specifies in user dialog boxes whether a tab of the TabPageCtrl control can be enabled. Disabled tabs are dimmed.
...
```python
Page1.Enable = 0  # 0=no, 1=yes
```

## See also

<div markdown="1">
<div class="SeeAlso"><p class="body">The following example specifies that <span class="Monospace">Page1</span> tab cannot be enabled:</p><div class="copyblue"><p class="body"><a href="#">Copy script</a></p></div><div class="codeblue"><pre><donottranslate>Page1.Enable = <span class="HlNumbers">0</span> <span class="HlComment">'0=no, 1=yes</span></donottranslate></pre></div><h2>Use</h2>
...
*Source: `Sudref/properties/SUD_property_Enable_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
