---
title: "ToTableCtrl.TranspHeaderWidth"
description: "Determines the width of the first column of a table in which columns and rows are transposed in a user dialog box. Assign 0 - No to the VerticalOrientation prop"
---

# ToTableCtrl.TranspHeaderWidth
...
```python
Table1.VerticalOrientation = 0
Table1.AutoHeaderWidth = 0
Table1.TranspHeaderWidth = 20
```
...
*Source: `Sudref/properties/SUD_property_TranspHeaderWidth_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
