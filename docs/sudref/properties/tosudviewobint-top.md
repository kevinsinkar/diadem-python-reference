---
title: "ToSudViewObInt.Top"
description: "Specifies the distance from the top edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen."
---

# ToSudViewObInt.Top

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Top for Dialog <NonModal>

Specifies the distance from the top edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen.
