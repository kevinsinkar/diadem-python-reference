---
title: "ToSudViewObInt.ScrollWidth"
description: "Specifies the width of a user dialog box with scroll bars, in dialog units ."
---

# ToSudViewObInt.ScrollWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollWidth for Dialog <NonModal>

Specifies the width of a user dialog box with scroll bars, in dialog units .
...
*Source: `Sudref/properties/SUD_property_ScrollWidth_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
