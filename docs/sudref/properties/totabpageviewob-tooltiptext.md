---
title: "ToTabPageViewOb.ToolTipText"
description: "Specifies the tooltip for a tab in a user dialog box. If you idle the mouse on a tab, a tooltip appears."
---

# ToTabPageViewOb.ToolTipText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipText for Page
...
Specifies the tooltip for a tab in a user dialog box. If you idle the mouse on a tab, a tooltip appears.
...
```python
Page1.ToolTipText = "Setting Layout Parameters"
```
...
*Source: `Sudref/properties/SUD_property_ToolTipText_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
