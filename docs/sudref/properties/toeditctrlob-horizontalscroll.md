---
title: "ToEditCtrlOb.horizontalscroll"
description: "Specifies in user dialog boxes whether a textbox displays a horizontal scroll bar. The property can have the following settings: 0 - None (WordWrap) Does not di"
---

# ToEditCtrlOb.horizontalscroll
...
<td><strong>Note</strong>  The <span class="Monospace">HorizontalScroll</span> property is only effective if the <a href="../toeditctrlob-alignment/">Alignment</a> property has the value <span class="Monospace">Left</span>.</td>
</tr>
</table>
</div>
