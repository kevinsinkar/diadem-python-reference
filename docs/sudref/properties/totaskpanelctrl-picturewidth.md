---
title: "ToTaskPanelCtrl.picturewidth"
description: "Specifies in user dialog boxes the separation of the graphic file which you specify with the Picture property. The user dialog box then divides the graphic file"
---

# ToTaskPanelCtrl.picturewidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureWidth for TaskPanel
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureWidth</span> property only if you assign a graphic to the <a href="../totaskpanelctrl-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
