---
title: "ToChnComboBoxCtrl.Accelerator"
description: "Specifies in a user dialog box which key you press with <Alt> to select a control."
---

# ToChnComboBoxCtrl.Accelerator

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Accelerator for ChnComboBox
...
Specifies in a user dialog box which key you press with <Alt> to select a control.
...
<td><strong>Note</strong>  Use the VBS function <span class="Monospace">Asc</span> to calculate the ASCII code of a character.</td>
</tr>
</table>
</div>
...
```python
ChnComboBox1.Accelerator = Asc("X")
```
...
*Source: `Sudref/properties/SUD_property_Accelerator_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
