---
title: "ToMulSelListItem.Value"
description: "Specifies the value of a term in a selection list in a user dialog box. Click the Properties tab, then click ListItems , to specify the terms in the selection l"
---

# ToMulSelListItem.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for ListItem
...
Specifies the value of a term in a selection list in a user dialog box. Click the Properties tab, then click ListItems , to specify the terms in the selection list.
...
```python
MsgBoxDisp(ListBox1.MultiSelection(1).Value)
```
...
*Source: `Sudref/properties/SUD_property_Value_ToMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
