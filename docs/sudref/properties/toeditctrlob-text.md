---
title: "ToEditCtrlOb.Text"
description: "Specifies the text displayed in a textbox in a user dialog box."
---

# ToEditCtrlOb.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for EditBox
...
Specifies the text displayed in a textbox in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_Text_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
