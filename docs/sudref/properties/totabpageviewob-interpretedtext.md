---
title: "ToTabPageViewOb.InterpretedText"
...
# ToTabPageViewOb.InterpretedText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for Page
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../totabpageviewob-interpretedtextenabled/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
