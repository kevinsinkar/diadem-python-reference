---
title: "ToGenericOcx.BackColor"
description: "Specifies the background color for an ActiveX control in a user dialog box. Use a RGB value or a VBS color constant to specify the color."
---

# ToGenericOcx.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ActiveX
...
Specifies the background color for an ActiveX control in a user dialog box. Use a RGB value or a VBS color constant to specify the color.
...
```python
ActiveX1.BackColor = 16711680
```

```python
ActiveX1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
