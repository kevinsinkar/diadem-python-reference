...
# ToChnCtrl.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for ChnCtrl
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
