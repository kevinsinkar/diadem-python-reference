---
title: "XTable.Visible"
description: "Specifies in user dialog boxes whether a control is visible in an extended table."
---

# XTable.Visible

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Visible for ChnComboBox <XTable>

Specifies in user dialog boxes whether a control is visible in an extended table.
