---
title: "ToSelectionRangeInt.FirstCol"
description: "Specifies the number of the first selected column in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable m"
---

# ToSelectionRangeInt.FirstCol

!!! abstract "Property &middot; `Sudref.chm`"
    Property: FirstCol for SelectionItem

Specifies the number of the first selected column in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable method returns the value True and the FirstCol property returns the value 0 .
