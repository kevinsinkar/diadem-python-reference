---
title: "CHyperOb.Bottom"
description: "Specifies the distance between the bottom of the control and the user dialog box origin. The dialog box origin is in the upper-left corner of the user dialog bo"
---

# CHyperOb.Bottom

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bottom for Control
...
Specifies the distance between the bottom of the control and the user dialog box origin. The dialog box origin is in the upper-left corner of the user dialog box.
...
<td><strong>Note  </strong>If the control is on a tab, the distance is in relation to the upper left corner of the tab surface of the <span class="Monospace">TabPageCtrl</span> control.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>For the controls <a href="../../objects/tovarcombort/">EnumComboBox</a>, <a href="../../objects/tochncomboboxctrl/">ChnComboBox</a>, and <a href="../../objects/tocombort/">ComboBox</a>, you only can read the value of the property, you cannot modify it.</td>
</tr>
</table>
</div>
...
```python
oMyCtrl = Dialog.GetControl("Input")
oMyCtrl.Bottom = 20
```
