...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ComboBox
...
```python
ComboBox1.BackColor = 16711680
```

```python
ComboBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
