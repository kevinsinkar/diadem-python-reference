---
title: "XTable.ReadOnly"
description: "Specifies in user dialog boxes that the values of controls of an extended table are only displayed. You cannot change the values."
---

# XTable.ReadOnly

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ReadOnly for EditBox <XTable>

Specifies in user dialog boxes that the values of controls of an extended table are only displayed. You cannot change the values.
...
<td><strong>Note</strong>  Set <span class="Monospace">0</span> for the <a href="../xtable-enable-7/">Enable</a> property for the <span class="Monospace">EditBox</span> control, to also prevent text from being copied.</td>
</tr>
</table>
</div>
