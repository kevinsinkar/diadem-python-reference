...
# ToTableCtrl.LockUpdate

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LockUpdate for Table
...
def Button1_EventClick(This):
    ...
    for T in range(1, N-1 + 1):
        Width = Width-Table1.Columns(T).Width
    Table1.Columns(N).Width = Width
    Table1.LockUpdate = FALSE
    XTable1.Refresh()
```
...
*Source: `Sudref/properties/SUD_property_LockUpdate_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
