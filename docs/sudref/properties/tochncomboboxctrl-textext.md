---
title: "ToChnComboBoxCtrl.TextExt"
description: "Specifies in user dialog boxes the term selected in a selection list. The user dialog box does not execute the EventChange method when the value of the control "
---

# ToChnComboBoxCtrl.TextExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TextExt for ChnComboBox

Specifies in user dialog boxes the term selected in a selection list. The user dialog box does not execute the EventChange method when the value of the control changes. The value range is the same as the number of options for the control.
