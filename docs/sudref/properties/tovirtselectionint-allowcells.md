---
title: "ToVirtSelectionInt.AllowCells"
description: "Specifies whether individual cell blocks can be selected in an extended table in user dialog boxes."
---

# ToVirtSelectionInt.AllowCells

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AllowCells for Selection

Specifies whether individual cell blocks can be selected in an extended table in user dialog boxes.
...
```python
XTable1.SelectedElements.AllowCells = TRUE
```
