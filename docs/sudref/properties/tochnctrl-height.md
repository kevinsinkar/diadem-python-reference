---
title: "ToChnCtrl.Height"
description: "Specifies the height of a control in a user dialog box."
---

# ToChnCtrl.Height

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Height for ChnCtrl
...
Specifies the height of a control in a user dialog box.
...
```python
MsgBoxDisp("Height: " + ChnCtrl1.Height)
```
