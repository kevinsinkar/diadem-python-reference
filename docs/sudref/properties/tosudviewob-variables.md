---
title: "ToSudviewob.variables"
description: "Displays information about the registered DIAdem variables in user dialog boxes. You use these variables in the properties of the controls. Controls that are co"
---

# ToSudviewob.variables

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Variables for Dialog
