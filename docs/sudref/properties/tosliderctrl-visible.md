...
```python
Slider1.Visible = 0  # 0=No, 1=Yes
```

## See also

<div markdown="1">
<div class="SeeAlso"><h2>Use</h2>
...
</table><div class="SeeAlso"><h2>See Also</h2>
</div><h2> </h2>
...
*Source: `Sudref/properties/SUD_property_Visible_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
