...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for CheckBox <XTable>
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../xtable-interpretedtextenabled-2/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToCheckRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
