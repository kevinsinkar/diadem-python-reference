...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ReadOnly for ChnCtrl <XTable>
...
<td><strong>Note</strong>  For the <span class="Monospace">ChnCtrl</span> control, also set the <a href="../xtable-enable-4/">Enable</a> property to <span class="Monospace">0</span> to prevent text from being copied.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_ReadOnly_ToChnCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
