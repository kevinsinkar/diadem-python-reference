---
title: "ToCurvePreviewOb.LabelVisible"
description: "Specifies whether the curve preview displays axis labels in user dialog boxes."
---

# ToCurvePreviewOb.LabelVisible

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LabelVisible for Curve2DPreview

Specifies whether the curve preview displays axis labels in user dialog boxes.
...
Curve2DPreview1.Curves.Add("[1]/[1]","[1]/[3]")
Curve2DPreview1.LabelVisible = FALSE
```
...
*Source: `Sudref/properties/SUD_property_LabelVisible_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
