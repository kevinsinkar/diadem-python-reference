...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: UseColors for ComboBox
...
```python
ComboBox1.UseColors = 0 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_UseColors_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
