---
title: "ToChnMulSelListItems.ChannelStringExt"
description: "Specifies in user dialog boxes the names of the selected channels of a channel selection list. The Syntax property specifies the format used for ChannelStringEx"
---

# ToChnMulSelListItems.ChannelStringExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ChannelStringExt for ChnMultiSelection
...
Specifies in user dialog boxes the names of the selected channels of a channel selection list. The Syntax property specifies the format used for ChannelStringExt .

## Signature

```python
obj.ChannelStringExt
```
...
```python
ChnListBox1.MultiSelection.ChannelStringExt = "Time,Speed"
```
...
*Source: `Sudref/properties/SUD_property_ChannelStringExt_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
