---
title: "ToSpinnerRt.Increment"
description: "Specifies the step width for the Spin Box control in user dialog boxes when you use the arrow keys."
---

# ToSpinnerRt.Increment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Increment for SpinBox
...
Specifies the step width for the Spin Box control in user dialog boxes when you use the arrow keys.
...
*Source: `Sudref/properties/SUD_property_Increment_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
