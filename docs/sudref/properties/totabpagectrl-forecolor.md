...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for TabPageCtrl
...
```python
TabPageCtrl1.ForeColor = 16711680
```

```python
TabPageCtrl1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
