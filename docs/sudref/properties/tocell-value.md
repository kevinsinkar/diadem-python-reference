---
title: "ToCell.Value"
description: "Specifies the value of a table cell in a user dialog box. Click the Properties tab, then click Cells , to specify the value of a table cell."
---

# ToCell.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for Cell
...
Specifies the value of a table cell in a user dialog box. Click the Properties tab, then click Cells , to specify the value of a table cell.
...
```python
MsgBoxDisp("Value: " + Table1.SelectedCells(1).Value)
```
...
*Source: `Sudref/properties/SUD_property_Value_ToCell.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
