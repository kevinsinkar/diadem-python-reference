---
title: "ToVirtGridCtrl.GridLinesVert"
description: "Specifies in a user dialog box whether an extended table displays vertical grid lines between the individual cells. The extended table always displays vertical "
---

# ToVirtGridCtrl.GridLinesVert

!!! abstract "Property &middot; `Sudref.chm`"
    Property: GridLinesVert for XTable

Specifies in a user dialog box whether an extended table displays vertical grid lines between the individual cells. The extended table always displays vertical separating lines in the table headings.
...
*Source: `Sudref/properties/SUD_property_GridLinesVert_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
