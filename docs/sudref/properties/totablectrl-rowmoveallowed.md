---
title: "ToTableCtrl.RowMoveAllowed"
description: "Enables you to move table rows with the mouse in user dialog boxes."
---

# ToTableCtrl.RowMoveAllowed

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RowMoveAllowed for Table

Enables you to move table rows with the mouse in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_RowMoveAllowed_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
