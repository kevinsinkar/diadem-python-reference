...
description: "Specifies in a user dialog box the index of the term selected in a selection list of the extended table."
---

# XTable.Selection

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for ComboBox <XTable>
...
Specifies in a user dialog box the index of the term selected in a selection list of the extended table.
...
*Source: `Sudref/properties/SUD_property_Selection_ToComboRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
