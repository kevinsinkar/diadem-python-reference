---
title: "ToTableCtrl.TitleFont"
description: "Specifies in user dialog boxes the font, the font type, and the font size for the column and row labels in tables. To restore the default settings, select Font "
---

# ToTableCtrl.TitleFont

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TitleFont for Table
...
*Source: `Sudref/properties/SUD_property_TitleFont_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
