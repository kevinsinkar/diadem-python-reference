---
title: "ToChnComboBoxCtrl.variableColIndex"
description: "Specifies which column in the DIAdem vector variable or the DIAdem matrix variable is linked to the control value in user dialog boxes. Use the Variable propert"
---

# ToChnComboBoxCtrl.variableColIndex

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VariableColIndex for ChnListBox
...
*Source: `Sudref/properties/SUD_property_variableColIndex_ToChnComboBoxCtrl.htm`*
