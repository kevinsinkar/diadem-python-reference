---
title: "ToEditCtrlOb.CurrentColumn"
description: "Specifies in user dialog boxes the index of the column where the cursor is located inside the textbox. If you set a column index, the cursor appears in the spec"
---

# ToEditCtrlOb.CurrentColumn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CurrentColumn for EditBox
...
*Source: `Sudref/properties/SUD_property_CurrentColumn_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
