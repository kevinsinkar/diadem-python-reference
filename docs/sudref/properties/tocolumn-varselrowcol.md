---
title: "ToColumn.VarSelRowCol"
description: "Specifies whether a user dialog box links a table column to a row or a column of a DIAdem matrix variable. To specify the property value, click Columns in the P"
---

# ToColumn.VarSelRowCol

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VarSelRowCol for Column

Specifies whether a user dialog box links a table column to a row or a column of a DIAdem matrix variable. To specify the property value, click Columns in the Properties tab, and select the value for Row/column in the dialog box that appears.
...
*Source: `Sudref/properties/SUD_property_VarSelRowCol_ToColumn.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
