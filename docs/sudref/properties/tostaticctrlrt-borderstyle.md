---
title: "ToStaticCtrlRt.BorderStyle"
description: "Specifies the frame style for a control in a user dialog box."
---

# ToStaticCtrlRt.BorderStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderStyle for Text

Specifies the frame style for a control in a user dialog box.
...
<td><strong>Note  </strong>If you assign the value <span class="Monospace">1 - 3D</span> to the property, the property <a href="../tostaticctrlrt-borderwidth/">BorderWidth</a> is ineffective.</td>
</tr>
</table>
</div>
...
```python
Text1.BorderStyle = 1 '0=Line, 1=3D, 2=Sunken, 3=Raised, 4=None
```
...
*Source: `Sudref/properties/SUD_property_BorderStyle_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
