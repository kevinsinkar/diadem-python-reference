---
title: "ToCurvePreviewOb.Curves"
description: "Returns a collection of all curves in a curve preview of a user dialog box."
---

# ToCurvePreviewOb.Curves

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Curves for Curve2DPreview
...
Returns a collection of all curves in a curve preview of a user dialog box.

## Signature

```python
return_value = obj.Curves
```
...
oMyCurve = Curve2DPreview1.Curves.Add("[1]/[1]","[1]/[3]")
oMyCurve.Color = dd.RGB(0, 255, 0)
...
*Source: `Sudref/properties/SUD_property_Curves_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
