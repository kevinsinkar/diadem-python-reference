---
title: "ToSudViewOb.Controls"
description: "Returns a collection of all the controls of a user dialog box. To access single controls in scripts, either use the Item property or enter the index in parenthe"
---

# ToSudViewOb.Controls

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Controls for Dialog
...
*Source: `Sudref/properties/SUD_property_Controls_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
