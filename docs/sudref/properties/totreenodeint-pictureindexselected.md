---
title: "ToTreeNodeInt.PictureIndexSelected"
description: "Specifies in user dialog boxes the sub-graphic index, which DIAdem displays in the tree when the node is selected. The user dialog box divides the graphic you s"
---

# ToTreeNodeInt.PictureIndexSelected

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureIndexSelected for TreeNode
...
*Source: `Sudref/properties/SUD_property_PictureIndexSelected_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
