---
title: "ToChnListBoxCtrl.TopIndex"
description: "Returns the index of the element that first appears in a ChnListBox selection list. This index is independent of the selection made in the channel selection lis"
---

# ToChnListBoxCtrl.TopIndex

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TopIndex for ChnListBox

Returns the index of the element that first appears in a ChnListBox selection list. This index is independent of the selection made in the channel selection list. If you assign the value 1 to the ShowBlankEntry property, the channel selection list shows a blank entry as the first entry. The returned index is then 0 . If the channel selection list does not show a blank entry, the index is 1 .
...
```python
MsgBoxDisp(ChnListBox1.TopIndex)
```
...
*Source: `Sudref/properties/SUD_property_TopIndex_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
