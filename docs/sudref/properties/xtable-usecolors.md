---
title: "XTable.UseColors"
description: "Specifies in user dialog boxes whether a control in an extended table uses the system color."
---

# XTable.UseColors

!!! abstract "Property &middot; `Sudref.chm`"
    Property: UseColors for ChnComboBox <XTable>
...
Specifies in user dialog boxes whether a control in an extended table uses the system color.
...
*Source: `Sudref/properties/SUD_property_UseColors_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
