...
# ToEditCtrlOb.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for EditBox
...
```python
EditBox1.BackColor = 16711680
```

```python
EditBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
