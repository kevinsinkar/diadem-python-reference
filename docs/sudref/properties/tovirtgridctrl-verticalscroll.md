---
title: "ToVirtGridCtrl.VerticalScroll"
description: "Specifies in user dialog boxes whether an extended table displays a vertical scroll bar."
---

# ToVirtGridCtrl.VerticalScroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VerticalScroll for XTable
...
Specifies in user dialog boxes whether an extended table displays a vertical scroll bar.
...
*Source: `Sudref/properties/SUD_property_VerticalScroll_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
