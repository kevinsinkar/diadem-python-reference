---
title: "ToSudviewob.showtitlemenu"
description: "Specifies whether the user dialog box has the Close symbol in the title. The property can have the following settings: 0 - No Does not display the Close symbol "
---

# ToSudviewob.showtitlemenu

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ShowTitleMenu for Dialog

Specifies whether the user dialog box has the Close symbol in the title. The property can have the following settings: 0 - No Does not display the Close symbol in the title bar of the dialog box. 1 - Yes Displays the Close symbol in the title bar of the dialog box.
...
*Source: `Sudref/properties/SUD_property_showtitlemenu_ToSudviewob.htm`*
