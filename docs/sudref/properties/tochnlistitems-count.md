---
title: "ToChnListItems.Count"
description: "Returns the number of selection terms in a channel selection list in user dialog boxes."
---

# ToChnListItems.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for ChnListItems

Returns the number of selection terms in a channel selection list in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToChnListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
