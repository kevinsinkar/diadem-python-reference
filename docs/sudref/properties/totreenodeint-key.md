---
title: "ToTreeNodeInt.Key"
description: "Specifies in user dialog boxes the unique key of a node in the tree. If you assign a key to a node, you can retain the object of this node with the GetNode meth"
---

# ToTreeNodeInt.Key

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Key for TreeNode

Specifies in user dialog boxes the unique key of a node in the tree. If you assign a key to a node, you can retain the object of this node with the GetNode method without knowing the hierarchy of the tree.
...
*Source: `Sudref/properties/SUD_property_Key_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
