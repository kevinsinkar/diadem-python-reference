---
title: "ToVarListBoxRt.ToolTipText"
...
# ToVarListBoxRt.ToolTipText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ToolTipText for EnumListBox
...
```python
EnumListBox1.ToolTipText = "ToolTip"
```
...
*Source: `Sudref/properties/SUD_property_ToolTipText_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
