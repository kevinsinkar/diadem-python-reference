---
title: "ToVarListBoxRt.picturealign"
description: "Specifies picture alignment in a selection list in a user dialog box. The property can have the following settings: 0 - Left Positions the graphic on the left a"
---

# ToVarListBoxRt.picturealign

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureAlign for EnumListBox
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureAlign</span> property only if you assign a graphic to the <a href="../tovarlistboxrt-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_picturealign_ToVarListBoxRt.htm`*
