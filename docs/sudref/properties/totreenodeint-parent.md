---
title: "ToTreeNodeInt.Parent"
description: "Specifies in user dialog boxes the parent node of a tree node."
---

# ToTreeNodeInt.Parent

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Parent for TreeNode

Specifies in user dialog boxes the parent node of a tree node.
...
*Source: `Sudref/properties/SUD_property_Parent_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
