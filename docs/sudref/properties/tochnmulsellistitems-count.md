---
title: "ToChnMulSelListItems.Count"
description: "Returns the number of the selected selection terms in a channel selection list in user dialog boxes."
---

# ToChnMulSelListItems.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for ChnMultiSelection
...
Returns the number of the selected selection terms in a channel selection list in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
