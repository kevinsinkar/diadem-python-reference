---
title: "ToSliderCtrl.ToolTipText"
description: "Specifies the tooltip for a control in a user dialog box. The tooltip appears when the mouse hovers over the control and the ToolTipMode property does not have "
---

# ToSliderCtrl.ToolTipText
...
```python
Slider1.ToolTipText = "Value " + Slider1.Value
```
