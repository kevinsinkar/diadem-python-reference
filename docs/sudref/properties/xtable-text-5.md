---
title: "XTable.Text"
description: "Specifies in user dialog boxes the selected term of a selection list in the extended table. The value range corresponds to the channel list in the Data Portal."
---

# XTable.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for ChnListBox <XTable>
...
Specifies in user dialog boxes the selected term of a selection list in the extended table. The value range corresponds to the channel list in the Data Portal.
...
<td><strong>Note  </strong>In the editable selection list you also can enter a term that the selection list does not contain. In this case, the properties <a href="../xtable-value-3/">Value</a> and <a href="../xtable-selection-2/">Selection</a> receive the value <span class="Monospace">-1</span>.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Text_ToChnListBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
