...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for Text <XTable>
...
*Source: `Sudref/properties/SUD_property_Enable_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
