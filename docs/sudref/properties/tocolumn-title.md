---
title: "ToColumn.Title"
description: "Specifies the label for a column or a row in a table in user dialog boxes. Click the Properties tab and then click Columns to specify the column labels, and cli"
---
...
Specifies the label for a column or a row in a table in user dialog boxes. Click the Properties tab and then click Columns to specify the column labels, and click Rows to specify the row labels.
...
```python
Table1.Columns(1).Title = "First Column"
```
...
*Source: `Sudref/properties/SUD_property_Title_ToColumn.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
