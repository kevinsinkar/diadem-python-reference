---
title: "ToChnListBoxCtrl.verticalscroll"
description: "Specifies in user dialog boxes whether a selection list displays a vertical scroll bar. The property can have the following settings: 0 - None Does not display "
---

# ToChnListBoxCtrl.verticalscroll

!!! abstract "Property &middot; `Sudref.chm`"
    Property: VerticalScroll for ChnListBox
