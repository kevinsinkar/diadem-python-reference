...
# ToTreeCtrl.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for Tree
...
```python
Tree1.ForeColor = 16711680
```

```python
Tree1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
