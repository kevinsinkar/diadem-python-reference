---
title: "ToViewConnectorOb.Height"
description: "Displays the height of the control in the user dialog box. You cannot change this property albeit if you create a user dialog box on the Properties tab or if yo"
---

# ToViewConnectorOb.Height

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Height for ViewConnector

Displays the height of the control in the user dialog box. You cannot change this property albeit if you create a user dialog box on the Properties tab or if you use in scripts during runtime of the user dialog box.
...
*Source: `Sudref/properties/SUD_property_Height_ToViewConnectorOb.HTM`*
