...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ChnCtrl
...
```python
ChnCtrl1.ForeColor = 16711680
```

```python
ChnCtrl1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
