---
title: "ToFrameRt.Text"
description: "Specifies the text displayed for a frame in a user dialog box. A user dialog box interprets DIAdem expressions in the text, if you set the value 1 for the Inter"
---

# ToFrameRt.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for Frame
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can use the <a href="../toframert-interpretedtext/">InterpretedText</a> property to read the interpreted text.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Text_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
