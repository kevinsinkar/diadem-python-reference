---
title: "ToBtnRteOb.Alignment"
description: "Specifies text alignment on a button in a user dialog box."
---

# ToBtnRteOb.Alignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Alignment for Button

Specifies text alignment on a button in a user dialog box.
...
```python
Button1.Alignment = 1  # 0=Left, 1=Center, 2=Right
```
...
*Source: `Sudref/properties/SUD_property_Alignment_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
