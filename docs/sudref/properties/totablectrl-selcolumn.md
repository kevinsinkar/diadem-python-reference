---
title: "ToTableCtrl.SelColumn"
description: "Returns the selected column of a table in a user dialog box. If you do not select a column, or if you select more than one column, the property has the value 0."
---

# ToTableCtrl.SelColumn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelColumn for Table
...
Returns the selected column of a table in a user dialog box. If you do not select a column, or if you select more than one column, the property has the value 0.
...
*Source: `Sudref/properties/SUD_property_SelColumn_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
