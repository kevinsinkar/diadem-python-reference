...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for Control
...
*Source: `Sudref/properties/SUD_property_ObjectType_CHyperOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
