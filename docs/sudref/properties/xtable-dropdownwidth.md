---
title: "XTable.DropDownWidth"
description: "Specifies in user dialog boxes the minimum width of an expanded selection list of an extended table. If this width is smaller than the specified width of the ta"
---

# XTable.DropDownWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: DropDownWidth for ChnComboBox <XTable>
...
*Source: `Sudref/properties/SUD_property_dropdownwidth_ToChnComboBoxCtrl_XTable.htm`*
