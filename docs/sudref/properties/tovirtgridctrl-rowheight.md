---
title: "ToVirtGridCtrl.RowHeight"
description: "Specifies in user dialog boxes the height of the rows in an extended table."
---

# ToVirtGridCtrl.RowHeight

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RowHeight for XTable
...
Specifies in user dialog boxes the height of the rows in an extended table.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If the specified row height is not sufficient to display a control, the extended table automatically extends this value.</td></tr></table>
</div>
