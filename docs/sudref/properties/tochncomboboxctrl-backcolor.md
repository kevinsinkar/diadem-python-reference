---
title: "ToChnComboBoxCtrl.BackColor"
...
# ToChnComboBoxCtrl.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ChnComboBox
...
```python
ChnComboBox1.BackColor = 16711680
```

```python
ChnComboBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
