---
title: "ToRadioRt.InterpretedText"
...
# ToRadioRt.InterpretedText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for RadioButton
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../toradiort-interpretedtextenabled/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
