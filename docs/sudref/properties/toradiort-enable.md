...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for RadioButton
...
```python
RadioButton1.Enable = 0  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_Enable_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
