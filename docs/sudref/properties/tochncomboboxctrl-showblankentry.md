---
title: "ToChnComboBoxCtrl.ShowBlankEntry"
description: "Specifies whether the channel selection list displays a blank entry as the first entry. The property can have the following settings: 0 - No Does not display th"
---

# ToChnComboBoxCtrl.ShowBlankEntry

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ShowBlankEntry for ChnComboBox

Specifies whether the channel selection list displays a blank entry as the first entry. The property can have the following settings: 0 - No Does not display the blank entry. 1 - Yes Displays the blank entry.
...
<td><strong>Note  </strong>If the channel selection list contains a blank entry, the indexing for <a href="../../methods/tochnmulsellistitems-item/">Item</a>, <a href="../tochncomboboxctrl-selection/">Selection</a>, and <a href="../tochnlistboxctrl-topindex/">TopIndex</a> starts at <span class="Monospace">0</span> instead of <span class="Monospace">1</span>. If you select the blank entry, <a href="../tochncomboboxctrl-value/">Value</a> receives the value <span class="Monospace">0</span> instead of the channel number.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_ShowBlankEntry_ToChnComboBoxCtrl.htm`*
