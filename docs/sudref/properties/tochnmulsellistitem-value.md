---
title: "ToChnMulSelListItem.Value"
description: "Specifies the value of a term in a channel selection list in a user dialog box."
---

# ToChnMulSelListItem.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for ChnListItem
...
Specifies the value of a term in a channel selection list in a user dialog box.
...
```python
MsgBoxDisp(ChnListBox1.MultiSelection(1).Value)
```
...
*Source: `Sudref/properties/SUD_property_Value_ToChnMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
