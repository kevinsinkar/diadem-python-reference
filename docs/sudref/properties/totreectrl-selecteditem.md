---
title: "ToTreeCtrl.SelectedItem"
description: "Returns in user dialog boxes the selected node in a tree. Use the SelectedItem property to request the currently selected node and select a node by assigning it"
---

# ToTreeCtrl.SelectedItem
...
*Source: `Sudref/properties/SUD_property_SelectedItem_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
