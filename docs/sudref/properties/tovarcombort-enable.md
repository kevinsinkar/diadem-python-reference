...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for EnumComboBox
...
```python
EnumComboBox1.Enable = 0  # 0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_Enable_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
