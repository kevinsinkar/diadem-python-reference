---
title: "ToSliderCtrl.TickDistance"
description: "Determines the tick distance on the Slider control in user dialog boxes. If the value range of the control is not a multiple of TickDistance , the last tick dis"
---

# ToSliderCtrl.TickDistance
...
```python
dd.MsgBox(Slider1.TickDistance)
```
