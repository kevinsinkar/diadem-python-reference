---
title: "XTable.Value"
description: "Specifies in a user dialog box the value of the term selected in a selection list of an extended table. The range of values corresponds to the number of options"
---

# XTable.Value

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for ListBox <XTable>

Specifies in a user dialog box the value of the term selected in a selection list of an extended table. The range of values corresponds to the number of options in the control. If no element is selected, the property has the value -1 .
...
*Source: `Sudref/properties/SUD_property_Value_ToListBoxRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
