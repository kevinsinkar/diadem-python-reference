---
title: "ToVirtGridCtrl.Width"
description: "Specifies in user dialog boxes the width of a column in the extended table."
---

# ToVirtGridCtrl.Width

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Width for XTable

Specifies in user dialog boxes the width of a column in the extended table.
