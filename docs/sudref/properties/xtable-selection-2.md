---
title: "XTable.Selection"
description: "Specifies in a user dialog box the index of the term selected in a selection list of the extended table. The index of the selection term corresponds to the chan"
---

# XTable.Selection

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for ChnListBox <XTable>

Specifies in a user dialog box the index of the term selected in a selection list of the extended table. The index of the selection term corresponds to the channel number in the Data Portal.
...
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>If you assign the value <span class="Monospace">1</span> to the <a href="../xtable-showblankentry-2/">ShowBlankEntry</a> property of a channel selection list, the list shows a blank entry as the first entry. The index of this blank entry is <span class="Monospace">0</span>.</td></tr>
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If you can make a multiple selection in a channel selection list, you use the <a href="../../methods/xtable-multiselection/">MultiSelection</a> method to list all the selected channels.</td></tr></table>
</div>
