---
title: "ToBtnRteOb.Text"
description: "Specifies the text displayed on a control in a user dialog box. A user dialog box interprets DIAdem expressions in the text, if you set the value 1 for the Inte"
---

# ToBtnRteOb.Text

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Text for Button
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You can use the <a href="../tobtnrteob-interpretedtext/">InterpretedText</a> property to read the interpreted text.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
...
*Source: `Sudref/properties/SUD_property_Text_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
