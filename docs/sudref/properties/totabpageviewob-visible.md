---
title: "ToTabPageViewOb.Visible"
description: "Specifies whether a tab of the TabPageCtrl control is visible in a user dialog box."
---

# ToTabPageViewOb.Visible

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Visible for Page

Specifies whether a tab of the TabPageCtrl control is visible in a user dialog box.
