---
title: "ToTreeNodeInt.Tag"
description: "Specifies in user dialog boxes a tag for a node in the tree. The tag does not affect the behavior of the node."
---

# ToTreeNodeInt.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for TreeNode
...
Specifies in user dialog boxes a tag for a node in the tree. The tag does not affect the behavior of the node.
...
```python
Tree1.GetNode("MyNode").Tag = "NodeTag"
```
...
*Source: `Sudref/properties/SUD_property_Tag_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
