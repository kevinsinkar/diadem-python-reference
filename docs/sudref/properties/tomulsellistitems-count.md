---
title: "ToMulSelListItems.Count"
description: "Returns the number of selected selection terms in a selection list in user dialog boxes."
---

# ToMulSelListItems.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for MultiSelection
...
Returns the number of selected selection terms in a selection list in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
