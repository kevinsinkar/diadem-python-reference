...
# ToComboRt.picturealign

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureAlign for ComboBox
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureAlign</span> property only if you assign a graphic to the <a href="../tocombort-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_picturealign_ToComboRt.htm`*
