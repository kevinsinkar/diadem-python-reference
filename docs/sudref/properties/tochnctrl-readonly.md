...
<td><strong>Note</strong>  For the <span class="Monospace">ChnCtrl</span> control, also set the <a href="../tochnctrl-enable/">Enable</a> property to <span class="Monospace">0</span> to prevent text from being copied.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_ReadOnly_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
