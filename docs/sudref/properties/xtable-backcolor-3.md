...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ChnComboBox <XTable>
...
*Source: `Sudref/properties/SUD_property_BackColor_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
