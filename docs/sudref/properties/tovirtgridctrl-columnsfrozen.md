---
title: "ToVirtGridCtrl.columnsfrozen"
description: "Specifies in user dialog boxes the number of columns to freeze in an extended table. These columns cannot be scrolled in an extended table. Freeze columns to sp"
---

# ToVirtGridCtrl.columnsfrozen

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ColumnsFrozen for XTable
