...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureAlign for ComboBox <XTable>
...
Specifies in a user dialog box the alignment of graphics in a selection list in the extended table. The property can have the following settings: 0 - Left Positions the graphic to the left. 1 - Right Positions the graphic to the right. 2 - Center Centers the graphic.
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureAlign</span> property only if you assign a graphic to the <a href="../xtable-picture-3/">Picture</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_picturealign_ToComboRt_XTable.htm`*
