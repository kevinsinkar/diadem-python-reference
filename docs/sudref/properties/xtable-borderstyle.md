---
title: "XTable.BorderStyle"
description: "Specifies the frame style for a control of an extended table in a user dialog box."
---

# XTable.BorderStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderStyle for Text <XTable>

Specifies the frame style for a control of an extended table in a user dialog box.
...
<td><strong>Note  </strong>If you assign the value <span class="Monospace">1 - 3D</span> to the property, the property <a href="../xtable-borderwidth/">BorderWidth</a> is ineffective.</td>
</tr>
</table>
</div>
...
```python
Cell.BorderStyle = 1 '0=Line, 1=3D, 2=Sunken, 3=Raised, 4=None
```
...
*Source: `Sudref/properties/SUD_property_BorderStyle_ToStaticCtrlRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
