---
title: "ToTreeNodeInt.PictureIndex"
description: "Specifies in user dialog boxes the index of the sub-graphic that DIAdem displays on a tree node. The user dialog box divides the graphic you specify with the Pi"
---

# ToTreeNodeInt.PictureIndex

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureIndex for TreeNode
...
def SetNodesPictureLevel(oNode):
    for oMyNode in oNode.Nodes:
        oMyNode.PictureIndex = oMyNode.Level
