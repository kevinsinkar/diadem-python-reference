---
title: "ToVarListBoxRt.picturewidth"
description: "Specifies in a user dialog box how the graphic file that you specify in Picture is divided up. The user dialog box divides the graphics file into several small "
---

# ToVarListBoxRt.picturewidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: PictureWidth for EnumListBox

Specifies in a user dialog box how the graphic file that you specify in Picture is divided up. The user dialog box divides the graphics file into several small graphics with the width specified as PictureWidth , and assigns the graphics to the individual entries in the selection list.
...
<td><strong>Note</strong>  You can specify the <span class="Monospace">PictureWidth</span> property only if you assign a graphic to the <a href="../tovarlistboxrt-picture/">Picture</a> property.</td>
</tr>
</table>
</div>
