---
title: "ToChnListBoxCtrl.selectionmode"
description: "Specifies whether the channel selection list allows multiple selection. The property can have the following settings: 0 - Single selection Multiple selection is"
---

# ToChnListBoxCtrl.selectionmode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectionMode for ChnListBox

Specifies whether the channel selection list allows multiple selection. The property can have the following settings: 0 - Single selection Multiple selection is not possible. 1 - Multiselection You can make a multiple selection in any order. 2 - Multiselection with order You can make a multiple selection in a specific order.
...
*Source: `Sudref/properties/SUD_property_selectionmode_ToChnListBoxCtrl.htm`*
