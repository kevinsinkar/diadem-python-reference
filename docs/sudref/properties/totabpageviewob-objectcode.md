---
title: "ToTabPageViewOb.ObjectCode"
description: "Specifies the unique name of a tab in the TabPageCtrl control in a user dialog box. Use this name to select a tab in the dialog editor, and to edit its properti"
---

# ToTabPageViewOb.ObjectCode
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
