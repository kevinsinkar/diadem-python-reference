---
title: "ToSelectedCells.Count"
description: "Returns the number of selected cells in a table in user dialog boxes."
---

# ToSelectedCells.Count

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Count for SelectedCells

Returns the number of selected cells in a table in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_Count_ToSelectedCells.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
