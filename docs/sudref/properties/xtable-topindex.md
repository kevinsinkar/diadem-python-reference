---
title: "XTable.TopIndex"
description: "Returns the index of the element that first appears in a channel selection list of the extended table. This index is independent of the selection made in the ch"
---
...
*Source: `Sudref/properties/SUD_property_TopIndex_ToChnListBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
