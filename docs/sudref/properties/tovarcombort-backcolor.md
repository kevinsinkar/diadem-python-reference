...
# ToVarComboRt.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for EnumComboBox
...
```python
EnumComboBox1.BackColor = 16711680
```

```python
EnumComboBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
