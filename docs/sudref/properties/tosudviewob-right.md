---
title: "ToSudViewOb.Right"
description: "Specifies the distance from the right edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen. The left edge of t"
---

# ToSudViewOb.Right

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Right for Dialog

Specifies the distance from the right edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen. The left edge of the user dialog box remains unchanged. To move a dialog box, use the Move method.
