---
title: "ToSudViewObInt.Right"
description: "Specifies the distance from the right edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen."
---

# ToSudViewObInt.Right

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Right for Dialog <NonModal>
...
Specifies the distance from the right edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  The value of the <span class="Monospace">Right</span> property must be greater than or equal to the sum of the properties <a href="../tosudviewobint-left/">Left</a> and <a href="../tosudviewobint-minwidth/">MinWidth</a>.</td></tr>
