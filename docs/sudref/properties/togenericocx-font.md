---
title: "ToGenericOcx.Font"
description: "Specifies the font, font style, and font size for ActiveX controls in user dialog boxes. You can use all the installed fonts."
---
...
<td><strong>Note  </strong>Not all ActiveX controls support this property.</td>
</tr>
</table>
</div>
...
```python
ActiveX1.Font = -FontPointsToPixels(10) + ",,0,0,0,400,0,0,0,0,3,2,1,34,Arial"
```
...
*Source: `Sudref/properties/SUD_property_Font_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
