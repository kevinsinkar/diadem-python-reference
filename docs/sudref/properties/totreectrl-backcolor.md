---
title: "ToTreeCtrl.BackColor"
description: "Specifies in user dialog boxes the background color of the area which displays the tree. Use the automatic setting if you want the background color to correspon"
---

# ToTreeCtrl.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for Tree
...
```python
Tree1.BackColor = 16711680
```

```python
Tree1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
