---
title: "ToChnListBoxCtrl.BackColor"
...
# ToChnListBoxCtrl.BackColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BackColor for ChnListBox
...
```python
ChnListBox1.BackColor = 16711680
```

```python
ChnListBox1.BackColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BackColor_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
