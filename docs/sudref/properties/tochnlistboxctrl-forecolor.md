---
title: "ToChnListBoxCtrl.ForeColor"
...
# ToChnListBoxCtrl.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ChnListBox
...
```python
ChnListBox1.ForeColor = 16711680
```

```python
ChnListBox1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
