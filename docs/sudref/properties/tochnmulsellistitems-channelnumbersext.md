---
title: "ToChnMulSelListItems.ChannelNumbersExt"
description: "Specifies in user dialog boxes the numbers of the selected channels of a channel selection list. This property contains the channel numbers in the order of sele"
---

# ToChnMulSelListItems.ChannelNumbersExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ChannelNumbersExt for ChnMultiSelection
...
```python
ChnListBox1.MultiSelection.ChannelNumbersExt = "1,4-7"
```
...
*Source: `Sudref/properties/SUD_property_ChannelNumbersExt_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
