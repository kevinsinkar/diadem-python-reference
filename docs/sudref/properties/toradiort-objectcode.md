...
# ToRadioRt.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for RadioButton
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
