---
title: "ToViewConnectorOb.ObjectType"
description: "Specifies the type of a control in user dialog boxes."
---

# ToViewConnectorOb.ObjectType

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectType for ViewConnector
...
Specifies the type of a control in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_ObjectType_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
