...
description: "Specifies the text alignment on a button of the extended table in a user dialog box."
---

# XTable.Alignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Alignment for Button <XTable>

Specifies the text alignment on a button of the extended table in a user dialog box.
...
```python
Cell.Alignment = 1  # 0=Left, 1=Center, 2=Right
```
...
*Source: `Sudref/properties/SUD_property_Alignment_ToBtnRteOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
