...
# ToVarListBoxRt.picture

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Picture for EnumListBox
...
<td><strong>Note  </strong>Use the <a href="../tovarlistboxrt-picturealign/">PictureAlign</a> property to specify the alignment of the graphics in the selection list.</td>
</tr>
</table>
</div>
