---
title: "ToSudViewObInt.ReducedToTitle"
description: "Specifies in user dialog boxes whether the dialog box display is reduced to the title bar."
---

# ToSudViewObInt.ReducedToTitle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ReducedToTitle for Dialog <NonModal>

Specifies in user dialog boxes whether the dialog box display is reduced to the title bar.
...
<td><strong>Note</strong>  You only can specify the  <span class="Monospace">ReducedToTitle</span> property if you assign the value <span class="Monospace"> 1 - Yes</span> to the <a href="../tosudviewob-showdlgreducer/">ShowDlgReducer</a> property.</td>
</tr>
</table>
</div>
