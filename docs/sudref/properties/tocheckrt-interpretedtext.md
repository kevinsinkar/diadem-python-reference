---
title: "ToCheckRt.InterpretedText"
...
# ToCheckRt.InterpretedText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for CheckBox
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../tocheckrt-interpretedtextenabled/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
