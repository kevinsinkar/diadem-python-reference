...
# ToViewConnectorOb.Right

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Right for ViewConnector
...
*Source: `Sudref/properties/SUD_property_Right_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
