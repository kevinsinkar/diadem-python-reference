...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: Value for EnumListBox
...
*Source: `Sudref/properties/SUD_property_Value_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
