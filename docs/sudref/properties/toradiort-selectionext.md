...
# ToRadioRt.SelectionExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectionExt for RadioButton
...
*Source: `Sudref/properties/SUD_property_SelectionExt_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
