...
```python
oMyCtrl = Dialog.GetControl("Header")
oMyCtrl.Tag = "Headline"
```
...
*Source: `Sudref/properties/SUD_property_Tag_CHyperOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
