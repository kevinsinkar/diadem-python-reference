---
title: "ToStaticCtrlRt.ForeColor"
...
# ToStaticCtrlRt.ForeColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for Text
...
```python
Text1.ForeColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
