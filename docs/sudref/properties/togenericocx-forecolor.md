---
title: "ToGenericOcx.ForeColor"
description: "Specifies the text color for an ActiveX control in a user dialog box. Use a RGB value or a VBS color constant to specify the color."
---

# ToGenericOcx.ForeColor
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
