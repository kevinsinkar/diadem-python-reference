---
title: "ToSudviewob.ShowDlgReducer"
description: "Specifies whether the user dialog box contains a symbol in the title bar which reduces the dialog box to the title bar. Use the ShowDlgReducer property mainly i"
---

# ToSudviewob.ShowDlgReducer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ShowDlgReducer for Dialog
