---
title: "ToComboRt.InterpretedText"
...
# ToComboRt.InterpretedText

!!! abstract "Property &middot; `Sudref.chm`"
    Property: InterpretedText for ComboBox
...
<td><strong>Note</strong>  The property returns an interpreted text only if you assign the value  <span class="Monospace">1–Yes</span> to the <a href="../tocombort-interpretedtextenabled/">InterpretedTextEnabled</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_InterpretedText_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
