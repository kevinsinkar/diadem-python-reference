...
# ToSliderCtrl.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for Slider
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
