---
title: "ToTaskPanelCtrl.Enable"
description: "Specifies in user dialog boxes whether a control can be enabled."
---

# ToTaskPanelCtrl.Enable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for TaskPanel

Specifies in user dialog boxes whether a control can be enabled.
...
```python
TaskPanel1.Enable = 0 '0=No, 1=Yes
```
...
*Source: `Sudref/properties/SUD_property_Enable_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
