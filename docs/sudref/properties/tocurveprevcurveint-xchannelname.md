---
title: "ToCurvePrevCurveInt.XChannelName"
description: "Specifies the name of the x-channel of a curve in the curve preview in user dialog boxes."
---

# ToCurvePrevCurveInt.XChannelName

!!! abstract "Property &middot; `Sudref.chm`"
    Property: XChannelName for Curve
...
Specifies the name of the x-channel of a curve in the curve preview in user dialog boxes.
...
MsgBoxDisp(oMyCurve.XChannelName + "  " + oMyCurve.YChannelName)
```
...
*Source: `Sudref/properties/SUD_property_XChannelName_ToCurvePrevCurveInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
