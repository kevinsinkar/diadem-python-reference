---
title: "ToSliderCtrl.IncrementPage"
description: "Specifies the step width for the Slider control in user dialog boxes when you use the <Page up> and <Page down> keys. If the value is not set or -1 , DIAdem use"
---

# ToSliderCtrl.IncrementPage
