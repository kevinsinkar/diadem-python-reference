---
title: "ToSudViewOb.TitleHeightPix"
description: "Specifies the height of the title bar in pixels in a user dialog box. Use this property to calculate the coordinates of a control in the user dialog box as an e"
---

# ToSudViewOb.TitleHeightPix

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TitleHeightPix for Dialog
...
```python
MsgBoxDisp(Dialog.TitleHeightPix)
MsgBoxDisp(Dialog.MapYPixelToDlu(Dialog.TitleHeightPix))
```
