...
<td><strong>Note  </strong>The property has no effect if you assign the value <span class="Monospace">0 - No</span> to the <a href="../tosudviewob-scrollbars/">ScrollBars</a> property.</td>
</tr>
</table>
</div>
...
```python
Dialog.ScrollBars = 1
Dialog.ScrollHeight = 200
Dialog.ScrollWidth = 200
```
...
*Source: `Sudref/properties/SUD_property_ScrollHeight_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
