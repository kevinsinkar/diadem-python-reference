---
title: "ToSudViewObInt.ObjectCode"
description: "Specifies the name of a user dialog box. Use the name Dialog within the dialog editor to edit the dialog box and its properties and events."
---

# ToSudViewObInt.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for Dialog <NonModal>
...
Specifies the name of a user dialog box. Use the name Dialog within the dialog editor to edit the dialog box and its properties and events.
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
