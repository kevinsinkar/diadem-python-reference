---
title: "ToSudViewObInt.EscapeMode"
description: "Specifies whether you can press <Esc> to cancel the user dialog box."
---

# ToSudViewObInt.EscapeMode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: EscapeMode for Dialog <NonModal>
...
Specifies whether you can press <Esc> to cancel the user dialog box.
...
<td><strong>Note  </strong>The <a href="../../../comoff/commands/isesckeypressed/">IsEscKeyPressed</a> function returns whether you pressed &lt;Esc&gt;.</td>
</tr>
<tr><td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>Set the <a href="../../../varoff/variables/autoabort/">AutoAbort</a> variable as <span class="Monospace">False</span> to avoid terminating the script when you exit the dialog box with &lt;Esc&gt;.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_EscapeMode_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
