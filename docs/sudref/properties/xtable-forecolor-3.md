...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ForeColor for ChnComboBox <XTable>
...
*Source: `Sudref/properties/SUD_property_ForeColor_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
