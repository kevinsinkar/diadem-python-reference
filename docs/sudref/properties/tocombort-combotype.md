...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: ComboType for ComboBox
...
```python
ComboBox1.ComboType = 2  # 2=StaticDropDown
```
...
*Source: `Sudref/properties/SUD_property_ComboType_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
