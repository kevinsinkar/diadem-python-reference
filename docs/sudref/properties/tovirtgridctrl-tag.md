---
title: "ToVirtGridCtrl.Tag"
description: "Defines any comment for a control in a user dialog box. The comment does not affect the behavior of the control."
---

# ToVirtGridCtrl.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for XTable
...
Defines any comment for a control in a user dialog box. The comment does not affect the behavior of the control.
...
*Source: `Sudref/properties/SUD_property_Tag_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
