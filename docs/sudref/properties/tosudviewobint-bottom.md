---
title: "ToSudViewObInt.Bottom"
description: "Specifies the distance from the bottom edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen."
---

# ToSudViewObInt.Bottom

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Bottom for Dialog <NonModal>
...
Specifies the distance from the bottom edge of a user dialog box to the screen origin. The screen origin is the top-left corner of the screen.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  The value of the <span class="Monospace">Bottom</span> property must be greater than or equal to the sum of the properties <a href="../tosudviewobint-top/">Top</a> and <a href="../tosudviewobint-minheight/">MinHeight</a>.</td></tr>
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>This does not include the height of the dialog box title, which the <a href="../tosudviewobint-titleheightpix/">TitleHeightPix</a> property specifies.</td></tr>
