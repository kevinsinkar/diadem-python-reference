---
title: "ToFrameRt.BorderColor"
description: "Specifies the color of a frame in a user dialog box. Use the automatic setting if you want the frame color to correspond to the color settings for the operating"
---

# ToFrameRt.BorderColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderColor for Frame
...
<td><strong>Note  </strong>The property is ineffective if you assign <span class="Monospace">1 - 3D</span> to the <a href="../toframert-borderstyle/">Borderstyle</a> property.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note  </strong>You also can use the <a href="../toframert-highlightcolor/">HighlightColor</a> property to change the color display for the frame.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
...
```python
Frame1.BorderColor = 16711680
```

```python
Frame1.BorderColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_BorderColor_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
