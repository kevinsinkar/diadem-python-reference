---
title: "ToVirtSelectionInt.AllowCols"
description: "Specifies whether entire columns of an extended table can be selected, for example if the appropriate column label is clicked, in user dialog boxes."
---

# ToVirtSelectionInt.AllowCols

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AllowCols for Selection

Specifies whether entire columns of an extended table can be selected, for example if the appropriate column label is clicked, in user dialog boxes.
...
```python
XTable1.SelectedElements.AllowCols = TRUE
```
