---
title: "ToCheckRt.ValueExt"
description: "Specifies in user dialog boxes the status of a checkbox. The user dialog box does not execute the EventChange method when the value of the control changes."
---

# ToCheckRt.ValueExt

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ValueExt for CheckBox
...
Specifies in user dialog boxes the status of a checkbox. The user dialog box does not execute the EventChange method when the value of the control changes.
