---
title: "ToSelectionRangeInt.LastCol"
description: "Specifies the number of the last selected column in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable me"
---

# ToSelectionRangeInt.LastCol

!!! abstract "Property &middot; `Sudref.chm`"
    Property: LastCol for SelectionItem
...
Specifies the number of the last selected column in a selection block of the extended table in user dialog boxes. If the whole table is selected, the IsTable method returns the value True and the LastCol property returns the value 0 .
