---
title: "ToCurvePreviewOb.AxisTextColor"
description: "Specifies in user dialog boxes the color of the axis and scale labeling for the Curve2DPreview control. Use the automatic setting if you want the color to corre"
---

# ToCurvePreviewOb.AxisTextColor

!!! abstract "Property &middot; `Sudref.chm`"
    Property: AxisTextColor for Curve2DPreview
...
```python
Curve2Dreview1.Curves.RemoveAll
Curve2DPreview1.Curves.Add("[[1]/[1]","[1]/[2]")
Curve2DPreview1.AxisTextColor = 16711680
Curve2DPreview1.Refresh
```

```python
Curve2DPreview1.AxisTextColor = dd.RGB(0,0,255)
```
...
*Source: `Sudref/properties/SUD_property_AxisTextColor_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
