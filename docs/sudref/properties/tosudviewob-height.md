...
Specifies the height of a user dialog box. If you assign the Resizeable property to the user dialog box, the property also specifies the minimum size for scalable user dialog boxes. To move a dialog box, use the Move method.
