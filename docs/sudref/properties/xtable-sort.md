---
title: "XTable.Sort"
description: "Specifies in user dialog boxes whether selection lists of an extended table sort the selection terms in alphabetical order. The property can have the following "
---

# XTable.Sort

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Sort for ComboBox <XTable>
...
Specifies in user dialog boxes whether selection lists of an extended table sort the selection terms in alphabetical order. The property can have the following settings: 0 - No Does not sort the elements. 1 - Yes Sorts the elements.
...
*Source: `Sudref/properties/SUD_property_sort_ToComboRt_XTable.htm`*
