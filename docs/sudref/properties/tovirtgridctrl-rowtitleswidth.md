---
title: "ToVirtGridCtrl.RowTitlesWidth"
description: "Specifies in user dialog boxes the width of the left column that contains the labeling of the extended table."
---

# ToVirtGridCtrl.RowTitlesWidth

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RowTitlesWidth for XTable
...
Specifies in user dialog boxes the width of the left column that contains the labeling of the extended table.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>The user dialog box only displays the left table labeling when you set <a href="../tovirtgridctrl-rowtitlesdisplay/">RowTitlesDisplay</a> to <span class="Monospace">Yes</span>.</td></tr></table>
</div>
