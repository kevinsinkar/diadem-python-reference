---
title: "ToListBoxRt.selectionmode"
description: "Specifies whether the selection list allows multiple selection. The property can have the following settings: 0 - Single selection Multiple selection is not pos"
---

# ToListBoxRt.selectionmode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: SelectionMode for ListBox
...
Specifies whether the selection list allows multiple selection. The property can have the following settings: 0 - Single selection Multiple selection is not possible. 1 - Multiselection You can make a multiple selection in any order.
...
*Source: `Sudref/properties/SUD_property_selectionmode_ToListBoxRt.htm`*
