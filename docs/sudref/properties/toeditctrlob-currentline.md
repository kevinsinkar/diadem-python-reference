---
title: "ToEditCtrlOb.CurrentLine"
description: "Specifies in user dialog boxes the index of the line where the cursor is located inside the textbox."
---

# ToEditCtrlOb.CurrentLine

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CurrentLine for EditBox
...
Specifies in user dialog boxes the index of the line where the cursor is located inside the textbox.
...
```python
Text1.Text = EditBox1.CurrentLine
```
...
*Source: `Sudref/properties/SUD_property_CurrentLine_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
