---
title: "ToSudViewOb.CursorPointer"
description: "Specifies how the user dialog box displays the mouse cursor on a dialog box control."
---

# ToSudViewOb.CursorPointer

!!! abstract "Property &middot; `Sudref.chm`"
    Property: CursorPointer for Dialog
