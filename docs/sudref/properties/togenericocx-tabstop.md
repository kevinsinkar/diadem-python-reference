...
# ToGenericOcx.TabStop

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TabStop for ActiveX
...
*Source: `Sudref/properties/SUD_property_TabStop_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
