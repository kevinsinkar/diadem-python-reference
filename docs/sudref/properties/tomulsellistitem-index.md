---
title: "ToMulSelListItem.Index"
description: "Returns the index of a selected term in the selection list in user dialog boxes."
---

# ToMulSelListItem.Index

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Index for ListItem

Returns the index of a selected term in the selection list in user dialog boxes.
...
for i in range(1, ListBox1.MultiSelection.Count + 1):
    MsgBoxDisp(ListBox1.MultiSelection.Item(i).Index + " , " + ListBox1.MultiSelection.Item(i).Text)
```
...
*Source: `Sudref/properties/SUD_property_Index_ToMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
