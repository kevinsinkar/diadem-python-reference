...
# ToVarComboRt.Selection

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Selection for EnumComboBox
...
*Source: `Sudref/properties/SUD_property_Selection_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
