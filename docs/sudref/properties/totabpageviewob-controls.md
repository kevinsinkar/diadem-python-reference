---
title: "ToTabPageViewOb.Controls"
description: "Returns a collection of all the controls of a tab in user dialog boxes. To access single controls in scripts, either use the Item property or enter the index in"
---

# ToTabPageViewOb.Controls

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Controls for Page
...
Returns a collection of all the controls of a tab in user dialog boxes. To access single controls in scripts, either use the Item property or enter the index in parentheses.

## Signature

```python
return_value = obj.Controls
```
...
```python
Page1.Controls(2).ForeColor = 16711680
```

```python
for oMyControl in Page1.Controls:
...
*Source: `Sudref/properties/SUD_property_Controls_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
