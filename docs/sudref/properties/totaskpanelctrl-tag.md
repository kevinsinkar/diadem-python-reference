---
title: "ToTaskPanelCtrl.Tag"
description: "Specifies in user dialog boxes a tag for a control. The tag does not affect the behavior of the control."
---

# ToTaskPanelCtrl.Tag

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Tag for TaskPanel

Specifies in user dialog boxes a tag for a control. The tag does not affect the behavior of the control.
...
```python
TaskPanel1.Tag = "First TaskPanel"
```
...
*Source: `Sudref/properties/SUD_property_Tag_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
