---
title: "ToCheckRt.tristate"
description: "Specifies whether a checkbox has two or three values in a user dialog box. The property can have the following settings: 0 - No Only allows the status Checked a"
---

# ToCheckRt.tristate

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TriState for CheckBox

Specifies whether a checkbox has two or three values in a user dialog box. The property can have the following settings: 0 - No Only allows the status Checked and Unchecked . 1 - Yes Also provides the status Undeterminate , which is a gray tick.
...
<td><strong>Note</strong>  The property is only effective if you enter <span class="Monospace"> 0 - No</span> for the <a href="../tocheckrt-ownerdrawn/">OwnerDrawn</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_tristate_ToCheckRt.htm`*
