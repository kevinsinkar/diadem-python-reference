...
description: "Frames the controls of an extended controls in dialog boxes. The property can have the following settings: 0 - No Draws no frame. 1 - Yes Draws a frame."
---

# XTable.BorderDrawn

!!! abstract "Property &middot; `Sudref.chm`"
    Property: BorderDrawn for ListBox <XTable>
...
Frames the controls of an extended controls in dialog boxes. The property can have the following settings: 0 - No Draws no frame. 1 - Yes Draws a frame.
...
*Source: `Sudref/properties/SUD_property_borderdrawn_ToListBoxRt_XTable.htm`*
