---
title: "XTable.Picture"
description: "Specifies in user dialog boxes the graphic of a selection list in the extended table. Click to the right of Picture in the Cell Type dialog box to paste, to loa"
---

# XTable.Picture

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Picture for ListBox <XTable>
...
<td><strong>Note  </strong>Use the <a href="../xtable-picturealign-3/">PictureAlign</a> property to specify the alignment of the graphics in the selection list.</td>
</tr>
</table>
</div>
