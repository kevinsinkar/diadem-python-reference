---
title: "ToTabPageViewOb.Height"
description: "Returns the height of a tab in user dialog boxes."
---

# ToTabPageViewOb.Height

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Height for Page

Returns the height of a tab in user dialog boxes.
...
<td><strong>Note</strong>  The <a href="../totabpagectrl-height/">Height</a> property of the <span class="Monospace">TabPageCtrl</span> control includes the height of the tab and the height of the labels.</td>
</tr>
</table>
</div>
...
```python
MsgBoxDisp("Height: " &Page1.Height)
```
...
*Source: `Sudref/properties/SUD_property_Height_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
