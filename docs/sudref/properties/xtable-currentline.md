...
!!! abstract "Property &middot; `Sudref.chm`"
    Property: CurrentLine for EditBox <XTable>
...
*Source: `Sudref/properties/SUD_property_CurrentLine_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
