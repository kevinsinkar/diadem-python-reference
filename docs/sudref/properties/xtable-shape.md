---
title: "XTable.Shape"
description: "Specifies in a user dialog box the display mode of the CheckBox control in an extended table. The property can have the following settings: 0 - CheckBox Display"
---

# XTable.Shape

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Shape for CheckBox <XTable>

Specifies in a user dialog box the display mode of the CheckBox control in an extended table. The property can have the following settings: 0 - CheckBox Displays the checkbox. 2 - Button (default) Displays a button as in Windows XP. 4 - Button (Classic) Displays a button as in Windows Classic.
...
*Source: `Sudref/properties/SUD_property_shape_ToCheckRt_XTable.htm`*
