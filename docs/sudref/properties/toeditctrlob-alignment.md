---
title: "ToEditCtrlOb.alignment"
description: "Specifies the text alignment in a textbox in a user dialog box. The property can have the following settings: 0 - Left Aligns the text flush to the left. 1 - Ce"
---

# ToEditCtrlOb.alignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Alignment for EditBox
...
Specifies the text alignment in a textbox in a user dialog box. The property can have the following settings: 0 - Left Aligns the text flush to the left. 1 - Center Centers the text. 2 - Right Aligns the text flush to the right.
...
<td><strong>Note</strong>  The <a href="../toeditctrlob-horizontalscroll/">HorizontalScroll</a> property is only effective if the <span class="Monospace">Alignment</span> property has the value <span class="Monospace">Left</span>.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_alignment_ToEditCtrlOb.htm`*
