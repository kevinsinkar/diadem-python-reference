---
title: "ToSudViewObInt.Enable"
description: "Specifies whether a user dialog box is enabled."
---

# ToSudViewObInt.Enable

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Enable for Dialog <NonModal>

Specifies whether a user dialog box is enabled.
...
<td><strong>Note  </strong>You cannot edit a disabled dialog box. Make sure that you enable the dialog box again.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_Enable_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
