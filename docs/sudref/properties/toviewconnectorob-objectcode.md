---
title: "ToViewConnectorOb.ObjectCode"
...
# ToViewConnectorOb.ObjectCode

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ObjectCode for ViewConnector
...
Specifies the unique name for a control in a user dialog box. Use this name to select a control in the dialog editor, to edit its properties and events. In scripts you also use the ObjectCode of a control to access the control. The ObjectCode of the ViewConnector control is always ViewConnector .
...
*Source: `Sudref/properties/SUD_property_ObjectCode_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
