---
title: "ToTableCtrl.ColMoveAllowed"
description: "Enables you to use the mouse to move table columns in user dialog boxes."
---

# ToTableCtrl.ColMoveAllowed

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ColMoveAllowed for Table

Enables you to use the mouse to move table columns in user dialog boxes.
...
*Source: `Sudref/properties/SUD_property_ColMoveAllowed_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
