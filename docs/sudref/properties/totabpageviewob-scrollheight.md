---
title: "ToTabPageViewOb.ScrollHeight"
description: "Specifies the height of a tab of the TabPageCtrl control with scroll bars in dialog units ."
---

# ToTabPageViewOb.ScrollHeight

!!! abstract "Property &middot; `Sudref.chm`"
    Property: ScrollHeight for Page

Specifies the height of a tab of the TabPageCtrl control with scroll bars in dialog units .
...
<td><strong>Note  </strong>The property has no effect if you assign the value <span class="Monospace">0 - No</span> to the <a href="../totabpageviewob-scrollbars/">ScrollBars</a> property.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/properties/SUD_property_ScrollHeight_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
