---
title: "ToSudViewObInt.FileName"
description: "Returns the name of the current dialog box in a user dialog box."
---

# ToSudViewObInt.FileName

!!! abstract "Property &middot; `Sudref.chm`"
    Property: FileName for Dialog <NonModal>
...
Returns the name of the current dialog box in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_FileName_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
