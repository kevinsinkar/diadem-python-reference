---
title: "ToEditCtrlOb.caseorpassword"
description: "Specifies in user dialog boxes how a textbox displays a text when you enter it. The property can have the following settings: 0 - None Displays text unaltered. "
---

# ToEditCtrlOb.caseorpassword
...
*Source: `Sudref/properties/SUD_property_caseorpassword_ToEditCtrlOb.htm`*
