---
title: "ToCurvePreviewOb.Flex"
description: "Specifies the change in the size and position of the control when you scale a user dialog box during runtime. The property has no effect if you assign the value"
---

# ToCurvePreviewOb.Flex

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Flex for Curve2DPreview
...
Specifies the change in the size and position of the control when you scale a user dialog box during runtime. The property has no effect if you assign the value 0 - No to the Resizeable dialog box property.
...
<td><strong>Note  </strong>If the control is in a tab, the size and position change according to the <span class="Monospace">TabPageCtrl</span> control, not according to the dialog box.</td>
</tr>
</table>
</div>
