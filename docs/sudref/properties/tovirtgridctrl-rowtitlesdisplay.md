---
title: "ToVirtGridCtrl.RowTitlesDisplay"
description: "Specifies in user dialog boxes whether extended tables display the row labels."
---

# ToVirtGridCtrl.RowTitlesDisplay

!!! abstract "Property &middot; `Sudref.chm`"
    Property: RowTitlesDisplay for XTable

Specifies in user dialog boxes whether extended tables display the row labels.

## Signature

```python
obj.RowTitlesDisplay
```
...
```python
XTable1.RowTitlesDisplay = FALSE
```
...
*Source: `Sudref/properties/SUD_property_RowTitlesDisplay_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
