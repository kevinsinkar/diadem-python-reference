---
title: "ToSliderCtrl.TickStyle"
description: "Specifies in user dialog boxes whether and where DIAdem displays ticks for the Slider control."
---

# ToSliderCtrl.TickStyle

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TickStyle for Slider
...
Specifies in user dialog boxes whether and where DIAdem displays ticks for the Slider control.

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>For a vertically aligned slider, DIAdem hides the ticks if they are not equidistant and a residual tick remains.</td></tr></table>
</div>
