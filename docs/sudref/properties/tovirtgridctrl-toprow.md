---
title: "ToVirtGridCtrl.TopRow"
description: "Specifies in user dialog boxes the index of the first visible row in the extended table."
---

# ToVirtGridCtrl.TopRow

!!! abstract "Property &middot; `Sudref.chm`"
    Property: TopRow for XTable

Specifies in user dialog boxes the index of the first visible row in the extended table.
