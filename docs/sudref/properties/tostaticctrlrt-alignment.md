---
title: "ToStaticCtrlRt.Alignment"
description: "Specifies the alignment of a text in a user dialog box."
---

# ToStaticCtrlRt.Alignment

!!! abstract "Property &middot; `Sudref.chm`"
    Property: Alignment for Text

Specifies the alignment of a text in a user dialog box.
...
*Source: `Sudref/properties/SUD_property_Alignment_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
