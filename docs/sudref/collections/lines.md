---
title: "Lines"
description: "Collection of all the Lines in an entry field in user dialog boxes."
---
...
```python
for i in range(1, Editbox1.Lines.Count + 1):
    MsgBoxDisp(i + ", " + EditBox1.Lines.Item(i).Text)
```
...
<p><a href="../../properties/toeditlines-count/">Count</a></p>
</div>
<div class="Methods"><h2>Methods</h2>
<p><a href="../../methods/toeditlines-item/">Item</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../objects/editbox/">EditBox &lt;XTable&gt;</a>.<a href="../../methods/xtable-lines/">Lines</a> | <a href="../../objects/toeditctrlob/">EditBox</a>.<a href="../../methods/toeditctrlob-lines/">Lines</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_ToEditLines.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
