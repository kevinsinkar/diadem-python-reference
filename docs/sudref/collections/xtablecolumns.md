---
title: "XTableColumns"
description: "Collection of all Columns of an extended table in a user dialog box. You can use the XTableColumns collection to delete the columns of the extended tables or to"
---

# XTableColumns

!!! abstract "Collection &middot; `Sudref.chm`"
    Collection: XTableColumns

Collection of all Columns of an extended table in a user dialog box. You can use the XTableColumns collection to delete the columns of the extended tables or to add columns to the table.
...
<p><a href="../../properties/tovirtcolcontint-count/">Count</a></p>
</div>
<div class="Methods"><h2>Methods</h2>
<p><a href="../../methods/tovirtcolcontint-add/">Add</a> | <a href="../../methods/tovirtcolcontint-addbytype/">AddByType</a> | <a href="../../methods/tovirtcolcontint-item/">Item</a> | <a href="../../methods/tovirtcolcontint-remove/">Remove</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../objects/tovirtgridctrl/">XTable</a>.<a href="../../properties/tovirtgridctrl-columns/">Columns</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_ToVirtColContInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
