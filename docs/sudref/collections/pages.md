---
title: "Pages"
description: "Collection of all the tabs of the TabPageCtrl control in user dialog boxes."
---
...
Collection of all the tabs of the TabPageCtrl control in user dialog boxes.
...
```python
for i in range(1, TabPageCtrl1.Pages.Count + 1):
    MsgBoxDisp(i + ", " + TabPageCtrl1.Pages(i).Title)
```
...
<p><a href="../../properties/totabpagelistfmt-count/">Count</a></p>
</div>
<div class="Methods"><h2>Methods</h2>
<p><a href="../../methods/totabpagelistfmt-item/">Item</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../objects/totabpagectrl/">TabPageCtrl</a>.<a href="../../properties/totabpagectrl-pages/">Pages</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_ToTabPageListFmt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
