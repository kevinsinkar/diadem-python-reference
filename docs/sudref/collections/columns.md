---
title: "Columns"
description: "Collection of all Columns of a table in user dialog boxes."
---
...
Collection of all Columns of a table in user dialog boxes.
...
```python
for i in range(1, Table1.Columns.Count + 1):
    MsgBoxDisp(Table1.Columns(i).Title)
```
...
<p><a href="../../properties/tocolumnsdisp-count/">Count</a></p>
</div>
<div class="Methods"><h2>Methods</h2>
<p><a href="../../methods/tocolumnsdisp-add/">Add</a> | <a href="../../methods/tocolumnsdisp-addto/">AddTo</a> | <a href="../../methods/tocolumnsdisp-item/">Item</a> | <a href="../../methods/tocolumnsdisp-move/">Move</a> | <a href="../../methods/tocolumnsdisp-remove/">Remove</a> | <a href="../../methods/tocolumnsdisp-swap/">Swap</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../objects/totablectrl/">Table</a>.<a href="../../properties/totablectrl-columns/">Columns</a></p>
</div>
</div>
