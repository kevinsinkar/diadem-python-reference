---
title: "ToTaskPanelCtrl.AddLinkItem"
description: "Creates a new entry in a group in the TaskPanel. This entry is selectable and can be linked to an action."
---

# ToTaskPanelCtrl.AddLinkItem

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddLinkItem for TaskPanel

Creates a new entry in a group in the TaskPanel. This entry is selectable and can be linked to an action.

## Signature

```python
obj.AddLinkItem(GroupKey, Key, Text)
```
...
*Source: `Sudref/methods/SUD_method_AddLinkItem_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
