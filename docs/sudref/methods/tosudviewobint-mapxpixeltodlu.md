---
title: "ToSudViewObInt.MapXPixelToDlu"
description: "Converts an x-coordinate that is specified in pixels, into dialog units . A dialog unit is a value that consists of the height and the width of the font used."
---

# ToSudViewObInt.MapXPixelToDlu

!!! abstract "Method &middot; `Sudref.chm`"
    Method: MapXPixelToDlu for Dialog <NonModal>

Converts an x-coordinate that is specified in pixels, into dialog units . A dialog unit is a value that consists of the height and the width of the font used.

## Signature

```python
iMapXPixelToDlu = Object.MapXPixelToDlu(X)
```
...
*Source: `Sudref/methods/SUD_method_MapXPixelToDlu_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
