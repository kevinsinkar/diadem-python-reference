...
```python
Dialog.Layers(ComboBox1.LayerName) = TRUE
```

```python
Page1.Layers(ComboBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
