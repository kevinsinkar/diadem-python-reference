...
```python
Dialog.Layers(Frame1.LayerName) = TRUE
```

```python
Page1.Layers(Frame2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
