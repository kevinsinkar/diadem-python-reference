...
```python
def Frame1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    Frame1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
