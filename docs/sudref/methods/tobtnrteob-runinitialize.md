...
```python
def Button1_EventInitialize(ByRef This):
    # Do something

def ComboBox1_EventChange(ByRef This):
    Button1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
