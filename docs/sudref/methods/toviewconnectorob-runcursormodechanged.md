---
title: "ToViewConnectorOb.RunCursorModeChanged"
description: "Triggers the EventCursorModeChanged event for a control in user dialog boxes."
---

# ToViewConnectorOb.RunCursorModeChanged

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunCursorModeChanged for ViewConnector

Triggers the EventCursorModeChanged event for a control in user dialog boxes.

## Signature

```python
obj.RunCursorModeChanged()
```
...
```python
def ViewConnector_EventCursorModeChanged(ByRef This):
    # Do something
def Button1_EventClick(ByRef This):
    ViewConnector.RunCursorModeChanged
```
...
*Source: `Sudref/methods/SUD_method_RunCursorModeChanged_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
