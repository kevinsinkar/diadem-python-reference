---
title: "ToTabPageViewOb.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the RefreshText method. You can use this method to refresh a control, after another cont"
---

# ToTabPageViewOb.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for Page

Triggers the EventRefresh event in user dialog boxes. The method starts the RefreshText method. You can use this method to refresh a control, after another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
