...
```python
MsgBoxDisp(ComboBox1.Items.Item(1).Value)
MsgBoxDisp(ComboBox1.Items(1).Value)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
