...
description: "You can use this method to refresh the ChnListBox control, when another control changes the data of this control."
---

# XTable.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for ChnListBox <XTable>
...
You can use this method to refresh the ChnListBox control, when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToChnListBoxCtrl_XTable.htm`*
