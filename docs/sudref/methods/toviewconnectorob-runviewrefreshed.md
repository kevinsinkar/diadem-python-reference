---
title: "ToViewConnectorOb.RunViewRefreshed"
description: "Triggers the EventViewRefreshed event for a control in user dialog boxes."
---

# ToViewConnectorOb.RunViewRefreshed

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunViewRefreshed for ViewConnector

Triggers the EventViewRefreshed event for a control in user dialog boxes.

## Signature

```python
obj.RunViewRefreshed()
```
...
*Source: `Sudref/methods/SUD_method_RunViewRefreshed_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
