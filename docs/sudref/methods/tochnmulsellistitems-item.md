---
title: "ToChnMulSelListItems.Item"
description: "Returns the ListItem object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection. This list contai"
---

# ToChnMulSelListItems.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for ChnMultiSelection

Returns the ListItem object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection. This list contains the selected entries from a selection list.
...
```python
MsgBoxDisp(ChnListBox1.MultiSelection.Item(1).Text)
MsgBoxDisp(ChnListBox1.MultiSelection(1).Text)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
