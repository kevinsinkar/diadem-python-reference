...
```python
Dialog.Layers(Button1.LayerName) = TRUE
```

```python
Page1.Layers(Button2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
