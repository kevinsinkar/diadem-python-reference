---
title: "ToEditCtrlOb.GetSelectionEnd"
description: "Returns in in user dialog boxes the position after which the selection in the entry field ends. If no text is selected, the method returns the value 1 ."
---

# ToEditCtrlOb.GetSelectionEnd

!!! abstract "Method &middot; `Sudref.chm`"
    Method: GetSelectionEnd for EditBox

Returns in in user dialog boxes the position after which the selection in the entry field ends. If no text is selected, the method returns the value 1 .
...
*Source: `Sudref/methods/SUD_method_GetSelectionEnd_ToEditCtrlOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
