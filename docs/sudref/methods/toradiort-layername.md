...
!!! abstract "Method &middot; `Sudref.chm`"
    Method: LayerName for RadioButton
...
```python
Dialog.Layers(RadioButton1.LayerName) = TRUE
```

```python
Page1.Layers(RadioButton2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
