---
title: "ToMulSelListItems.RemoveSelection"
description: "Removes the selection marking of a term in a selection list in user dialog boxes."
---

# ToMulSelListItems.RemoveSelection

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RemoveSelection for MultiSelection
...
Removes the selection marking of a term in a selection list in user dialog boxes.
...
```python
ListBox1.MultiSelection.RemoveSelection(1, 0)
```

```python
ListBox1.MultiSelection.RemoveSelection(1, 2)
```
...
*Source: `Sudref/methods/SUD_method_RemoveSelection_ToMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
