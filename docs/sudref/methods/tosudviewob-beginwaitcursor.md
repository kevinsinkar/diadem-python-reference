...
<td><strong>Note  </strong>Use the <a href="../tosudviewob-endwaitcursor/">EndWaitCursor</a> method to reset the cursor. Use <a href="../tosudviewob-restorewaitcursor/">RestoreWaitCursor</a> to restore the mouse cursor to an hourglass after the hourglass display was aborted, for example, if a dialog box call occurred or a message was displayed.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_BeginWaitCursor_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
