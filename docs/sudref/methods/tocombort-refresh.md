---
title: "ToComboRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the methods RefreshText and RefreshValue . You can use this method to refresh the ComboB"
---
...
*Source: `Sudref/methods/SUD_method_Refresh_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
