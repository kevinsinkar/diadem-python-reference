...
```python
def ComboBox1_EventInitialize(ByRef This):
    # Do something
def EditBox1_EventChange(ByRef This):
    ComboBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
