---
title: "ToChnCtrl.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the ChnCtrl control, when another control changes the data of this cont"
---
...
*Source: `Sudref/methods/SUD_method_Refresh_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
