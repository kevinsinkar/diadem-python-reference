---
title: "ToSudViewOb.RestoreWaitCursor"
...
# ToSudViewOb.RestoreWaitCursor

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RestoreWaitCursor for Dialog
...
<td><strong>Note  </strong>Use the <a href="../tosudviewob-endwaitcursor/">EndWaitCursor</a> method to reset the cursor.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_RestoreWaitCursor_ToSudViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
