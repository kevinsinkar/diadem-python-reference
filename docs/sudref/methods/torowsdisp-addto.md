---
title: "ToRowsDisp.AddTo"
description: "Adds a new row at a specific position in tables of user dialog boxes. The subsequent rows move up accordingly."
---

# ToRowsDisp.AddTo

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddTo for Rows

Adds a new row at a specific position in tables of user dialog boxes. The subsequent rows move up accordingly.

## Signature

```python
return_value = obj.AddTo(Row)
```
...
<td><strong>Note  </strong>Use the <a href="../torowsdisp-add/">Add</a> method to insert the item at the end of the table.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_AddTo_ToRowsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
