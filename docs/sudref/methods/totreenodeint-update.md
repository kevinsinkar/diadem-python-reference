---
title: "ToTreeNodeInt.Update"
description: "Refreshes in user dialog boxes a node or a node with a subnode in a tree. With this method you can refresh the node after its data was changed. Use the Refresh "
---

# ToTreeNodeInt.Update
...
| --- | ---: | --- |
| `eUpdateModeNode` | 0 | Refreshes the node. |
| `eUpdateModeNodeAndChilds` | 1 | Refreshes the node and the subnode. |
...
*Source: `Sudref/methods/SUD_method_Update_ToTreeNodeInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
