---
title: "ToTreeNodeListInt.Add"
description: "Creates in user dialog boxes a new node in a tree in a user dialog box. The new node is created on the level of the TreeNodes object."
---

# ToTreeNodeListInt.Add

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Add for TreeNodes

Creates in user dialog boxes a new node in a tree in a user dialog box. The new node is created on the level of the TreeNodes object.

## Signature

```python
return_value = obj.Add(Text)
```
...
*Source: `Sudref/methods/SUD_method_Add_ToTreeNodeListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
