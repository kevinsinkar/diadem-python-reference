---
title: "ToSudViewObInt.RefreshAll"
description: "Triggers the EventRefresh event in user dialog boxes for all the controls in the user dialog box. The EventRefresh event starts the methods RefreshText and Refr"
---

# ToSudViewObInt.RefreshAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshAll for Dialog <NonModal>

Triggers the EventRefresh event in user dialog boxes for all the controls in the user dialog box. The EventRefresh event starts the methods RefreshText and RefreshValue . The RefreshAll method allows all controls to react simultaneously when other controls change.
...
*Source: `Sudref/methods/SUD_method_RefreshAll_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
