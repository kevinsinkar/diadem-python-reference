...
```python
Dialog.Layers(ActiveX1.LayerName) = TRUE
```

```python
Page1.Layers(ActiveX2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
