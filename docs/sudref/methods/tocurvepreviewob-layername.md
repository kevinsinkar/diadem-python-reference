...
```python
Dialog.Layers(Curve2DPreview1.LayerName) = TRUE
```

```python
Page1.Layers(Curve2DPreview2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
