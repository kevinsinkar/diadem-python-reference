...
# ToCheckRt.RefreshValue

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshValue for CheckBox
...
*Source: `Sudref/methods/SUD_method_RefreshValue_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
