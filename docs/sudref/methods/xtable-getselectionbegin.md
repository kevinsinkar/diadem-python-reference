---
title: "XTable.GetSelectionBegin"
description: "Returns in extended tables in user dialog boxes the position at which the selection in an entry field begins. If no text is selected, the method returns the val"
---

# XTable.GetSelectionBegin
...
*Source: `Sudref/methods/SUD_method_GetSelectionBegin_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
