---
title: "ToListItems.RemoveAll"
description: "Deletes all the selection terms from a selection list in user dialog boxes. The method is not available for the controls EnumComboBox , EnumListBox , and RadioB"
---

# ToListItems.RemoveAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RemoveAll for ListItems

Deletes all the selection terms from a selection list in user dialog boxes. The method is not available for the controls EnumComboBox , EnumListBox , and RadioButton .
...
*Source: `Sudref/methods/SUD_method_RemoveAll_ToListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
