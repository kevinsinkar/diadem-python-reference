---
title: "ToTabPageViewOb.RunInitialize"
description: "Triggers the EventInitialize event for a tab of the TabPageCtrl control in user dialog boxes."
---

# ToTabPageViewOb.RunInitialize

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunInitialize for Page

Triggers the EventInitialize event for a tab of the TabPageCtrl control in user dialog boxes.
...
```python
def Page1_EventInitialize(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
