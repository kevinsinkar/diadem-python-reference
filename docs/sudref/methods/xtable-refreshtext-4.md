---
title: "XTable.RefreshText"
description: "Refreshes the text displayed on a control in extended tables in user dialog boxes. This is useful when the text contains a DIAdem expression, such as @T1@ , wit"
---

# XTable.RefreshText

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshText for ListBox <XTable>

Refreshes the text displayed on a control in extended tables in user dialog boxes. This is useful when the text contains a DIAdem expression, such as @T1@ , with changed values.
