---
title: "ToViewConnectorOb.RunPlayStatusChanged"
description: "Triggers the EventPlayStatusChanged event for a control in user dialog boxes."
---

# ToViewConnectorOb.RunPlayStatusChanged

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunPlayStatusChanged for ViewConnector

Triggers the EventPlayStatusChanged event for a control in user dialog boxes.

## Signature

```python
obj.RunPlayStatusChanged(bStartPlaying)
```
...
*Source: `Sudref/methods/SUD_method_RunPlayStatusChanged_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
