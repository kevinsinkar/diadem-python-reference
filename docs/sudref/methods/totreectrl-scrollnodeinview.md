---
title: "ToTreeCtrl.ScrollNodeInView"
description: "Displays in dialog boxes a node in the tree. If necessary, DIAdem opens the associated branches and moves the node into the visible area."
---

# ToTreeCtrl.ScrollNodeInView
...
*Source: `Sudref/methods/SUD_method_ScrollNodeInView_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
