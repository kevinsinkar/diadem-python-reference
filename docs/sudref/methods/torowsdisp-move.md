---
title: "ToRowsDisp.Move"
description: "Moves a table row in a user dialog box."
---

# ToRowsDisp.Move

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Move for Rows
...
Moves a table row in a user dialog box.
...
*Source: `Sudref/methods/SUD_method_Move_ToRowsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
