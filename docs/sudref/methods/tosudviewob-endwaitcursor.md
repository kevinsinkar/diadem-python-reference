...
<td><strong>Note  </strong>Use the <a href="../tosudviewob-beginwaitcursor/">BeginWaitCursor</a> method to display the mouse cursor as an hourglass.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_EndWaitCursor_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
