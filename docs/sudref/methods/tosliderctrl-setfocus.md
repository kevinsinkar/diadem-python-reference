---
title: "ToSliderCtrl.SetFocus"
description: "Sets the focus on a control in a user dialog box."
---

# ToSliderCtrl.SetFocus

!!! abstract "Method &middot; `Sudref.chm`"
    Method: SetFocus for Slider
...
*Source: `Sudref/methods/SUD_method_SetFocus_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
