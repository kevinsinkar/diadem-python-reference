---
title: "XTable.FillItemsByVar"
description: "Adds the selection terms from an enumeration variable to an existing selection list in extended tables in user dialog boxes. The selection terms can be appended"
---

# XTable.FillItemsByVar

!!! abstract "Method &middot; `Sudref.chm`"
    Method: FillItemsByVar for ComboBox <XTable>
...
Cell.FillItemsByVar("XChnStyle",FALSE)
```
...
*Source: `Sudref/methods/SUD_method_FillItemsByVar_ToComboRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
