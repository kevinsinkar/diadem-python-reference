---
title: "ToRowsDisp.Swap"
description: "Swaps the positions of two rows in a user dialog box table. The method modifies only the DisplayedLocation property, not the index for addressing the rows."
---

# ToRowsDisp.Swap

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Swap for Rows
...
Swaps the positions of two rows in a user dialog box table. The method modifies only the DisplayedLocation property, not the index for addressing the rows.
...
*Source: `Sudref/methods/SUD_method_Swap_ToRowsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
