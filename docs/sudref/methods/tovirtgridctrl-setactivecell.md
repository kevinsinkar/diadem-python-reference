---
title: "ToVirtGridCtrl.SetActiveCell"
description: "Positions the enabled cell of an extended table in user dialog boxes."
---

# ToVirtGridCtrl.SetActiveCell
...
```python
obj.SetActiveCell(Row, Column)
```

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>The properties <a href="../../properties/tovirtgridctrl-activecellcol/">ActiveCellCol</a> and <a href="../../properties/tovirtgridctrl-activecellrow/">ActiveCellRow</a> receive the column index or the row index of the enabled cell.</td></tr></table>
</div>
...
*Source: `Sudref/methods/SUD_method_SetActiveCell_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
