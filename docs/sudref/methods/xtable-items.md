---
title: "XTable.Items"
description: "Returns a collection of all selection terms of a channel selection list, in extended tables in user dialog boxes."
---

# XTable.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for ChnComboBox <XTable>
...
*Source: `Sudref/methods/SUD_method_Items_ToChnComboBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
