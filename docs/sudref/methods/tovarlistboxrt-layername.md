...
```python
Dialog.Layers(EnumListBox1.LayerName) = TRUE
```

```python
Page1.Layers(EnumListBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
