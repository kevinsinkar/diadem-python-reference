---
title: "ToSudViewOb.Hide"
description: "Hides the user dialog box. If you hide the dialog box, you cannot operate DIAdem. To use DIAdem again, you must redisplay and close the hidden dialog box."
---

# ToSudViewOb.Hide

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Hide for Dialog
...
Hides the user dialog box. If you hide the dialog box, you cannot operate DIAdem. To use DIAdem again, you must redisplay and close the hidden dialog box.
