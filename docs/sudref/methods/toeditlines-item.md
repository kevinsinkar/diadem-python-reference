---
title: "ToEditLines.Item"
description: "Returns the Line object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection."
---

# ToEditLines.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for Lines
...
Returns the Line object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection.
...
```python
MsgBoxDisp(EditBox1.Lines.Item(1))
MsgBoxDisp(EditBox1.Lines(1))
```
...
*Source: `Sudref/methods/SUD_method_Item_ToEditLines.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
