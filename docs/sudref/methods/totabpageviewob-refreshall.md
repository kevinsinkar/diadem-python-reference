---
title: "ToTabPageViewOb.RefreshAll"
description: "Triggers the EventRefresh event for a tab of the TabPageCtrl control, and the controls that the tab contains, in user dialog boxes. The EventRefresh event start"
---

# ToTabPageViewOb.RefreshAll
...
*Source: `Sudref/methods/SUD_method_RefreshAll_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
