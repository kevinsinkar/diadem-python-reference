...
# ToFrameRt.RefreshValue

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshValue for Frame
...
*Source: `Sudref/methods/SUD_method_RefreshValue_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
