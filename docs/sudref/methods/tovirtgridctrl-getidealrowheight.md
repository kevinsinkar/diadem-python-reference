---
title: "ToVirtGridCtrl.GetIdealRowHeight"
description: "Checks the height of all controls of the extended table and determines the best row height for the extended table. The method only returns a value unequal -1 if"
---

# ToVirtGridCtrl.GetIdealRowHeight

!!! abstract "Method &middot; `Sudref.chm`"
    Method: GetIdealRowHeight for XTable
...
Checks the height of all controls of the extended table and determines the best row height for the extended table. The method only returns a value unequal -1 if the extended table contains at least one control whose height cannot be specified by the user, for example, ComboBox , EnumComboBox , or ChnComboBox .

## Signature

```python
iGetIdealRowHeight = Object.GetIdealRowHeight()
```
...
```python
XTable1.RowHeight = XTable1.GetIdealRowHeight
```
...
*Source: `Sudref/methods/SUD_method_GetIdealRowHeight_ToVirtGridCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
