...
<td><strong>Note</strong>  Click <strong>Edit»Variables</strong> and select the <strong>Restore when cancelled</strong> property for the DIAdem variables defined in the user dialog box, so you can restore the original values after you click Cancel, or after you call the  <span class="Monospace">Apply</span> method.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_Apply_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
