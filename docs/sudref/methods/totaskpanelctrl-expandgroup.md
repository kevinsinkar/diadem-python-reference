---
title: "ToTaskPanelCtrl.ExpandGroup"
description: "Opens a group in the TaskPanel of a user dialog box."
---

# ToTaskPanelCtrl.ExpandGroup

!!! abstract "Method &middot; `Sudref.chm`"
    Method: ExpandGroup for TaskPanel

Opens a group in the TaskPanel of a user dialog box.
...
*Source: `Sudref/methods/SUD_method_ExpandGroup_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
