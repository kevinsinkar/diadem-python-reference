...
```python
def RadioButton1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    RadioButton1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
