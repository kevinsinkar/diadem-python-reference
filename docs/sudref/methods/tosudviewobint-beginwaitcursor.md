---
title: "ToSudViewObInt.BeginWaitCursor"
description: "Displays the mouse cursor as an hourglass in user dialog boxes, to indicate that the action takes time."
---

# ToSudViewObInt.BeginWaitCursor

!!! abstract "Method &middot; `Sudref.chm`"
    Method: BeginWaitCursor for Dialog <NonModal>
...
Displays the mouse cursor as an hourglass in user dialog boxes, to indicate that the action takes time.
...
<td><strong>Note  </strong>Use the <a href="../tosudviewobint-endwaitcursor/">EndWaitCursor</a> method to reset the cursor. Use <a href="../tosudviewobint-restorewaitcursor/">RestoreWaitCursor</a> to restore the mouse cursor to an hourglass after the hourglass display was aborted, for example, if a dialog box call occurred or a message was displayed.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_BeginWaitCursor_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
