---
title: "ToSliderCtrl.LayerName"
description: "Returns the name of the layer associated with a control in user dialog boxes."
---

# ToSliderCtrl.LayerName

!!! abstract "Method &middot; `Sudref.chm`"
    Method: LayerName for Slider
...
```python
Dialog.Layers(Slider1.LayerName) = TRUE
```

```python
Page1.Layers(Slider2.LayerName) = TRUE
```

## See also

<div markdown="1">
<div class="SeeAlso"><p class="body">The following example shows the dialog box layer associated with <span class="Monospace">Slider1</span>:</p><div class="copyblue"><p class="body"><a href="#">Copy script</a></p></div><div class="codeblue"><pre><donottranslate>Dialog.Layers(Slider1.LayerName) = <span class="HlVBSKeyword">TRUE</span></donottranslate></pre></div><p class="body">The following example shows the layer associated with <span class="Monospace">Slider2</span> on the <span class="Monospace">Page1</span> tab:</p><div class="copyblue"><p class="body"><a href="#">Copy script</a></p></div><div class="codeblue"><pre><donottranslate>Page1.Layers(Slider2.LayerName) = <span class="HlVBSKeyword">TRUE</span></donottranslate></pre></div>
<h2>See Also</h2>
...
*Source: `Sudref/methods/SUD_method_LayerName_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
