---
title: "ToSudViewObInt.MapYPixelToDlu"
description: "Converts a y-coordinate that is specified in pixels, into dialog units . A dialog unit is a value that consists of the height and the width of the font used."
---

# ToSudViewObInt.MapYPixelToDlu

!!! abstract "Method &middot; `Sudref.chm`"
    Method: MapYPixelToDlu for Dialog <NonModal>
...
Converts a y-coordinate that is specified in pixels, into dialog units . A dialog unit is a value that consists of the height and the width of the font used.

## Signature

```python
iMapYPixelToDlu = Object.MapYPixelToDlu(Y)
```
...
*Source: `Sudref/methods/SUD_method_MapYPixelToDlu_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
