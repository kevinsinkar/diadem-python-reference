---
title: "ToCurvePrevCurvesInt.Item"
description: "Returns the curve associated with a specific index of the curve preview in a user dialog box."
---

# ToCurvePrevCurvesInt.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for Curves
...
Returns the curve associated with a specific index of the curve preview in a user dialog box.
...
```python
MsgBoxDisp("Name of first x-channel: " + Curve2DPreview1.Curves.Item(1).XChannelName)
MsgBoxDisp("Name of first x-channel: " + Curve2DPreview1.Curves(1).XChannelName)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToCurvePrevCurvesInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
