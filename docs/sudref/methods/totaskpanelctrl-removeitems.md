---
title: "ToTaskPanelCtrl.RemoveItems"
description: "Deletes all groups and entries in the TaskPanel of a user dialog box."
---

# ToTaskPanelCtrl.RemoveItems
...
def CreateNewPanel(This):
    ...
    This.AddLinkItem("AnimalGroup","cat","Cat")
    This.AddLinkItem("PlantsGroup","tree","Tree")
    This.AddLinkItem("PlantsGroup","flower","Flower")
```
...
*Source: `Sudref/methods/SUD_method_RemoveItems_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
