---
title: "ToVarComboRt.Items"
description: "Returns a collection of all selection terms of an EnumComboBox selection list in user dialog boxes."
---

# ToVarComboRt.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for EnumComboBox
...
Returns a collection of all selection terms of an EnumComboBox selection list in user dialog boxes.
...
```python
MsgBoxDisp(EnumComboBox1.Items.Count)
```

```python
MsgBoxDisp(EnumComboBox1.Items(3).Text)
```
...
*Source: `Sudref/methods/SUD_method_Items_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
