...
def Button1_EventClick(This):
    ...
    Dialog.RunCustomAction(sMyAction)
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
