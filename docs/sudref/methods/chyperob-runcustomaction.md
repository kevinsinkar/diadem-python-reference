...
```python
sAction = "UpperLimit"
oEdit = Dialog.GetControl("EditBox1")
oEdit.RunCustomAction(sAction)
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_CHyperOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
