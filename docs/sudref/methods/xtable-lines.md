---
title: "XTable.Lines"
description: "Returns a collection of the rows in extended tables in a textbox in user dialog boxes."
---
...
Returns a collection of the rows in extended tables in a textbox in user dialog boxes.
...
```python
MsgBoxDisp(Cell.Lines.Item(1).Text)
```
...
*Source: `Sudref/methods/SUD_method_Lines_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
