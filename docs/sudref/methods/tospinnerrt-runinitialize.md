...
```python
def SpinBox1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    SpinBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
