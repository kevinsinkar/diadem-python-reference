---
title: "ToTabPageCtrl.RunInitialize"
description: "Triggers the EventInitialize event for the TabPageCtrl control in user dialog boxes."
---

# ToTabPageCtrl.RunInitialize

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunInitialize for TabPageCtrl
...
Triggers the EventInitialize event for the TabPageCtrl control in user dialog boxes.
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
