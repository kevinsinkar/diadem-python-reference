---
title: "ToColumnsDisp.Item"
description: "Returns the Column object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection."
---
...
Returns the Column object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection.
...
```python
MsgBoxDisp(Table1.Columns.Item(1).Title)
MsgBoxDisp(Table1.Columns(1).Title)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToColumnsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
