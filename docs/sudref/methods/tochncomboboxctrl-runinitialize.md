---
title: "ToChnComboBoxCtrl.RunInitialize"
description: "Triggers the EventInitialize event for a control in user dialog boxes."
---

# ToChnComboBoxCtrl.RunInitialize

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunInitialize for ChnComboBox
...
```python
def ChnComboBox1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    ChnComboBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
