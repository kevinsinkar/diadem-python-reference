---
title: "ToPictureOb.RunClick"
description: "Triggers the EventClick event for a control in user dialog boxes."
---

# ToPictureOb.RunClick

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunClick for Picture
...
```python
def Picture1_EventClick(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunClick_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
