---
title: "ToVirtSelectionInt.RemoveAll"
description: "Deletes the selection marking for all the selection blocks in an extended table in user dialog boxes."
---

# ToVirtSelectionInt.RemoveAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RemoveAll for Selection

Deletes the selection marking for all the selection blocks in an extended table in user dialog boxes.
...
*Source: `Sudref/methods/SUD_method_RemoveAll_ToVirtSelectionInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
