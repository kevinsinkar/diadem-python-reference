---
title: "ToViewConnectorOb.RunCursorTypeChanged"
description: "Triggers the EventCursorTypeChanged event for a control in user dialog boxes."
---

# ToViewConnectorOb.RunCursorTypeChanged

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunCursorTypeChanged for ViewConnector

Triggers the EventCursorTypeChanged event for a control in user dialog boxes.

## Signature

```python
obj.RunCursorTypeChanged()
```
...
*Source: `Sudref/methods/SUD_method_RunCursorTypeChanged_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
