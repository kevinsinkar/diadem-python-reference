...
# ToSudViewObInt.Cancel

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Cancel for Dialog <NonModal>

Triggers the EventTerminate event and closes the user dialog box. The method has the same effect as clicking a button that has the value Cancel for the ButtonType property.
...
<td><strong>Note  </strong>Select in the dialog editor <strong>Edit»Variables</strong> and the <strong>Restore when cancels</strong> property for the DIAdem variables defined in the user dialog box, to restore the original values after you cancel.</td>
</tr>
<tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../tosudviewobint-hide/">Hide</a> method if you want to hide the dialog box.</td></tr></table>
</div>
