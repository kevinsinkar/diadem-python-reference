...
def Button1_EventClick(ByRef This):
    ...
    RadioButton1.RunCustomAction(sMyAction)
```

```python
def RadioButton1_EventCustomAction(ByRef This, VarParam):
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
