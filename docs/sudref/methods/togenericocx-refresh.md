...
# ToGenericOcx.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for ActiveX
...
*Source: `Sudref/methods/SUD_method_Refresh_ToGenericOcx.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
