---
title: "ToVirtSelectionInt.AddCells"
description: "Selects the specified cells of an extended table in user dialog boxes. If multiple selection is possible in the extended table, this method adds the specified c"
---

# ToVirtSelectionInt.AddCells
...
```python
obj.AddCells(FromRow, FromCol, ToRow, ToCol)
```
...
XTable1.SelectedElements.AddCells(2,4,3,4)
XTable1.Refresh()
```
