---
title: "ToVarListBoxRt.RefreshValue"
description: "Refreshes the displayed value of a control in user dialog boxes. This is useful when other events change the value of the variables linked to the control."
---

# ToVarListBoxRt.RefreshValue

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshValue for EnumListBox
...
```python
EnumListBox1.RefreshValue
```

## See also

<div markdown="1">
<div class="SeeAlso"><p class="body">The following example refreshes the value of <span class="Monospace">EnumListBox1</span>:</p><div class="copyblue"><p class="body"><a href="#">Copy script</a></p></div><div class="codeblue"><pre><donottranslate><span class="HlVBSKeyword">Call</span> EnumListBox1.RefreshValue</donottranslate></pre></div><h2>See Also</h2>
...
*Source: `Sudref/methods/SUD_method_RefreshValue_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
