...
```python
Dialog.Layers(TaskPanel1.LayerName) = TRUE
```

```python
Page1.Layers(TaskPanel2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
