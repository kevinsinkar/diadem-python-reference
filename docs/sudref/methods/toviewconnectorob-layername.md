...
```python
Dialog.Layers(ViewConector1.LayerName) = TRUE
```

```python
Page1.Layers(ViewConnector2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
