...
```python
def ChnCtrl1_EventChange(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunChange_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
