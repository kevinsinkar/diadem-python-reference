...
```python
def Table1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    Table1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
