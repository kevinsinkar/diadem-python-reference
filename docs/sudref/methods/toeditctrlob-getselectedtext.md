---
title: "ToEditCtrlOb.GetSelectedText"
description: "Returns the selected text from a textbox in user dialog boxes."
---

# ToEditCtrlOb.GetSelectedText
...
```python
MsgBoxDisp(EditBox1.GetSelectedText)
```
...
*Source: `Sudref/methods/SUD_method_GetSelectedText_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
