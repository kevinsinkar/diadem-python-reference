...
def Button1_EventClick(ByRef This):
    ...
    ListBox1.RunCustomAction(sMyAction)
```

```python
def ListBox1_EventCustomAction(ByRef This, VarParam):
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
