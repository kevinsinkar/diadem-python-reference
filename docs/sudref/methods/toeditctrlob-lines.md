---
title: "ToEditCtrlOb.Lines"
description: "Returns a collection of the rows in a textbox in user dialog boxes."
---
...
```python
MsgBoxDisp(EditBox1.Lines.Item(1).Text)
```
...
*Source: `Sudref/methods/SUD_method_Lines_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
