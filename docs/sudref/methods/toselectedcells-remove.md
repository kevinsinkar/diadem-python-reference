---
title: "ToSelectedCells.Remove"
description: "Removes a table cell selection in user dialog boxes."
---

# ToSelectedCells.Remove

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Remove for SelectedCells

Removes a table cell selection in user dialog boxes.
