...
```python
Dialog.Layers(CheckBox1.LayerName) = TRUE
```

```python
Page1.Layers(CheckBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
