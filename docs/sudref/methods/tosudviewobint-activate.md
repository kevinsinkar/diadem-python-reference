---
title: "ToSudViewObInt.Activate"
description: "Enables a non-modal user dialog box."
---

# ToSudViewObInt.Activate

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Activate for Dialog <NonModal>
...
Enables a non-modal user dialog box.
...
```python
oMyDlg = dd.SudDlgCreate("Dlg1","Test.sud")
oMyDlg.Show
InteractionOn
oMyDlg.Activate
```
...
*Source: `Sudref/methods/SUD_method_Activate_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
