...
```python
def Picture1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    Picture1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
