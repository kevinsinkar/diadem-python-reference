---
title: "ToSliderCtrl.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Slider control when another control changes the data of this contro"
---

# ToSliderCtrl.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for Slider

Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Slider control when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
