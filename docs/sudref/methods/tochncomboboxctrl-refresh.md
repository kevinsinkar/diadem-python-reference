---
title: "ToChnComboBoxCtrl.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the ChnComboBox control, wh"
---

# ToChnComboBoxCtrl.Refresh
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note</strong>  If you use the method <a href="../tosudviewobint-refreshall/">RefreshAll</a>, DIAdem does not refresh the channel selection list.</td></tr></table>
</div>
...
```python
ChnSmooth("MyChn","Y_Smooth",12,"maxNumber")
ChnComboBox1.Refresh
```
...
*Source: `Sudref/methods/SUD_method_Refresh_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
