...
!!! abstract "Method &middot; `Sudref.chm`"
    Method: OK for Dialog <NonModal>

Triggers the EventTerminate event and closes the user dialog box. The method has the same effect as clicking a button that has the value OK for the ButtonType property.
