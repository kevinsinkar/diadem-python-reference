---
title: "ToRowsDisp.Add"
description: "Appends a new row to a table in user dialog boxes."
---
...
Appends a new row to a table in user dialog boxes.
...
<td><strong>Note  </strong>Use the <a href="../torowsdisp-addto/">AddTo</a> method to insert the item at a specific position in the table.</td>
</tr>
</table>
</div>
