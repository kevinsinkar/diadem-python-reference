---
title: "ToSudViewObInt.SetForeground"
description: "Displays the user dialog box on top. Use this method to indicate that the user can start making entries in the dialog box again after actions that take a long t"
---

# ToSudViewObInt.SetForeground

!!! abstract "Method &middot; `Sudref.chm`"
    Method: SetForeground for Dialog <NonModal>

Displays the user dialog box on top. Use this method to indicate that the user can start making entries in the dialog box again after actions that take a long time.
...
*Source: `Sudref/methods/SUD_method_SetForeground_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
