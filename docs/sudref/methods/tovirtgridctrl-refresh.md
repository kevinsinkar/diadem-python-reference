---
title: "ToVirtGridCtrl.Refresh"
description: "Triggers the EventRefresh event for the XTable control in user dialog boxes. With the Refresh method you can refresh a control after another control modifies th"
---

# ToVirtGridCtrl.Refresh
...
<div markdown="1">
<table class="Borderless" id="table3"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>When the extended table refreshes, the <a href="../../events/eventvalget-eventvalget/">EventValGet</a> event triggers for all visible cells.</td></tr><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>After this method is called in an event, do not trigger a command that uses a dialog box, such as <span class="Monospace">MsgBox</span>, because then DIAdem cannot execute the <span class="Monospace">Refresh</span> method correctly.</td></tr></table>
</div>
...
*Source: `Sudref/methods/SUD_method_Refresh_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
