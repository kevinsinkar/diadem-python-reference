---
title: "ToTaskPanelCtrl.RunInitialize"
description: "Triggers the EventInitialize event for a control in user dialog boxes. Use this event to fill the TaskPanel with groups and entries."
---

# ToTaskPanelCtrl.RunInitialize

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunInitialize for TaskPanel
...
Triggers the EventInitialize event for a control in user dialog boxes. Use this event to fill the TaskPanel with groups and entries.
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
