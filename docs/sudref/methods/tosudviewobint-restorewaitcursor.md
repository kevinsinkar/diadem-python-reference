---
title: "ToSudViewObInt.RestoreWaitCursor"
description: "Redisplays the cursor as an hourglass after the display of the hourglass was interrupted, for example, because of a dialog box call or a message display."
---

# ToSudViewObInt.RestoreWaitCursor

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RestoreWaitCursor for Dialog <NonModal>

Redisplays the cursor as an hourglass after the display of the hourglass was interrupted, for example, because of a dialog box call or a message display.

## Signature

```python
obj.RestoreWaitCursor()
```
...
<td><strong>Note  </strong>Use the <a href="../tosudviewobint-endwaitcursor/">EndWaitCursor</a> method to reset the cursor.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_RestoreWaitCursor_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
