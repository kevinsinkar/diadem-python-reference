...
```python
Dialog.Layers(ChnListBox1.LayerName) = TRUE
```

```python
Page1.Layers(ChnListBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
