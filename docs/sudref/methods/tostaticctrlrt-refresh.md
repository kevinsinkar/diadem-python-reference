---
title: "ToStaticCtrlRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Text control, when another control changes the data of this control"
---

# ToStaticCtrlRt.Refresh
...
*Source: `Sudref/methods/SUD_method_Refresh_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
