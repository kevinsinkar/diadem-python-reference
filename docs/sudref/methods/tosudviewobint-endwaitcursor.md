---
title: "ToSudViewObInt.EndWaitCursor"
description: "Redisplays the mouse cursor after it appears as a wait cursor in user dialog boxes."
---

# ToSudViewObInt.EndWaitCursor

!!! abstract "Method &middot; `Sudref.chm`"
    Method: EndWaitCursor for Dialog <NonModal>
...
Redisplays the mouse cursor after it appears as a wait cursor in user dialog boxes.
...
<td><strong>Note  </strong>Use the <a href="../tosudviewobint-beginwaitcursor/">BeginWaitCursor</a> method to display the mouse cursor as an hourglass.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_EndWaitCursor_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
