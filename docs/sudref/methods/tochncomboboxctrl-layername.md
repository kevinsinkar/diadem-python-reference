...
```python
Dialog.Layers(ChnComboBox1.LayerName) = TRUE
```

```python
Page1.Layers(ChnComboBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
