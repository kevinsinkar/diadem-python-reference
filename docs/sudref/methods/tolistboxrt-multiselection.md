---
title: "ToListBoxRt.MultiSelection"
description: "Returns a collection of the selected terms of a selection list in user dialog boxes."
---

# ToListBoxRt.MultiSelection

!!! abstract "Method &middot; `Sudref.chm`"
    Method: MultiSelection for ListBox
...
Returns a collection of the selected terms of a selection list in user dialog boxes.
...
for i in range(1, ListBox1.MultiSelection.Count + 1):
    MsgBoxDisp(ListBox1.MultiSelection(i).Text)
```
...
*Source: `Sudref/methods/SUD_method_MultiSelection_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
