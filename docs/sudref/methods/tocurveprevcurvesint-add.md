---
title: "ToCurvePrevCurvesInt.Add"
description: "Generates a new curve in the curve preview in user dialog boxes."
---

# ToCurvePrevCurvesInt.Add

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Add for Curves
...
Generates a new curve in the curve preview in user dialog boxes.

## Signature

```python
return_value = obj.Add(XChnNameNumber, YChnNameNumber)
```
