---
title: "ToSudViewObInt.Hide"
description: "Hides the user dialog box."
---

# ToSudViewObInt.Hide

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Hide for Dialog <NonModal>

Hides the user dialog box.
