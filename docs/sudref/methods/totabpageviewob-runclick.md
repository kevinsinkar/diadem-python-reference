---
title: "ToTabPageViewOb.RunClick"
description: "Triggers the EventClick event for a tab in user dialog boxes."
---

# ToTabPageViewOb.RunClick

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunClick for Page
...
Triggers the EventClick event for a tab in user dialog boxes.
...
*Source: `Sudref/methods/SUD_method_RunClick_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
