...
```python
def ListBox1_EventChange(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunChange_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
