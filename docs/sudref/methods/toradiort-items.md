---
title: "ToRadioRt.Items"
description: "Returns a collection of all selection terms of an option field selection list in user dialog boxes."
---

# ToRadioRt.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for RadioButton

Returns a collection of all selection terms of an option field selection list in user dialog boxes.
...
```python
MsgBoxDisp(RadioButton1.Items.Count)
```

```python
MsgBoxDisp(RadioButton1.Items(3).InterpretedText)
```
...
*Source: `Sudref/methods/SUD_method_Items_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
