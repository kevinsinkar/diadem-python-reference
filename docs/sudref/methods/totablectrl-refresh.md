---
title: "ToTableCtrl.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Table control, when another control changes the data of this contro"
---
...
*Source: `Sudref/methods/SUD_method_Refresh_ToTableCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
