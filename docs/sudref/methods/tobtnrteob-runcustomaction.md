...
def Button1_EventClick(ByRef This):
    ...
    Button2.RunCustomAction(sMyAction)
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
