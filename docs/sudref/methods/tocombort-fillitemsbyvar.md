---
title: "ToComboRt.FillItemsByVar"
...
# ToComboRt.FillItemsByVar

!!! abstract "Method &middot; `Sudref.chm`"
    Method: FillItemsByVar for ComboBox
...
ComboBox1.FillItemsByVar("XChnStyle",FALSE)
```
...
*Source: `Sudref/methods/SUD_method_FillItemsByVar_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
