---
title: "ToVirtGridCtrl.RunColCtrlPreset"
description: "Triggers the EventColCtrlPreSet() event for the XTable control in user dialog boxes. You can use this event to configure the controls that are assigned to the c"
---

# ToVirtGridCtrl.RunColCtrlPreset
