---
title: "ToViewConnectorOb.RunCustomAction"
description: "Triggers the EventCustomAction event. You can use this event anywhere, for any purpose."
---

# ToViewConnectorOb.RunCustomAction

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunCustomAction for ViewConnector
...
def Button1_EventClick(ByRef This):
    ...
    ViewConnector1.RunCustomAction(sMyAction)
```

```python
def Button2_EventCustomAction(ByRef This, VarParam):
    if VarParam = "UpperLimit":
        MsgBoxDisp("UpperLimit")
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
