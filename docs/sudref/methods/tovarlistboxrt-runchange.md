...
```python
def EnumListBox1_EventChange(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    EnumListBox1.RunChange
```
...
*Source: `Sudref/methods/SUD_method_RunChange_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
