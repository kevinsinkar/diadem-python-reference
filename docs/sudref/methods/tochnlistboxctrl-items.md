---
title: "ToChnListBoxCtrl.Items"
description: "Returns a collection of all selection terms of a ChnListBox selection list in user dialog boxes."
---

# ToChnListBoxCtrl.Items
...
```python
MsgBoxDisp(ChnListBox1.Items.Count)
```

```python
MsgBoxDisp(ChnListBox1.Items(3).Text)
```
...
*Source: `Sudref/methods/SUD_method_Items_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
