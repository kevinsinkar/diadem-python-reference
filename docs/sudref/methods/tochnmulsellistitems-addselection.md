---
title: "ToChnMulSelListItems.AddSelection"
description: "Adds selection terms to the selected area of a channel selection list in user dialog boxes."
---

# ToChnMulSelListItems.AddSelection

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddSelection for ChnMultiSelection

Adds selection terms to the selected area of a channel selection list in user dialog boxes.

## Signature

```python
obj.AddSelection(Index, Range)
```
...
```python
ChnListBox1.MultiSelection.AddSelection(1, 3)
```

```python
ChnListBox1.MultiSelection.AddSelection(1, 2)
ChnListBox1.MultiSelection.AddSelection(4, 1)
```
...
*Source: `Sudref/methods/SUD_method_AddSelection_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
