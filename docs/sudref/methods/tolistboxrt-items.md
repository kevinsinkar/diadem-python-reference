---
title: "ToListBoxRt.Items"
description: "Returns a collection of all selection terms of a ListBox selection list in user dialog boxes."
---

# ToListBoxRt.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for ListBox
...
Returns a collection of all selection terms of a ListBox selection list in user dialog boxes.
...
```python
ListBox1.Items.Add("red",1)
```

```python
MsgBoxDisp(ListBox1.Items.Count)
```

```python
MsgBoxDisp(ListBox1.Items(3).InterpretedText)
```
...
*Source: `Sudref/methods/SUD_method_Items_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
