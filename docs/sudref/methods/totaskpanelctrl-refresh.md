---
title: "ToTaskPanelCtrl.Refresh"
description: "Triggers the EventRefresh event for a control in user dialog boxes. With the Refresh method you can refresh a control after another control modifies the data of"
---

# ToTaskPanelCtrl.Refresh
...
*Source: `Sudref/methods/SUD_method_Refresh_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
