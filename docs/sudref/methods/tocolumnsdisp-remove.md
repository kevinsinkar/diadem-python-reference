---
title: "ToColumnsDisp.Remove"
description: "Deletes a column from a table in a user dialog box. The subsequent columns move up."
---

# ToColumnsDisp.Remove
...
Deletes a column from a table in a user dialog box. The subsequent columns move up.
