---
title: "ToCurvePreviewOb.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Curve2DPreview control after its data was changed by a different co"
---

# ToCurvePreviewOb.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for Curve2DPreview

Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Curve2DPreview control after its data was changed by a different control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
