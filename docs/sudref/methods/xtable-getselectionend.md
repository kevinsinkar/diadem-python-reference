---
title: "XTable.GetSelectionEnd"
description: "Returns in extended tables in user dialog boxes the position after which the selection in an entry field ends. If no text is selected, the method returns the va"
---

# XTable.GetSelectionEnd
...
*Source: `Sudref/methods/SUD_method_GetSelectionEnd_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
