...
```python
Dialog.Layers(ChnCtrl1.LayerName) = TRUE
```

```python
Page1.Layers(ChnCtrl2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToChnCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
