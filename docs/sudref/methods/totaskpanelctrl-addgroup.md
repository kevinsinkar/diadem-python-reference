---
title: "ToTaskPanelCtrl.AddGroup"
description: "Creates a group in the TaskPanel of a new group"
---

# ToTaskPanelCtrl.AddGroup

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddGroup for TaskPanel
...
Creates a group in the TaskPanel of a new group

## Signature

```python
obj.AddGroup(GroupKey, Text)
```
...
*Source: `Sudref/methods/SUD_method_AddGroup_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
