---
title: "ToEditCtrlOb.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the EditBox control, when a"
---

# ToEditCtrlOb.Refresh
...
*Source: `Sudref/methods/SUD_method_Refresh_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
