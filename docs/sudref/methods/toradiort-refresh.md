---
title: "ToRadioRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the RadioButton control, when another control changes the data of this "
---

# ToRadioRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for RadioButton
...
Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the RadioButton control, when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
