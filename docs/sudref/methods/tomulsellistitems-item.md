...
# ToMulSelListItems.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for MultiSelection
...
```python
MsgBoxDisp(ListBox1.MultiSelection.Item(1).Text)
MsgBoxDisp(ListBox1.MultiSelection(1).Text)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
