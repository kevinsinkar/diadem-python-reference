---
title: "ToCurvePreviewOb.RunCustomAction"
description: "Triggers the EventCustomAction event for a control in user dialog boxes. You can use this event anywhere, for any purpose."
---

# ToCurvePreviewOb.RunCustomAction

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunCustomAction for Curve2DPreview
...
def Button1_EventClick(ByRef This):
    ...
    Curve2DPreview1.RunCustomAction(sMyAction)
```

```python
def Curve2DPreview1_EventCustomAction(ByRef This, VarParam):
    if VarParam = "UpperLimit":
        This.TooltipText = "Limit exceeded"
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToCurvePreviewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
