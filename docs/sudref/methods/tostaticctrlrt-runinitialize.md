...
```python
def Text1_EventInitialize(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
