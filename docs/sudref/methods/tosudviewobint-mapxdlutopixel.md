---
title: "ToSudViewObInt.MapXDluToPixel"
description: "Converts an x-coordinate that is specified in dialog units , into pixels. A dialog unit is a value that consists of the height and the width of the font used."
---

# ToSudViewObInt.MapXDluToPixel

!!! abstract "Method &middot; `Sudref.chm`"
    Method: MapXDluToPixel for Dialog <NonModal>

Converts an x-coordinate that is specified in dialog units , into pixels. A dialog unit is a value that consists of the height and the width of the font used.

## Signature

```python
iMapXDluToPixel = Object.MapXDluToPixel(X)
```
...
iPixel = oMyDlg.MapXDluToPixel(10)
MsgBoxDisp(iPixel)
```
...
*Source: `Sudref/methods/SUD_method_MapXDluToPixel_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
