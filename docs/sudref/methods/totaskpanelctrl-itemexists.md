---
title: "ToTaskPanelCtrl.ItemExists"
description: "Specifies whether an entry with a specific key exists in the TaskPanel of a user dialog box."
---

# ToTaskPanelCtrl.ItemExists

!!! abstract "Method &middot; `Sudref.chm`"
    Method: ItemExists for TaskPanel

Specifies whether an entry with a specific key exists in the TaskPanel of a user dialog box.

## Signature

```python
bItemExists = Object.ItemExists(Key)
```
...
*Source: `Sudref/methods/SUD_method_ItemExists_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
