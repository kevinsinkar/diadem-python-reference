---
title: "ToSelectedCells.Item"
description: "Returns the Cell object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection."
---

# ToSelectedCells.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for SelectedCells

Returns the Cell object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection.
...
*Source: `Sudref/methods/SUD_method_Item_ToSelectedCells.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
