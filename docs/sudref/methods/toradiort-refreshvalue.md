...
# ToRadioRt.RefreshValue

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshValue for RadioButton
...
*Source: `Sudref/methods/SUD_method_RefreshValue_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
