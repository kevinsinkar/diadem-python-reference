...
```python
Dialog.Layers(EnumComboBox1.LayerName) = TRUE
```

```python
Page1.Layers(EnumComboBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
