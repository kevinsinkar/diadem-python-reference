...
def Button1_EventClick(This):
    ...
    Page1.RunCustomAction(sMyAction)
```

```python
def Page1_EventCustomAction(This, VarParam):
    if VarParam == "UpperLimit":
        This.Color= dd.RGB(255, 0, 0)
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToTabPageViewOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
