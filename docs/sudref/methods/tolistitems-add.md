---
title: "ToListItems.Add"
description: "Adds a term to a selection list in user dialog boxes. The method is not available for the controls EnumComboBox , EnumListBox , and RadioButton ."
---

# ToListItems.Add

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Add for ListItems

Adds a term to a selection list in user dialog boxes. The method is not available for the controls EnumComboBox , EnumListBox , and RadioButton .

## Signature

```python
return_value = obj.Add(Text, Value)
```
