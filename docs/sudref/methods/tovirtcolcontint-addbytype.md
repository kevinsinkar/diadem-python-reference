---
title: "ToVirtColContInt.AddByType"
description: "Adds a new column to an extended table in user dialog boxes. The new column appears at the end of the table."
---

# ToVirtColContInt.AddByType

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddByType for XTableColumns
...
Adds a new column to an extended table in user dialog boxes. The new column appears at the end of the table.

## Signature

```python
return_value = obj.AddByType(Name, Type)
```

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../../properties/tovirtgridctrl-lockupdate/">LockUpdate</a> property, which suppresses the interim extended table refresh, if you add several columns.</td></tr>
<tr>
...
```python
oMyColumn = XTable1.Columns.AddByType("NewCol","ComboBox")
XTable1.Refresh
```
...
*Source: `Sudref/methods/SUD_method_AddByType_ToVirtColContInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
