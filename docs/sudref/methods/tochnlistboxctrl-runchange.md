...
```python
def ChnListBox1_EventChange(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    ChnListBox1.RunChange
```
...
*Source: `Sudref/methods/SUD_method_RunChange_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
