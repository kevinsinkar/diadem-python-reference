---
title: "ToTreeNodeListInt.Remove"
description: "Deletes in user dialog boxes one node of a tree branch."
---

# ToTreeNodeListInt.Remove

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Remove for TreeNodes

Deletes in user dialog boxes one node of a tree branch.
...
def Button1_EventClick(ByRef This):
    ...
    if (not oMyNode is None):
        ...
        if (oParentNode is None):
            Tree1.Nodes.Remove(oMyNode.Index)
            Tree1.Refresh
        else:
...
*Source: `Sudref/methods/SUD_method_Remove_ToTreeNodeListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
