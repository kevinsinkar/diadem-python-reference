...
def Button1_EventClick(This):
    ...
    XTable1.RunCustomAction(sMyAction)
```

```python
def XTable1_EventCustomAction(This, VarParam):
    if VarParam == "UpperLimit":
        This.BackColor= dd.RGB(255, 0, 0)
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
