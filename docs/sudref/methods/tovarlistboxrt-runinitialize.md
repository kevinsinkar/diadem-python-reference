...
```python
def EnumListBox1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(Byref This):
    EnumListBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
