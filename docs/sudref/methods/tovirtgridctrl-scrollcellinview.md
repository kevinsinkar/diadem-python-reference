---
title: "ToVirtGridCtrl.ScrollCellInView"
description: "Moves a cell of the extended table in user dialog boxes, into the visible range if this cell is not already visible."
---

# ToVirtGridCtrl.ScrollCellInView
...
*Source: `Sudref/methods/SUD_method_ScrollCellInView_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
