---
title: "ToVarComboRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the EnumComboBox control, w"
---

# ToVarComboRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for EnumComboBox

Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the EnumComboBox control, when another control changes the data of this control.
...
def ComboBox1_EventChange(Byref This):
    EnumComboBox1.Value = 2
    EnumComboBox1.Refresh
```
...
*Source: `Sudref/methods/SUD_method_Refresh_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
