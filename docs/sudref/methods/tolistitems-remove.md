---
title: "ToListItems.Remove"
description: "Deletes a selection term from a selection list in user dialog boxes. The method is not available for the controls EnumComboBox , EnumListBox , and RadioButton ."
---

# ToListItems.Remove

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Remove for ListItems

Deletes a selection term from a selection list in user dialog boxes. The method is not available for the controls EnumComboBox , EnumListBox , and RadioButton .
