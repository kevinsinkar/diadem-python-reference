---
title: "ToVarListBoxRt.Items"
description: "Returns a collection of all selection terms of an EnumListBox selection list in user dialog boxes."
---

# ToVarListBoxRt.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for EnumListBox
...
Returns a collection of all selection terms of an EnumListBox selection list in user dialog boxes.
...
```python
MsgBoxDisp(EnumListBox1.Items.Count)
```

```python
MsgBoxDisp(EnumListBox1.Items(3).Text)
```
