---
title: "ToTaskPanelCtrl.RemoveItem"
description: "Deletes an entry in the TaskPanel of a user dialog box. If the deleted entry is a group, the method deletes the subordinate entries."
---

# ToTaskPanelCtrl.RemoveItem
...
def Button1_EventClick(This):
    if TaskPanel1.ItemExists("electricGroup"):
        TaskPanel1.RemoveItem("electricGroup")
...
*Source: `Sudref/methods/SUD_method_RemoveItem_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
