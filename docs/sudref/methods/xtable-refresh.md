---
title: "XTable.Refresh"
description: "You can use this method to refresh the ChnComboBox control, when another control changes the data of this control."
---

# XTable.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for ChnComboBox <XTable>
...
You can use this method to refresh the ChnComboBox control, when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToChnComboBoxCtrl_XTable.htm`*
