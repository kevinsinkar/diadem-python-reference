...
description: "Returns a collection of the selected channels of a channel selection list, in extended tables in user dialog boxes."
---
...
*Source: `Sudref/methods/SUD_method_MultiSelection_ToChnListBoxCtrl_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
