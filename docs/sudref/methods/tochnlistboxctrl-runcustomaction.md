...
def Button1_EventClick(ByRef This):
    ...
    ChnListBox1.RunCustomAction(sMyAction)
```

```python
def ChnListBox1_EventCustomAction(Byref This, VarParam):
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
