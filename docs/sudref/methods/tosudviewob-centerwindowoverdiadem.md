---
title: "ToSudViewOb.CenterWindowOverDIAdem"
description: "Centers a user dialog box in relation to the DIAdem window."
---

# ToSudViewOb.CenterWindowOverDIAdem

!!! abstract "Method &middot; `Sudref.chm`"
    Method: CenterWindowOverDIAdem for Dialog
...
*Source: `Sudref/methods/SUD_method_CenterWindowOverDIAdem_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
