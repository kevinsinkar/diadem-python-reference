---
title: "ToSelectedCells.Add"
description: "Adds a cell to the selected area of a table in a user dialog box."
---

# ToSelectedCells.Add

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Add for SelectedCells

Adds a cell to the selected area of a table in a user dialog box.

## Signature

```python
return_value = obj.Add(Row, Column)
```
