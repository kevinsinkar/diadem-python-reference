---
title: "ToSudViewObInt.CenterWindowOverDIAdem"
description: "Centers a user dialog box in relation to the DIAdem window."
---

# ToSudViewObInt.CenterWindowOverDIAdem

!!! abstract "Method &middot; `Sudref.chm`"
    Method: CenterWindowOverDIAdem for Dialog <NonModal>

Centers a user dialog box in relation to the DIAdem window.

## Signature

```python
obj.CenterWindowOverDIAdem()
```
...
*Source: `Sudref/methods/SUD_method_CenterWindowOverDIAdem_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
