---
title: "ToRowsDisp.Remove"
description: "Deletes a row from a table in user dialog boxes. The subsequent rows move up."
---

# ToRowsDisp.Remove

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Remove for Rows

Deletes a row from a table in user dialog boxes. The subsequent rows move up.
