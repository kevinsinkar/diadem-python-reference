---
title: "ToVirtSelectionInt.Item"
description: "Returns the SelectedElements object for a specific index in user dialog boxes. The returned object provides access to the selections in the extended table."
---

# ToVirtSelectionInt.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for Selection
...
Returns the SelectedElements object for a specific index in user dialog boxes. The returned object provides access to the selections in the extended table.
...
```python
MsgBoxDisp(XTable1.SelectedElements.Item(1).FirstRow)
MsgBoxDisp(XTable1.SelectedElements(1).FirstRow)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToVirtSelectionInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
