...
```python
Dialog.Layers(SpinBox1.LayerName) = TRUE
```

```python
Page1.Layers(SpinBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
