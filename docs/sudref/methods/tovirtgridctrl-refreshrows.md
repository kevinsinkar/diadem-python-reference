---
title: "ToVirtGridCtrl.RefreshRows"
description: "Refreshes one or more rows of an extended table in user dialog boxes. This refresh triggers the EventValGet event for the visible rows in the table."
---

# ToVirtGridCtrl.RefreshRows
