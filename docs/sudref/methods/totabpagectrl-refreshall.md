---
title: "ToTabPageCtrl.RefreshAll"
description: "Triggers the EventRefresh event in user dialog boxes, for all tabs of the TabPageCtrl control, and the controls the tab contains. The RefreshAll method allows a"
---

# ToTabPageCtrl.RefreshAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshAll for TabPageCtrl

Triggers the EventRefresh event in user dialog boxes, for all tabs of the TabPageCtrl control, and the controls the tab contains. The RefreshAll method allows all tabs to react simultaneously when other controls change.
...
*Source: `Sudref/methods/SUD_method_RefreshAll_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
