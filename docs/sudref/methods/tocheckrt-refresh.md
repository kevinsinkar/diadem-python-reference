---
title: "ToCheckRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the CheckBox control, when another control changes the data of this con"
---

# ToCheckRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for CheckBox

Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the CheckBox control, when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToCheckRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
