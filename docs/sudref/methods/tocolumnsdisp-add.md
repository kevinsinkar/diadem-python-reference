---
title: "ToColumnsDisp.Add"
description: "Appends a new column to a table in user dialog boxes."
---
...
Appends a new column to a table in user dialog boxes.
...
<td><strong>Note  </strong>Use the <a href="../tocolumnsdisp-addto/">AddTo</a> method to insert the item at a specific position in the table.</td>
</tr>
</table>
</div>
