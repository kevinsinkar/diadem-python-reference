---
title: "ToTreeCtrl.GetNode"
description: "Uses a unique key to specify a node. The node can be anywhere in the tree of a user dialog box. If the node does not exist, the method returns the value Nothing"
---
...
*Source: `Sudref/methods/SUD_method_GetNode_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
