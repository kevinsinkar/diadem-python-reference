---
title: "ToSudViewObInt.MapYDluToPixel"
description: "Converts a y-coordinate that is specified in dialog units , into pixels. A dialog unit is a value that consists of the height and the width of the font used."
---

# ToSudViewObInt.MapYDluToPixel

!!! abstract "Method &middot; `Sudref.chm`"
    Method: MapYDluToPixel for Dialog <NonModal>
...
Converts a y-coordinate that is specified in dialog units , into pixels. A dialog unit is a value that consists of the height and the width of the font used.

## Signature

```python
iMapYDluToPixel = Object.MapYDluToPixel(Y)
```
...
iPixel = oMyDlg.MapYDluToPixel(10)
MsgBoxDisp(iPixel)
```
...
*Source: `Sudref/methods/SUD_method_MapYDluToPixel_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
