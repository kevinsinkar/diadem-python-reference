---
title: "XTable.GetSelectedText"
description: "Returns the selected text from a textbox, in extended tables in user dialog boxes."
---

# XTable.GetSelectedText

!!! abstract "Method &middot; `Sudref.chm`"
    Method: GetSelectedText for EditBox <XTable>

Returns the selected text from a textbox, in extended tables in user dialog boxes.
...
```python
MsgBoxDisp(Cell.GetSelectedText)
```
...
*Source: `Sudref/methods/SUD_method_GetSelectedText_ToEditCtrlOb_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
