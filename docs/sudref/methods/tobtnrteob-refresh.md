---
title: "ToBtnRteOb.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Button control, when another control changes the data of this contr"
---
...
*Source: `Sudref/methods/SUD_method_Refresh_ToBtnRteOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
