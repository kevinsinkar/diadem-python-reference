---
title: "ToListBoxRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the methods RefreshText and RefreshValue . You can use this method to refresh the ListBo"
---

# ToListBoxRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for ListBox

Triggers the EventRefresh event in user dialog boxes. The method starts the methods RefreshText and RefreshValue . You can use this method to refresh the ListBox control, when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
