---
title: "ToViewConnectorOb.Move"
description: "Moves a control in a user dialog box."
---

# ToViewConnectorOb.Move

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Move for ViewConnector
...
*Source: `Sudref/methods/SUD_method_Move_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
