---
title: "ToColumnsDisp.AddTo"
description: "Adds a new column at a specific position in tables of user dialog boxes. The subsequent columns move up accordingly. Use the Add method to insert the item at th"
---

# ToColumnsDisp.AddTo

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddTo for Columns
...
Adds a new column at a specific position in tables of user dialog boxes. The subsequent columns move up accordingly. Use the Add method to insert the item at the end of the table.

## Signature

```python
return_value = obj.AddTo(Column)
```
...
*Source: `Sudref/methods/SUD_method_AddTo_ToColumnsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
