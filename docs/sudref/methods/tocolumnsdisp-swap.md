---
title: "ToColumnsDisp.Swap"
description: "Swaps the positions of two columns in a user dialog box table. The method modifies only the DisplayedLocation property, not the index for addressing the columns"
---

# ToColumnsDisp.Swap

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Swap for Columns
...
Swaps the positions of two columns in a user dialog box table. The method modifies only the DisplayedLocation property, not the index for addressing the columns.

## Signature

```python
obj.Swap(Column1, Column2)
```
...
*Source: `Sudref/methods/SUD_method_Swap_ToColumnsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
