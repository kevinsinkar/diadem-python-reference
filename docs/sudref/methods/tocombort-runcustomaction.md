...
def Button1_EventClick(ByRef This):
    ...
    ComboBox1.RunCustomAction(sMyAction)
```

```python
def ComboBox1_EventCustomAction(Byref This, VarParam):
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
