---
title: "ToTabPageListFmt.Item"
description: "Returns the Page object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection."
---

# ToTabPageListFmt.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for Pages

Returns the Page object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection.
...
```python
MsgBoxDisp(TabPageCtrl1.Pages.Item(1).Title)
MsgBoxDisp(TabPageCtrl1.Pages(1).Title)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToTabPageListFmt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
