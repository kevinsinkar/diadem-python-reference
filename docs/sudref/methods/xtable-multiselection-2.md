---
title: "XTable.MultiSelection"
description: "Returns a list of the selected terms of a selection list, in extended tables in user dialog boxes."
---

# XTable.MultiSelection

!!! abstract "Method &middot; `Sudref.chm`"
    Method: MultiSelection for ListBox <XTable>

Returns a list of the selected terms of a selection list, in extended tables in user dialog boxes.

## Signature

```python
return_value = obj.MultiSelection()
```
...
```python
for i in range(1, Cell.MultiSelection.Count + 1):
    MsgBoxDisp(Cell.MultiSelection(i).Text)
```
