...
```python
Dialog.Layers(XTable1.LayerName) = TRUE
```

```python
Page1.Layers(XTable2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToVirtGridCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
