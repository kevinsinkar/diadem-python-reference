---
title: "ToSudViewObInt.ExportToPicture"
description: "Creates a graphics file with an image of the user dialog box. The user dialog box should not have scroll bars."
---

# ToSudViewObInt.ExportToPicture

!!! abstract "Method &middot; `Sudref.chm`"
    Method: ExportToPicture for Dialog <NonModal>
...
Creates a graphics file with an image of the user dialog box. The user dialog box should not have scroll bars.

## Signature

```python
obj.ExportToPicture(FileName, PrintNonClient)
```
...
```python
oMyDlg = dd.SudDlgCreate("Analyze","Project1.sud")
oMyDlg.ExportToPicture("C:\Test.jpg", TRUE)
```
...
*Source: `Sudref/methods/SUD_method_ExportToPicture_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
