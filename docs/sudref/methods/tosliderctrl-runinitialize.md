...
```python
def Slider1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    Slider1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
