---
title: "ToSudViewObInt.GetControl"
description: "Returns the user dialog box control associated with a specific name."
---

# ToSudViewObInt.GetControl
...
```python
return_value = obj.GetControl(ObjectCode)
```
...
*Source: `Sudref/methods/SUD_method_GetControl_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
