---
title: "ToCurvePrevCurvesInt.Remove"
description: "Deletes a curve entry from a curve preview in a user dialog box."
---

# ToCurvePrevCurvesInt.Remove

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Remove for Curves
...
Deletes a curve entry from a curve preview in a user dialog box.
...
```python
Curve2DPreview1.Curves.Remove(1)
```
...
*Source: `Sudref/methods/SUD_method_Remove_ToCurvePrevCurvesInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
