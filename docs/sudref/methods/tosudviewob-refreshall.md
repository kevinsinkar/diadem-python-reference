...
# ToSudViewOb.RefreshAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshAll for Dialog
...
*Source: `Sudref/methods/SUD_method_RefreshAll_ToSudViewOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
