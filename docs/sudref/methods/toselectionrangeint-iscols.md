---
title: "ToSelectionRangeInt.iscols"
description: "Specifies in user dialog boxes whether the current selection block in the extended table consists of columns."
---

# ToSelectionRangeInt.iscols

!!! abstract "Method &middot; `Sudref.chm`"
    Method: IsCols for SelectionItem

Specifies in user dialog boxes whether the current selection block in the extended table consists of columns.

## Signature

```python
bIsCols = Object.IsCols()
```
