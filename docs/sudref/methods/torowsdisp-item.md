---
title: "ToRowsDisp.Item"
description: "Returns the Row object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection."
---

# ToRowsDisp.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for Rows
...
Returns the Row object for a specific index in user dialog boxes. The returned object enables you to access the entries in the collection.
...
```python
MsgBoxDisp(Table1.Rows.Item(1).Title)
MsgBoxDisp(Table1.Rows(1).Title)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToRowsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
