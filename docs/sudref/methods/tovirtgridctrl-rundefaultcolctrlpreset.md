---
title: "ToVirtGridCtrl.RunDefaultColCtrlPreset"
description: "Triggers the EventDefaultColCtrlPreSet event for the XTable control in user dialog boxes. You can use this event to configure the controls that are assigned to "
---

# ToVirtGridCtrl.RunDefaultColCtrlPreset
