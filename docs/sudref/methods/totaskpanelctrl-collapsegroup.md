---
title: "ToTaskPanelCtrl.CollapseGroup"
description: "Closes a group in the TaskPanel of a user dialog box."
---

# ToTaskPanelCtrl.CollapseGroup

!!! abstract "Method &middot; `Sudref.chm`"
    Method: CollapseGroup for TaskPanel

Closes a group in the TaskPanel of a user dialog box.

## Signature

```python
obj.CollapseGroup(Key)
```
...
*Source: `Sudref/methods/SUD_method_CollapseGroup_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
