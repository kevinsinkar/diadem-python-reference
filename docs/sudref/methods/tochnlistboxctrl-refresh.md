---
title: "ToChnListBoxCtrl.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the ChnListBox control, whe"
---

# ToChnListBoxCtrl.Refresh
...
*Source: `Sudref/methods/SUD_method_Refresh_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
