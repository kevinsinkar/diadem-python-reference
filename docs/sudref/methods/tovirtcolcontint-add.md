---
title: "ToVirtColContInt.Add"
description: "Adds a column that is type <Default> to an extended table in user dialog boxes. The new column appears at the end of the table."
---

# ToVirtColContInt.Add

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Add for XTableColumns
...
Adds a column that is type <Default> to an extended table in user dialog boxes. The new column appears at the end of the table.

## Signature

```python
return_value = obj.Add(Column)
```

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../../properties/tovirtgridctrl-lockupdate/">LockUpdate</a> property, which suppresses the interim extended table refresh, if you add several columns.</td></tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>You also can use the <a href="../../properties/tovirtcolcontint-count/">Count</a> property to change the number of columns in the extended table.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../tovirtgridctrl-refresh/">Refresh</a> method to refresh the extended table.</td>
</tr>
</table>
</div>
...
```python
oMyColumn = XTable1.Columns.Add("NewCol")
XTable1.Refresh
```
