...
def Button1_EventClick(ByRef This):
    ...
    Text1.RunCustomAction(sMyAction)
```

```python
def Text1_EventCustomAction(ByRef This, VarParam):
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToStaticCtrlRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
