---
title: "ToVirtColContInt.Remove"
description: "Deletes a column from an extended table in a user dialog box. The subsequent columns move up."
---

# ToVirtColContInt.Remove

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Remove for XTableColumns

Deletes a column from an extended table in a user dialog box. The subsequent columns move up.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>Use the <a href="../../properties/tovirtgridctrl-lockupdate/">LockUpdate</a> property, which suppresses the interim extended table refresh, if you delete several columns.</td></tr><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>You also can use the <a href="../../properties/tovirtcolcontint-count/">Count</a> property to change the number of columns in the extended table.</td></tr></table>
</div>
...
```python
XTable1.Columns.Remove(1)
```

```python
XTable1.Columns.Remove("Column1")
```

```python
XTable1.Columns.Count = XTable1.Columns.Count - 3
```
