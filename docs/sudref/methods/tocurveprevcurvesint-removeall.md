---
title: "ToCurvePrevCurvesInt.RemoveAll"
description: "Deletes all curve entries from a curve preview in a user dialog box."
---

# ToCurvePrevCurvesInt.RemoveAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RemoveAll for Curves

Deletes all curve entries from a curve preview in a user dialog box.
...
*Source: `Sudref/methods/SUD_method_RemoveAll_ToCurvePrevCurvesInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
