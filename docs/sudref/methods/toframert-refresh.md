---
title: "ToFrameRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the methods RefreshText and RefreshValue . You can use this method to refresh the Frame "
---

# ToFrameRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for Frame
...
Triggers the EventRefresh event in user dialog boxes. The method starts the methods RefreshText and RefreshValue . You can use this method to refresh the Frame control, when another control changes the data of this control.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToFrameRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
