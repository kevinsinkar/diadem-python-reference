---
title: "ToSpinnerRt.SetRange"
description: "Specifies the value range for the SpinBox control in user dialog boxes."
---

# ToSpinnerRt.SetRange

!!! abstract "Method &middot; `Sudref.chm`"
    Method: SetRange for SpinBox

Specifies the value range for the SpinBox control in user dialog boxes.

## Signature

```python
obj.SetRange(LLimit, ULimit)
```
