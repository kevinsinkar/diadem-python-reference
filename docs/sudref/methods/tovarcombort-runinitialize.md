...
```python
def EnumComboBox1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    EnumComboBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
