---
title: "ToVirtColInt.IsDefault"
description: "Specifies in user dialog boxes whether <Default> type controls are assigned to a column in the extended table. Use the Configure columns dialog box in the dialo"
---

# ToVirtColInt.IsDefault
...
*Source: `Sudref/methods/SUD_method_IsDefault_ToVirtColInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
