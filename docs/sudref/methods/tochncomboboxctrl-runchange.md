---
title: "ToChnComboBoxCtrl.RunChange"
description: "Triggers the EventChange event for a control in user dialog boxes."
---

# ToChnComboBoxCtrl.RunChange

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunChange for ChnComboBox

Triggers the EventChange event for a control in user dialog boxes.
...
```python
def ChnComboBox1_EventChange(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    ChnComboBox1.RunChange
```
...
*Source: `Sudref/methods/SUD_method_RunChange_ToChnComboBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
