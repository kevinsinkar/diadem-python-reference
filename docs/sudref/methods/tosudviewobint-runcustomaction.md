...
oMyDlg.RunCustomAction(sMyAction)
```
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
