...
```python
Dialog.Layers(Picture1.LayerName) = TRUE
```

```python
Page1.Layers(Picture2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
