---
title: "ToSpinnerRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the SpinBox control, when another control changes the data of this cont"
---

# ToSpinnerRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for SpinBox
...
Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the SpinBox control, when another control changes the data of this control.
...
def ComboBox1_EventChange(This):
    SpinBox1.ForeColor = dd.RGB(255, 0, 0)
    SpinBox1.Refresh
```
...
*Source: `Sudref/methods/SUD_method_Refresh_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
