---
title: "XTable.Items"
description: "Returns a collection of all selection terms of a selection list, in extended tables in user dialog boxes."
---

# XTable.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for ListBox <XTable>
...
Returns a collection of all selection terms of a selection list, in extended tables in user dialog boxes.
...
```python
Cell.Items.Add("red",1)
```

```python
MsgBoxDisp(Cell.Items.Count)
```

```python
MsgBoxDisp(Cell.Items(3).InterpretedText)
```
...
*Source: `Sudref/methods/SUD_method_Items_ToListBoxRt_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
