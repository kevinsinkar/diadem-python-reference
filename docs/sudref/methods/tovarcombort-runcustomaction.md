...
def Button1_EventClick(ByRef This):
    ...
    EnumComboBox1.RunCustomAction(sMyAction)
```

```python
def EnumComboBox1_EventCustomAction(ByRef This, VarParam):
...
*Source: `Sudref/methods/SUD_method_RunCustomAction_ToVarComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
