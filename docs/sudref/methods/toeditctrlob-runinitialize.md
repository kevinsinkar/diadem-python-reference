...
```python
def EditBox1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    EditBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToEditCtrlOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
