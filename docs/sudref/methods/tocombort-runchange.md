...
```python
def ComboBox2_EventChange(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunChange_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
