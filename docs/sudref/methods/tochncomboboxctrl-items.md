---
title: "ToChnComboBoxCtrl.Items"
description: "Returns a collection of all selection terms of a ChnComboBox selection list in user dialog boxes."
---

# ToChnComboBoxCtrl.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for ChnComboBox
...
Returns a collection of all selection terms of a ChnComboBox selection list in user dialog boxes.
...
```python
MsgBoxDisp(ChnComboBox1.Items.Count)
```

```python
MsgBoxDisp(ChnComboBox1.Items(3).Text)
```
