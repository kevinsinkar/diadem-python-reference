---
title: "ToChnMulSelListItems.RemoveSelection"
description: "Removes the selection marking of a channel in a channel selection list in user dialog boxes."
---

# ToChnMulSelListItems.RemoveSelection

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RemoveSelection for ChnMultiSelection
...
Removes the selection marking of a channel in a channel selection list in user dialog boxes.

## Signature

```python
obj.RemoveSelection(Index, Range)
```
...
```python
ChnListBox1.MultiSelection.RemoveSelection(1, 0)
```

```python
ChnListBox1.MultiSelection.RemoveSelection(1, 2)
```
...
*Source: `Sudref/methods/SUD_method_RemoveSelection_ToChnMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
