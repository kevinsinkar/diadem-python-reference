...
```python
def Slider1_EventChange(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunChange_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
