---
title: "ToVirtColContInt.Item"
description: "Returns the XTableColumn object for a specific index in user dialog boxes. The returned object provides access to the columns in the extended table."
---

# ToVirtColContInt.Item

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Item for XTableColumns

Returns the XTableColumn object for a specific index in user dialog boxes. The returned object provides access to the columns in the extended table.
...
```python
MsgBoxDisp(XTable1.Columns.Item(1).Name)
MsgBoxDisp(XTable1.Columns(1).Name)
```
...
*Source: `Sudref/methods/SUD_method_Item_ToVirtColContInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
