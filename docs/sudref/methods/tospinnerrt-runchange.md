...
```python
def SpinBox1_EventChange(ByRef This):
    # Do something
...
*Source: `Sudref/methods/SUD_method_RunChange_ToSpinnerRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
