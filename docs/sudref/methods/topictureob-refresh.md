---
title: "ToPictureOb.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Picture control, when another control changes the data of this cont"
---

# ToPictureOb.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for Picture
...
Triggers the EventRefresh event in user dialog boxes. You can use this method to refresh the Picture control, when another control changes the data of this control.
...
def Button1_EventClick(This):
    Picture1.Picture = "c:\temp\example.wmf"
    Picture1.Refresh
```
...
*Source: `Sudref/methods/SUD_method_Refresh_ToPictureOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
