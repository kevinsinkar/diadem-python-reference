---
title: "ToViewConnectorOb.RunActiveAreaChanged"
description: "Triggers the EventActiveAreaChanged event for a control in user dialog boxes."
---

# ToViewConnectorOb.RunActiveAreaChanged

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunActiveAreaChanged for ViewConnector
...
Triggers the EventActiveAreaChanged event for a control in user dialog boxes.

## Signature

```python
obj.RunActiveAreaChanged(bIsActive)
```
...
*Source: `Sudref/methods/SUD_method_RunActiveAreaChanged_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
