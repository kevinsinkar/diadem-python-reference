---
title: "ToViewConnectorOb.RunCursorPosChanged"
description: "Triggers the EventCursorPosChanged event for a control in user dialog boxes."
---

# ToViewConnectorOb.RunCursorPosChanged

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunCursorPosChanged for ViewConnector

Triggers the EventCursorPosChanged event for a control in user dialog boxes.

## Signature

```python
obj.RunCursorPosChanged()
```
...
*Source: `Sudref/methods/SUD_method_RunCursorPosChanged_ToViewConnectorOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
