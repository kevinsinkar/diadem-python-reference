...
```python
Dialog.Layers(Tree1.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
