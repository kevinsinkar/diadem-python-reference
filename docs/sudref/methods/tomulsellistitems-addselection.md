---
title: "ToMulSelListItems.AddSelection"
description: "Adds selection terms to the selected area of a selection list in user dialog boxes."
---

# ToMulSelListItems.AddSelection

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddSelection for MultiSelection
...
Adds selection terms to the selected area of a selection list in user dialog boxes.
...
```python
ListBox1.MultiSelection.AddSelection(1, 3)
```

```python
ListBox1.MultiSelection.AddSelection(1, 2)
ListBox1.MultiSelection.AddSelection(4, 1)
```
...
*Source: `Sudref/methods/SUD_method_AddSelection_ToMulSelListItems.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
