...
```python
Dialog.Layers(ListBox1.LayerName) = TRUE
```

```python
Page1.Layers(ListBox2.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
