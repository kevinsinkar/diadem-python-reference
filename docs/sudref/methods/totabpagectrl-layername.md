...
```python
Dialog.Layers(TabPageCtrl1.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_ToTabPageCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
