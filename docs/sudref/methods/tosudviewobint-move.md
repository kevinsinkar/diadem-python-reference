---
title: "ToSudViewObInt.Move"
description: "Moves a user dialog box."
---

# ToSudViewObInt.Move

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Move for Dialog <NonModal>

Moves a user dialog box.
...
*Source: `Sudref/methods/SUD_method_Move_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
