---
title: "ToVirtGridCtrl.RefreshCols"
description: "Refreshes one or more columns of an extended table in user dialog boxes. The refresh triggers the EventValGet event for the visible columns in the table."
---

# ToVirtGridCtrl.RefreshCols

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RefreshCols for XTable
...
Refreshes one or more columns of an extended table in user dialog boxes. The refresh triggers the EventValGet event for the visible columns in the table.

## Signature

```python
obj.RefreshCols(FromCol, ToCol)
```
