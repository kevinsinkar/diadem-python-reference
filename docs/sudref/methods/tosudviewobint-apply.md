---
title: "ToSudViewObInt.Apply"
description: "Transfers the modified values of the DIAdem variables defined in the user dialog box immediately to DIAdem. The method has the same effect as clicking a button "
---

# ToSudViewObInt.Apply

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Apply for Dialog <NonModal>

Transfers the modified values of the DIAdem variables defined in the user dialog box immediately to DIAdem. The method has the same effect as clicking a button that has the value Apply for the ButtonType property.
...
<td><strong>Note  </strong>This method is only available to keep DIAdem compatible with previous versions. Do not use this method.</td>
</tr>
<tr>
<td class="Icon"><img src="../image/note.gif"/></td>
<td><strong>Note</strong>  Click <strong>Edit»Variables</strong> and select the <strong>Restore when canceled</strong> property for the DIAdem variables defined in the user dialog box, so you can restore the original values after you click Cancel, or after you call the  <span class="Monospace">Apply</span> method.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/methods/SUD_method_Apply_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
