---
title: "ToTaskPanelCtrl.SetItemText"
description: "Specifies in the TaslPanel of a user dialog box the text of an entry. Use this method to change the text of an entry. The entry can also be a group."
---

# ToTaskPanelCtrl.SetItemText

!!! abstract "Method &middot; `Sudref.chm`"
    Method: SetItemText for TaskPanel

Specifies in the TaslPanel of a user dialog box the text of an entry. Use this method to change the text of an entry. The entry can also be a group.

## Signature

```python
obj.SetItemText(Key, Text)
```
...
def Button1_EventClick(This):
    TaskPanel1.SetItemText("version","Version 2.0")
...
*Source: `Sudref/methods/SUD_method_SetItemText_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
