---
title: "ToSelectionRangeInt.isrows"
description: "Specifies in user dialog boxes whether the current selection block in the extended table consists of rows."
---

# ToSelectionRangeInt.isrows

!!! abstract "Method &middot; `Sudref.chm`"
    Method: IsRows for SelectionItem
...
Specifies in user dialog boxes whether the current selection block in the extended table consists of rows.

## Signature

```python
bIsRows = Object.IsRows()
```
