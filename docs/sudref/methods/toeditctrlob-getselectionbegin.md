---
title: "ToEditCtrlOb.GetSelectionBegin"
description: "Returns in in user dialog boxes the position at which the selection in the entry field begins. If no text is selected, the method returns the value 1 ."
---

# ToEditCtrlOb.GetSelectionBegin

!!! abstract "Method &middot; `Sudref.chm`"
    Method: GetSelectionBegin for EditBox

Returns in in user dialog boxes the position at which the selection in the entry field begins. If no text is selected, the method returns the value 1 .
...
sOutPut = sOutPut + "Selected text: " + EditBox1.GetSelectedText + VBCrLf
sOutPut = sOutPut + "Selection begin: " + EditBox1.GetSelectionBegin + VBCrLf
sOutPut = sOutPut + "Selection end: " + EditBox1.GetSelectionEnd + VBCrLf
Text1.Text = sOutPut
Text1.RefreshText
```
...
*Source: `Sudref/methods/SUD_method_GetSelectionBegin_ToEditCtrlOb.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
