---
title: "ToRadioRt.Text"
description: "Returns the term selected for a radio button in user dialog boxes."
---

# ToRadioRt.Text

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Text for RadioButton

Returns the term selected for a radio button in user dialog boxes.
...
*Source: `Sudref/methods/SUD_method_Text_ToRadioRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
