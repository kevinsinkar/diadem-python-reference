---
title: "ToSudViewObInt.RunTerminate"
description: "Triggers the EventTerminate event for a user dialog box."
---

# ToSudViewObInt.RunTerminate

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RunTerminate for Dialog <NonModal>
...
Triggers the EventTerminate event for a user dialog box.
...
*Source: `Sudref/methods/SUD_method_RunTerminate_ToSudViewObInt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
