---
title: "ToSudViewOb.SetArgument"
description: "This method is obsolete. Use an a user-defined class instead. An example for using a class is shown in the GetArgument method."
---

# ToSudViewOb.SetArgument
