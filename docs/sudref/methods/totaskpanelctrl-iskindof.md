---
title: "ToTaskPanelCtrl.IsKindOf"
description: "Checks whether an entry in the TaskPanel of a user dialog box is a specific type."
---

# ToTaskPanelCtrl.IsKindOf

!!! abstract "Method &middot; `Sudref.chm`"
    Method: IsKindOf for TaskPanel
...
Checks whether an entry in the TaskPanel of a user dialog box is a specific type.

## Signature

```python
bIsKindOf = Object.IsKindOf(Key, Type)
```
...
| --- | ---: | --- |
| `eTaskPanelItemGroup` | 0 | Group |
| `eTaskPanelItemLink` | 1 | Text which can be connected to an action. |
| `eTaskPanelItemText` | 2 | Text which cannot be connected to an action. |
...
*Source: `Sudref/methods/SUD_method_IsKindOf_ToTaskPanelCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
