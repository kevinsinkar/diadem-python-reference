...
```python
def ChnListBox1_EventInitialize(ByRef This):
    # Do something
def ComboBox1_EventChange(ByRef This):
    ChnListBox1.RunInitialize
```
...
*Source: `Sudref/methods/SUD_method_RunInitialize_ToChnListBoxCtrl.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
