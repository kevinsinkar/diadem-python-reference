---
title: "ToTreeNodeListInt.RemoveAll"
description: "Deletes in user dialog boxes all nodes of a branch in a tree."
---

# ToTreeNodeListInt.RemoveAll

!!! abstract "Method &middot; `Sudref.chm`"
    Method: RemoveAll for TreeNodes

Deletes in user dialog boxes all nodes of a branch in a tree.
...
*Source: `Sudref/methods/SUD_method_RemoveAll_ToTreeNodeListInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
