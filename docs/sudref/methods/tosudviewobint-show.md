---
title: "ToSudViewObInt.Show"
description: "Shows the user dialog box previously hidden with the Hide method or created with the SudDlgCreate command."
---

# ToSudViewObInt.Show

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Show for Dialog <NonModal>
...
Shows the user dialog box previously hidden with the Hide method or created with the SudDlgCreate command.
...
```python
oMyDlg = dd.SudDlgCreate("Dlg1","Example.sud")
oMyDlg.Show
```
