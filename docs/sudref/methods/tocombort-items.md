---
title: "ToComboRt.Items"
description: "Returns a collection of all selection terms of a ComboBox selection list in user dialog boxes."
---

# ToComboRt.Items

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Items for ComboBox
...
Returns a collection of all selection terms of a ComboBox selection list in user dialog boxes.
...
```python
ComboBox1.Items.Add("red ",1)
```

```python
MsgBoxDisp(ComboBox1.Items.Count)
```

```python
MsgBoxDisp(ComboBox1.Items(3).InterpretedText)
```
...
*Source: `Sudref/methods/SUD_method_Items_ToComboRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
