---
title: "ToVarListBoxRt.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the EnumListBox control, wh"
---

# ToVarListBoxRt.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for EnumListBox

Triggers the EventRefresh event in user dialog boxes. The method starts the method RefreshValue . You can use this method to refresh the EnumListBox control, when another control changes the data of this control.
...
def ComboBox1_EventChange(Byref This):
    EnumListBox1.Value = 2
    EnumListBox1.Refresh
```
...
*Source: `Sudref/methods/SUD_method_Refresh_ToVarListBoxRt.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
