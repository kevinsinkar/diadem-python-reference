---
title: "ToVirtSelectionInt.AddCols"
description: "Selects the specified columns of an extended table in user dialog boxes. If multiple selection is possible in the extended table, this method adds the specified"
---

# ToVirtSelectionInt.AddCols

!!! abstract "Method &middot; `Sudref.chm`"
    Method: AddCols for Selection
...
Selects the specified columns of an extended table in user dialog boxes. If multiple selection is possible in the extended table, this method adds the specified columns to the columns that are already selected.

## Signature

```python
obj.AddCols(FromCol, ToCol)
```
...
```python
XTable1.SelectedElements.RemoveAll
XTable1.SelectedElements.AddCols(2,3)
XTable1.Refresh()
```
