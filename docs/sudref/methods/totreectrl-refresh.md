---
title: "ToTreeCtrl.Refresh"
description: "Triggers the EventRefresh event in user dialog boxes. You can use this method to completely remap the tree, for example, after you create, delete, or change nod"
---

# ToTreeCtrl.Refresh

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Refresh for Tree

Triggers the EventRefresh event in user dialog boxes. You can use this method to completely remap the tree, for example, after you create, delete, or change nodes. Use the Update method to refresh an individual node or a node with subnodes.
...
*Source: `Sudref/methods/SUD_method_Refresh_ToTreeCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
