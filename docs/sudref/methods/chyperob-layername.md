...
```python
oMyCtrl = Dialog.GetControl("EditBox1")
Dialog.Layers(oMyCtrl.LayerName) = TRUE
```
...
*Source: `Sudref/methods/SUD_method_LayerName_CHyperOb.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
