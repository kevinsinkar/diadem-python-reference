---
title: "ToColumnsDisp.Move"
description: "Moves a table column in a user dialog box."
---

# ToColumnsDisp.Move

!!! abstract "Method &middot; `Sudref.chm`"
    Method: Move for Columns

Moves a table column in a user dialog box.
...
*Source: `Sudref/methods/SUD_method_Move_ToColumnsDisp.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
