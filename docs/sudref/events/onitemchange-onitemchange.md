---
title: "onitemchange.OnItemChange"
description: "Triggers in user dialog boxes after the contents of a table cell are edited and you leave the cell."
---
...
Triggers in user dialog boxes after the contents of a table cell are edited and you leave the cell.

## Signature

```python
dd.OnItemChange(ByRef This, Row, Col)
```
...
*Source: `Sudref/events/sud_event_onitemchange.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
