---
title: "EventMouseDown.EventMouseDown"
description: "Triggers when the left mouse button or the right mouse button is pressed in user dialog boxes."
---
...
Triggers when the left mouse button or the right mouse button is pressed in user dialog boxes.

## Signature

```python
dd.EventMouseDown(ByRef This, Button, Shift, X, Y)
```
...
*Source: `Sudref/events/sud_event_EventMouseDown.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
