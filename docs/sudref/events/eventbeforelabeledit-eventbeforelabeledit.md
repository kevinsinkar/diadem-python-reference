---
title: "EventBeforeLabelEdit.EventBeforeLabelEdit"
description: "Is triggered in user dialog boxes before the text of an element selected in the tree is edited. To edit a selected text, click the text again or press F2. If yo"
---

# EventBeforeLabelEdit.EventBeforeLabelEdit

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventBeforeLabelEdit for Tree

Is triggered in user dialog boxes before the text of an element selected in the tree is edited. To edit a selected text, click the text again or press F2. If you set the Cancel parameter to True in the event, DIAdem does not allow the edit process.
...
*Source: `Sudref/events/sud_event_EventBeforeLabelEdit.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
