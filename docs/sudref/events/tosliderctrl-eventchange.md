---
title: "ToSliderCtrl.eventchange"
description: "Triggers in user dialog boxes when moving the slider in the Slider control, or when calling the RunChange method. Following the"
---

# ToSliderCtrl.eventchange

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventChange for Slider

Triggers in user dialog boxes when moving the slider in the Slider control, or when calling the RunChange method. Following the

## Signature

```python
dd.EventChange(ByRef This, ThumbTracking)
```
...
def Slider1_EventChange(This, ThumbTracking):
    if ThumbTracking:
        ...
        This.ToolTipText = "Final value " + This.Value
```
...
*Source: `Sudref/events/sud_event_eventchange_ToSliderCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
