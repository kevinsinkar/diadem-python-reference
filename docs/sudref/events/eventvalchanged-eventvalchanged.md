---
title: "EventValChanged.EventValChanged"
description: "Triggers in user dialog boxes when a value or a text of a cell in the extended table changes."
---

# EventValChanged.EventValChanged
...
```python
dd.EventValChanged(ByRef This, Row, Col, ByRef Cell)
```
...
*Source: `Sudref/events/sud_event_EventValChanged.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
