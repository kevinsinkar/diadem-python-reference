---
title: "eventcursormodechanged.EventCursorModeChanged"
description: "Is triggered in user dialog boxes if the cursor is switched or if the RunCursorModeChanged method is called. You can switch between free cursor, maximum cursor,"
---

# eventcursormodechanged.EventCursorModeChanged

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventCursorModeChanged for ViewConnector
...
Is triggered in user dialog boxes if the cursor is switched or if the RunCursorModeChanged method is called. You can switch between free cursor, maximum cursor, and minimum cursor.

## Signature

```python
dd.EventCursorModeChanged(ByRef This)
```
...
*Source: `Sudref/events/sud_event_eventcursormodechanged.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
