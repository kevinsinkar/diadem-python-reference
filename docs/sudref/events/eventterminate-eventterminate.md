---
title: "EventTerminate.EventTerminate"
description: "Triggers when a user dialog box is closed or when the RunTerminate method, the Ok method, or the Cancel method is called. Use the EventQueryClose event to eithe"
---
...
*Source: `Sudref/events/sud_event_EventTerminate.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
