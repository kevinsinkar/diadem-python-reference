---
title: "eventchange.EventChange"
description: "Triggers in user dialog boxes when the value or the text of a control changes or when the RunChange method is called."
---
...
Triggers in user dialog boxes when the value or the text of a control changes or when the RunChange method is called.

## Signature

```python
dd.EventChange(ByRef This)
```
...
<td><strong>Note  </strong>This event does not trigger until the value or the text of the control actually changes.</td>
</tr>
</table>
</div>
...
*Source: `Sudref/events/sud_event_eventchange.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
