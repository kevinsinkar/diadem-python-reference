...
```python
dd.EventContextMenuPointSelected(ByRef This, Row, Col, MenuPoint)
```
...
*Source: `Sudref/events/sud_event_EventContextMenuPointSelected_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
