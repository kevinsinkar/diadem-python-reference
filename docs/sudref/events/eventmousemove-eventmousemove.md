---
title: "EventMouseMove.EventMouseMove"
description: "Triggers in user dialog boxes when you move the mouse. Use the event to request which key is pressed or to request a mouse position."
---
...
Triggers in user dialog boxes when you move the mouse. Use the event to request which key is pressed or to request a mouse position.

## Signature

```python
dd.EventMouseMove(ByRef This, Button, Shift, X, Y)
```
...
*Source: `Sudref/events/sud_event_EventMouseMove.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
