---
title: "onselchange.OnSelChange"
description: "Triggers in user dialog boxes when the selection in a table changes."
---
...
Triggers in user dialog boxes when the selection in a table changes.

## Signature

```python
dd.OnSelChange(ByRef This)
```
...
*Source: `Sudref/events/sud_event_onselchange.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
