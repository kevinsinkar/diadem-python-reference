---
title: "eventviewrefreshed.EventViewRefreshed"
description: "Is triggered in user dialog boxes if DIAdem VIEW is refreshed with <F5> or if the methods  View. Refresh or RunViewRefreshed are called."
---

# eventviewrefreshed.EventViewRefreshed

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventViewRefreshed for ViewConnector

Is triggered in user dialog boxes if DIAdem VIEW is refreshed with <F5> or if the methods  View. Refresh or RunViewRefreshed are called.

## Signature

```python
dd.EventViewRefreshed(ByRef This)
```
...
*Source: `Sudref/events/sud_event_eventviewrefreshed.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
