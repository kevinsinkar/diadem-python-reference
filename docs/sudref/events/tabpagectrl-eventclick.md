---
title: "TabPageCtrl.EventClick"
description: "Triggers in user dialog boxes when a tab of the TabPageCtrl control is clicked, or when the RunClick method is called."
---

# TabPageCtrl.EventClick

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventClick for Page

Triggers in user dialog boxes when a tab of the TabPageCtrl control is clicked, or when the RunClick method is called.

## Signature

```python
dd.EventClick(ByRef This)
```
...
*Source: `Sudref/events/sud_event_EventClick_TabPageCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
