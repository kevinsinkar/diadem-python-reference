---
title: "TabPageCtrl.EventRefresh"
description: "The RefreshAll method triggers this event in the TabPageCtrl control, and the methods Refresh and RefreshAll trigger this event in tabs, to refresh the texts an"
---

# TabPageCtrl.EventRefresh

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventRefresh for Page and TabPageCtrl

The RefreshAll method triggers this event in the TabPageCtrl control, and the methods Refresh and RefreshAll trigger this event in tabs, to refresh the texts and values of all the controls. The user dialog box also triggers this event for the controls during initialization.

## Signature

```python
dd.EventRefresh(ByRef This)
```
