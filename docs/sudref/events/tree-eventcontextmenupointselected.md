---
title: "Tree.EventContextMenuPointSelected"
description: "Is triggered in user dialog box when an item from the context menu is selected."
---

# Tree.EventContextMenuPointSelected

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventContextMenuPointSelected for Tree
...
```python
dd.EventContextMenuPointSelected(ByRef This, ByRef Node, MenuPoint)
```
...
*Source: `Sudref/events/sud_event_EventContextMenuPointSelected_Tree.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
