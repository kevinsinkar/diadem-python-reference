---
title: "EventMouseUp.EventMouseUp"
description: "Triggers in user dialog boxes when the left mouse button or the right mouse button is released."
---
...
Triggers in user dialog boxes when the left mouse button or the right mouse button is released.

## Signature

```python
dd.EventMouseUp(ByRef This, Button, Shift, X, Y)
```
...
*Source: `Sudref/events/sud_event_EventMouseUp.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
