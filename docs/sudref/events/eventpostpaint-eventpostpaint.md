---
title: "eventpostpaint.EventPostPaint"
description: "Is triggered in user dialog boxes after the curve preview is refreshed."
---

# eventpostpaint.EventPostPaint

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventPostPaint
...
Is triggered in user dialog boxes after the curve preview is refreshed.

## Signature

```python
dd.EventPostPaint(ByRef This)
```
...
<tr>
<td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>If the event definition contains an error, DIAdem aborts the user dialog box without an error message. The error is described in the logfile.</td>
</tr>
</table>
</div>
