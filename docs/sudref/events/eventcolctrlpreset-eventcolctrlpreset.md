---
title: "EventColCtrlPreset.EventColCtrlPreSet"
description: "Triggers when the user dialog box opens or when the RunColCtrlPreSet method is used in the user dialog box. You can use this event to configure the controls tha"
---

# EventColCtrlPreset.EventColCtrlPreSet

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventColCtrlPreSet for XTable
...
*Source: `Sudref/events/sud_event_EventColCtrlPreset.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
