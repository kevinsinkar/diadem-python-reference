---
title: "EventNodeCollapse.EventNodeCollapse"
description: "Is triggered in user dialog boxes when a branch in the tree  collapses interactively. The Expanded property has the value False when the event occurs. If you se"
---

# EventNodeCollapse.EventNodeCollapse
...
```python
dd.EventNodeCollapse(ByRef This, ByRef Node)
```
...
def Tree1_EventNodeCollapse(ByRef This, ByRef Node):
    Node.Expanded = True
...
*Source: `Sudref/events/sud_event_EventNodeCollapse.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
