---
title: "eventplaystatuschanged.EventPlayStatusChanged"
description: "Is triggered in user dialog boxes if the functions Start , Repeat Play, or Pause are enabled in DIAdem VIEW or if the RunPlayStatusChanged method is called."
---

# eventplaystatuschanged.EventPlayStatusChanged

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventPlayStatusChanged for ViewConnector

Is triggered in user dialog boxes if the functions Start , Repeat Play, or Pause are enabled in DIAdem VIEW or if the RunPlayStatusChanged method is called.

## Signature

```python
dd.EventPlayStatusChanged(ByRef This, bStartPlaying)
```
...
*Source: `Sudref/events/sud_event_eventplaystatuschanged.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
