---
title: "XTable.EventContextMenuShowing"
description: "Is triggered in user dialog boxes by a right-click before the context menu displays."
---

# XTable.EventContextMenuShowing

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventContextMenuShowing for XTable
...
Is triggered in user dialog boxes by a right-click before the context menu displays.

## Signature

```python
dd.EventContextMenuShowing(ByRef This, Row, Col, MenuPoints)
```
...
*Source: `Sudref/events/sud_event_EventContextMenuShowing_XTable.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
