---
title: "tree.eventdrop"
description: "Is triggered when you drag and drop an element from the Data Portal onto the tree and you release the left mouse button. The event can only be triggered if Drop"
---

# tree.eventdrop

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventDrop for Tree

Is triggered when you drag and drop an element from the Data Portal onto the tree and you release the left mouse button. The event can only be triggered if Dropping is permitted.

## Signature

```python
dd.EventDrop(ByRef This, DropInformation, ByRef DropEffect, ByRef Node)
```
...
*Source: `Sudref/events/sud_event_eventdrop_tree.htm`*
