---
title: "TabPageCtrl.EventMouseUp"
description: "Triggers in user dialog boxes when the left mouse button or the right mouse button is released in a tab of the TabPageCtrl control."
---

# TabPageCtrl.EventMouseUp

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventMouseUp for TabPageCtrl
...
Triggers in user dialog boxes when the left mouse button or the right mouse button is released in a tab of the TabPageCtrl control.

## Signature

```python
dd.EventMouseUp(ByRef This, Index, Button, Shift, X, Y)
```
...
*Source: `Sudref/events/sud_event_EventMouseUp_TabPageCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
