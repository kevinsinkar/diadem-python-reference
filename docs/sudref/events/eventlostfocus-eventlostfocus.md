---
title: "EventLostFocus.EventLostFocus"
description: "Triggers in user dialog boxes if a control looses the focus due to a mouse click or because <Tab> was pressed. You can use this event to respond to the current "
---

# EventLostFocus.EventLostFocus
...
*Source: `Sudref/events/sud_event_EventLostFocus.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
