---
title: "EventClpCopy.EventClpCopy"
description: "Triggers in user dialog boxes when <Ctrl-C> is pressed in the extended table."
---

# EventClpCopy.EventClpCopy
...
*Source: `Sudref/events/sud_event_EventClpCopy.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
