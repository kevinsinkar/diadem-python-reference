---
title: "eventactiveareachanged.EventActiveAreaChanged"
description: "Is triggered in user dialog boxes if a different area is enabled in DIAdem VIEW or if the RunActiveAreaChanged method is called."
---

# eventactiveareachanged.EventActiveAreaChanged

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventActiveAreaChanged for ViewConnector

Is triggered in user dialog boxes if a different area is enabled in DIAdem VIEW or if the RunActiveAreaChanged method is called.

## Signature

```python
dd.EventActiveaAreaChanged(ByRef This, bIsActive)
```
...
*Source: `Sudref/events/sud_event_eventactiveareachanged.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
