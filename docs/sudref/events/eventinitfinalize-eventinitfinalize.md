---
title: "eventinitfinalize.EventInitFinalize"
description: "Triggers in user dialog boxes after the dialog box and the associated controls are initialized."
---

# eventinitfinalize.EventInitFinalize

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventInitFinalize for Dialog

Triggers in user dialog boxes after the dialog box and the associated controls are initialized.

## Signature

```python
dd.EventInitFinalize(ByRef This)
```
...
*Source: `Sudref/events/sud_event_eventinitfinalize.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
