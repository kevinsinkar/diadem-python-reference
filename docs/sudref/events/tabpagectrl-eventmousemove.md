---
title: "TabPageCtrl.EventMouseMove"
description: "Triggers in user dialog boxes when the mouse idles on the TabPageCtrl control."
---

# TabPageCtrl.EventMouseMove

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventMouseMove for TabPageCtrl
...
Triggers in user dialog boxes when the mouse idles on the TabPageCtrl control.

## Signature

```python
dd.EventMouseMove(ByRef This, Index, Button, Shift, X, Y)
```
...
*Source: `Sudref/events/sud_event_EventMouseMove_TabPageCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
