---
title: "EventValSet.EventValSet"
description: "Triggers in user dialog boxes to save the value of a cell of the extended table."
---

# EventValSet.EventValSet
...
```python
dd.EventValSet(ByRef This, Row, Col, ByRef Cell)
```
...
*Source: `Sudref/events/sud_event_EventValSet.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
