---
title: "TabPageCtrl.Eventinitialize"
description: "Triggers in user dialog boxes if the TabPageCtrl control initializes when the dialog box opens, or if one of the tabs initializes, or when the RunInitialize met"
---

# TabPageCtrl.Eventinitialize

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventInitialize for Page and TabPageCtrl

Triggers in user dialog boxes if the TabPageCtrl control initializes when the dialog box opens, or if one of the tabs initializes, or when the RunInitialize method is called.
...
<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>When the event is called, the control is already initialized and has already read the variable value if a variable is involved.</td></tr></table>
</div>
