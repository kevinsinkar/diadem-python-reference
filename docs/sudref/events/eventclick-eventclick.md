---
title: "EventClick.EventClick"
description: "Triggers when a click is performed in user dialog boxes or when the RunClick method is called."
---
...
Triggers when a click is performed in user dialog boxes or when the RunClick method is called.
...
*Source: `Sudref/events/sud_event_EventClick.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
