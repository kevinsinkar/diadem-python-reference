---
title: "EventDblClick.EventDblClick"
description: "Triggers when a double-click is performed in user dialog boxes."
---
...
Triggers when a double-click is performed in user dialog boxes.

## Signature

```python
dd.EventDblClick(ByRef This)
```
...
*Source: `Sudref/events/sud_event_EventDblClick.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
