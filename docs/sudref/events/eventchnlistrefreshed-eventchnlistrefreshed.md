---
title: "eventchnlistrefreshed.EventChnListRefreshed"
description: "Triggers in user dialog boxes when the Data Portal refreshes, if you assign the value 1 to the DataRefreshActive property."
---

# eventchnlistrefreshed.EventChnListRefreshed

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventChnListRefreshed
...
Triggers in user dialog boxes when the Data Portal refreshes, if you assign the value 1 to the DataRefreshActive property.

## Signature

```python
dd.EventChnListRefreshed(ByRef This)
```

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="../image/note.gif"/></td><td><strong>Note  </strong>The <a href="../../../varoff/variables/uiautorefresh/">UIAutoRefresh</a> setting specifies whether DIAdem informs the Data Portal about changes to the channel contents.</td></tr></table>
</div>
...
*Source: `Sudref/events/sud_event_eventchnlistrefreshed.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
