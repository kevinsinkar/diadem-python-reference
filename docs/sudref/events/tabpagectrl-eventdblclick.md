---
title: "tabPageCtrl.EventDblClick"
description: "Triggers when the TabPageCtrl control is double-clicked in user dialog boxes."
---

# tabPageCtrl.EventDblClick

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventDblClick for TabPageCtrl

Triggers when the TabPageCtrl control is double-clicked in user dialog boxes.

## Signature

```python
dd.EventDblClick(ByRef This, Index)
```
...
*Source: `Sudref/events/sud_event_EventDblClick_tabPageCtrl.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
