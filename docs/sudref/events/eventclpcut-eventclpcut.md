---
title: "EventClpCut.EventClpCut"
description: "Triggers in user dialog boxes when <Ctrl-X> is pressed in the extended table."
---

# EventClpCut.EventClpCut

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventClpCut for XTable

Triggers in user dialog boxes when <Ctrl-X> is pressed in the extended table.

## Signature

```python
dd.EventClpCut(ByRef This)
```
...
*Source: `Sudref/events/sud_event_EventClpCut.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
