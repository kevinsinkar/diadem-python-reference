---
title: "EventNodeClick.EventNodeClick"
description: "The following example creates a tree. If you click a node, the example displays the entry you clicked:"
---

# EventNodeClick.EventNodeClick

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventNodeClick for Tree
...
The following example creates a tree. If you click a node, the example displays the entry you clicked:

## Signature

```python
dd.EventNodeClick(ByRef This, ByRef Node)
```
...
*Source: `Sudref/events/sud_event_EventNodeClick.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
