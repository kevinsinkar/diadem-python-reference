---
title: "EventCustomAction.EventCustomAction"
description: "Triggers in user dialog boxes when the methods RunCustomAction or RunCustomActionAll are called. You can use this event anywhere, for any purpose."
---

# EventCustomAction.EventCustomAction

!!! abstract "Event &middot; `Sudref.chm`"
    Event: EventCustomAction
...
Triggers in user dialog boxes when the methods RunCustomAction or RunCustomActionAll are called. You can use this event anywhere, for any purpose.

## Signature

```python
dd.EventCustomAction(ByRef This, VarParam)
```
...
*Source: `Sudref/events/sud_event_EventCustomAction.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
