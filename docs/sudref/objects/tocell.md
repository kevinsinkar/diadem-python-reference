---
title: "ToCell"
description: "The Cell object corresponds to a cell of a table in user dialog boxes."
---
...
```python
for i in range(1, Table1.SelectedCells.Count + 1):
    MsgBoxDisp(i + ", " + Table1.SelectedCells.Item(i).Value)
```
...
<p><a href="../../properties/tocell-column/">Column</a> | <a href="../../properties/tocell-row/">Row</a> | <a href="../../properties/tocell-value/">Value</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../tocolumn/">Column</a>.<a href="../../properties/tocolumn-cells/">Cells</a> | <a href="../torow/">Row</a>.<a href="../../properties/torow-cells/">Cells</a> | <a href="../../collections/selectedcells/">SelectedCells</a>.<a href="../../methods/toselectedcells-add/">Add</a> | <a href="../../collections/selectedcells/">SelectedCells</a>.<a href="../../methods/toselectedcells-item/">Item</a> | <a href="../totablectrl/">Table</a>.<a href="../../properties/totablectrl-cells/">Cells</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_ToCell.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
