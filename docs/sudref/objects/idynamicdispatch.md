---
title: "IDynamicDispatch"
description: "The IDynamicDispatch object corresponds with an ActiveX object. Refer to the ActiveX documentation for a description of the individual controls and the associat"
---

# IDynamicDispatch

!!! abstract "Object &middot; `Sudref.chm`"
    Object: IDynamicDispatch

The IDynamicDispatch object corresponds with an ActiveX object. Refer to the ActiveX documentation for a description of the individual controls and the associated methods and properties.
...
<h2>Returned From</h2>
<p><a href="../togenericocx/">ActiveX</a>.<a href="../../methods/togenericocx-x/">X</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_IDynamicDispatch.htm`*
