---
title: "ToChnMulSelListItem"
description: "The ChnListItem object corresponds to a selected term of a channel selection list for multiple selection, in user dialog boxes."
---
...
The ChnListItem object corresponds to a selected term of a channel selection list for multiple selection, in user dialog boxes.
...
for i in range(1, ChnListBox1.MultiSelection.Count + 1):
    MsgBoxDisp(ChnListBox1.MultiSelection.Item(i).Text)
```
...
<p><a href="../../properties/tochnmulsellistitem-index/">Index</a> | <a href="../../properties/tochnmulsellistitem-text/">Text</a> | <a href="../../properties/tochnmulsellistitem-value/">Value</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../collections/chnmultiselection/">ChnMultiSelection</a>.<a href="../../methods/tochnmulsellistitems-item/">Item</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_ToChnMulSelListItem.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
