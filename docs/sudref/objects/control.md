---
title: "Control"
description: "The Control object corresponds to a control in an extended table. A control in an extended table is one of the following types Button <XTable> , CheckBox <XTabl"
---

# Control

!!! abstract "Object &middot; `Sudref.chm`"
    Object: Control <XTable>

The Control object corresponds to a control in an extended table. A control in an extended table is one of the following types Button <XTable> , CheckBox <XTable> , ChnComboBox <XTable> , ChnListBox <XTable> , ComboBox <XTable> , EditBox <XTable> , ListBox <XTable> , or Text <XTable> . Note You only can access these controls within the event procedures of the extended table.
...
<td><strong>Note</strong>  You only can access these controls within the event procedures of the extended table.</td>
</tr>
</table>
</div>
...
<h2>Properties</h2>
<p><a href="../../properties/xtable-objecttype/">ObjectType</a> | <a href="../../properties/xtable-tag/">Tag</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_CHyperOb_XTable.htm`*
