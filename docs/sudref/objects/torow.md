---
title: "ToRow"
description: "The Row object corresponds to a row of a table in user dialog boxes."
---
...
for i in range(1, Table1.Rows.Count + 1):
    MsgBoxDisp(i + ", " + Table1.Rows.Item(i).Title)
```
...
<p><a href="../../properties/torow-cells/">Cells</a> | <a href="../../properties/torow-displayedlocation/">DisplayedLocation</a> | <a href="../../properties/torow-title/">Title</a> | <a href="../../properties/torow-width/">Width</a></p>
</div>
<div class="ReturnFrom"><h2>Returned From</h2>
<p><a href="../../collections/rows/">Rows</a>.<a href="../../methods/torowsdisp-add/">Add</a> | <a href="../../collections/rows/">Rows</a>.<a href="../../methods/torowsdisp-addto/">AddTo</a> | <a href="../../collections/rows/">Rows</a>.<a href="../../methods/torowsdisp-item/">Item</a></p>
</div>
</div>
...
*Source: `Sudref/objects/SUD_Objects_ToRow.HTM`&nbsp;&middot;&nbsp;Python translated from VBS*
