---
title: "IUnitSet.DisplayName"
description: "Returns the display name of a unit set in the units catalog. The display name is the name that DIAdem displays on the user interface of the units catalog."
---

# IUnitSet.DisplayName

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: DisplayName for Set

Returns the display name of a unit set in the units catalog. The display name is the name that DIAdem displays on the user interface of the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets("si_units").DisplayName)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_DisplayName_IUnitSet.htm`*
