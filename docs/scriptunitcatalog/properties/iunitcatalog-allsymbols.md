---
title: "IUnitCatalog.AllSymbols"
description: "Returns all the defined symbols of the units catalog."
---

# IUnitCatalog.AllSymbols

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: AllSymbols for UnitCatalog

Returns all the defined symbols of the units catalog.

## Signature

```python
return_value = obj.AllSymbols
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_AllSymbols_IUnitCatalog.htm`*
