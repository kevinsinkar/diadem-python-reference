---
title: "IPhysicalUnitCollection.Count"
description: "Returns the number of all defined symbols in the units catalog."
---

# IPhysicalUnitCollection.Count

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Count for Units

Returns the number of all defined symbols in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.AllSymbols.Count)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Count_IPhysicalUnitCollection.htm`*
