---
title: "IPhysicalQuantity.CurrentExp"
description: "Returns the exponent of the current intensity for a physical quantity in the units catalog."
---

# IPhysicalQuantity.CurrentExp

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: CurrentExp for Quantity

Returns the exponent of the current intensity for a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("permittivity").CurrentExp)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_CurrentExp_IPhysicalQuantity.htm`*
