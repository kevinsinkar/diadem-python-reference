---
title: "IPhysicalQuantity.DisplayName"
description: "Returns the display name of a physical quantity in the units catalog. The display name is the name that DIAdem displays on the user interface of the units catal"
---

# IPhysicalQuantity.DisplayName

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: DisplayName for Quantity

Returns the display name of a physical quantity in the units catalog. The display name is the name that DIAdem displays on the user interface of the units catalog.
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_DisplayName_IPhysicalQuantity.htm`*
