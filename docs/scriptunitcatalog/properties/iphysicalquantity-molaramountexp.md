---
title: "IPhysicalQuantity.MolarAmountExp"
description: "Returns the exponent of the molar amount of substance for a physical quantity in the units catalog."
---

# IPhysicalQuantity.MolarAmountExp

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: MolarAmountExp for Quantity

Returns the exponent of the molar amount of substance for a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("amount_of_substance").MolarAmountExp)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_MolarAmountExp_IPhysicalQuantity.htm`*
