---
title: "IUnitCatalog.Description"
description: "Returns the description of a units catalog."
---

# IUnitCatalog.Description

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Description for UnitCatalog

Returns the description of a units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Description)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Description_IUnitCatalog.htm`*
