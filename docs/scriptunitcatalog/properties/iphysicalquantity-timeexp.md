---
title: "IPhysicalQuantity.TimeExp"
description: "Returns the exponent of time for a physical quantity in the units catalog."
---

# IPhysicalQuantity.TimeExp

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: TimeExp for Quantity

Returns the exponent of time for a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("acceleration").TimeExp)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_TimeExp_IPhysicalQuantity.htm`*
