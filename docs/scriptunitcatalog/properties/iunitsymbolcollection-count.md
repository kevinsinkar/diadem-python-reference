...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases.Count)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Count_IUnitSymbolCollection.htm`*
