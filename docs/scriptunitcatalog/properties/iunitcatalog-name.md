---
title: "IUnitCatalog.Name"
description: "Returns the name of the units catalog."
---

# IUnitCatalog.Name

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Name for UnitCatalog

Returns the name of the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Name)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Name_IUnitCatalog.htm`*
