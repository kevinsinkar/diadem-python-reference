---
title: "IPhysicalUnit.Factor"
description: "Returns the factor for conversion into the base unit of a physical quantity, in the units catalog."
---

# IPhysicalUnit.Factor

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Factor for Unit

Returns the factor for conversion into the base unit of a physical quantity, in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").Factor)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Factor_IPhysicalUnit.htm`*
