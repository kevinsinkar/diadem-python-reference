---
title: "IPhysicalUnit.SymbolAliases"
description: "Returns a collection of all the symbol alternatives that are defined for a unit in the units catalog."
---

# IPhysicalUnit.SymbolAliases

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: SymbolAliases for Unit

Returns a collection of all the symbol alternatives that are defined for a unit in the units catalog.

## Signature

```python
return_value = obj.SymbolAliases
```
...
for oMyQuantity in dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases:
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_SymbolAliases_IPhysicalUnit.htm`*
