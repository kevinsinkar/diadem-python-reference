---
title: "IPhysicalUnit.Description"
description: "Returns the description of a unit in the units catalog."
---

# IPhysicalUnit.Description

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Description for Unit

Returns the description of a unit in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("length").Units("in").Description)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Description_IPhysicalUnit.htm`*
