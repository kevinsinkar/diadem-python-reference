---
title: "IPhysicalUnit.Name"
description: "Returns the name of a unit in the units catalog."
---

# IPhysicalUnit.Name

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Name for Unit

Returns the name of a unit in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("volume").Units(1).Name)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Name_IPhysicalUnit.htm`*
