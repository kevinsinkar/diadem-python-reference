---
title: "IUnitSetQuantity.DefaultUnit"
description: "Returns the default unit of a physical quantity of a unit set in the units catalog."
---

# IUnitSetQuantity.DefaultUnit

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: DefaultUnit for UsedQuantity

Returns the default unit of a physical quantity of a unit set in the units catalog.

## Signature

```python
return_value = obj.DefaultUnit
```

## Python example

```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities("volume").DefaultUnit.DisplayName)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_DefaultUnit_IUnitSetQuantity.htm`*
