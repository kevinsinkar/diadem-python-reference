---
title: "IPhysicalQuantity.BaseSymbol"
description: "Returns the symbol of the base unit of a physical quantity. The base unit is the unit in the physical quantity, that is linear scaled and has the Factor 1."
---

# IPhysicalQuantity.BaseSymbol

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: BaseSymbol for Quantity

Returns the symbol of the base unit of a physical quantity. The base unit is the unit in the physical quantity, that is linear scaled and has the Factor 1.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").BaseSymbol)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_BaseSymbol_IPhysicalQuantity.htm`*
