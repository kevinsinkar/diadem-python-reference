---
title: "IUnitSymbol.Description"
description: "Returns the description of the symbol of a unit in the units catalog."
---

# IUnitSymbol.Description

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Description for Symbol

Returns the description of the symbol of a unit in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").Symbol.Description)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Description_IUnitSymbol.htm`*
