---
title: "IUnitCatalogSymbolCollection.Count"
description: "Returns the number of symbols that are defined for a unit in the units catalog."
---

# IUnitCatalogSymbolCollection.Count

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Count for AllSymbols

Returns the number of symbols that are defined for a unit in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities("volume").UsedUnits.Count)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Count_IUnitCatalogSymbolCollection.htm`*
