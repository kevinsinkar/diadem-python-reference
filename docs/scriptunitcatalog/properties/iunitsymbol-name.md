---
title: "IUnitSymbol.Name"
description: "Returns the name of a symbol in the units catalog."
---

# IUnitSymbol.Name

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Name for Symbol

Returns the name of a symbol in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("volume").Units("liter").Symbol.Name)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Name_IUnitSymbol.htm`*
