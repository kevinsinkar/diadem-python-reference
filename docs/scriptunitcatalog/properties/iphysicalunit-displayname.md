---
title: "IPhysicalUnit.DisplayName"
description: "Returns the display name of a unit in the units catalog. The display name is the name that DIAdem displays on the user interface of the units catalog."
---

# IPhysicalUnit.DisplayName

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: DisplayName for Unit

Returns the display name of a unit in the units catalog. The display name is the name that DIAdem displays on the user interface of the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units(1).DiaplayName)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_DisplayName_IPhysicalUnit.htm`*
