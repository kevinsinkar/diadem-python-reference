---
title: "IPhysicalQuantity.Name"
description: "Returns the name of a physical quantity in the units catalog."
---

# IPhysicalQuantity.Name

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Name for Quantity

Returns the name of a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities(1).Name)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Name_IPhysicalQuantity.htm`*
