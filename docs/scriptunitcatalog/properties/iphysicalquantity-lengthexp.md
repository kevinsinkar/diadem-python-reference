---
title: "IPhysicalQuantity.LengthExp"
description: "Returns the exponent of the length for a physical quantity in the units catalog."
---

# IPhysicalQuantity.LengthExp

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: LengthExp for Quantity

Returns the exponent of the length for a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("area").LengthExp)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_LengthExp_IPhysicalQuantity.htm`*
