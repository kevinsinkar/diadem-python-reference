---
title: "IPhysicalUnit.ScaleType"
description: "Returns the scaling type of a unit in the units catalog."
---

# IPhysicalUnit.ScaleType

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: ScaleType for Unit

Returns the scaling type of a unit in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities("ratio").UsedUnits("decibel").ScaleType)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_ScaleType_IPhysicalUnit.htm`*
