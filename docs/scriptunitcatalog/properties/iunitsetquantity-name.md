---
title: "IUnitSetQuantity.Name"
description: "Returns the name of a physical quantity from a unit set in the units catalog."
---

# IUnitSetQuantity.Name

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Name for UsedQuantity

Returns the name of a physical quantity from a unit set in the units catalog.
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Name_IUnitSetQuantity.htm`*
