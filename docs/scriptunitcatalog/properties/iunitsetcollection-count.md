---
title: "IUnitSetCollection.Count"
description: "Returns the number of defined unit sets in the units catalog."
---

# IUnitSetCollection.Count

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Count for Sets

Returns the number of defined unit sets in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets.Count)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Count_IUnitSetCollection.htm`*
