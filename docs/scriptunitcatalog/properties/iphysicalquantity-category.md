---
title: "IPhysicalQuantity.Category"
description: "Returns the category to which a physical quantity of the units catalog is assigned."
---

# IPhysicalQuantity.Category

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Category for Quantity

Returns the category to which a physical quantity of the units catalog is assigned.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Category)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Category_IPhysicalQuantity.htm`*
