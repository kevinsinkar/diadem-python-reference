---
title: "IUnitSetUnitCollection.Count"
description: "Returns the number of units that a physical quantity uses, for a unit set in the units catalog."
---

# IUnitSetUnitCollection.Count
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Count_IUnitSetUnitCollection.htm`*
