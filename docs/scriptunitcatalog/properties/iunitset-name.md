---
title: "IUnitSet.Name"
description: "Returns the name of a unit set in the units catalog."
---
...
Returns the name of a unit set in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Sets(1).Name)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Name_IUnitSet.htm`*
