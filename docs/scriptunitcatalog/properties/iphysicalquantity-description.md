---
title: "IPhysicalQuantity.Description"
description: "Returns the description of a physical quantity in the units catalog."
---

# IPhysicalQuantity.Description

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: Description for Quantity

Returns the description of a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("energy").Description)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_Description_IPhysicalQuantity.htm`*
