---
title: "IUnitSetQuantity.UsedUnits"
description: "Returns a collection of all the units that a physical quantity of a unit set uses in the units catalog."
---

# IUnitSetQuantity.UsedUnits

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: UsedUnits for UsedQuantity

Returns a collection of all the units that a physical quantity of a unit set uses in the units catalog.

## Signature

```python
return_value = obj.UsedUnits
```

## Python example

```python
sOutput = "List of units: " +"\r\n"
for oMyUnit in dd.UnitCatalog.Quantities("volume").Units:
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_UsedUnits_IUnitSetQuantity.htm`*
