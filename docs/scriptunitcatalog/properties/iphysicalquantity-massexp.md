---
title: "IPhysicalQuantity.MassExp"
description: "Returns the exponent of the mass for a physical quantity in the units catalog."
---

# IPhysicalQuantity.MassExp

!!! abstract "Property &middot; `ScriptUnitCatalog.chm`"
    Property: MassExp for Quantity

Returns the exponent of the mass for a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("energy").MassExp)
```
...
*Source: `ScriptUnitCatalog/properties/DiaCmpnt_property_MassExp_IPhysicalQuantity.htm`*
