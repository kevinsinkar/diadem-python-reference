---
title: "IUnitSymbolCollection.Move"
description: "Changes the position of the alternative symbol in the SymbolAliases collection in the units catalog. If you change the position, you also change the index of th"
---

# IUnitSymbolCollection.Move

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Move for SymbolAliases

Changes the position of the alternative symbol in the SymbolAliases collection in the units catalog. If you change the position, you also change the index of the alternative symbol.
...
```python
dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases.Move(3,1)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Move_IUnitSymbolCollection.htm`*
