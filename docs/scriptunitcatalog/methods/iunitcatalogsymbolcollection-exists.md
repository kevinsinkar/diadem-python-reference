---
title: "IUnitCatalogSymbolCollection.Exists"
description: "Checks whether a symbol already exists in the units catalog."
---

# IUnitCatalogSymbolCollection.Exists

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Exists for AllSymbols

Checks whether a symbol already exists in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.AllSymbols.Exists("l"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Exists_IUnitCatalogSymbolCollection.htm`*
