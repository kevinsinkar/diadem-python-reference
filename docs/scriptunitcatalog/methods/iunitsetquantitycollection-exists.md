---
title: "IUnitSetQuantityCollection.Exists"
description: "Checks whether a physical quantity already exists in a unit set."
---

# IUnitSetQuantityCollection.Exists

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Exists for UsedQuantities

Checks whether a physical quantity already exists in a unit set.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.ets("mechanics").UsedQuantities.Exists("volume"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Exists_IUnitSetQuantityCollection.htm`*
