---
title: "IUnitCatalog.Reset"
description: "Restores the delivery status of the units catalog."
---

# IUnitCatalog.Reset

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Reset for UnitCatalog

Restores the delivery status of the units catalog.
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Reset_IUnitCatalog.htm`*
