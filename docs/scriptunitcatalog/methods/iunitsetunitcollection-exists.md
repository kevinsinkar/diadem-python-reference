---
title: "IUnitSetUnitCollection.Exists"
description: "Checks whether the unit of a physical quantity already exists in a unit set in the units catalog."
---

# IUnitSetUnitCollection.Exists

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Exists for UsedUnits

Checks whether the unit of a physical quantity already exists in a unit set in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Sets("mechanics").UsedQuantities("volume").UsedUnits.Exists("liter"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Exists_IUnitSetUnitCollection.htm`*
