---
title: "IPhysicalQuantityCollection.GetIndex"
description: "Returns the index of a physical quantity from the collection of all the physical quantities in the units catalog."
---

# IPhysicalQuantityCollection.GetIndex

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: GetIndex for Quantities

Returns the index of a physical quantity from the collection of all the physical quantities in the units catalog.
...
```python
iGetIndex = dd.UnitCatalog.Quantities.GetIndex("volume")
dd.MsgBoxDisp (dd.UnitCatalog.Quantities(iGetIndex).Name)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_GetIndex_IPhysicalQuantityCollection.htm`*
