---
title: "IPhysicalQuantityCollection.Remove"
description: "Deletes a physical quantity with all the associated units and symbols, from the units catalog."
---

# IPhysicalQuantityCollection.Remove
...
```python
dd.UnitCatalog.Quantities.Remove("temperature")
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Remove_IPhysicalQuantityCollection.htm`*
