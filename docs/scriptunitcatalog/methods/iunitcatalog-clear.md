---
title: "IUnitCatalog.Clear"
description: "Deletes the contents of the current units catalog."
---

# IUnitCatalog.Clear

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Clear for UnitCatalog

Deletes the contents of the current units catalog.
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Clear_IUnitCatalog.htm`*
