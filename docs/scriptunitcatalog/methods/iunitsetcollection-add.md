---
title: "IUnitSetCollection.Add"
description: "Adds a unit set to the units catalog."
---

# IUnitSetCollection.Add

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Add for Sets

Adds a unit set to the units catalog.
...
```python
dd.UnitCatalog.Sets.Add("Custom")
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Add_IUnitSetCollection.htm`*
