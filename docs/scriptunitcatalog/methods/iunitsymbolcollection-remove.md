---
title: "IUnitSymbolCollection.Remove"
description: "Deletes an alternative symbol of a unit of the units catalog."
---

# IUnitSymbolCollection.Remove

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Remove for SymbolAliases

Deletes an alternative symbol of a unit of the units catalog.
...
```python
dd.UnitCatalog.Quantities("length").Units("Picometer").SymbolAliases.Remove("pm")
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Remove_IUnitSymbolCollection.htm`*
