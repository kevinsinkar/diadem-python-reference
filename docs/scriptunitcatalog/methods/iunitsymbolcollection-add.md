---
title: "IUnitSymbolCollection.Add"
description: "Adds a new symbol to a unit in the units catalog."
---

# IUnitSymbolCollection.Add

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Add for SymbolAliases

Adds a new symbol to a unit in the units catalog.
...
```python
dd.UnitCatalog.Quantities("area").Units("square_meter").SymbolAliases.Add("m*2")
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Add_IUnitSymbolCollection.htm`*
