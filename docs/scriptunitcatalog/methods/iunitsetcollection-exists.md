---
title: "IUnitSetCollection.Exists"
description: "Checks whether a unit set already exists in the units catalog."
---

# IUnitSetCollection.Exists

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Exists for Sets

Checks whether a unit set already exists in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Sets.Exists("mechanics"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Exists_IUnitSetCollection.htm`*
