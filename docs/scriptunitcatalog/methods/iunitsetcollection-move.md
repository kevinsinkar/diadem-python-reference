---
title: "IUnitSetCollection.Move"
description: "Changes the position of a unit set in the Sets collection in the units catalog. If you change the position, you also change the index of the unit set."
---

# IUnitSetCollection.Move

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Move for Sets

Changes the position of a unit set in the Sets collection in the units catalog. If you change the position, you also change the index of the unit set.
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Move_IUnitSetCollection.htm`*
