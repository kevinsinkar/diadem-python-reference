---
title: "IPhysicalUnitCollection.Exists"
description: "Checks whether a unit already exists in the units catalog."
---

# IPhysicalUnitCollection.Exists

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Exists for Units

Checks whether a unit already exists in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("volume").Units.Exists("liter"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Exists_IPhysicalUnitCollection.htm`*
