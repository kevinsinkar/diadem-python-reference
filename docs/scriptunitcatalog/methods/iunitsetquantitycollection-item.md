---
title: "IUnitSetQuantityCollection.Item"
description: "Returns a UsedQuantity object in the units catalog. A UsedQuantity object is a physical quantity of a unit set in the units catalog."
---

# IUnitSetQuantityCollection.Item

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Item for UsedQuantities

Returns a UsedQuantity object in the units catalog. A UsedQuantity object is a physical quantity of a unit set in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities.Item(1).Name)
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities(1).Name)
```

```python
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities.Item("volume").Name)
dd.MsgBoxDisp (dd.UnitCatalog.Sets("mechanics").UsedQuantities("volume").Name)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Item_IUnitSetQuantityCollection.htm`*
