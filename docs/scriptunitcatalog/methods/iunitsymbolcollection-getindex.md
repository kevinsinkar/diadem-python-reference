---
title: "IUnitSymbolCollection.GetIndex"
description: "Returns the index of an alternative symbol of the unit of a physical quantity from a unit set in the units catalog."
---

# IUnitSymbolCollection.GetIndex

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: GetIndex for SymbolAliases

Returns the index of an alternative symbol of the unit of a physical quantity from a unit set in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases.GetIndex("l"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_GetIndex_IUnitSymbolCollection.htm`*
