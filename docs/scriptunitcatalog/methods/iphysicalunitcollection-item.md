---
title: "IPhysicalUnitCollection.Item"
description: "Returns a Unit object in the units catalog. A Unit object is a unit of a physical quantity in the units catalog."
---

# IPhysicalUnitCollection.Item

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Item for Units

Returns a Unit object in the units catalog. A Unit object is a unit of a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units.Item(1).DisplayName)
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units(1).DisplayName)
```

```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units.Item("liter").DisplayName)
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").DisplayName)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Item_IPhysicalUnitCollection.htm`*
