---
title: "IUnitCatalogSymbolCollection.GetIndex"
description: "Returns the index of a symbol from the collection of all the symbols in the units catalog."
---

# IUnitCatalogSymbolCollection.GetIndex

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: GetIndex for AllSymbols

Returns the index of a symbol from the collection of all the symbols in the units catalog.
...
```python
iGetIndex = dd.UnitCatalog.AllSymbols.GetIndex("h")
dd.MsgBoxDisp(dd.UnitCatalog.AllSymbols(iGetIndex).name)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_GetIndex_IUnitCatalogSymbolCollection.htm`*
