---
title: "IUnitSetCollection.GetIndex"
description: "Returns the index of a unit set from the units catalog."
---

# IUnitSetCollection.GetIndex

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: GetIndex for Sets

Returns the index of a unit set from the units catalog.
...
```python
iGetIndex = dd.UnitCatalog.Sets.GetIndex("mechanics")
dd.MsgBoxDisp(dd.UnitCatalog.Sets(iGetIndex).name)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_GetIndex_IUnitSetCollection.htm`*
