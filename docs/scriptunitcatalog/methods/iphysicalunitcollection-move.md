---
title: "IPhysicalUnitCollection.Move"
description: "Changes the position of a unit in the Units collection in the units catalog. If you change the position, you also change the index of the unit."
---

# IPhysicalUnitCollection.Move
...
```python
dd.UnitCatalog.Quantities("volume").Units.Move(1,4)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Move_IPhysicalUnitCollection.htm`*
