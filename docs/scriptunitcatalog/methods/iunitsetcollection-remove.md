---
title: "IUnitSetCollection.Remove"
description: "Deletes a unit set with all the quantities and units it contains, from the units catalog."
---

# IUnitSetCollection.Remove

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Remove for Sets

Deletes a unit set with all the quantities and units it contains, from the units catalog.
...
```python
dd.UnitCatalog.Sets.Remove("mechanics")
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Remove_IUnitSetCollection.htm`*
