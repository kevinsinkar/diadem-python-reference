---
title: "IPhysicalQuantityCollection.Move"
description: "Changes the position of a physical quantity in the Quantities collection in the units catalog. If you change the position, you also change the index of the phys"
---

# IPhysicalQuantityCollection.Move
...
```python
dd.UnitCatalog.Quantities.Move(1,4)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Move_IPhysicalQuantityCollection.htm`*
