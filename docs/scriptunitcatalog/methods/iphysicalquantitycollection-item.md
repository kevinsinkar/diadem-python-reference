---
title: "IPhysicalQuantityCollection.Item"
description: "Returns a Quantity object in the units catalog. A Quantity object is a physical quantity in the units catalog."
---

# IPhysicalQuantityCollection.Item

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Item for Quantities

Returns a Quantity object in the units catalog. A Quantity object is a physical quantity in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities.Item(1).DisplayName)
dd.MsgBoxDisp (dd.UnitCatalog.Quantities(1).DisplayName)
```

```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities.Item("volume").DisplayName)
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").DisplayName)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Item_IPhysicalQuantityCollection.htm`*
