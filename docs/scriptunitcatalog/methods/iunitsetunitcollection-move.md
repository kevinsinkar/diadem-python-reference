---
title: "IUnitSetUnitCollection.Move"
description: "Changes the position of a unit in the UsedUnits collection in the units catalog. If you change the position, you also change the index of the unit."
---

# IUnitSetUnitCollection.Move

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Move for UsedUnits

Changes the position of a unit in the UsedUnits collection in the units catalog. If you change the position, you also change the index of the unit.
...
```python
dd.UnitCatalog.Sets("mechanics").UsedQuantities("length").UsedUnits.Move(1,3)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Move_IUnitSetUnitCollection.htm`*
