---
title: "IUnitSymbolCollection.Item"
description: "Returns a Symbol object in the units catalog. A Symbol object is a unit symbol of a physical quantity from a unit set in the units catalog."
---

# IUnitSymbolCollection.Item

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Item for SymbolAliases

Returns a Symbol object in the units catalog. A Symbol object is a unit symbol of a physical quantity from a unit set in the units catalog.
...
```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases.Item(1).Name)
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases(1).Name)
```

```python
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases.Item("l").Name)
dd.MsgBoxDisp (dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases("l").Name)
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Item_IUnitSymbolCollection.htm`*
