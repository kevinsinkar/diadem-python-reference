---
title: "IUnitSymbolCollection.Exists"
description: "Checks whether the symbol of a unit already exists in a unit set in the units catalog."
---

# IUnitSymbolCollection.Exists

!!! abstract "Method &middot; `ScriptUnitCatalog.chm`"
    Method: Exists for SymbolAliases

Checks whether the symbol of a unit already exists in a unit set in the units catalog.
...
```python
dd.MsgBoxDisp(dd.UnitCatalog.Quantities("volume").Units("liter").SymbolAliases.Exists("l"))
```
...
*Source: `ScriptUnitCatalog/methods/DiaCmpnt_method_Exists_IUnitSymbolCollection.htm`*
