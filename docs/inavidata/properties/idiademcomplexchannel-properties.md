---
title: "IDiademComplexChannel.Properties"
description: "Contains the Properties collection that is associated with a ComplexChannel object in the script interface for internal data."
---

# IDiademComplexChannel.Properties

!!! abstract "Property &middot; `Inavidata.chm`"
    Property: Properties for ComplexChannel <Data>

Contains the Properties collection that is associated with a ComplexChannel object in the script interface for internal data.
...
*Source: `Inavidata/properties/DiaCmpnt_property_Properties_IDiademComplexChannel.htm`*
