---
title: "IDiademChannelGroups.Count"
description: "Returns the number of elements of a ChannelGroups collection, in the script interface for internal data."
---

# IDiademChannelGroups.Count
...
```python
dd.MsgBoxDisp(dd.Data.Root.ChannelGroups.Count)
```
...
*Source: `Inavidata/properties/DiaCmpnt_property_Count_IDiademChannelGroups.HTM`*
