---
title: "ITemplateProperties.Count"
description: "Returns the number of elements of a TemplateProperties collection, in the script interface for internal data."
---

# ITemplateProperties.Count
...
```python
dd.MsgBoxDisp(dd.Data.Settings.CustomPropertyTemplate.RootProperties.Count)
```
...
*Source: `Inavidata/properties/DiaCmpnt_property_Count_ITemplateProperties.htm`*
