---
title: "IDiademChannelGroup.Properties"
...
# IDiademChannelGroup.Properties

!!! abstract "Property &middot; `Inavidata.chm`"
    Property: Properties for ChannelGroup <Data>
...
```python
for oMyGrp in dd.Data.Root.ChannelGroups:
    if oMyGrp.Properties.Exists("Test_Status") :
        oMyGrp.Properties("Test_Status").Value = "failed"
```
...
*Source: `Inavidata/properties/DiaCmpnt_property_Properties_IDiademChannelGroup.HTM`*
