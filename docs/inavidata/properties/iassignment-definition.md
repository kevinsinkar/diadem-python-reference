---
title: "IAssignment.Definition"
description: "Specifies the numeric value of an assignment, in the script interface for internal data. A text value (property Value) is assigned to a numeric value (property "
---

# IAssignment.Definition
...
*Source: `Inavidata/properties/DiaCmpnt_property_Definition_IAssignment.htm`*
