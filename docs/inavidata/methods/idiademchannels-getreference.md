---
title: "IDiademChannels.GetReference"
description: "Returns the channel reference of channels in a list, in the script interface for internal data. Use this method when you are working with data objects and need "
---

# IDiademChannels.GetReference
...
sChannelList = oMyGroup.Channels.GetReference(dd.ExtendChnName)
dd.MsgBoxDisp (sChannelList)
```
...
*Source: `Inavidata/methods/DiaCmpnt_method_GetReference_IDiademChannels.HTM`*
