---
title: "IDiademChannelGroup.IsKindOf"
description: "Checks the type of an element in the script interface for internal data."
---

# IDiademChannelGroup.IsKindOf

!!! abstract "Method &middot; `Inavidata.chm`"
    Method: IsKindOf for ChannelGroup <Data>
...
*Source: `Inavidata/methods/DiaCmpnt_method_IsKindOf_IDiademChannelGroup.htm`*
