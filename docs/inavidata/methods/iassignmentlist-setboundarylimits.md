---
title: "IAssignmentList.SetBoundaryLimits"
description: "Specifies the behavior at the interval limits of the minimum and maximum values of an assignment, in the script interface for internal data."
---

# IAssignmentList.SetBoundaryLimits
...
```python
obj.SetBoundaryLimits(LimitsLeft, LimitsRight)
```
...
*Source: `Inavidata/methods/DiaCmpnt_method_SetBoundaryLimits_IAssignmentList.htm`*
