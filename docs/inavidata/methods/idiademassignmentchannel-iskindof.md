---
title: "IDiademAssignmentChannel.IsKindOf"
description: "Checks the type of an assignment channel in the script interface for internal data."
---

# IDiademAssignmentChannel.IsKindOf

!!! abstract "Method &middot; `Inavidata.chm`"
    Method: IsKindOf for AssignmentChannel <Data>

Checks the type of an assignment channel in the script interface for internal data.
...
if oMyChannel.IsKindOf(dd.eDataAssignmentChannel) :
...
*Source: `Inavidata/methods/DiaCmpnt_method_IsKindOf_IDiademAssignmentChannel.htm`*
