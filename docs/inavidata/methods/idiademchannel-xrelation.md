---
title: "IDiademChannel.XRelation"
...
# IDiademChannel.XRelation

!!! abstract "Method &middot; `Inavidata.chm`"
    Method: XRelation for Channel <Data>
...
*Source: `Inavidata/methods/DiaCmpnt_method_XRelation_IDiademChannel.htm`*
