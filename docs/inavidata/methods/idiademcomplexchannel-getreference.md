---
title: "IDiademComplexChannel.GetReference"
description: "Returns the channel reference of a complex channel in the script interface for internal data. Use this method when you are working with data objects and need ch"
---

# IDiademComplexChannel.GetReference
...
dd.MsgBoxDisp (sMyComplexChannelReference)
```
...
*Source: `Inavidata/methods/DiaCmpnt_method_GetReference_IDiademComplexChannel.htm`*
