---
title: "IDiademComplexChannel.IsKindOf"
description: "Checks the type of an element in the script interface for internal data."
---

# IDiademComplexChannel.IsKindOf

!!! abstract "Method &middot; `Inavidata.chm`"
    Method: IsKindOf for ComplexChannel <Data>
...
*Source: `Inavidata/methods/DiaCmpnt_method_IsKindOf_IDiademComplexChannel.htm`*
