---
title: "ILogFileCollection.GetIndex"
description: "Returns the index of a logfile from the LogFiles collection in the Bus Log Converter ."
---

# ILogFileCollection.GetIndex

!!! abstract "Method &middot; `ICANConverter.chm`"
    Method: GetIndex for LogFiles

Returns the index of a logfile from the LogFiles collection in the Bus Log Converter .
...
*Source: `ICANConverter/methods/CANConverter_method_GetIndex_ILogFileCollection.htm`*
