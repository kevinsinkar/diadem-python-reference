---
title: "IFormulaAdaptor.Tag"
description: "Specifies any comment for an input or an output of a calculation."
---

# IFormulaAdaptor.Tag

!!! abstract "Property &middot; `ICalculationSet.chm`"
    Property: Tag for InputOrOutput

Specifies any comment for an input or an output of a calculation.
...
*Source: `ICalculationSet/properties/FormulaCalc_property_Tag_IFormulaAdaptor.htm`*
