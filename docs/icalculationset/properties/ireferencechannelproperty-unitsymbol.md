...
if oMyInput.ReferenceType == dd.eReferenceTypeChannelProperty :
    ...
    oMyInput.Reference.UnitSymbol = "1/s"
```
...
*Source: `ICalculationSet/properties/FormulaCalc_property_UnitSymbol_IReferenceChannelProperty.htm`*
