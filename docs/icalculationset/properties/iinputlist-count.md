---
title: "IInputList.Count"
description: "Returns the number of inputs that are dependent on an output of a calculation."
---
...
*Source: `ICalculationSet/properties/FormulaCalc_property_Count_IInputList.htm`*
