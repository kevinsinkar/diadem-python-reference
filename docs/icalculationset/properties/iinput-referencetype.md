---
title: "IInput.ReferenceType"
description: "Specifies the reference type, which is dependent on the data type, of the input of a calculation. If the input of the calculation is dependent on an output from"
---

# IInput.ReferenceType

!!! abstract "Property &middot; `ICalculationSet.chm`"
    Property: ReferenceType for Input

Specifies the reference type, which is dependent on the data type, of the input of a calculation. If the input of the calculation is dependent on an output from another calculation, you cannot change the ReferenceType property.
...
*Source: `ICalculationSet/properties/FormulaCalc_property_ReferenceType_IInput.htm`*
