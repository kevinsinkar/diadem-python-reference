---
title: "IReferenceAbstract.Parent"
description: "Specifies the input or the output of a calculation to which the reference is assigned."
---

# IReferenceAbstract.Parent

!!! abstract "Property &middot; `ICalculationSet.chm`"
    Property: Parent for Reference

Specifies the input or the output of a calculation to which the reference is assigned.
...
*Source: `ICalculationSet/properties/FormulaCalc_property_Parent_IReferenceAbstract.htm`*
