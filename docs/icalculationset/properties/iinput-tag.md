---
title: "IInput.Tag"
description: "Specifies any comment for an input of a calculation."
---

# IInput.Tag

!!! abstract "Property &middot; `ICalculationSet.chm`"
    Property: Tag for Input

Specifies any comment for an input of a calculation.
...
```python
dd.CalculationSet.CalculationGroups(1).Calculations(1).Inputs(1).Tag = "My Remark on this input"
```
...
*Source: `ICalculationSet/properties/FormulaCalc_property_Tag_IInput.htm`*
