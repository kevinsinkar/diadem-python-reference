---
title: "IToColorPaletteEntryInt.ColorRGB"
description: "Specifies the RGB value of the palette color DIAdem uses for a contour display or a bird's eye view display. DIAdem only includes the color when the Color prope"
---

# IToColorPaletteEntryInt.ColorRGB

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ColorRGB for ColorPaletteEntry

Specifies the RGB value of the palette color DIAdem uses for a contour display or a bird's eye view display. DIAdem only includes the color when the Color property has the value other colors .
...
for i in range( 1, oMyObj.Count+1):
    dd.LogfileWrite("ColorRGB: " + oMyObj(i).ColorRGB + " / Value: " + oMyObj(i).Value)
```
...
*Source: `Scriptview/properties/VIEW_property_ColorRGB_IToColorPaletteEntryInt.htm`*
