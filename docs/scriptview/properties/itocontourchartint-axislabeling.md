---
title: "IToContourChartInt.AxisLabeling"
description: "Specifies whether DIAdem displays the axis label in a contour display in DIAdem VIEW."
---

# IToContourChartInt.AxisLabeling

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: AxisLabeling for Contour

Specifies whether DIAdem displays the axis label in a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_AxisLabeling_IToContourChartInt.htm`*
