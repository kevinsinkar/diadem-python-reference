---
title: "ITo2DChartInt.YScalingBegin"
description: "Specifies the smallest value of the y-scaling of a 2D axis system in DIAdem VIEW if manual scaling is set. DIAdem includes this setting only if the YScalingMode"
---

# ITo2DChartInt.YScalingBegin

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: YScalingBegin for CurveChart2D

Specifies the smallest value of the y-scaling of a 2D axis system in DIAdem VIEW if manual scaling is set. DIAdem includes this setting only if the YScalingMode property contains the value manual .
...
*Source: `Scriptview/properties/VIEW_property_YScalingBegin_ITo2DChartInt.htm`*
