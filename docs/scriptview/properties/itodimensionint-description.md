---
title: "IToDimensionInt.Description"
description: "Specifies the description of a cursor dimension in DIAdem VIEW."
---

# IToDimensionInt.Description

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Description for Dimension

Specifies the description of a cursor dimension in DIAdem VIEW.
...
for oMyDim in dd.View.ActiveSheet.Cursor.Dimensions:
    dd.MsgBoxDisp(oMyDim.Name + " / " + oMyDim.Description)
```
...
*Source: `Scriptview/properties/VIEW_property_Description_IToDimensionInt.htm`*
