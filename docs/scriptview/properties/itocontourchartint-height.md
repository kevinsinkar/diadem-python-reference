---
title: "IToContourChartInt.Height"
description: "Specifies which cursor dimension DIAdem assigns to the z-axis of a contour display in DIAdem VIEW."
---

# IToContourChartInt.Height

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Height for Contour

Specifies which cursor dimension DIAdem assigns to the z-axis of a contour display in DIAdem VIEW.
...
dd.MsgBoxDisp("Abscissa: " + oMyObj.Abscissa + ", Ordinate: " + oMyObj.Ordinate + " Height: " + oMyObj.Height)
```
...
*Source: `Scriptview/properties/VIEW_property_Height_IToContourChartInt.htm`*
