---
title: "IToDimensionInt.Value2"
description: "Specifies the position of the second cursor line for a cursor dimension in DIAdem VIEW."
---

# IToDimensionInt.Value2

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Value2 for Dimension

Specifies the position of the second cursor line for a cursor dimension in DIAdem VIEW.
...
dd.MsgBoxDisp("Value1: " + oMyObj.Value1 + ", Value2: " + oMyObj.Value2 + ", Diff: " + oMyObj.Difference)
```
...
*Source: `Scriptview/properties/VIEW_property_Value2_IToDimensionInt.htm`*
