---
title: "IToCascadeCurveInt.Index"
description: "Returns the index of a waterfall curve in a cascade display in DIAdem VIEW. The waterfall curve must always be the first curve in the cascade display."
---

# IToCascadeCurveInt.Index
...
dd.MsgBoxDisp("Index of NewCurve: " + oMyCascadeCurve.Index)
```
...
*Source: `Scriptview/properties/VIEW_property_Index_IToCascadeCurveInt.htm`*
