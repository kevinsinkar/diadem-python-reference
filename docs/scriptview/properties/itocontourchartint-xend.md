---
title: "IToContourChartInt.XEnd"
description: "Returns the end of the value range of an x-axis of a contour display in DIAdem VIEW."
---

# IToContourChartInt.XEnd

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: XEnd for Contour

Returns the end of the value range of an x-axis of a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_XEnd_IToContourChartInt.htm`*
