---
title: "IToContourCurveInt.Index"
description: "Returns the index of a contour in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.Index

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Index for ContourCurve

Returns the index of a contour in a contour display in DIAdem VIEW.
...
```python
oNewCurve = dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour.AddContour("[1]/[1]","[1]/[2]","[1]/[3]")
...
*Source: `Scriptview/properties/VIEW_property_Index_IToContourCurveInt.htm`*
