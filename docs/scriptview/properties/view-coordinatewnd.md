---
title: "VIEW.CoordinateWnd"
description: "Returns the coordinate window in DIAdem VIEW."
---

# VIEW.CoordinateWnd

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: CoordinateWnd for View

Returns the coordinate window in DIAdem VIEW.

## Signature

```python
return_value = obj.CoordinateWnd
```

## Python example

```python
dd.View.CoordinateWnd.SetPos(300,300)
...
*Source: `Scriptview/properties/VIEW_property_CoordinateWnd_VIEW.htm`*
