---
title: "IToCursorMasterInt.Mode"
description: "Specifies the type of the cursor in DIAdem VIEW."
---

# IToCursorMasterInt.Mode

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Mode for Cursor

Specifies the type of the cursor in DIAdem VIEW.
...
```python
dd.View.Sheets(1).Cursor.Mode = "GraphPoints"
```
...
*Source: `Scriptview/properties/VIEW_property_Mode_IToCursorMasterInt.htm`*
