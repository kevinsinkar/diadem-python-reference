---
title: "IToContourCurveInt.Structure"
description: "Specifies the data structure for a contour display in DIAdem VIEW."
---

# IToContourCurveInt.Structure

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Structure for ContourCurve

Specifies the data structure for a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Structure_IToContourCurveInt.htm`*
