---
title: "IToContourChartInt.CreateCuttingEdge"
description: "Specifies whether DIAdem displays the intersection curve for a contour display in DIAdem VIEW."
---

# IToContourChartInt.CreateCuttingEdge

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: CreateCuttingEdge for Contour

Specifies whether DIAdem displays the intersection curve for a contour display in DIAdem VIEW.

## Signature

```python
obj.CreateCuttingEdge
```
...
*Source: `Scriptview/properties/VIEW_property_CreateCuttingEdge_IToContourChartInt.htm`*
