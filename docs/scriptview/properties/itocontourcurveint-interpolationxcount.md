---
title: "IToContourCurveInt.InterpolationXCount"
description: "Specifies for the interpolation display in DIAdem VIEW the number of grid points in x-direction."
---

# IToContourCurveInt.InterpolationXCount

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: InterpolationXCount for ContourCurve

Specifies for the interpolation display in DIAdem VIEW the number of grid points in x-direction.

## Signature

```python
obj.InterpolationXCount
```
...
*Source: `Scriptview/properties/VIEW_property_InterpolationXCount_IToContourCurveInt.htm`*
