---
title: "IToCascadeCurveInt.TagTemporary"
description: "Property: TagTemporary for WaterfallCurve Specifies a temporary tag for a curve in a cascade display in DIAdem VIEW. Use this property to add additional informa"
---

# IToCascadeCurveInt.TagTemporary

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: TagTemporary for WaterfallCurve
...
oMyCascadeCurve.TagTemporary = TempTag()
oMyCascadeCurve.TagTemporary.Name = "Waterfall curve"
oMyCascadeCurve.TagTemporary.IsValid = 1
```
...
*Source: `Scriptview/properties/VIEW_property_TagTemporary_IToCascadeCurveInt.htm`*
