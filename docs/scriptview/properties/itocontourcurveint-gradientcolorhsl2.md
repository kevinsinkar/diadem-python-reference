---
title: "IToContourCurveInt.GradientColorHSL2"
description: "Specifies the end color of the color palette in the HSL color model for the contours display in DIAdem VIEW."
---

# IToContourCurveInt.GradientColorHSL2

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: GradientColorHSL2 for ContourCurve

Specifies the end color of the color palette in the HSL color model for the contours display in DIAdem VIEW.

## Signature

```python
obj.GradientColorHSL2
```
...
*Source: `Scriptview/properties/VIEW_property_GradientColorHSL2_IToContourCurveInt.htm`*
