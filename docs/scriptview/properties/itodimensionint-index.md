---
title: "IToDimensionInt.Index"
description: "Returns the index of a cursor dimension in DIAdem VIEW."
---

# IToDimensionInt.Index

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Index for Dimension

Returns the index of a cursor dimension in DIAdem VIEW.
...
```python
oNewDim = dd.View.ActiveSheet.Cursor.Dimensions.Add("MyDim")
dd.MsgBoxDisp("Index of NewDim: " + oNewDim.Index)
```
...
*Source: `Scriptview/properties/VIEW_property_Index_IToDimensionInt.htm`*
