---
title: "IToContourCurveInt.DisplayIsolineValues"
description: "Specifies whether DIAdem labels the additional isolines in a contour display in DIAdem VIEW with contour values."
---

# IToContourCurveInt.DisplayIsolineValues

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DisplayIsolineValues for ContourCurve

Specifies whether DIAdem labels the additional isolines in a contour display in DIAdem VIEW with contour values.
...
oMyContour.UserDefinedColoringEntries.RemoveAll()
oMyContour.UserDefinedColoringEntries.Add(3000,"red",dd.RGB(255,0,0))
oMyContour.UserDefinedColoringEntries.Add(4000,"red",dd.RGB(255,0,0))
oMyContour.UserDefinedColoringEntries.Add(5000,"red",dd.RGB(255,0,0))
oMyContour.DisplayIsolines = True
oMyContour.DisplayIsolineValues = True
```
...
*Source: `Scriptview/properties/VIEW_property_DisplayIsolineValues_IToContourCurveInt.htm`*
