---
title: "IToContourCurveInt.DisplaySymbols"
description: "Specifies in the contour display in DIAdem VIEW whether DIAdem also labels the measured values with z-values."
---

# IToContourCurveInt.DisplaySymbols

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DisplaySymbols for ContourCurve

Specifies in the contour display in DIAdem VIEW whether DIAdem also labels the measured values with z-values.
...
oMyContour.DisplaySymbols = True
```
...
*Source: `Scriptview/properties/VIEW_property_DisplaySymbols_IToContourCurveInt.htm`*
