---
title: "ITo2DCurveEnumInt.Count"
description: "Returns the number of elements in a 2DCurves collection in DIAdem VIEW."
---

# ITo2DCurveEnumInt.Count

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Count for 2DCurves

Returns the number of elements in a 2DCurves collection in DIAdem VIEW.
...
```python
dd.MsgBoxDisp("Number of Curves: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.Curves.Count)
```
...
*Source: `Scriptview/properties/VIEW_property_Count_ITo2DCurveEnumInt.htm`*
