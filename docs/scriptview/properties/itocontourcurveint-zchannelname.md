---
title: "IToContourCurveInt.ZChannelName"
description: "Specifies the name of the z-channel of a contour in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.ZChannelName

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ZChannelName for ContourCurve

Specifies the name of the z-channel of a contour in a contour display in DIAdem VIEW.
...
oMyCurves.AddContour("[1]/[1]","[1]/[2]","[1]/[3]")
oMyCurves.AddIsoline("[1]/[1]","[1]/[4]")
for oMyCurve in oMyCurves:
    dd.MsgBoxDisp("X-channel: " + oMyCurve.XChannelName  + "@@crlf@@" + "Y-channel: " + oMyCurve.YChannelName  + "@@crlf@@" + "Z-channel: " + oMyCurve.ZChannelName)
```
...
*Source: `Scriptview/properties/VIEW_property_ZChannelName_IToContourCurveInt.htm`*
