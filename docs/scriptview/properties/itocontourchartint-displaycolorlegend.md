---
title: "IToContourChartInt.DisplayColorLegend"
description: "Specifies whether DIAdem also displays a color legend for a contour display in DIAdem VIEW."
---

# IToContourChartInt.DisplayColorLegend

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DisplayColorLegend for Contour

Specifies whether DIAdem also displays a color legend for a contour display in DIAdem VIEW.

## Signature

```python
obj.DisplayColorLegend
```
...
oMyObj.DisplayColorLegend = True
```
...
*Source: `Scriptview/properties/VIEW_property_DisplayColorLegend_IToContourChartInt.htm`*
