---
title: "ITo2DChartInt.ZoomCursor"
description: "Specifies the zoom function for a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.ZoomCursor

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ZoomCursor for CurveChart2D

Specifies the zoom function for a 2D axis system in DIAdem VIEW.
...
oMyChart.Curves2D.Add("[1]/[1]","[1]/[3]")
oMyChart.ZoomCursor = "BandZoomCursor"
```
...
*Source: `Scriptview/properties/VIEW_property_ZoomCursor_ITo2DChartInt.htm`*
