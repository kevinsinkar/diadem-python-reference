---
title: "ITo2DChartInt.YScalingMode"
description: "Specifies whether DIAdem scales the y-axis in a 2D axis system in DIAdem VIEW automatically or manually."
---

# ITo2DChartInt.YScalingMode

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: YScalingMode for CurveChart2D

Specifies whether DIAdem scales the y-axis in a 2D axis system in DIAdem VIEW automatically or manually.
...
<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>When the <a href="../ito2dchartint-yscaling/">YScaling</a> property contains the value <span class="Monospace">1 system [%]</span>, DIAdem ignores the <span class="Monospace">YScalingMode</span> property and then scales automatically.</td></tr></table>
</div>
...
*Source: `Scriptview/properties/VIEW_property_YScalingMode_ITo2DChartInt.htm`*
