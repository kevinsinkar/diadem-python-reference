---
title: "IToContourCurveInt.EnvelopeType"
description: "Specifies the origin of the boundary curve in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.EnvelopeType

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: EnvelopeType for ContourCurve

Specifies the origin of the boundary curve in a contour display in DIAdem VIEW.
...
oMyContour.EnvelopeXChannelNumber = 1
oMyContour.EnvelopeYChannelNumber = 2
```
...
*Source: `Scriptview/properties/VIEW_property_EnvelopeType_IToContourCurveInt.htm`*
