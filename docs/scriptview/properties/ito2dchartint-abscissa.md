---
title: "ITo2DChartInt.Abscissa"
description: "Specifies which cursor dimension DIAdem assigns to the x-axis of a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.Abscissa

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Abscissa for CurveChart2D

Specifies which cursor dimension DIAdem assigns to the x-axis of a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Abscissa_ITo2DChartInt.htm`*
