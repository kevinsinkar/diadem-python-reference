---
title: "IToContourChartInt.Area"
description: "Returns the area in DIAdem VIEW that contains a contour display."
---

# IToContourChartInt.Area

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Area for Contour

Returns the area in DIAdem VIEW that contains a contour display.
...
*Source: `Scriptview/properties/VIEW_property_Area_IToContourChartInt.htm`*
