---
title: "IToContourChartInt.Abscissa"
description: "Specifies which cursor dimension DIAdem assigns to the x-axis of a contour display in DIAdem VIEW."
---

# IToContourChartInt.Abscissa

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Abscissa for Contour

Specifies which cursor dimension DIAdem assigns to the x-axis of a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Abscissa_IToContourChartInt.htm`*
