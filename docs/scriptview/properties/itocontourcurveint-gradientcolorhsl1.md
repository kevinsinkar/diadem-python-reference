---
title: "IToContourCurveInt.GradientColorHSL1"
description: "Specifies the start color of the color palette in the HSL color model for the contours display in DIAdem VIEW."
---

# IToContourCurveInt.GradientColorHSL1

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: GradientColorHSL1 for ContourCurve

Specifies the start color of the color palette in the HSL color model for the contours display in DIAdem VIEW.

## Signature

```python
obj.GradientColorHSL1
```
...
oMyArea.DisplayObjType = "Contour"
oMyContour = oMyArea.DisplayObj.CurvesContour.AddContour("[1]/[1]","[1]/[2]","[1]/[3]")
oMyContour.Structure = "Triplet"
oMyContour.ColoringType = "Gradient"
oMyContour.GradientColorHSL1 = dd.RGBtoHSL(dd.RGB(0,0,255))
oMyContour.GradientColorHSL2 = dd.RGBtoHSL(dd.RGB(255,0,0))
oMyContour.GradientColorsCount = 64
```
...
*Source: `Scriptview/properties/VIEW_property_GradientColorHSL1_IToContourCurveInt.htm`*
