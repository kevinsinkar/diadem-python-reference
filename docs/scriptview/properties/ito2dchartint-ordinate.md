---
title: "ITo2DChartInt.Ordinate"
description: "Specifies which cursor dimension DIAdem assigns to the y-axis of a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.Ordinate

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Ordinate for CurveChart2D

Specifies which cursor dimension DIAdem assigns to the y-axis of a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Ordinate_ITo2DChartInt.htm`*
