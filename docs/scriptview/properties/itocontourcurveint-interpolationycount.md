---
title: "IToContourCurveInt.InterpolationYCount"
description: "Specifies for the interpolation display in DIAdem VIEW the number of grid points in y-direction."
---

# IToContourCurveInt.InterpolationYCount

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: InterpolationYCount for ContourCurve

Specifies for the interpolation display in DIAdem VIEW the number of grid points in y-direction.

## Signature

```python
obj.InterpolationYCount
```
...
*Source: `Scriptview/properties/VIEW_property_InterpolationYCount_IToContourCurveInt.htm`*
