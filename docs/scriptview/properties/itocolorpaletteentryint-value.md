---
title: "IToColorPaletteEntryInt.Value"
description: "Specifies the upper limit of a scaling section that DIAdem uses for the user-defined coloring of a contour display or a bird's eye view display."
---

# IToColorPaletteEntryInt.Value

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Value for ColorPaletteEntry

Specifies the upper limit of a scaling section that DIAdem uses for the user-defined coloring of a contour display or a bird's eye view display.
...
*Source: `Scriptview/properties/VIEW_property_Value_IToColorPaletteEntryInt.htm`*
