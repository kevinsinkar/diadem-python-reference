---
title: "IToCoordinateDisplayInt.Cursor"
description: "Returns the Cursor object in DIAdem VIEW."
---

# IToCoordinateDisplayInt.Cursor

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Cursor for CoordinateWnd

Returns the Cursor object in DIAdem VIEW.

## Signature

```python
return_value = obj.Cursor
```
...
dd.View.CoordinateWnd.Cursor.X1 = 10
dd.View.CoordinateWnd.Cursor.Y1 = 20
dd.View.CoordinateWnd.Cursor.X2 = 30
dd.View.CoordinateWnd.Cursor.Y2 = 40
dd.View.CoordinateWnd.Visible = True
dd.MsgBoxDisp("Dx position: " + dd.View.CoordinateWnd.Cursor.Dx)
dd.MsgBoxDisp("Dy position: " + dd.View.CoordinateWnd.Cursor.Dy)
```
...
*Source: `Scriptview/properties/VIEW_property_Cursor_IToCoordinateDisplayInt.htm`*
