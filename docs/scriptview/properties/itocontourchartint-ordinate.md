---
title: "IToContourChartInt.Ordinate"
description: "Specifies which cursor dimension DIAdem assigns to the y-axis of a contour display in DIAdem VIEW."
---

# IToContourChartInt.Ordinate

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Ordinate for Contour

Specifies which cursor dimension DIAdem assigns to the y-axis of a contour display in DIAdem VIEW.
...
dd.MsgBoxDisp("Abscissa: " + oMyObj.Abscissa + "\r\n" + "Ordinate: " + oMyObj.Ordinate + "Height: " + oMyObj.Height)
```
...
*Source: `Scriptview/properties/VIEW_property_Ordinate_IToContourChartInt.htm`*
