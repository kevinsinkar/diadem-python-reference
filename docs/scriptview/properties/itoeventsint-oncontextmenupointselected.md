---
title: "IToEventsInt.OnContextMenuPointSelected"
description: "Specifies the name of the user command that DIAdem executes when you select a context menu item in DIAdem VIEW."
---

# IToEventsInt.OnContextMenuPointSelected

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: OnContextMenuPointSelected for Events

Specifies the name of the user command that DIAdem executes when you select a context menu item in DIAdem VIEW.
...
<p><a href="../../events/oncontextmenupointselected-oncontextmenupointselected/">OnContextMenuPointSelected</a> | <a href="#" data-unresolved="1">Objects Overview</a></p>
</div>
</div>

---

*Source: `Scriptview/properties/VIEW_property_OnContextMenuPointSelected_IToEventsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
