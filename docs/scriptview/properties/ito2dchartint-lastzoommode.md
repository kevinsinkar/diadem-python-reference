---
title: "ITo2DChartInt.LastZoomMode"
description: "Specifies which zoom mode was used last in a 2D axis system of DIAdem VIEW."
---

# ITo2DChartInt.LastZoomMode

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: LastZoomMode for CurveChart2D

Specifies which zoom mode was used last in a 2D axis system of DIAdem VIEW.
...
if oMyChart.DisplayObjType == "CurveChart2D" :
...
*Source: `Scriptview/properties/VIEW_property_LastZoomMode_ITo2DChartInt.htm`*
