---
title: "IToAttrEnumInt.Count"
description: "Returns the number of elements in a LegendItems collection in DIAdem VIEW."
---

# IToAttrEnumInt.Count

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Count for LegendItems

Returns the number of elements in a LegendItems collection in DIAdem VIEW.
...
```python
dd.MsgBoxDisp("Number of LegendItems: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.LegendItems.Count)
```
...
*Source: `Scriptview/properties/VIEW_property_Count_IToAttrEnumInt.htm`*
