---
title: "IToCurveRelatedYScalingInt.Mode"
description: "Specifies how DIAdem defines the value range of a curve-related y-scaling in a 2D axis system in DIAdem VIEW."
---

# IToCurveRelatedYScalingInt.Mode

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Mode for CurveRelatedYScaling

Specifies how DIAdem defines the value range of a curve-related y-scaling in a 2D axis system in DIAdem VIEW.
...
| --- | ---: | --- |
| `eVIEWYScalingModeAutomatic` | 0 | Automatic scaling from the associated curves DIAdem uses the value ranges of the curves to specify the beginning and the end of the scaling. |
| `eVIEWYScalingModeManual` | 1 | Manual scaling DIAdem reads the beginning and the end of the scaling from the properties. |
...
*Source: `Scriptview/properties/VIEW_property_Mode_IToCurveRelatedYScalingInt.htm`*
