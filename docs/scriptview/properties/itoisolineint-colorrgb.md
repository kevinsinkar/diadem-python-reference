---
title: "IToIsolineInt.ColorRGB"
description: "Specifies the color of an isoline in a contour display in DIAdem VIEW. DIAdem only includes the color when the Color property has the value other colors ."
---

# IToIsolineInt.ColorRGB

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ColorRGB for Isoline

Specifies the color of an isoline in a contour display in DIAdem VIEW. DIAdem only includes the color when the Color property has the value other colors .
...
oMyIsoline.Color = "other colors"
oMyIsoline.ColorRGB = dd.RGB(100,100,200)
```
...
*Source: `Scriptview/properties/VIEW_property_ColorRGB_IToIsolineInt.htm`*
