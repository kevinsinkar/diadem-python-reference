---
title: "IToContourCurveInt.Type"
description: "Specifies the display mode of a curve in a contour display in DIAdem VIEW. The property always has the value Contour ."
---

# IToContourCurveInt.Type

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Type for ContourCurve

Specifies the display mode of a curve in a contour display in DIAdem VIEW. The property always has the value Contour .
...
```python
dd.MsgBoxDisp("Type: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour(1).Type)
```
...
*Source: `Scriptview/properties/VIEW_property_Type_IToContourCurveInt.htm`*
