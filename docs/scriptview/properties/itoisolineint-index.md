---
title: "IToIsolineInt.Index"
description: "Returns the index of an isoline in a contour display in DIAdem VIEW."
---

# IToIsolineInt.Index

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Index for Isoline

Returns the index of an isoline in a contour display in DIAdem VIEW.
...
```python
oNewCurve = dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour.AddIsoline("[1]/[1]","[1]/[2]")
...
*Source: `Scriptview/properties/VIEW_property_Index_IToIsolineInt.htm`*
