---
title: "ITo2DChartInt.XScalingType"
description: "Specifies the type of the x-axis scaling in a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.XScalingType

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: XScalingType for CurveChart2D

Specifies the type of the x-axis scaling in a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_XScalingType_ITo2DChartInt.htm`*
