---
title: "IToContourCurveInt.EnvelopeYChannelName"
description: "Specifies the name of the y-channel of a user-defined boundary curve in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.EnvelopeYChannelName

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: EnvelopeYChannelName for ContourCurve

Specifies the name of the y-channel of a user-defined boundary curve in a contour display in DIAdem VIEW.

## Signature

```python
obj.EnvelopeYChannelName
```
...
oMyContour.DisplayEnvelope = True
oMyContour.EnvelopeType = "Channels"
oMyContour.EnvelopeXChannelName = "[11/[1]"
oMyContour.EnvelopeYChannelName = "[1]/[2]"
```
...
*Source: `Scriptview/properties/VIEW_property_EnvelopeYChannelName_IToContourCurveInt.htm`*
