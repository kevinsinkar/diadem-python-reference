---
title: "IToDimensionInt.Difference"
description: "Specifies the difference between the properties Value1 and Value2 for a cursor dimension in DIAdem VIEW."
---

# IToDimensionInt.Difference

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Difference for Dimension

Specifies the difference between the properties Value1 and Value2 for a cursor dimension in DIAdem VIEW.
...
```python
oMyObj = dd.View.Sheets(1).Cursor.Dimensions(1)
dd.MsgBoxDisp("Value 1: " + oMyObj.Value1 + " Value2: " + oMyObj.Value2 + " Diff: " + oMyObj.Difference)
```
...
*Source: `Scriptview/properties/VIEW_property_Difference_IToDimensionInt.htm`*
