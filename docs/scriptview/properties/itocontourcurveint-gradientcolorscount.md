---
title: "IToContourCurveInt.GradientColorsCount"
description: "Specifies the the number of colors in a color palette for the contour display in DIAdem VIEW."
---

# IToContourCurveInt.GradientColorsCount

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: GradientColorsCount for ContourCurve

Specifies the the number of colors in a color palette for the contour display in DIAdem VIEW.

## Signature

```python
obj.GradientColorsCount
```
...
*Source: `Scriptview/properties/VIEW_property_GradientColorsCount_IToContourCurveInt.htm`*
