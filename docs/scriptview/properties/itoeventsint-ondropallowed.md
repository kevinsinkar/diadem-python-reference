---
title: "IToEventsInt.OnDropAllowed"
...
# IToEventsInt.OnDropAllowed

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: OnDropAllowed for Events

Specifies the name of the user command which DIAdem executes when you drag and drop elements, such as one or more channels, a channel group, or one or more properties, from the Data Portal into an area in DIAdem VIEW. Use this event to determine whether dropping onto the area is allowed.
...
<p><a href="../../events/ondropallowed-ondropallowed/">OnDropAllowed</a> | <a href="#" data-unresolved="1">Objects Overview</a></p>
</div>
</div>

---

*Source: `Scriptview/properties/VIEW_property_OnDropAllowed_IToEventsInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
