---
title: "IToContourCurveInt.YChannelName"
description: "Specifies the name of the y-channel of a contour in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.YChannelName

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: YChannelName for ContourCurve

Specifies the name of the y-channel of a contour in a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_YChannelName_IToContourCurveInt.htm`*
