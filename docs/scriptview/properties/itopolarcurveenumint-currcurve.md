---
title: "IToPolarCurveEnumInt.CurrCurve"
description: "Returns the curve of a polar axis system of DIAdem VIEW with the legend that includes the formula expression which uses this property."
---

# IToPolarCurveEnumInt.CurrCurve

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: CurrCurve for PolarCurves

Returns the curve of a polar axis system of DIAdem VIEW with the legend that includes the formula expression which uses this property.
...
*Source: `Scriptview/properties/VIEW_property_CurrCurve_IToPolarCurveEnumInt.htm`*
