---
title: "IToCoordinateDisplayInt.Width"
description: "Specifies the width of the DIAdem VIEW coordinate window, in pixels."
---

# IToCoordinateDisplayInt.Width

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Width for CoordinateWnd

Specifies the width of the DIAdem VIEW coordinate window, in pixels.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The value -1 refers to the default width.</td></tr></table>
</div>

## Python example

```python
dd.MsgBoxDisp(dd.View.CoordinateWnd.Width)
```
...
*Source: `Scriptview/properties/VIEW_property_Width_IToCoordinateDisplayInt.htm`*
