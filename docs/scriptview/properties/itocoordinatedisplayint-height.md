---
title: "IToCoordinateDisplayInt.Height"
description: "Specifies the height of the DIAdem VIEW coordinate window, in pixels."
---

# IToCoordinateDisplayInt.Height

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Height for CoordinateWnd

Specifies the height of the DIAdem VIEW coordinate window, in pixels.
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The value <span class="Monospace">-1</span> specifies the default height.</td></tr></table>
</div>

## Python example

```python
dd.MsgBoxDisp(dd.View.CoordinateWnd.Height)
```
...
*Source: `Scriptview/properties/VIEW_property_Height_IToCoordinateDisplayInt.htm`*
