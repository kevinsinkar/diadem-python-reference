---
title: "ITo2DChartInt.LegendItems"
description: "Returns a collection of the legend entries of a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.LegendItems

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: LegendWidth for CurveChart2D

Returns a collection of the legend entries of a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_LegendItems_ITo2DChartInt.htm`*
