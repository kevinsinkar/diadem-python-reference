---
title: "IToDimensionInt.Type"
description: "Specifies the type of a cursor dimension in DIAdem VIEW."
---

# IToDimensionInt.Type

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Type for Dimension

Specifies the type of a cursor dimension in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Type_IToDimensionInt.htm`*
