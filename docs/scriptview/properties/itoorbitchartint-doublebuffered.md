---
title: "IToOrbitChartInt.DoubleBuffered"
description: "Specifies whether DIAdem plots an orbit axis system without flickers during the update in DIAdem VIEW."
---

# IToOrbitChartInt.DoubleBuffered

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DoubleBuffered for Orbit

Specifies whether DIAdem plots an orbit axis system without flickers during the update in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_DoubleBuffered_IToOrbitChartInt.htm`*
