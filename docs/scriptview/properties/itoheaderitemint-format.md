---
title: "IToHeaderItemInt.Format"
description: "Specifies the Format definition of the texts and numbers in the heading of a channel table in DIAdem VIEW."
---

# IToHeaderItemInt.Format

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Format for HeaderItem

Specifies the Format definition of the texts and numbers in the heading of a channel table in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Format_IToHeaderItemInt.htm`*
