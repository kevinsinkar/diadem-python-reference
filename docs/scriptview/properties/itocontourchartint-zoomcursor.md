---
title: "IToContourChartInt.ZoomCursor"
description: "Specifies the zoom function for a contour display in DIAdem VIEW."
---

# IToContourChartInt.ZoomCursor

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ZoomCursor for Contour

Specifies the zoom function for a contour display in DIAdem VIEW.
...
oMyDispObj = dd.View.Sheets(1).Areas(1).DisplayObj
oMyContour = oMyDispObj.CurvesContour.AddContour("[1]/[1]","[1]/[2]","[1]/[3]")
oMyContour.Structure = "Triplet"
oMyDispObj.ZoomCursor = "FrameZoomCursor"
```
...
*Source: `Scriptview/properties/VIEW_property_ZoomCursor_IToContourChartInt.htm`*
