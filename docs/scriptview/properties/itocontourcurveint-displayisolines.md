---
title: "IToContourCurveInt.DisplayIsolines"
description: "Specifies whether DIAdem displays the isolines defined in the contour table in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.DisplayIsolines

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DisplayIsolines for ContourCurve

Specifies whether DIAdem displays the isolines defined in the contour table in a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_DisplayIsolines_IToContourCurveInt.htm`*
