---
title: "IToDropEventContext.Area"
description: "Returns the area in DIAdem VIEW onto which data was dropped."
---

# IToDropEventContext.Area

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Area for DropEventContext

Returns the area in DIAdem VIEW onto which data was dropped.
...
*Source: `Scriptview/properties/VIEW_property_Area_IToDropEventContext.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
