---
title: "ITo2DChartInt.XBegin"
description: "Returns the beginning of the x-axis value range in a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.XBegin

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: XBegin for CurveChart2D

Returns the beginning of the x-axis value range in a 2D axis system in DIAdem VIEW.
...
<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The <span class="Monospace">XBegin</span> property does not return a valid value for the scaling mode <span class="Monospace">n Systems [phys.]</span>.</td></tr></table>
<table class="Borderless">
<tr>
<td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The <span class="Monospace">XBegin</span> property contains the value of the last display in DIAdem VIEW.</td>
</tr>
</table>
</div>
...
*Source: `Scriptview/properties/VIEW_property_XBegin_ITo2DChartInt.htm`*
