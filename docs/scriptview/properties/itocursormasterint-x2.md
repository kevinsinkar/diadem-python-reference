---
title: "IToCursorMasterInt.X2"
description: "Specifies the x-value of the right cursor line of a band or frame cursor in DIAdem VIEW."
---

# IToCursorMasterInt.X2

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: X2 for Cursor

Specifies the x-value of the right cursor line of a band or frame cursor in DIAdem VIEW.
...
```python
dd.View.ActiveSheet.Cursor.Type = "Frame"
...
*Source: `Scriptview/properties/VIEW_property_X2_IToCursorMasterInt.htm`*
