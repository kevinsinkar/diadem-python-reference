---
title: "IToIsolineInt.YChannelName"
description: "Specifies the name of the y-channel of an isoline in a contour display in DIAdem VIEW."
---

# IToIsolineInt.YChannelName

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: YChannelName for Isoline

Specifies the name of the y-channel of an isoline in a contour display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_YChannelName_IToIsolineInt.htm`*
