---
title: "IToContourChartInt.XBegin"
description: "Returns the beginning of the value range of an x-axis of a contour display in DIAdem VIEW."
---

# IToContourChartInt.XBegin

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: XBegin for Contour

Returns the beginning of the value range of an x-axis of a contour display in DIAdem VIEW.
...
if oMyChart.DisplayObjType == "Contour" :
    ...
    dd.LogfileWrite("No Contour area")
```
...
*Source: `Scriptview/properties/VIEW_property_XBegin_IToContourChartInt.htm`*
