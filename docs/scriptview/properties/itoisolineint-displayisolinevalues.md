---
title: "IToIsolineInt.DisplayIsolineValues"
description: "Specifies whether DIAdem labels the additional isoline in a contour display in DIAdem VIEW with its contour value."
---

# IToIsolineInt.DisplayIsolineValues

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DisplayIsolineValues for Isoline

Specifies whether DIAdem labels the additional isoline in a contour display in DIAdem VIEW with its contour value.

## Signature

```python
obj.DisplayIsolineValues
```

## Notes

<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>Enter the isovalue into the <span class="Monospace">ResultIsovalue</span> custom properties of the respective x-channels and y-channels. When DIAdem runs a <a href="#" data-unresolved="1">contour line calculation</a>, DIAdem saves the contour value in the <span class="Monospace">ResultIsovalue</span> custom property of the respective result channels.</td></tr></table>
</div>
...
oMyCurve = oMyObj.CurvesContour.AddIsoline("[1]/[1]","[1]/[4]")
oMyCurve.DisplayIsolineValues = True
```
...
*Source: `Scriptview/properties/VIEW_property_DisplayIsolineValues_IToIsolineInt.htm`*
