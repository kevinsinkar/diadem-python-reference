---
title: "IToContourCurveInt.EnvelopeXChannelName"
description: "Specifies the name of the x-channel of a user-defined boundary curve in a contour display in DIAdem VIEW."
---

# IToContourCurveInt.EnvelopeXChannelName

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: EnvelopeXChannelName for ContourCurve

Specifies the name of the x-channel of a user-defined boundary curve in a contour display in DIAdem VIEW.

## Signature

```python
obj.EnvelopeXChannelName
```
...
oMyContour.EnvelopeXChannelName = "[1]/[1]"
...
*Source: `Scriptview/properties/VIEW_property_EnvelopeXChannelName_IToContourCurveInt.htm`*
