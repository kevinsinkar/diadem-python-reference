---
title: "IToCursorMasterInt.P2"
description: "Specifies the point number of the right band cursor or frame cursor in relation to the leading curve in DIAdem VIEW."
---

# IToCursorMasterInt.P2

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: P2 for Cursor

Specifies the point number of the right band cursor or frame cursor in relation to the leading curve in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_P2_IToCursorMasterInt.htm`*
