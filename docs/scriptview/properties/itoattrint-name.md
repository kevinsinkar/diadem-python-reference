---
title: "IToAttrInt.Name"
description: "Returns the name of a legend entry in a 2D axis system in DIAdem VIEW."
---
...
Returns the name of a legend entry in a 2D axis system in DIAdem VIEW.
...
for oMyLegendItem in oMyLegends:
    dd.MsgBoxDisp("Name of LegendItem: " + oMyLegendItem.Name)
```
...
*Source: `Scriptview/properties/VIEW_property_Name_IToAttrInt.htm`*
