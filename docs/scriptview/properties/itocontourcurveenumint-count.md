---
title: "IToContourCurveEnumInt.Count"
description: "Returns the number of elements in a Contour collection in DIAdem VIEW."
---

# IToContourCurveEnumInt.Count

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Count for ContourCurves

Returns the number of elements in a Contour collection in DIAdem VIEW.
...
```python
dd.MsgBoxDisp("Number of Curves: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour.Count)
```
...
*Source: `Scriptview/properties/VIEW_property_Count_IToContourCurveEnumInt.htm`*
