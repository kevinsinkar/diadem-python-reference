---
title: "IToBodeCurveEnumInt.CurrCurve"
description: "Returns the curve of a Bode axis system from DIAdem VIEW with the legend that includes the formula expression which uses this property."
---

# IToBodeCurveEnumInt.CurrCurve

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: CurrCurve for BodeCurves

Returns the curve of a Bode axis system from DIAdem VIEW with the legend that includes the formula expression which uses this property.
...
oMyCurve = oMyChart.CurvesBode.Add("[1]/[1]","[1]/[2]","[1]/[3]")
...
*Source: `Scriptview/properties/VIEW_property_CurrCurve_IToBodeCurveEnumInt.htm`*
