---
title: "IToCursorMasterInt.Interpolating"
description: "Specifies whether interpolates the coordinates of all curves when moving the curve cursor."
---

# IToCursorMasterInt.Interpolating

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Interpolating for Cursor

Specifies whether interpolates the coordinates of all curves when moving the curve cursor.
...
```python
oMySheet = dd.View.ActiveSheet.Cursor.Type = "Crosshair"
oMySheet.Cursor.Interpolating = True
...
*Source: `Scriptview/properties/VIEW_property_Interpolating_IToCursorMasterInt.htm`*
