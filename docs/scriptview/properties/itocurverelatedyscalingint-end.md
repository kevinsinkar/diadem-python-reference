---
title: "IToCurveRelatedYScalingInt.End"
description: "Specifies the end of the value range of a curve-related manual y-scaling of a 2D axis system in DIAdem VIEW."
---

# IToCurveRelatedYScalingInt.End

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: End for CurveRelatedYScaling

Specifies the end of the value range of a curve-related manual y-scaling of a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_End_IToCurveRelatedYScalingInt.htm`*
