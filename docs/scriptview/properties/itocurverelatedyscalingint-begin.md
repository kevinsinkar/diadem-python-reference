---
title: "IToCurveRelatedYScalingInt.Begin"
description: "Specifies the start of the value range of a curve-related manual y-scaling of a 2D axis system in DIAdem VIEW."
---

# IToCurveRelatedYScalingInt.Begin

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Begin for CurveRelatedYScaling

Specifies the start of the value range of a curve-related manual y-scaling of a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Begin_IToCurveRelatedYScalingInt.htm`*
