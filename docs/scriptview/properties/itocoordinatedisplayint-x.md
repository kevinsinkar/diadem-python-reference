---
title: "IToCoordinateDisplayInt.X"
description: "Returns the x-position of the coordinate window in DIAdem VIEW."
---

# IToCoordinateDisplayInt.X

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: X for CoordinateWnd

Returns the x-position of the coordinate window in DIAdem VIEW.
...
dd.MsgBoxDisp("X position: " + dd.View.CoordinateWnd.X  + "\r\n" + "Y position: " + dd.View.CoordinateWnd.Y)
```
...
*Source: `Scriptview/properties/VIEW_property_X_IToCoordinateDisplayInt.htm`*
