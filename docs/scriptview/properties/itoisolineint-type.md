---
title: "IToIsolineInt.Type"
description: "Specifies the display mode of a curve in a contour display in DIAdem VIEW. The property always has the value Isoline ."
---

# IToIsolineInt.Type

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Type for Isoline

Specifies the display mode of a curve in a contour display in DIAdem VIEW. The property always has the value Isoline .
...
```python
dd.MsgBoxDisp("Type: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour(2).Type)
```
...
*Source: `Scriptview/properties/VIEW_property_Type_IToIsolineInt.htm`*
