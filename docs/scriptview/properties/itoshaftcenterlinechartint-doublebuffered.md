---
title: "IToShaftCenterlineChartInt.DoubleBuffered"
description: "Specifies whether DIAdem plots a shaft centerline axis system without flickers during the update in DIAdem VIEW."
---

# IToShaftCenterlineChartInt.DoubleBuffered

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DoubleBuffered for ShaftCenterline

Specifies whether DIAdem plots a shaft centerline axis system without flickers during the update in DIAdem VIEW.
...
oMyChart.CurvesShaftCenterline.Add("[1]/[1]","[1]/[2]")
...
*Source: `Scriptview/properties/VIEW_property_DoubleBuffered_IToShaftCenterlineChartInt.htm`*
