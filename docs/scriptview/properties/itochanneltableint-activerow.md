---
title: "IToChannelTableInt.ActiveRow"
description: "Returns the active row of a channel table in DIAdem VIEW."
---

# IToChannelTableInt.ActiveRow

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ActiveRow for ChannelTable

Returns the active row of a channel table in DIAdem VIEW.
...
if dd.View.ActiveSheet.ActiveArea.DisplayObjType == "ChannelTable" :
    dd.MsgBoxDisp("Active column: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.ActiveRow)
else:
...
*Source: `Scriptview/properties/VIEW_property_ActiveRow_IToChannelTableInt.htm`*
