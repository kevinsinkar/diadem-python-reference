---
title: "IToIsolineInt.Name"
description: "Specifies the name of an isoline in a contour display in DIAdem VIEW."
---

# IToIsolineInt.Name

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Name for Isoline

Specifies the name of an isoline in a contour display in DIAdem VIEW.
...
oMyCurve = dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour.AddIsoline("[1]/[1]","[1]/[2]")
dd.MsgBoxDisp(oMyCurve.Name)
```
...
*Source: `Scriptview/properties/VIEW_property_Name_IToIsolineInt.htm`*
