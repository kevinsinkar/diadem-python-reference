---
title: "IToCursorMasterInt.Type"
description: "Specifies the cursor type for a worksheet in DIAdem VIEW."
---

# IToCursorMasterInt.Type

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Type for Cursor

Specifies the cursor type for a worksheet in DIAdem VIEW.
...
```python
dd.View.ActiveSheet.Cursor.Type = "Band"
```
...
*Source: `Scriptview/properties/VIEW_property_Type_IToCursorMasterInt.htm`*
