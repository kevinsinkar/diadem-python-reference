---
title: "IToOrderLineInt.Color"
description: "Specifies the color of an order line in a cascade display in DIAdem VIEW."
---

# IToOrderLineInt.Color

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Color for OrderLine

Specifies the color of an order line in a cascade display in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Color_IToOrderLineInt.htm`*
