---
title: "IToCursorMasterInt.Dimensions"
description: "Returns a collection of the cursor dimensions of a worksheet in DIAdem VIEW."
---

# IToCursorMasterInt.Dimensions

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Dimensions for Cursor

Returns a collection of the cursor dimensions of a worksheet in DIAdem VIEW.
...
```python
oMyActDim = dd.View.ActiveSheet.Cursor.Dimensions
oMyActDim.Add("Frequency")
```
...
*Source: `Scriptview/properties/VIEW_property_Dimensions_IToCursorMasterInt.htm`*
