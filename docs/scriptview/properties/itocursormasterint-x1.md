---
title: "IToCursorMasterInt.X1"
description: "Specifies the x-value of the crosshair cursor, or of the left band cursor of the band or frame cursor in DIAdem VIEW."
---

# IToCursorMasterInt.X1

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: X1 for Cursor

Specifies the x-value of the crosshair cursor, or of the left band cursor of the band or frame cursor in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_X1_IToCursorMasterInt.htm`*
