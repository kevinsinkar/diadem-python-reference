---
title: "IToCursorMasterInt.Y1"
description: "Specifies the y-value of the crosshair cursor, or of the left band cursor of a band or frame cursor in DIAdem VIEW."
---

# IToCursorMasterInt.Y1

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Y1 for Cursor

Specifies the y-value of the crosshair cursor, or of the left band cursor of a band or frame cursor in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_Y1_IToCursorMasterInt.htm`*
