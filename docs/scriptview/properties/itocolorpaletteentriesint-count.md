---
title: "IToColorPaletteEntriesInt.Count"
description: "Returns the number of elements in an ColorPaletteEntries collection in DIAdem VIEW."
---

# IToColorPaletteEntriesInt.Count

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: Count for ColorPaletteEntries

Returns the number of elements in an ColorPaletteEntries collection in DIAdem VIEW.
...
```python
MyObj = dd.View.ActiveSheet.ActiveArea.DisplayObj.UserDefinedColoringEntries
for i in range( 1, MyObj.Count+1):
    dd.LogfileWrite("Color: " + MyObj(i).Color + " / Value: " + MyObj(i).Value)
```
...
*Source: `Scriptview/properties/VIEW_property_Count_IToColorPaletteEntriesInt.htm`*
