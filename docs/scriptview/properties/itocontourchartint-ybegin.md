---
title: "IToContourChartInt.YBegin"
description: "Returns the beginning of the value range of a y-axis in a contour display in DIAdem VIEW."
---

# IToContourChartInt.YBegin

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: YBegin for Contour

Returns the beginning of the value range of a y-axis in a contour display in DIAdem VIEW.
...
<div markdown="1">
<table class="Borderless" id="table2"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The <span class="Monospace">YBegin</span> property contains the value of the last display in DIAdem VIEW.</td></tr></table>
</div>
...
*Source: `Scriptview/properties/VIEW_property_YBegin_IToContourChartInt.htm`*
