---
title: "IToCursorMasterInt.ConstantDeltas"
description: "Specifies whether DIAdem keeps the intervals between the dX cursor line and the dY cursor line constant or whether DIAdem positions both cursor lines on one cur"
---

# IToCursorMasterInt.ConstantDeltas

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: ConstantDeltas for Cursor

Specifies whether DIAdem keeps the intervals between the dX cursor line and the dY cursor line constant or whether DIAdem positions both cursor lines on one curve point, when you select a band cursor or a frame cursor in DIAdem VIEW.
...
```python
dd.View.Sheets(1).Cursor.Type = "Band"
dd.View.ActiveSheet.Cursor.X1 = 10
dd.View.ActiveSheet.Cursor.X2 = 30
dd.View.ActiveSheet.Cursor.ConstantDeltas = True
...
*Source: `Scriptview/properties/VIEW_property_ConstantDeltas_IToCursorMasterInt.htm`*
