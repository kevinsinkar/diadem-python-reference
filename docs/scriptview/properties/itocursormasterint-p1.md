---
title: "IToCursorMasterInt.P1"
description: "Specifies the point numbers of the crosshair cursor or of the left band cursor or the left frame cursor in relation to the leading curve in DIAdem VIEW."
---

# IToCursorMasterInt.P1

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: P1 for Cursor

Specifies the point numbers of the crosshair cursor or of the left band cursor or the left frame cursor in relation to the leading curve in DIAdem VIEW.
...
dd.View.ActiveSheet.Cursor.P1 = 10
dd.View.ActiveSheet.Cursor.P2 = 20
dd.WndShow ("VIEW")
