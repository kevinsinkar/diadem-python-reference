---
title: "IToCursorMasterInt.DX"
description: "Returns the distance between the right and the left cursor for the band cursor and the frame cursor in DIAdem VIEW."
---

# IToCursorMasterInt.DX

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: DX for Cursor

Returns the distance between the right and the left cursor for the band cursor and the frame cursor in DIAdem VIEW.
...
*Source: `Scriptview/properties/VIEW_property_DX_IToCursorMasterInt.htm`*
