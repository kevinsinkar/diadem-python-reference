---
title: "IToBirdsEyeViewChartInt.FieldsOfView"
description: "Returns a collection of sensor fields of view in a bird's eye view display in DIAdem VIEW."
---

# IToBirdsEyeViewChartInt.FieldsOfView

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: FieldsOfView for BirdsEyeView

Returns a collection of sensor fields of view in a bird's eye view display in DIAdem VIEW.

## Signature

```python
return_value = obj.FieldsOfView
```
...
*Source: `Scriptview/properties/VIEW_property_FieldsOfView_IToBirdsEyeViewChartInt.htm`*
