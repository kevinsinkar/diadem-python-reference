---
title: "ITo2DChartInt.YEnd"
description: "Returns the end of the value range of the y-axis of a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.YEnd

!!! abstract "Property &middot; `Scriptview.chm`"
    Property: YEnd for CurveChart2D

Returns the end of the value range of the y-axis of a 2D axis system in DIAdem VIEW.
...
<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The <span class="Monospace">YEnd</span> property does not return a valid value for the scaling mode <span class="Monospace">n Systems [phys.]</span>.</td></tr></table>
<table class="Borderless">
<tr>
<td class="Icon"><img height="25" src="../image/note.gif" width="26"/></td><td><strong>Note  </strong>The <span class="Monospace">YEnd</span> property contains the value of the last display in DIAdem VIEW.</td>
</tr>
</table>
</div>
...
*Source: `Scriptview/properties/VIEW_property_YEnd_ITo2DChartInt.htm`*
