...
description: "Is triggered when an item in a context menu is selected in DIAdem VIEW."
---
...
Is triggered when an item in a context menu is selected in DIAdem VIEW.
...
<p class="body"> <a href="../../properties/itoeventsint-oncontextmenupointselected/">OnContextMenuPointSelected</a> | <a href="#" data-unresolved="1">Objects Overview</a></p>
</div>
</div>

---

*Source: `Scriptview/events/VIEW_events_OnContextMenuPointSelected.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
