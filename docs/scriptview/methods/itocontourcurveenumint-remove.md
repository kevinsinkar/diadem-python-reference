---
title: "IToContourCurveEnumInt.Remove"
description: "Deletes one element from the ContourCurves collection."
---

# IToContourCurveEnumInt.Remove

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Remove for ContourCurves

Deletes one element from the ContourCurves collection.
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour.Remove(1)
```
...
*Source: `Scriptview/methods/VIEW_method_Remove_IToContourCurveEnumInt.htm`*
