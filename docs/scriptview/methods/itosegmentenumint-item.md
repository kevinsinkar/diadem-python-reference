---
title: "IToSegmentEnumInt.Item"
description: "Returns the Segment object associated with a specific name or index in DIAdem VIEW."
---

# IToSegmentEnumInt.Item
...
```python
dd.MsgBoxDisp("Name of first x-channel: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.Segments.Item(1).XChannelName)
dd.MsgBoxDisp("Name of first x-channel: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.Segments(1).XChannelName)
```
...
*Source: `Scriptview/methods/VIEW_method_Item_IToSegmentEnumInt.htm`*
