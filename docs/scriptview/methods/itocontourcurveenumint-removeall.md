---
title: "IToContourCurveEnumInt.RemoveAll"
description: "Deletes all elements from the ContourCurves collection."
---

# IToContourCurveEnumInt.RemoveAll

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: RemoveAll for ContourCurves

Deletes all elements from the ContourCurves collection.
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.CurvesContour.RemoveAll()
```
...
*Source: `Scriptview/methods/VIEW_method_RemoveAll_IToContourCurveEnumInt.htm`*
