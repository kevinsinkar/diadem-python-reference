---
title: "IToCursorMasterInt.Forwards"
description: "Moves the cursor forwards along the enabled curve of the enabled range in one big step, or displays a later video frame of the enabled range."
---

# IToCursorMasterInt.Forwards

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Forwards for Cursor

Moves the cursor forwards along the enabled curve of the enabled range in one big step, or displays a later video frame of the enabled range.
...
*Source: `Scriptview/methods/VIEW_method_Forwards_IToCursorMasterInt.htm`*
