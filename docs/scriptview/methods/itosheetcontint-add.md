---
title: "IToSheetContInt.Add"
description: "Adds an object to the Sheets collection and returns a Sheet object, in the script interface of DIAdem VIEW."
---
...
*Source: `Scriptview/methods/VIEW_method_Add_IToSheetContInt.htm`*
