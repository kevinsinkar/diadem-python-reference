---
title: "IToHeaderItems.Remove"
description: "Deletes one element from the HeaderItems collection."
---

# IToHeaderItems.Remove
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.HeaderItems.Remove("Name")
```
...
*Source: `Scriptview/methods/VIEW_method_Remove_IToHeaderItems.htm`*
