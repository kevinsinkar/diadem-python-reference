---
title: "IToFieldOfViewListInt.Add"
description: "Adds an object to the FieldsOfView collection and returns a FieldOfView object, in the script interface of DIAdem VIEW. A FieldOfView object corresponds to a se"
---

# IToFieldOfViewListInt.Add
...
```python
return_value = obj.Add(LateralDistance, LongitudinalDistance, OrientationAngle, ApertureAngle, Radius, FillTransparency)
```
...
*Source: `Scriptview/methods/VIEW_method_Add_IToFieldOfViewListInt.htm`*
