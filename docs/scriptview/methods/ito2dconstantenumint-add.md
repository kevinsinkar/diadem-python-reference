---
title: "ITo2DConstantEnumInt.Add"
description: "Adds an object to the Constants collection and returns a Constant object in the script interface of DIAdem VIEW."
---

# ITo2DConstantEnumInt.Add
...
```python
return_value = obj.Add(ValueExpression, Direction)
```
...
*Source: `Scriptview/methods/VIEW_method_Add_ITo2DConstantEnumInt.htm`*
