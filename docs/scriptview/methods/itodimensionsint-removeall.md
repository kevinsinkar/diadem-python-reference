---
title: "IToDimensionsInt.RemoveAll"
description: "Deletes all elements from the Dimensions collection."
---

# IToDimensionsInt.RemoveAll

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: RemoveAll for Dimensions
...
```python
dd.View.ActiveSheet.Cursor.Dimensions.RemoveAll()
```
...
*Source: `Scriptview/methods/VIEW_method_RemoveAll_IToDimensionsInt.htm`*
