---
title: "IToCascadeCurveEnumInt.AddLine"
description: "Adds an object to the CascadeCurve collection and returns a Line object in the DIAdem VIEW script interface."
---

# IToCascadeCurveEnumInt.AddLine
...
```python
return_value = obj.AddLine(XNameOrNo, YNameOrNo)
```
...
*Source: `Scriptview/methods/VIEW_method_AddLine_IToCascadeCurveEnumInt.htm`*
