---
title: "IToDimensionsInt.Item"
description: "Returns the Dimension object associated with a specific name or index in DIAdem VIEW."
---

# IToDimensionsInt.Item

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Item for Dimensions

Returns the Dimension object associated with a specific name or index in DIAdem VIEW.
...
```python
dd.MsgBoxDisp("Name of first dimension: " + dd.View.ActiveSheet.Cursor.Dimensions.Item(1).Name)
dd.MsgBoxDisp("Name of first dimension: " + dd.View.ActiveSheet.Cursor.Dimensions(1).Name)
```
...
*Source: `Scriptview/methods/VIEW_method_Item_IToDimensionsInt.htm`*
