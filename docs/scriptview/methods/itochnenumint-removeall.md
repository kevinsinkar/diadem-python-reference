---
title: "IToChnEnumInt.RemoveAll"
description: "Deletes all elements from the Columns collection."
---

# IToChnEnumInt.RemoveAll
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.Columns.RemoveAll()
```
...
*Source: `Scriptview/methods/VIEW_method_RemoveAll_IToChnEnumInt.htm`*
