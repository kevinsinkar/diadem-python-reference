---
title: "IToCursorMasterInt.Backwards"
description: "Moves the cursor backwards along the enabled curve of the enabled range in one big step, or displays a previous video frame of the enabled range."
---

# IToCursorMasterInt.Backwards
...
*Source: `Scriptview/methods/VIEW_method_Backwards_IToCursorMasterInt.htm`*
