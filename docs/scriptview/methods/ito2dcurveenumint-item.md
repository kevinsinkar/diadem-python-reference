---
title: "ITo2DCurveEnumInt.Item"
description: "Returns the 2DCurve object associated with a specific name or index in DIAdem VIEW."
---

# ITo2DCurveEnumInt.Item
...
```python
dd.MsgBoxDisp("Name of first x-channel: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.Curves2D.Item(1).XChannelName)
dd.MsgBoxDisp("Name of first x-channel: " + dd.View.ActiveSheet.ActiveArea.DisplayObj.Curves2D(1).XChannelName)
```
...
*Source: `Scriptview/methods/VIEW_method_Item_ITo2DCurveEnumInt.htm`*
