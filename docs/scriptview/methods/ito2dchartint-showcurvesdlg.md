---
title: "ITo2DChartInt.ShowCurvesDlg"
description: "Opens the dialog box where you specify the curves in a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.ShowCurvesDlg

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: ShowCurvesDlg for CurveChart2D

Opens the dialog box where you specify the curves in a 2D axis system in DIAdem VIEW.
...
*Source: `Scriptview/methods/VIEW_method_ShowCurvesDlg_ITo2DChartInt.htm`*
