---
title: "IToColorPaletteEntriesInt.Add"
description: "Adds an object to the ColorPaletteEntries collection and returns a ColorPaletteEntry object, in the script interface of DIAdem VIEW."
---

# IToColorPaletteEntriesInt.Add

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Add for ColorPaletteEntries

Adds an object to the ColorPaletteEntries collection and returns a ColorPaletteEntry object, in the script interface of DIAdem VIEW.

## Signature

```python
return_value = obj.Add(Value, Color, ColorRGB)
```
...
*Source: `Scriptview/methods/VIEW_method_Add_IToColorPaletteEntriesInt.htm`*
