---
title: "IToDimensionsInt.Add"
description: "Adds an object to the Dimensions collection and returns a Dimension object in the script interface of DIAdem VIEW."
---

# IToDimensionsInt.Add

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Add for Dimensions

Adds an object to the Dimensions collection and returns a Dimension object in the script interface of DIAdem VIEW.
...
```python
dd.View.ActiveSheet.Cursor.Dimensions.Add("Frequency")
```
...
*Source: `Scriptview/methods/VIEW_method_Add_IToDimensionsInt.htm`*
