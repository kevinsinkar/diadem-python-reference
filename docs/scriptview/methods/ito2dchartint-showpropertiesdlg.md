---
title: "ITo2DChartInt.ShowPropertiesDlg"
description: "Opens the dialog box where you select the channel properties which DIAdem displays in the legend of a 2D axis system in DIAdem VIEW."
---

# ITo2DChartInt.ShowPropertiesDlg
...
dd.View.Sheets(1).Areas(1).DisplayObj.ShowPropertiesDlg()
```
