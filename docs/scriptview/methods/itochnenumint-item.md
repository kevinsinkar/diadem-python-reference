---
title: "IToChnEnumInt.Item"
description: "Returns the Column object associated with a specific name or index in DIAdem VIEW."
---
...
```python
dd.MsgBoxDisp("Name of first column: " + dd.View.ActiveSheet.Cursor.Dimensions.Item(1).Name)
dd.MsgBoxDisp("Name of first column: " + dd.View.ActiveSheet.Cursor.Dimension(1).Name)
```
...
*Source: `Scriptview/methods/VIEW_method_Item_IToChnEnumInt.htm`*
