---
title: "IToContourChartInt.ShowPropertiesDlg"
description: "Opens the dialog box where you select the channel properties which DIAdem displays in the legend of a contour display in DIAdem VIEW."
---

# IToContourChartInt.ShowPropertiesDlg

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: ShowPropertiesDlg for Contour

Opens the dialog box where you select the channel properties which DIAdem displays in the legend of a contour display in DIAdem VIEW.
...
*Source: `Scriptview/methods/VIEW_method_ShowPropertiesDlg_IToContourChartInt.htm`*
