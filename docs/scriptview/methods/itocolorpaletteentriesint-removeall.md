---
title: "IToColorPaletteEntriesInt.RemoveAll"
description: "Deletes all elements from the ColorPaletteEntries collection."
---

# IToColorPaletteEntriesInt.RemoveAll

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: RemoveAll for ColorPaletteEntries

Deletes all elements from the ColorPaletteEntries collection.
...
*Source: `Scriptview/methods/VIEW_method_RemoveAll_IToColorPaletteEntriesInt.htm`*
