---
title: "IToColorPaletteEntriesInt.Remove"
description: "Deletes one element from the ColorPaletteEntries collection."
---

# IToColorPaletteEntriesInt.Remove

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Remove for ColorPaletteEntries

Deletes one element from the ColorPaletteEntries collection.
...
*Source: `Scriptview/methods/VIEW_method_Remove_IToColorPaletteEntriesInt.htm`*
