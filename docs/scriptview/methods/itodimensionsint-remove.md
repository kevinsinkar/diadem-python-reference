---
title: "IToDimensionsInt.Remove"
description: "Deletes one element from the Dimensions collection."
---

# IToDimensionsInt.Remove

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: Remove for Dimensions

Deletes one element from the Dimensions collection.
...
```python
dd.View.ActiveSheet.Cursor.Dimensions.Remove(4)
```
...
*Source: `Scriptview/methods/VIEW_method_Remove_IToDimensionsInt.htm`*
