---
title: "ITo2DCurveEnumInt.Remove"
description: "Deletes one element from the 2DCurves collection."
---

# ITo2DCurveEnumInt.Remove
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.Curves2D.Remove(1)
```
...
*Source: `Scriptview/methods/VIEW_method_Remove_ITo2DCurveEnumInt.htm`*
