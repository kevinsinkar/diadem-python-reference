---
title: "IToContourCurveEnumInt.AddIsoline"
description: "Adds an object to the Curves collection and returns a Curve object in the script interface of DIAdem VIEW."
---

# IToContourCurveEnumInt.AddIsoline

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: AddIsoline for ContourCurves

Adds an object to the Curves collection and returns a Curve object in the script interface of DIAdem VIEW.

## Signature

```python
return_value = obj.AddIsoline(XNameOrNo, YNameOrNo)
```
...
oMyArea.DisplayObj.CurvesContour.AddContour("[1]/[1]","[1]/[2]","[1]/[3]")
oMyArea.DisplayObj.CurvesContour(1).Structure = "Triplet"
oMyArea.DisplayObj.CurvesContour.AddIsoline("[1]/[1]","[1]/[2]")
```
...
*Source: `Scriptview/methods/VIEW_method_AddIsoline_IToContourCurveEnumInt.htm`*
