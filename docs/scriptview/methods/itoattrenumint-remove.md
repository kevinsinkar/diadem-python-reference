---
title: "IToAttrEnumInt.Remove"
description: "Deletes one element from the LegendItems collection."
---

# IToAttrEnumInt.Remove
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.LegendItems.Remove("Name")
```
...
*Source: `Scriptview/methods/VIEW_method_Remove_IToAttrEnumInt.htm`*
