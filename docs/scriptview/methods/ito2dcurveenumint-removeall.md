---
title: "ITo2DCurveEnumInt.RemoveAll"
description: "Deletes all elements from the 2DCurves collection."
---

# ITo2DCurveEnumInt.RemoveAll
...
```python
dd.View.ActiveSheet.ActiveArea.DisplayObj.Curves2D.RemoveAll()
```
...
*Source: `Scriptview/methods/VIEW_method_RemoveAll_ITo2DCurveEnumInt.htm`*
