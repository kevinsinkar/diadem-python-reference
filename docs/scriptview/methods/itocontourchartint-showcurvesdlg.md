---
title: "IToContourChartInt.ShowCurvesDlg"
description: "Opens the dialog box where you specify the curves in a contour display in DIAdem VIEW."
---

# IToContourChartInt.ShowCurvesDlg

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: ShowCurvesDlg for Contour

Opens the dialog box where you specify the curves in a contour display in DIAdem VIEW.
...
dd.View.Sheets(1).Areas(1).DisplayObj.ShowCurvesDlg()
```
...
*Source: `Scriptview/methods/VIEW_method_ShowCurvesDlg_IToContourChartInt.htm`*
