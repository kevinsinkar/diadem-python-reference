---
title: "ITo2DCurveEnumInt.Add"
description: "Adds an object to the 2DCurves collection and returns a 2DCurve object, in the script interface of DIAdem VIEW."
---

# ITo2DCurveEnumInt.Add
...
oMySheet.ActiveArea.DisplayObj.Curves2D.Add("[1]/[1]","[1]/[2]")
```
...
*Source: `Scriptview/methods/VIEW_method_Add_ITo2DCurveEnumInt.htm`*
