---
title: "IToContourCurveEnumInt.AddContour"
description: "Adds an object to the Curves collection in DIAdem VIEW and returns a Curve object:"
---

# IToContourCurveEnumInt.AddContour

!!! abstract "Method &middot; `Scriptview.chm`"
    Method: AddContour for ContourCurves

Adds an object to the Curves collection in DIAdem VIEW and returns a Curve object:

## Signature

```python
return_value = obj.AddContour(XNameOrNo, YNameOrNo, ZNameOrNo)
```
...
*Source: `Scriptview/methods/VIEW_method_AddContour_IToContourCurveEnumInt.htm`*
