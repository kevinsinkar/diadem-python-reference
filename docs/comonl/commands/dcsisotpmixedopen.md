---
title: "DCSISOTPMixedOpen"
description: "Starts a diagnosis session over a CAN port using the ISO TP mixed mode transport protocol."
---

# DCSISOTPMixedOpen

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSISOTPMixedOpen

Starts a diagnosis session over a CAN port using the ISO TP mixed mode transport protocol.
...
<tr><td width="150">DCSTransmitExtension</td>
<td>Specifies the address extension for the transmission.<div id="exp_DCSTransmitExtension">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
<td>Access: Read only</td></tr>
...
<tr><td width="150">DCSReceiveExtension</td>
<td>Specifies the address extension.<div id="exp_DCSReceiveExtension">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
<td>Access: Read only</td></tr>
...
*Source: `ComOnl/DCSISOTPMixedOpen.htm`*
