---
title: "DCSVWTPOpen"
description: "Starts a diagnosis session over the VW TP 2.0 transmission protocol without starting communication with the engine control unit (ECU)."
---
...
Starts a diagnosis session over the VW TP 2.0 transmission protocol without starting communication with the engine control unit (ECU).
