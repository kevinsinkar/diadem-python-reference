---
title: "OPCClearGroup"
description: "Deletes all OPC items of an OPC group."
---

# OPCClearGroup

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCClearGroup

Deletes all OPC items of an OPC group.

## Signature

```python
dd.OPCClearGroup(OPCGrpHandle)
```
...
*Source: `ComOnl/OPCClearGroup.htm`*
