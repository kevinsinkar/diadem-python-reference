---
title: "ECUCCPActionService"
description: "Calls an implementation-specific service on the ECU (CCP only)."
---

# ECUCCPActionService

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: ECUCCPActionService

Calls an implementation-specific service on the ECU (CCP only).
...
*Source: `ComOnl/ECUCCPActionService.htm`*
