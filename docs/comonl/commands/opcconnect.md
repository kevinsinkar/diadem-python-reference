---
title: "OPCConnect"
description: "Connects an OPC server."
---
...
```python
dd.OPCConnect(OPCSrvName, OPCConnectTO)
```
...
<tr>
<td width="150">OPCSrvHandle</td>
<td>Receives the handle for the connection to the OPC server.<div id="exp_OPCSrvHandle">
<table class="Borderless" id="table7">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a></td>
</tr>
<tr>
<td>0 &lt;= OPCSrvHandle &lt;= 2147483647</td>
</tr>
</table>
</div>
</td>
