---
title: "DCSUDS06MemoryRead"
description: "Reads data from the memory of the engine control unit (ECU)."
---

# DCSUDS06MemoryRead

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSUDS06MemoryRead

Reads data from the memory of the engine control unit (ECU).
...
*Source: `ComOnl/DCSUDS06MemoryRead.htm`*
