---
title: "DCSOBDEmissionDTCGet"
description: "Deletes the emission related diagnostic trouble codes (DTC)."
---

# DCSOBDEmissionDTCGet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSOBDEmissionDTCGet

Deletes the emission related diagnostic trouble codes (DTC).
...
*Source: `ComOnl/DCSOBDEmissionDTCGet.htm`*
