---
title: "DCSOBDCurrentEmissionDTCGet"
description: "Reads the emission related diagnostic trouble codes (DTC) of the current test drive cycle."
---

# DCSOBDCurrentEmissionDTCGet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSOBDCurrentEmissionDTCGet

Reads the emission related diagnostic trouble codes (DTC) of the current test drive cycle.
...
*Source: `ComOnl/DCSOBDCurrentEmissionDTCGet.htm`*
