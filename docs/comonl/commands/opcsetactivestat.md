---
title: "OPCSetActiveStat"
description: "Enables or disables OPC items of an OPC group."
---
...
```python
dd.OPCSetActiveStat(OPCGrpHandle, OPCItemNo, OPCItemActive)
```
...
<div markdown="1">
<table class="Borderless" id="table14"><tr><td width="150">OPCErrorCode</td><td>Receives the status of the OPC command.<div id="exp_OPCErrorCode">
...
<p class="Body">Specify the field length with the <a href="../../../varonl/variables/opcitemno/">OPCItemNo</a> variable.</p><p class="Body">The <span class="Monospace">aOPCItemError</span> variable can contain the following values:</p><table class="Borderless" id="table20">
<tr>
...
*Source: `ComOnl/OPCSetActiveStat.htm`*
