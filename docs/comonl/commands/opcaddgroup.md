---
title: "OPCAddGroup"
description: "Creates a new OPC group on the OPC server."
---
...
Creates a new OPC group on the OPC server.

## Signature

```python
dd.OPCAddGroup(OPCSrvHandle, OPCGrpActive, OPCUpdRate, OPCDeadband, OPCLNGID)
```
...
<tr><td width="150">OPCSrvHandle</td>
<td>Specifies the handle for the connection to the OPC server.<div id="exp_OPCSrvHandle">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
<td>0 &lt;= OPCSrvHandle &lt;= 2147483647</td></tr>
</table>
</div></td></tr>
<tr><td width="150">OPCGrpActive</td>
<td>Specifies the status of the created OPC group.<div id="exp_OPCGrpActive">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
<td>0 &lt;= OPCGrpActive &lt;= 1</td></tr>
</table>
<p>The <span class="Monospace">OPCGrpActive</span> variable can contain the following values:</p>
<table class="Borderless">
<tr>
...
<tr><td width="150"><pre><donottranslate>0</donottranslate></pre></td><td>The group is not active after it is created.</td></tr><tr><td width="150"><pre><donottranslate>1</donottranslate></pre></td><td>The group is active after it is created.</td></tr></table>
<p class="Body">
</p></div></td></tr>
...
<tr><td width="150">OPCLNGID</td>
<td>Specifies the language identifier.<div id="exp_OPCLNGID">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
<td>-2147483648 &lt;= OPCLngID &lt;= 2147483647</td></tr>
</table>
<p class="Body">
</p></div></td></tr>
</table>
...
<td>Receives the return value of the OPC command.<div id="exp_OPCHResult">
<table class="Borderless">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a></td>
</tr>
<tr>
<td>-2147483648 &lt;= OPCHResult &lt;= 2147483647</td>
</tr>
</table>
...
<tr>
<td width="150">OPCGrpHandle</td>
<td>Receives the handle of an OPC group.<div id="exp_OPCGrpHandle">
<table class="Borderless">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a></td>
</tr>
<tr>
<td>0 &lt;= OPCGrpHandle &lt;= 2147483647</td>
</tr>
</table>
</div>
</td>
...
<tr>
<td width="150">OPCUpdRate</td>
<td>Receives the current update rate if the OPC server does not accept the specified update rate.<div id="exp_OPCUpdRate_1">
<table class="Borderless">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a></td>
</tr>
<tr>
<td>0 &lt;= OPCUpdRate &lt;= 2147483647</td>
</tr>
</table>
</div>
</td>
