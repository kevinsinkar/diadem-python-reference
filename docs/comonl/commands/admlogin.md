---
title: "ADMLogin"
description: "Opens the user management dialog box where the user logs on and off."
---
...
Opens the user management dialog box where the user logs on and off.
