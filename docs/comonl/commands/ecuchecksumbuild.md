---
title: "ECUChecksumBuild"
description: "Calculates a checksum over a defined memory range within the ECU."
---

# ECUChecksumBuild

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: ECUChecksumBuild
...
*Source: `ComOnl/ECUChecksumBuild.htm`*
