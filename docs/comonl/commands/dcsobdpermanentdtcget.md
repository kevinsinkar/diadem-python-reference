---
title: "DCSOBDPermanentDTCGet"
description: "Reads all permanent diagnostic trouble codes (DTC)."
---

# DCSOBDPermanentDTCGet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSOBDPermanentDTCGet

Reads all permanent diagnostic trouble codes (DTC).
...
*Source: `ComOnl/DCSOBDPermanentDTCGet.htm`*
