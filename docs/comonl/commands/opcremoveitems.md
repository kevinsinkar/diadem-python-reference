---
title: "OPCRemoveItems"
description: "Deletes OPC items from an OPC group."
---

# OPCRemoveItems

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCRemoveItems

Deletes OPC items from an OPC group.

## Signature

```python
dd.OPCRemoveItems(OPCGrpHandle, OPCItemNo)
```
...
*Source: `ComOnl/OPCRemoveItems.htm`*
