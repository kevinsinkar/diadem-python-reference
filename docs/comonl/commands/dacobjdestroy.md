---
title: "DACObjDestroy"
description: "Cancels access to a DAC object without adopting a configuration."
---
...
```python
dd.DacObjOpen("Raumklima")
dd.DacObjDlg("")
dd.SUDDlgShow(dd.BlDlg,dd.ResourceDrv + dd.BlDlg)
if dd.DlgState=="IDOk" :
    dd.DacObjClose(dd.BlActName)
else:
    dd.DacObjDestroy(dd.BlActName)
```

---

*Source: `ComOnl/DACObjDestroy.htm`*
