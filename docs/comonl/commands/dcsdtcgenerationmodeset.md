---
title: "DCSDTCGenerationModeSet"
description: "Controls the generation of diagnostic trouble codes (DTC)."
---

# DCSDTCGenerationModeSet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSDTCGenerationModeSet

Controls the generation of diagnostic trouble codes (DTC).

## Signature

```python
dd.DCSDTCGenerationModeSet(DCSDiagRef, DCSGroupOfDTC, DCSData, DCSDTCDescriptor)
```
...
*Source: `ComOnl/DCSDTCGenerationModeSet.htm`*
