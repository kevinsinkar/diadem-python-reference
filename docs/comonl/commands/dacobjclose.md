---
title: "DACObjClose"
description: "Closes a DAC block after the configuration."
---
...
Closes a DAC block after the configuration.

## Signature

```python
dd.DACObjClose(DacObjName)
```
