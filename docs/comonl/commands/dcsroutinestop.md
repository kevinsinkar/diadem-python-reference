---
title: "DCSRoutineStop"
description: "Stops a routine on the engine control unit (ECU)."
---

# DCSRoutineStop

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSRoutineStop

Stops a routine on the engine control unit (ECU).
...
*Source: `ComOnl/DCSRoutineStop.htm`*
