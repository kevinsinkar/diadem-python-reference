---
title: "BlPinDel"
description: "Delete signal connections in sub-block diagrams."
---
...
Delete signal connections in sub-block diagrams.

## Signature

```python
dd.BlPinDel(SchemeLev, BlPinDelOutp, BlPinDelNo)
```
...
<tr><td width="150">BlPinDelOutp</td>
<td>Specifies whether the terminal to be deleted is a signal input or a signal output.<div id="exp_BlPinDelOutp">
<table class="Borderless">
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlPinDelOutp = <em>Value</em>
Call DACObjClose(<em>BlockName</em>)</pre></donottranslate><br attr="ext"/>You need the DAC block name to open the DAC block, to access the variable, and to close the DAC block.<br attr="ext"/><br attr="ext"/>Refer to <a href="#" data-unresolved="1">Accessing Objects in DIAdem DAC</a> for more information.</td></tr></table>
<p class="Body">The <span class="Monospace">BlPinDelOutp</span> variable can contain the following values:</p>
<table class="Borderless" id="table2">
<tr>
<td style="BORDER-BOTTOM: 1px solid" width="150"><strong>Value</strong></td>
<td style="BORDER-BOTTOM: 1px solid"><strong>Meaning</strong></td>
...
<tr><td width="150">BlPinDelNo</td>
<td>Specifies the number of the block terminal to be deleted.<div id="exp_BlPinDelNo">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Byte variable</a></td></tr>
<tr>
</tr>
