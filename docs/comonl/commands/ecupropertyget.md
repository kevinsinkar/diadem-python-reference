---
title: "ECUPropertyGet"
description: "Retrieves the property of the driver, the database, the ECU, the Characteristic, the Measurement, or the Measurement task."
---

# ECUPropertyGet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: ECUPropertyGet

Retrieves the property of the driver, the database, the ECU, the Characteristic, the Measurement, or the Measurement task.
...
<td>Specifies the value of the property. The return value is a ECUPropertyValue type.<div id="exp_ECUPropertyValue">
<table class="Borderless">
...
*Source: `ComOnl/ECUPropertyGet.htm`*
