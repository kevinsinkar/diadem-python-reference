---
title: "OPCRemoveGroup"
description: "Deletes OPC groups on OPC servers."
---

# OPCRemoveGroup

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCRemoveGroup

Deletes OPC groups on OPC servers.

## Signature

```python
dd.OPCRemoveGroup(OPCSrvHandle)
```
...
*Source: `ComOnl/OPCRemoveGroup.htm`*
