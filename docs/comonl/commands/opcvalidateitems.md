---
title: "OPCValidateItems"
description: "Validates the items of an OPC group to add these items to the OPC group."
---

# OPCValidateItems

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCValidateItems

Validates the items of an OPC group to add these items to the OPC group.

## Signature

```python
dd.OPCValidateItems(OPCGrpHandle, OPCItemNo)
```
...
<table class="Borderless">
<tr>
<td width="150">OPCErrorCode</td>
<td>Receives the status of the OPC command.<div id="exp_OPCErrorCode">
...
<tr>
<td width="150">OPCHResult</td>
<td>Receives the return value of the OPC command.<div id="exp_OPCHResult__1">
...
<table class="Borderless" id="table14">
<tr>
...
<tr>
<td width="150">aOPCItemError</td>
<td>Receives the status of operations with various OPC items.<div id="exp_aOPCItemError__1">
<table class="Borderless" id="table16">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a><br attr="ext"/>i = 1 ... 1024</td>
</tr>
</table>
<p class="Body">Specify the field length with the <a href="../../../varonl/variables/opcitemno/">OPCItemNo</a> variable.</p>
<p class="Body">The <span class="Monospace">aOPCItemError</span> variable can contain the following values:</p>
...
<td>Command could not execute. The <a href="../../../varonl/variables/opcerrorcode/">OPCErrorCode</a> variable contains a list of error codes.</td>
</tr>
</table>
<p class="Body"></p>
</div>
...
<tr>
<td width="150">aOPCAccessRights</td>
<td>Receives the field that contains the access rights of various OPC items.<div id="exp_aOPCAccessRights">
<table class="Borderless">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a><br attr="ext"/>i = 1 ... 1024</td>
</tr>
<tr>
<td>-2147483648 &lt;= aOPCAccessRights &lt;= 2147483647</td>
</tr>
</table>
<p class="Body">The <a href="../../../varonl/variables/opcitemno/">OPCItemNo</a> variable limits the field length.</p>
<p class="Body"></p>
</div>
</td>
</tr>
<tr>
<td width="150">aOPCDataType</td>
<td>Receives the data types that an OPC server transfers for various OPC items.<div id="exp_aOPCDataType">
<table class="Borderless">
<tr>
<td><a href="#" data-unresolved="1">Longinteger variable</a><br attr="ext"/>i = 1 ... 1024</td>
</tr>
...
```python
aOPCItemID = []
aOPCItemID.append("SINE:1.0..5.0:10.0")
aOPCItemID.append("MotorRPMSensor")

OPCValidateItems(OPCGrpHandle,2)

print(aOPCAccessRights(1),0,"Access rights item 1")
print(aOPCAccessRights(2),0,"Access rights item  2")
print(aOPCDatatype(1),0,"Data type item 1")
print(aOPCDatatype(2),0,"Data type item 2")
```

---

*Source: `ComOnl/OPCValidateItems.htm`*
