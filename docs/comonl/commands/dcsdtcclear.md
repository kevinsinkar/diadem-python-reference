---
title: "DCSDTCClear"
description: "Deletes selected diagnostic trouble codes (DTC)."
---
...
Deletes selected diagnostic trouble codes (DTC).

## Signature

```python
dd.DCSDTCClear(DCSDiagRef, DCSGroupOfDTC, DCSDTCDescriptor)
```
