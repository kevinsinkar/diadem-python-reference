---
title: "OPCDISConnect"
description: "Disconnects an OPC server."
---
...
<td>Receives the status of the OPC command.<div id="exp_OPCErrorCode__1">
...
*Source: `ComOnl/OPCDISConnect.htm`*
