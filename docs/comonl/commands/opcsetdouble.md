---
title: "OPCSetDouble"
description: "Assigns a Double type value to an OPC server."
---

# OPCSetDouble

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCSetDouble

Assigns a Double type value to an OPC server.

## Signature

```python
dd.OPCSetDouble(OPCItemHandle, OPCDoubleValue)
```
...
<tr><td width="150">OPCDoubleValue</td>
<td>Specifies the current value of an OPC item.<div id="exp_OPCDoubleValue">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Floating-point number variable</a></td></tr>
<tr>
<td>-1E+35 &lt;= OPCDoubleValue &lt;= 1E+35</td></tr>
</table>
<p class="Body">
</p></div></td></tr>
</table>
...
*Source: `ComOnl/OPCSetDouble.htm`*
