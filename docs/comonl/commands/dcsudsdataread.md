---
title: "DCSUDSDataRead"
description: "Uses a local identifier to read data from the engine control unit (ECU)."
---

# DCSUDSDataRead

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSUDSDataRead

Uses a local identifier to read data from the engine control unit (ECU).
...
*Source: `ComOnl/DCSUDSDataRead.htm`*
