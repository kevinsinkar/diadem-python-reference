---
title: "OPCWriteSync"
description: "Writes values to OPC items of an OPC group."
---

# OPCWriteSync

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCWriteSync

Writes values to OPC items of an OPC group.

## Signature

```python
dd.OPCWriteSync(OPCGrpHandle, OPCItemNo)
```

## Notes

<div markdown="1">
<table class="Borderless"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note</strong>  Before a script executes the command <span class="Monospace">OPCWriteSync</span>, you must assign the values to be written to the variables <a href="../opcsetint/">OPCSetInt</a>, <a href="../opcsetdouble/">OPCSetDouble</a>, and <a href="../opcsetstring/">OPCSetString</a>.</td></tr></table>
</div>
...
<tr><td width="150">aOPCItemError</td><td>Receives the status of operations with various OPC items.<div id="exp_aOPCItemError0">
<table class="Borderless" id="table16">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a><br attr="ext"/>i = 1 ... 1024</td></tr>
</table>
<p class="Body">Specify the field length with the <a href="../../../varonl/variables/opcitemno/">OPCItemNo</a> variable.</p><p class="Body">The <span class="Monospace">aOPCItemError</span> variable can contain the following values:</p><table class="Borderless" id="table17">
<tr>
...
*Source: `ComOnl/OPCWriteSync.htm`*
