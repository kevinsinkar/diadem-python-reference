---
title: "DCSUDSGetDTCByStatus"
description: "Executes a status request in order to read selected diagnostic trouble codes (DTC)."
---

# DCSUDSGetDTCByStatus

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSUDSGetDTCByStatus

Executes a status request in order to read selected diagnostic trouble codes (DTC).
...
*Source: `ComOnl/DCSUDSGetDTCByStatus.htm`*
