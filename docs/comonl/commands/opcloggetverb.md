---
title: "OPCLogGetVerb"
description: "Determines the settings of the logfile for OPC communication."
---

# OPCLogGetVerb

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: OPCLogGetVerb

Determines the settings of the logfile for OPC communication.

## Signature

```python
dd.OPCLogGetVerb(OPCLogCategory)
```
...
<div markdown="1">
<table class="Borderless"><tr><td width="150">OPCLogEnableCat</td><td>Displays whether DIAdem records the categories listed in the <span class="Monospace">OPCLogCategory</span> variables.<div id="exp_OPCLogEnableCat__1">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
...
<tr><td width="150">0</td><td>DIAdem does not record the category in the OPC logfile.</td></tr><tr><td width="150">1</td><td>DIAdem records the category in the OPC logfile.</td></tr></table>
<p class="Body">
</p></div></td></tr></table>
</div>
...
*Source: `ComOnl/OPCLogGetVerb.htm`*
