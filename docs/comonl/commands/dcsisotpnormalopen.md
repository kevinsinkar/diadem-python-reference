---
title: "DCSISOTPNormalOpen"
description: "Starts a diagnosis session over a CAN port using the ISO TP normal mode transport protocol."
---

# DCSISOTPNormalOpen

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSISOTPNormalOpen

Starts a diagnosis session over a CAN port using the ISO TP normal mode transport protocol.
...
*Source: `ComOnl/DCSISOTPNormalOpen.htm`*
