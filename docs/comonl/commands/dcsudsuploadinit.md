---
title: "DCSUDSUploadInit"
description: "Initiates the data upload onto the engine control unit (ECU)."
---

# DCSUDSUploadInit

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSUDSUploadInit

Initiates the data upload onto the engine control unit (ECU).

## Signature

```python
dd.DCSUDSUploadInit(DCSDiagRef, DCSMemoryAddress, DCSMemorySize, DCSMemoryAddressLength, DCSMemorySizeLength, DCSDataFormatIdentifier)
```
...
*Source: `ComOnl/DCSUDSUploadInit.htm`*
