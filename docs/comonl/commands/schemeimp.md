---
title: "SchemeImp"
description: "Imports the specified subblock diagram file in the new subblock diagram of the existing block diagram."
---
...
Imports the specified subblock diagram file in the new subblock diagram of the existing block diagram.

## Signature

```python
dd.SchemeImp(SchemeImpFile)
```
...
<tr><td width="150">SchemeImpFile</td>
<td>Specifies the subblock diagram file to be loaded.<div id="exp_SchemeImpFile">
<table class="Borderless">
