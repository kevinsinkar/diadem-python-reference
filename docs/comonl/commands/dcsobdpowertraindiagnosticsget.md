---
title: "DCSOBDPowertrainDiagnosticsGet"
description: "Executes an OBD request current powertrain diagnostic data service and reads the data that is acquired."
---

# DCSOBDPowertrainDiagnosticsGet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSOBDPowertrainDiagnosticsGet

Executes an OBD request current powertrain diagnostic data service and reads the data that is acquired.
...
*Source: `ComOnl/DCSOBDPowertrainDiagnosticsGet.htm`*
