---
title: "OPCSetInt"
description: "Assigns a Variant type value to an OPC server."
---
...
Assigns a Variant type value to an OPC server.

## Signature

```python
dd.OPCSetInt(OPCItemHandle, OPCIntValue)
```
...
<tr><td width="150">OPCIntValue</td>
<td>Specifies the current value of an OPC item.<div id="exp_OPCIntValue">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger variable</a></td></tr>
<tr>
<td>-2147483648 &lt;= OPCIntValue &lt;= 2147483647</td></tr>
</table>
<p class="Body">
</p></div></td></tr>
</table>
