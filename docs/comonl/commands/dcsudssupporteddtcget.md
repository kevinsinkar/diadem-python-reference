---
title: "DCSUDSSupportedDTCGet"
description: "Reads a list with all supported diagnostic trouble codes (DTCs)."
---

# DCSUDSSupportedDTCGet

!!! abstract "Command &middot; `ComOnl.chm`"
    Command: DCSUDSSupportedDTCGet

Reads a list with all supported diagnostic trouble codes (DTCs).
...
*Source: `ComOnl/DCSUDSSupportedDTCGet.htm`*
