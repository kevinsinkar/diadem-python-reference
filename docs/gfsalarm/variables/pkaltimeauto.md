---
title: "PkAlTimeAuto"
description: "Specifies whether DIAdem automatically adds a time stamp to an entry."
---
...
<div markdown="1">
<table class="Borderless" id="table20"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlTimeAuto = <em>Value</em>
...
*Source: `Gfsalarm/pkaltimeauto.htm`*
