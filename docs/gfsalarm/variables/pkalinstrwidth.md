---
title: "PkAlInstrWidth"
description: "Specifies the width of the instrument in DIAdem VISUAL."
---
...
<div markdown="1">
<table class="Borderless" id="table18"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlInstrWidth = <em>Value</em>
...
*Source: `Gfsalarm/pkalinstrwidth.htm`*
