---
title: "PkAlLogSizeMin"
description: "Specifies the size of the logfile block that is maintained in the file when DIAdem resets the logfile."
---
...
<div markdown="1">
<table class="Borderless" id="table14"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlLogSizeMin = <em>Value</em>
...
*Source: `Gfsalarm/pkallogsizemin.htm`*
