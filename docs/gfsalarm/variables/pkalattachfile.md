---
title: "PkAlAttachFile"
description: "Specifies the name of a file that is to be sent as an attachment."
---
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlAttachFile = <em>Value</em>
...
*Source: `Gfsalarm/pkalattachfile.htm`*
