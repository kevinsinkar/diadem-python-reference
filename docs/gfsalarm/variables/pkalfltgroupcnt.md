---
title: "PkAlFltGroupCnt"
description: "Specifies the number of alarm groups that are to be displayed."
---
...
<div markdown="1">
<table class="Borderless" id="table34"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlFltGroupCnt = <em>Value</em>
...
*Source: `Gfsalarm/pkalfltgroupcnt.htm`*
