---
title: "PkAlGroup"
description: "Specifies the names of the defined alarm groups."
---
...
<div markdown="1">
<table class="Borderless" id="table32"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlGroup = <em>Value</em>
