---
title: "PkAlFrame"
description: "Specifies whether DIAdem displays a frame."
---
...
<div markdown="1">
<table class="Borderless" id="table36"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/><br attr="ext"/>
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    PkAlFrame = <em>Value</em>
