---
title: "PkAlShowButton"
description: "Specifies whether DIAdem displays the OK button in the text window."
---
...
*Source: `Gfsalarm/pkalshowbutton.htm`*
