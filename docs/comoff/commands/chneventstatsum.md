---
title: "ChnEventStatSum"
description: "Specifies the sum of individual events or of all events from the result list of an event search."
---

# ChnEventStatSum

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventStatSum

Specifies the sum of individual events or of all events from the result list of an event search.
...
for iCount in range( 1, dd.ChnEventCount(dd.ChnEventResultList)+1):
    sOutPut = sOutPut + " Event " + iCount + ": " + dd.Str(dd.ChnEventStatSum("[1]/[2]", dd.ChnEventResultList, iCount),"ENGd.ddd")
print(sOutPut)
```

---

*Source: `ComOff/ChnEventStatSum.htm`*
