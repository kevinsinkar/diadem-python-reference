---
title: "ChnResampleChnBasedXOffsetCalc3"
description: "Uses a synchronization channel to map three measurements onto new interpolation channels."
---

# ChnResampleChnBasedXOffsetCalc3

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnResampleChnBasedXOffsetCalc3

Uses a synchronization channel to map three measurements onto new interpolation channels.

## Signature

```python
dd.ChnResampleChnBasedXOffsetCalc3( XW , Y , ChnList, XOffset, XW , Y1 , ChnList1, XOffset1, XW , Y2 , ChnList2, XOffset2, AutoTimeChn, XOffsetMode, SamplingPointChn, [ResampleMappingMode], [ResampleAntiAliasingFilter], [ResampleInterpolateNovalues], [ResampleCorrelationMode])
```
...
<td>Specifies the time channel of the first measurement.</td></tr>
...
<tr><td width="150"><em>XW</em></td>
<td>Specifies the time channel of the second measurement.</td></tr>
...
<tr><td width="150"><em>XW</em></td>
<td>Specifies the time channel of the third measurement.</td></tr>
...
*Source: `ComOff/ChnResampleChnBasedXOffsetCalc3.htm`*
