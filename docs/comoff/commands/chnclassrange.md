---
title: "ChnClassRange"
description: "Calculates the classification with the range counting method DIN 45667."
---
...
```python
return_value = dd.ChnClassRange( Y , ResultChannel , ResultChannel , ResultChannel , ClassMeth1, FrequencyType, Hysteresis, FrequencyPara, [OpenBoundClass])
```
...
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the positive ranges.</td></tr>
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the negative ranges.</td></tr>
...
<p class="Body">The <em>absolute class frequency</em> H<sub>i</sub> of the i-th class K<sub>i</sub> for i=1, 2, ...p for even numbers p of the created classes is equal the number of observation values in the class K<sub>i</sub>. The <em>relative class frequency</em> h<em>i</em> of the class K<em>i</em> is then <span class="Monospace">1/n</span> multiplied by the absolute class frequency.</p>
...
*Source: `ComOff/ChnClassRange.htm`*
