---
title: "ChnClassTimeLev1"
description: "Calculates the classification with the time-at-level counting method I."
---

# ChnClassTimeLev1

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnClassTimeLev1

Calculates the classification with the time-at-level counting method I.

## Signature

```python
return_value = dd.ChnClassTimeLev1( Y , ResultChannel , ResultChannel , ClassMeth1, FrequencyType, [OpenBoundClass])
```
...
*Source: `ComOff/ChnClassTimeLev1.htm`*
