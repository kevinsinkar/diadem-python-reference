...
```python
dd.ChnGenLSFitWeighted( Y , ChnList, Y1 , ResultChannel , GenLSFitCovariance, GenLSFitAlgorithm)
```
...
<div markdown="1">
<table class="Borderless" id="table1"><tr><td width="150">GenLSFitMSE</td><td>Receives the mean squared error of a general LS linear fitting.<div id="exp_GenLSFitMSE">
...
*Source: `ComOff/ChnGenLSFitWeighted.htm`*
