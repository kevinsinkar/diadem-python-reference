---
title: "ChnEventOperationAND"
description: "Connects two search results with the AND operator."
---

# ChnEventOperationAND

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventOperationAND
...
Connects two search results with the AND operator.
...
*Source: `ComOff/ChnEventOperationAND.htm`*
