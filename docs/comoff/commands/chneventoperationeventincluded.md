---
title: "ChnEventOperationEventIncluded"
description: "Connects two search results with the INCLUDE operator. The second search result must be contained in the first search result for the search condition to be vali"
---

# ChnEventOperationEventIncluded

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventOperationEventIncluded
...
Connects two search results with the INCLUDE operator. The second search result must be contained in the first search result for the search condition to be valid.
...
dd.ChnEventResultList = dd.ChnEventOperationEventIncluded(dd.ChnEventList1, dd.ChnEventList2)
...
*Source: `ComOff/ChnEventOperationEventIncluded.htm`*
