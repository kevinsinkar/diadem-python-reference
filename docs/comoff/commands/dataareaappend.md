---
title: "DataAreaAppend"
description: "Copies a data block from channels and appends the data block to other channels."
---
...
```python
dd.DataAreaAppend(ChnArg1, ChnRow, ValNo, ChnArg2, TargetChn)
```
...
<td><strong>Note</strong><p class="body">The <a href="../datablappend/">DataBlAppend</a> command replaces the <span class="Monospace">DataAreaAppend</span> command.</p>
...
<p class="Bodey">If the target channels are not the same length, DIAdem adds the data block, starting at the row number of the longest channel. In the process the shorter channels have gaps which DIAdem fills with 0.</p>
...
```python
dd.DataAreaAppend("Group1/Channel1",3,10,"Group1/Channel4","Group2/Channel1")
```

---

*Source: `ComOff/DataAreaAppend.htm`*
