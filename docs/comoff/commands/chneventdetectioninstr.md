---
title: "ChnEventDetectionInStr"
description: "Checks whether a text in a text channel contains a character string."
---

# ChnEventDetectionInStr

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventDetectionInStr

Checks whether a text in a text channel contains a character string.
...
<tr><td width="150">[ChnEventStringPosition]</td>
<td>Specifies the start position of the search. If you do not specify this value, the search starts with the first character.<div id="exp_ChnEventStringPosition">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Integer</a></td></tr>
<tr>
<td>1 &lt;= ChnEventStringPosition &lt;= 1073741824<br attr="ext"/>Access: Read/Write</td></tr>
</table>
</div></td></tr>
...
dd.ChnEventResultList = dd.ChnEventDetectionInStr("" , "[3]/[1]", "max", 1, True)
dd.ChnEventCreateStatusChn("Event/EventStatus", dd.ChnEventResultList, "[3]/[1]", 0, 1)
```

---

*Source: `ComOff/ChnEventDetectionInStr.htm`*
