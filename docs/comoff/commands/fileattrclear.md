---
title: "FileAttrClear"
description: "Deletes file attributes."
---
...
```python
dd.FileAttrClear(FSSourceName, FSAttrType)
```
...
```python
dd.FileAttrClear(dd.ScriptReadPath + "*.*","faReadOnly")
```

---

*Source: `ComOff/FileAttrClear.htm`*
