---
title: "ChnClassTimeLev2"
description: "Calculates the classification with the time-at-level counting method II."
---

# ChnClassTimeLev2

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnClassTimeLev2

Calculates the classification with the time-at-level counting method II.

## Signature

```python
return_value = dd.ChnClassTimeLev2( Y , X , ResultChannel , ResultChannel , ClassMeth1, FrequencyType, [OpenBoundClass])
```
...
<td>Specifies the data channel containing the related time values.</td></tr>
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the class means.</td></tr>
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the-time-at level.</td></tr>
...
*Source: `ComOff/ChnClassTimeLev2.htm`*
