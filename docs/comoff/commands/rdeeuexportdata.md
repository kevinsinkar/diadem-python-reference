---
title: "RdeEuExportData"
description: "Exports the input data of the RdeEuAnalysis data evaluation according to the data exchange format described in Commission Regulation (EU) 2018/1832 of November "
---

# RdeEuExportData

!!! abstract "Command &middot; `ComOff.chm`"
    Command: RdeEuExportData
...
*Source: `ComOff/RdeEuExportData.htm`*
