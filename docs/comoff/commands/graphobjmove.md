---
title: "GraphObjMove"
description: "The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the GraphObjMove command:"
---

# GraphObjMove

!!! abstract "Command &middot; `ComOff.chm`"
    Command: GraphObjMove (Obsolete)

The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the GraphObjMove command:
...
```python
dd.Report.ActiveSheet.Objects(1).Position.ZOrder.Move(1)
```

---

*Source: `ComOff/GraphObjMove.htm`*
