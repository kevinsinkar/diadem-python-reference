---
title: "FolderAttrClear"
description: "Deletes folder attributes."
---
...
```python
dd.FolderAttrClear(FSSourceName, FSAttrType)
```
...
```python
dd.FolderAttrClear(dd.ScriptReadPath + "L*", "faReadOnly")
```

---

*Source: `ComOff/FolderAttrClear.htm`*
