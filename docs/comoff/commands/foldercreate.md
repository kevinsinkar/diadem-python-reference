...
<table class="Borderless"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>If the folder to be generated already exists, DIAdem terminates the command without an error message.</td></tr></table>
<table class="Borderless"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>You also can create subfolders.</td></tr></table>
</div>
...
```python
dd.FolderCreate(dd.ScriptReadPath + "MySub1\\MySub2")
```

---

*Source: `ComOff/FolderCreate.htm`*
