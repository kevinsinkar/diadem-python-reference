---
title: "AudioOutSetSampleRate"
description: "Specifies the sampling rate of the audio output."
---

# AudioOutSetSampleRate

!!! abstract "Command &middot; `ComOff.chm`"
    Command: AudioOutSetSampleRate

Specifies the sampling rate of the audio output.

## Signature

```python
dd.AudioOutSetSampleRate(AudioHandle, AudioSampleRate)
```
...
*Source: `ComOff/AudioOutSetSampleRate.htm`*
