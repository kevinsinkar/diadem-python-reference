---
title: "PicPrintNoDlg"
description: "The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the PicPrintNoDlg command:"
---

# PicPrintNoDlg

!!! abstract "Command &middot; `ComOff.chm`"
    Command: PicPrintNoDlg (Obsolete)

The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the PicPrintNoDlg command:
...
*Source: `ComOff/PicPrintNoDlg.htm`*
