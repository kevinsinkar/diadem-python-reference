---
title: "ChnAreaInsert0"
description: "Inserts data values with zeros into a channel. In the process DIAdem moves existing values down."
---

# ChnAreaInsert0

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnAreaInsert0

Inserts data values with zeros into a channel. In the process DIAdem moves existing values down.

## Signature

```python
dd.ChnAreaInsert0(ChnArg1, ChnRow, ValNo)
```
...
```python
dd.ChnAreaInsert0("Example/Time",1,10)
```

---

*Source: `ComOff/ChnAreaInsert0.htm`*
