---
title: "ChnStatisticsMovingWindow"
description: "Calculates statistical characteristic values channel by channel, whereby the characteristic values are calculated through a symmetrical window that is moved acr"
---

# ChnStatisticsMovingWindow

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnStatisticsMovingWindow

Calculates statistical characteristic values channel by channel, whereby the characteristic values are calculated through a symmetrical window that is moved across the channel values. If the window size is even, the portion of the window before the current channel value is one value larger than after the current channel value. If there are not enough elements at the endpoints, DIAdem will automatically cut off the window.

## Signature

```python
return_value = dd.ChnStatisticsMovingWindow( Y , StatsSelection, Width , [StatsUsePopulationFormula])
```
...
<tr><td width="150">Width</td>
<td>Specifies the window width.<div id="exp_Width">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Longinteger</a></td></tr>
<tr>
<td>1 &lt;= Width &lt;= 2147483647<br attr="ext"/>Access: Read/Write</td></tr>
</table>
</div></td></tr>
...
```python
dd.ChnResult = dd.ChnStatisticsMovingWindow("[1]/[1]", dd.eStatsMinimum + dd.eStatsMaximum + dd.eStatsGeometricMean, 5)
```

---

*Source: `ComOff/ChnStatisticsMovingWindow.htm`*
