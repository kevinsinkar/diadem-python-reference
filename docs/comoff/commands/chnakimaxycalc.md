---
title: "ChnAkimaXYCalc"
description: "Approximates a signal with an Akima subspline. If required, DIAdem also generates the interpolation points channel necessary for calculating the splines."
---

# ChnAkimaXYCalc

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnAkimaXYCalc

Approximates a signal with an Akima subspline. If required, DIAdem also generates the interpolation points channel necessary for calculating the splines.

## Signature

```python
return_value = dd.ChnAkimaXYCalc( XW , Y , ResultChannel , ResultChannel , XChnStyle, SplineXNo, SplineXDiv, AkimaFit, AkimaRange, AkimaCoeff, AkimaPerc)
```
...
*Source: `ComOff/ChnAkimaXYCalc.htm`*
