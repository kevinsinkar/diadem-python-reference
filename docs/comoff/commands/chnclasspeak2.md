---
title: "ChnClassPeak2"
description: "Calculates the classification with the peak value method II."
---

# ChnClassPeak2

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnClassPeak2

Calculates the classification with the peak value method II.

## Signature

```python
return_value = dd.ChnClassPeak2( Y , ResultChannel , ResultChannel , ClassMeth1, FrequencyType, Hysteresis, ClassRefLine, [OpenBoundClass])
```
...
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the peak values 2.</td></tr>
...
*Source: `ComOff/ChnClassPeak2.htm`*
