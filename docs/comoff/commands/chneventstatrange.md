---
title: "ChnEventStatRange"
description: "Specifies the span width of an individual event or of all events from the results list of an event search."
---

# ChnEventStatRange

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventStatRange
...
Specifies the span width of an individual event or of all events from the results list of an event search.
...
for iCount in range( 1, dd.ChnEventCount(dd.ChnEventResultList)+1):
    sOutPut = sOutPut + " Event " + iCount + ": " + dd.Str(dd.ChnEventStatRange("[1]/[2]", dd.ChnEventResultList, iCount),"ENGd.ddd")
print(sOutPut)
```

---

*Source: `ComOff/ChnEventStatRange.htm`*
