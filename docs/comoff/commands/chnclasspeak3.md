---
title: "ChnClassPeak3"
description: "Calculates the classification with the peak value method III."
---

# ChnClassPeak3

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnClassPeak3

Calculates the classification with the peak value method III.

## Signature

```python
return_value = dd.ChnClassPeak3( Y , ResultChannel , ResultChannel , ResultChannel , ClassMeth1, FrequencyType, Hysteresis, [OpenBoundClass])
```
...
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the minimum peak values.</td></tr>
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the maximum peak values.</td></tr>
...
*Source: `ComOff/ChnClassPeak3.htm`*
