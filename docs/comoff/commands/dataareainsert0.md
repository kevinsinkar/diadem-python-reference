---
title: "DataAreaInsert0"
description: "Inserts a data block with zeros into channels. In the process DIAdem moves existing values down."
---

# DataAreaInsert0

!!! abstract "Command &middot; `ComOff.chm`"
    Command: DataAreaInsert0

Inserts a data block with zeros into channels. In the process DIAdem moves existing values down.

## Signature

```python
dd.DataAreaInsert0(ChnArg1, ChnRow, ValNo, ChnArg2)
```
...
<td><strong>Note</strong><p class="Body">The channels used are in the same order as the channel numbers. This order is not always the same as the order of the channels in the Data Portal.</p>
...
```python
dd.DataAreaInsert0("Group1/Channel1",1,10,"Group1/Channel4")
```

---

*Source: `ComOff/DataAreaInsert0.htm`*
