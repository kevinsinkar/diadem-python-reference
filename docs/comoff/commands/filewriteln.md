---
title: "FileWriteLn"
description: "Possible syntax: FileWriteLn, FW"
---
...
Possible syntax: FileWriteLn, FW

## Signature

```python
dd.FileWriteLn(FileName, RecMode, FileLine)
```
...
<table class="Borderless"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>If the target file already exists DIAdem overwrites this file without a confirmation prompt. If the ASCII file is not open when DIAdem executes the <span class="Monospace">FileWriteLn</span> command, DIAdem opens this file and closes the file again. If the file is already open, DIAdem does not close the file after the command is executed.</td></tr></table>
