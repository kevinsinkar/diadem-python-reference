---
title: "ChnClassLevCross"
description: "Calculates the classification with the level crossing counting method."
---

# ChnClassLevCross

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnClassLevCross

Calculates the classification with the level crossing counting method.

## Signature

```python
return_value = dd.ChnClassLevCross( Y , ResultChannel , ResultChannel , ClassMeth1, FrequencyType, Hysteresis, ClassRefLine, [OpenBoundClass])
```
...
<td>Specifies the result channel that receives the class limits.</td></tr>
<tr><td width="150"><em>ResultChannel</em></td>
<td>Specifies the result channel that receives the level crossings.</td></tr>
...
*Source: `ComOff/ChnClassLevCross.htm`*
