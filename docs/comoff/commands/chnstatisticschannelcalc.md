---
title: "ChnStatisticsChannelCalc"
description: "Calculates characteristic statistical values channelwise."
---
...
```python
return_value = dd.ChnStatisticsChannelCalc(ChnList1, StatsSelection, [ StatsStartIndex ], [ StatsEndIndex ], [StatsUsePopulationFormula], [StatsResultChn], [StatsResultChnNames], [StatsResultChnNameFormat])
```
...
*Source: `ComOff/ChnStatisticsChannelCalc.htm`*
