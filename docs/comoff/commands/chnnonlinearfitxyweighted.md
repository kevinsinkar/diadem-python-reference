---
title: "ChnNonLinearFitXYWeighted"
...
!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnNonLinearFitXYWeighted
...
```python
dd.ChnNonLinearFitXYWeighted( XW , Y , Y1 , ResultChannel , ResultChannel , XChnStyle, XNo, XDiv, NonLinearFitMaxIterations, NonLinearFitCovariance)
```
...
*Source: `ComOff/ChnNonLinearFitXYWeighted.htm`*
