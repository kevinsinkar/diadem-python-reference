---
title: "MatScalAdd"
description: "Adds a scalar value componentwise to a matrix."
---
...
Adds a scalar value componentwise to a matrix.

## Signature

```python
dd.MatScalAdd(ChnList, MatScalVal, MatScalIP)
```
