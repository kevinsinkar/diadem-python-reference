---
title: "ChnEventCompareChnNE"
description: "Determines the area in a data channel in which the value is not equal to the value of the second channel."
---

# ChnEventCompareChnNE

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventCompareChnNE
...
Determines the area in a data channel in which the value is not equal to the value of the second channel.
...
<td>Specifies the data channel containing the x-values of the first channel. If the associated y-channel is a waveform or xy-channel, you do not need to specify this channel.</td></tr>
...
dd.ChnEventResultList =  dd.ChnEventCompareChnNE("" , "[1]/[2]", "[1]/[3]")
dd.ChnEventCreateStatusChn("Event/EventStatus", dd.ChnEventResultList, "[1]/[2]", 0, 1)
```

---

*Source: `ComOff/ChnEventCompareChnNE.htm`*
