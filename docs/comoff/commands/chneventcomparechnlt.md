---
title: "ChnEventCompareChnLT"
description: "Determines the area in a data channel in which the value is less than the value of the second channel."
---

# ChnEventCompareChnLT

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventCompareChnLT
...
Determines the area in a data channel in which the value is less than the value of the second channel.
...
dd.ChnEventResultList =  dd.ChnEventCompareChnLT("" , "[1]/[2]", "[1]/[3]")
dd.ChnEventCreateStatusChn("Event/EventStatus", dd.ChnEventResultList, "[1]/[2]", 0, 1)
```

---

*Source: `ComOff/ChnEventCompareChnLT.htm`*
