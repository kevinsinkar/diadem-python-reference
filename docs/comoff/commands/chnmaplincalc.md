---
title: "ChnMapLinCalc"
description: "Maps a signal onto a new x-range."
---

# ChnMapLinCalc

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnMapLinCalc

Maps a signal onto a new x-range.

## Signature

```python
return_value = dd.ChnMapLinCalc( XW , Y , X1 , ResultChannel , MapLinNovInterp, MapLinExtType, MapLinBdryVal, MapLinFctType, [MapLinInnerVal])
```
...
<td>Contains the result channel with the y-values converted to the new x-value range. <a href="../../../inavidata/collections/elementlist/">ElementList &lt;Data&gt;</a> type return value.</td></tr>
</table>
</div>
...
oMyResultChn = dd.ChnMapLinCalc(oMyXChannel, oMyYChannel, oMyX1Channel, "Results/LinearMapped", True, ". value", dd.NoValue, "analogue", 0)
print("Result channel: " , oMyResultChn(1).ChannelGroup.Name , "/" , oMyResultChn(1).Name)
```

```python
oMyResultChn = dd.ChnMapLinCalc("[1]/[1]","[1]/[2]","[1]/[3]", "Results/LinearMapped", True, ". value", dd.NoValue, "analogue", 0)
print("Result channel: " , oMyResultChn(1).ChannelGroup.Name , "/" , oMyResultChn(1).Name)
```

---

*Source: `ComOff/ChnMapLinCalc.htm`*
