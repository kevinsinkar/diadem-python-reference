...
```python
dd.DataAreaInsert(ChnArg1, ChnRow, ValNo, ChnArg2, TargetChn, TargetLine)
```
...
<td><strong>Note</strong><p class="body">The <a href="../datablinsert/">DataBlInsert</a> command replaces the <span class="Monospace">DataAreaInsert</span> command.</p>
...
<p class="Body">If the data block in the clipboard is larger than the existing channels, DIAdem creates new channels.</p>
...
```python
dd.DataAreaInsert("Group1/Channel1", 2, 10, "Group1/Channel4", "Group2/Channel1", 1)
```

---

*Source: `ComOff/DataAreaInsert.htm`*
