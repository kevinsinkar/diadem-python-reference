---
title: "ChnEventStatArithMean"
description: "Specifies the arithmetic mean of an individual event or of all events from the results list of an event search."
---

# ChnEventStatArithMean

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventStatArithMean
...
Specifies the arithmetic mean of an individual event or of all events from the results list of an event search.
...
for iCount in range( 1, dd.ChnEventCount(dd.ChnEventResultList)+1):
    sOutPut = sOutPut + " Event " + iCount + ": " + dd.Str(dd.ChnEventStatArithMean("[1]/[2]", dd.ChnEventResultList, iCount),"ENGd.ddd")
print(sOutPut)
```

---

*Source: `ComOff/ChnEventStatArithMean.htm`*
