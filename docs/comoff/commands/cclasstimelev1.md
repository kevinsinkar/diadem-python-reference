---
title: "CClassTimeLev1"
description: "Calculates compound classification with the time-at-level counting method."
---

# CClassTimeLev1

!!! abstract "Command &middot; `ComOff.chm`"
    Command: CClassTimeLev1

Calculates compound classification with the time-at-level counting method.

## Signature

```python
dd.CClassTimeLev1( Y , Y1 , ClassMeth2, FrequencyType)
```
...
*Source: `ComOff/CClassTimeLev1.htm`*
