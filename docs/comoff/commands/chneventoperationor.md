---
title: "ChnEventOperationOR"
description: "Connects two search results with the OR operator."
---

# ChnEventOperationOR

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventOperationOR

Connects two search results with the OR operator.
...
dd.ChnEventResultList = dd.ChnEventOperationOR(dd.ChnEventList1, dd.ChnEventList2)
...
*Source: `ComOff/ChnEventOperationOR.htm`*
