---
title: "AudioOutResume"
description: "Continues the audio output."
---

# AudioOutResume

!!! abstract "Command &middot; `ComOff.chm`"
    Command: AudioOutResume

Continues the audio output.

## Signature

```python
dd.AudioOutResume(AudioHandle)
```
...
*Source: `ComOff/AudioOutResume.htm`*
