---
title: "CClassSample"
description: "Calculates compound classification with the sample counting method."
---
...
```python
dd.CClassSample( Y , Y1 , ClassMeth2, FrequencyType, OpenBoundClass)
```
...
*Source: `ComOff/CClassSample.htm`*
