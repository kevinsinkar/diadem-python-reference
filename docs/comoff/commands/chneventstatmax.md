---
title: "ChnEventStatMax"
description: "Specifies the maximum value of an individual event or of all events from the result list of an event search."
---

# ChnEventStatMax

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventStatMax

Specifies the maximum value of an individual event or of all events from the result list of an event search.
...
for iCount in range( 1, dd.ChnEventCount(dd.ChnEventResultList)+1):
    sOutPut = sOutPut + " Event " + iCount + ": " + dd.Str(dd.ChnEventStatMax("[1]/[2]", dd.ChnEventResultList, iCount),"ENGd.ddd")
print(sOutPut)
```

---

*Source: `ComOff/ChnEventStatMax.htm`*
