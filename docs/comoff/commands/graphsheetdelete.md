---
title: "GraphSheetDelete"
description: "The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the GraphSheetDelete command:"
---

# GraphSheetDelete

!!! abstract "Command &middot; `ComOff.chm`"
    Command: GraphSheetDelete (Obsolete)

The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the GraphSheetDelete command:
...
*Source: `ComOff/GraphSheetDelete.htm`*
