---
title: "ChnEventCompareChnEQ"
description: "Determines the area in a data channel in which the value is equal to the value of the second channel."
---

# ChnEventCompareChnEQ

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventCompareChnEQ
...
Determines the area in a data channel in which the value is equal to the value of the second channel.
...
dd.ChnEventResultList =  dd.ChnEventCompareChnEQ("" , "[1]/[2]", "[1]/[3]")
dd.ChnEventCreateStatusChn("Event/EventStatus", dd.ChnEventResultList, "[1]/[2]", 0, 1)
```

---

*Source: `ComOff/ChnEventCompareChnEQ.htm`*
