---
title: "RdeEuExportReport1"
description: "Exports the interim results of the RdeEuAnalysis data evaluation according to the data exchange format described in Commission Regulation (EU) 2018/1832 of Nove"
---

# RdeEuExportReport1

!!! abstract "Command &middot; `ComOff.chm`"
    Command: RdeEuExportReport1

Exports the interim results of the RdeEuAnalysis data evaluation according to the data exchange format described in Commission Regulation (EU) 2018/1832 of November 5, 2018, Annex III, Appendix 8, Point 4.2.1, Table 3. The command assumes that the metadata is stored as group properties of the first channel group.
...
*Source: `ComOff/RdeEuExportReport1.htm`*
