---
title: "ChnEventCompareChnLE"
description: "Determines the area in a data channel in which the value is less than or equal to the value of the second channel."
---

# ChnEventCompareChnLE

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnEventCompareChnLE
...
Determines the area in a data channel in which the value is less than or equal to the value of the second channel.
...
dd.ChnEventResultList =  dd.ChnEventCompareChnLE("" , "[1]/[2]", "[1]/[3]")
dd.ChnEventCreateStatusChn("Event/EventStatus", dd.ChnEventResultList, "[1]/[2]", 0, 1)
```

---

*Source: `ComOff/ChnEventCompareChnLE.htm`*
