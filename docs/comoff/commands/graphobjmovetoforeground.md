---
title: "GraphObjMoveToForeground"
description: "The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the GraphObjMoveToForeground command:"
---

# GraphObjMoveToForeground

!!! abstract "Command &middot; `ComOff.chm`"
    Command: GraphObjMoveToForeground (Obsolete)

The following example shows you how to use the object-oriented interface of DIAdem REPORT instead of the GraphObjMoveToForeground command:
...
```python
dd.Report.ActiveSheet.Objects(1).Position.ZOrder.MoveToForeground()
```

---

*Source: `ComOff/GraphObjMoveToForeground.htm`*
