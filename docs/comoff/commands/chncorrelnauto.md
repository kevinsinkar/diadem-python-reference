---
title: "ChnCorrelNAuto"
description: "Calculates a normalized autocorrelation, which means the result values are between -1 and 1."
---

# ChnCorrelNAuto

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnCorrelNAuto

Calculates a normalized autocorrelation, which means the result values are between -1 and 1.

## Signature

```python
return_value = dd.ChnCorrelNAuto( XW , Y , ResultChannel , ResultChannel , CorrelType, CorrelVal)
```
...
*Source: `ComOff/ChnCorrelNAuto.htm`*
