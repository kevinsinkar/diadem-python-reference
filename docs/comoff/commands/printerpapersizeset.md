---
title: "PrinterPaperSizeSet"
description: "Specifies the paper format of the printer."
---
...
<tr><td width="150">PrinterPaperSizes</td>
<td>Specifies the paper format.<div id="exp_PrinterPaperSizes">
<table class="Borderless">
...
<td>Specifies the paper format. The return value is a PrinterPaperSizes type. If DIAdem returns an empty string, an error occurred. An error can occur, for example, when the printer name is not specified.<div id="exp_PrinterPaperSizes__1">
<table class="Borderless">
<tr><td><a href="#" data-unresolved="1">Enumeration variable</a></td></tr>
<tr>
<td>Enumeration variable with the following selection terms<table class="Borderless">
...
*Source: `ComOff/PrinterPaperSizeSet.htm`*
