---
title: "FolderDlgShow"
description: "Calls the path selection dialog box."
---

# FolderDlgShow

!!! abstract "Command &middot; `ComOff.chm`"
    Command: FolderDlgShow

Calls the path selection dialog box.
...
<td>Receives the status of a dialog box after you exit the dialog box. Return value of the same type as DlgState.<div id="exp_DlgState">
<table class="Borderless">
...
*Source: `ComOff/FolderDlgShow.htm`*
