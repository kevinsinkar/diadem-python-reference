---
title: "ChnAdd"
description: "Adds two or more channels."
---
...
```python
return_value = dd.ChnAdd( Y , CALCYChn, ResultChannel )
```
...
<td>Specifies the data channel with the values you want to add.</td></tr>
...
MyMultipleResultChn = dd.ChnAdd("Group1/Channel1", oMyChannelList,"Added")
```

---

*Source: `ComOff/ChnAdd.htm`*
