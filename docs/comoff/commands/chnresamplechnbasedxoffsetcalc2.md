---
title: "ChnResampleChnBasedXOffsetCalc2"
description: "Uses a synchronization channel to map two measurements onto new interpolation channels."
---

# ChnResampleChnBasedXOffsetCalc2

!!! abstract "Command &middot; `ComOff.chm`"
    Command: ChnResampleChnBasedXOffsetCalc2

Uses a synchronization channel to map two measurements onto new interpolation channels.

## Signature

```python
dd.ChnResampleChnBasedXOffsetCalc2( XW , Y , ChnList, XOffset, XW , Y1 , ChnList1, XOffset1, AutoTimeChn, XOffsetMode, SamplingPointChn, [ResampleMappingMode], [ResampleAntiAliasingFilter], [ResampleInterpolateNovalues], [ResampleCorrelationMode])
```
...
*Source: `ComOff/ChnResampleChnBasedXOffsetCalc2.htm`*
