---
title: "ChnResampleChnBased"
description: "Maps a signal onto an interpolation channel."
---
...
```python
return_value = dd.ChnResampleChnBased( XW , Y , SamplingPointChn, ResultChannel , ResampleMappingMode, ResampleAntiAliasingFilter, ResampleInterpolateNovalues, [ResampleInterpolationMethod])
```
...
oMyResultChn = dd.ChnResampleChnBased(oMyXChannel, oMyYChannel, oMyX1Channel, "Results/Resampled", "Automatic", False, False, "Akima")
print("Result channel: " , oMyResultChn(1).ChannelGroup.Name , "/" , oMyResultChn(1).Name)
```

```python
oMyResultChn = dd.ChnResampleChnBased("[1]/[1]", "[1]/[2]", "[1]/[3]", "Results/Resampled", "Automatic", False, False, "Akima")
print("Result channel: " , oMyResultChn(1).ChannelGroup.Name , "/" , oMyResultChn(1).Name)
```

---

*Source: `ComOff/ChnResampleChnBased.htm`*
