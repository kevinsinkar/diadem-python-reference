---
title: "ChnResampleFreqBasedXOffsetCalc2"
description: "Uses a synchronization channel to map two measurements on a new sampling rate."
---

# ChnResampleFreqBasedXOffsetCalc2
...
```python
dd.ChnResampleFreqBasedXOffsetCalc2( XW , Y , ChnList, XOffset, XW , Y1 , ChnList1, XOffset1, AutoTimeChn, XOffsetMode, SampleFrequency, [ResampleMappingMode], [ResampleAntiAliasingFilter], [ResampleInterpolateNovalues], [ResampleCorrelationMode])
```
...
*Source: `ComOff/ChnResampleFreqBasedXOffsetCalc2.htm`*
