---
title: "CClassMaxSave"
description: "Calculates compound classification with the maximum value memory method."
---

# CClassMaxSave

!!! abstract "Command &middot; `ComOff.chm`"
    Command: CClassMaxSave

Calculates compound classification with the maximum value memory method.

## Signature

```python
dd.CClassMaxSave( Y , Y1 , ClassMeth2, FrequencyType, ClassRange, OpenBoundClass)
```
...
*Source: `ComOff/CClassMaxSave.htm`*
