---
title: "AudioOutClose"
description: "Stops the sound output of channels."
---

# AudioOutClose

!!! abstract "Command &middot; `ComOff.chm`"
    Command: AudioOutClose

Stops the sound output of channels.

## Signature

```python
dd.AudioOutClose(AudioHandle)
```
...
*Source: `ComOff/AudioOutClose.htm`*
