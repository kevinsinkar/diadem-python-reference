---
title: "PrinterPaperSizeSelectable"
description: "Specifies whether a paper format can be selected."
---

# PrinterPaperSizeSelectable

!!! abstract "Command &middot; `ComOff.chm`"
    Command: PrinterPaperSizeSelectable
...
Specifies whether a paper format can be selected.
...
*Source: `ComOff/PrinterPaperSizeSelectable.htm`*
