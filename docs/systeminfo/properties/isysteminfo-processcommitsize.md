---
title: "ISystemInfo.ProcessCommitSize"
description: "Returns the guaranteed virtual memory reserved by the process, in kB."
---

# ISystemInfo.ProcessCommitSize

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: ProcessCommitSize for SystemInfo

Returns the guaranteed virtual memory reserved by the process, in kB.

## Signature

```python
obj.ProcessCommitSize
```
...
*Source: `SystemInfo/properties/SystemInfo_property_ProcessCommitSize_ISystemInfo.htm`*
