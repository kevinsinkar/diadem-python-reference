---
title: "ISystemInfo.PhysicalMemoryTotal"
description: "Returns the entire physical memory, in kB."
---

# ISystemInfo.PhysicalMemoryTotal

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: PhysicalMemoryTotal for SystemInfo

Returns the entire physical memory, in kB.

## Signature

```python
obj.PhysicalMemoryTotal
```
...
*Source: `SystemInfo/properties/SystemInfo_property_PhysicalMemoryTotal_ISystemInfo.htm`*
