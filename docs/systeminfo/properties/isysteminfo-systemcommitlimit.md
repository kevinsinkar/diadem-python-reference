---
title: "ISystemInfo.SystemCommitLimit"
description: "Returns the available guaranteed virtual memory, in kB."
---

# ISystemInfo.SystemCommitLimit

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: SystemCommitLimit for SystemInfo

Returns the available guaranteed virtual memory, in kB.

## Signature

```python
obj.SystemCommitLimit
```
...
*Source: `SystemInfo/properties/SystemInfo_property_SystemCommitLimit_ISystemInfo.htm`*
