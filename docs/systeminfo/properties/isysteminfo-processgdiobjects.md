---
title: "ISystemInfo.ProcessGDIObjects"
description: "Returns the number of GDI objects (Graphics Device Interface) used by the process."
---

# ISystemInfo.ProcessGDIObjects

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: ProcessGDIObjects for SystemInfo

Returns the number of GDI objects (Graphics Device Interface) used by the process.

## Signature

```python
obj.ProcessGDIObjects
```
...
*Source: `SystemInfo/properties/SystemInfo_property_ProcessGDIObjects_ISystemInfo.htm`*
