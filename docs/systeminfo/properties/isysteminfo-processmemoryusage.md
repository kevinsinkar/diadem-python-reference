---
title: "ISystemInfo.ProcessMemoryUsage"
description: "Returns the address space the process uses, in kB."
---

# ISystemInfo.ProcessMemoryUsage

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: ProcessMemoryUsage for SystemInfo
...
*Source: `SystemInfo/properties/SystemInfo_property_ProcessMemoryUsage_ISystemInfo.htm`*
