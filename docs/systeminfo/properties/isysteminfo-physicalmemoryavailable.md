---
title: "ISystemInfo.PhysicalMemoryAvailable"
description: "Returns the memory the process uses, in kB."
---

# ISystemInfo.PhysicalMemoryAvailable

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: PhysicalMemoryAvailable for SystemInfo

Returns the memory the process uses, in kB.

## Signature

```python
obj.PhysicalMemoryAvailable
```
...
*Source: `SystemInfo/properties/SystemInfo_property_PhysicalMemoryAvailable_ISystemInfo.htm`*
