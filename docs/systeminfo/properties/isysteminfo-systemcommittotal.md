---
title: "ISystemInfo.SystemCommitTotal"
description: "Returns the total available guaranteed virtual memory, in kB."
---

# ISystemInfo.SystemCommitTotal

!!! abstract "Property &middot; `SystemInfo.chm`"
    Property: SystemCommitTotal for SystemInfo

Returns the total available guaranteed virtual memory, in kB.

## Signature

```python
obj.SystemCommitTotal
```
...
*Source: `SystemInfo/properties/SystemInfo_property_SystemCommitTotal_ISystemInfo.htm`*
