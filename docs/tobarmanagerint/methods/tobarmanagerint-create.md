...
# ToBarManagerInt.Create

!!! abstract "Method &middot; `ToBarManagerInt.chm`"
    Method: Create for BarManagerUnattached
...
*Source: `ToBarManagerInt/methods/DIABars_method_Create_ToBarManagerInt.htm`*
