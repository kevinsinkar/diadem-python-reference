---
title: "ToBarManagerUIInt.Import"
...
# ToBarManagerUIInt.Import

!!! abstract "Method &middot; `ToBarManagerInt.chm`"
    Method: Import for BarManager
...
```python
dd.BarManager.Import("MyBarDef.bdn", "eImportSkip")
```
...
*Source: `ToBarManagerInt/methods/DIABars_method_Import_ToBarManagerUIInt.htm`*
