---
title: "ToBarManagerUIInt.Load"
description: "Loads a bar definition."
---

# ToBarManagerUIInt.Load

!!! abstract "Method &middot; `ToBarManagerInt.chm`"
    Method: Load for BarManager
...
```python
dd.BarManager.Load("MyDefinition.bdn")
```
...
*Source: `ToBarManagerInt/methods/DIABars_method_Load_ToBarManagerUIInt.htm`*
