---
title: "ToActionObjPopupInt.GetBarID"
...
# ToActionObjPopupInt.GetBarID

!!! abstract "Method &middot; `ToBarManagerInt.chm`"
    Method: GetBarID for ActionObjPopup
...
```python
oMyObj = dd.BarManager.ActionObjs("MyPopup")
oMyObj.OnRefreshCode.Code = "If This.GetBarID = \"SCRGroup\" Then"
...
*Source: `ToBarManagerInt/methods/DIABars_method_GetBarID_ToActionObjPopupInt.htm`*
