---
title: "ToBarManagerUIInt.SaveAsDeployment"
...
# ToBarManagerUIInt.SaveAsDeployment

!!! abstract "Method &middot; `ToBarManagerInt.chm`"
    Method: SaveAsDeployment for BarManager
...
```python
dd.BarManager.SaveAsDeployment("MyDefinition.bdy")
```
...
*Source: `ToBarManagerInt/methods/DIABars_method_SaveAsDeployment_ToBarManagerUIInt.htm`*
