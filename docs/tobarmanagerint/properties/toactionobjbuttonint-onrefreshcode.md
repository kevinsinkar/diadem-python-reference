---
title: "ToActionObjButtonInt.OnRefreshCode"
...
!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: OnRefreshCode for ActionObjButton
...
<td><strong>Note  </strong>You can modify the <span class="Monospace">OnRefreshCode</span> property only for user-defined bar elements. The <a href="../toactionobjbuttonint-kind/">Kind</a> property specifies whether a bar element is a free element or a user-defined element.</td>
</tr>
</table>
...
```python
oActionObj = BarManager.ActionObjs.Add("MyButton","CustomButton")
oActionObj.OnRefreshCode.Code = "This.Enable = (GlobUsedChn > 0)"
BarManager.Bars("SCRDIAdemScriptsFunc").UsedActionObj.Add(oActionObj)
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_OnRefreshCode_ToActionObjButtonInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
