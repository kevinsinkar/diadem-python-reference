---
title: "ToActionObjPopupInt.OnRefreshCode"
...
!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: OnRefreshCode for ActionObjPopup

Contains the VBS code of a button, which DIAdem executes during the refresh process. DIAdem executes a refresh, for example, when you switch a panel, open a bar, or click a button. The refresh also executes if you specify a refresh command of the bar manager with a script. Within the VBS code you can use and change the properties of the object. Use the This variable to access the object.
...
<td><strong>Note  </strong>You can modify the <span class="Monospace">OnRefreshCode</span> property only for user-defined bar elements. The <a href="../toactionobjpopupint-kind/">Kind</a> property specifies whether a bar element is a free element or a user-defined element.</td>
</tr>
</table>
...
```python
oActionObj = BarManager.ActionObjs("MyPopup")
...
*Source: `ToBarManagerInt/properties/DIABars_property_OnRefreshCode_ToActionObjPopupInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
