---
title: "ToBaseActionObjBaseInt.ID"
...
# ToBaseActionObjBaseInt.ID

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: ID for ActionObj
...
```python
if dd.BarManager.ActionObjs.Exists("MyObj") :
    dd.BarManager.ActionObjs("MyObj").ID = "MyObj_1"
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_ID_ToBaseActionObjBaseInt.htm`*
