---
title: "ToActionObjCheckInt.Caption"
description: "Specifies the label of a bar element. Use the Style property to specify the label."
---

# ToActionObjCheckInt.Caption

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: Caption for ActionObjCheckbutton
...
oFloating.Caption = "Floating Portal"
...
*Source: `ToBarManagerInt/properties/DIABars_property_Caption_ToActionObjCheckInt.htm`*
