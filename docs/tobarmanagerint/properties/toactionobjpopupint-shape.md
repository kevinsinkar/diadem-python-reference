---
title: "ToActionObjPopupInt.Shape"
...
# ToActionObjPopupInt.Shape

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: Shape for ActionObjPopup
...
| `eActObjShapeTab` | 1 | DIAdem displays the bar element as a tab. This setting does not influence the ActionObjPopup object. |

## Python example

```python
dd.MsgBoxDisp("Shape of second element: " + dd.BarManager.ActionObjs(2).Shape)
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_Shape_ToActionObjPopupInt.htm`*
