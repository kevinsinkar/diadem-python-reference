---
title: "ToActionObjPopupInt.Picture"
description: "Specifies which graphic appears for the button that opens a bar on the DIAdem interface. For DIAdem to display a graphic, the graphics file must contain a symbo"
---

# ToActionObjPopupInt.Picture

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: Picture for ActionObjPopup
...
if not (dd.BarManager.ActionObjs.Exists("MyObjCheck1")) :
    oMyActionObj = dd.BarManager.ActionObjs.Add("MyObjCheck1", "CustomPopUp")
...
*Source: `ToBarManagerInt/properties/DIABars_property_Picture_ToActionObjPopupInt.htm`*
