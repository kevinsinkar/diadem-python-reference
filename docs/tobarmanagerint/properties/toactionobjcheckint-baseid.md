---
title: "ToActionObjCheckInt.BaseID"
...
# ToActionObjCheckInt.BaseID

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: BaseID for ActionObjCheckbutton
...
def MyReset(oMyObject):
    if oMyObject.BaseId == "CustomCheckButton" :
        dd.MsgBoxDisp(oMyObject.Check)
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_BaseID_ToActionObjCheckInt.htm`*
