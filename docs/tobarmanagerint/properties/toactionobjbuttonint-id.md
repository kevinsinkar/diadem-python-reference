...
# ToActionObjButtonInt.ID

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: ID for ActionObjButton
...
if dd.BarManager.ActionObjs.Exists("MyButton") :
    dd.BarManager.ActionObjs("MyButton").ID = "MyButton_1"
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_ID_ToActionObjButtonInt.htm`*
