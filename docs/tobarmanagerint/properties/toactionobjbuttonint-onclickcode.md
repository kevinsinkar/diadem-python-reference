---
title: "ToActionObjButtonInt.OnClickCode"
...
# ToActionObjButtonInt.OnClickCode

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: OnClickCode for ActionObjButton
...
<td><strong>Note  </strong>You can modify the <span class="Monospace">OnClickCode</span> property only for user-defined bar elements. The <a href="../toactionobjbuttonint-kind/">Kind</a> property specifies whether a bar element is a free element or a user-defined element.</td>
</tr>
</table>
...
```python
oActionObj = BarManager.ActionObjs("MyButton")
oActionObj.OnClickCode.Code = "MsgBoxDisp(""Hello"")"
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_OnClickCode_ToActionObjButtonInt.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
