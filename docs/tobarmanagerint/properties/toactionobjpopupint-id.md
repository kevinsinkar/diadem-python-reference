...
if dd.BarManager.ActionObjs.Exists("MyPopup") :
    dd.BarManager.ActionObjs("MyPopup").ID = "MyPopup_1"
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_ID_ToActionObjPopupInt.htm`*
