---
title: "ToActionObjButtonInt.BaseID"
...
def MyReset(oMyObject):
    if oMyObject.BaseId == "CustomButton" :
...
*Source: `ToBarManagerInt/properties/DIABars_property_BaseID_ToActionObjButtonInt.htm`*
