---
title: "ToActionObjPopupInt.Type"
description: "Returns the bar element type."
---

# ToActionObjPopupInt.Type

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: Type for ActionObjPopup
...
def MyReset(oMyObject):
    if (oMyObject.Type == dd.eActObjTypePopup) :
...
*Source: `ToBarManagerInt/properties/DIABars_property_Type_ToActionObjPopupInt.htm`*
