---
title: "ToActionObjButtonInt.Type"
description: "Returns the bar element type."
---

# ToActionObjButtonInt.Type

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: Type for ActionObjButton
...
| `eActObjTypeCheckButton` | 1 | The bar element is a button that displays a status. Not possible here. |
...
def MyReset(oMyObject):
    if (oMyObject.Type != dd.eActObjTypeButton) :
...
*Source: `ToBarManagerInt/properties/DIABars_property_Type_ToActionObjButtonInt.htm`*
