---
title: "ToActionObjPopupInt.BaseID"
...
# ToActionObjPopupInt.BaseID

!!! abstract "Property &middot; `ToBarManagerInt.chm`"
    Property: BaseID for ActionObjPopup
...
def MyReset(oMyObject):
    if oMyObject.BaseId == "CustomPopup" :
        oMyObject.ResetBarID()
```
...
*Source: `ToBarManagerInt/properties/DIABars_property_BaseID_ToActionObjPopupInt.htm`*
