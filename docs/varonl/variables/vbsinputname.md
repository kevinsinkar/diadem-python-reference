---
title: "VBSInputName"
description: "Specifies the name of an input of the VBS block."
---

# VBSInputName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSInputName

Specifies the name of an input of the VBS block.
...
*Source: `VarOnl/VBSInputName.htm`*
