---
title: "BlPinInpEvntMax"
description: "Specifies the maximum number of alarm inputs on DAC blocks."
---

# BlPinInpEvntMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpEvntMax

Specifies the maximum number of alarm inputs on DAC blocks.
...
*Source: `VarOnl/BlPinInpEvntMax.htm`*
