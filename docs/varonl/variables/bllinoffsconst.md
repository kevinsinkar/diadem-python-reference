---
title: "BlLinOffsConst"
description: "Specifies the value of the offset of a thermo linearization."
---

# BlLinOffsConst

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinOffsConst

Specifies the value of the offset of a thermo linearization.
...
*Source: `VarOnl/BlLinOffsConst.htm`*
