---
title: "BlMonSyncClock"
description: "Specifies whether DIAdem reads the measurement data at the same rate as DIAdem writes the data to the measurement file."
---

# BlMonSyncClock

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMonSyncClock

Specifies whether DIAdem reads the measurement data at the same rate as DIAdem writes the data to the measurement file.
...
*Source: `VarOnl/BlMonSyncClock.htm`*
