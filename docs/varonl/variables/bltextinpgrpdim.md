---
title: "BlTextInpGrpDim"
description: "The BlTextInpGrpDim variable can contain the following values:"
---

# BlTextInpGrpDim

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextInpGrpDim

The BlTextInpGrpDim variable can contain the following values:
...
*Source: `VarOnl/BlTextInpGrpDim.htm`*
