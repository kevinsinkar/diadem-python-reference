---
title: "BlTimeOffs"
description: "Specifies whether DIAdem acquires the current time or the time from the start of the measurement."
---
...
Specifies whether DIAdem acquires the current time or the time from the start of the measurement.
