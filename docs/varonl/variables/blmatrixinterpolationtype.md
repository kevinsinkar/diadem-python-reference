---
title: "BlMatrixInterpolationType"
description: "Specifies whether DIAdem uses the bilinear method or the bicubic spline method for interpolating the values."
---

# BlMatrixInterpolationType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMatrixInterpolationType

Specifies whether DIAdem uses the bilinear method or the bicubic spline method for interpolating the values.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlMatrixInterpolationType = <em>Value</em>
...
*Source: `VarOnl/BlMatrixInterpolationType.htm`*
