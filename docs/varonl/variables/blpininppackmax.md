---
title: "BlPinInpPackMax"
description: "Specifies the maximum number of packet inputs on DAC blocks."
---

# BlPinInpPackMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpPackMax

Specifies the maximum number of packet inputs on DAC blocks.
...
*Source: `VarOnl/BlPinInpPackMax.htm`*
