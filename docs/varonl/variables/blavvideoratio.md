---
title: "BlAVVideoRatio"
description: "Specifies whether DIAdem VISUAL displays the live images according to the aspect ratio of the specified resolution or whether the images fill the frame."
---

# BlAVVideoRatio

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVVideoRatio

Specifies whether DIAdem VISUAL displays the live images according to the aspect ratio of the specified resolution or whether the images fill the frame.
...
*Source: `VarOnl/BlAVVideoRatio.htm`*
