---
title: "BlStopDelay"
description: "Specifies how many seconds an impulse remains at the control output of the impulse delay."
---

# BlStopDelay

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlStopDelay

Specifies how many seconds an impulse remains at the control output of the impulse delay.
