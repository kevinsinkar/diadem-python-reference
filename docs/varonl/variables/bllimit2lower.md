---
title: "BlLimit2Lower"
description: "Specifies the lower limit of the alarm range in display instruments."
---

# BlLimit2Lower

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLimit2Lower

Specifies the lower limit of the alarm range in display instruments.
...
*Source: `VarOnl/BlLimit2Lower.htm`*
