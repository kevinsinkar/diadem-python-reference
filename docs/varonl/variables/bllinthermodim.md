---
title: "BlLinThermoDim"
description: "Specifies the unit of the result data of a thermo linearization."
---

# BlLinThermoDim

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinThermoDim

Specifies the unit of the result data of a thermo linearization.
...
*Source: `VarOnl/BlLinThermoDim.htm`*
