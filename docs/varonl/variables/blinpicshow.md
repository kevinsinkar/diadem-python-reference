---
title: "BlInPicShow"
description: "Specifies whether DIAdem displays a graphic on a push button when the button is not pressed."
---

# BlInPicShow

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInPicShow

Specifies whether DIAdem displays a graphic on a push button when the button is not pressed.
