---
title: "BlBkXparentCol"
description: "Specifies which background color DIAdem displays as transparent in a display instrument."
---

# BlBkXparentCol

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBkXparentCol

Specifies which background color DIAdem displays as transparent in a display instrument.
...
*Source: `VarOnl/BlBkXparentCol.htm`*
