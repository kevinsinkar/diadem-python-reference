---
title: "BlSlopeLevel"
description: "Specifies the threshold value of a slope condition or the upper limit value of a status display."
---

# BlSlopeLevel

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSlopeLevel

Specifies the threshold value of a slope condition or the upper limit value of a status display.
...
*Source: `VarOnl/BlSlopeLevel.htm`*
