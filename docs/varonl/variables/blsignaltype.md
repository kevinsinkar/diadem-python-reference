---
title: "BlSignalType"
description: "Specifies the form of the signal that the function generator generates."
---

# BlSignalType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSignalType

Specifies the form of the signal that the function generator generates.
...
*Source: `VarOnl/BlSignalType.htm`*
