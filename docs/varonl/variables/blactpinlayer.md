---
title: "BlActPinLayer"
description: "Contains the bus layer of the open block terminal."
---

# BlActPinLayer

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinLayer

Contains the bus layer of the open block terminal.
...
*Source: `VarOnl/BlActPinLayer.htm`*
