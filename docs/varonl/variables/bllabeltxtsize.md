---
title: "BlLabelTxtSize"
description: "Specifies the font size for the labels of display instruments."
---

# BlLabelTxtSize

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLabelTxtSize

Specifies the font size for the labels of display instruments.
...
*Source: `VarOnl/BlLabelTxtSize.htm`*
