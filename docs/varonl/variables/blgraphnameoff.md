---
title: "BlGraphNameOff"
description: "Specifies the name of a graphic that DIAdem displays when a switch is off or a push button is not pressed."
---

# BlGraphNameOff

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphNameOff

Specifies the name of a graphic that DIAdem displays when a switch is off or a push button is not pressed.
...
*Source: `VarOnl/BlGraphNameOff.htm`*
