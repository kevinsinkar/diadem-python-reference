---
title: "BlBgFile"
description: "Specifies the name of a graphics file for the background of a display instrument."
---
...
Specifies the name of a graphics file for the background of a display instrument.
