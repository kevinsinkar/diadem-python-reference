---
title: "BlCndInpGrpDim"
description: "The BlCndInpGrpDim variable can contain the following values:"
---

# BlCndInpGrpDim

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndInpGrpDim

The BlCndInpGrpDim variable can contain the following values:
...
*Source: `VarOnl/BlCndInpGrpDim.htm`*
