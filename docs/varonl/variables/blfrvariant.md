---
title: "BlFrVariant"
description: "Specifies the position where DIAdem starts to plot color shading in an instrument frame."
---

# BlFrVariant

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlFrVariant

Specifies the position where DIAdem starts to plot color shading in an instrument frame.
