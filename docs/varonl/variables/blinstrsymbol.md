---
title: "BlInstrSymbol"
description: "Specifies the symbol displayed in the XY-display or the scatter display."
---

# BlInstrSymbol

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrSymbol

Specifies the symbol displayed in the XY-display or the scatter display.
...
*Source: `VarOnl/BlInstrSymbol.htm`*
