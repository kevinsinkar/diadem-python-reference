---
title: "BlIconBmp"
description: "Specifies the name of a graphics file which contains the symbol for a DAC block."
---
...
Specifies the name of a graphics file which contains the symbol for a DAC block.
