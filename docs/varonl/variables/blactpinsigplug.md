---
title: "BlActPinSigPlug"
description: "Contains the connection status of a signal at the open block input."
---

# BlActPinSigPlug

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinSigPlug

Contains the connection status of a signal at the open block input.
...
*Source: `VarOnl/BlActPinSigPlug.htm`*
