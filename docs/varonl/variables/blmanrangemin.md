---
title: "BlManRangeMin"
description: "Specifies the lower limit of the display range."
---

# BlManRangeMin

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManRangeMin

Specifies the lower limit of the display range.
...
*Source: `VarOnl/BlManRangeMin.htm`*
