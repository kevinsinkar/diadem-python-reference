---
title: "BlUseInitValueOnNoValue"
description: "Specifies whether DIAdem converts the NoValue value into a initialization value."
---

# BlUseInitValueOnNoValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlUseInitValueOnNoValue

Specifies whether DIAdem converts the NoValue value into a initialization value.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlUseInitValueOnNoValue = <em>Value</em>
...
*Source: `VarOnl/BlUseInitValueOnNoValue.htm`*
