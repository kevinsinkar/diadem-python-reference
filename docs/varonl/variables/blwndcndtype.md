---
title: "BlWndCndType"
description: "Specifies whether a condition is true at window entry or at window exit."
---

# BlWndCndType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlWndCndType

Specifies whether a condition is true at window entry or at window exit.
...
*Source: `VarOnl/BlWndCndType.htm`*
