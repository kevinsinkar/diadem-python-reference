---
title: "BlDLLDrvName"
description: "Specifies the name of a GPI DAC driver to be used."
---

# BlDLLDrvName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDLLDrvName

Specifies the name of a GPI DAC driver to be used.
...
*Source: `VarOnl/BlDLLDrvName.htm`*
