---
title: "BlScale2Inp1V"
description: "Specifies the first measurement values for a two-point scaling."
---

# BlScale2Inp1V

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale2Inp1V

Specifies the first measurement values for a two-point scaling.
...
*Source: `VarOnl/BlScale2Inp1V.htm`*
