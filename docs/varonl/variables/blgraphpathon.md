---
title: "BlGraphPathOn"
description: "Specifies the name of a graphic and the path that DIAdem displays when a switch is on or a push button is pressed."
---

# BlGraphPathOn

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphPathOn

Specifies the name of a graphic and the path that DIAdem displays when a switch is on or a push button is pressed.
...
*Source: `VarOnl/BlGraphPathOn.htm`*
