---
title: "BlEvntSourceName"
description: "Specifies the name of the alarm signals connected to the alarm inputs."
---

# BlEvntSourceName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntSourceName

Specifies the name of the alarm signals connected to the alarm inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlEvntSourceName(i,j)
...
*Source: `VarOnl/BlEvntSourceName.htm`*
