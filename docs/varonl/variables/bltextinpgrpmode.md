---
title: "BlTextInpGrpMode"
description: "Specifies the current list length mode of the text input."
---

# BlTextInpGrpMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextInpGrpMode

Specifies the current list length mode of the text input.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlTextInpGrpMode(i) = <em>Value</em>
...
*Source: `VarOnl/BlTextInpGrpMode.htm`*
