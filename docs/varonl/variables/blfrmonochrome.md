---
title: "BlFrMonochrome"
description: "Specifies whether one of the two colors of a color shading in the instrument frame is gray."
---

# BlFrMonochrome

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlFrMonochrome

Specifies whether one of the two colors of a color shading in the instrument frame is gray.
...
*Source: `VarOnl/BlFrMonochrome.htm`*
