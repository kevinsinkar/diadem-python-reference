---
title: "BlCndInpSigMax"
description: "Specifies the number of control signals at the control inputs."
---

# BlCndInpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndInpSigMax

Specifies the number of control signals at the control inputs.
...
*Source: `VarOnl/BlCndInpSigMax.htm`*
