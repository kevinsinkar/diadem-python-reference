---
title: "BlOffsetOrgValue"
description: "Specifies whether DIAdem outputs the original values or NoValues for the values in the interval from which DIAdem determines the offset. If the value is TRUE , "
---

# BlOffsetOrgValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlOffsetOrgValue

Specifies whether DIAdem outputs the original values or NoValues for the values in the interval from which DIAdem determines the offset. If the value is TRUE , DIAdem outputs the original values.
...
*Source: `VarOnl/BlOffsetOrgValue.htm`*
