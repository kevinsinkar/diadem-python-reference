---
title: "BlMiniTicks"
description: "Specifies the number of miniticks between two ticks in display instruments."
---

# BlMiniTicks

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMiniTicks

Specifies the number of miniticks between two ticks in display instruments.
