---
title: "BlControlMax"
description: "Specifies the maximum controller output of the PID controller."
---

# BlControlMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlControlMax

Specifies the maximum controller output of the PID controller.
...
*Source: `VarOnl/BlControlMax.htm`*
