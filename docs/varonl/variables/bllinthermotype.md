---
title: "BlLinThermoType"
description: "Specifies the thermo couple of a thermo linearization."
---

# BlLinThermoType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinThermoType

Specifies the thermo couple of a thermo linearization.
...
*Source: `VarOnl/BlLinThermoType.htm`*
