---
title: "BlControlTv"
description: "Specifies the rate time Tv of the differential part of a PID controller in seconds."
---

# BlControlTv

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlControlTv

Specifies the rate time Tv of the differential part of a PID controller in seconds.
