---
title: "BlMonFileName"
description: "Specifies the name of the DIAdem DAT file."
---

# BlMonFileName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMonFileName

Specifies the name of the DIAdem DAT file.
...
*Source: `VarOnl/BlMonFileName.htm`*
