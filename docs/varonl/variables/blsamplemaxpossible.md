---
title: "BlSampleMaxPossible"
description: "Specifies whether a storage block saves the maximum possible number of values."
---

# BlSampleMaxPossible

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSampleMaxPossible

Specifies whether a storage block saves the maximum possible number of values.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlSampleMaxPossible = <em>Value</em>
...
*Source: `VarOnl/BlSampleMaxPossible.htm`*
