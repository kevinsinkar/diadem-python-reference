---
title: "BlChnNames"
description: "Specifies the channel to be read from the Data Portal via its name."
---
...
Specifies the channel to be read from the Data Portal via its name.
