---
title: "BLMatrixXValue"
description: "Specifies the values DIAdem uses as x-values of the interpolation matrix."
---

# BLMatrixXValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BLMatrixXValue

Specifies the values DIAdem uses as x-values of the interpolation matrix.
...
*Source: `VarOnl/BLMatrixXValue.htm`*
