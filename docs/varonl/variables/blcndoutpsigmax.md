---
title: "BlCndOutpSigMax"
description: "Specifies the number of control signals outgoing from the control outputs."
---

# BlCndOutpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndOutpSigMax

Specifies the number of control signals outgoing from the control outputs.
...
*Source: `VarOnl/BlCndOutpSigMax.htm`*
