---
title: "BlEvntOutpSigMax"
description: "Specifies the number of alarm signals outgoing from the alarm outputs."
---

# BlEvntOutpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntOutpSigMax

Specifies the number of alarm signals outgoing from the alarm outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlEvntOutpSigMax(i)
...
*Source: `VarOnl/BlEvntOutpSigMax.htm`*
