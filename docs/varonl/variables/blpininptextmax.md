---
title: "BlPinInpTextMax"
description: "Specifies the maximum number of text inputs on DAC blocks."
---

# BlPinInpTextMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpTextMax

Specifies the maximum number of text inputs on DAC blocks.
...
*Source: `VarOnl/BlPinInpTextMax.htm`*
