---
title: "BlSignalFormula"
description: "Specifies the names of program variables and auxiliary variables where DIAdem saves results."
---

# BlSignalFormula

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSignalFormula

Specifies the names of program variables and auxiliary variables where DIAdem saves results.
...
*Source: `VarOnl/BlSignalFormula.htm`*
