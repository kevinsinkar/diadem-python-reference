---
title: "BlInBgPicShow"
description: "Specifies whether DIAdem displays a graphic on a push button when the button is pressed."
---

# BlInBgPicShow

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInBgPicShow

Specifies whether DIAdem displays a graphic on a push button when the button is pressed.
...
*Source: `VarOnl/BlInBgPicShow.htm`*
