---
title: "BlMapScaleLineControl"
description: "Specifies that DIAdem shows a scaling bar in OpenStreetMap map displays."
---

# BlMapScaleLineControl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMapScaleLineControl

Specifies that DIAdem shows a scaling bar in OpenStreetMap map displays.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlMapScaleLineControl = <em>Value</em>
...
*Source: `VarOnl/BlMapScaleLineControl.htm`*
