---
title: "BlDataOutpGrpMax"
description: "Specifies the number of data outputs on DAC blocks."
---

# BlDataOutpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataOutpGrpMax

Specifies the number of data outputs on DAC blocks.
...
*Source: `VarOnl/BlDataOutpGrpMax.htm`*
