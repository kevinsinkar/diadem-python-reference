---
title: "BlSignalColor"
description: "Specifies the colors DIAdem uses to plot signals in display instruments."
---

# BlSignalColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSignalColor

Specifies the colors DIAdem uses to plot signals in display instruments.
...
*Source: `VarOnl/BlSignalColor.htm`*
