---
title: "BlCndSourceGrp"
description: "Specifies the number of the signal output from which the control signal that is connected to the control input, originates."
---

# BlCndSourceGrp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndSourceGrp

Specifies the number of the signal output from which the control signal that is connected to the control input, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlCndSourceGrp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlCndSourceGrp.htm`*
