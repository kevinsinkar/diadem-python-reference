---
title: "BlSignalVisible"
description: "Specifies whether DIAdem displays the signal in the display instrument."
---

# BlSignalVisible

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSignalVisible

Specifies whether DIAdem displays the signal in the display instrument.
...
*Source: `VarOnl/BlSignalVisible.htm`*
