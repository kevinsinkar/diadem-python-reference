---
title: "BlGraphDispOff"
description: "Specifies whether DIAdem displays a graphic when a switch is off or when a push button is not pressed."
---

# BlGraphDispOff

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphDispOff

Specifies whether DIAdem displays a graphic when a switch is off or when a push button is not pressed.
...
*Source: `VarOnl/BlGraphDispOff.htm`*
