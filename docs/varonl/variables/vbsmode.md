---
title: "VBSMode"
description: "Specifies the operating mode of the script DAC driver."
---
...
Specifies the operating mode of the script DAC driver.
...
<table class="Borderless" id="table1"><tr><td class="Icon"><img src="image/note.gif"/></td><td><strong>Note  </strong>Refer to the page <a href="#" data-unresolved="1">Operating Modes for the Script DAC Driver</a> for further information about the operating modes.</td></tr></table>
</div>

---

*Source: `VarOnl/VBSMode.htm`*
