---
title: "BlScaleAutoSize"
description: "Specifies whether DIAdem specifies the font size for the scale of a display instrument."
---

# BlScaleAutoSize

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScaleAutoSize

Specifies whether DIAdem specifies the font size for the scale of a display instrument.
...
*Source: `VarOnl/BlScaleAutoSize.htm`*
