---
title: "BlInVariant"
description: "Specifies where DIAdem starts plotting the color shading that DIAdem displays on the push button when the button is not pressed."
---

# BlInVariant

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInVariant

Specifies where DIAdem starts plotting the color shading that DIAdem displays on the push button when the button is not pressed.
