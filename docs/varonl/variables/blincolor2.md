---
title: "BlInColor2"
description: "Specifies the second color in color shading that DIAdem displays on a push button or on a radio button when the push button is not pressed or the radio button i"
---
...
Specifies the second color in color shading that DIAdem displays on a push button or on a radio button when the push button is not pressed or the radio button is not selected.
