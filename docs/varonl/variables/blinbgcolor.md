---
title: "BlInBgColor"
description: "Specifies the filling color for a push button or for a radio button, which DIAdem displays when the push button is pressed or the radio button is selected."
---

# BlInBgColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInBgColor

Specifies the filling color for a push button or for a radio button, which DIAdem displays when the push button is pressed or the radio button is selected.
