---
title: "BlTimeFormat"
description: "Specifies whether DIAdem displays the time range with or without decimal places."
---

# BlTimeFormat

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTimeFormat

Specifies whether DIAdem displays the time range with or without decimal places.
...
*Source: `VarOnl/BlTimeFormat.htm`*
