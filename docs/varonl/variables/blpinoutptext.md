---
title: "BlPinOutpText"
description: "Specifies the names of the text outputs on DAC blocks."
---

# BlPinOutpText

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpText

Specifies the names of the text outputs on DAC blocks.
...
*Source: `VarOnl/BlPinOutpText.htm`*
