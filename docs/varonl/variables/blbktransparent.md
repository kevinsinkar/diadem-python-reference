---
title: "BlBkTransparent"
description: "Specifies whether DIAdem displays the background graphic in a display instrument as transparent."
---

# BlBkTransparent

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBkTransparent

Specifies whether DIAdem displays the background graphic in a display instrument as transparent.
...
*Source: `VarOnl/BlBkTransparent.htm`*
