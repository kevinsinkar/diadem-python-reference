---
title: "BlLinInp2"
description: "Specifies the second voltage value of the preamplifier output of a thermo linearization."
---
...
Specifies the second voltage value of the preamplifier output of a thermo linearization.
