---
title: "BlVisLineCount"
description: "Specifies the number of lines displayed in messages and tables."
---

# BlVisLineCount

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVisLineCount

Specifies the number of lines displayed in messages and tables.
...
*Source: `VarOnl/BlVisLineCount.htm`*
