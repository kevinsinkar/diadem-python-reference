---
title: "BlPkTxMethod"
description: "Specifies which value the Unpack packet block outputs until a new data packet arrives."
---

# BlPkTxMethod

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPkTxMethod

Specifies which value the Unpack packet block outputs until a new data packet arrives.
...
*Source: `VarOnl/BlPkTxMethod.htm`*
