---
title: "BlPackInpGrpDim"
description: "The BlPackInpGrpDim variable can contain the following values:"
---

# BlPackInpGrpDim

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackInpGrpDim

The BlPackInpGrpDim variable can contain the following values:
...
*Source: `VarOnl/BlPackInpGrpDim.htm`*
