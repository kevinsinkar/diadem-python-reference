---
title: "BlPackOutpGrpMax"
description: "Specifies the number of packet outputs at DAC blocks."
---

# BlPackOutpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackOutpGrpMax

Specifies the number of packet outputs at DAC blocks.
...
*Source: `VarOnl/BlPackOutpGrpMax.htm`*
