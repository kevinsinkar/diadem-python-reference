---
title: "BlControlSetPt"
description: "Specifies the constant set point of a controller."
---

# BlControlSetPt

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlControlSetPt

Specifies the constant set point of a controller.
...
*Source: `VarOnl/BlControlSetPt.htm`*
