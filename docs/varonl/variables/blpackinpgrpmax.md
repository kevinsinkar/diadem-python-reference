---
title: "BlPackInpGrpMax"
description: "Specifies the number of packet inputs at DAC blocks."
---

# BlPackInpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackInpGrpMax

Specifies the number of packet inputs at DAC blocks.
...
*Source: `VarOnl/BlPackInpGrpMax.htm`*
