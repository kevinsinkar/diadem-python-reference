---
title: "BlAutoRatio"
description: "Specifies whether DIAdem maintains the width-to-height ratio of the container graphic."
---

# BlAutoRatio

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAutoRatio

Specifies whether DIAdem maintains the width-to-height ratio of the container graphic.
