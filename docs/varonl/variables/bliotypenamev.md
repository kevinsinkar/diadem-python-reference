---
title: "BlIoTypeNameV"
description: "Specifies the names of input type and output type definitions."
---

# BlIoTypeNameV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlIoTypeNameV

Specifies the names of input type and output type definitions.
...
*Source: `VarOnl/BlIoTypeNameV.htm`*
