---
title: "BlOutpTypeName"
description: "Specifies the name of the signal type of an output block."
---

# BlOutpTypeName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlOutpTypeName

Specifies the name of the signal type of an output block.
...
*Source: `VarOnl/BlOutpTypeName.htm`*
