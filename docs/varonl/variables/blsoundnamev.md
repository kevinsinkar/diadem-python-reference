---
title: "BlSoundNameV"
description: "Specifies the audio files that DIAdem plays in the status display."
---

# BlSoundNameV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSoundNameV

Specifies the audio files that DIAdem plays in the status display.
...
*Source: `VarOnl/BlSoundNameV.htm`*
