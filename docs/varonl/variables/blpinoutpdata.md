---
title: "BlPinOutpData"
description: "Specifies the names of the data outputs at DAC blocks."
---

# BlPinOutpData

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpData

Specifies the names of the data outputs at DAC blocks.
...
*Source: `VarOnl/BlPinOutpData.htm`*
