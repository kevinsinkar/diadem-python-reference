---
title: "BlAVVideoWithAudio"
description: "Specifies whether DIAdem records the video with or without sound track."
---

# BlAVVideoWithAudio

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVVideoWithAudio

Specifies whether DIAdem records the video with or without sound track.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlAVVideoWithAudio = <em>Value</em>
...
*Source: `VarOnl/BlAVVideoWithAudio.htm`*
