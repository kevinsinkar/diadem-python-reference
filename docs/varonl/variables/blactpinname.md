---
title: "BlActPinName"
description: "Specifies the dialog box name of an open block connection."
---

# BlActPinName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinName

Specifies the dialog box name of an open block connection.
...
*Source: `VarOnl/BlActPinName.htm`*
