---
title: "BlXRangeMinDisp"
description: "Specifies the lower limit of the display range of the x-signal of an xy-display or scatter display."
---

# BlXRangeMinDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlXRangeMinDisp

Specifies the lower limit of the display range of the x-signal of an xy-display or scatter display.
...
*Source: `VarOnl/BlXRangeMinDisp.htm`*
