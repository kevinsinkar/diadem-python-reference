---
title: "VBSConnector"
description: "Specifies the number of a measurement point of the script DAC driver."
---

# VBSConnector

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSConnector

Specifies the number of a measurement point of the script DAC driver.
...
*Source: `VarOnl/VBSConnector.htm`*
