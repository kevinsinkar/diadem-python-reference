---
title: "BlEvntInpGrpMax"
description: "Specifies the number of alarm inputs on DAC blocks."
---

# BlEvntInpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntInpGrpMax

Specifies the number of alarm inputs on DAC blocks.
...
*Source: `VarOnl/BlEvntInpGrpMax.htm`*
