---
title: "BlInstrTimeRange"
description: "Specifies the range of the time axis of display instruments."
---

# BlInstrTimeRange

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrTimeRange

Specifies the range of the time axis of display instruments.
...
*Source: `VarOnl/BlInstrTimeRange.htm`*
