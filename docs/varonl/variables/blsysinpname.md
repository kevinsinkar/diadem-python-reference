---
title: "BlSysInpName"
description: "Specifies the terminal names of the clock signals at system inputs."
---

# BlSysInpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysInpName

Specifies the terminal names of the clock signals at system inputs.
...
*Source: `VarOnl/BlSysInpName.htm`*
