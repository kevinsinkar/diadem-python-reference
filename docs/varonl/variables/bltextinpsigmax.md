---
title: "BlTextInpSigMax"
description: "Specifies the maximum number of text signals located at text inputs."
---

# BlTextInpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextInpSigMax

Specifies the maximum number of text signals located at text inputs.
...
*Source: `VarOnl/BlTextInpSigMax.htm`*
