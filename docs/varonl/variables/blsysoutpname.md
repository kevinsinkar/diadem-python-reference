---
title: "BlSysOutpName"
description: "Specifies the terminal names of the clock signals at system outputs."
---

# BlSysOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysOutpName

Specifies the terminal names of the clock signals at system outputs.
...
*Source: `VarOnl/BlSysOutpName.htm`*
