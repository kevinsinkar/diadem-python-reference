---
title: "BlManStepWidth"
description: "Specifies the step width between two values for manual input instruments."
---

# BlManStepWidth

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManStepWidth

Specifies the step width between two values for manual input instruments.
...
*Source: `VarOnl/BlManStepWidth.htm`*
