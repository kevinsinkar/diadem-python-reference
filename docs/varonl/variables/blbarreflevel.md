---
title: "BlBarRefLevel"
description: "Specifies the reference point of a bar display as a percentage of the bar display area."
---

# BlBarRefLevel

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBarRefLevel

Specifies the reference point of a bar display as a percentage of the bar display area.
...
*Source: `VarOnl/BlBarRefLevel.htm`*
