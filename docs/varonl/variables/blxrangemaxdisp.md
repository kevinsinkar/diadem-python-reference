---
title: "BlXRangeMaxDisp"
description: "Specifies the upper limit of the display range of the x-signal of an xy-display or scatter display."
---

# BlXRangeMaxDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlXRangeMaxDisp

Specifies the upper limit of the display range of the x-signal of an xy-display or scatter display.
...
*Source: `VarOnl/BlXRangeMaxDisp.htm`*
