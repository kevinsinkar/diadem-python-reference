---
title: "BlManRatioOff"
description: "Specifies whether DIAdem maintains the height/width ratio of the graphic that DIAdem displays when the push button is not pressed."
---

# BlManRatioOff

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManRatioOff

Specifies whether DIAdem maintains the height/width ratio of the graphic that DIAdem displays when the push button is not pressed.
...
*Source: `VarOnl/BlManRatioOff.htm`*
