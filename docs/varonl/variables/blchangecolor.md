---
title: "BlChangeColor"
description: "Specifies whether DIAdem displays the entire bar in the warning color and the alarm color when the limit value is exceeded."
---

# BlChangeColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlChangeColor

Specifies whether DIAdem displays the entire bar in the warning color and the alarm color when the limit value is exceeded.
...
*Source: `VarOnl/BlChangeColor.htm`*
