---
title: "BlFrBrightness"
description: "Specifies gray as the second color for color shading of an instrument frame in monochrome display."
---

# BlFrBrightness

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlFrBrightness

Specifies gray as the second color for color shading of an instrument frame in monochrome display.
...
*Source: `VarOnl/BlFrBrightness.htm`*
