---
title: "BlPinOutpEvnt"
description: "Specifies the names of the alarm outputs on DAC blocks."
---

# BlPinOutpEvnt

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpEvnt

Specifies the names of the alarm outputs on DAC blocks.
...
*Source: `VarOnl/BlPinOutpEvnt.htm`*
