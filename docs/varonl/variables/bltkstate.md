---
title: "BlTkState"
description: "Specifies the status of a system clock with the block System clock status ."
---
...
Specifies the status of a system clock with the block System clock status .
