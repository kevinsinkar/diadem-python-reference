---
title: "BlGraphNameV"
description: "Specifies the graphic that shows a status display for the individual data signals."
---

# BlGraphNameV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphNameV

Specifies the graphic that shows a status display for the individual data signals.
...
*Source: `VarOnl/BlGraphNameV.htm`*
