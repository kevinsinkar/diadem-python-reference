---
title: "BlDataSourceBl"
description: "Specifies the number of the DAC block from which the data signal that is connected to the data input, originates."
---

# BlDataSourceBl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataSourceBl

Specifies the number of the DAC block from which the data signal that is connected to the data input, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlDataSourceBl(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlDataSourceBl.htm`*
