---
title: "BlArrowColor"
description: "Specifies the pointer colors of polar displays."
---

# BlArrowColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlArrowColor

Specifies the pointer colors of polar displays.
...
*Source: `VarOnl/BlArrowColor.htm`*
