---
title: "BlGraphPathOff"
description: "Specifies the name of a graphic and path that DIAdem displays when the switch is off or the push button is not pressed."
---

# BlGraphPathOff

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphPathOff

Specifies the name of a graphic and path that DIAdem displays when the switch is off or the push button is not pressed.
...
*Source: `VarOnl/BlGraphPathOff.htm`*
