---
title: "BlInColor"
description: "Specifies the filling color for a push button that is not pressed or for a radio button that is not selected."
---
...
Specifies the filling color for a push button that is not pressed or for a radio button that is not selected.
