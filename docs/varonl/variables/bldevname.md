---
title: "BlDevName"
description: "Specifies the device name of a hardware driver block."
---
...
Specifies the device name of a hardware driver block.
