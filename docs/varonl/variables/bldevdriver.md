---
title: "BlDevDriver"
description: "Specifies the device driver of a hardware driver block."
---

# BlDevDriver

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDevDriver

Specifies the device driver of a hardware driver block.
