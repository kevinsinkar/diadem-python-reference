---
title: "BlPinIconRow"
description: "Specifies the row in the graphics file which contains the symbol for the block terminal."
---

# BlPinIconRow

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinIconRow

Specifies the row in the graphics file which contains the symbol for the block terminal.
...
*Source: `VarOnl/BlPinIconRow.htm`*
