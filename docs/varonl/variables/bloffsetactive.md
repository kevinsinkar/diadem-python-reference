---
title: "BlOffsetActive"
description: "Specifies whether DIAdem executes the offset correction."
---

# BlOffsetActive

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlOffsetActive

Specifies whether DIAdem executes the offset correction.
...
*Source: `VarOnl/BlOffsetActive.htm`*
