---
title: "BlScale2Inp1"
description: "Specifies the first measurement value for a two-point scaling."
---

# BlScale2Inp1

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale2Inp1

Specifies the first measurement value for a two-point scaling.
...
*Source: `VarOnl/BlScale2Inp1.htm`*
