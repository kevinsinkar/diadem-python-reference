---
title: "BlSysSignalName"
description: "Specifies the signal names of the signals at system outputs."
---

# BlSysSignalName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysSignalName

Specifies the signal names of the signals at system outputs.
...
*Source: `VarOnl/BlSysSignalName.htm`*
