---
title: "VBSCustomDlgName"
description: "Specifies the name of the dialog box contained in the dialog box file. A SUD file can contain several dialog boxes."
---

# VBSCustomDlgName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSCustomDlgName

Specifies the name of the dialog box contained in the dialog box file. A SUD file can contain several dialog boxes.
...
*Source: `VarOnl/VBSCustomDlgName.htm`*
