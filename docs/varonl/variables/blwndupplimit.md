---
title: "BlWndUppLimit"
description: "Specifies the end value of a count."
---

# BlWndUppLimit

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlWndUppLimit

Specifies the end value of a count.
...
*Source: `VarOnl/BlWndUppLimit.htm`*
