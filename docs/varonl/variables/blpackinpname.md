---
title: "BlPackInpName"
description: "Specifies the terminal names of packet signals at packet inputs."
---

# BlPackInpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackInpName

Specifies the terminal names of packet signals at packet inputs.
...
*Source: `VarOnl/BlPackInpName.htm`*
