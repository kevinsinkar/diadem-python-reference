---
title: "BlInBrightness"
description: "Specifies gray as the second color of color shading that DIAdem displays on a push button when the button is not pressed. A brightness value of 0 is black, and "
---

# BlInBrightness

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInBrightness

Specifies gray as the second color of color shading that DIAdem displays on a push button when the button is not pressed. A brightness value of 0 is black, and a value of 255 is white.
...
*Source: `VarOnl/BlInBrightness.htm`*
