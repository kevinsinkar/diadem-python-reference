---
title: "BlTextOutpSigMax"
description: "Specifies the maximum number of text signals outgoing from text outputs."
---

# BlTextOutpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextOutpSigMax

Specifies the maximum number of text signals outgoing from text outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlTextOutpSigMax(i)
...
*Source: `VarOnl/BlTextOutpSigMax.htm`*
