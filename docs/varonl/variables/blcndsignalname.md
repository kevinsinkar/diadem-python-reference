---
title: "BlCndSignalName"
description: "Specifies the signal names of the signals at control outputs."
---

# BlCndSignalName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndSignalName

Specifies the signal names of the signals at control outputs.
...
*Source: `VarOnl/BlCndSignalName.htm`*
