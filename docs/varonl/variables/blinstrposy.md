---
title: "BlInstrPosY"
description: "Specifies the distance of the reference point of a display from the bottom edge of the page, as a percentage of the worksheet."
---

# BlInstrPosY

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrPosY

Specifies the distance of the reference point of a display from the bottom edge of the page, as a percentage of the worksheet.
