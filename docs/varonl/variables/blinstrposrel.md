---
title: "BlInstrPosRel"
description: "Specifies the position of a display in relation to the reference point."
---

# BlInstrPosRel

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrPosRel

Specifies the position of a display in relation to the reference point.
...
*Source: `VarOnl/BlInstrPosRel.htm`*
