---
title: "BlPinOutpDataMax"
description: "Specifies the maximum number of data outputs at DAC blocks."
---

# BlPinOutpDataMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpDataMax

Specifies the maximum number of data outputs at DAC blocks.
...
*Source: `VarOnl/BlPinOutpDataMax.htm`*
