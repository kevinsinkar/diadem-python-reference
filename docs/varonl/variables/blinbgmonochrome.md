---
title: "BlInBgMonochrome"
description: "Specifies gray as the second color of a color shading that DIAdem displays on a push button when the button is pressed."
---

# BlInBgMonochrome

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInBgMonochrome

Specifies gray as the second color of a color shading that DIAdem displays on a push button when the button is pressed.
...
*Source: `VarOnl/BlInBgMonochrome.htm`*
