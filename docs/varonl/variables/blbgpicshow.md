---
title: "BlBgPicShow"
description: "Specifies whether DIAdem displays a background graphic in the display instrument."
---

# BlBgPicShow

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBgPicShow

Specifies whether DIAdem displays a background graphic in the display instrument.
