---
title: "BlLimit1Color"
description: "Specifies the color of the warning range in display instruments."
---

# BlLimit1Color

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLimit1Color

Specifies the color of the warning range in display instruments.
...
*Source: `VarOnl/BlLimit1Color.htm`*
