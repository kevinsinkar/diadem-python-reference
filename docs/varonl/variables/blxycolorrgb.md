---
title: "BlXYColorRGB"
description: "Specifies the RGB values for the signal colors of an xy-display or a scatter display."
---

# BlXYColorRGB

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlXYColorRGB

Specifies the RGB values for the signal colors of an xy-display or a scatter display.
...
*Source: `VarOnl/BlXYColorRGB.htm`*
