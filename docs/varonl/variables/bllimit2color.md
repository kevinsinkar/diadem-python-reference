---
title: "BlLimit2Color"
description: "Specifies the color of the alarm range in display instruments."
---

# BlLimit2Color

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLimit2Color

Specifies the color of the alarm range in display instruments.
...
*Source: `VarOnl/BlLimit2Color.htm`*
