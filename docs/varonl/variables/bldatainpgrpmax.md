---
title: "BlDataInpGrpMax"
description: "Specifies the number of data inputs at DAC blocks."
---

# BlDataInpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataInpGrpMax

Specifies the number of data inputs at DAC blocks.
...
*Source: `VarOnl/BlDataInpGrpMax.htm`*
