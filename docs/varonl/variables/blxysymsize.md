---
title: "BlXYSymSize"
description: "Specifies the size of the symbol or graphic displayed in an xy-display."
---

# BlXYSymSize

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlXYSymSize

Specifies the size of the symbol or graphic displayed in an xy-display.
