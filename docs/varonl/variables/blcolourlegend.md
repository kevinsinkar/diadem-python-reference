---
title: "BlColourLegend"
description: "Specifies whether and where DIAdem displays a color legend for the color matrix."
---

# BlColourLegend

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlColourLegend

Specifies whether and where DIAdem displays a color legend for the color matrix.
...
*Source: `VarOnl/BlColourLegend.htm`*
