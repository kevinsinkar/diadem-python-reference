---
title: "BlMapType"
description: "Specifies which map type DIAdem uses for the map display."
---
...
Specifies which map type DIAdem uses for the map display.
