---
title: "BlNoDataOutput"
description: "Specifies whether the output signals of the DAC block are active."
---

# BlNoDataOutput

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlNoDataOutput

Specifies whether the output signals of the DAC block are active.
...
*Source: `VarOnl/BlNoDataOutput.htm`*
