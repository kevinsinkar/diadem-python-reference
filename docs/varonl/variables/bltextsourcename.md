---
title: "BlTextSourceName"
description: "Specifies the names of the text signals that are connected to the text inputs."
---

# BlTextSourceName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextSourceName

Specifies the names of the text signals that are connected to the text inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlTextSourceName(i,j)
...
*Source: `VarOnl/BlTextSourceName.htm`*
