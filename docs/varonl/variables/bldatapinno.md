---
title: "BlDataPinNo"
description: "Specifies the number of the physical supply terminal that DIAdem acquires the data of the data signal from."
---

# BlDataPinNo

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataPinNo

Specifies the number of the physical supply terminal that DIAdem acquires the data of the data signal from.
