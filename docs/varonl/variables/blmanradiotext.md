---
title: "BlManRadioText"
description: "Specifies the text for the options."
---

# BlManRadioText

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManRadioText

Specifies the text for the options.
...
*Source: `VarOnl/BlManRadioText.htm`*
