---
title: "BlChnDelay"
description: "Specifies the number of values between the channel start and the channel values that DIAdem accesses."
---
...
Specifies the number of values between the channel start and the channel values that DIAdem accesses.
