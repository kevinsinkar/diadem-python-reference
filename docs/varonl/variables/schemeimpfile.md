---
title: "SchemeImpFile"
description: "Specifies the subblock diagram file to be loaded."
---

# SchemeImpFile

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: SchemeImpFile

Specifies the subblock diagram file to be loaded.
...
*Source: `VarOnl/SchemeImpFile.htm`*
