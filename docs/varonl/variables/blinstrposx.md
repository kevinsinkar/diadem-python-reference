---
title: "BlInstrPosX"
description: "Specifies the distance of the reference point of a display from the left side of the page, as a percentage of the worksheet."
---

# BlInstrPosX

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrPosX

Specifies the distance of the reference point of a display from the left side of the page, as a percentage of the worksheet.
