---
title: "BlPinInpEvnt"
description: "Specifies the names of the alarm inputs on DAC blocks."
---

# BlPinInpEvnt

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpEvnt

Specifies the names of the alarm inputs on DAC blocks.
...
*Source: `VarOnl/BlPinInpEvnt.htm`*
