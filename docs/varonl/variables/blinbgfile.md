---
title: "BlInBgFile"
description: "Specifies the name and the path of the graphics file that DIAdem displays on a push button or on a radio button when the button is pressed."
---
...
Specifies the name and the path of the graphics file that DIAdem displays on a push button or on a radio button when the button is pressed.
