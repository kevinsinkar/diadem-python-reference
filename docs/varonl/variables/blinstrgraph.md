---
title: "BlInstrGraph"
description: "Specifies the container graphic in which DIAdem displays the bar."
---

# BlInstrGraph

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrGraph

Specifies the container graphic in which DIAdem displays the bar.
...
*Source: `VarOnl/BlInstrGraph.htm`*
