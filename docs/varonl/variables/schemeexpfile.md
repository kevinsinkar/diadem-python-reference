---
title: "SchemeExpFile"
description: "Specifies the subblock diagram file to be saved."
---

# SchemeExpFile

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: SchemeExpFile

Specifies the subblock diagram file to be saved.
...
*Source: `VarOnl/SchemeExpFile.htm`*
