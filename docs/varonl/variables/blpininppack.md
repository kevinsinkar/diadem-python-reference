---
title: "BlPinInpPack"
description: "Specifies the names of the packet inputs on DAC blocks."
---

# BlPinInpPack

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpPack

Specifies the names of the packet inputs on DAC blocks.
...
*Source: `VarOnl/BlPinInpPack.htm`*
