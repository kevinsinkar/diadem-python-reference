---
title: "BlSymbolName"
description: "Specifies the name of the graphics file that shows the XY-display or the scatter display as a symbol."
---

# BlSymbolName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSymbolName

Specifies the name of the graphics file that shows the XY-display or the scatter display as a symbol.
...
*Source: `VarOnl/BlSymbolName.htm`*
