---
title: "BlPackOutpSigMax"
description: "Specifies the number of packet signals at the packet inputs."
---

# BlPackOutpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackOutpSigMax

Specifies the number of packet signals at the packet inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlPackOutpSigMax(i)
...
*Source: `VarOnl/BlPackOutpSigMax.htm`*
