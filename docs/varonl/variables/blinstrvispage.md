---
title: "BlInstrVisPage"
description: "Specifies the VISUAL page."
---

# BlInstrVisPage

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrVisPage

Specifies the VISUAL page.
...
<table class="Borderless" id="table2"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>Use VISUAL pages to show or to hide various displays simultaneously during the layout phase, or to block further configuration for these displays.</td></tr></table>
</div>

---

*Source: `VarOnl/BlInstrVisPage.htm`*
