---
title: "BlFrameColor"
description: "Specifies the frame color of a graphic."
---

# BlFrameColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlFrameColor

Specifies the frame color of a graphic.
...
*Source: `VarOnl/BlFrameColor.htm`*
