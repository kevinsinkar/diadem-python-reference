---
title: "BlScale2Phys1V"
description: "Specifies the first physical values for two-point scaling."
---

# BlScale2Phys1V

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale2Phys1V

Specifies the first physical values for two-point scaling.
...
*Source: `VarOnl/BlScale2Phys1V.htm`*
