---
title: "BlStartDelay"
description: "Specifies in seconds the time that elapses before the impulse delay forwards the incoming control signal."
---

# BlStartDelay

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlStartDelay

Specifies in seconds the time that elapses before the impulse delay forwards the incoming control signal.
...
*Source: `VarOnl/BlStartDelay.htm`*
