---
title: "BlActPinOutpDir"
description: "Specifies whether a block terminal is an input or an output."
---

# BlActPinOutpDir

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinOutpDir

Specifies whether a block terminal is an input or an output.
...
*Source: `VarOnl/BlActPinOutpDir.htm`*
