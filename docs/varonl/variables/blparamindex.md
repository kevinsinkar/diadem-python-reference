---
title: "BlParamIndex"
description: "Specifies the index of the signal type of an acquisition block or of an output block."
---

# BlParamIndex

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlParamIndex

Specifies the index of the signal type of an acquisition block or of an output block.
...
*Source: `VarOnl/BlParamIndex.htm`*
