---
title: "BlStopExternal"
description: "Specifies that an external TTL signal initiates a stop trigger."
---

# BlStopExternal

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlStopExternal

Specifies that an external TTL signal initiates a stop trigger.
...
*Source: `VarOnl/BlStopExternal.htm`*
