---
title: "VBSFileName"
description: "Specifies the name of the script the script DAC driver uses."
---

# VBSFileName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSFileName

Specifies the name of the script the script DAC driver uses.
