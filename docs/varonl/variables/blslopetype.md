---
title: "BlSlopeType"
description: "Specifies the direction of a slope."
---

# BlSlopeType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSlopeType

Specifies the direction of a slope.
