---
title: "BlAVCapture"
description: "Specifies whether DIAdem starts recording the video when the measurement starts."
---

# BlAVCapture

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVCapture

Specifies whether DIAdem starts recording the video when the measurement starts.
