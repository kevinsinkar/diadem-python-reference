---
title: "BlMsgTimeStamp"
description: "Specifies whether DIAdem displays the time before each message."
---

# BlMsgTimeStamp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMsgTimeStamp

Specifies whether DIAdem displays the time before each message.
...
*Source: `VarOnl/BlMsgTimeStamp.htm`*
