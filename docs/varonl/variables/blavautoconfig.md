---
title: "BlAVAutoConfig"
description: "Specifies whether DIAdem determines the settings of the video camera automatically."
---

# BlAVAutoConfig

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVAutoConfig

Specifies whether DIAdem determines the settings of the video camera automatically.
...
*Source: `VarOnl/BlAVAutoConfig.htm`*
