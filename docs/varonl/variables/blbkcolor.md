---
title: "BlBkColor"
description: "Specifies the background color of display instruments."
---
...
Specifies the background color of display instruments.
...
<table class="Borderless"><tr><td class="Icon"><img src="image/note.gif"/></td><td><strong>Note  </strong>Use an empty entry to select transparency as color.</td></tr></table>
</div>

---

*Source: `VarOnl/BlBkColor.htm`*
