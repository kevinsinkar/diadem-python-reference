---
title: "BlRangeMaxDisp"
description: "Specifies the upper limit of the display range for display instruments."
---

# BlRangeMaxDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlRangeMaxDisp

Specifies the upper limit of the display range for display instruments.
...
*Source: `VarOnl/BlRangeMaxDisp.htm`*
