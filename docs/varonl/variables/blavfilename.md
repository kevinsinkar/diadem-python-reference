---
title: "BlAVFilename"
description: "Specifies the filename for storing the video."
---

# BlAVFilename

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVFilename

Specifies the filename for storing the video.
...
*Source: `VarOnl/BlAVFilename.htm`*
