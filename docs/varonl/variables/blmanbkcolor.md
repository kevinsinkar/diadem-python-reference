---
title: "BlManBkColor"
description: "Specifies a color for display instruments."
---

# BlManBkColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManBkColor

Specifies a color for display instruments.
...
*Source: `VarOnl/BlManBkColor.htm`*
