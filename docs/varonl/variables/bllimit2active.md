---
title: "BlLimit2Active"
description: "Specifies whether DIAdem displays the alarm range in display instruments."
---

# BlLimit2Active

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLimit2Active

Specifies whether DIAdem displays the alarm range in display instruments.
...
*Source: `VarOnl/BlLimit2Active.htm`*
