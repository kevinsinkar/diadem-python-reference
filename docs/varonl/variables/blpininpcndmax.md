---
title: "BlPinInpCndMax"
description: "Specifies the maximum number of control inputs at DAC blocks."
---

# BlPinInpCndMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpCndMax

Specifies the maximum number of control inputs at DAC blocks.
...
*Source: `VarOnl/BlPinInpCndMax.htm`*
