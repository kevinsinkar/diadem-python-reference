---
title: "BlCndInpName"
description: "Specifies the terminal names of control signals at control inputs."
---

# BlCndInpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndInpName

Specifies the terminal names of control signals at control inputs.
...
*Source: `VarOnl/BlCndInpName.htm`*
