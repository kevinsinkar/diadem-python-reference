---
title: "BlIconColumn"
description: "Specifies the column in the graphics file, which contains the symbol for a DAC block."
---

# BlIconColumn

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlIconColumn

Specifies the column in the graphics file, which contains the symbol for a DAC block.
...
*Source: `VarOnl/BlIconColumn.htm`*
