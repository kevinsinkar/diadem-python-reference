---
title: "BlActPinSigMark"
description: "Specifies whether a signal is selected in the open dialog box of a block input."
---

# BlActPinSigMark

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinSigMark

Specifies whether a signal is selected in the open dialog box of a block input.
...
*Source: `VarOnl/BlActPinSigMark.htm`*
