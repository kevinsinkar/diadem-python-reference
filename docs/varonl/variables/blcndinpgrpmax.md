---
title: "BlCndInpGrpMax"
description: "Specifies the number of control inputs at DAC blocks."
---

# BlCndInpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndInpGrpMax

Specifies the number of control inputs at DAC blocks.
...
*Source: `VarOnl/BlCndInpGrpMax.htm`*
