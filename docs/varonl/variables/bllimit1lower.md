---
title: "BlLimit1Lower"
description: "Specifies the lower limit of the warning range in display instruments."
---

# BlLimit1Lower

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLimit1Lower

Specifies the lower limit of the warning range in display instruments.
...
*Source: `VarOnl/BlLimit1Lower.htm`*
