---
title: "BlBgMonochrome"
description: "Specifies whether one of the two colors of a color shading in the background of a display instrument is gray."
---

# BlBgMonochrome

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBgMonochrome

Specifies whether one of the two colors of a color shading in the background of a display instrument is gray.
...
*Source: `VarOnl/BlBgMonochrome.htm`*
