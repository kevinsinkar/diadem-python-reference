---
title: "BlRefChnName"
description: "Specifies the name of the reference channel or time time channel that DIAdem creates when DIAdem saves measurement values."
---

# BlRefChnName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlRefChnName

Specifies the name of the reference channel or time time channel that DIAdem creates when DIAdem saves measurement values.
...
*Source: `VarOnl/BlRefChnName.htm`*
