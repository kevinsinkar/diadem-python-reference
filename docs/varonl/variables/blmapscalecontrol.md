---
title: "BlMapScaleControl"
description: "Specifies that DIAdem shows the scale in the map display of OpenStreetMap maps."
---

# BlMapScaleControl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMapScaleControl

Specifies that DIAdem shows the scale in the map display of OpenStreetMap maps.
...
*Source: `VarOnl/BlMapScaleControl.htm`*
