---
title: "BlSysSourceName"
description: "Specifies the names of the clock signals connected to the system inputs."
---

# BlSysSourceName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysSourceName

Specifies the names of the clock signals connected to the system inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlSysSourceName(i,j)
...
*Source: `VarOnl/BlSysSourceName.htm`*
