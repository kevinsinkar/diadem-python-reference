---
title: "BlLimit1Upper"
description: "Specifies the upper limit of the warning range in display instruments."
---

# BlLimit1Upper

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLimit1Upper

Specifies the upper limit of the warning range in display instruments.
...
*Source: `VarOnl/BlLimit1Upper.htm`*
