---
title: "BlDataSourceGrp"
description: "Specifies the number of the signal output from which the data signal that is connected to the data inputs, originates."
---

# BlDataSourceGrp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataSourceGrp

Specifies the number of the signal output from which the data signal that is connected to the data inputs, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlDataSourceGrp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlDataSourceGrp.htm`*
