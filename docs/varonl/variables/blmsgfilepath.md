---
title: "BlMsgFilePath"
description: "Specifies the path of a message file."
---

# BlMsgFilePath

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMsgFilePath

Specifies the path of a message file.
...
*Source: `VarOnl/BlMsgFilePath.htm`*
