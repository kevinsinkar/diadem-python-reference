---
title: "BlWndUppLimitV"
description: "Specifies the upper limit values of a window condition."
---

# BlWndUppLimitV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlWndUppLimitV

Specifies the upper limit values of a window condition.
...
*Source: `VarOnl/BlWndUppLimitV.htm`*
