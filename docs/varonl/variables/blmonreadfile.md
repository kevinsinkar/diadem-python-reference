---
title: "BlMonReadFile"
description: "Specifies the position where DIAdem starts to read out a DAT measurement file."
---

# BlMonReadFile

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMonReadFile

Specifies the position where DIAdem starts to read out a DAT measurement file.
...
*Source: `VarOnl/BlMonReadFile.htm`*
