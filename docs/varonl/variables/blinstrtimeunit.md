---
title: "BlInstrTimeUnit"
description: "Specifies the unit of the time axis of display instruments."
---

# BlInstrTimeUnit

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrTimeUnit

Specifies the unit of the time axis of display instruments.
...
*Source: `VarOnl/BlInstrTimeUnit.htm`*
