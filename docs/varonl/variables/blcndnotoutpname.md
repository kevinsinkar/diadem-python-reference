---
title: "BlCndNotOutpName"
description: "Specifies the terminal names of inverted control signals at control outputs."
---

# BlCndNotOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndNotOutpName

Specifies the terminal names of inverted control signals at control outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlCndNotOutpName(i) = <em>Value</em>
...
*Source: `VarOnl/BlCndNotOutpName.htm`*
