---
title: "BlGraphDispOn"
description: "Specifies whether DIAdem displays a graphic when a switch is on or when a push button is pressed."
---

# BlGraphDispOn

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphDispOn

Specifies whether DIAdem displays a graphic when a switch is on or when a push button is pressed.
...
*Source: `VarOnl/BlGraphDispOn.htm`*
