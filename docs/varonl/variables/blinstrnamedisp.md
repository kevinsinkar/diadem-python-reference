---
title: "BlInstrNameDisp"
description: "Specifies whether DIAdem displays the block name of display instruments."
---

# BlInstrNameDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrNameDisp

Specifies whether DIAdem displays the block name of display instruments.
...
*Source: `VarOnl/BlInstrNameDisp.htm`*
