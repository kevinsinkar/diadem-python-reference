---
title: "VBSCustomDlgUse"
description: "Specifies that DIAdem opens the user dialog box for the configuration of the DAC block."
---

# VBSCustomDlgUse

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSCustomDlgUse

Specifies that DIAdem opens the user dialog box for the configuration of the DAC block.
...
*Source: `VarOnl/VBSCustomDlgUse.htm`*
