---
title: "BlPinInpText"
description: "Specifies the names of the text inputs on DAC blocks."
---

# BlPinInpText

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpText

Specifies the names of the text inputs on DAC blocks.
...
*Source: `VarOnl/BlPinInpText.htm`*
