---
title: "BlActPinSigMax"
description: "Specifies the number of terminals in a block input."
---

# BlActPinSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinSigMax

Specifies the number of terminals in a block input.
...
*Source: `VarOnl/BlActPinSigMax.htm`*
