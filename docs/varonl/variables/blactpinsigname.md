---
title: "BlActPinSigName"
description: "Specifies the name of a signal at the open block input."
---

# BlActPinSigName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinSigName

Specifies the name of a signal at the open block input.
...
*Source: `VarOnl/BlActPinSigName.htm`*
