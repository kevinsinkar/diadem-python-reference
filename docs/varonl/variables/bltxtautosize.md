---
title: "BlTxtAutoSize"
description: "Specifies whether DIAdem specifies the font size for display instruments and for manual input."
---

# BlTxtAutoSize

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTxtAutoSize

Specifies whether DIAdem specifies the font size for display instruments and for manual input.
...
*Source: `VarOnl/BlTxtAutoSize.htm`*
