---
title: "BlManOpenAng"
description: "Specifies the aperture angle of a dial."
---

# BlManOpenAng

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManOpenAng

Specifies the aperture angle of a dial.
...
*Source: `VarOnl/BlManOpenAng.htm`*
