---
title: "BLMatrixYValue"
description: "Specifies the values DIAdem uses as y-values of the interpolation matrix."
---

# BLMatrixYValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BLMatrixYValue

Specifies the values DIAdem uses as y-values of the interpolation matrix.
...
*Source: `VarOnl/BLMatrixYValue.htm`*
