---
title: "BlSysInpSigMax"
description: "Specifies the maximum number of clock signals at system inputs."
---

# BlSysInpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysInpSigMax

Specifies the maximum number of clock signals at system inputs.
...
*Source: `VarOnl/BlSysInpSigMax.htm`*
