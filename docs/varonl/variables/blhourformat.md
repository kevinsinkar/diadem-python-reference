---
title: "BlHourFormat"
description: "Specifies whether DIAdem measures the time or running measurement in 12 hour cycles or 24 hour cycles."
---

# BlHourFormat

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlHourFormat

Specifies whether DIAdem measures the time or running measurement in 12 hour cycles or 24 hour cycles.
...
*Source: `VarOnl/BlHourFormat.htm`*
