---
title: "BlPkSize"
description: "Specifies the number of values that the Pack packet block combines to data packets."
---
...
Specifies the number of values that the Pack packet block combines to data packets.
