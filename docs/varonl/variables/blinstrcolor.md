---
title: "BlInstrColor"
description: "Specifies the background color of polar displays."
---

# BlInstrColor

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrColor

Specifies the background color of polar displays.
...
*Source: `VarOnl/BlInstrColor.htm`*
