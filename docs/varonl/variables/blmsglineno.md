---
title: "BlMsgLineNo"
description: "Specifies whether DIAdem numbers the message consecutively."
---

# BlMsgLineNo

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMsgLineNo

Specifies whether DIAdem numbers the message consecutively.
