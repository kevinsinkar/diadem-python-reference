---
title: "BlPackInpGrpMode"
description: "Specifies the current list length mode of the packet input."
---

# BlPackInpGrpMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackInpGrpMode

Specifies the current list length mode of the packet input.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlPackInpGrpMode(i) = <em>Value</em>
...
*Source: `VarOnl/BlPackInpGrpMode.htm`*
