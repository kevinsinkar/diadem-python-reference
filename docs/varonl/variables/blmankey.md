---
title: "BlManKey"
description: "Specifies the function key you use to control a push button or a switch."
---
...
Specifies the function key you use to control a push button or a switch.
