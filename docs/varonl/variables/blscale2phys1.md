---
title: "BlScale2Phys1"
description: "Specifies the first physical value for a two-point scaling."
---

# BlScale2Phys1

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale2Phys1

Specifies the first physical value for a two-point scaling.
...
*Source: `VarOnl/BlScale2Phys1.htm`*
