---
title: "BlVISManFrame"
description: "Specifies whether DIAdem shows when a button is pressed in DIAdem VISUAL."
---

# BlVISManFrame

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVISManFrame

Specifies whether DIAdem shows when a button is pressed in DIAdem VISUAL.
...
*Source: `VarOnl/BlVISManFrame.htm`*
