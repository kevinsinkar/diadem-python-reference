---
title: "BlDLLParam1"
description: "Specifies the name of the DAC device to be used for a measurement."
---

# BlDLLParam1

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDLLParam1

Specifies the name of the DAC device to be used for a measurement.
