---
title: "BlLinXChnName"
description: "Specifies the names of the channels that contains the measured values of a linearization function."
---

# BlLinXChnName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinXChnName

Specifies the names of the channels that contains the measured values of a linearization function.
...
*Source: `VarOnl/BlLinXChnName.htm`*
