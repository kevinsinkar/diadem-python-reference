---
title: "BlSaveChannel"
description: "Specifies whether DIAdem saves the connected signals. The index is the same as the signal number."
---

# BlSaveChannel

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSaveChannel

Specifies whether DIAdem saves the connected signals. The index is the same as the signal number.
...
*Source: `VarOnl/BlSaveChannel.htm`*
