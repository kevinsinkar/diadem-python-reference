---
title: "BlTime"
description: "Specifies the time in seconds after which DIAdem outputs a trigger."
---
...
Specifies the time in seconds after which DIAdem outputs a trigger.
