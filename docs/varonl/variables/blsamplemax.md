---
title: "BlSampleMax"
description: "Specifies the number of measurement values that the save blocks save in one cycle."
---

# BlSampleMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSampleMax

Specifies the number of measurement values that the save blocks save in one cycle.
