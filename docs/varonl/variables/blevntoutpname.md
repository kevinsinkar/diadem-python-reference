---
title: "BlEvntOutpName"
description: "Specifies the terminal names of alarm signals at alarm outputs."
---

# BlEvntOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntOutpName

Specifies the terminal names of alarm signals at alarm outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlEvntOutpName(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlEvntOutpName.htm`*
