---
title: "BlPinIconBmp"
description: "Specifies the name of a graphics file which contains the symbol for a block terminal."
---

# BlPinIconBmp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinIconBmp

Specifies the name of a graphics file which contains the symbol for a block terminal.
...
*Source: `VarOnl/BlPinIconBmp.htm`*
