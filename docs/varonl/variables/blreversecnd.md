---
title: "BlReverseCnd"
description: "Specifies whether a control block also has inverted outputs."
---

# BlReverseCnd

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlReverseCnd

Specifies whether a control block also has inverted outputs.
...
*Source: `VarOnl/BlReverseCnd.htm`*
