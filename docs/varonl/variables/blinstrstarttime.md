---
title: "BlInstrStartTime"
description: "Specifies the period after which the measured data display starts."
---

# BlInstrStartTime

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrStartTime

Specifies the period after which the measured data display starts.
...
*Source: `VarOnl/BlInstrStartTime.htm`*
