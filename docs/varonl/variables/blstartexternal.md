---
title: "BlStartExternal"
description: "Specifies that an external TTL signal initiates a start trigger."
---

# BlStartExternal

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlStartExternal

Specifies that an external TTL signal initiates a start trigger.
...
*Source: `VarOnl/BlStartExternal.htm`*
