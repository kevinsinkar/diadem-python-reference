---
title: "BlTrigNext"
description: "Specifies that, after a stop trigger, DIAdem uses a start trigger to start saving measured values again."
---
...
Specifies that, after a stop trigger, DIAdem uses a start trigger to start saving measured values again.
