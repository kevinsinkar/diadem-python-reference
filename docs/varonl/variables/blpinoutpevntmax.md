---
title: "BlPinOutpEvntMax"
description: "Specifies the maximum number of alarm outputs on DAC blocks."
---

# BlPinOutpEvntMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpEvntMax

Specifies the maximum number of alarm outputs on DAC blocks.
...
*Source: `VarOnl/BlPinOutpEvntMax.htm`*
