---
title: "BlColumnCount"
description: "Specifies the number of columns in a color matrix."
---

# BlColumnCount

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlColumnCount

Specifies the number of columns in a color matrix.
...
*Source: `VarOnl/BlColumnCount.htm`*
