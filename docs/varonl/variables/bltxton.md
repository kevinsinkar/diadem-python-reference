---
title: "BlTxtOn"
description: "Specifies the text that DIAdem displays when a switch is on or when a button is pushed."
---
...
Specifies the text that DIAdem displays when a switch is on or when a button is pushed.
