---
title: "BlDataInpGrpDim"
description: "The BlDataInpGrpDim variable can contain the following values:"
---

# BlDataInpGrpDim

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataInpGrpDim

The BlDataInpGrpDim variable can contain the following values:
...
*Source: `VarOnl/BlDataInpGrpDim.htm`*
