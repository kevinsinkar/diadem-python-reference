---
title: "BlSysInpGrpDim"
description: "The BlSysInpGrpDim variable can contain the following values:"
---

# BlSysInpGrpDim

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysInpGrpDim

The BlSysInpGrpDim variable can contain the following values:
...
*Source: `VarOnl/BlSysInpGrpDim.htm`*
