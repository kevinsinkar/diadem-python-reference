---
title: "BlDataOutpName"
description: "Specifies the terminal names of data signals at data outputs."
---

# BlDataOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataOutpName

Specifies the terminal names of data signals at data outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlDataOutpName(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlDataOutpName.htm`*
