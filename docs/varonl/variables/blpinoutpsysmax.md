---
title: "BlPinOutpSysMax"
description: "Specifies the maximum number of system outputs at DAC blocks."
---

# BlPinOutpSysMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpSysMax

Specifies the maximum number of system outputs at DAC blocks.
...
*Source: `VarOnl/BlPinOutpSysMax.htm`*
