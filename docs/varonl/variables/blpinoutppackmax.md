---
title: "BlPinOutpPackMax"
description: "Specifies the maximum number of packet outputs on DAC blocks."
---

# BlPinOutpPackMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpPackMax

Specifies the maximum number of packet outputs on DAC blocks.
...
*Source: `VarOnl/BlPinOutpPackMax.htm`*
