---
title: "BlOffsetMode"
description: "Specifies how DIAdem determines the offset from the interval."
---

# BlOffsetMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlOffsetMode

Specifies how DIAdem determines the offset from the interval.
...
*Source: `VarOnl/BlOffsetMode.htm`*
