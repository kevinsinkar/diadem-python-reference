---
title: "BlSelVariant"
description: "Specifies in which part of the radio button and from which position, DIAdem starts to plot color shading when the radio button has the focus."
---

# BlSelVariant

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSelVariant

Specifies in which part of the radio button and from which position, DIAdem starts to plot color shading when the radio button has the focus.
...
*Source: `VarOnl/BlSelVariant.htm`*
