---
title: "BlGraphNameOn"
description: "Specifies the name of a graphic that DIAdem displays when a switch is on or a push button is pressed."
---

# BlGraphNameOn

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlGraphNameOn

Specifies the name of a graphic that DIAdem displays when a switch is on or a push button is pressed.
...
*Source: `VarOnl/BlGraphNameOn.htm`*
