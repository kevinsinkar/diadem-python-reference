---
title: "BlYRangeMaxDisp"
description: "Specifies the upper limit of the display range of the y-signal of an xy-display or scatter display."
---

# BlYRangeMaxDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlYRangeMaxDisp

Specifies the upper limit of the display range of the y-signal of an xy-display or scatter display.
...
*Source: `VarOnl/BlYRangeMaxDisp.htm`*
