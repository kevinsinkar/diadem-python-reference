---
title: "BlInstrUseTRange"
description: "Specifies whether DIAdem may change the time axis in the clock mode Hardware clock to optimize the speed."
---

# BlInstrUseTRange

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrUseTRange

Specifies whether DIAdem may change the time axis in the clock mode Hardware clock to optimize the speed.
...
*Source: `VarOnl/BlInstrUseTRange.htm`*
