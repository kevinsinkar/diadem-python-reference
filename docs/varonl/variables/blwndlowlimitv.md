---
title: "BlWndLowLimitV"
description: "Specifies the lower limit values of a window condition."
---

# BlWndLowLimitV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlWndLowLimitV

Specifies the lower limit values of a window condition.
...
*Source: `VarOnl/BlWndLowLimitV.htm`*
