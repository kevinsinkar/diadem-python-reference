---
title: "BlLinLowOutRangeValue"
description: "Specifies the value which DIAdem uses in Free Linearization through Table and Free Linearization through Channels for the result data when the value range of th"
---

# BlLinLowOutRangeValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinLowOutRangeValue

Specifies the value which DIAdem uses in Free Linearization through Table and Free Linearization through Channels for the result data when the value range of the output values is undershot.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlLinLowOutRangeValue = <em>Value</em>
...
*Source: `VarOnl/BlLinLowOutRangeValue.htm`*
