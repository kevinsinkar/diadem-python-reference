---
title: "BlAVAudioDevice"
description: "Specifies the audio recording device."
---

# BlAVAudioDevice

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVAudioDevice
...
*Source: `VarOnl/BlAVAudioDevice.htm`*
