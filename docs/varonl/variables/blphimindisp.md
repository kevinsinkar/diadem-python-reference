---
title: "BlPhiMinDisp"
description: "Specifies the lower limit of the angle area in a polar display."
---

# BlPhiMinDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPhiMinDisp

Specifies the lower limit of the angle area in a polar display.
...
*Source: `VarOnl/BlPhiMinDisp.htm`*
