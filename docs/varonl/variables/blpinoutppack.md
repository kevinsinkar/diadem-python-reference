---
title: "BlPinOutpPack"
description: "Specifies the names of the packet outputs on DAC blocks."
---

# BlPinOutpPack

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpPack

Specifies the names of the packet outputs on DAC blocks.
...
*Source: `VarOnl/BlPinOutpPack.htm`*
