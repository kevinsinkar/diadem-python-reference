---
title: "BlDataActive"
description: "Specifies whether a data signal is active."
---

# BlDataActive

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataActive

Specifies whether a data signal is active.
...
*Source: `VarOnl/BlDataActive.htm`*
