---
title: "BlCndSourceBl"
description: "Specifies the number of the DAC block from which the control signal that is connected to the control input originates."
---

# BlCndSourceBl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndSourceBl

Specifies the number of the DAC block from which the control signal that is connected to the control input originates.
...
*Source: `VarOnl/BlCndSourceBl.htm`*
