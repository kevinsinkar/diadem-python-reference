---
title: "BlAVVideoBitrate"
description: "Specifies the bit rate of the video stream in kBit/s. DIAdem saves the video stream in the video file."
---

# BlAVVideoBitrate

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVVideoBitrate

Specifies the bit rate of the video stream in kBit/s. DIAdem saves the video stream in the video file.
...
*Source: `VarOnl/BlAVVideoBitrate.htm`*
