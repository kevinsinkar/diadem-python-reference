---
title: "BlVISManNoDisp"
description: "Specifies whether DIAdem displays the current numeric values below the dial or the slider control."
---

# BlVISManNoDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVISManNoDisp

Specifies whether DIAdem displays the current numeric values below the dial or the slider control.
...
*Source: `VarOnl/BlVISManNoDisp.htm`*
