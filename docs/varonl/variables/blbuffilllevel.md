---
title: "BlBufFillLevel"
description: "Specifies whether DIAdem displays the filling of the buffer monitor as a percentage or in seconds."
---

# BlBufFillLevel

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBufFillLevel

Specifies whether DIAdem displays the filling of the buffer monitor as a percentage or in seconds.
...
*Source: `VarOnl/BlBufFillLevel.htm`*
