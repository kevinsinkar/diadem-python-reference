---
title: "BlDeltaYV"
description: "Specifies the maximum difference between two measurement values in the DAC Signal alteration block."
---
...
Specifies the maximum difference between two measurement values in the DAC Signal alteration block.
