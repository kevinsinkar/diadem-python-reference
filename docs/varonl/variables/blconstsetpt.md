---
title: "BlConstSetPt"
description: "Specifies whether a controller uses a constant set point."
---

# BlConstSetPt

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlConstSetPt

Specifies whether a controller uses a constant set point.
...
*Source: `VarOnl/BlConstSetPt.htm`*
