---
title: "BlLinExtRefTmp"
description: "Specifies whether DIAdem uses an additional offset for a thermo linearization."
---

# BlLinExtRefTmp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinExtRefTmp

Specifies whether DIAdem uses an additional offset for a thermo linearization.
...
*Source: `VarOnl/BlLinExtRefTmp.htm`*
