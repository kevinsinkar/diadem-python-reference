---
title: "BlMatrixXLen"
description: "Specifies the number of values DIAdem uses as x-values of the interpolation matrix."
---

# BlMatrixXLen

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMatrixXLen

Specifies the number of values DIAdem uses as x-values of the interpolation matrix.
...
*Source: `VarOnl/BlMatrixXLen.htm`*
