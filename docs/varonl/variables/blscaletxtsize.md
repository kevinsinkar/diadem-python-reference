---
title: "BlScaleTxtSize"
description: "Specifies the font size for the scale labels of display instruments."
---

# BlScaleTxtSize

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScaleTxtSize

Specifies the font size for the scale labels of display instruments.
...
*Source: `VarOnl/BlScaleTxtSize.htm`*
