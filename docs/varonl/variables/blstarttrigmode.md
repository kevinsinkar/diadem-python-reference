---
title: "BlStartTrigMode"
description: "Specifies that DIAdem saves measurement values before the start trigger or that DIAdem rejects the values after the start trigger."
---

# BlStartTrigMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlStartTrigMode

Specifies that DIAdem saves measurement values before the start trigger or that DIAdem rejects the values after the start trigger.
...
*Source: `VarOnl/BlStartTrigMode.htm`*
