---
title: "BlTxtOff"
description: "Specifies the text that DIAdem displays when a switch is off or when a button is not pushed."
---
...
Specifies the text that DIAdem displays when a switch is off or when a button is not pushed.
