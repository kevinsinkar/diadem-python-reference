---
title: "BlMonRange"
description: "Specifies how many of the measurement values that were written last into a file, DIAdem reads."
---
...
Specifies how many of the measurement values that were written last into a file, DIAdem reads.
