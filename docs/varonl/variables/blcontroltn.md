---
title: "BlControlTn"
description: "Specifies the reciprocal of the reset time Tn of the integral part of a PID controller in s -1 ."
---

# BlControlTn

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlControlTn

Specifies the reciprocal of the reset time Tn of the integral part of a PID controller in s -1 .
