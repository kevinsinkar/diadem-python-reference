---
title: "BlManRadioKey"
description: "Specifies the function key that the block checks."
---

# BlManRadioKey

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManRadioKey

Specifies the function key that the block checks.
...
*Source: `VarOnl/BlManRadioKey.htm`*
