---
title: "BlSigNameDispMode"
description: "Specifies the position of the signal names for a numeric display."
---

# BlSigNameDispMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSigNameDispMode

Specifies the position of the signal names for a numeric display.
...
*Source: `VarOnl/BlSigNameDispMode.htm`*
