---
title: "BlEvntSourceOutp"
description: "Specifies the signal number of the alarm signals connected to the alarm inputs."
---

# BlEvntSourceOutp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntSourceOutp

Specifies the signal number of the alarm signals connected to the alarm inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlEvntSourceOutp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlEvntSourceOutp.htm`*
