---
title: "BlSysInpGrpMax"
description: "Specifies the maximum number of system inputs on DAC blocks."
---

# BlSysInpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysInpGrpMax

Specifies the maximum number of system inputs on DAC blocks.
...
*Source: `VarOnl/BlSysInpGrpMax.htm`*
