---
title: "BlTimeCndType"
description: "Specifies whether the DAC block Time range outputs a signal once or periodically."
---

# BlTimeCndType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTimeCndType

Specifies whether the DAC block Time range outputs a signal once or periodically.
...
*Source: `VarOnl/BlTimeCndType.htm`*
