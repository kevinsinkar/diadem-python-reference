---
title: "BlVisStateType"
description: "Specifies the display type of a status display."
---

# BlVisStateType

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVisStateType

Specifies the display type of a status display.
...
*Source: `VarOnl/BlVisStateType.htm`*
