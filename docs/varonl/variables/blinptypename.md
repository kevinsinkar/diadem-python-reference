---
title: "BlInpTypeName"
description: "Specifies the name of the signal type of an acquisition block."
---

# BlInpTypeName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInpTypeName

Specifies the name of the signal type of an acquisition block.
...
*Source: `VarOnl/BlInpTypeName.htm`*
