---
title: "BlSigNameDisp"
description: "Specifies whether DIAdem displays the signal names in display instruments."
---

# BlSigNameDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSigNameDisp

Specifies whether DIAdem displays the signal names in display instruments.
...
*Source: `VarOnl/BlSigNameDisp.htm`*
