---
title: "BlActPinInpShow"
description: "Specifies whether DIAdem displays the terminal names in the block input dialog box."
---

# BlActPinInpShow

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlActPinInpShow

Specifies whether DIAdem displays the terminal names in the block input dialog box.
...
*Source: `VarOnl/BlActPinInpShow.htm`*
