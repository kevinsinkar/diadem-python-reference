---
title: "BlControlMin"
description: "Specifies the minimum controller output limit of the PID controller."
---

# BlControlMin

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlControlMin

Specifies the minimum controller output limit of the PID controller.
...
*Source: `VarOnl/BlControlMin.htm`*
