---
title: "BlPinInpData"
description: "Specifies the names of the data inputs at DAC blocks."
---

# BlPinInpData

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpData

Specifies the names of the data inputs at DAC blocks.
...
*Source: `VarOnl/BlPinInpData.htm`*
