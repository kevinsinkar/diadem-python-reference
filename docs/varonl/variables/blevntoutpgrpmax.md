---
title: "BlEvntOutpGrpMax"
description: "Specifies the number of alarm outputs on DAC blocks."
---

# BlEvntOutpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntOutpGrpMax

Specifies the number of alarm outputs on DAC blocks.
...
*Source: `VarOnl/BlEvntOutpGrpMax.htm`*
