---
title: "BlTxtColorRGB"
description: "Specifies the RGB values for the text color of the axis labels of display instruments."
---

# BlTxtColorRGB

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTxtColorRGB

Specifies the RGB values for the text color of the axis labels of display instruments.
...
*Source: `VarOnl/BlTxtColorRGB.htm`*
