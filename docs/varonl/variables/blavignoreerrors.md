---
title: "BlAVIgnoreErrors"
description: "Specifies how DIAdem behaves if an error occurs."
---

# BlAVIgnoreErrors

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVIgnoreErrors

Specifies how DIAdem behaves if an error occurs.
...
*Source: `VarOnl/BlAVIgnoreErrors.htm`*
