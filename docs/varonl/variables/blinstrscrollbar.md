---
title: "BlInstrScrollBar"
description: "Specifies whether the display instrument has a scroll bar."
---

# BlInstrScrollBar

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrScrollBar

Specifies whether the display instrument has a scroll bar.
...
*Source: `VarOnl/BlInstrScrollBar.htm`*
