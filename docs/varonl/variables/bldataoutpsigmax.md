---
title: "BlDataOutpSigMax"
description: "Specifies the number of data signals outgoing from the data outputs."
---

# BlDataOutpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataOutpSigMax

Specifies the number of data signals outgoing from the data outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlDataOutpSigMax(i)
...
*Source: `VarOnl/BlDataOutpSigMax.htm`*
