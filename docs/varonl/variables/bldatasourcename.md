---
title: "BlDataSourceName"
description: "Specifies the names of the data signals connected to the data inputs."
---

# BlDataSourceName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataSourceName

Specifies the names of the data signals connected to the data inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlDataSourceName(i,j)
...
*Source: `VarOnl/BlDataSourceName.htm`*
