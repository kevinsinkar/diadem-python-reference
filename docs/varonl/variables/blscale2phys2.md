---
title: "BlScale2Phys2"
description: "Specifies the second physical value for a two-point scaling."
---

# BlScale2Phys2

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale2Phys2

Specifies the second physical value for a two-point scaling.
...
*Source: `VarOnl/BlScale2Phys2.htm`*
