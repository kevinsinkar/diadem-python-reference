---
title: "BlStopInterv"
description: "Specifies the number of values that DIAdem saves after the stop trigger or that DIAdem rejects before the stop trigger."
---

# BlStopInterv

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlStopInterv

Specifies the number of values that DIAdem saves after the stop trigger or that DIAdem rejects before the stop trigger.
...
*Source: `VarOnl/BlStopInterv.htm`*
