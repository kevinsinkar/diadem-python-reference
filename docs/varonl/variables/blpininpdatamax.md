---
title: "BlPinInpDataMax"
description: "Specifies the maximum number of data inputs at DAC blocks."
---

# BlPinInpDataMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpDataMax

Specifies the maximum number of data inputs at DAC blocks.
...
*Source: `VarOnl/BlPinInpDataMax.htm`*
