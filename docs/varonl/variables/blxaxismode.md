---
title: "BlXAxisMode"
description: "Specifies the display mode of the time axis in display instruments."
---

# BlXAxisMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlXAxisMode

Specifies the display mode of the time axis in display instruments.
