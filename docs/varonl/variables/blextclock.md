---
title: "BlExtClock"
description: "Specifies whether DIAdem uses an external clock for the system clock."
---
...
Specifies whether DIAdem uses an external clock for the system clock.
