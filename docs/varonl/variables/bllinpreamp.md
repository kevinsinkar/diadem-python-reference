---
title: "BlLinPreAmp"
description: "Specifies whether DIAdem uses an external preamplifier for a thermo linearization."
---

# BlLinPreAmp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlLinPreAmp

Specifies whether DIAdem uses an external preamplifier for a thermo linearization.
