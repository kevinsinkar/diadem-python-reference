---
title: "BlInFile"
description: "Specifies the name, including the path, of the graphics file that DIAdem displays on a push button when the button is not pressed."
---
...
Specifies the name, including the path, of the graphics file that DIAdem displays on a push button when the button is not pressed.
