---
title: "BlMonoFlopInterv"
description: "Specifies the time in seconds that a mono flop outputs an active signal."
---

# BlMonoFlopInterv

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMonoFlopInterv

Specifies the time in seconds that a mono flop outputs an active signal.
...
*Source: `VarOnl/BlMonoFlopInterv.htm`*
