---
title: "BlWndLowLimit"
description: "Specifies the start value of a count."
---

# BlWndLowLimit

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlWndLowLimit

Specifies the start value of a count.
...
*Source: `VarOnl/BlWndLowLimit.htm`*
