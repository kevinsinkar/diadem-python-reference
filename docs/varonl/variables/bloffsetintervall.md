---
title: "BlOffsetIntervall"
description: "Specifies the size of the interval from which DIAdem specifies the offset."
---

# BlOffsetIntervall

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlOffsetIntervall

Specifies the size of the interval from which DIAdem specifies the offset.
...
*Source: `VarOnl/BlOffsetIntervall.htm`*
