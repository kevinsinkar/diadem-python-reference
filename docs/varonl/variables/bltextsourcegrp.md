---
title: "BlTextSourceGrp"
description: "Specifies the number of the signal output from which the text signal that is connected to the text inputs, originates."
---

# BlTextSourceGrp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextSourceGrp

Specifies the number of the signal output from which the text signal that is connected to the text inputs, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlTextSourceGrp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlTextSourceGrp.htm`*
