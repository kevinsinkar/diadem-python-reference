---
title: "BlPolarDirection"
description: "Specifies the direction angle in the polar display."
---

# BlPolarDirection

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPolarDirection

Specifies the direction angle in the polar display.
...
*Source: `VarOnl/BlPolarDirection.htm`*
