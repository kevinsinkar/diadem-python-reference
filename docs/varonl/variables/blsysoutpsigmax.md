---
title: "BlSysOutpSigMax"
description: "Specifies the maximum number of clock signals outgoing from system outputs."
---

# BlSysOutpSigMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysOutpSigMax

Specifies the maximum number of clock signals outgoing from system outputs.
...
*Source: `VarOnl/BlSysOutpSigMax.htm`*
