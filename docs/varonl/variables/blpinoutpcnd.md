---
title: "BlPinOutpCnd"
description: "Specifies the names of the control outputs at DAC blocks."
---

# BlPinOutpCnd

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpCnd

Specifies the names of the control outputs at DAC blocks.
...
*Source: `VarOnl/BlPinOutpCnd.htm`*
