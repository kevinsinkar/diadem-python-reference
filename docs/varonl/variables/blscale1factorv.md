---
title: "BlScale1FactorV"
description: "Specifies the factors for the linear equations of a linear scaling."
---

# BlScale1FactorV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale1FactorV

Specifies the factors for the linear equations of a linear scaling.
...
*Source: `VarOnl/BlScale1FactorV.htm`*
