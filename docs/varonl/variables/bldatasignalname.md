---
title: "BlDataSignalName"
description: "Specifies the names of the signals at data outputs."
---

# BlDataSignalName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataSignalName

Specifies the names of the signals at data outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlDataSignalName(i) = <em>Value</em>
...
*Source: `VarOnl/BlDataSignalName.htm`*
