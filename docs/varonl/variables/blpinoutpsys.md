---
title: "BlPinOutpSys"
description: "Specifies the names of the system outputs at DAC blocks."
---

# BlPinOutpSys

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpSys

Specifies the names of the system outputs at DAC blocks.
...
*Source: `VarOnl/BlPinOutpSys.htm`*
