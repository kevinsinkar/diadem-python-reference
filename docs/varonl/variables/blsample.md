---
title: "BlSample"
description: "Specifies the number of signal changes that the DAC block No. of Values monitors."
---
...
Specifies the number of signal changes that the DAC block No. of Values monitors.
