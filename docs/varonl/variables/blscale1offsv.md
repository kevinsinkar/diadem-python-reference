---
title: "BlScale1OffsV"
description: "Specifies the offsets for the linear equations of a linear scaling."
---

# BlScale1OffsV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlScale1OffsV

Specifies the offsets for the linear equations of a linear scaling.
...
*Source: `VarOnl/BlScale1OffsV.htm`*
