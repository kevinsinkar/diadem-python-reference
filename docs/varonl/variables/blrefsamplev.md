---
title: "BlRefSampleV"
description: "Specifies which values the signal alteration compares with the current measurement value."
---

# BlRefSampleV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlRefSampleV

Specifies which values the signal alteration compares with the current measurement value.
...
*Source: `VarOnl/BlRefSampleV.htm`*
