---
title: "BlInstrUnit"
description: "Specifies the unit of the display clock of a display instrument."
---

# BlInstrUnit

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrUnit

Specifies the unit of the display clock of a display instrument.
