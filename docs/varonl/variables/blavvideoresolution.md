---
title: "BlAVVideoResolution"
description: "Specifies the resolution of the selected video camera."
---

# BlAVVideoResolution

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVVideoResolution

Specifies the resolution of the selected video camera.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlAVVideoResolution = <em>Value</em>
...
*Source: `VarOnl/BlAVVideoResolution.htm`*
