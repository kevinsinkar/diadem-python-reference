---
title: "BlMapPositionControl"
description: "Specifies that DIAdem shows the latitude and longitude of the map markers in maps from OpenStreetMap."
---

# BlMapPositionControl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMapPositionControl

Specifies that DIAdem shows the latitude and longitude of the map markers in maps from OpenStreetMap.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlMapPositionControl = <em>Value</em>
...
<table class="Borderless"><tr><td class="Icon"><img src="image/note.gif"/></td><td><strong>Note  </strong>This function is not available for MapPoint maps.</td></tr></table>
</div>

---

*Source: `VarOnl/BlMapPositionControl.htm`*
