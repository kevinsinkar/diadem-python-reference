---
title: "BlInstrAlignment"
description: "Specifies whether DIAdem displays an instrument horizontally or vertically."
---

# BlInstrAlignment

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrAlignment

Specifies whether DIAdem displays an instrument horizontally or vertically.
...
*Source: `VarOnl/BlInstrAlignment.htm`*
