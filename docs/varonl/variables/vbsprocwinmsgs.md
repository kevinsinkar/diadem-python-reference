---
title: "VBSProcWinMsgs"
description: "Specifies that DIAdem processes Windows messages."
---

# VBSProcWinMsgs

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSProcWinMsgs

Specifies that DIAdem processes Windows messages.
...
*Source: `VarOnl/VBSProcWinMsgs.htm`*
