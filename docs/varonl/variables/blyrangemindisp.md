---
title: "BlYRangeMinDisp"
description: "Specifies the lower limit of the display range of the y-signal of an xy-display or a scatter display."
---

# BlYRangeMinDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlYRangeMinDisp

Specifies the lower limit of the display range of the y-signal of an xy-display or a scatter display.
...
*Source: `VarOnl/BlYRangeMinDisp.htm`*
