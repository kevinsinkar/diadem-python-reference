---
title: "BlManRadioValue"
description: "Specifies the numeric values that DIAdem outputs at the block output of the radio button or the checkbox."
---

# BlManRadioValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManRadioValue

Specifies the numeric values that DIAdem outputs at the block output of the radio button or the checkbox.
...
*Source: `VarOnl/BlManRadioValue.htm`*
