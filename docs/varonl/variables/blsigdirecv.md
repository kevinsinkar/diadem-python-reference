---
title: "BlSigDirecV"
description: "Specifies which signal alterations DIAdem evaluates."
---

# BlSigDirecV

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSigDirecV

Specifies which signal alterations DIAdem evaluates.
