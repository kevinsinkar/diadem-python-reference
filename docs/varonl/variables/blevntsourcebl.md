---
title: "BlEvntSourceBl"
description: "Specifies the number of the DAC block from which the alarm signal that is connected to the alarm input originates."
---

# BlEvntSourceBl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntSourceBl

Specifies the number of the DAC block from which the alarm signal that is connected to the alarm input originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlEvntSourceBl(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlEvntSourceBl.htm`*
