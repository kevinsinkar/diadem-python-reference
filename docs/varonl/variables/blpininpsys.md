---
title: "BlPinInpSys"
description: "Specifies the names of the system inputs on DAC blocks."
---

# BlPinInpSys

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinInpSys

Specifies the names of the system inputs on DAC blocks.
