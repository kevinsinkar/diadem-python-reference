---
title: "BlTextInpName"
description: "Specifies the terminal names of text signals at text inputs."
---

# BlTextInpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextInpName

Specifies the terminal names of text signals at text inputs.
...
*Source: `VarOnl/BlTextInpName.htm`*
