---
title: "BlPackSourceGrp"
description: "Specifies the number of the signal output from which the packet signal that is connected to the packet input, originates."
---

# BlPackSourceGrp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackSourceGrp

Specifies the number of the signal output from which the packet signal that is connected to the packet input, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlPackSourceGrp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlPackSourceGrp.htm`*
