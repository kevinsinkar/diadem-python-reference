---
title: "BlManDim"
description: "Specifies the unit of the values that the numeric input, the slider control, and the dial output."
---
...
Specifies the unit of the values that the numeric input, the slider control, and the dial output.
