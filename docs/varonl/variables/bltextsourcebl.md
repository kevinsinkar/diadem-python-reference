---
title: "BlTextSourceBl"
description: "Specifies the number of the DAC block from which the text signal that is connected to the text inputs, originates."
---

# BlTextSourceBl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextSourceBl

Specifies the number of the DAC block from which the text signal that is connected to the text inputs, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlTextSourceBl(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlTextSourceBl.htm`*
