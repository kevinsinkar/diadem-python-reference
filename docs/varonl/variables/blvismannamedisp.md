---
title: "BlVISManNameDisp"
description: "Specifies whether DIAdem displays the name of a manual input instrument."
---

# BlVISManNameDisp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVISManNameDisp

Specifies whether DIAdem displays the name of a manual input instrument.
...
*Source: `VarOnl/BlVISManNameDisp.htm`*
