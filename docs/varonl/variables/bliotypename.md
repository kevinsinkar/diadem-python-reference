---
title: "BlIoTypeName"
description: "Specifies the name of the signal type of an acquisition block or an output block."
---

# BlIoTypeName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlIoTypeName

Specifies the name of the signal type of an acquisition block or an output block.
...
*Source: `VarOnl/BlIoTypeName.htm`*
