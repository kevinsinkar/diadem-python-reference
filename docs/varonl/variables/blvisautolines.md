---
title: "BlVisAutoLines"
description: "Specifies whether DIAdem determines the visible lines in messages and tables."
---

# BlVisAutoLines

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVisAutoLines

Specifies whether DIAdem determines the visible lines in messages and tables.
...
*Source: `VarOnl/BlVisAutoLines.htm`*
