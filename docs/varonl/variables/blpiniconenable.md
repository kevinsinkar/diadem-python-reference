---
title: "BlPinIconEnable"
description: "Specifies whether DIAdem displays the symbol and the text on a block terminal."
---

# BlPinIconEnable

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinIconEnable

Specifies whether DIAdem displays the symbol and the text on a block terminal.
...
*Source: `VarOnl/BlPinIconEnable.htm`*
