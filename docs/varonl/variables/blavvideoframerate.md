---
title: "BlAVVideoFramerate"
description: "Specifies the frame rate of the video in Hz."
---

# BlAVVideoFramerate

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVVideoFramerate

Specifies the frame rate of the video in Hz.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlAVVideoFramerate = <em>Value</em>
...
*Source: `VarOnl/BlAVVideoFramerate.htm`*
