---
title: "VBSCustomDlgFile"
description: "Specifies the name of the dialog box file including the path."
---

# VBSCustomDlgFile

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSCustomDlgFile

Specifies the name of the dialog box file including the path.
...
*Source: `VarOnl/VBSCustomDlgFile.htm`*
