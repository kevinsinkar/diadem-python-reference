---
title: "BlSampleMaxUnit"
description: "Specifies whether DIAdem interprets the number of storage cycles as number of values or as duration."
---

# BlSampleMaxUnit

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSampleMaxUnit

Specifies whether DIAdem interprets the number of storage cycles as number of values or as duration.
...
*Source: `VarOnl/BlSampleMaxUnit.htm`*
