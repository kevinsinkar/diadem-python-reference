---
title: "BlYScalingMode"
description: "Specifies how DIAdem scales the y-axis of VISUAL displays."
---

# BlYScalingMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlYScalingMode

Specifies how DIAdem scales the y-axis of VISUAL displays.
...
*Source: `VarOnl/BlYScalingMode.htm`*
