---
title: "BlSysInpGrpMode"
description: "Specifies the current list length mode of the system input."
---

# BlSysInpGrpMode

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysInpGrpMode

Specifies the current list length mode of the system input.
...
*Source: `VarOnl/BlSysInpGrpMode.htm`*
