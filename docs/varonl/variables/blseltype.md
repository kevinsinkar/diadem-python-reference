---
title: "BlSelType"
description: "Specifies the direction of the color shading that DIAdem displays on a radio button when the radio button has the focus."
---
...
Specifies the direction of the color shading that DIAdem displays on a radio button when the radio button has the focus.
