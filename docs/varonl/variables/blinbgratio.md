---
title: "BlInBgRatio"
description: "Specifies whether DIAdem maintains the height/width ratio of the graphic that DIAdem displays on a push button when the button is pressed."
---

# BlInBgRatio

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInBgRatio

Specifies whether DIAdem maintains the height/width ratio of the graphic that DIAdem displays on a push button when the button is pressed.
