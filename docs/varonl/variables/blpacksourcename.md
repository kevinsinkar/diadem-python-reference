---
title: "BlPackSourceName"
description: "Specifies the names of the data signals that are connected to the packet inputs."
---

# BlPackSourceName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackSourceName

Specifies the names of the data signals that are connected to the packet inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    <em>Value</em> = BlPackSourceName(i,j)
...
<table class="Borderless" id="table2"><tr><td class="Icon"><img height="25" src="image/note.gif" width="26"/></td><td><strong>Note  </strong>The <span class="Monospace">BlPackSourcename</span> variable is read-only.</td></tr></table>
</div>

---

*Source: `VarOnl/BlPackSourceName.htm`*
