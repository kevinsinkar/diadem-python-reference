---
title: "BlChnNo"
description: "Specifies the channel to be read from the Data Portal via its channel number."
---
...
Specifies the channel to be read from the Data Portal via its channel number.
