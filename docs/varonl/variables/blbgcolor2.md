---
title: "BlBgColor2"
description: "Specifies the second color in the color shading of the background of a display instrument."
---
...
Specifies the second color in the color shading of the background of a display instrument.
