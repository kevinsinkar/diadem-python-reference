---
title: "BlPackOutpName"
description: "Specifies the terminal names of packet signals at packet outputs."
---

# BlPackOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackOutpName

Specifies the terminal names of packet signals at packet outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlPackOutpName(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlPackOutpName.htm`*
