---
title: "BlSignalColorRGB"
description: "Specifies the RGB values for the colors that DIAdem uses to display signals in display instruments."
---

# BlSignalColorRGB

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSignalColorRGB

Specifies the RGB values for the colors that DIAdem uses to display signals in display instruments.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlSignalColorRGB(i) = <em>Value</em>
...
*Source: `VarOnl/BlSignalColorRGB.htm`*
