---
title: "BlAVFileOverwrite"
description: "Specifies whether DIAdem waits for a prompt before overwriting an existing video file."
---

# BlAVFileOverwrite

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlAVFileOverwrite

Specifies whether DIAdem waits for a prompt before overwriting an existing video file.
...
*Source: `VarOnl/BlAVFileOverwrite.htm`*
