---
title: "BlPackSourceBl"
description: "Specifies the number of the DAC block from which the packet signal that is connected to the packet input, originates."
---

# BlPackSourceBl

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPackSourceBl

Specifies the number of the DAC block from which the packet signal that is connected to the packet input, originates.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlPackSourceBl(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlPackSourceBl.htm`*
