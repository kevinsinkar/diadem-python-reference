---
title: "BlInstrCycle"
description: "Specifies the frequency with which DIAdem displays the measurement values in display instruments."
---

# BlInstrCycle

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInstrCycle

Specifies the frequency with which DIAdem displays the measurement values in display instruments.
...
*Source: `VarOnl/BlInstrCycle.htm`*
