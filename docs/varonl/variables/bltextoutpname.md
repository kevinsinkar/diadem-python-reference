---
title: "BlTextOutpName"
description: "Specifies the terminal names of text signals at text outputs."
---

# BlTextOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextOutpName

Specifies the terminal names of text signals at text outputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlTextOutpName(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlTextOutpName.htm`*
