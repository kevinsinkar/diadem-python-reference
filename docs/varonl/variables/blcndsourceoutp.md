---
title: "BlCndSourceOutp"
description: "Specifies the signal number of the control signals connected to the control inputs."
---

# BlCndSourceOutp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndSourceOutp

Specifies the signal number of the control signals connected to the control inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlCndSourceOutp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlCndSourceOutp.htm`*
