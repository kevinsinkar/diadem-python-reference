---
title: "BlBinLogic"
description: "Specifies whether DIAdem enables or disables a binary display if the measured values are within the measurement range."
---
...
Specifies whether DIAdem enables or disables a binary display if the measured values are within the measurement range.
