---
title: "BlSysSourceOutp"
description: "Specifies the signal number of the clock signals connected to the system inputs."
---

# BlSysSourceOutp

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSysSourceOutp

Specifies the signal number of the clock signals connected to the system inputs.
...
<donottranslate><pre>Call DACObjOpen(<em>BlockName</em>)
    BlSysSourceOutp(i,j) = <em>Value</em>
...
*Source: `VarOnl/BlSysSourceOutp.htm`*
