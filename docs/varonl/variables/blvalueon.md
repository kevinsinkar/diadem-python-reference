---
title: "BlValueOn"
description: "Specifies the value that DIAdem displays when a switch is on or when a button is pressed."
---
...
Specifies the value that DIAdem displays when a switch is on or when a button is pressed.
