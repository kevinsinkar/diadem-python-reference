---
title: "BlTextOutpGrpMax"
description: "Specifies the maximum number of text outputs on DAC blocks."
---

# BlTextOutpGrpMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlTextOutpGrpMax

Specifies the maximum number of text outputs on DAC blocks.
...
*Source: `VarOnl/BlTextOutpGrpMax.htm`*
