---
title: "BlDataInpName"
description: "Specifies the terminal names of data signals at data inputs."
---

# BlDataInpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlDataInpName

Specifies the terminal names of data signals at data inputs.
...
*Source: `VarOnl/BlDataInpName.htm`*
