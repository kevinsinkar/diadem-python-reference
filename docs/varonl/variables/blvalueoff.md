---
title: "BlValueOff"
description: "Specifies the value that DIAdem displays when a switch is off or when a button is not pressed."
---
...
Specifies the value that DIAdem displays when a switch is off or when a button is not pressed.
