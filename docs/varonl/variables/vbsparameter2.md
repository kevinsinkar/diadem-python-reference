---
title: "VBSParameter2"
description: "Specifies a parameter of the script DAC driver."
---

# VBSParameter2

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: VBSParameter2

Specifies a parameter of the script DAC driver.
...
*Source: `VarOnl/VBSParameter2.htm`*
