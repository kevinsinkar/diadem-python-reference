---
title: "BlOffsetRetrigger"
description: "Specifies whether DIAdem runs the channel offset once or repeatedly."
---

# BlOffsetRetrigger

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlOffsetRetrigger

Specifies whether DIAdem runs the channel offset once or repeatedly.
...
*Source: `VarOnl/BlOffsetRetrigger.htm`*
