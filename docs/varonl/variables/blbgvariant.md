---
title: "BlBgVariant"
description: "Specifies the position where DIAdem starts to plot color shading in the background of a display instrument."
---

# BlBgVariant

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlBgVariant

Specifies the position where DIAdem starts to plot color shading in the background of a display instrument.
