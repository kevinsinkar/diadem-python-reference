---
title: "BlInitValue"
description: "Specifies the initialization value for various DAC blocks. DIAdem outputs this value as long as the program has not returned a valid value."
---

# BlInitValue

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlInitValue

Specifies the initialization value for various DAC blocks. DIAdem outputs this value as long as the program has not returned a valid value.
