---
title: "BlTextV"
description: "Specifies the text that shows a status display for the individual data signals."
---
...
Specifies the text that shows a status display for the individual data signals.
