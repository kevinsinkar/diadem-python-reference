---
title: "BlCndOutpName"
description: "Specifies the terminal names of control signals at control outputs."
---

# BlCndOutpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlCndOutpName

Specifies the terminal names of control signals at control outputs.
...
*Source: `VarOnl/BlCndOutpName.htm`*
