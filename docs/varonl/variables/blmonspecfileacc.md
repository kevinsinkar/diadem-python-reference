---
title: "BlMonSpecFileAcc"
description: "Specifies the type of access to a DAT measurement file."
---

# BlMonSpecFileAcc

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlMonSpecFileAcc

Specifies the type of access to a DAT measurement file.
...
*Source: `VarOnl/BlMonSpecFileAcc.htm`*
