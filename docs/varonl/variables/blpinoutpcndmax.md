---
title: "BlPinOutpCndMax"
description: "Specifies the maximum number of control outputs at DAC blocks."
---

# BlPinOutpCndMax

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlPinOutpCndMax

Specifies the maximum number of control outputs at DAC blocks.
...
*Source: `VarOnl/BlPinOutpCndMax.htm`*
