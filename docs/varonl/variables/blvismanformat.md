---
title: "BlVISManFormat"
description: "Specifies the format of the numbers in display instruments."
---

# BlVISManFormat

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlVISManFormat

Specifies the format of the numbers in display instruments.
...
*Source: `VarOnl/BlVISManFormat.htm`*
