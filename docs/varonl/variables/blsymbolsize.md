---
title: "BlSymbolSize"
description: "Specifies the size of the symbol or graphic displayed in a scatter display."
---

# BlSymbolSize

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlSymbolSize

Specifies the size of the symbol or graphic displayed in a scatter display.
...
*Source: `VarOnl/BlSymbolSize.htm`*
