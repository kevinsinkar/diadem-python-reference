---
title: "BlEvntInpName"
description: "Specifies the terminal names of alarm signals at alarm inputs."
---

# BlEvntInpName

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlEvntInpName

Specifies the terminal names of alarm signals at alarm inputs.
...
*Source: `VarOnl/BlEvntInpName.htm`*
