---
title: "BlLinInp1"
description: "Specifies the first voltage value of the preamplifier output of a thermo linearization."
---
...
Specifies the first voltage value of the preamplifier output of a thermo linearization.
