---
title: "BlManRadioCount"
description: "Specifies the list length, which is the number of options of a radio button."
---

# BlManRadioCount

!!! abstract "Variable &middot; `VarOnl.chm`"
    Variable: BlManRadioCount

Specifies the list length, which is the number of options of a radio button.
...
*Source: `VarOnl/BlManRadioCount.htm`*
