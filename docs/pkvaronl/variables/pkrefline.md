---
title: "PkRefLine"
description: "Specifies in packet processing the zero line for the classification method, to separate oscillations into positive and negative sections."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRefLine</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrefline.htm`*
