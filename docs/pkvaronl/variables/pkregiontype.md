---
title: "PkRegionType"
description: "Specifies in packet processing whether the trigger event occurs inside or outside the monitored area."
---

# PkRegionType

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkRegionType

Specifies in packet processing whether the trigger event occurs inside or outside the monitored area.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRegionType</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkregiontype.htm`*
