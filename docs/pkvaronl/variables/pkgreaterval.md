---
title: "PkGreaterVal"
description: "Specifies in packet processing the limit value to be exceeded."
---

# PkGreaterVal

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkGreaterVal

Specifies in packet processing the limit value to be exceeded.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkGreaterVal</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkgreaterval.htm`*
