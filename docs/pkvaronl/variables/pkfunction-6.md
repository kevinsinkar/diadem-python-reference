---
title: "PkFunction"
description: "Specifies in packet processing the mathematical function to be calculated."
---
...
Specifies in packet processing the mathematical function to be calculated.
...
*Source: `PkVarOnl/pkvaronl/pkmfunction.htm`*
