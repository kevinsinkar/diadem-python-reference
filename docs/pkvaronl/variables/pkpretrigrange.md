---
title: "PkPreTrigRange"
description: "Specifies in packet processing how many values DIAdem outputs before a trigger event. The pretrigger range must not exceed the block size."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPreTrigRange</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpretrigrange.htm`*
