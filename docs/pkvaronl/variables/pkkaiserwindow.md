---
title: "PkKaiserWindow"
description: "Specifies in packet processing whether DIAdem calculates the Kaiser window for FIR filters."
---

# PkKaiserWindow

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkKaiserWindow

Specifies in packet processing whether DIAdem calculates the Kaiser window for FIR filters.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkKaiserWindow</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkkaiserwindow.htm`*
