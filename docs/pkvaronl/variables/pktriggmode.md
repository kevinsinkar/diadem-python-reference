---
title: "PkTriggMode"
description: "Specifies in packet processing the triggering of the threshold value."
---

# PkTriggMode

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkTriggMode

Specifies in packet processing the triggering of the threshold value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTriggMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktriggmode.htm`*
