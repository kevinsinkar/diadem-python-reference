---
title: "PkUpWarnLmt"
description: "Specifies in packet processing the top warning limit in the voltmeter."
---

# PkUpWarnLmt

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkUpWarnLmt

Specifies in packet processing the top warning limit in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUpWarnLmt</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkupwarnlmt.htm`*
