---
title: "PkTimeTc"
description: "Specifies in packet processing the time constant for calculating the root mean square of a level calculation."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTimeTc</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktimetc.htm`*
