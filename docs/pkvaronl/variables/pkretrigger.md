---
title: "PkRetrigger"
description: "Specifies in packet processing whether DIAdem checks a trigger signal continuously for trigger events."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRetrigger</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkretrigger.htm`*
