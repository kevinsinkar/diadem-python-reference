---
title: "PkSumBlock"
description: "Specifies in packet processing whether DIAdem calculates the sum of the measured values in one data packet."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkSumBlock</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pksumblock.htm`*
