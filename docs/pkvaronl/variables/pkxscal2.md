---
title: "PkXScal2"
description: "Specifies in packet processing the scaled measurement value for the second x-point of a characteristic curve."
---
...
Specifies in packet processing the scaled measurement value for the second x-point of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXScal2</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxscal2.htm`*
