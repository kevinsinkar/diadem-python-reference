---
title: "PkMode"
description: "Specifies in packet processing when the timer outputs a control signal."
---
...
Specifies in packet processing when the timer outputs a control signal.
...
*Source: `PkVarOnl/pkvaronl/pkzmode.htm`*
