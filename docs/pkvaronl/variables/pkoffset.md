---
title: "PkOffset"
description: "Specifies in packet processing the smallest value of the voltmeter display area."
---
...
Specifies in packet processing the smallest value of the voltmeter display area.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkOffset(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkoffset.htm`*
