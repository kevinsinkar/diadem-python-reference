---
title: "PkRate"
description: "Specifies in packet processing the sampling rate of the signal the function generator creates."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkClockRate</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrate.htm`*
