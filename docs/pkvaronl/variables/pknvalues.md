---
title: "PkNValues"
description: "Specifies in packet processing the maximum number of values collected in the buffer."
---
...
Specifies in packet processing the maximum number of values collected in the buffer.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNValues</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknvalues.htm`*
