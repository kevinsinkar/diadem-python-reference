---
title: "PkTitleTxt"
description: "Specifies in packet processing the text that DIAdem shows above the voltmeter display."
---
...
Specifies in packet processing the text that DIAdem shows above the voltmeter display.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTitleTxt(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkatitletxt.htm`*
