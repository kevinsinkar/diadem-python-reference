---
title: "PkDispPhMax"
description: "Specifies in packet processing whether DIAdem identifies the greatest measurement value in the voltmeter, with a marker."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDispPhMax(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdispphmax.htm`*
