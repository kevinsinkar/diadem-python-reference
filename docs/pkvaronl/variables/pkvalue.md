---
title: "PkValue"
description: "Returns in packet processing the current value of an input instrument."
---
...
Returns in packet processing the current value of an input instrument.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkValue</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkvalue.htm`*
