---
title: "PkRepeatMode"
description: "Specifies in packet processing which data DIAdem reads repeatedly from a file."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRepeatMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrepeatmode.htm`*
