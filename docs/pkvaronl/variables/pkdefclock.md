---
title: "PkDefClock"
description: "Specifies in packet processing whether the function generator uses the sampling rate and the block size set in Settings»Packet Processing»Default System Clock t"
---
...
Specifies in packet processing whether the function generator uses the sampling rate and the block size set in Settings»Packet Processing»Default System Clock to generate data packets.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkdefClock</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdefclock.htm`*
