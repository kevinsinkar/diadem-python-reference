---
title: "PkCursRight"
description: "Receives in packet processing the point number of the right cursor in the measurement data window of the oscilloscope."
---

# PkCursRight

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkCursRight

Receives in packet processing the point number of the right cursor in the measurement data window of the oscilloscope.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCursRight</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcursright.htm`*
