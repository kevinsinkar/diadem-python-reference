---
title: "PkAboveMsg"
description: "Specifies in packet processing the message text for the status display when the data signal exceeds the top alarm limit."
---
...
Specifies in packet processing the message text for the status display when the data signal exceeds the top alarm limit.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAboveMsg(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkabovemsg.htm`*
