---
title: "PkNumber"
description: "Specifies in packet processing the number of classes of an online classification."
---
...
Specifies in packet processing the number of classes of an online classification.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNumber</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknumber.htm`*
