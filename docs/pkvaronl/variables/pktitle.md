---
title: "PkTitle"
description: "Specifies in packet processing the title to be saved with the data."
---
...
Specifies in packet processing the title to be saved with the data.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTitle</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktitle.htm`*
