---
title: "PkAMean"
description: "Specifies in packet processing that DIAdem calculates the arithmetic mean as the statistical characteristic value."
---
...
Specifies in packet processing that DIAdem calculates the arithmetic mean as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAMean</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkamean.htm`*
