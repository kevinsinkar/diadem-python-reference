---
title: "PkMode"
description: "Specifies in packet processing how DIAdem calculates the arithmetic mean."
---
...
Specifies in packet processing how DIAdem calculates the arithmetic mean.
...
*Source: `PkVarOnl/pkvaronl/pkmmode.htm`*
