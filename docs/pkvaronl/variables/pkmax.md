---
title: "PkMax"
description: "Specifies in packet processing the end value of the slider control scale and the dial knob."
---
...
Specifies in packet processing the end value of the slider control scale and the dial knob.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkMax(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkmax.htm`*
