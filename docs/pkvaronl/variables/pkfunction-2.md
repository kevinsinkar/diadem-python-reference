---
title: "PkFunction"
description: "Specifies in packet processing the function of the spectral analysis."
---
...
Specifies in packet processing the function of the spectral analysis.
...
*Source: `PkVarOnl/pkvaronl/pkanafunction.htm`*
