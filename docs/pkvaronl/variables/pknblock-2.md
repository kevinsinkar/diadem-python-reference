---
title: "PkNBlock"
description: "Specifies in packet processing the number of data packets after which DIAdem rejects the current values of an online classification and starts a new count."
---
...
Specifies in packet processing the number of data packets after which DIAdem rejects the current values of an online classification and starts a new count.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNBlock</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknblocks.htm`*
