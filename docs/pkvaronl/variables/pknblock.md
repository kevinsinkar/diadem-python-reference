---
title: "PkNBlock"
description: "Specifies in packet processing the number of repetitions to copy data packets and to output the data packets repeatedly."
---
...
Specifies in packet processing the number of repetitions to copy data packets and to output the data packets repeatedly.
...
*Source: `PkVarOnl/pkvaronl/pknblock.htm`*
