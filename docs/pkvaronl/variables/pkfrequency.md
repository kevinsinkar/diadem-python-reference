---
title: "PkFrequency"
description: "Specifies in packet processing the limit frequency or the mean frequency of digital filters."
---

# PkFrequency

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkFrequency

Specifies in packet processing the limit frequency or the mean frequency of digital filters.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFrequency</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkffrequency.htm`*
