---
title: "PkFilterOrder"
description: "Specifies in packet processing the order of IIR filters."
---

# PkFilterOrder

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkFilterOrder

Specifies in packet processing the order of IIR filters.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFilterOrder</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkfilterorder.htm`*
