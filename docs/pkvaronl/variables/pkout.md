---
title: "PkOut"
description: "Specifies in packet processing the output string to transfer data over a serial interface to an external device."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkOut</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkout.htm`*
