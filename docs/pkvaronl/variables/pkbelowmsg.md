---
title: "PkBelowMsg"
description: "Specifies in packet processing the message text for the status display when the data signal undershoots the bottom alarm limit."
---
...
Specifies in packet processing the message text for the status display when the data signal undershoots the bottom alarm limit.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkBelowMsg(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkbelowmsg.htm`*
