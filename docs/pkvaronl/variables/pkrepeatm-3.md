---
title: "PkRepeatM"
description: "Specifies in packet processing that DIAdem writes a specified number of data packets into the Data Portal."
---
...
*Source: `PkVarOnl/pkvaronl/pkrepeatms.htm`*
