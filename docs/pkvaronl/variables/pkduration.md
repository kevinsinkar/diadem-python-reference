---
title: "PkDuration"
description: "Specifies in packet processing whether DIAdem transfers all data packets or a specific number of data packets after a trigger event."
---
...
Specifies in packet processing whether DIAdem transfers all data packets or a specific number of data packets after a trigger event.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDuration</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkduration.htm`*
