---
title: "PkUpperLim"
description: "Specifies in packet processing the top window limit of a window trigger."
---
...
Specifies in packet processing the top window limit of a window trigger.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUpperLim</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkupperlim.htm`*
