---
title: "PkXCh"
description: "Specifies in packet processing the sampling rate DIAdem uses to generate an x-channel when reading data."
---
...
Specifies in packet processing the sampling rate DIAdem uses to generate an x-channel when reading data.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXCh</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxch2.htm`*
