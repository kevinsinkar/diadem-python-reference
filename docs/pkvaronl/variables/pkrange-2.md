---
title: "PkRange"
description: "Specifies in packet processing the entire display area of a voltmeter."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRange</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrange.htm`*
