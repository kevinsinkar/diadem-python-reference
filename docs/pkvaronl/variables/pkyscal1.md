---
title: "PkYScal1"
description: "Specifies in packet processing the scaled measurement value for the first y-point of a characteristic curve."
---
...
Specifies in packet processing the scaled measurement value for the first y-point of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkYScal1</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkyscal1.htm`*
