---
title: "PkTransFctType"
description: "Specifies in packet processing the calculation mode of the transfer function for the FFT of two time signals."
---

# PkTransFctType

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkTransFctType

Specifies in packet processing the calculation mode of the transfer function for the FFT of two time signals.
...
*Source: `PkVarOnl/pkvaronl/pktransfcttype.htm`*
