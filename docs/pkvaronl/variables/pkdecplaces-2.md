---
title: "PkDecPlaces"
description: "Specifies the number of places after the decimal point, for digital display in packet processing."
---
...
Specifies the number of places after the decimal point, for digital display in packet processing.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDecPlaces(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdecplaces.htm`*
