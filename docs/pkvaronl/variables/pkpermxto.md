---
title: "PkPermXTo"
description: "Specifies in packet processing the end value of the x-axis in seconds in order to scale the x-axis of the oscilloscope."
---
...
Specifies in packet processing the end value of the x-axis in seconds in order to scale the x-axis of the oscilloscope.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPermXTo</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpermxto.htm`*
