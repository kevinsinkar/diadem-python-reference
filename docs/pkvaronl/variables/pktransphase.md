---
title: "PkTransPhase"
description: "Specifies in packet processing whether DIAdem calculates the phase spectrum for an FFT of two time signals."
---

# PkTransPhase

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkTransPhase

Specifies in packet processing whether DIAdem calculates the phase spectrum for an FFT of two time signals.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTransPhase</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktransphase.htm`*
