---
title: "PkRipple"
description: "Specifies in packet processing the ripples of digital filters in the pass-band of the Chebyshev and the elliptic filters."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRipple</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkripple.htm`*
