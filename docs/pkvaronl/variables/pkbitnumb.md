---
title: "PkBitNumb"
description: "Specifies in packet processing the number of bits for a bit switch."
---
...
Specifies in packet processing the number of bits for a bit switch.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkBitNumb(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkbitnumb.htm`*
