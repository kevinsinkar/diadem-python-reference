---
title: "PkRepeatM"
description: "Specifies in packet processing how often the replicator repeatedly outputs a data packet to the block diagram."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRepeatM</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrepeatmdupl.htm`*
