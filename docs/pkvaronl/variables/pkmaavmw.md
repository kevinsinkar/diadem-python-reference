---
title: "PkMAAVMW"
description: "Specifies in packet processing whether DIAdem calculates the average absolute deviation from the mean as a statistical characteristic value."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkMAAVMW</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkmaavmw.htm`*
