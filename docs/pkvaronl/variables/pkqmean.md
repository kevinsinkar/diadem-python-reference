---
title: "PkQMean"
description: "Specifies in packet processing whether DIAdem calculates the square mean or the root mean square as the statistical value."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkQMean</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkqmean.htm`*
