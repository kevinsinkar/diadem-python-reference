---
title: "PkWindowType"
description: "Specifies in packet processing the type of activating windows condition."
---

# PkWindowType

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkWindowType

Specifies in packet processing the type of activating windows condition.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkWindowType</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkwindowtype.htm`*
