---
title: "PkFunction"
description: "Specifies in packet processing which window function to use."
---
...
Specifies in packet processing which window function to use.
...
*Source: `PkVarOnl/pkvaronl/pkffunction.htm`*
