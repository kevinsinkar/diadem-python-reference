---
title: "PkLowAlrmLmt"
description: "Specifies in packet processing the bottom alarm limit in the voltmeter."
---

# PkLowAlrmLmt

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLowAlrmLmt

Specifies in packet processing the bottom alarm limit in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowAlrmLmt(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowalrmlmt.htm`*
