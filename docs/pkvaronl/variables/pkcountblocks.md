---
title: "PkCountBlocks"
description: "Specifies the period in which the packet processing counter outputs data packets."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCountBlocks</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcountblocks.htm`*
