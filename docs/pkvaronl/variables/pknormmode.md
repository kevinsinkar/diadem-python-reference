---
title: "PkNormMode"
description: "Specifies in packet processing the curve display in the oscilloscope."
---
...
Specifies in packet processing the curve display in the oscilloscope.
...
<td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/>
    ...
    <donottranslate>PkNormMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknormmode.htm`*
