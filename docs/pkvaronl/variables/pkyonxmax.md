---
title: "PkYonXMax"
description: "Specifies in packet processing whether DIAdem calculates the measurement value of the greatest time value as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the measurement value of the greatest time value as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkYOnXMax</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkyonxmax.htm`*
