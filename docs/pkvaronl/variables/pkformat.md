---
title: "PkFormat"
description: "Specifies in packet processing the written File format ."
---
...
Specifies in packet processing the written File format .
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFormat</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkformat.htm`*
