---
title: "PkYonXMin"
description: "Specifies in packet processing whether DIAdem calculates the measurement value of the smallest time value as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the measurement value of the smallest time value as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkYonXMin</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkyonxmin.htm`*
