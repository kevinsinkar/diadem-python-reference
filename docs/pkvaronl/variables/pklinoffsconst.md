---
title: "PkLinOffsConst"
description: "Specifies in packet processing which temperature value to add for the offset of a thermo linearization."
---

# PkLinOffsConst

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLinOffsConst

Specifies in packet processing which temperature value to add for the offset of a thermo linearization.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLinOffsConst</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklinoffsconst.htm`*
