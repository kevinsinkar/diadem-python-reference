---
title: "PkXValueMode"
description: "Specifies in packet processing the format of an x-channel to be generated."
---

# PkXValueMode

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkXValueMode

Specifies in packet processing the format of an x-channel to be generated.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXValueMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxvaluemode.htm`*
