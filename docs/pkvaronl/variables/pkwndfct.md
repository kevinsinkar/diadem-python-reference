---
title: "PkWndFct"
description: "Specifies in packet processing the windows function for an FFT. To reduce the spectral broadening, DIAdem multiplies the time signal by the selected window func"
---
...
Specifies in packet processing the windows function for an FFT. To reduce the spectral broadening, DIAdem multiplies the time signal by the selected window function.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <span class="Monospace">PkWndFct</span> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkwndfct.htm`*
