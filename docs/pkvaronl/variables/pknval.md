---
title: "PkNVal"
description: "Specifies in packet processing the number of values to write into the Data Portal."
---
...
Specifies in packet processing the number of values to write into the Data Portal.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNVal</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknval.htm`*
