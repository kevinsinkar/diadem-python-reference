---
title: "PkButTxtOn"
description: "Specifies in packet processing a text for the switched on mode of switches, push buttons, and bit switches."
---
...
Specifies in packet processing a text for the switched on mode of switches, push buttons, and bit switches.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkButTxtOn(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkbuttxton.htm`*
