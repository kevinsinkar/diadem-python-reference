---
title: "PkWndCorrectTyp"
description: "Specifies in packet processing the correction of an FFT amplitude attenuation that is caused by the window function."
---

# PkWndCorrectTyp

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkWndCorrectTyp

Specifies in packet processing the correction of an FFT amplitude attenuation that is caused by the window function.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkWndCorrectTyp</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkwndcorrecttyp.htm`*
