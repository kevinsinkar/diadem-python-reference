---
title: "PkCursLeft"
description: "Receives in packet processing the point number of the left cursor in the measurement data window of the oscilloscope."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCursLeft</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcursleft.htm`*
