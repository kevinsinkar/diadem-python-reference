---
title: "PkThreshold"
description: "Specifies in packet processing the threshold value of a slope condition."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkThreshold</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkthreshold.htm`*
