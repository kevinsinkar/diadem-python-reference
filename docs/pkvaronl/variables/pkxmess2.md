---
title: "PkXMess2"
description: "Specifies in packet processing the measurement value for the second x-point of a characteristic curve."
---
...
Specifies in packet processing the measurement value for the second x-point of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXMess2</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxmess2.htm`*
