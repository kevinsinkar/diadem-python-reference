---
title: "PkDecPlaces"
description: "Specifies in packet processing the number of decimal places in the numeric display of the voltmeter."
---

# PkDecPlaces

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkDecPlaces

Specifies in packet processing the number of decimal places in the numeric display of the voltmeter.
...
<br attr="ext"/>
<donottranslate>
<pre>DACObjOpen(<em>BlockName</em>)
          PkDecPlaces(i) = <em>Value</em>
          DACObjClose(<em>BlockName</em>)
         </pre>
</donottranslate>
...
*Source: `PkVarOnl/pkvaronl/pkadecplaces.htm`*
