---
title: "PkDispTrend"
description: "Specifies in packet processing whether DIAdem displays the measurement data trend in the voltmeter."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDispTrend(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdisptrend.htm`*
