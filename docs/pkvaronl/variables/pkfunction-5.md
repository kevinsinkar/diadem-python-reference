---
title: "PkFunction"
description: "Specifies in packet processing the statistical characteristic values to be calculated for each data packet."
---
...
Specifies in packet processing the statistical characteristic values to be calculated for each data packet.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFunktion</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkfunction.htm`*
