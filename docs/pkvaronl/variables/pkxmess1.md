---
title: "PkXMess1"
description: "Specifies in packet processing the measurement value for the first x-point of a characteristic curve."
---
...
Specifies in packet processing the measurement value for the first x-point of a characteristic curve.
...
<br attr="ext"/> <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXMess1</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxmess1.htm`*
