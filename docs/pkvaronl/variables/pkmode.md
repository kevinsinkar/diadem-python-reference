---
title: "PkMode"
description: "Specifies in packet processing the signal display of the voltmeter."
---
...
Specifies in packet processing the signal display of the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkMode(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkamode.htm`*
