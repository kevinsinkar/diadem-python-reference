---
title: "PkCoherence"
description: "Specifies in packet processing whether DIAdem calculates the coherence for an FFT of two signals with a joint time channel."
---

# PkCoherence

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkCoherence

Specifies in packet processing whether DIAdem calculates the coherence for an FFT of two signals with a joint time channel.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCoherence</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcoherence.htm`*
