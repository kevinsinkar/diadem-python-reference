---
title: "PkSkipVal"
description: "Specifies in packet processing the number of values that DIAdem rejects at the start of a measurement, when creating sections."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkSkipVal </donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkskipval.htm`*
