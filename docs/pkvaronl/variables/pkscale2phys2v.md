---
title: "PkScale2Phys2V"
description: "Specifies in packet processing the measurement value for the second linear point of a 2-point scaling."
---

# PkScale2Phys2V

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkScale2Phys2V

Specifies in packet processing the measurement value for the second linear point of a 2-point scaling.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScale2Phys2V</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscale2phys2v.htm`*
