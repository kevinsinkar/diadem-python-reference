---
title: "PkUserUnitS"
description: "Specifies in packet processing the short form of a user unit."
---

# PkUserUnitS

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkUserUnitS

Specifies in packet processing the short form of a user unit.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUserUnitS</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkuserunits.htm`*
