---
title: "PkBitCol"
description: "Specifies in packet processing the number of columns which in turn specifies the arrangement of the switches in a bit switch."
---
...
Specifies in packet processing the number of columns which in turn specifies the arrangement of the switches in a bit switch.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkBitCol(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkbitcol.htm`*
