---
title: "PkPermXFrom"
description: "Specifies in packet processing the start value of the x-axis in seconds in order to scale the x-axis of the oscilloscope."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPermXFrom</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpermxfrom.htm`*
