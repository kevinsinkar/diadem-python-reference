---
title: "PkXUnit"
description: "Specifies in packet processing the unit for the time axis of a characteristic curve."
---
...
Specifies in packet processing the unit for the time axis of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXUnit</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxunit.htm`*
