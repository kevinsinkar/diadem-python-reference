---
title: "PkScalMax"
description: "Specifies in packet processing whether DIAdem scales the results of a spectral analysis to a minimum."
---
...
Specifies in packet processing whether DIAdem scales the results of a spectral analysis to a minimum.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScalMax</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscalmax.htm`*
