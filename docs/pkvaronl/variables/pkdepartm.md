---
title: "PkDepartm"
description: "Specifies in packet processing the department name to be saved with the data."
---
...
Specifies in packet processing the department name to be saved with the data.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDepartm</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdepartm.htm`*
