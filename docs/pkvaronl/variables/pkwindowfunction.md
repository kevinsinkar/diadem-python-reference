---
title: "PkWindowFunction"
description: "Specifies in packet processing the windows function of IIR filters."
---

# PkWindowFunction

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkWindowFunction

Specifies in packet processing the windows function of IIR filters.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkWindowFunction</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkwindowfunction.htm`*
