---
title: "PkThresholdR"
description: "Specifies in packet processing the threshold value of the retrigger slope."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkThresholdR</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkthresholdr.htm`*
