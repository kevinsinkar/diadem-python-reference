---
title: "PkFilterType"
description: "Specifies in packet processing the IIR filter type."
---

# PkFilterType

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkFilterType

Specifies in packet processing the IIR filter type.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFilterType</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkfiltertype.htm`*
