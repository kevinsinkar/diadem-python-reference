---
title: "PkUser"
description: "Specifies in packet processing the name of the author to be saved with the data."
---
...
Specifies in packet processing the name of the author to be saved with the data.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUser</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkuser.htm`*
