---
title: "PkTrigType"
description: "Specifies in packet processing which condition activates a control signal for the trigger search."
---
...
Specifies in packet processing which condition activates a control signal for the trigger search.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTrigType</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktrigtype.htm`*
