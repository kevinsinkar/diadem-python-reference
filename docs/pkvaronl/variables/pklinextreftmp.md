---
title: "PkLinExtRefTmp"
description: "Specifies in packet processing whether DIAdem uses an offset for thermo linearization."
---

# PkLinExtRefTmp

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLinExtRefTmp

Specifies in packet processing whether DIAdem uses an offset for thermo linearization.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLinExtRefTmp</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklinextreftmp.htm`*
