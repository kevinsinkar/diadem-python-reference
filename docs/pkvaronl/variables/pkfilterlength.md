---
title: "PkFilterLength"
description: "Specifies for digital filters in packet processing the number of values to be calculated for FIR filters."
---

# PkFilterLength

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkFilterLength

Specifies for digital filters in packet processing the number of values to be calculated for FIR filters.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFilterLength</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkfilterlength.htm`*
