---
title: "PkAverageType"
description: "Specifies in packet processing which mean value DIAdem calculates for an FFT of two time signals."
---

# PkAverageType

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkAverageType

Specifies in packet processing which mean value DIAdem calculates for an FFT of two time signals.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAverageType</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkaveragetype.htm`*
