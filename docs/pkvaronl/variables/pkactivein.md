---
title: "PkActiveIn"
description: "Specifies the number of the data input on the packet processing multiplexer if the PkCtrlMode variable has the value 1 ."
---
...
Specifies the number of the data input on the packet processing multiplexer if the PkCtrlMode variable has the value 1 .
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
     <donottranslate>PkActiveIn </donottranslate>= <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkactivein.htm`*
