---
title: "PkAnalysis"
description: "Specifies in packet processing whether DIAdem runs a third analysis or an octave analysis."
---
...
Specifies in packet processing whether DIAdem runs a third analysis or an octave analysis.
...
<td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/>
    <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAnalysis</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkanalysis.htm`*
