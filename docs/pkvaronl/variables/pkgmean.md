---
title: "PkGMean"
description: "Specifies in packet processing that DIAdem calculates the geometric mean as the statistical characteristic value."
---
...
Specifies in packet processing that DIAdem calculates the geometric mean as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkGMean</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkgmean.htm`*
