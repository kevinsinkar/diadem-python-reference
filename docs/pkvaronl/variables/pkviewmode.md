---
title: "PkViewMode"
description: "Specifies in packet processing the signal display of the oscilloscope."
---
...
Specifies in packet processing the signal display of the oscilloscope.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkViewMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkviewmode.htm`*
