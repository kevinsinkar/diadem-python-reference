---
title: "PkName"
description: "Specifies in packet processing the name and path of the data file to be read or written."
---
...
Specifies in packet processing the name and path of the data file to be read or written.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkName</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkname.htm`*
