---
title: "PkLinThermoDim"
description: "Specifies in packet processing the unit of the physical output value of a thermo linearization."
---

# PkLinThermoDim

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLinThermoDim

Specifies in packet processing the unit of the physical output value of a thermo linearization.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLinThermoDim</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklinthermodim.htm`*
