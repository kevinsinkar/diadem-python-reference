---
title: "PkRMS"
description: "Specifies in packet processing whether a level calculation calculates the root mean square or the peak of the acoustic pressure."
---
...
Specifies in packet processing whether a level calculation calculates the root mean square or the peak of the acoustic pressure.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRMS</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrms.htm`*
