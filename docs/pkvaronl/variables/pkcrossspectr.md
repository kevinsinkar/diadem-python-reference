---
title: "PkCrossSpectr"
description: "Specifies in packet processing whether the FFT of two signals calculates the cross spectrum or the transfer function."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCrossSpectr</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcrossspectr.htm`*
