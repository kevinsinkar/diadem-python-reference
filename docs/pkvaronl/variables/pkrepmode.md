---
title: "PkRepMode"
description: "Specifies in packet processing that DIAdem reads the data repeatedly and outputs the data to the block diagram."
---
...
Specifies in packet processing that DIAdem reads the data repeatedly and outputs the data to the block diagram.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRepMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrepmode.htm`*
