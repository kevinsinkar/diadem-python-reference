---
title: "PkScaleDimV"
description: "Specifies in packet processing the unit of the physical output value of a two-point-scaling."
---
...
Specifies in packet processing the unit of the physical output value of a two-point-scaling.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScaleDimV</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscaledimv.htm`*
