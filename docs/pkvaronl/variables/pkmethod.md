---
title: "PkMethod"
description: "Specifies in packet processing the classification method of a classification."
---
...
Specifies in packet processing the classification method of a classification.
...
*Source: `PkVarOnl/pkvaronl/pkmethod.htm`*
