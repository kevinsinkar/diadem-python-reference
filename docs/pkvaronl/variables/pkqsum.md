---
title: "PkQSum"
description: "Specifies in packet processing whether DIAdem calculates the sum of the squared values of a data packet as a statistical characteristic value."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkQSum</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkqsum.htm`*
