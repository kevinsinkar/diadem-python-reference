---
title: "PkSwitch"
description: "Specifies in packet processing how the relay switch works."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkSwitch</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkswitch.htm`*
