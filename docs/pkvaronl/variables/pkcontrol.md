---
title: "PkControl"
description: "Specifies in packet processing the data output number at the demultiplexer for data output."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkControl = <em>Value</em>
DACObjClose(<em>BlockName</em>)</donottranslate></pre> </donottranslate>
...
*Source: `PkVarOnl/pkvaronl/pkcontrol.htm`*
