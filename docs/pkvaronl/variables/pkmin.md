---
title: "PkMin"
description: "Specifies in packet processing the start value of a slider control scale and a dial scale."
---
...
Specifies in packet processing the start value of a slider control scale and a dial scale.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkMin(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkmin.htm`*
