---
title: "PkGreaterOn"
description: "Specifies in packet processing whether DIAdem monitors when a specific limit value is exceeded."
---

# PkGreaterOn

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkGreaterOn

Specifies in packet processing whether DIAdem monitors when a specific limit value is exceeded.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkGreaterOn</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkgreateron.htm`*
