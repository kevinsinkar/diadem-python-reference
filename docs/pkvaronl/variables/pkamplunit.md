---
title: "PkAmplUnit"
description: "Specifies in packet processing the amplitude unit of the function generator."
---
...
Specifies in packet processing the amplitude unit of the function generator.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAmplUnit</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkamplunit.htm`*
