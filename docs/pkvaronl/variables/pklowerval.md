---
title: "PkLowerVal"
description: "Specifies in packet processing the limit value of a threshold to be exceeded."
---
...
Specifies in packet processing the limit value of a threshold to be exceeded.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowerVal</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowerval.htm`*
