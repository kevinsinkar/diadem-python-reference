---
title: "PkLowAlrmOn"
description: "Specifies in packet processing that DIAdem displays the undershooting of the bottom alarm limit in the voltmeter."
---

# PkLowAlrmOn

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLowAlrmOn

Specifies in packet processing that DIAdem displays the undershooting of the bottom alarm limit in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowAlrmOn</donottranslate><donottranslate>(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowalrmon.htm`*
