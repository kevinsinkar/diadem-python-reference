---
title: "PkPermYTo"
description: "Specifies in packet processing the end value of the y-axis in order to scale the y-axis of the oscilloscope."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPermYTo</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpermyto.htm`*
