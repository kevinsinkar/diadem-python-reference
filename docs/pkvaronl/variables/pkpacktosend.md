---
title: "PkPackToSend"
description: "Specifies in packet processing the number of output data packets to be output after a trigger event."
---

# PkPackToSend

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkPackToSend

Specifies in packet processing the number of output data packets to be output after a trigger event.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPackToSend</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpacktosend.htm`*
