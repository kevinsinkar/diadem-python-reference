---
title: "PkUpdateCP"
description: "Specifies in packet processing whether DIAdem reads new calibration curves for multiple point scaling, during a measurement."
---
...
Specifies in packet processing whether DIAdem reads new calibration curves for multiple point scaling, during a measurement.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUpdateCP</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkupdatecp.htm`*
