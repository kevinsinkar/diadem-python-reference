---
title: "PkCompany"
description: "Specifies in packet processing the company logo that is to be saved with the written data."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCompany</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcompany.htm`*
