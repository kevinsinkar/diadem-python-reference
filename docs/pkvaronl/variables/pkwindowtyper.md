---
title: "PkWindowTypeR"
description: "Specifies in packet processing the type of activating window condition of a retrigger."
---

# PkWindowTypeR

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkWindowTypeR

Specifies in packet processing the type of activating window condition of a retrigger.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkWindowTypeR</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkwindowtyper.htm`*
