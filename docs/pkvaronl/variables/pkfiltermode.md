---
title: "PkFilterMode"
description: "Specifies in packet processing the filter type of digital filters."
---

# PkFilterMode

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkFilterMode
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFilterMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkfiltermode.htm`*
