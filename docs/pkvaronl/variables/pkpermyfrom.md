---
title: "PkPermYFrom"
description: "Specifies in packet processing the start value of the y-axis in seconds in order to scale the y-axis of the oscilloscope."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPermYFrom</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpermyfrom.htm`*
