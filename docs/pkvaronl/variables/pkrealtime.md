---
title: "PkRealTime"
description: "Specifies in packet processing whether the function generator generates data packets as fast as possible or with the specified clock rate and packet size."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRealTime</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkrealtime.htm`*
