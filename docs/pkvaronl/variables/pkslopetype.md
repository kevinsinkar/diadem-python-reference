---
title: "PkSlopeType"
description: "Specifies in packet processing the type of slope condition to be activated."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkSlopeType </donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkslopetype.htm`*
