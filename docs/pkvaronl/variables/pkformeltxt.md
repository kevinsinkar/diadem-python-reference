---
title: "PkFormelTxt"
description: "Specifies in packet processing the formula to be calculated."
---

# PkFormelTxt

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkFormelTxt

Specifies in packet processing the formula to be calculated.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
     <donottranslate>PkFormelTxt </donottranslate>= <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkformeltxt.htm`*
