---
title: "PkDispDigi"
description: "Specifies in packet processing whether DIAdem shows a numeric display in the voltmeter."
---
...
Specifies in packet processing whether DIAdem shows a numeric display in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDispDigi(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdispdigi.htm`*
