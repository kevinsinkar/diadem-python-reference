---
title: "PkCutoffFreq"
description: "Specifies in packet processing the 3 dB-limit frequency for highpass and lowpass digital filters."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCutoffFreq</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcutofffreq.htm`*
