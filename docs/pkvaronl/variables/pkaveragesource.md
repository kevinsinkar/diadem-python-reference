---
title: "PkAverageSource"
description: "Specifies in packet processing whether DIAdem calculates the average of an FFT from the amplitude or from the autospectrum."
---

# PkAverageSource

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkAverageSource

Specifies in packet processing whether DIAdem calculates the average of an FFT from the amplitude or from the autospectrum.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAverageSource</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkaveragesource.htm`*
