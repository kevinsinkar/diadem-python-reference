---
title: "PkNPck"
description: "Specifies in packet processing the number of data packets to write into the Data Portal."
---
...
Specifies in packet processing the number of data packets to write into the Data Portal.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNPck</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknpck.htm`*
