---
title: "PkWndPara"
description: "Specifies in packet processing the parameters for the window functions Kaiser-Bessel, Cauchy, Gauss, and Exponential."
---
...
Specifies in packet processing the parameters for the window functions Kaiser-Bessel, Cauchy, Gauss, and Exponential.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkWndPara</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkwndpara.htm`*
