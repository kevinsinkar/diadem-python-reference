---
title: "PkQFactor"
description: "Specifies in packet processing the quality factor for bandpass and bandstop of digital filters."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkQFactor</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkqfactor.htm`*
