---
title: "PkReset"
description: "Specifies in packet processing when DIAdem triggers the reset of an online classification to reject values and to begin a new count."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkReset</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkreset.htm`*
