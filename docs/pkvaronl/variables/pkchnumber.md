---
title: "PkChNumber"
description: "Specifies in packet processing the number of a data channel to be read from a file. If you assign the value 0 to the PkChNumber variable, DIAdem reads all data "
---
...
Specifies in packet processing the number of a data channel to be read from a file. If you assign the value 0 to the PkChNumber variable, DIAdem reads all data channels of the file.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkChNumber</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkchnumber.htm`*
