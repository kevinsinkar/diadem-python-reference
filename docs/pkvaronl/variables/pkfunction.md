---
title: "PkFunction"
description: "Specifies in packet processing how DIAdem calculates the data of two packet buses."
---
...
Specifies in packet processing how DIAdem calculates the data of two packet buses.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkFunction</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkafunction.htm`*
