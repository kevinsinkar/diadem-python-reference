---
title: "PkOrder"
description: "Specifies in packet processing the filter order of digital filters. High filter orders provide a steeper filter with greater phase displacement"
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkOrder</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkorder.htm`*
