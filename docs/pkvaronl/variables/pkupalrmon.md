---
title: "PkUpAlrmOn"
description: "Specifies in packet processing whether DIAdem displays the exceeding of the top alarm limit in the voltmeter."
---
...
Specifies in packet processing whether DIAdem displays the exceeding of the top alarm limit in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUpAlrmOn</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkupalrmon.htm`*
