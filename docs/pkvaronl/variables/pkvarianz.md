---
title: "PkVarianz"
description: "Specifies in packet processing that DIAdem calculates the variance as the statistical characteristic value."
---
...
Specifies in packet processing that DIAdem calculates the variance as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkVarianz</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkvarianz.htm`*
