---
title: "PkRadio"
description: "Specifies in packet processing whether the switches of a multi-channel input instrument switch off each other."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRadio</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkradio.htm`*
