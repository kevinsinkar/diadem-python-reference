---
title: "PkInPacketT"
description: "Specifies in packet processing that DIAdem saves the data packets that arrive at the replicator during a repetition cycle, to the clipboard."
---

# PkInPacketT

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkInPacketT

Specifies in packet processing that DIAdem saves the data packets that arrive at the replicator during a repetition cycle, to the clipboard.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkInPacket</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkinpackett.htm`*
