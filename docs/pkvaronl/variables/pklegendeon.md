---
title: "PkLegendeOn"
description: "Specifies in packet processing whether DIAdem displays the curve legend in the oscilloscope display window."
---

# PkLegendeOn

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLegendeOn

Specifies in packet processing whether DIAdem displays the curve legend in the oscilloscope display window.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLegendeOn</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklegendeon.htm`*
