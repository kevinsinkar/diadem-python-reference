---
title: "PkResetCount"
description: "Specifies in packet processing the number of data packets after which DIAdem rejects the current values of an FFT and restarts averaging."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkResetCount</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkresetcount.htm`*
