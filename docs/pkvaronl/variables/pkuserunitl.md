---
title: "PkUserUnitL"
description: "Specifies in packet processing the name of a user unit."
---

# PkUserUnitL

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkUserUnitL

Specifies in packet processing the name of a user unit.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUserUnitL</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkuserunitl.htm`*
