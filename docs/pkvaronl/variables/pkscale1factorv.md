---
title: "PkScale1FactorV"
description: "Specifies in packet processing the factor of a linear scale."
---

# PkScale1FactorV

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkScale1FactorV

Specifies in packet processing the factor of a linear scale.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScale1FactorV</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscale1factorv.htm`*
