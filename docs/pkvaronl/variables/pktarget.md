---
title: "PkTarget"
description: "Specifies in packet processing that DIAdem prints out the protocol lists."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTarget</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktarget.htm`*
