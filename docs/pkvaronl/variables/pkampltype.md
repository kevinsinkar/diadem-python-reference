---
title: "PkAmplType"
description: "Specifies in packet processing which spectrum DIAdem calculates from the results of a FFT."
---
...
Specifies in packet processing which spectrum DIAdem calculates from the results of a FFT.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAmplType</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkampltype.htm`*
