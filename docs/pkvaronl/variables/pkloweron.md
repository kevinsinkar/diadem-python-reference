---
title: "PkLowerOn"
description: "Specifies in packet processing whether DIAdem monitors when a limit value is undershot."
---
...
Specifies in packet processing whether DIAdem monitors when a limit value is undershot.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowerOn</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkloweron.htm`*
