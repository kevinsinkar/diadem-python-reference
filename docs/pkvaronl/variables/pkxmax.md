---
title: "PkXMax"
description: "Specifies in packet processing whether DIAdem calculates the greatest time value as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the greatest time value as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXMax</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxmax.htm`*
