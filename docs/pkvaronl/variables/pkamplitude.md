---
title: "PkAmplitude"
description: "Specifies in packet processing the amplitude of the generator signal."
---

# PkAmplitude

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkAmplitude

Specifies in packet processing the amplitude of the generator signal.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAmplitude </donottranslate>= <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkamplitude.htm`*
