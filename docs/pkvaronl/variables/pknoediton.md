---
title: "PkNoEditOn"
description: "Specifies in packet processing whether you can operate specific functions in the display window in the oscilloscope."
---
...
Specifies in packet processing whether you can operate specific functions in the display window in the oscilloscope.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNoEditOn</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknoediton.htm`*
