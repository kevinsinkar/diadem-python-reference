---
title: "PkYScal2"
description: "Specifies in packet processing the scaled measurement value for the second y-point of a characteristic curve."
---
...
Specifies in packet processing the scaled measurement value for the second y-point of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkYScal2</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkyscal2.htm`*
