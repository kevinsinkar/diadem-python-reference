---
title: "PkRecLength"
description: "Specifies in packet processing the number of values to be displayed simultaneously in the oscilloscope and thereby the display area of the recorder."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkRecLength</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkreclength.htm`*
