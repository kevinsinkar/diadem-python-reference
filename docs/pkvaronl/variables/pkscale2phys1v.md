---
title: "PkScale2Phys1V"
description: "Specifies in packet processing the measurement value for the first linear point of a 2-point scaling."
---

# PkScale2Phys1V

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkScale2Phys1V

Specifies in packet processing the measurement value for the first linear point of a 2-point scaling.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScale2Phys1V</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscale2phys1v.htm`*
