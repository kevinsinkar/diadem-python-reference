---
title: "PkCommNew"
description: "Specifies in packet processing the comment to be saved with the data."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCommNew</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcommnew.htm`*
