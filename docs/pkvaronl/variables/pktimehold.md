---
title: "PkTimeHold"
description: "Specifies in packet processing the time in seconds that DIAdem deletes from the level calculation before a pause."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <span class="Monospace">PkTimeHold</span>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktimehold.htm`*
