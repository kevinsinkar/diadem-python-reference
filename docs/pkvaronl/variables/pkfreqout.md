---
title: "PkFreqOut"
description: "Specifies in packet processing how fast DIAdem outputs level calculations."
---
...
Specifies in packet processing how fast DIAdem outputs level calculations.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
     <donottranslate>PkFreqOut </donottranslate>= <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkfreqout.htm`*
