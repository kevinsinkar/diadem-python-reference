---
title: "PkLowerFreq"
description: "Specifies in packet processing the lower 3 dB-limit frequency for bandpass or bandstop of digital filters."
---

# PkLowerFreq

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLowerFreq

Specifies in packet processing the lower 3 dB-limit frequency for bandpass or bandstop of digital filters.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowerFreq</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowerfreq.htm`*
