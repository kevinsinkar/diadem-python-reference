---
title: "PkAttenuation"
description: "Specifies in packet processing the attenuation for the elliptic and the inverse Chebyshev filter."
---

# PkAttenuation

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkAttenuation

Specifies in packet processing the attenuation for the elliptic and the inverse Chebyshev filter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAttenuation</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkattenuation.htm`*
