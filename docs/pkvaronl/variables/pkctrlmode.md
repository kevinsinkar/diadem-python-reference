---
title: "PkCtrlMode"
description: "Specifies the data input from which the packet processing multiplexer reads and outputs data."
---
...
Specifies the data input from which the packet processing multiplexer reads and outputs data.
...
<td><strong>Note  </strong>You must use the following object hierarchy to access the variable:<br attr="ext"/>
    ...
    <donottranslate>PkCtrlMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkctrlmode.htm`*
