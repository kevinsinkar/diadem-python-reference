---
title: "PkResNBlocks"
description: "Specifies in packet processing the number of data packets after which DIAdem starts a new mean value calculation."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkResNBlocks</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkresnblocks.htm`*
