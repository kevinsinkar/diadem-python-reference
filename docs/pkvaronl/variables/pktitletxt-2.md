---
title: "PkTitleTxt"
description: "Specifies in packet processing the text for the label of the input instrument."
---
...
Specifies in packet processing the text for the label of the input instrument.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTitleTxt</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktitletxt.htm`*
