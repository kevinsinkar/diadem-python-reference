---
title: "PkPermYOn"
description: "Specifies in packet processing a fixed scaling for the y-axis of the oscilloscope."
---
...
Specifies in packet processing a fixed scaling for the y-axis of the oscilloscope.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPermYOn</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpermyon.htm`*
