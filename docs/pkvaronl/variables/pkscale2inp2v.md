---
title: "PkScale2Inp2V"
description: "Specifies in packet processing the scaled value for the second linear point of a two-point-scaling."
---

# PkScale2Inp2V

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkScale2Inp2V

Specifies in packet processing the scaled value for the second linear point of a two-point-scaling.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScale2Inp2V</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscale2inp2v.htm`*
