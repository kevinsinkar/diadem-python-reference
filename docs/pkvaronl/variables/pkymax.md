---
title: "PkYMax"
description: "Specifies in packet processing whether DIAdem calculates the greatest measurement value as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the greatest measurement value as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkYMax</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkymax.htm`*
