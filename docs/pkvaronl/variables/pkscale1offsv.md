---
title: "PkScale1OffsV"
description: "Specifies in packet processing the offset of a linear scale."
---

# PkScale1OffsV

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkScale1OffsV

Specifies in packet processing the offset of a linear scale.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkScale1OffsV</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkscale1offsv.htm`*
