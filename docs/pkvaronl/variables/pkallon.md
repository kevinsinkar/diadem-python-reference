---
title: "PkAllOn"
description: "Selects all statistical characteristic values in the statistics dialog box of packet processing."
---
...
Selects all statistical characteristic values in the statistics dialog box of packet processing.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAllOn</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkallon.htm`*
