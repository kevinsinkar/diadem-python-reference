---
title: "PkXMin"
description: "Specifies in packet processing whether DIAdem calculates the smallest time value as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the smallest time value as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXMin</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxmin.htm`*
