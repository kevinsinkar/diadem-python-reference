---
title: "PkCountMode"
description: "Specifies in packet processing whether the counter counts measurement values, data packets, or time spans."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkCountMode</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkcountmode.htm`*
