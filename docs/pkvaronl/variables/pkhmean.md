---
title: "PkHMean"
description: "Specifies in packet processing whether DIAdem calculates the harmonic mean as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the harmonic mean as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkHMean</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkhmean.htm`*
