---
title: "PkStdAbw"
description: "Specifies in packet processing whether DIAdem calculates the standard deviation as the statistical characteristic value."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkStdAbw</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkstdabw.htm`*
