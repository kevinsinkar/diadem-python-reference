---
title: "PkLowWarnLmt"
description: "Specifies in packet processing the bottom warning limit in the voltmeter."
---

# PkLowWarnLmt

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLowWarnLmt

Specifies in packet processing the bottom warning limit in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowWarnLmt(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowwarnlmt.htm`*
