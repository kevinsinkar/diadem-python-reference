---
title: "PkLowerLim"
description: "Specifies in packet processing the bottom window limit of a window trigger."
---
...
Specifies in packet processing the bottom window limit of a window trigger.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowerLim</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowerlim.htm`*
