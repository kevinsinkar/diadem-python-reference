---
title: "PkUpWarnOn"
description: "Specifies in packet processing whether DIAdem displays the exceeding of the top warning limit in the voltmeter."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUpWarnOn</donottranslate>(i) = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkupwarnon.htm`*
