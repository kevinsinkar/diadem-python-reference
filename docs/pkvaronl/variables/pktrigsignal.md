---
title: "PkTrigSignal"
description: "Specifies in packet processing which input signal at the trigger block checks DIAdem for trigger events."
---

# PkTrigSignal

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkTrigSignal

Specifies in packet processing which input signal at the trigger block checks DIAdem for trigger events.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkTrigSignal</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pktrigsignal.htm`*
