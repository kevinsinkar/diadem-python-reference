---
title: "PkXRate"
description: "Specifies in packet processing the sampling rate for generating the x-channel when DIAdem reads data."
---
...
Specifies in packet processing the sampling rate for generating the x-channel when DIAdem reads data.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXRate</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxrate.htm`*
