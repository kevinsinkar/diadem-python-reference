---
title: "PkAScaling"
description: "Specifies in packet processing that DIAdem runs an A-scaling for the noise level in decibel [dB] for a third or octave analysis."
---
...
Specifies in packet processing that DIAdem runs an A-scaling for the noise level in decibel [dB] for a third or octave analysis.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAScaling</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkascaling.htm`*
