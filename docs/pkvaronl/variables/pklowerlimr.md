---
title: "PkLowerLimR"
description: "Specifies in packet processing the bottom window limit of a retrigger."
---

# PkLowerLimR

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkLowerLimR

Specifies in packet processing the bottom window limit of a retrigger.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkLowerLimR</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pklowerlimr.htm`*
