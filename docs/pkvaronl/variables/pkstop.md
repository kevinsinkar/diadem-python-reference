---
title: "PkStop"
description: "Specifies in packet processing the stop string to deinitialize an external device over the serial interface."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkStop</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkstop.htm`*
