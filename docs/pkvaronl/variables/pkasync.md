---
title: "PkAsync"
description: "Specifies in packet processing when DIAdem transfers data packets at the active data input of the multiplexer."
---
...
Specifies in packet processing when DIAdem transfers data packets at the active data input of the multiplexer.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkAsync</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkasync.htm`*
