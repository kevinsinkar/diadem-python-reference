---
title: "PkDispScala"
description: "Specifies in packet processing whether DIAdem displays a scale in the voltmeter."
---

# PkDispScala

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkDispScala

Specifies in packet processing whether DIAdem displays a scale in the voltmeter.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkDispScala(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkdispscala.htm`*
