---
title: "PkPhaseFFT"
description: "Specifies in packet processing whether DIAdem calculates the phase spectrum for the FFT. For phase calculation, DIAdem calculates the angle measured countercloc"
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPhaseFFT</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkphasefft.htm`*
