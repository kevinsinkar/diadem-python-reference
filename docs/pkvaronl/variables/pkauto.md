---
title: "PkAuto"
description: "Specifies in packet processing that DIAdem scales the display area of a display instrument like the incoming data packets."
---
...
Specifies in packet processing that DIAdem scales the display area of a display instrument like the incoming data packets.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
   <donottranslate>PkAuto(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkauto.htm`*
