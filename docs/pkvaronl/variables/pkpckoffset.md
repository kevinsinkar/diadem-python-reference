---
title: "PkPckOffset"
description: "Specifies in packet processing the overlapping width with which the offset register outputs data packets."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkPckOffset</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkpckoffset.htm`*
