---
title: "PkSlopeTypeR"
description: "Specifies in packet processing the type of retrigger slope condition to be activated."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkSlopeTypeR</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkslopetyper.htm`*
