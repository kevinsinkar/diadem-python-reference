---
title: "PkEnd"
description: "Specifies in packet processing the top limit value of the last class of an online classification."
---
...
Specifies in packet processing the top limit value of the last class of an online classification.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkEnd</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkend.htm`*
