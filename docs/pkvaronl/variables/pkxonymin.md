---
title: "PkXonYMin"
description: "Specifies in packet processing whether DIAdem calculates the time value of the minimum measurement value as the statistical characteristic value."
---
...
Specifies in packet processing whether DIAdem calculates the time value of the minimum measurement value as the statistical characteristic value.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXonYMin</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxonymin.htm`*
