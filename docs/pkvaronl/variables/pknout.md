---
title: "PkNOut"
description: "Specifies in packet processing the number of signal outputs of a copy."
---
...
Specifies in packet processing the number of signal outputs of a copy.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkNOut</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pknout.htm`*
