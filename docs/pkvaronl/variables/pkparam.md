---
title: "PkParam"
description: "Specifies in packet processing the type of data amount to be created in sections."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkParam</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkparam.htm`*
