---
title: "PkButTxtOff"
description: "Specifies in packet processing a text for the switched off mode of switches, push buttons, and bit switches."
---

# PkButTxtOff

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkButTxtOff

Specifies in packet processing a text for the switched off mode of switches, push buttons, and bit switches.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkButTxtOff(i)</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkbuttxtoff.htm`*
