---
title: "PkSmoothNVal"
description: "Specifies in packet processing the number of values for calculating the moving average."
---

# PkSmoothNVal

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkSmoothNVal

Specifies in packet processing the number of values for calculating the moving average.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkSmoothNVal</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pksmoothnval.htm`*
