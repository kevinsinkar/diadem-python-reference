---
title: "PkYMess2"
description: "Specifies in packet processing the measurement value for the second y-point of a characteristic curve."
---
...
Specifies in packet processing the measurement value for the second y-point of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkYMess2</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkymess2.htm`*
