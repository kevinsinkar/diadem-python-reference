---
title: "PkUpperLimR"
description: "Specifies in packet processing the top window limit of a retrigger."
---
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkUpperLimR</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkupperlimr.htm`*
