---
title: "PkXScal1"
description: "Specifies in packet processing the scaled measurement value for the first x-point of a characteristic curve."
---
...
Specifies in packet processing the scaled measurement value for the first x-point of a characteristic curve.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkXScal1</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkxscal1.htm`*
