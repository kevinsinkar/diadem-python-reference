---
title: "PkStopNBlocks"
description: "Specifies after how many data packets DIAdem stops the packet processing."
---

# PkStopNBlocks

!!! abstract "Variable &middot; `PkVarOnl.chm`"
    Variable: PkStopNBlocks

Specifies after how many data packets DIAdem stops the packet processing.
...
 <donottranslate><pre>DACObjOpen(<em>BlockName</em>)
    <donottranslate>PkStopNBlocks</donottranslate> = <em>Value</em>
...
*Source: `PkVarOnl/pkvaronl/pkstopnblocks.htm`*
