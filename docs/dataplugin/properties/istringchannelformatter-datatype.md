---
title: "IStringChannelFormatter.Datatype"
description: "Specifies the data type of a DirectAccess channel that is associated with a StringBlock."
---

# IStringChannelFormatter.Datatype

!!! abstract "Property &middot; `DataPlugin.chm`"
    Property: DataType for StringChannelFormatter

Specifies the data type of a DirectAccess channel that is associated with a StringBlock.
...
*Source: `DataPlugin/Properties/DataPlugin_Property_Datatype_IStringChannelFormatter.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
