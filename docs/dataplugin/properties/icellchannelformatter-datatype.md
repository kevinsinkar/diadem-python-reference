---
title: "ICellChannelFormatter.DataType"
description: "Specifies the data type of a DirectAccess channel that is associated with a CellBlock."
---

# ICellChannelFormatter.DataType

!!! abstract "Property &middot; `DataPlugin.chm`"
    Property: DataType for CellChannelFormatter

Specifies the data type of a DirectAccess channel that is associated with a CellBlock.
...
*Source: `DataPlugin/Properties/DataPlugin_property_DataType_ICellChannelFormatter.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
