---
title: "IAbstractChannel.IsKindOf"
description: "Checks whether a Channel object is a certain type."
---

# IAbstractChannel.IsKindOf

!!! abstract "Method &middot; `DataPlugin.chm`"
    Method: IsKindOf for AbstractChannel
...
*Source: `DataPlugin/Methods/DataPlugin_method_IsKindOf_IAbstractChannel.htm`&nbsp;&middot;&nbsp;Python translated from VBS*
