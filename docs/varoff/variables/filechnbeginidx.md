---
title: "FileChnBeginIdx"
description: "Specifies the first value to be read in when DAT files are imported via header."
---

# FileChnBeginIdx

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileChnBeginIdx

Specifies the first value to be read in when DAT files are imported via header.
...
*Source: `VarOff/FileChnBeginIdx.htm`*
