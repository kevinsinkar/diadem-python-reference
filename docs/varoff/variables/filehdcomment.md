---
title: "FileHdComment"
description: "Receives the comments of the data set when DAT files are imported via header."
---

# FileHdComment

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdComment

Receives the comments of the data set when DAT files are imported via header.
...
*Source: `VarOff/FileHdComment.htm`*
