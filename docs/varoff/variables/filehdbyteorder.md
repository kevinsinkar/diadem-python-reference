---
title: "FileHdByteOrder"
description: "Receives the byte order of binary dat when DAT files are imported via header."
---

# FileHdByteOrder

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdByteOrder

Receives the byte order of binary dat when DAT files are imported via header.
...
*Source: `VarOff/FileHdByteOrder.htm`*
