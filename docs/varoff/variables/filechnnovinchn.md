---
title: "FileChnNovInChn"
description: "Specifies the NoValue value in a channel when DAT files are imported via header."
---

# FileChnNovInChn

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileChnNovInChn

Specifies the NoValue value in a channel when DAT files are imported via header.
...
*Source: `VarOff/FileChnNovInChn.htm`*
