---
title: "FileChnLength"
description: "Specifies the length of a data channel when DAT files are imported via header."
---

# FileChnLength

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileChnLength

Specifies the length of a data channel when DAT files are imported via header.
...
*Source: `VarOff/FileChnLength.htm`*
