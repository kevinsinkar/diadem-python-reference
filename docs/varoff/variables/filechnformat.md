---
title: "FileChnFormat"
description: "Specifies the display format of the channel when DAT files are imported via header."
---

# FileChnFormat

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileChnFormat

Specifies the display format of the channel when DAT files are imported via header.
...
*Source: `VarOff/FileChnFormat.htm`*
