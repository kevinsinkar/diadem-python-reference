---
title: "FileHdAddTxt1"
description: "Specifies a variable that can be used for any additional information about the data set when DAT files are imported via header."
---

# FileHdAddTxt1

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdAddTxt1

Specifies a variable that can be used for any additional information about the data set when DAT files are imported via header.
...
*Source: `VarOff/FileHdAddTxt1.htm`*
