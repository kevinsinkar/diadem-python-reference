---
title: "FileHdDate"
description: "Receives the date of the last storage of the data set when DAT files are imported via header."
---
...
Receives the date of the last storage of the data set when DAT files are imported via header.
