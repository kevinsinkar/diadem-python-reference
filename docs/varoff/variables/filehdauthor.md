---
title: "FileHdAuthor"
description: "Receives the author of the data set when DAT files are imported via header."
---

# FileHdAuthor

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdAuthor

Receives the author of the data set when DAT files are imported via header.
...
*Source: `VarOff/FileHdAuthor.htm`*
