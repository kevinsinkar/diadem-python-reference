---
title: "FileChnNovKey"
description: "Specifies whether a channel contains NoValues when DAT files are imported via header."
---

# FileChnNovKey

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileChnNovKey

Specifies whether a channel contains NoValues when DAT files are imported via header.
...
*Source: `VarOff/FileChnNovKey.htm`*
