---
title: "FileHdTitle"
description: "Receives the name of the data set when DAT files are imported via header."
---

# FileHdTitle

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdTitle

Receives the name of the data set when DAT files are imported via header.
