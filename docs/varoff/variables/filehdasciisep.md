---
title: "FileHdASCIISep"
description: "Receives the character that separates the single values of ASCII block data when DAT files are imported via header."
---

# FileHdASCIISep

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdASCIISep

Receives the character that separates the single values of ASCII block data when DAT files are imported via header.
...
*Source: `VarOff/FileHdASCIISep.htm`*
