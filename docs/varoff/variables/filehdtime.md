---
title: "FileHdTime"
description: "Receives the time of the last storage of the data set when DAT files are imported via header."
---
...
Receives the time of the last storage of the data set when DAT files are imported via header.
