---
title: "FileChnName"
description: "Specifies the name of a data channel when DAT files are imported via header."
---

# FileChnName

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileChnName

Specifies the name of a data channel when DAT files are imported via header.
