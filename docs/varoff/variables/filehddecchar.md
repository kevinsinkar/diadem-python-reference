---
title: "FileHdDecChar"
description: "Receives the decimal symbol used in ASCII files when DAT files are imported via header."
---

# FileHdDecChar

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdDecChar

Receives the decimal symbol used in ASCII files when DAT files are imported via header.
...
*Source: `VarOff/FileHdDecChar.htm`*
