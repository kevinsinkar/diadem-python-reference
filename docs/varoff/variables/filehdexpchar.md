---
title: "FileHdExpChar"
description: "Receives the exponential character used in ASCII files when DAT files are imported via header."
---

# FileHdExpChar

!!! abstract "Variable &middot; `VarOff.chm`"
    Variable: FileHdExpChar

Receives the exponential character used in ASCII files when DAT files are imported via header.
...
*Source: `VarOff/FileHdExpChar.htm`*
