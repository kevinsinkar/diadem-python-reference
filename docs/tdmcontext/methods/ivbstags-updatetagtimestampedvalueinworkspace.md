---
title: "IVbsTags.UpdateTagTimestampedValueInWorkspace"
...
# IVbsTags.UpdateTagTimestampedValueInWorkspace

!!! abstract "Method &middot; `TDMcontext.chm`"
    Method: UpdateTagTimestampedValueInWorkspace for Tags <SystemLink>
...
```python
obj.UpdateTagTimestampedValueInWorkspace(path, timestampedValue, workspace)
```
...
*Source: `TDMcontext/methods/TDMContext_method_UpdateTagTimestampedValueInWorkspace_IVbsTags.htm`*
