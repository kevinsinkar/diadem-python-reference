---
title: "IVbsContextASInit.TaskExecution"
...
# IVbsContextASInit.TaskExecution

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: TaskExecution for ContextInitialize <Analysis Automation>
...
*Source: `TDMcontext/properties/TDMContext_property_TaskExecution_IVbsContextASInit.htm`*
