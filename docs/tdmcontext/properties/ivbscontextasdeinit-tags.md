---
title: "IVbsContextASDeinit.Tags"
...
# IVbsContextASDeinit.Tags

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: Tags for ContextFinalize <Analysis Automation>
...
*Source: `TDMcontext/properties/TDMContext_property_Tags_IVbsContextASDeinit.htm`*
