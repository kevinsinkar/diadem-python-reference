---
title: "IVbsContextASInit.FileService"
...
# IVbsContextASInit.FileService

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: FileService for ContextInitialize <Analysis Automation>
...
*Source: `TDMcontext/properties/TDMContext_property_FileService_IVbsContextASInit.htm`*
