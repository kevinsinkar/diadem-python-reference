---
title: "IVbsContextAS.TempFolder"
...
# IVbsContextAS.TempFolder

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: TempFolder for ContextRun <Analysis Automation>
...
def On_Run_AnalysisProcedure(oContext):
    ...
    oContext.LogResult("Temporary path for run: " + TempPath)
```
...
*Source: `TDMcontext/properties/TDMContext_property_TempFolder_IVbsContextAS.htm`*
