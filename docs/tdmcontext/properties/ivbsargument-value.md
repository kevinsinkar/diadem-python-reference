---
title: "IVbsArgument.Value"
description: "Specifies the value of an argument."
---

# IVbsArgument.Value

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: Value for Argument <SystemLink>

Specifies the value of an argument.
...
*Source: `TDMcontext/properties/TDMContext_property_Value_IVbsArgument.htm`*
