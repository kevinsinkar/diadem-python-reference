---
title: "IVbsProcedureInfo.Name"
description: "Specifies the name of the analysis automation procedure that a task executes."
---

# IVbsProcedureInfo.Name

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: Name for ProcedureInfo <Analysis Automation>

Specifies the name of the analysis automation procedure that a task executes.
...
*Source: `TDMcontext/properties/TDMContext_property_Name_IVbsProcedureInfo.htm`*
