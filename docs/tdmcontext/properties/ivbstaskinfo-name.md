---
title: "IVbsTaskInfo.Name"
description: "Specifies the name of a task from the list of executable tasks."
---

# IVbsTaskInfo.Name

!!! abstract "Property &middot; `TDMcontext.chm`"
    Property: Name for TaskInfo <Analysis Automation>

Specifies the name of a task from the list of executable tasks.
...
*Source: `TDMcontext/properties/TDMContext_property_Name_IVbsTaskInfo.htm`*
